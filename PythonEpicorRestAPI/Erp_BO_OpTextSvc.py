...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.OpTextSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.OpTextSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_OpTexts(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.OpTextSvc/OpTexts",headers=creds) as resp:
           return await resp.json()

async def post_OpTexts(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.OpTextSvc/OpTexts", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_OpTexts_Company_OpTextID(Company, OpTextID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.OpTextSvc/OpTexts(" + Company + "," + OpTextID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_OpTexts_Company_OpTextID(Company, OpTextID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.OpTextSvc/OpTexts(" + Company + "," + OpTextID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_OpTexts_Company_OpTextID(Company, OpTextID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.OpTextSvc/OpTexts(" + Company + "," + OpTextID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.OpTextSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseOpText, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.OpTextSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(opTextID, epicorHeaders = None):
   """  
...
async def post_GetNewOpText(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.OpTextSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_OpTextListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_OpTextListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_OpTextRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_OpTextRow] = obj["value"]
      pass

class Erp_Tablesets_OpTextListRow:
   def __init__(self, obj):
      ...
      self.InspectLines:str = obj["InspectLines"]
...
class Erp_Tablesets_OpTextListTableset:
   def __init__(self, obj):
      self.OpTextList:list[Erp_Tablesets_OpTextListRow] = obj["OpTextList"]
...
class Erp_Tablesets_OpTextTableset:
   def __init__(self, obj):
      self.OpText:list[Erp_Tablesets_OpTextRow] = obj["OpText"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtOpTextTableset:
   def __init__(self, obj):
      self.OpText:list[Erp_Tablesets_OpTextRow] = obj["OpText"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_OpTextTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_OpTextListTableset] = obj["returnObj"]
      pass
...
class GetNewOpText_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_OpTextTableset] = obj["ds"]
      pass

class GetNewOpText_output:
   def __init__(self, obj):
      pass
...
class GetRows_input:
   ...
   """  
   def __init__(self, obj):
      self.whereClauseOpText:str = obj["whereClauseOpText"]
      self.pageSize:int = obj["pageSize"]
      self.absolutePage:int = obj["absolutePage"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtOpTextTableset] = obj["ds"]
