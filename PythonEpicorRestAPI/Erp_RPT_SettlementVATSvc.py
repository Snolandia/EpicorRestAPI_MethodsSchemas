...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SettlementVATSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SettlementVATSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_OnChangeGLSummary(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SettlementVATSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SettlementVATSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SettlementVATSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SettlementVATParamRow:
   def __init__(self, obj):
      self.CutOffDate:str = obj["CutOffDate"]
      self.DocumentType:str = obj["DocumentType"]
      self.GLSummary:bool = obj["GLSummary"]
      self.BookID:str = obj["BookID"]
      self.TaxRgnList:str = obj["TaxRgnList"]
      """  Tas Region List  """  
...
class Erp_Tablesets_SettlementVATTableset:
   def __init__(self, obj):
      self.SettlementVATParam:list[Erp_Tablesets_SettlementVATParamRow] = obj["SettlementVATParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SettlementVATTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SettlementVATTableset] = obj["returnObj"]
      pass
...
class OnChangeGLSummary_output:
   def __init__(self, obj):
      pass
