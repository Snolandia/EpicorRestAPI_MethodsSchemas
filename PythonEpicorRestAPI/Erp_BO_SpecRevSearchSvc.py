...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.SpecRevSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.SpecRevSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_SpecRevSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.SpecRevSearchSvc/SpecRevSearches",headers=creds) as resp:
           return await resp.json()

async def post_SpecRevSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.SpecRevSearchSvc/SpecRevSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_SpecRevSearches_Company_SpecType_SpecID_SpecRevNum(Company, SpecType, SpecID, SpecRevNum, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.SpecRevSearchSvc/SpecRevSearches(" + Company + "," + SpecType + "," + SpecID + "," + SpecRevNum + ")",headers=creds) as resp:
           return await resp.json()

async def patch_SpecRevSearches_Company_SpecType_SpecID_SpecRevNum(Company, SpecType, SpecID, SpecRevNum, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.SpecRevSearchSvc/SpecRevSearches(" + Company + "," + SpecType + "," + SpecID + "," + SpecRevNum + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_SpecRevSearches_Company_SpecType_SpecID_SpecRevNum(Company, SpecType, SpecID, SpecRevNum, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.SpecRevSearchSvc/SpecRevSearches(" + Company + "," + SpecType + "," + SpecID + "," + SpecRevNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.SpecRevSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseSpecRev, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.SpecRevSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(specType, specID, specRevNum, epicorHeaders = None):
   """  
...
async def post_GetNewSpecRev(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.SpecRevSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_SpecRevListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_SpecRevListRow] = obj["value"]
      pass
...
class Erp_Tablesets_SpecRevListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_SpecRevListTableset:
   def __init__(self, obj):
      self.SpecRevList:list[Erp_Tablesets_SpecRevListRow] = obj["SpecRevList"]
...
class Erp_Tablesets_SpecRevTableset:
   def __init__(self, obj):
      self.SpecRev:list[Erp_Tablesets_SpecRevRow] = obj["SpecRev"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtSpecRevTableset:
   def __init__(self, obj):
      self.SpecRev:list[Erp_Tablesets_SpecRevRow] = obj["SpecRev"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SpecRevTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SpecRevListTableset] = obj["returnObj"]
      pass
...
class GetNewSpecRev_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SpecRevTableset] = obj["ds"]
      self.specType:str = obj["specType"]
      self.specID:str = obj["specID"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtSpecRevTableset] = obj["ds"]
