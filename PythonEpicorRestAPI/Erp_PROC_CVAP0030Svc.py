...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CVAP0030Svc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CVAP0030Svc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_getDefaultBalanceType(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CVAP0030Svc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CVAP0030Svc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CVAP0030ParamRow:
   def __init__(self, obj):
      ...
      self.Audit:bool = obj["Audit"]
      self.FiscalYearSuffix:str = obj["FiscalYearSuffix"]
      self.RunCurrencyRevalue:bool = obj["RunCurrencyRevalue"]
...
class Erp_Tablesets_CVAP0030Tableset:
   def __init__(self, obj):
      self.CVAP0030Param:list[Erp_Tablesets_CVAP0030ParamRow] = obj["CVAP0030Param"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CVAP0030Tableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CVAP0030Tableset] = obj["returnObj"]
      pass
...
class getDefaultBalanceType_input:
   """ Required : 
   bankAcctIdList
   """  
   def __init__(self, obj):
      self.bankAcctIdList:str = obj["bankAcctIdList"]
      pass

class getDefaultBalanceType_output:
   def __init__(self, obj):
