...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.EuropeanSalesReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.EuropeanSalesReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_OnChangeECSalesReportID(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.EuropeanSalesReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.EuropeanSalesReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.EuropeanSalesReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_EuropeanSalesReportParamRow:
...
class Erp_Tablesets_EuropeanSalesReportTableset:
   def __init__(self, obj):
      self.EuropeanSalesReportParam:list[Erp_Tablesets_EuropeanSalesReportParamRow] = obj["EuropeanSalesReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_EuropeanSalesReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_EuropeanSalesReportTableset] = obj["returnObj"]
      pass
...
class OnChangeECSalesReportID_input:
   """ Required : 
   proposedECSalesReportID
   ds
   """  
   def __init__(self, obj):
      self.proposedECSalesReportID:str = obj["proposedECSalesReportID"]
      """  The proposed currency code  """  
      self.ds:list[Erp_Tablesets_EuropeanSalesReportTableset] = obj["ds"]
      pass

class OnChangeECSalesReportID_output:
   def __init__(self, obj):
      pass
