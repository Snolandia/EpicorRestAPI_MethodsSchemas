...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.TransferBalancesSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.TransferBalancesSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_ChangeBookID(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.TransferBalancesSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_ChangeFiscalCalendarID(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangeFromYear(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangeFromYearSuffix(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangeToYear(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangeToYearSuffix(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangeTransferOption(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangeYearsOption(requestBody, epicorHeaders = None):
   """  
...
async def post_getCalendarID(requestBody, epicorHeaders = None):
   """  
...
async def post_getFiscalYears(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.TransferBalancesSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class ChangeBookID_input:
   ...
   def __init__(self, obj):
      self.cBookID:str = obj["cBookID"]
      """  The Book ID  """  
      self.ds:list[Erp_Tablesets_TransferBalancesTableset] = obj["ds"]
      pass
...
class ChangeFiscalCalendarID_input:
   """ Required : 
   cFiscalCalendarID
   ds
   """  
...
class ChangeFiscalCalendarID_output:
   def __init__(self, obj):
      pass
...
class ChangeFromYearSuffix_input:
   """ Required : 
   cFromYearSuffix
   ds
   """  
   def __init__(self, obj):
      self.cFromYearSuffix:str = obj["cFromYearSuffix"]
      """  The From Fiscal Year Suffix  """  
      self.ds:list[Erp_Tablesets_TransferBalancesTableset] = obj["ds"]
      pass

class ChangeFromYearSuffix_output:
   def __init__(self, obj):
      pass
...
class ChangeFromYear_input:
   """ Required : 
   iFromYear
   ds
   """  
   def __init__(self, obj):
      self.iFromYear:int = obj["iFromYear"]
      """  The From Fiscal Year  """  
      self.ds:list[Erp_Tablesets_TransferBalancesTableset] = obj["ds"]
      pass

class ChangeFromYear_output:
   def __init__(self, obj):
      pass
...
class ChangeToYearSuffix_input:
   """ Required : 
   cToYearSuffix
   ds
   """  
   def __init__(self, obj):
      self.cToYearSuffix:str = obj["cToYearSuffix"]
      """  The To Fiscal Year Suffix  """  
      self.ds:list[Erp_Tablesets_TransferBalancesTableset] = obj["ds"]
      pass

class ChangeToYearSuffix_output:
   def __init__(self, obj):
      pass
...
class ChangeToYear_input:
   """ Required : 
   iToYear
   ds
   """  
   def __init__(self, obj):
      self.iToYear:int = obj["iToYear"]
      """  The To Fiscal Year  """  
      self.ds:list[Erp_Tablesets_TransferBalancesTableset] = obj["ds"]
      pass

class ChangeToYear_output:
   def __init__(self, obj):
      pass
...
class ChangeTransferOption_input:
   """ Required : 
   cTransferOption
   ds
   """  
   def __init__(self, obj):
      self.cTransferOption:str = obj["cTransferOption"]
      """  The Transfer Option  """  
      self.ds:list[Erp_Tablesets_TransferBalancesTableset] = obj["ds"]
      pass

class ChangeTransferOption_output:
   def __init__(self, obj):
      pass
...
class ChangeYearsOption_input:
   """ Required : 
   cYearsOption
   ds
   """  
   def __init__(self, obj):
      self.cYearsOption:str = obj["cYearsOption"]
      """  The Years Option  """  
      self.ds:list[Erp_Tablesets_TransferBalancesTableset] = obj["ds"]
      pass

class ChangeYearsOption_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_TransferBalancesParamRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      self.TransferOption:str = obj["TransferOption"]
      self.BookID:str = obj["BookID"]
      self.BookDescription:str = obj["BookDescription"]
      self.FiscalCalendarID:str = obj["FiscalCalendarID"]
      self.FiscalCalDescription:str = obj["FiscalCalDescription"]
      self.EnableBook:bool = obj["EnableBook"]
      self.EnableCalendar:bool = obj["EnableCalendar"]
      self.YearsOption:str = obj["YearsOption"]
      self.FromYear:int = obj["FromYear"]
      self.FromYearSuffix:str = obj["FromYearSuffix"]
      self.ToYear:int = obj["ToYear"]
      self.ToYearSuffix:str = obj["ToYearSuffix"]
      self.LogFileName:str = obj["LogFileName"]
      self.LogFileNameDisplay:str = obj["LogFileNameDisplay"]
      self.EnableToYear:bool = obj["EnableToYear"]
...
class Erp_Tablesets_TransferBalancesTableset:
   def __init__(self, obj):
      self.TransferBalancesParam:list[Erp_Tablesets_TransferBalancesParamRow] = obj["TransferBalancesParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TransferBalancesTableset] = obj["returnObj"]
      pass
...
class getCalendarID_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.cCalendarID:str = obj["parameters"]
      pass

      """  output parameters  """  

class getFiscalYears_input:
   """ Required : 
   inYrOption
   cTransferOption
   cBookID
   ...
   """  
   def __init__(self, obj):
      self.inYrOption:str = obj["inYrOption"]
      self.cTransferOption:str = obj["cTransferOption"]
      self.cBookID:str = obj["cBookID"]
      self.cFiscalCalendarID:str = obj["cFiscalCalendarID"]
      pass

class getFiscalYears_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.outFromYear:int = obj["parameters"]
      self.outFromYearSuf:str = obj["parameters"]
      self.outToYear:int = obj["parameters"]
      self.outToYearSuf:str = obj["parameters"]
      pass
