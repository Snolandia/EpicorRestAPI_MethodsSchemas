...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PartPriceHistorySvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PartPriceHistorySvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PartPriceHistorySvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PartPriceHistorySvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PartPriceHistorySvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PartPriceHistoryParamRow:
   def __init__(self, obj):
      self.Vendors:str = obj["Vendors"]
      """  Vendor List  """  
      self.Parts:str = obj["Parts"]
      """  Part List  """  
      self.MostRecentOnly:bool = obj["MostRecentOnly"]
      """  Most Recent Prices Only  """  
      self.IncludeMfgParts:bool = obj["IncludeMfgParts"]
      """  Indicate if the report will Include Manufacturer Parts  """  
      self.IncludeVendorParts:bool = obj["IncludeVendorParts"]
...
class Erp_Tablesets_PartPriceHistoryTableset:
   def __init__(self, obj):
      self.PartPriceHistoryParam:list[Erp_Tablesets_PartPriceHistoryParamRow] = obj["PartPriceHistoryParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PartPriceHistoryTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PartPriceHistoryTableset] = obj["returnObj"]
      pass
