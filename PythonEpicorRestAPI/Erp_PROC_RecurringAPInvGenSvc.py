...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RecurringAPInvGenSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RecurringAPInvGenSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ConfirmInactiveVendor(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.RecurringAPInvGenSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RecurringAPInvGenSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class ConfirmInactiveVendor_input:
   """ Required : 
   cycleCodes
   suppliers
   """  
   def __init__(self, obj):
      self.cycleCodes:str = obj["cycleCodes"]
      self.suppliers:str = obj["suppliers"]
      pass

class ConfirmInactiveVendor_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_RecurringAPInvGenParamRow:
   def __init__(self, obj):
      ...
      self.Suppliers:str = obj["Suppliers"]
      self.SuppliersIDLst:str = obj["SuppliersIDLst"]
...
class Erp_Tablesets_RecurringAPInvGenTableset:
   def __init__(self, obj):
      self.RecurringAPInvGenParam:list[Erp_Tablesets_RecurringAPInvGenParamRow] = obj["RecurringAPInvGenParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_RecurringAPInvGenTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_RecurringAPInvGenTableset] = obj["returnObj"]
      pass
