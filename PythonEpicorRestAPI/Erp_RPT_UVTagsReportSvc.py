...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.UVTagsReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.UVTagsReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
/// <param name="ds">Report Data set</param>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.UVTagsReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.UVTagsReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.UVTagsReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_UVTagsReportRow:
   def __init__(self, obj):
      ...
      self.MonthDesc:str = obj["MonthDesc"]
      """  Month Description  """  
...
class Erp_Tablesets_UVTagsReportTableset:
   def __init__(self, obj):
      self.UVTagsReport:list[Erp_Tablesets_UVTagsReportRow] = obj["UVTagsReport"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UVTagsReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_UVTagsReportTableset] = obj["returnObj"]
      pass
