...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARLOCReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARLOCReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARLOCReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARLOCReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARLOCReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ARLOCReportParamRow:
   def __init__(self, obj):
      self.LOCStatus:str = obj["LOCStatus"]
      """  Status (Open, closed or both)  """  
      self.CustBillToList:str = obj["CustBillToList"]
      """  Bill to customer list  """  
      self.CustomerList:str = obj["CustomerList"]
      """  Customer list  """  
      self.ExpiryFromDate:str = obj["ExpiryFromDate"]
      """  Expiry From Date  """  
      self.ExpiryFromDateToken:str = obj["ExpiryFromDateToken"]
      """  Expiry From Date Token  """  
      self.ExpiryToDate:str = obj["ExpiryToDate"]
      """  Expiry To Date  """  
      self.ExpiryToDateToken:str = obj["ExpiryToDateToken"]
...
class Erp_Tablesets_ARLOCReportTableset:
   def __init__(self, obj):
      self.ARLOCReportParam:list[Erp_Tablesets_ARLOCReportParamRow] = obj["ARLOCReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ARLOCReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ARLOCReportTableset] = obj["returnObj"]
      pass
