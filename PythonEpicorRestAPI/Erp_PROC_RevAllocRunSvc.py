...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RevAllocRunSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RevAllocRunSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ValidateReverseDate(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.RevAllocRunSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RevAllocRunSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_RevAllocRunParamRow:
...
class Erp_Tablesets_RevAllocRunTableset:
   def __init__(self, obj):
      self.RevAllocRunParam:list[Erp_Tablesets_RevAllocRunParamRow] = obj["RevAllocRunParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_RevAllocRunTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_RevAllocRunTableset] = obj["returnObj"]
      pass
...
class ValidateReverseDate_input:
   """ Required : 
   ipReverseDate
   """  
   def __init__(self, obj):
      self.ipReverseDate:str = obj["ipReverseDate"]
      """  Reverse Date  """  
      pass

class ValidateReverseDate_output:
   def __init__(self, obj):
      pass
