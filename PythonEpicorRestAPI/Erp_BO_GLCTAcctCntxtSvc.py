...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLCTAcctCntxtSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLCTAcctCntxtSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GLCTAcctCntxts(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLCTAcctCntxtSvc/GLCTAcctCntxts",headers=creds) as resp:
           return await resp.json()
...
async def post_GLCTAcctCntxts(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.GLCTAcctCntxtSvc/GLCTAcctCntxts", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GLCTAcctCntxts_Company_GLControlType_GLCTAcctNum(Company, GLControlType, GLCTAcctNum, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLCTAcctCntxtSvc/GLCTAcctCntxts(" + Company + "," + GLControlType + "," + GLCTAcctNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_GLCTAcctCntxts_Company_GLControlType_GLCTAcctNum(Company, GLControlType, GLCTAcctNum, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.GLCTAcctCntxtSvc/GLCTAcctCntxts(" + Company + "," + GLControlType + "," + GLCTAcctNum + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_GLCTAcctCntxts_Company_GLControlType_GLCTAcctNum(Company, GLControlType, GLCTAcctNum, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.GLCTAcctCntxtSvc/GLCTAcctCntxts(" + Company + "," + GLControlType + "," + GLCTAcctNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLCTAcctCntxtSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseGLCTAcctCntxt, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLCTAcctCntxtSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(glControlType, glCTAcctNum, epicorHeaders = None):
   """  
...
async def post_GetNewGLCTAcctCntxt(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.GLCTAcctCntxtSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_GLCTAcctCntxtListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_GLCTAcctCntxtListRow] = obj["value"]
      pass
...
class Erp_Tablesets_GLCTAcctCntxtListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_GLCTAcctCntxtListTableset:
   def __init__(self, obj):
      self.GLCTAcctCntxtList:list[Erp_Tablesets_GLCTAcctCntxtListRow] = obj["GLCTAcctCntxtList"]
...
class Erp_Tablesets_GLCTAcctCntxtTableset:
   def __init__(self, obj):
      self.GLCTAcctCntxt:list[Erp_Tablesets_GLCTAcctCntxtRow] = obj["GLCTAcctCntxt"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtGLCTAcctCntxtTableset:
   def __init__(self, obj):
      self.GLCTAcctCntxt:list[Erp_Tablesets_GLCTAcctCntxtRow] = obj["GLCTAcctCntxt"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLCTAcctCntxtTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLCTAcctCntxtListTableset] = obj["returnObj"]
      pass
...
class GetNewGLCTAcctCntxt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GLCTAcctCntxtTableset] = obj["ds"]
      self.glControlType:str = obj["glControlType"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtGLCTAcctCntxtTableset] = obj["ds"]
