...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.IoTDeviceEventRetrieverSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.IoTDeviceEventRetrieverSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ChangeIoTHubName(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.PROC.IoTDeviceEventRetrieverSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.IoTDeviceEventRetrieverSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class ChangeIoTHubName_input:
   ...
   def __init__(self, obj):
      ...
      self.ts:list[Ice_Tablesets_IoTDeviceEventRetrieverTableset] = obj["ts"]
      pass

class ChangeIoTHubName_output:
   def __init__(self, obj):
      pass
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_IoTDeviceEventRetrieverTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_IoTDeviceEventRetrieverTableset] = obj["returnObj"]
      pass
...
class Ice_Tablesets_IoTDeviceEventRetrieverParamRow:
   def __init__(self, obj):
      self.IoTHubName:str = obj["IoTHubName"]
      self.ResubmitOnCompletion:bool = obj["ResubmitOnCompletion"]
      """  When set the process will be resubmitted with the same parameters it was ran from previously  """  
      self.RunTimeMinutes:int = obj["RunTimeMinutes"]
      self.EventHubLeaseFromEnd:bool = obj["EventHubLeaseFromEnd"]
...
class Ice_Tablesets_IoTDeviceEventRetrieverTableset:
   def __init__(self, obj):
      self.IoTDeviceEventRetrieverParam:list[Ice_Tablesets_IoTDeviceEventRetrieverParamRow] = obj["IoTDeviceEventRetrieverParam"]
