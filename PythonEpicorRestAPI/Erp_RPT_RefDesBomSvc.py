...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.RefDesBomSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.RefDesBomSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetSortByOptionList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.RefDesBomSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.RefDesBomSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.RefDesBomSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_RefDesBomParamRow:
   def __init__(self, obj):
      self.EffDate:str = obj["EffDate"]
      """  Effective Date  """  
      self.PageAssembly:bool = obj["PageAssembly"]
      ...
      self.JobsOp:bool = obj["JobsOp"]
      self.PartsOp:bool = obj["PartsOp"]
      self.QuotesOp:bool = obj["QuotesOp"]
...
class Erp_Tablesets_RefDesBomTableset:
   def __init__(self, obj):
      self.RefDesBomParam:list[Erp_Tablesets_RefDesBomParamRow] = obj["RefDesBomParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_RefDesBomTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_RefDesBomTableset] = obj["returnObj"]
      pass
