...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_ChangeBookID(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_ChangePurgeOption(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class ChangeBookID_input:
   ...
   def __init__(self, obj):
      ...
      """  The Book ID  """  
      self.ds:list[Erp_Tablesets_PurgeGLHistTableset] = obj["ds"]
      pass
...
class ChangePurgeOption_input:
   """ Required : 
   cPurgeMode
   ds
   """  
   def __init__(self, obj):
      self.cPurgeMode:str = obj["cPurgeMode"]
      self.ds:list[Erp_Tablesets_PurgeGLHistTableset] = obj["ds"]
      pass

class ChangePurgeOption_output:
   def __init__(self, obj):
      pass
...
class CheckFiscalyear_input:
   ...
   def __init__(self, obj):
      ...
      """  fiscalYearIN  """  
      self.fiscalYearSuffixIN:str = obj["fiscalYearSuffixIN"]
      """  fiscalYearSuffixIN  """  
      self.purgeOptionIN:str = obj["purgeOptionIN"]
      """  purgeOptionIN  """  
      pass
...
class Erp_Tablesets_PurgeGLHistParamRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      self.FiscalYear:int = obj["FiscalYear"]
      self.PurgeOption:str = obj["PurgeOption"]
...
class Erp_Tablesets_PurgeGLHistTableset:
   def __init__(self, obj):
      self.PurgeGLHistParam:list[Erp_Tablesets_PurgeGLHistParamRow] = obj["PurgeGLHistParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PurgeGLHistTableset] = obj["returnObj"]
      pass
