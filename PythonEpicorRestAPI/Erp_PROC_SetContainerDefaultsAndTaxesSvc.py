...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SetContainerDefaultsAndTaxesSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SetContainerDefaultsAndTaxesSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SetContainerDefaultsAndTaxesSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.SetContainerDefaultsAndTaxesSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_SetContainerDfltsTaxesParamRow:
   def __init__(self, obj):
      ...
      self.GenerateTaxes:bool = obj["GenerateTaxes"]
      """  Flag to ensure taxes are generated for the selected containers  """  
      self.ProcessOrdered:bool = obj["ProcessOrdered"]
...
class Erp_Tablesets_SetContainerDfltsTaxesTableset:
   def __init__(self, obj):
      self.SetContainerDfltsTaxesParam:list[Erp_Tablesets_SetContainerDfltsTaxesParamRow] = obj["SetContainerDfltsTaxesParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SetContainerDfltsTaxesTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SetContainerDfltsTaxesTableset] = obj["returnObj"]
      pass
