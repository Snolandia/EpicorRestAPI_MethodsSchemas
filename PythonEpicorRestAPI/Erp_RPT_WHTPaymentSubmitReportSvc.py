...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WHTPaymentSubmitReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WHTPaymentSubmitReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewParametersAndDefaults(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WHTPaymentSubmitReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetWHTPaymentSubmitReportData(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WHTPaymentSubmitReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WHTPaymentSubmitReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_WHTPaymentSubmitReportParamRow:
   def __init__(self, obj):
      self.ReportName:str = obj["ReportName"]
      self.Description:str = obj["Description"]
      self.FiscalCalendarID:str = obj["FiscalCalendarID"]
      self.FiscalCalendarName:str = obj["FiscalCalendarName"]
...
class Erp_Tablesets_WHTPaymentSubmitReportTableset:
   def __init__(self, obj):
      self.WHTPaymentSubmitReportParam:list[Erp_Tablesets_WHTPaymentSubmitReportParamRow] = obj["WHTPaymentSubmitReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_WHTPaymentSubmitReportTableset] = obj["ds"]
      pass
...
class GetNewParametersAndDefaults_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_WHTPaymentSubmitReportTableset] = obj["returnObj"]
      pass
...
class GetWHTPaymentSubmitReportData_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class GetWHTPaymentSubmitReportData_output:
   def __init__(self, obj):
      pass
