...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ImportLaborSchedSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ImportLaborSchedSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ImportLaborSchedSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ImportLaborSchedSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ImportLaborSchedParamRow:
   def __init__(self, obj):
      self.BackupFile:bool = obj["BackupFile"]
      """  Indicates if the inbound file will be backed up on the backup folder.  """  
      self.Continuous:bool = obj["Continuous"]
      self.DefTimeStatus:str = obj["DefTimeStatus"]
...
class Erp_Tablesets_ImportLaborSchedTableset:
   def __init__(self, obj):
      self.ImportLaborSchedParam:list[Erp_Tablesets_ImportLaborSchedParamRow] = obj["ImportLaborSchedParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ImportLaborSchedTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ImportLaborSchedTableset] = obj["returnObj"]
      pass
