...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GlbTableSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GlbTableSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_GlbTables(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GlbTableSvc/GlbTables",headers=creds) as resp:
           return await resp.json()

async def post_GlbTables(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.GlbTableSvc/GlbTables", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_GlbTables_Company_TableName_ExtSystemID_ExtCompanyID(Company, TableName, ExtSystemID, ExtCompanyID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GlbTableSvc/GlbTables(" + Company + "," + TableName + "," + ExtSystemID + "," + ExtCompanyID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_GlbTables_Company_TableName_ExtSystemID_ExtCompanyID(Company, TableName, ExtSystemID, ExtCompanyID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.GlbTableSvc/GlbTables(" + Company + "," + TableName + "," + ExtSystemID + "," + ExtCompanyID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_GlbTables_Company_TableName_ExtSystemID_ExtCompanyID(Company, TableName, ExtSystemID, ExtCompanyID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.GlbTableSvc/GlbTables(" + Company + "," + TableName + "," + ExtSystemID + "," + ExtCompanyID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GlbTableSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseGlbTable, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GlbTableSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(tableName, extSystemID, extCompanyID, epicorHeaders = None):
   """  
...
async def post_GetAvailFields(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.GlbTableSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_OnChangeCompany(requestBody, epicorHeaders = None):
   """  
...
async def post_GetNewGlbTable(requestBody, epicorHeaders = None):
   """  
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_GlbTableListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_GlbTableListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_GlbTableRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_GlbTableRow] = obj["value"]
      pass

class Erp_Tablesets_GlbTableListRow:
   def __init__(self, obj):
...
3) check for table (sys and co are blank), if no fields then nothing updated.  """  
      self.UseFieldList:str = obj["UseFieldList"]
...
3) check for table (sys and co are blank), if no fields then nothing updated.  """  
      ...
      self.FieldStatus:str = obj["FieldStatus"]
      """  Description of the fields selected  """  
      self.RowMod:str = obj["RowMod"]
      """  RowMod  """  
      pass

class Erp_Tablesets_GlbTableRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.TableName:str = obj["TableName"]
...
3) check for table (sys and co are blank), if no fields then nothing updated.  """  
      ...
      self.FieldStatus:str = obj["FieldStatus"]
      """  Description of the fields selected  """  
      self.AvailableFields:str = obj["AvailableFields"]
...
class Erp_Tablesets_GlbTableListTableset:
   def __init__(self, obj):
      self.GlbTableList:list[Erp_Tablesets_GlbTableListRow] = obj["GlbTableList"]
...
class Erp_Tablesets_GlbTableTableset:
   def __init__(self, obj):
      self.GlbTable:list[Erp_Tablesets_GlbTableRow] = obj["GlbTable"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtGlbTableTableset:
   def __init__(self, obj):
      self.GlbTable:list[Erp_Tablesets_GlbTableRow] = obj["GlbTable"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class GetAvailFields_input:
   """ Required : 
   cTableName
   """  
   def __init__(self, obj):
...
class GetAvailFields_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.cFieldList:str = obj["parameters"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GlbTableTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GlbTableListTableset] = obj["returnObj"]
      pass
...
class GetNewGlbTable_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GlbTableTableset] = obj["ds"]
      self.tableName:str = obj["tableName"]
      self.extSystemID:str = obj["extSystemID"]
      pass

class GetNewGlbTable_output:
   def __init__(self, obj):
      pass
...
class GetRows_input:
   ...
   """  
   def __init__(self, obj):
      self.whereClauseGlbTable:str = obj["whereClauseGlbTable"]
      self.pageSize:int = obj["pageSize"]
      self.absolutePage:int = obj["absolutePage"]
      pass
...
class OnChangeCompany_input:
   ...
   """  
   def __init__(self, obj):
      self.cExtSystemID:str = obj["cExtSystemID"]
      """  System ID  """  
      self.cExtCompanyID:str = obj["cExtCompanyID"]
      """  Company ID  """  
      self.ds:list[Erp_Tablesets_GlbTableTableset] = obj["ds"]
      pass

class OnChangeCompany_output:
   def __init__(self, obj):
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtGlbTableTableset] = obj["ds"]
