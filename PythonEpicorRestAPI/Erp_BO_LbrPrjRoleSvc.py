...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LbrPrjRoleSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LbrPrjRoleSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_LbrPrjRoles(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LbrPrjRoleSvc/LbrPrjRoles",headers=creds) as resp:
           return await resp.json()

async def post_LbrPrjRoles(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.LbrPrjRoleSvc/LbrPrjRoles", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_LbrPrjRoles_Company_LaborHedSeq_LaborDtlSeq(Company, LaborHedSeq, LaborDtlSeq, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LbrPrjRoleSvc/LbrPrjRoles(" + Company + "," + LaborHedSeq + "," + LaborDtlSeq + ")",headers=creds) as resp:
           return await resp.json()

async def patch_LbrPrjRoles_Company_LaborHedSeq_LaborDtlSeq(Company, LaborHedSeq, LaborDtlSeq, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.LbrPrjRoleSvc/LbrPrjRoles(" + Company + "," + LaborHedSeq + "," + LaborDtlSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_LbrPrjRoles_Company_LaborHedSeq_LaborDtlSeq(Company, LaborHedSeq, LaborDtlSeq, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.LbrPrjRoleSvc/LbrPrjRoles(" + Company + "," + LaborHedSeq + "," + LaborDtlSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LbrPrjRoleSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseLaborDtl, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LbrPrjRoleSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_OnChangeNewPrjRoleCd(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.LbrPrjRoleSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_UpdatePrjRoleCd(requestBody, epicorHeaders = None):
   """  
...
class Erp_Tablesets_LbrPrjRoleTableset:
   def __init__(self, obj):
      self.LaborDtl:list[Erp_Tablesets_LaborDtlRow] = obj["LaborDtl"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtLbrPrjRoleTableset:
   def __init__(self, obj):
      self.LaborDtl:list[Erp_Tablesets_LaborDtlRow] = obj["LaborDtl"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_LbrPrjRoleTableset] = obj["returnObj"]
      pass
...
class GetNewLaborDtl_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_LbrPrjRoleTableset] = obj["ds"]
      self.laborHedSeq:int = obj["laborHedSeq"]
      pass
...
class OnChangeNewPrjRoleCd_input:
   """ Required : 
   ipNewPrjRoleCd
   ds
   """  
   def __init__(self, obj):
      self.ipNewPrjRoleCd:str = obj["ipNewPrjRoleCd"]
      """  The NewPrjRoleCd value.  """  
      self.ds:list[Erp_Tablesets_LbrPrjRoleTableset] = obj["ds"]
      pass

class OnChangeNewPrjRoleCd_output:
   def __init__(self, obj):
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtLbrPrjRoleTableset] = obj["ds"]
