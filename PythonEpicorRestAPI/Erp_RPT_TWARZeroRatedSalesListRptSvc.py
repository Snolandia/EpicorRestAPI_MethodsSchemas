...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_OnChangeOfReportPeriod(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_TWARZeroRatedSalesListRptParamRow:
   def __init__(self, obj):
      self.FiscalCalendarID:str = obj["FiscalCalendarID"]
      self.FiscalYear:int = obj["FiscalYear"]
      self.FiscalYearSuffix:str = obj["FiscalYearSuffix"]
      self.ReportPeriod:int = obj["ReportPeriod"]
      self.DeclarationDate:str = obj["DeclarationDate"]
      self.DeclarationDateToken:str = obj["DeclarationDateToken"]
...
class Erp_Tablesets_TWARZeroRatedSalesListRptTableset:
   def __init__(self, obj):
      self.TWARZeroRatedSalesListRptParam:list[Erp_Tablesets_TWARZeroRatedSalesListRptParamRow] = obj["TWARZeroRatedSalesListRptParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TWARZeroRatedSalesListRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TWARZeroRatedSalesListRptTableset] = obj["returnObj"]
      pass
...
class OnChangeOfReportPeriod_input:
   """ Required : 
   fiscalYear
   fiscalYearSuffix
   reportPeriod
...
class OnChangeOfReportPeriod_output:
   def __init__(self, obj):
      pass
