...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetLabelReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetLabelReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.AssetLabelReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetLabelReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.AssetLabelReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_AssetLabelParamRow:
   def __init__(self, obj):
      self.StatusNew:bool = obj["StatusNew"]
      """  Status New  """  
      self.StatusInactive:bool = obj["StatusInactive"]
      """  Status Inactive  """  
      self.StatusDisposed:bool = obj["StatusDisposed"]
      """  Status Disposed  """  
      self.StatusActive:bool = obj["StatusActive"]
      """  Status Active  """  
      self.AcqFromDate:str = obj["AcqFromDate"]
      """  Acquired From Date  """  
      self.AcqFromDateToken:str = obj["AcqFromDateToken"]
      """  Acquired From Date Token  """  
      self.AcqToDate:str = obj["AcqToDate"]
      """  Acquired To Date  """  
      self.AcqToDateToken:str = obj["AcqToDateToken"]
      """  Acquired To Date Token  """  
      self.IncludeChild:bool = obj["IncludeChild"]
      """  IncludeChild  """  
      ...
      """  Warehouse List  """  
      self.LocIDList:str = obj["LocIDList"]
      """  LocID List  """  
...
class Erp_Tablesets_AssetLabelReportTableset:
   def __init__(self, obj):
      self.AssetLabelParam:list[Erp_Tablesets_AssetLabelParamRow] = obj["AssetLabelParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_AssetLabelReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_AssetLabelReportTableset] = obj["returnObj"]
      pass
