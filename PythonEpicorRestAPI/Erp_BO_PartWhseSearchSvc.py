...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartWhseSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartWhseSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_PartWhseSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartWhseSearchSvc/PartWhseSearches",headers=creds) as resp:
           return await resp.json()

async def post_PartWhseSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PartWhseSearchSvc/PartWhseSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_PartWhseSearches_Company_PartNum_WarehouseCode(Company, PartNum, WarehouseCode, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartWhseSearchSvc/PartWhseSearches(" + Company + "," + PartNum + "," + WarehouseCode + ")",headers=creds) as resp:
           return await resp.json()

async def patch_PartWhseSearches_Company_PartNum_WarehouseCode(Company, PartNum, WarehouseCode, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PartWhseSearchSvc/PartWhseSearches(" + Company + "," + PartNum + "," + WarehouseCode + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_PartWhseSearches_Company_PartNum_WarehouseCode(Company, PartNum, WarehouseCode, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PartWhseSearchSvc/PartWhseSearches(" + Company + "," + PartNum + "," + WarehouseCode + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartWhseSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClausePartWhseSearch, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartWhseSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetListbyKBPlant(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PartWhseSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_WarehouseInCurPlant(requestBody, epicorHeaders = None):
   """  
...
class Erp_Tablesets_PartWhseSearchTableset:
   def __init__(self, obj):
      self.PartWhseSearch:list[Erp_Tablesets_PartWhseSearchRow] = obj["PartWhseSearch"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtPartWhseSearchTableset:
   def __init__(self, obj):
      self.PartWhseSearch:list[Erp_Tablesets_PartWhseSearchRow] = obj["PartWhseSearch"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PartWhseSearchTableset] = obj["returnObj"]
      pass
...
class GetListbyKBPlant_input:
   ...
   def __init__(self, obj):
      ...
      self.AbsolutePage:int = obj["AbsolutePage"]
      """  Absolute page.  """  
      self.CurKBPlant:str = obj["CurKBPlant"]
      """  Current KB Plant.  """  
      pass

class GetListbyKBPlant_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PartWhseSearchListTableset] = obj["returnObj"]
      pass
...
class GetNewPartWhseSearch_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PartWhseSearchTableset] = obj["ds"]
      self.partNum:str = obj["partNum"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtPartWhseSearchTableset] = obj["ds"]
...
class WarehouseInCurPlant_input:
   """ Required : 
   pcWarehouseCode
   """  
   def __init__(self, obj):
      self.pcWarehouseCode:str = obj["pcWarehouseCode"]
      pass

class WarehouseInCurPlant_output:
   def __init__(self, obj):
