...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PriorityDispatchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PriorityDispatchSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PriorityDispatchSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PriorityDispatchSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PriorityDispatchSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PriorityDispatchParamRow:
   def __init__(self, obj):
      self.Departments:str = obj["Departments"]
      self.MaxNoOpr:int = obj["MaxNoOpr"]
      """  Max No of Operations per Work Center  """  
      self.OprCutoffDate:str = obj["OprCutoffDate"]
      """  Operation Cutoff Date  """  
      self.NewPage:bool = obj["NewPage"]
      """  New Page Per Work Center  """  
      self.OprCutoffDateToken:str = obj["OprCutoffDateToken"]
      self.ResrceGrps:str = obj["ResrceGrps"]
      self.MtlStatus:bool = obj["MtlStatus"]
      self.SumDtl:bool = obj["SumDtl"]
      self.PrintLbrRptRes:bool = obj["PrintLbrRptRes"]
      self.ListAllSchedRes:bool = obj["ListAllSchedRes"]
      self.PrintTotals:bool = obj["PrintTotals"]
...
class Erp_Tablesets_PriorityDispatchTableset:
   def __init__(self, obj):
      self.PriorityDispatchParam:list[Erp_Tablesets_PriorityDispatchParamRow] = obj["PriorityDispatchParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PriorityDispatchTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PriorityDispatchTableset] = obj["returnObj"]
      pass
