...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLRefReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLRefReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetApplicationDefaults(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GLRefReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_OnChangeSegment(requestBody, epicorHeaders = None):
   """  
...
async def post_GetSortBy(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GLRefReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLRefReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_GLRefReportParamRow:
   def __init__(self, obj):
      self.FiscalYear:int = obj["FiscalYear"]
      self.FromPeriod:int = obj["FromPeriod"]
      self.ToPeriod:int = obj["ToPeriod"]
      self.StartAcct:str = obj["StartAcct"]
      self.ENDAcct:str = obj["ENDAcct"]
      self.refsSelected:str = obj["refsSelected"]
...
class Erp_Tablesets_GLRefReportTableset:
   def __init__(self, obj):
      self.GLRefReportParam:list[Erp_Tablesets_GLRefReportParamRow] = obj["GLRefReportParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GLRefReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLRefReportTableset] = obj["returnObj"]
      pass
...
class GetSortBy_output:
   ...
   def parameters(self, obj):
      self.SortByOption:str = obj["parameters"]
      pass
...
class OnChangeSegment_input:
   ...
   def __init__(self, obj):
      self.ipBookID:str = obj["ipBookID"]
      self.segment:str = obj["segment"]
      pass

class OnChangeSegment_output:
   def __init__(self, obj):
      pass
