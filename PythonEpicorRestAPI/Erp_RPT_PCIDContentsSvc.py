...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PCIDContentsSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PCIDContentsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_SubmitPrintLabels(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PCIDContentsSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_GetListOfReportStyles(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PCIDContentsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PCIDContentsSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PCIDContentsParamRow:
   def __init__(self, obj):
      self.InventoryStagedAll:str = obj["InventoryStagedAll"]
      self.PCIDsToPrint:str = obj["PCIDsToPrint"]
      self.IncludeEmpty:bool = obj["IncludeEmpty"]
      self.WhatToPrint:str = obj["WhatToPrint"]
      ...
      self.LabelsPrinterDesc:str = obj["LabelsPrinterDesc"]
      self.LabelsPrinter:str = obj["LabelsPrinter"]
      self.LabelsStyleList:str = obj["LabelsStyleList"]
      """  Delimited list of report styles for the GenPCID label  """  
      self.LabelsStyleNum:int = obj["LabelsStyleNum"]
      """  Report Style number for GenPCID Label  """  
      self.NumLabelsToPrint:int = obj["NumLabelsToPrint"]
      """  The number of labels to print  """  
      self.NewPagePerPCID:bool = obj["NewPagePerPCID"]
...
class Erp_Tablesets_PCIDContentsTableset:
   def __init__(self, obj):
      self.PCIDContentsParam:list[Erp_Tablesets_PCIDContentsParamRow] = obj["PCIDContentsParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PCIDContentsTableset] = obj["ds"]
      pass
...
class GetListOfReportStyles_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PCIDContentsTableset] = obj["returnObj"]
      pass
...
class SubmitPrintLabels_input:
   ...
   """  
   def __init__(self, obj):
      self.PCIDTypes:str = obj["PCIDTypes"]
      self.ipPCIDsToPrint:str = obj["ipPCIDsToPrint"]
...
class SubmitPrintLabels_output:
   def __init__(self, obj):
      pass
