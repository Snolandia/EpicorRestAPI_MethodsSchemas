...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.BankFundPostSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.BankFundPostSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_DelRecords(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.BankFundPostSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.BankFundPostSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class DelRecords_input:
   ...
   def __init__(self, obj):
      self.nTranNum:int = obj["nTranNum"]
      self.fromBank:str = obj["fromBank"]
      self.toBank:str = obj["toBank"]
      pass

class DelRecords_output:
   def __init__(self, obj):
      pass

class Erp_Tablesets_BankFundPostParamRow:
   def __init__(self, obj):
      self.ACTType:str = obj["ACTType"]
      self.GroupID:str = obj["GroupID"]
      self.TranDate:str = obj["TranDate"]
      self.SourceBank:str = obj["SourceBank"]
      self.TargetBank:str = obj["TargetBank"]
      self.TranNum:int = obj["TranNum"]
      self.IntendPost:bool = obj["IntendPost"]
      self.PELotNumber:str = obj["PELotNumber"]
      """  Peru CSF - Lot Number  """  
      self.PEOutputPath:str = obj["PEOutputPath"]
...
class Erp_Tablesets_BankFundPostTableset:
   def __init__(self, obj):
      self.BankFundPostParam:list[Erp_Tablesets_BankFundPostParamRow] = obj["BankFundPostParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_BankFundPostTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_BankFundPostTableset] = obj["returnObj"]
      pass
