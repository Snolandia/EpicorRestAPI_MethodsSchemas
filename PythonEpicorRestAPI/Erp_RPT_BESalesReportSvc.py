...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BESalesReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BESalesReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_OnChangeSalesReportID(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.BESalesReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BESalesReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.BESalesReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_BESalesReportParamRow:
   def __init__(self, obj):
      self.SalesReportID:str = obj["SalesReportID"]
      """  Sales Report ID  """  
      ...
      """  End Date  """  
      self.RptOutputLanguage:str = obj["RptOutputLanguage"]
      """  Report Language: Dutch, French and German  """  
      self.DspLimitAmount:int = obj["DspLimitAmount"]
...
class Erp_Tablesets_BESalesReportTableset:
   def __init__(self, obj):
      self.BESalesReportParam:list[Erp_Tablesets_BESalesReportParamRow] = obj["BESalesReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_BESalesReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_BESalesReportTableset] = obj["returnObj"]
      pass
...
class OnChangeSalesReportID_input:
   """ Required : 
   proposedSalesReportID
   ds
   """  
   def __init__(self, obj):
      self.proposedSalesReportID:str = obj["proposedSalesReportID"]
      """  The proposed Sales Report ID  """  
      self.ds:list[Erp_Tablesets_BESalesReportTableset] = obj["ds"]
      pass

class OnChangeSalesReportID_output:
   def __init__(self, obj):
      pass
