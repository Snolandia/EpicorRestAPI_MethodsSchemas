...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TOPackSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TOPackSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_PackNumDefaults(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TOPackSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_ValidateReportStyle(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TOPackSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TOPackSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_TOPackParamRow:
   def __init__(self, obj):
...
class Erp_Tablesets_TOPackTableset:
   def __init__(self, obj):
      self.TOPackParam:list[Erp_Tablesets_TOPackParamRow] = obj["TOPackParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TOPackTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TOPackTableset] = obj["returnObj"]
      pass
...
class ValidateReportStyle_input:
   """ Required : 
   reportStyleID
   """  
   def __init__(self, obj):
...
class ValidateReportStyle_output:
   def __init__(self, obj):
      pass
