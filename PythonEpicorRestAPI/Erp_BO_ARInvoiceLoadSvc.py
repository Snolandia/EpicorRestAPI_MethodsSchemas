...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ARInvoiceLoadSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ARInvoiceLoadSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_ARInvoiceLoads(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ARInvoiceLoadSvc/ARInvoiceLoads",headers=creds) as resp:
           return await resp.json()

async def post_ARInvoiceLoads(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ARInvoiceLoadSvc/ARInvoiceLoads", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_ARInvoiceLoads_Company_InvoiceNum(Company, InvoiceNum, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ARInvoiceLoadSvc/ARInvoiceLoads(" + Company + "," + InvoiceNum + ")",headers=creds) as resp:
           return await resp.json()

async def patch_ARInvoiceLoads_Company_InvoiceNum(Company, InvoiceNum, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.ARInvoiceLoadSvc/ARInvoiceLoads(" + Company + "," + InvoiceNum + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_ARInvoiceLoads_Company_InvoiceNum(Company, InvoiceNum, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.ARInvoiceLoadSvc/ARInvoiceLoads(" + Company + "," + InvoiceNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ARInvoiceLoadSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseARInvoiceLoad, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ARInvoiceLoadSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_AnotherInvoice(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ARInvoiceLoadSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_GetCurrencyBase(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ARInvoiceLoadSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def post_GetTotals(epicorHeaders = None):
   """  
...
async def post_OnChangeofCreditMemo(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangeofDispInvoiceBal(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangeofDocDispInvoiceBal(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangeofDocInvoiceBal(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangeofFiscalPeriod(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangeofFiscalYear(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangeofInvoiceBal(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangeofTaxRegionCode(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangingofTax(requestBody, epicorHeaders = None):
   """  
...
async def post_CheckforPostInvoices(requestBody, epicorHeaders = None):
   """  
...
async def post_CheckBeforePosting(epicorHeaders = None):
   """  
...
async def post_GetNewARInvoiceLoad(requestBody, epicorHeaders = None):
   """  
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_ARInvoiceLoadListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_ARInvoiceLoadListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_ARInvoiceLoadRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_ARInvoiceLoadRow] = obj["value"]
      pass

class Erp_Tablesets_ARInvoiceLoadListRow:
   def __init__(self, obj):
...
Export Bill Type  """  
      ...
      """  Customer ID  """  
      self.BaseInvBal:int = obj["BaseInvBal"]
      ...
      self.CurrencyRateType:str = obj["CurrencyRateType"]
      """  Currency rate type  (ex: USD > GBP)  """  
      self.CurrencyCodeSymbol:str = obj["CurrencyCodeSymbol"]
      """  Currency code symbol  """  
      self.TempInvoiceBal:int = obj["TempInvoiceBal"]
      """  store invoice balance for after update.  """  
      self.TempDocInvoiceBal:int = obj["TempDocInvoiceBal"]
      """  Temporary doc invoice balance for after update.  """  
      self.UseLegalNumbers:bool = obj["UseLegalNumbers"]
      """  flag for use of legal numbers  """  
      self.DocCurrencyCodeSymbol:str = obj["DocCurrencyCodeSymbol"]
...
class Erp_Tablesets_ARInvoiceLoadRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.OpenInvoice:bool = obj["OpenInvoice"]
...
# Custom Schemas:
#########################################################################
class AnotherInvoice_input:
   """ Required : 
   PriorCustNum
   """  
   def __init__(self, obj):
      self.PriorCustNum:int = obj["PriorCustNum"]
      """  Customer number  """  
      pass

class AnotherInvoice_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ARInvoiceLoadTableset] = obj["returnObj"]
      pass

class CheckBeforePosting_output:
   def __init__(self, obj):
      pass

class CheckforPostInvoices_input:
   """ Required : 
   OktoPost
   """  
   def __init__(self, obj):
      self.OktoPost:int = obj["OktoPost"]
      pass

class CheckforPostInvoices_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.OktoPost:int = obj["parameters"]
      pass
...
class Erp_Tablesets_ARInvoiceLoadListTableset:
   def __init__(self, obj):
      self.ARInvoiceLoadList:list[Erp_Tablesets_ARInvoiceLoadListRow] = obj["ARInvoiceLoadList"]
...
class Erp_Tablesets_ARInvoiceLoadTableset:
   def __init__(self, obj):
      self.ARInvoiceLoad:list[Erp_Tablesets_ARInvoiceLoadRow] = obj["ARInvoiceLoad"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtARInvoiceLoadTableset:
   def __init__(self, obj):
      self.ARInvoiceLoad:list[Erp_Tablesets_ARInvoiceLoadRow] = obj["ARInvoiceLoad"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ARInvoiceLoadListTableset] = obj["returnObj"]
      pass
...
class GetNewARInvoiceLoad_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ARInvoiceLoadTableset] = obj["ds"]
      pass

class GetNewARInvoiceLoad_output:
   def __init__(self, obj):
      pass
...
class GetRows_input:
   """ Required : 
   whereClauseARInvoiceLoad
   pageSize
   absolutePage
   """  
   def __init__(self, obj):
      self.whereClauseARInvoiceLoad:str = obj["whereClauseARInvoiceLoad"]
      self.pageSize:int = obj["pageSize"]
      self.absolutePage:int = obj["absolutePage"]
      pass
...
class GetTotals_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.TotInvoiceAmt:int = obj["parameters"]
      self.CurrSymbol:str = obj["parameters"]
      pass
...
class OnChangeofCreditMemo_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class OnChangeofCreditMemo_output:
   def __init__(self, obj):
      pass
...
class OnChangeofDispInvoiceBal_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class OnChangeofDispInvoiceBal_output:
   def __init__(self, obj):
      pass
...
class OnChangeofDocDispInvoiceBal_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class OnChangeofDocDispInvoiceBal_output:
   def __init__(self, obj):
      pass
...
class OnChangeofDocInvoiceBal_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class OnChangeofDocInvoiceBal_output:
   def __init__(self, obj):
      pass
...
class OnChangeofFiscalPeriod_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class OnChangeofFiscalPeriod_output:
   def __init__(self, obj):
      pass
...
class OnChangeofFiscalYear_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class OnChangeofFiscalYear_output:
   def __init__(self, obj):
      pass
...
class OnChangeofInvoiceBal_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class OnChangeofInvoiceBal_output:
   def __init__(self, obj):
      pass
...
class OnChangeofTaxRegionCode_input:
   """ Required : 
   taxRegionCode
   ds
   """  
...
class OnChangeofTaxRegionCode_output:
   def __init__(self, obj):
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtARInvoiceLoadTableset] = obj["ds"]
