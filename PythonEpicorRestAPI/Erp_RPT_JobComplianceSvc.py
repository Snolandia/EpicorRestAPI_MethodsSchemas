...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobComplianceSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobComplianceSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobComplianceSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.JobComplianceSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.JobComplianceSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_JobComplianceParamRow:
   def __init__(self, obj):
      self.Jobs:str = obj["Jobs"]
      """  Job List  """  
      self.Restrictions:str = obj["Restrictions"]
      """  Restriction List  """  
      self.Assemblies:bool = obj["Assemblies"]
      """  Include Assemblies  """  
      self.Materials:bool = obj["Materials"]
      """  Include Materials  """  
      self.Operations:bool = obj["Operations"]
      self.Substances:bool = obj["Substances"]
...
class Erp_Tablesets_JobComplianceTableset:
   def __init__(self, obj):
      self.JobComplianceParam:list[Erp_Tablesets_JobComplianceParamRow] = obj["JobComplianceParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_JobComplianceTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_JobComplianceTableset] = obj["returnObj"]
      pass
