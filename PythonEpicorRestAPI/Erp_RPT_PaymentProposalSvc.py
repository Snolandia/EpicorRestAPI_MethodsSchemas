...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PaymentProposalSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PaymentProposalSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_OnChangeUseDisc(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PaymentProposalSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PaymentProposalSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PaymentProposalSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PaymentProposalRow:
   def __init__(self, obj):
      self.DueDate:str = obj["DueDate"]
      self.UseDisc:bool = obj["UseDisc"]
      self.IncludeOnHold:bool = obj["IncludeOnHold"]
      self.SupGroupList:str = obj["SupGroupList"]
      self.PayMethodList:str = obj["PayMethodList"]
      self.ExcludeZeroDiscounts:bool = obj["ExcludeZeroDiscounts"]
...
class Erp_Tablesets_PaymentProposalTableset:
   def __init__(self, obj):
      self.PaymentProposal:list[Erp_Tablesets_PaymentProposalRow] = obj["PaymentProposal"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PaymentProposalTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PaymentProposalTableset] = obj["returnObj"]
      pass
