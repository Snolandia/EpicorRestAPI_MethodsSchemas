...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.COLocJrnRecSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.COLocJrnRecSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetJournalNumList(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.COLocJrnRecSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.COLocJrnRecSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.COLocJrnRecSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_COLocJrnRecParamRow:
   def __init__(self, obj):
      ...
      """  End Fiscal Period  """  
      self.FilterByGroupID:bool = obj["FilterByGroupID"]
      """  Filter By GroupID  """  
      ...
      """  Journal Code  """  
      self.JrnCodeList:str = obj["JrnCodeList"]
      """  Journal Code List  """  
...
class Erp_Tablesets_COLocJrnRecTableset:
   def __init__(self, obj):
      self.COLocJrnRecParam:list[Erp_Tablesets_COLocJrnRecParamRow] = obj["COLocJrnRecParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_COLocJrnRecTableset] = obj["ds"]
      pass
...
class GetJournalNumList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.getJrnlNumList:str = obj["parameters"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_COLocJrnRecTableset] = obj["returnObj"]
      pass
