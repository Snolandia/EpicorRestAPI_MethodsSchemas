...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WorkerCompReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WorkerCompReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_Check_Rights(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WorkerCompReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetWorkersCompCodes(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WorkerCompReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WorkerCompReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_WorkerCompParamRow:
   def __init__(self, obj):
      ...
      self.WorkersCompList:str = obj["WorkersCompList"]
...
class Erp_Tablesets_WorkerCompReportTableset:
   def __init__(self, obj):
      self.WorkerCompParam:list[Erp_Tablesets_WorkerCompParamRow] = obj["WorkerCompParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_WorkerCompReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_WorkerCompReportTableset] = obj["returnObj"]
      pass
...
class GetWorkersCompCodes_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.WorkersCompList:str = obj["parameters"]
      pass
