...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ARInvoicePostSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ARInvoicePostSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_checkPeruTaxes(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ARInvoicePostSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_checkSystemSetup(epicorHeaders = None):
   """  
...
async def post_glInterface(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ARInvoicePostSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ARInvoicePostSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ARInvoicePostParamRow:
...
class Erp_Tablesets_ARInvoicePostTableset:
   def __init__(self, obj):
      self.ARInvoicePostParam:list[Erp_Tablesets_ARInvoicePostParamRow] = obj["ARInvoicePostParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ARInvoicePostTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ARInvoicePostTableset] = obj["returnObj"]
      pass
...
class checkPeruTaxes_output:
   def __init__(self, obj):
      pass

class checkSystemSetup_output:
   def __init__(self, obj):
      pass

class glInterface_output:
   def __init__(self, obj):
      pass
