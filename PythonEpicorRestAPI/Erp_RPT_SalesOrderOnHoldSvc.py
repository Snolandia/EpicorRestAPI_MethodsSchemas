...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderOnHoldSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderOnHoldSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderOnHoldSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderOnHoldSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderOnHoldSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SalesOrderOnHoldParamRow:
   def __init__(self, obj):
      self.CustNumList:str = obj["CustNumList"]
      """  Delimited list of Cust Numbers to print the report for  """  
      self.DaysSinceLastAuth:int = obj["DaysSinceLastAuth"]
      ...
      self.OrderNumList:str = obj["OrderNumList"]
...
class Erp_Tablesets_SalesOrderOnHoldTableset:
   def __init__(self, obj):
      self.SalesOrderOnHoldParam:list[Erp_Tablesets_SalesOrderOnHoldParamRow] = obj["SalesOrderOnHoldParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SalesOrderOnHoldTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SalesOrderOnHoldTableset] = obj["returnObj"]
      pass
