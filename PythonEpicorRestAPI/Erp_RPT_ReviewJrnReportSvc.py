...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
<param name="ipBookID">Book ID</param><param name="opCOACode">COA Code for book</param><param name="opBookDescription"> book description</param>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
<remarks> Notes:  special condition - where All Selected needs a list constructed in this case.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetACTTypesList(epicorHeaders = None):
   """  
...
async def post_GetGLBooksList(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_ReviewJrnReportParamRow:
   def __init__(self, obj):
      self.BookID:str = obj["BookID"]
      self.StartDate:str = obj["StartDate"]
      self.DCDUser:str = obj["DCDUser"]
      self.EndDate:str = obj["EndDate"]
      self.JournalEntryNum:int = obj["JournalEntryNum"]
      self.GLAccount:str = obj["GLAccount"]
      self.GLAcctDebCr:str = obj["GLAcctDebCr"]
      ...
      self.GLAccountDisp:str = obj["GLAccountDisp"]
      ...
      self.ErrorOption:str = obj["ErrorOption"]
...
class Erp_Tablesets_ReviewJrnReportTableset:
   def __init__(self, obj):
      self.ReviewJrnReportParam:list[Erp_Tablesets_ReviewJrnReportParamRow] = obj["ReviewJrnReportParam"]
      self.ReportStyle:list[Erp_Tablesets_ReportStyleRow] = obj["ReportStyle"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class GetACTTypesList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.ACTTypesList:str = obj["parameters"]
      pass
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ReviewJrnReportTableset] = obj["ds"]
      pass
...
class GetGLBooksList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.GLBooksList:str = obj["parameters"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ReviewJrnReportTableset] = obj["returnObj"]
      pass
