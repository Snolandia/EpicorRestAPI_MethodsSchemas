...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetPeriodOrDate(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetTranType(epicorHeaders = None):
   """  
...
async def post_GetWarning_ByDateRange(requestBody, epicorHeaders = None):
   """  
...
REFERENCED WHEN 'ByPeriodOrDate = "DT"
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetWarning_ByFiscalPeriod(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_IntraStatGenericParamRow:
   def __init__(self, obj):
      self.FiscalYear:int = obj["FiscalYear"]
      self.Period:int = obj["Period"]
      self.TranType:str = obj["TranType"]
      self.RoundWeights:bool = obj["RoundWeights"]
      self.RoundAmounts:bool = obj["RoundAmounts"]
      self.ByPeriodOrDate:str = obj["ByPeriodOrDate"]
      self.StartDate:str = obj["StartDate"]
      self.EndDate:str = obj["EndDate"]
      self.StartDateToken:str = obj["StartDateToken"]
      self.EndDateToken:str = obj["EndDateToken"]
      self.FiscalYearToken:str = obj["FiscalYearToken"]
      self.PeriodToken:str = obj["PeriodToken"]
...
class Erp_Tablesets_IntraStatGenericTableset:
   def __init__(self, obj):
      self.IntraStatGenericParam:list[Erp_Tablesets_IntraStatGenericParamRow] = obj["IntraStatGenericParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_IntraStatGenericTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_IntraStatGenericTableset] = obj["returnObj"]
      pass
...
class GetPeriodOrDate_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.PeriodOrDateCode:str = obj["parameters"]
      pass
...
class GetTranType_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.TranTypes:str = obj["parameters"]
      pass

      """  output parameters  """  

class GetWarning_ByDateRange_input:
   """ Required : 
   DateFrom
   DateTo
   """  
...
class GetWarning_ByDateRange_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.WarningOut:bool = obj["WarningOut"]
      self.WarningMess:str = obj["parameters"]
      pass

      """  output parameters  """  

class GetWarning_ByFiscalPeriod_input:
   """ Required : 
   PeriodIn
   FiscalYearIn
   """  
   def __init__(self, obj):
      self.PeriodIn:int = obj["PeriodIn"]
      self.FiscalYearIn:int = obj["FiscalYearIn"]
      pass

class GetWarning_ByFiscalPeriod_output:
   def __init__(self, obj):
      pass
