...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.IMPartBinSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.IMPartBinSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_AckPartBin(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.IMPartBinSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_CountPartBin(requestBody, epicorHeaders = None):
   """  
...
async def post_GetAllPartBin(requestBody, epicorHeaders = None):
   """  
...
async def post_GetPartBin(requestBody, epicorHeaders = None):
   """  
...
class AckPartBin_input:
   ...
   def __init__(self, obj):
      self.ts:list[Erp_Tablesets_IMPartBinTableset] = obj["ts"]
...
class Erp_Tablesets_IMPartBinRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
...
class Erp_Tablesets_IMPartBinTableset:
   def __init__(self, obj):
      self.IntQueInOut:list[Erp_Tablesets_IntQueInOutRow] = obj["IntQueInOut"]
      self.IMPartBin:list[Erp_Tablesets_IMPartBinRow] = obj["IMPartBin"]
...
class GetAllPartBin_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_IMPartBinTableset] = obj["returnObj"]
      pass
