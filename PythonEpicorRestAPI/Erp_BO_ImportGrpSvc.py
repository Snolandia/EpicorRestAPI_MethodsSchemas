...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ImportGrpSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ImportGrpSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_ImportGrps(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ImportGrpSvc/ImportGrps",headers=creds) as resp:
           return await resp.json()

async def post_ImportGrps(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ImportGrpSvc/ImportGrps", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_ImportGrps_Company_ImportID(Company, ImportID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ImportGrpSvc/ImportGrps(" + Company + "," + ImportID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_ImportGrps_Company_ImportID(Company, ImportID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.ImportGrpSvc/ImportGrps(" + Company + "," + ImportID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_ImportGrps_Company_ImportID(Company, ImportID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.ImportGrpSvc/ImportGrps(" + Company + "," + ImportID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ImportGrpSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseImportGrp, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ImportGrpSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetCodeDescList(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ImportGrpSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_ImportGrpTableset:
   def __init__(self, obj):
      self.ImportGrp:list[Erp_Tablesets_ImportGrpRow] = obj["ImportGrp"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtImportGrpTableset:
   def __init__(self, obj):
      self.ImportGrp:list[Erp_Tablesets_ImportGrpRow] = obj["ImportGrp"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ImportGrpTableset] = obj["returnObj"]
      pass
...
class GetNewImportGrp_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ImportGrpTableset] = obj["ds"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtImportGrpTableset] = obj["ds"]
