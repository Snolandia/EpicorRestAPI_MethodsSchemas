...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ResourceSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ResourceSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_Resources(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ResourceSvc/Resources",headers=creds) as resp:
           return await resp.json()
...
async def post_Resources(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ResourceSvc/Resources", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_Resources_Company_ResourceID(Company, ResourceID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ResourceSvc/Resources(" + Company + "," + ResourceID + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_Resources_Company_ResourceID(Company, ResourceID, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.ResourceSvc/Resources(" + Company + "," + ResourceID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_Resources_Company_ResourceID(Company, ResourceID, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.ResourceSvc/Resources(" + Company + "," + ResourceID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ResourceSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseResource, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ResourceSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_ChangedCharacteristicAttrClassID(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ResourceSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_QueueClearExternalMES(requestBody, epicorHeaders = None):
   """  
...
async def post_QueueClearExternalMESResSchedulingBoard(requestBody, epicorHeaders = None):
   """  
...
async def post_GetResourcesExtMES(requestBody, epicorHeaders = None):
   """  
...
class ChangedCharacteristicAttrClassID_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ResourceTableset] = obj["ds"]
      pass
...
class EnterpriseGetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ResourceListTableset] = obj["returnObj"]
      pass
...
class Erp_Tablesets_ResourceListTableset:
   def __init__(self, obj):
...
class Erp_Tablesets_ResourceTableset:
   def __init__(self, obj):
      self.Resource:list[Erp_Tablesets_ResourceRow] = obj["Resource"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtResourceTableset:
   def __init__(self, obj):
      self.Resource:list[Erp_Tablesets_ResourceRow] = obj["Resource"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ResourceTableset] = obj["returnObj"]
      pass
...
class GetResourcesExtMES_input:
   """ Required : 
   whereClause
   pageSize
   absolutePage
...
class GetResourcesExtMES_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ResourceListTableset] = obj["returnObj"]
      pass
...
class QueueClearExternalMESResSchedulingBoard_input:
   """ Required : 
   ipResourceID
   ipResourceGrpID
   """  
...
class QueueClearExternalMESResSchedulingBoard_output:
   def __init__(self, obj):
      pass

class QueueClearExternalMES_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ResourceListTableset] = obj["ds"]
      pass

class QueueClearExternalMES_output:
   def __init__(self, obj):
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtResourceTableset] = obj["ds"]
