...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_OnChangeTaxReportID(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_ExportTaxDeclReport(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_BEVATTaxDeclReportParamRow:
   def __init__(self, obj):
      self.TaxReportID:str = obj["TaxReportID"]
      """  VAT Tax Report ID  """  
      ...
      self.AskPayment:bool = obj["AskPayment"]
      """  Demand Payment  """  
      self.Restitution:bool = obj["Restitution"]
      """  Demand Restitution  """  
      self.ClientListing:bool = obj["ClientListing"]
      """  Add Customer List  """  
      self.Comment:str = obj["Comment"]
      """  Declaration Comment  """  
      self.DeclLanguage:str = obj["DeclLanguage"]
...
class Erp_Tablesets_BEVATTaxDeclReportTableset:
   def __init__(self, obj):
      self.BEVATTaxDeclReportParam:list[Erp_Tablesets_BEVATTaxDeclReportParamRow] = obj["BEVATTaxDeclReportParam"]
...
class ExportTaxDeclReport_input:
   """ Required : 
   ds
   ipFileFile
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_BEVATTaxDeclReportTableset] = obj["ds"]
      self.ipFileFile:str = obj["ipFileFile"]
      """  File Name  """  
      pass

class ExportTaxDeclReport_output:
   def __init__(self, obj):
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_BEVATTaxDeclReportTableset] = obj["returnObj"]
      pass
...
class OnChangeTaxReportID_input:
   """ Required : 
   proposedTaxReportID
   ds
   """  
   def __init__(self, obj):
      self.proposedTaxReportID:str = obj["proposedTaxReportID"]
      """  The proposed TaxReportID  """  
      self.ds:list[Erp_Tablesets_BEVATTaxDeclReportTableset] = obj["ds"]
      pass

class OnChangeTaxReportID_output:
   def __init__(self, obj):
      pass
