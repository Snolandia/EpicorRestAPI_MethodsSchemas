...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ECCUOMAndCustomerE10Svc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ECCUOMAndCustomerE10Svc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ECCUOMAndCustomerE10Svc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ECCUOMAndCustomerE10Svc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ECCUOMAndCustomerE10ParamRow:
   def __init__(self, obj):
      self.LogFilename:str = obj["LogFilename"]
      """  Log Filename  """  
      self.ConvertPartUOM:bool = obj["ConvertPartUOM"]
      """  yes/no  """  
      self.ConvertCustomer:bool = obj["ConvertCustomer"]
      """  Convert Customer  """  
...
class Erp_Tablesets_ECCUOMAndCustomerE10Tableset:
   def __init__(self, obj):
      self.ECCUOMAndCustomerE10Param:list[Erp_Tablesets_ECCUOMAndCustomerE10ParamRow] = obj["ECCUOMAndCustomerE10Param"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ECCUOMAndCustomerE10Tableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ECCUOMAndCustomerE10Tableset] = obj["returnObj"]
      pass
