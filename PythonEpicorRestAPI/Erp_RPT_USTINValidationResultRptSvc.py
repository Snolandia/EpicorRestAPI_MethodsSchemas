...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.USTINValidationResultRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.USTINValidationResultRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetParamsByReportID(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.USTINValidationResultRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.USTINValidationResultRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.USTINValidationResultRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_USTINValidationResultRptParamRow:
   def __init__(self, obj):
      self.Description:str = obj["Description"]
      self.TINValidationResultID:str = obj["TINValidationResultID"]
      self.IncludeDuplicated:bool = obj["IncludeDuplicated"]
      self.IncludeInvalid:bool = obj["IncludeInvalid"]
      self.IncludeMatched:bool = obj["IncludeMatched"]
      self.IncludeNotFound:bool = obj["IncludeNotFound"]
      self.SysRowID:str = obj["SysRowID"]
...
class Erp_Tablesets_USTINValidationResultRptTableset:
   def __init__(self, obj):
      self.USTINValidationResultRptParam:list[Erp_Tablesets_USTINValidationResultRptParamRow] = obj["USTINValidationResultRptParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_USTINValidationResultRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_USTINValidationResultRptTableset] = obj["returnObj"]
      pass
...
class GetParamsByReportID_input:
   """ Required : 
...
class GetParamsByReportID_output:
   def __init__(self, obj):
      pass
