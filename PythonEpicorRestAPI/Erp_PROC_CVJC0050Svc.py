...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetTransactions(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GlobalSecurityCheck(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetLaborSeqLists(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CVJC0050ParamRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      self.CompName:str = obj["CompName"]
      self.ConvDesc:str = obj["ConvDesc"]
      self.ConvID:str = obj["ConvID"]
      self.EmpID:str = obj["EmpID"]
      self.EmpName:str = obj["EmpName"]
      self.LaborDtlSeqList:str = obj["LaborDtlSeqList"]
      self.LaborHedSeqList:str = obj["LaborHedSeqList"]
...
class Erp_Tablesets_CVJC0050Tableset:
   def __init__(self, obj):
      self.CVJC0050Param:list[Erp_Tablesets_CVJC0050ParamRow] = obj["CVJC0050Param"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_CVJC0050TranTableset:
   def __init__(self, obj):
      self.CVJCLaborDtl:list[Erp_Tablesets_CVJCLaborDtlRow] = obj["CVJCLaborDtl"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_CVJCLaborDtlRow:
   def __init__(self, obj):
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CVJC0050Tableset] = obj["ds"]
      pass
...
class GetLaborSeqLists_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CVJC0050TranTableset] = obj["ds"]
      pass

class GetLaborSeqLists_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.laborHedSeqList:str = obj["parameters"]
      self.laborDtlSeqList:str = obj["parameters"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CVJC0050Tableset] = obj["returnObj"]
      pass
...
class GetTransactions_input:
   ...
   def __init__(self, obj):
      ...
      self.employee:str = obj["employee"]
      """  The Employee Number to process  """  
      pass

class GetTransactions_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CVJC0050TranTableset] = obj["returnObj"]
      pass

class GlobalSecurityCheck_output:
   def __init__(self, obj):
      self.returnObj:bool = obj["returnObj"]
      pass
