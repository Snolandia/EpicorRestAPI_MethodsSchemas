...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CNGTIStatusReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CNGTIStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CNGTIStatusReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CNGTIStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CNGTIStatusReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CNGTIStatusReportParamRow:
   def __init__(self, obj):
      self.CNGTICustomerList:str = obj["CNGTICustomerList"]
      self.CNGTIInvoiceList:str = obj["CNGTIInvoiceList"]
      self.CNGTIFromDate:str = obj["CNGTIFromDate"]
      self.CNGTIToDate:str = obj["CNGTIToDate"]
      self.CNGTIStatus0:bool = obj["CNGTIStatus0"]
      self.CNGTIStatus1:bool = obj["CNGTIStatus1"]
      self.CNGTIStatus2:bool = obj["CNGTIStatus2"]
      self.CNGTIFromDateToken:str = obj["CNGTIFromDateToken"]
      self.CNGTIToDateToken:str = obj["CNGTIToDateToken"]
      self.CNGTIIncludeCreditMemos:bool = obj["CNGTIIncludeCreditMemos"]
...
class Erp_Tablesets_CNGTIStatusReportTableset:
   def __init__(self, obj):
      self.CNGTIStatusReportParam:list[Erp_Tablesets_CNGTIStatusReportParamRow] = obj["CNGTIStatusReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CNGTIStatusReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CNGTIStatusReportTableset] = obj["returnObj"]
      pass
