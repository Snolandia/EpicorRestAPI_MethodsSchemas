...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AssetDepreciationSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AssetDepreciationSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_UnpostedDisposalsExist(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.AssetDepreciationSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AssetDepreciationSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_AssetDepreciationRow:
   def __init__(self, obj):
      self.AssetList:str = obj["AssetList"]
      self.AssetRegList:str = obj["AssetRegList"]
      self.CalculateOption:str = obj["CalculateOption"]
      self.ClassList:str = obj["ClassList"]
      self.DepMethodList:str = obj["DepMethodList"]
      self.GroupList:str = obj["GroupList"]
      self.IncChildAsset:bool = obj["IncChildAsset"]
      self.IncAutoRecalc:bool = obj["IncAutoRecalc"]
...
class Erp_Tablesets_AssetDepreciationTableset:
   def __init__(self, obj):
      self.AssetDepreciation:list[Erp_Tablesets_AssetDepreciationRow] = obj["AssetDepreciation"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_AssetDepreciationTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_AssetDepreciationTableset] = obj["returnObj"]
      pass
...
class UnpostedDisposalsExist_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class UnpostedDisposalsExist_output:
   def __init__(self, obj):
      self.returnObj:bool = obj["returnObj"]
