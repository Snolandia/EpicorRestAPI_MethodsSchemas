...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BTGenPCIDSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BTGenPCIDSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_SetPrintParams(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.BTGenPCIDSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_SubmitReport(requestBody, epicorHeaders = None):
   """  
...
async def post_GetDefaultLabelPrinter(requestBody, epicorHeaders = None):
   """  
...
async def post_GetDefaultPrintContentsLabelParams(requestBody, epicorHeaders = None):
   """  
...
async def post_GetDefaultPrintParams(requestBody, epicorHeaders = None):
   """  
...
async def post_GetDefaultsAndPrint(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BTGenPCIDSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.BTGenPCIDSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_BTGenPCIDParamRow:
   def __init__(self, obj):
      self.PCID:str = obj["PCID"]
      """  PCID parameter  """  
      self.DefaultStyleNum:int = obj["DefaultStyleNum"]
...
class Erp_Tablesets_BTGenPCIDTableset:
   def __init__(self, obj):
      self.BTGenPCIDParam:list[Erp_Tablesets_BTGenPCIDParamRow] = obj["BTGenPCIDParam"]
...
class GetDefaultLabelPrinter_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_BTGenPCIDTableset] = obj["ds"]
      pass

class GetDefaultLabelPrinter_output:
   def __init__(self, obj):
      pass
...
class GetDefaultPrintContentsLabelParams_input:
   """ Required : 
   warehouseCode
   ds
   """  
...
class GetDefaultPrintContentsLabelParams_output:
   def __init__(self, obj):
      pass
...
class GetDefaultPrintParams_input:
   """ Required : 
   ds
   partNum
   orderNum
...
class GetDefaultPrintParams_output:
   def __init__(self, obj):
      pass
...
class GetDefaultsAndPrint_input:
   """ Required : 
   printContents
   warehouseCode
   pcid
   ...
   """  
   def __init__(self, obj):
      self.printContents:bool = obj["printContents"]
      ...
      self.printerID:str = obj["printerID"]
      """  Printer ID  """  
      self.sendDefaults:bool = obj["sendDefaults"]
...
class GetDefaultsAndPrint_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.ds:list[Erp_Tablesets_BTGenPCIDTableset] = obj["ds"]
      self.launchGenPCID:bool = obj["launchGenPCID"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_BTGenPCIDTableset] = obj["returnObj"]
      pass
...
class SubmitReport_input:
   ...
   def __init__(self, obj):
      ...
      self.ipPrinter:str = obj["ipPrinter"]
      self.ipTxFlag:str = obj["ipTxFlag"]
      self.ipTxType:str = obj["ipTxType"]
      self.ipAgentID:str = obj["ipAgentID"]
      self.ipAgentSchedNum:int = obj["ipAgentSchedNum"]
      self.ipAgentTaskNum:int = obj["ipAgentTaskNum"]
      self.ipNumLabels:int = obj["ipNumLabels"]
      self.ipStyleNum:int = obj["ipStyleNum"]
      self.ipReportProgram:str = obj["ipReportProgram"]
      pass

class SubmitReport_output:
   def __init__(self, obj):
      pass
...
class ValidatePrinter_input:
   ...
   """  
   def __init__(self, obj):
      self.iPrinterID:str = obj["iPrinterID"]
...
class ValidatePrinter_output:
   ...
   def parameters(self, obj):
      self.opPrinterID:str = obj["parameters"]
      pass
