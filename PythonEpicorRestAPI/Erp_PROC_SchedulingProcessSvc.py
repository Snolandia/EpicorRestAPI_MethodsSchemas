...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SchedulingProcessSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SchedulingProcessSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_lastRunDate(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.SchedulingProcessSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SchedulingProcessSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_SchedulingProcessRow:
   def __init__(self, obj):
      ...
      self.WhatIfScheduleOnly:bool = obj["WhatIfScheduleOnly"]
...
class Erp_Tablesets_SchedulingProcessTableset:
   def __init__(self, obj):
      self.SchedulingProcess:list[Erp_Tablesets_SchedulingProcessRow] = obj["SchedulingProcess"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SchedulingProcessTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SchedulingProcessTableset] = obj["returnObj"]
      pass
