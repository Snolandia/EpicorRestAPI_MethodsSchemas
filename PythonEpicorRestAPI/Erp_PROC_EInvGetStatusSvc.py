...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.EInvGetStatusSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.EInvGetStatusSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetInvoiceParams(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.EInvGetStatusSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.EInvGetStatusSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_EInvGetStatusParamRow:
...
class Erp_Tablesets_EInvGetStatusTableset:
   def __init__(self, obj):
      self.EInvGetStatusParam:list[Erp_Tablesets_EInvGetStatusParamRow] = obj["EInvGetStatusParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_EInvGetStatusTableset] = obj["ds"]
      pass
...
class GetInvoiceParams_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_EInvGetStatusTableset] = obj["returnObj"]
      pass
