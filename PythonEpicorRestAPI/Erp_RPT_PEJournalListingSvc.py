...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PEJournalListingSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PEJournalListingSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PEJournalListingSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_CheckRights(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PEJournalListingSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetExternalCompany(epicorHeaders = None):
   """  
...
async def post_GetReportOptionList(epicorHeaders = None):
   """  
...
async def post_ExcludePR(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PEJournalListingSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class CheckRights_output:
   def __init__(self, obj):
      pass

class Erp_Tablesets_JournalListingParamRow:
   def __init__(self, obj):
      ...
      self.MultiCompanyOnly:bool = obj["MultiCompanyOnly"]
      self.ExtCompanyID:str = obj["ExtCompanyID"]
      self.ShowExtCompDtls:bool = obj["ShowExtCompDtls"]
      self.BookID:str = obj["BookID"]
      """  Book ID  """  
      self.FiscalYearSuffix:str = obj["FiscalYearSuffix"]
      self.FromJrnlNum:int = obj["FromJrnlNum"]
      """   From Journal Num              
Colombia field  """  
      self.ToJrnNum:int = obj["ToJrnNum"]
      """   To Journal Num                
Colombia field  """  
      self.COPrintBase:bool = obj["COPrintBase"]
      """  Colombia Field to print base report  """  
      self.GroupBy:str = obj["GroupBy"]
      self.FiscalCalendarID:str = obj["FiscalCalendarID"]
      self.PrintSelCriteria:bool = obj["PrintSelCriteria"]
      self.ShowStatUOM:bool = obj["ShowStatUOM"]
      self.ShowAdditionalDesc:bool = obj["ShowAdditionalDesc"]
...
class Erp_Tablesets_JournalListingTableset:
   def __init__(self, obj):
      self.JournalListingParam:list[Erp_Tablesets_JournalListingParamRow] = obj["JournalListingParam"]
...
class ExcludePR_input:
   """ Required : 
   IP_JrnlCode
   """  
   def __init__(self, obj):
      self.IP_JrnlCode:str = obj["IP_JrnlCode"]
      """  'IP_JrnlCode' codes  """  
      pass

class ExcludePR_output:
   def __init__(self, obj):
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_JournalListingTableset] = obj["ds"]
      pass
...
class GetExternalCompany_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.ExtCompanyList:str = obj["parameters"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_JournalListingTableset] = obj["returnObj"]
      pass
...
class GetReportOptionList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.ReportOptionList:str = obj["parameters"]
      pass
