...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SubstShipCustomerSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SubstShipCustomerSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
This is to give the UI a visual on the values for the SortByOption.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SubstShipCustomerSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SubstShipCustomerSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SubstShipCustomerSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SubstShipCustParamRow:
   def __init__(self, obj):
      self.CustNumList:str = obj["CustNumList"]
      self.IncludeExempt:bool = obj["IncludeExempt"]
      self.IncludeManual:bool = obj["IncludeManual"]
      self.RestrictionTypeIDList:str = obj["RestrictionTypeIDList"]
      self.ShipEndDate:str = obj["ShipEndDate"]
      self.ShipEndDateToken:str = obj["ShipEndDateToken"]
      self.ShipStartDate:str = obj["ShipStartDate"]
      self.ShipStartDateToken:str = obj["ShipStartDateToken"]
      self.SortBy:str = obj["SortBy"]
      self.SummarizeWeight:bool = obj["SummarizeWeight"]
...
class Erp_Tablesets_SubstShipCustomerTableset:
   def __init__(self, obj):
      self.SubstShipCustParam:list[Erp_Tablesets_SubstShipCustParamRow] = obj["SubstShipCustParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SubstShipCustomerTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SubstShipCustomerTableset] = obj["returnObj"]
      pass
