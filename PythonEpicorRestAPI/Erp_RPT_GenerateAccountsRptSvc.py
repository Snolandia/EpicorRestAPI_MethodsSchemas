...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GenerateAccountsRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GenerateAccountsRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GenerateAccountsRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GenerateAccountsRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GenerateAccountsRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_GenerateAccountsRptParamRow:
   def __init__(self, obj):
      self.COACode:str = obj["COACode"]
      self.GenerationMode:int = obj["GenerationMode"]
      self.OverrideMode:int = obj["OverrideMode"]
      self.SegParam1:str = obj["SegParam1"]
      self.SegParam2:str = obj["SegParam2"]
      self.SegParam3:str = obj["SegParam3"]
      self.SegParam4:str = obj["SegParam4"]
      self.SegParam5:str = obj["SegParam5"]
      self.SegParam6:str = obj["SegParam6"]
      self.SegParam7:str = obj["SegParam7"]
      self.SegParam8:str = obj["SegParam8"]
      self.SegParam9:str = obj["SegParam9"]
      self.SegParam10:str = obj["SegParam10"]
      self.SegParam11:str = obj["SegParam11"]
      self.SegParam12:str = obj["SegParam12"]
      self.SegParam13:str = obj["SegParam13"]
      self.SegParam14:str = obj["SegParam14"]
      self.SegParam15:str = obj["SegParam15"]
      self.SegParam16:str = obj["SegParam16"]
      self.SegParam17:str = obj["SegParam17"]
      self.SegParam18:str = obj["SegParam18"]
      self.SegParam19:str = obj["SegParam19"]
      self.SegParam20:str = obj["SegParam20"]
      self.COADesc:str = obj["COADesc"]
...
class Erp_Tablesets_GenerateAccountsRptTableset:
   def __init__(self, obj):
      self.GenerateAccountsRptParam:list[Erp_Tablesets_GenerateAccountsRptParamRow] = obj["GenerateAccountsRptParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GenerateAccountsRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GenerateAccountsRptTableset] = obj["returnObj"]
      pass
