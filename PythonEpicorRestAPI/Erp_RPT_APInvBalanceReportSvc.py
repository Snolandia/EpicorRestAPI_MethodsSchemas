...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetDateOfPeriod(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetCOA(requestBody, epicorHeaders = None):
   """  
...
async def post_ClearGLAccount(requestBody, epicorHeaders = None):
   """  
...
async def post_IsCOADifferent(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangedIncludeGLAcct(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class ChangedIncludeGLAcct_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_APInvBalanceReportTableset] = obj["ds"]
      pass

class ChangedIncludeGLAcct_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_APInvBalanceParamRow:
   def __init__(self, obj):
      self.BeginDate:str = obj["BeginDate"]
      self.EndDate:str = obj["EndDate"]
      self.AcctBalInDebit:bool = obj["AcctBalInDebit"]
      self.VendList:str = obj["VendList"]
      self.VendGroupList:str = obj["VendGroupList"]
      ...
      self.BeginDateToken:str = obj["BeginDateToken"]
      self.EndDateToken:str = obj["EndDateToken"]
      self.SortBy:str = obj["SortBy"]
      self.IncludeDebitMemos:bool = obj["IncludeDebitMemos"]
      self.Book:str = obj["Book"]
      self.IncludeGLAcct:bool = obj["IncludeGLAcct"]
      self.Range:str = obj["Range"]
      self.PayInstOption:str = obj["PayInstOption"]
      ...
      self.IsSummary:bool = obj["IsSummary"]
      self.GLAccountList:str = obj["GLAccountList"]
      self.IncludePrePayments:bool = obj["IncludePrePayments"]
      self.IncludeLI:bool = obj["IncludeLI"]
      """  Include Logged Invoices. Only Logged Invoices with Posted = true, void = false and matched = true. Will be displayed.  """  
      self.OneTimeList:str = obj["OneTimeList"]
      """  Colombia Loc Field  """  
      self.COSortBy:str = obj["COSortBy"]
      """  Sort By option for Columbia  """  
      self.PrintSelCriteria:bool = obj["PrintSelCriteria"]
      """  Print Selection Criteria  """  
      self.IsPECorrection:bool = obj["IsPECorrection"]
      self.VendIDList:str = obj["VendIDList"]
      self.SortByAvailID:str = obj["SortByAvailID"]
      self.SortByDesc:str = obj["SortByDesc"]
      self.SortByAvailDesc:str = obj["SortByAvailDesc"]
...
class Erp_Tablesets_APInvBalanceReportTableset:
   def __init__(self, obj):
      self.APInvBalanceParam:list[Erp_Tablesets_APInvBalanceParamRow] = obj["APInvBalanceParam"]
...
class GetCOA_output:
   ...
   def parameters(self, obj):
      self.outCOA:str = obj["parameters"]
      pass
...
class GetDateOfPeriod_input:
   ...
   """  
   def __init__(self, obj):
      self.inYear:int = obj["inYear"]
      self.inYearSuffix:str = obj["inYearSuffix"]
      self.inPeriod:int = obj["inPeriod"]
      self.inBookID:str = obj["inBookID"]
      self.inStartOrEnd:str = obj["inStartOrEnd"]
      pass
...
class GetDateOfPeriod_output:
   ...
   def parameters(self, obj):
      self.outDate:str = obj["parameters"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_APInvBalanceReportTableset] = obj["returnObj"]
      pass
...
class IsCOADifferent_input:
   """ Required : 
   prevBookID
   currBookID
   """  
   def __init__(self, obj):
      self.prevBookID:str = obj["prevBookID"]
      """  Previous BookID  """  
      self.currBookID:str = obj["currBookID"]
      """  Selected BookID  """  
      pass

class IsCOADifferent_output:
   def __init__(self, obj):
      self.returnObj:bool = obj["returnObj"]
      pass
