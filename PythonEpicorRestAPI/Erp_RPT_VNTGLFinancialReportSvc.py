...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.VNTGLFinancialReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.VNTGLFinancialReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_ChangeBookID(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.VNTGLFinancialReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_GetDataComboReportTemplate(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.VNTGLFinancialReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.VNTGLFinancialReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class ChangeBookID_input:
   ...
   def __init__(self, obj):
      ...
      """  Book ID  """  
      self.ds:list[Erp_Tablesets_VNTGLFinancialReportTableset] = obj["ds"]
      pass
...
class ChangeFiscalPer_input:
   ...
   def __init__(self, obj):
      ...
      """  Fiscal YearSuffix  """  
      self.iStartFiscalPeriod:int = obj["iStartFiscalPeriod"]
      """  StartFiscalPeriod  """  
      self.iEndFiscalPeriod:int = obj["iEndFiscalPeriod"]
      """  EndFiscalPeriod  """  
      self.ds:list[Erp_Tablesets_VNTGLFinancialReportTableset] = obj["ds"]
      pass
...
class ChangeGLReportID_input:
   ...
   """  
   def __init__(self, obj):
      self.iReportID:str = obj["iReportID"]
      """  ReportID  """  
      self.ds:list[Erp_Tablesets_VNTGLFinancialReportTableset] = obj["ds"]
      pass
...
class Erp_Tablesets_VNTGLFinancialReportParamRow:
   def __init__(self, obj):
      ...
      self.ReportTemplate:str = obj["ReportTemplate"]
...
class Erp_Tablesets_VNTGLFinancialReportTableset:
   def __init__(self, obj):
      self.VNTGLFinancialReportParam:list[Erp_Tablesets_VNTGLFinancialReportParamRow] = obj["VNTGLFinancialReportParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_VNTGLFinancialReportTableset] = obj["returnObj"]
      pass
