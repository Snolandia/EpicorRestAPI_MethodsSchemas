...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BomListingReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BomListingReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetReportFormat(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.BomListingReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BomListingReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.BomListingReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_BomListingParamRow:
   def __init__(self, obj):
      ...
      self.RevList:str = obj["RevList"]
      """  Rev list  """  
      self.EffDateList:str = obj["EffDateList"]
      self.ProdQtyList:str = obj["ProdQtyList"]
      self.CostComparisions:bool = obj["CostComparisions"]
      self.AltMethodList:str = obj["AltMethodList"]
      self.IncludeRefDes:bool = obj["IncludeRefDes"]
      """  IncludeRefDes  """  
...
class Erp_Tablesets_BomListingReportTableset:
   def __init__(self, obj):
      self.BomListingParam:list[Erp_Tablesets_BomListingParamRow] = obj["BomListingParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_BomListingReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_BomListingReportTableset] = obj["returnObj"]
      pass
