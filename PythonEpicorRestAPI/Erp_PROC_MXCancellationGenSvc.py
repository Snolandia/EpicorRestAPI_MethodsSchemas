...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXCancellationGenSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXCancellationGenSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXCancellationGenSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.MXCancellationGenSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MXCancellationGenParamRow:
   def __init__(self, obj):
      self.DspDocument:str = obj["DspDocument"]
      """  Reverse Document  """  
      self.DspReverseDocument:str = obj["DspReverseDocument"]
      """  DspReverseDocument  """  
      ...
      self.ReverseGroupID:str = obj["ReverseGroupID"]
      """  Reverse Cash Receipt GroupID  """  
      self.ReverseHeadNum:int = obj["ReverseHeadNum"]
...
class Erp_Tablesets_MXCancellationGenTableset:
   def __init__(self, obj):
      self.MXCancellationGenParam:list[Erp_Tablesets_MXCancellationGenParamRow] = obj["MXCancellationGenParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MXCancellationGenTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MXCancellationGenTableset] = obj["returnObj"]
      pass
