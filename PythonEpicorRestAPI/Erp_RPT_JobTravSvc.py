...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobTravSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobTravSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_ChangeJobNum(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.JobTravSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetSOExists(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobTravSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.JobTravSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class ChangeJobNum_input:
   ...
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_JobTravTableset] = obj["ds"]
      pass
...
class Erp_Tablesets_JobTravParamRow:
   def __init__(self, obj):
      self.PrntAllMassPrnt:bool = obj["PrntAllMassPrnt"]
      self.Jobs:str = obj["Jobs"]
      self.Assembly:str = obj["Assembly"]
      self.SubAssem:bool = obj["SubAssem"]
      self.NewPgPerAsm:bool = obj["NewPgPerAsm"]
      self.OprDates:bool = obj["OprDates"]
      self.OprStd:bool = obj["OprStd"]
      self.BarCodes:bool = obj["BarCodes"]
      self.ShpSchd:bool = obj["ShpSchd"]
      self.PrintSchedResources:bool = obj["PrintSchedResources"]
      self.PrintSchedResrcDesc:bool = obj["PrintSchedResrcDesc"]
      self.OpInstructions:bool = obj["OpInstructions"]
      self.PrintAttributes:bool = obj["PrintAttributes"]
      """  Flag to indicate if Attributes sets will be printed in the report.  """  
      self.DisableShpSchd:bool = obj["DisableShpSchd"]
...
class Erp_Tablesets_JobTravTableset:
   def __init__(self, obj):
      self.JobTravParam:list[Erp_Tablesets_JobTravParamRow] = obj["JobTravParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_JobTravTableset] = obj["returnObj"]
      pass
...
class GetSOExists_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.soExists:str = obj["parameters"]
      pass
