...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetPartClassList(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetPartTypeList(epicorHeaders = None):
   """  
...
async def post_GetStockTypeList(epicorHeaders = None):
   """  
...
async def post_GetContractByID(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_TimePhaseMatReqmtParamRow:
   def __init__(self, obj):
      self.OnlyPartNum:str = obj["OnlyPartNum"]
      """  Part Number  """  
      self.PartTypes:str = obj["PartTypes"]
      """  Part Types  """  
      self.StockTypes:str = obj["StockTypes"]
      """  Stock Types  """  
      self.PartClasses:str = obj["PartClasses"]
      """  Part Class List  """  
      self.ProjBalCutOff:str = obj["ProjBalCutOff"]
      """  Project Balance Cut Off Date  """  
      self.DoSecondPass:bool = obj["DoSecondPass"]
      """  Exceptions Only  """  
      self.OrderByDate:str = obj["OrderByDate"]
      """  Order By Date  """  
      self.BelowReOrder:bool = obj["BelowReOrder"]
      """  Below Re-Order toggle  """  
      self.BelowMinimum:bool = obj["BelowMinimum"]
      """  Below Minimum  """  
      self.BelowSafety:bool = obj["BelowSafety"]
      """  Below Safety  """  
      self.BelowZero:bool = obj["BelowZero"]
      """  Below Zero  """  
      self.OverMaximum:bool = obj["OverMaximum"]
      """  Over Maximum  """  
      self.Suggestions:bool = obj["Suggestions"]
      """  Include Suggestions  """  
      self.ProjBalCutOffToken:str = obj["ProjBalCutOffToken"]
      self.OrderByDateToken:str = obj["OrderByDateToken"]
      self.TFSuggestions:bool = obj["TFSuggestions"]
      ...
      self.PlanningContract:bool = obj["PlanningContract"]
      self.PrintZeroOnHandQtyIfNoExpection:bool = obj["PrintZeroOnHandQtyIfNoExpection"]
...
class Erp_Tablesets_TimePhaseMatReqmtTableset:
   def __init__(self, obj):
      self.TimePhaseMatReqmtParam:list[Erp_Tablesets_TimePhaseMatReqmtParamRow] = obj["TimePhaseMatReqmtParam"]
...
class GetContractByID_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TimePhaseMatReqmtTableset] = obj["ds"]
      self.contractID:str = obj["contractID"]
      """  ContractID changed  """  
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TimePhaseMatReqmtTableset] = obj["returnObj"]
      pass
...
class GetPartClassList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.PartClassList:str = obj["parameters"]
      pass

      """  output parameters  """  

class GetPartTypeList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.PartTypeList:str = obj["parameters"]
      pass
...
class GetStockTypeList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.StockTypeList:str = obj["parameters"]
      pass
