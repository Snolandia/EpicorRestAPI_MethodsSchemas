...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ImportRevisionSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ImportRevisionSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ImportRevisionSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ImportRevisionSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ImportRevisionParamRow:
   def __init__(self, obj):
      self.CompaniesList:str = obj["CompaniesList"]
      """  tList of companies.  """  
      self.DelAllPrevRevs:bool = obj["DelAllPrevRevs"]
      self.ManualSelectionBooks:bool = obj["ManualSelectionBooks"]
      self.ACTTypeRevisionsInfoXML:str = obj["ACTTypeRevisionsInfoXML"]
      """  Xml representation of ACTType Revisions dataset.  """  
      self.MappingDataXML:str = obj["MappingDataXML"]
...
class Erp_Tablesets_ImportRevisionTableset:
   def __init__(self, obj):
      self.ImportRevisionParam:list[Erp_Tablesets_ImportRevisionParamRow] = obj["ImportRevisionParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ImportRevisionTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ImportRevisionTableset] = obj["returnObj"]
      pass
