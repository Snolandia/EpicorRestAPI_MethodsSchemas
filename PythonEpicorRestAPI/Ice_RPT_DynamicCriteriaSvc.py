...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetNewDynamicCriteriaReportParam(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_TransformDynamicCriteria(requestBody, epicorHeaders = None):
   """  
...
async def post_LoadCriteriaFromXml(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class GetDefaults_input:
   ...
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_DynamicCriteriaTableset] = obj["ds"]
      pass
...
class GetNewDynamicCriteriaReportParam_input:
   """ Required : 
   reportID
   """  
   def __init__(self, obj):
...
class GetNewDynamicCriteriaReportParam_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_DynamicCriteriaTableset] = obj["returnObj"]
      pass
...
class Ice_Tablesets_DynamicCriteriaParamRow:
   def __init__(self, obj):
      self.ReportID:str = obj["ReportID"]
      """  Report ID  """  
...
class Ice_Tablesets_DynamicCriteriaTableset:
   def __init__(self, obj):
      self.DynamicCriteriaParam:list[Ice_Tablesets_DynamicCriteriaParamRow] = obj["DynamicCriteriaParam"]
...
class LoadCriteriaFromXml_input:
   """ Required : 
   xml
   """  
   def __init__(self, obj):
...
class LoadCriteriaFromXml_output:
   def __init__(self, obj):
...
class TransformDynamicCriteria_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class TransformDynamicCriteria_output:
   def __init__(self, obj):
      self.returnObj      #schema had no properties on an object.
      pass
