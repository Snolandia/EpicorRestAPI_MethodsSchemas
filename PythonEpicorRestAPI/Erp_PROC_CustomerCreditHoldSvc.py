...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CustomerCreditHoldSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CustomerCreditHoldSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CustomerCreditHoldSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CustomerCreditHoldSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CustomerCreditHoldParamRow:
   def __init__(self, obj):
      ...
      """  Log file name.  """  
      self.TermsCodeList:str = obj["TermsCodeList"]
      """  Terms code filter.  """  
      self.IncludeAgingCreditHold:bool = obj["IncludeAgingCreditHold"]
      """  Include Aging Credit Hold Checking  """  
      self.IncludeCreditHold:bool = obj["IncludeCreditHold"]
...
class Erp_Tablesets_CustomerCreditHoldTableset:
   def __init__(self, obj):
      self.CustomerCreditHoldParam:list[Erp_Tablesets_CustomerCreditHoldParamRow] = obj["CustomerCreditHoldParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CustomerCreditHoldTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CustomerCreditHoldTableset] = obj["returnObj"]
      pass
