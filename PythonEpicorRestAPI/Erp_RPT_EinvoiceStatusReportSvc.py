...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.EinvoiceStatusReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.EinvoiceStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.EinvoiceStatusReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.EinvoiceStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.EinvoiceStatusReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_EinvoiceStatusReportParamRow:
   def __init__(self, obj):
      self.RangeBy:str = obj["RangeBy"]
      """  Ranging by order  """  
      ...
      """  To date token  """  
      self.ErrorMessage:bool = obj["ErrorMessage"]
      ...
      """  Customers list  """  
      self.CustomerGroupList:str = obj["CustomerGroupList"]
...
class Erp_Tablesets_EinvoiceStatusReportTableset:
   def __init__(self, obj):
      self.EinvoiceStatusReportParam:list[Erp_Tablesets_EinvoiceStatusReportParamRow] = obj["EinvoiceStatusReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_EinvoiceStatusReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_EinvoiceStatusReportTableset] = obj["returnObj"]
      pass
