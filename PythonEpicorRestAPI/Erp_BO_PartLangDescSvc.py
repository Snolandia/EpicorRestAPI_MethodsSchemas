...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartLangDescSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartLangDescSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_PartLangDescs(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartLangDescSvc/PartLangDescs",headers=creds) as resp:
           return await resp.json()
...
async def post_PartLangDescs(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PartLangDescSvc/PartLangDescs", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_PartLangDescs_Company_PartNum_LangNameID(Company, PartNum, LangNameID, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartLangDescSvc/PartLangDescs(" + Company + "," + PartNum + "," + LangNameID + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_PartLangDescs_Company_PartNum_LangNameID(Company, PartNum, LangNameID, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PartLangDescSvc/PartLangDescs(" + Company + "," + PartNum + "," + LangNameID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_PartLangDescs_Company_PartNum_LangNameID(Company, PartNum, LangNameID, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PartLangDescSvc/PartLangDescs(" + Company + "," + PartNum + "," + LangNameID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartLangDescSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClausePartLangDesc, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartLangDescSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(partNum, langNameID, epicorHeaders = None):
   """  
...
async def post_GetNewPartLangDesc(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PartLangDescSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PartLangDescListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PartLangDescListRow] = obj["value"]
      pass
...
class Erp_Tablesets_PartLangDescListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_PartLangDescListTableset:
   def __init__(self, obj):
      self.PartLangDescList:list[Erp_Tablesets_PartLangDescListRow] = obj["PartLangDescList"]
...
class Erp_Tablesets_PartLangDescTableset:
   def __init__(self, obj):
      self.PartLangDesc:list[Erp_Tablesets_PartLangDescRow] = obj["PartLangDesc"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtPartLangDescTableset:
   def __init__(self, obj):
      self.PartLangDesc:list[Erp_Tablesets_PartLangDescRow] = obj["PartLangDesc"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PartLangDescTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PartLangDescListTableset] = obj["returnObj"]
      pass
...
class GetNewPartLangDesc_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PartLangDescTableset] = obj["ds"]
      self.partNum:str = obj["partNum"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtPartLangDescTableset] = obj["ds"]
