...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PlantCostIDUpdateSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PlantCostIDUpdateSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ChangeNewPlantCostID(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.PlantCostIDUpdateSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
values will need to be updated, do they wish to continue with this change.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.PlantCostIDUpdateSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PlantCostIDUpdateSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class ChangeNewPlantCostID_input:
   """ Required : 
   NewPlantCostID
   ds
   """  
   def __init__(self, obj):
      self.NewPlantCostID:str = obj["NewPlantCostID"]
      """  Proposed PlantCostID field  """  
      self.ds:list[Erp_Tablesets_PlantCostIDUpdateTableset] = obj["ds"]
      pass

class ChangeNewPlantCostID_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_PlantCostIDUpdateRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      self.Plant:str = obj["Plant"]
      self.PlantCostID:str = obj["PlantCostID"]
      self.NewPlantCostID:str = obj["NewPlantCostID"]
      self.NewPlantCostDesc:str = obj["NewPlantCostDesc"]
      self.ReasonCode:str = obj["ReasonCode"]
      self.ReasonCodeDesc:str = obj["ReasonCodeDesc"]
      self.PlantCostDesc:str = obj["PlantCostDesc"]
...
class Erp_Tablesets_PlantCostIDUpdateTableset:
   def __init__(self, obj):
      self.PlantCostIDUpdate:list[Erp_Tablesets_PlantCostIDUpdateRow] = obj["PlantCostIDUpdate"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PlantCostIDUpdateTableset] = obj["returnObj"]
      pass
