...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_ReverseCashReceipts(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/ReverseCashReceipts",headers=creds) as resp:
           return await resp.json()

async def post_ReverseCashReceipts(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/ReverseCashReceipts", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_ReverseCashReceipts_Company_GroupID_HeadNum(Company, GroupID, HeadNum, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/ReverseCashReceipts(" + Company + "," + GroupID + "," + HeadNum + ")",headers=creds) as resp:
           return await resp.json()

async def patch_ReverseCashReceipts_Company_GroupID_HeadNum(Company, GroupID, HeadNum, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/ReverseCashReceipts(" + Company + "," + GroupID + "," + HeadNum + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_ReverseCashReceipts_Company_GroupID_HeadNum(Company, GroupID, HeadNum, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/ReverseCashReceipts(" + Company + "," + GroupID + "," + HeadNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_LegalNumGenOpts(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/LegalNumGenOpts",headers=creds) as resp:
           return await resp.json()
...
async def post_LegalNumGenOpts(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/LegalNumGenOpts", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_LegalNumGenOpts_Company_LegalNumberID(Company, LegalNumberID, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/LegalNumGenOpts(" + Company + "," + LegalNumberID + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_LegalNumGenOpts_Company_LegalNumberID(Company, LegalNumberID, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/LegalNumGenOpts(" + Company + "," + LegalNumberID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_LegalNumGenOpts_Company_LegalNumberID(Company, LegalNumberID, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/LegalNumGenOpts(" + Company + "," + LegalNumberID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseCashHead, whereClauseLegalNumGenOpts, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_CheckDocumentIsLocked(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ReverseCashReceiptSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_IsAutoReversed(requestBody, epicorHeaders = None):
   """  
...
async def post_AutoReverseCashReceipt(requestBody, epicorHeaders = None):
   """  
...
async def post_ReverseCashReceiptWithDescription(requestBody, epicorHeaders = None):
   """  
...
async def post_GetListForBankRec(requestBody, epicorHeaders = None):
   """  
...
async def post_DeleteReversedDocs(requestBody, epicorHeaders = None):
   """  
...
async def post_HasCreditCardTransactions(requestBody, epicorHeaders = None):
   """  
...
# Custom Schemas:
#########################################################################
class AutoReverseCashReceipt_input:
   """ Required : 
   ds
   groupID
   headNum
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ReverseCashReceiptTableset] = obj["ds"]
      self.groupID:str = obj["groupID"]
      ...
      self.inTranDocTypeID:str = obj["inTranDocTypeID"]
...
class AutoReverseCashReceipt_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.ds:list[Erp_Tablesets_ReverseCashReceiptTableset] = obj["ds"]
      self.newHeadNum:int = obj["parameters"]
...
class DeleteReversedDocs_input:
   """ Required : 
   headNum
   ds
   """  
...
class DeleteReversedDocs_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_ReverseCashReceiptTableset:
   def __init__(self, obj):
...
class Erp_Tablesets_UpdExtReverseCashReceiptTableset:
   def __init__(self, obj):
      self.CashHead:list[Erp_Tablesets_CashHeadRow] = obj["CashHead"]
      self.LegalNumGenOpts:list[Erp_Tablesets_LegalNumGenOptsRow] = obj["LegalNumGenOpts"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ReverseCashReceiptTableset] = obj["returnObj"]
      pass
...
class GetListForBankRec_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CashHeadListTableset] = obj["returnObj"]
      pass
...
class HasCreditCardTransactions_input:
   """ Required : 
   headnum
   """  
   def __init__(self, obj):
...
class HasCreditCardTransactions_output:
   def __init__(self, obj):
...
class PreUpdate_input:
   ...
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ReverseCashReceiptTableset] = obj["ds"]
      self.inputDate:str = obj["inputDate"]
      """  The date of Cash Receipt Reverse  """  
      self.inTranDocType:str = obj["inTranDocType"]
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtReverseCashReceiptTableset] = obj["ds"]
...
class _ReverseCashReceiptWithDescription_input:
   """ Required : 
   ds
   groupID
   headNum
...
class _ReverseCashReceiptWithDescription_output:
   def __init__(self, obj):
      pass
...
class _ReverseCashReceipt_input:
   """ Required : 
   ds
   groupID
   headNum
...
class _ReverseCashReceipt_output:
   def __init__(self, obj):
      pass
