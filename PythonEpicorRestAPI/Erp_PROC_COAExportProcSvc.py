...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.COAExportProcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.COAExportProcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetServerTempPath(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.COAExportProcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_GetDefaultsAndApplicationDefaults(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.COAExportProcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_COAExportProcParamRow:
   def __init__(self, obj):
      ...
      self.ClientFileName:str = obj["ClientFileName"]
...
class Erp_Tablesets_COAExportProcTableset:
   def __init__(self, obj):
      self.COAExportProcParam:list[Erp_Tablesets_COAExportProcParamRow] = obj["COAExportProcParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_COAExportProcTableset] = obj["ds"]
      pass
...
class GetDefaultsAndApplicationDefaults_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class GetDefaultsAndApplicationDefaults_output:
   def __init__(self, obj):
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_COAExportProcTableset] = obj["returnObj"]
      pass
