...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COASegmentSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COASegmentSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_COASegmentSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COASegmentSearchSvc/COASegmentSearches",headers=creds) as resp:
           return await resp.json()

async def post_COASegmentSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.COASegmentSearchSvc/COASegmentSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_COASegmentSearches_Company_COACode_SegmentNbr(Company, COACode, SegmentNbr, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COASegmentSearchSvc/COASegmentSearches(" + Company + "," + COACode + "," + SegmentNbr + ")",headers=creds) as resp:
           return await resp.json()

async def patch_COASegmentSearches_Company_COACode_SegmentNbr(Company, COACode, SegmentNbr, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.COASegmentSearchSvc/COASegmentSearches(" + Company + "," + COACode + "," + SegmentNbr + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_COASegmentSearches_Company_COACode_SegmentNbr(Company, COACode, SegmentNbr, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.COASegmentSearchSvc/COASegmentSearches(" + Company + "," + COACode + "," + SegmentNbr + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COASegmentSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseCOASegmentSearch, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COASegmentSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewCOASegmentSearch(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.COASegmentSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_COASegmentSearchListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_COASegmentSearchListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_COASegmentSearchRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_COASegmentSearchRow] = obj["value"]
      pass

class Erp_Tablesets_COASegmentSearchListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_COASegmentSearchRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.COACode:str = obj["COACode"]
...
class Erp_Tablesets_COASegmentSearchListTableset:
   def __init__(self, obj):
      self.COASegmentSearchList:list[Erp_Tablesets_COASegmentSearchListRow] = obj["COASegmentSearchList"]
...
class Erp_Tablesets_COASegmentSearchTableset:
   def __init__(self, obj):
      self.COASegmentSearch:list[Erp_Tablesets_COASegmentSearchRow] = obj["COASegmentSearch"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtCOASegmentSearchTableset:
   def __init__(self, obj):
      self.COASegmentSearch:list[Erp_Tablesets_COASegmentSearchRow] = obj["COASegmentSearch"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_COASegmentSearchTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_COASegmentSearchListTableset] = obj["returnObj"]
      pass
...
class GetNewCOASegmentSearch_input:
   """ Required : 
   ds
   coACode
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_COASegmentSearchTableset] = obj["ds"]
      self.coACode:str = obj["coACode"]
      pass

class GetNewCOASegmentSearch_output:
   def __init__(self, obj):
      pass
...
class GetRows_input:
   """ Required : 
   whereClauseCOASegmentSearch
   pageSize
   absolutePage
   """  
   def __init__(self, obj):
      self.whereClauseCOASegmentSearch:str = obj["whereClauseCOASegmentSearch"]
      self.pageSize:int = obj["pageSize"]
      self.absolutePage:int = obj["absolutePage"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtCOASegmentSearchTableset] = obj["ds"]
