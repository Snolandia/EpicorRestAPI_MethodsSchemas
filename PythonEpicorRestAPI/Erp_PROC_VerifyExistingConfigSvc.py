...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.VerifyExistingConfigSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.VerifyExistingConfigSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.VerifyExistingConfigSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.VerifyExistingConfigSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_VerifyExistingConfigParamRow:
   def __init__(self, obj):
      self.PartsList:str = obj["PartsList"]
      """  List of Selected Parts  """  
      self.LogFileName:str = obj["LogFileName"]
      self.VerifyExistingQuotes:bool = obj["VerifyExistingQuotes"]
      self.VerifyExistingOrders:bool = obj["VerifyExistingOrders"]
      self.VerifyExistingJobs:bool = obj["VerifyExistingJobs"]
      self.UpdateSIValues:bool = obj["UpdateSIValues"]
...
class Erp_Tablesets_VerifyExistingConfigTableset:
   def __init__(self, obj):
      self.VerifyExistingConfigParam:list[Erp_Tablesets_VerifyExistingConfigParamRow] = obj["VerifyExistingConfigParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_VerifyExistingConfigTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_VerifyExistingConfigTableset] = obj["returnObj"]
      pass
