...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConvertPcInValuesSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConvertPcInValuesSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConvertPcInValuesSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ConvertPcInValuesSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ConvertPcInValuesParamRow:
   def __init__(self, obj):
      self.LogFileName:str = obj["LogFileName"]
      self.ConvertJobs:bool = obj["ConvertJobs"]
      self.ConvertSIValues:bool = obj["ConvertSIValues"]
      self.ConvertOrders:bool = obj["ConvertOrders"]
      self.ConvertQuotes:bool = obj["ConvertQuotes"]
      self.ConvertDemand:bool = obj["ConvertDemand"]
      self.ConvertPO:bool = obj["ConvertPO"]
      self.QuoteList:str = obj["QuoteList"]
      self.JobList:str = obj["JobList"]
      self.OrderList:str = obj["OrderList"]
      self.QuoteDateStart:str = obj["QuoteDateStart"]
      self.QuoteDateEnd:str = obj["QuoteDateEnd"]
      self.JobDateStart:str = obj["JobDateStart"]
      self.JobDateEnd:str = obj["JobDateEnd"]
      self.OrderDateStart:str = obj["OrderDateStart"]
      self.OrderDateEnd:str = obj["OrderDateEnd"]
      self.DemandDateStart:str = obj["DemandDateStart"]
      self.DemandDateEnd:str = obj["DemandDateEnd"]
      self.PODateStart:str = obj["PODateStart"]
      self.PODateEnd:str = obj["PODateEnd"]
      self.DemandList:str = obj["DemandList"]
      self.POList:str = obj["POList"]
      self.IncludeClosedTargets:bool = obj["IncludeClosedTargets"]
...
class Erp_Tablesets_ConvertPcInValuesTableset:
   def __init__(self, obj):
      self.ConvertPcInValuesParam:list[Erp_Tablesets_ConvertPcInValuesParamRow] = obj["ConvertPcInValuesParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ConvertPcInValuesTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ConvertPcInValuesTableset] = obj["returnObj"]
      pass
