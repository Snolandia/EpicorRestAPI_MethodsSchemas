...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_TFOrdDtlSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/TFOrdDtlSearches",headers=creds) as resp:
           return await resp.json()

async def post_TFOrdDtlSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/TFOrdDtlSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_TFOrdDtlSearches_Company_TFLineNum(Company, TFLineNum, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/TFOrdDtlSearches(" + Company + "," + TFLineNum + ")",headers=creds) as resp:
           return await resp.json()

async def patch_TFOrdDtlSearches_Company_TFLineNum(Company, TFLineNum, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/TFOrdDtlSearches(" + Company + "," + TFLineNum + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_TFOrdDtlSearches_Company_TFLineNum(Company, TFLineNum, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/TFOrdDtlSearches(" + Company + "," + TFLineNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseTFOrdDtl, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_CustomGetByID(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetOrdHedList(requestBody, epicorHeaders = None):
   """  
...
class CustomGetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TFOrdDtlSearchTableset] = obj["returnObj"]
      pass
...
class Erp_Tablesets_TFOrdDtlSearchTableset:
   def __init__(self, obj):
      self.TFOrdDtl:list[Erp_Tablesets_TFOrdDtlRow] = obj["TFOrdDtl"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtTFOrdDtlSearchTableset:
   def __init__(self, obj):
      self.TFOrdDtl:list[Erp_Tablesets_TFOrdDtlRow] = obj["TFOrdDtl"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetNewTFOrdDtl_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TFOrdDtlSearchTableset] = obj["ds"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtTFOrdDtlSearchTableset] = obj["ds"]
