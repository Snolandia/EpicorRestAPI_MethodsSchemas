...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.ScheduledFunctionSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.ScheduledFunctionSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_BuildParametersTable(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.PROC.ScheduledFunctionSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.ScheduledFunctionSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class BuildParametersTable_input:
   """ Required : 
   libraryID
   functionID
   """  
...
class BuildParametersTable_output:
   def __init__(self, obj):
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_ScheduledFunctionsTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_ScheduledFunctionsTableset] = obj["returnObj"]
      pass
...
class Ice_Tablesets_ScheduledFunctionParamRow:
   def __init__(self, obj):
      self.FunctionDescription:str = obj["FunctionDescription"]
      """  The EFx description  """  
      self.FunctionId:str = obj["FunctionId"]
      """  The EFx function identifier  """  
      self.LibraryDescription:str = obj["LibraryDescription"]
      """  The EFx library description  """  
      self.LibraryId:str = obj["LibraryId"]
      """  THe EFx library identifier  """  
      self.ParameterValues:str = obj["ParameterValues"]
...
class Ice_Tablesets_ScheduledFunctionsTableset:
   def __init__(self, obj):
      self.ScheduledFunctionParam:list[Ice_Tablesets_ScheduledFunctionParamRow] = obj["ScheduledFunctionParam"]
