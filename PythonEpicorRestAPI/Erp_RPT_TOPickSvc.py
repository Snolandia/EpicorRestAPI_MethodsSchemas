...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TOPickSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TOPickSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetPlantList(epicorHeaders = None):
   """  
...
<param name="ToList">To Plants List</param>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TOPickSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TOPickSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TOPickSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_TOPickParamRow:
   def __init__(self, obj):
      self.OrderNumbers:str = obj["OrderNumbers"]
      self.DispBarCodes:bool = obj["DispBarCodes"]
      self.SysRowID:str = obj["SysRowID"]
...
class Erp_Tablesets_TOPickTableset:
   def __init__(self, obj):
      self.TOPickParam:list[Erp_Tablesets_TOPickParamRow] = obj["TOPickParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TOPickTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TOPickTableset] = obj["returnObj"]
      pass
...
class GetPlantList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.ToList:str = obj["parameters"]
      pass
