...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.NonConfAnalReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.NonConfAnalReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetSortByList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.NonConfAnalReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.NonConfAnalReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.NonConfAnalReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_NonConfAnalReportRow:
   def __init__(self, obj):
      self.FromDt:str = obj["FromDt"]
      self.ToDt:str = obj["ToDt"]
      self.Parts:str = obj["Parts"]
      self.Employees:str = obj["Employees"]
      self.Machines:str = obj["Machines"]
      self.Operations:bool = obj["Operations"]
      self.InvIss:bool = obj["InvIss"]
      self.RMA:bool = obj["RMA"]
      self.PO:bool = obj["PO"]
      self.SubContOpr:bool = obj["SubContOpr"]
      self.PrtCmnts:bool = obj["PrtCmnts"]
      self.SortBy:str = obj["SortBy"]
      self.fAll:bool = obj["fAll"]
...
class Erp_Tablesets_NonConfAnalReportTableset:
   def __init__(self, obj):
      self.NonConfAnalReport:list[Erp_Tablesets_NonConfAnalReportRow] = obj["NonConfAnalReport"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_NonConfAnalReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_NonConfAnalReportTableset] = obj["returnObj"]
      pass
