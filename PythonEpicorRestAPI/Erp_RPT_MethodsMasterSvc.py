...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MethodsMasterSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MethodsMasterSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetReportFormat(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MethodsMasterSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MethodsMasterSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MethodsMasterSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MethodsMasterParamRow:
   def __init__(self, obj):
      self.ProductGroups:str = obj["ProductGroups"]
      ...
      self.PartListParts:str = obj["PartListParts"]
      """  Parts List Parts  """  
      self.PartListRevisions:str = obj["PartListRevisions"]
      """  Part List Revisions  """  
      self.PartListProdQtys:str = obj["PartListProdQtys"]
      """  Part List Production Quantities  """  
      self.PartListEffectiveDates:str = obj["PartListEffectiveDates"]
      """  Part List Effective Dates  """  
      self.EffectivityDateToken:str = obj["EffectivityDateToken"]
      self.PartListAltMethods:str = obj["PartListAltMethods"]
...
class Erp_Tablesets_MethodsMasterTableset:
   def __init__(self, obj):
      self.MethodsMasterParam:list[Erp_Tablesets_MethodsMasterParamRow] = obj["MethodsMasterParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MethodsMasterTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MethodsMasterTableset] = obj["returnObj"]
      pass
