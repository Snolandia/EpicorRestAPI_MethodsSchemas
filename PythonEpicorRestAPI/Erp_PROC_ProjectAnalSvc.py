...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ProjectAnalSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ProjectAnalSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_CheckAutoReGen(requestBody, epicorHeaders = None):
   """  
...
<param name="ipAsOfDate">ipAsOfDate.</param><param name="ipProjectID">ipProjectID.</param><param name="opDisable">opDisable.</param>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ProjectAnalSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ProjectAnalSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class CheckAutoReGen_input:
   ...
   def __init__(self, obj):
      ...
      self.opDisable:bool = obj["opDisable"]
      pass

class CheckAutoReGen_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_ProjAnalParamRow:
   def __init__(self, obj):
      self.ProjectList:str = obj["ProjectList"]
      self.SaveCopy:bool = obj["SaveCopy"]
      self.UpliftPrjRev:bool = obj["UpliftPrjRev"]
      ...
      self.RegenAnal:bool = obj["RegenAnal"]
      self.AutoReGen:bool = obj["AutoReGen"]
      self.LastRGDate:str = obj["LastRGDate"]
      self.BuildProjCommit:bool = obj["BuildProjCommit"]
      """  Indicates whether or not to generate the ProjectCommit records.  """  
      self.ShowCostsMakeFromJob:bool = obj["ShowCostsMakeFromJob"]
      """  Show Costs Make From Job  """  
      self.RegenEntireProject:bool = obj["RegenEntireProject"]
...
class Erp_Tablesets_ProjectAnalTableset:
   def __init__(self, obj):
      self.ProjAnalParam:list[Erp_Tablesets_ProjAnalParamRow] = obj["ProjAnalParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ProjectAnalTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ProjectAnalTableset] = obj["returnObj"]
      pass
