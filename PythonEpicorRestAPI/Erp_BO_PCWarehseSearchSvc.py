...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PCWarehseSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PCWarehseSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PCWarehseSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
on just one plant or leave blank to search on all plants.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PCWarehseSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PCWarehseSearchRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PCWarehseSearchRow] = obj["value"]
      pass

class Erp_Tablesets_PCWarehseSearchRow:
   def __init__(self, obj):
...
class Erp_Tablesets_PCWarehseSearchTableset:
   def __init__(self, obj):
      self.PCWarehseSearch:list[Erp_Tablesets_PCWarehseSearchRow] = obj["PCWarehseSearch"]
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PCWarehseSearchTableset] = obj["returnObj"]
      pass
