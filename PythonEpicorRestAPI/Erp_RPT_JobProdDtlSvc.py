...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobProdDtlSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobProdDtlSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_AllowPrintJobProfitability(epicorHeaders = None):
   """  
...
the option of printing job profitability to be defined
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.JobProdDtlSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SetPrintInventoryAttributes(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.JobProdDtlSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobProdDtlSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class AllowPrintJobProfitability_output:
   def __init__(self, obj):
      pass

class Erp_Tablesets_JobProdDtlParamRow:
   def __init__(self, obj):
      self.JobList:str = obj["JobList"]
      self.AsmList:str = obj["AsmList"]
      self.SummaryOnly:bool = obj["SummaryOnly"]
      self.Consolidate:bool = obj["Consolidate"]
      self.ByProdGroup:bool = obj["ByProdGroup"]
      self.MaterialTrans:bool = obj["MaterialTrans"]
      self.PrintBreakDown:bool = obj["PrintBreakDown"]
      self.LaborTrans:bool = obj["LaborTrans"]
      self.FirstArtTrans:bool = obj["FirstArtTrans"]
      self.PrintProfit:bool = obj["PrintProfit"]
      self.PrintSN:bool = obj["PrintSN"]
      self.AllowAsm:bool = obj["AllowAsm"]
      """  Allow Assemblies  """  
      self.AllowJobProfitability:bool = obj["AllowJobProfitability"]
      self.ExclMiscCharg:bool = obj["ExclMiscCharg"]
      """  Excluded miscellaneous charges.  """  
      self.PrintDowntime:bool = obj["PrintDowntime"]
...
class Erp_Tablesets_JobProdDtlTableset:
   def __init__(self, obj):
      self.JobProdDtlParam:list[Erp_Tablesets_JobProdDtlParamRow] = obj["JobProdDtlParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_JobProdDtlTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_JobProdDtlTableset] = obj["returnObj"]
      pass
