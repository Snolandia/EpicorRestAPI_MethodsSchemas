...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.IntrastatExportProcessSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.IntrastatExportProcessSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_PreValidateParam(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.IntrastatExportProcessSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_CorrelateProcParam(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.IntrastatExportProcessSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class CorrelateProcParam_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_IntrastatExportProcessTableset] = obj["ds"]
      pass

class CorrelateProcParam_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_IntrastatExportProcessParamRow:
   def __init__(self, obj):
      self.ReportID:str = obj["ReportID"]
      self.EFTHeadID:int = obj["EFTHeadID"]
      self.FileName:str = obj["FileName"]
      """  Path to export file.  """  
      self.FileName2:str = obj["FileName2"]
      """  Path to export file (used in UK for Despatch).  """  
      self.FileNameDisplay:str = obj["FileNameDisplay"]
      self.FileName2Display:str = obj["FileName2Display"]
...
class Erp_Tablesets_IntrastatExportProcessTableset:
   def __init__(self, obj):
      self.IntrastatExportProcessParam:list[Erp_Tablesets_IntrastatExportProcessParamRow] = obj["IntrastatExportProcessParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_IntrastatExportProcessTableset] = obj["returnObj"]
      pass
