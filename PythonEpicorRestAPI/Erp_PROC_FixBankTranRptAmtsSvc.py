...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.FixBankTranRptAmtsSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.FixBankTranRptAmtsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.FixBankTranRptAmtsSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.FixBankTranRptAmtsSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_FixBankTranRptAmtsParamRow:
   def __init__(self, obj):
      self.StartDate:str = obj["StartDate"]
      self.GroupPrefix:str = obj["GroupPrefix"]
      self.JournalCode:str = obj["JournalCode"]
      self.JournalDescription:str = obj["JournalDescription"]
...
class Erp_Tablesets_FixBankTranRptAmtsTableset:
   def __init__(self, obj):
      self.FixBankTranRptAmtsParam:list[Erp_Tablesets_FixBankTranRptAmtsParamRow] = obj["FixBankTranRptAmtsParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_FixBankTranRptAmtsTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_FixBankTranRptAmtsTableset] = obj["returnObj"]
      pass
