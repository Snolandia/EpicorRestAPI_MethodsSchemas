...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXCartaPorteGenSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXCartaPorteGenSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXCartaPorteGenSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.MXCartaPorteGenSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MXCartaPorteGenParamRow:
   def __init__(self, obj):
      self.PackNum:str = obj["PackNum"]
      self.PurPoint:str = obj["PurPoint"]
      self.VendorNum:int = obj["VendorNum"]
      self.ShipmentType:int = obj["ShipmentType"]
...
class Erp_Tablesets_MXCartaPorteGenTableset:
   def __init__(self, obj):
      self.MXCartaPorteGenParam:list[Erp_Tablesets_MXCartaPorteGenParamRow] = obj["MXCartaPorteGenParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MXCartaPorteGenTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MXCartaPorteGenTableset] = obj["returnObj"]
      pass
