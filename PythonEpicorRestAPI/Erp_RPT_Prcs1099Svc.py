...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.Prcs1099Svc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.Prcs1099Svc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetDateOfPeriod(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.Prcs1099Svc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_SetYearStartAndEndDates(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.Prcs1099Svc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.Prcs1099Svc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_Prcs1099ReportRow:
   def __init__(self, obj):
      self.MinAmt:int = obj["MinAmt"]
      ...
      self.IncludeSettledPI:bool = obj["IncludeSettledPI"]
...
class Erp_Tablesets_Prcs1099Tableset:
   def __init__(self, obj):
      self.Prcs1099Report:list[Erp_Tablesets_Prcs1099ReportRow] = obj["Prcs1099Report"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_Prcs1099Tableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_Prcs1099Tableset] = obj["returnObj"]
      pass
...
class SetYearStartAndEndDates_input:
   """ Required : 
   inYear
   ds
   """  
...
class SetYearStartAndEndDates_output:
   def __init__(self, obj):
      pass
