...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StockAgingReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StockAgingReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StockAgingReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.StockAgingReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.StockAgingReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_StockAgingReportParamRow:
   def __init__(self, obj):
      ...
      """  Warehouse List  """  
      self.AgingStockProvFmtCode:str = obj["AgingStockProvFmtCode"]
      """  Stock Provision Format Code  """  
      self.AgingStockProvFmtDesc:str = obj["AgingStockProvFmtDesc"]
      ...
      self.AddMtlBurdenToUnitCost:bool = obj["AddMtlBurdenToUnitCost"]
...
class Erp_Tablesets_StockAgingReportTableset:
   def __init__(self, obj):
      self.StockAgingReportParam:list[Erp_Tablesets_StockAgingReportParamRow] = obj["StockAgingReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_StockAgingReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_StockAgingReportTableset] = obj["returnObj"]
      pass
