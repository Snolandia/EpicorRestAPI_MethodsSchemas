...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CNDataExportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CNDataExportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_OnChangeBookID(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CNDataExportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CNDataExportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CNDataExportRow:
   def __init__(self, obj):
      self.CNElectronicAcctBook:bool = obj["CNElectronicAcctBook"]
      self.CNDescDataFileDocument:bool = obj["CNDescDataFileDocument"]
      self.CNAcctDocument:bool = obj["CNAcctDocument"]
      self.CNDepartment:bool = obj["CNDepartment"]
      self.CNBusinessUnit:bool = obj["CNBusinessUnit"]
      self.CNProject:bool = obj["CNProject"]
      self.CNMonthlyAcctSummary:bool = obj["CNMonthlyAcctSummary"]
      self.CNBalanceSheetDocument:bool = obj["CNBalanceSheetDocument"]
      self.CNVoucherDocument:bool = obj["CNVoucherDocument"]
      self.CNIncomeStatement:bool = obj["CNIncomeStatement"]
      self.CNFiscalYear:int = obj["CNFiscalYear"]
      self.CNPeriodFrom:int = obj["CNPeriodFrom"]
      self.CNPeriodTo:int = obj["CNPeriodTo"]
      self.CNVoucherDateFrom:str = obj["CNVoucherDateFrom"]
      self.CNBook:str = obj["CNBook"]
      self.CNVoucherDateTo:str = obj["CNVoucherDateTo"]
      self.CNFromAcct:str = obj["CNFromAcct"]
      self.CNToAcct:str = obj["CNToAcct"]
      self.CNFileLocation:str = obj["CNFileLocation"]
      self.CNCOACode:str = obj["CNCOACode"]
      self.CNVoucherDateToToken:str = obj["CNVoucherDateToToken"]
      self.CNStyleNumIS:int = obj["CNStyleNumIS"]
      """  CSF China - field used for save StyleNum for Income Statement in DataExport  """  
      self.CNStyleNum:int = obj["CNStyleNum"]
      self.CNStyleNumBS:int = obj["CNStyleNumBS"]
      """  CSF China - field used for save StyleNum in DataExport  """  
      self.CNStyleDescription:str = obj["CNStyleDescription"]
      self.CNDepSegNbr:int = obj["CNDepSegNbr"]
      """  Department Segment Number  """  
      self.CNDepSegName:str = obj["CNDepSegName"]
      """  Department Segment Name  """  
      self.CNProjSegNbr:int = obj["CNProjSegNbr"]
      """  Project Segment Number  """  
      self.CNProjSegName:str = obj["CNProjSegName"]
      """  Department Segment Name  """  
...
class Erp_Tablesets_CNDataExportTableset:
   def __init__(self, obj):
      self.CNDataExport:list[Erp_Tablesets_CNDataExportRow] = obj["CNDataExport"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CNDataExportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CNDataExportTableset] = obj["returnObj"]
      pass
