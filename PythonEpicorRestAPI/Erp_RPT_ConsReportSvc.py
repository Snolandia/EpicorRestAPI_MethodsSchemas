...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ConsReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ConsReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ChangeGenID(requestBody, epicorHeaders = None):
   """  
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ConsReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ConsReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ConsReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class ChangeGenID_input:
   ...
   def __init__(self, obj):
      ...
      self.ds:list[Erp_Tablesets_ConsReportTableset] = obj["ds"]
      pass

class ChangeGenID_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_ConsReportParamRow:
   def __init__(self, obj):
      ...
      self.ConsDescription:str = obj["ConsDescription"]
      """  Consolidation Description  """  
      self.TgtCOA:str = obj["TgtCOA"]
      """  Target COA  """  
      self.GenStatus:str = obj["GenStatus"]
      """  Generation Status  """  
      self.TgtBookDesc:str = obj["TgtBookDesc"]
      """  Target book description  """  
      self.TgtCompanyDesc:str = obj["TgtCompanyDesc"]
      """  Target company description  """  
      self.TgtCOADesc:str = obj["TgtCOADesc"]
...
class Erp_Tablesets_ConsReportTableset:
   def __init__(self, obj):
      self.ConsReportParam:list[Erp_Tablesets_ConsReportParamRow] = obj["ConsReportParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ConsReportTableset] = obj["returnObj"]
      pass
