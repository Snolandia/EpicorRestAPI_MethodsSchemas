...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.JobOperSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.JobOperSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_JobOperSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.JobOperSearchSvc/JobOperSearches",headers=creds) as resp:
           return await resp.json()

async def post_JobOperSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.JobOperSearchSvc/JobOperSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_JobOperSearches_Company_JobNum_AssemblySeq_OprSeq(Company, JobNum, AssemblySeq, OprSeq, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.JobOperSearchSvc/JobOperSearches(" + Company + "," + JobNum + "," + AssemblySeq + "," + OprSeq + ")",headers=creds) as resp:
           return await resp.json()

async def patch_JobOperSearches_Company_JobNum_AssemblySeq_OprSeq(Company, JobNum, AssemblySeq, OprSeq, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.JobOperSearchSvc/JobOperSearches(" + Company + "," + JobNum + "," + AssemblySeq + "," + OprSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_JobOperSearches_Company_JobNum_AssemblySeq_OprSeq(Company, JobNum, AssemblySeq, OprSeq, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.JobOperSearchSvc/JobOperSearches(" + Company + "," + JobNum + "," + AssemblySeq + "," + OprSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.JobOperSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseJobOper, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.JobOperSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewJobOper(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.JobOperSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_JobOperListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_JobOperListRow] = obj["value"]
      pass
...
class Erp_Tablesets_JobOperListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_JobOperListTableset:
   def __init__(self, obj):
      self.JobOperList:list[Erp_Tablesets_JobOperListRow] = obj["JobOperList"]
...
class Erp_Tablesets_JobOperSearchTableset:
   def __init__(self, obj):
      self.JobOper:list[Erp_Tablesets_JobOperRow] = obj["JobOper"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtJobOperSearchTableset:
   def __init__(self, obj):
      self.JobOper:list[Erp_Tablesets_JobOperRow] = obj["JobOper"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_JobOperSearchTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_JobOperListTableset] = obj["returnObj"]
      pass
...
class GetNewJobOper_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_JobOperSearchTableset] = obj["ds"]
      self.jobNum:str = obj["jobNum"]
      self.assemblySeq:int = obj["assemblySeq"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtJobOperSearchTableset] = obj["ds"]
