...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GLSumExportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GLSumExportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_OnChangeBookID(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.GLSumExportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_GetFileFilter(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.GLSumExportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetFileExtension(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GLSumExportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_GLSumExportParamRow:
   def __init__(self, obj):
      ...
      self.ExportFormat:str = obj["ExportFormat"]
      """  Export Format  """  
      self.IncludePriorYear:bool = obj["IncludePriorYear"]
      ...
      """  Company Tax ID  """  
      self.ExportFileEncoding:str = obj["ExportFileEncoding"]
      """  Encoding (CSF Sweden)  """  
...
class Erp_Tablesets_GLSumExportTableset:
   def __init__(self, obj):
      self.GLSumExportParam:list[Erp_Tablesets_GLSumExportParamRow] = obj["GLSumExportParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GLSumExportTableset] = obj["ds"]
      pass
...
class GetFileExtension_input:
   """ Required : 
   sExtensionTmp
   """  
   def __init__(self, obj):
      self.sExtensionTmp:str = obj["sExtensionTmp"]
      pass

class GetFileExtension_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass

class GetFileFilter_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLSumExportTableset] = obj["returnObj"]
      pass
