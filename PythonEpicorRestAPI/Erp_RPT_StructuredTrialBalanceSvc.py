...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StructuredTrialBalanceSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StructuredTrialBalanceSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetApplicationDefaults(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.StructuredTrialBalanceSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_OnChangeMainBook(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StructuredTrialBalanceSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.StructuredTrialBalanceSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_StructuredTrialBalanceParamRow:
   def __init__(self, obj):
      ...
      """  List of Levels  """  
      self.PrintOnlyTotals:bool = obj["PrintOnlyTotals"]
      """  Print only totals  """  
      ...
      self.IncludeUnposted:bool = obj["IncludeUnposted"]
...
class Erp_Tablesets_StructuredTrialBalanceTableset:
   def __init__(self, obj):
      self.StructuredTrialBalanceParam:list[Erp_Tablesets_StructuredTrialBalanceParamRow] = obj["StructuredTrialBalanceParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_StructuredTrialBalanceTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_StructuredTrialBalanceTableset] = obj["returnObj"]
      pass
