...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GUIAPCheckListSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GUIAPCheckListSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GUIAPCheckListSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GUIAPCheckListSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GUIAPCheckListSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_GUIAPCheckListParamRow:
   def __init__(self, obj):
      self.InvoiceDateStart:str = obj["InvoiceDateStart"]
      self.InvoiceDateEnd:str = obj["InvoiceDateEnd"]
      self.DataRange:str = obj["DataRange"]
      self.PrintDeductCode:bool = obj["PrintDeductCode"]
      self.VendorNumList:str = obj["VendorNumList"]
      self.InvoiceDateEndToken:str = obj["InvoiceDateEndToken"]
      self.InvoiceDateStartToken:str = obj["InvoiceDateStartToken"]
...
class Erp_Tablesets_GUIAPCheckListTableset:
   def __init__(self, obj):
      self.GUIAPCheckListParam:list[Erp_Tablesets_GUIAPCheckListParamRow] = obj["GUIAPCheckListParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GUIAPCheckListTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GUIAPCheckListTableset] = obj["returnObj"]
      pass
