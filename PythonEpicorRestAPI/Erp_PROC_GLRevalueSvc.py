...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GLRevalueSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GLRevalueSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.GLRevalueSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetBookDefault(requestBody, epicorHeaders = None):
   """  
...
async def post_GetReverseDefault(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GLRevalueSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_GLRevalueParamRow:
   def __init__(self, obj):
      ...
      self.ReverseDateToken:str = obj["ReverseDateToken"]
      self.Reverse:bool = obj["Reverse"]
      self.JournalCode:str = obj["JournalCode"]
      self.JrnlDescription:str = obj["JrnlDescription"]
      self.TranText:str = obj["TranText"]
      self.CurrCodeList:str = obj["CurrCodeList"]
      self.AcctList:str = obj["AcctList"]
      self.UseAccrual:bool = obj["UseAccrual"]
      self.COACode:str = obj["COACode"]
      self.FiscalCalendarID:str = obj["FiscalCalendarID"]
      self.BookCurr:str = obj["BookCurr"]
...
class Erp_Tablesets_GLRevalueTableset:
   def __init__(self, obj):
      self.GLRevalueParam:list[Erp_Tablesets_GLRevalueParamRow] = obj["GLRevalueParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GLRevalueTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLRevalueTableset] = obj["returnObj"]
      pass
...
class GetReverseDefault_output:
   def __init__(self, obj):
      pass
