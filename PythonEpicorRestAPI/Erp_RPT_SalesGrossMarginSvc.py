...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesGrossMarginSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesGrossMarginSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetCustomerGroupList(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesGrossMarginSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetOutputType(epicorHeaders = None):
   """  
...
async def post_GetPriceOptionList(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesGrossMarginSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesGrossMarginSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SalesGrossMarginParamRow:
   def __init__(self, obj):
      ...
      """  Customer List  """  
      self.CustGrpList:str = obj["CustGrpList"]
      """  Customer Group List  """  
      self.PartList:str = obj["PartList"]
      """  Parts Selected  """  
      self.ProdGrpList:str = obj["ProdGrpList"]
      """  Product Group list  """  
      self.SortByOption:str = obj["SortByOption"]
      """  Sortby Option List  """  
      self.PriceOption:str = obj["PriceOption"]
      """  Price Option list  """  
      self.SummaryOnly:bool = obj["SummaryOnly"]
      """  Show Summary Only Toggle  """  
      self.ClosedJobs:bool = obj["ClosedJobs"]
      """  Closed Jobs Toggle  """  
      self.OutputType:str = obj["OutputType"]
      """  Printer or ASCII file  """  
      self.OutputFName:str = obj["OutputFName"]
      """  Output File Name  """  
      ...
      self.UseAdjCost:bool = obj["UseAdjCost"]
      """  Use Adjusted Costs  """  
      self.CurrDesc:str = obj["CurrDesc"]
      self.CurrencyCode:str = obj["CurrencyCode"]
      self.InclCancelInvc:bool = obj["InclCancelInvc"]
      self.PrintSelCriteria:bool = obj["PrintSelCriteria"]
      self.PrintChart:bool = obj["PrintChart"]
      self.CustListID:str = obj["CustListID"]
      self.IncludeActCostAlloc:bool = obj["IncludeActCostAlloc"]
      self.IncludePeriodicAvgCost:bool = obj["IncludePeriodicAvgCost"]
      self.SysRowID:str = obj["SysRowID"]
...
class Erp_Tablesets_SalesGrossMarginTableset:
   def __init__(self, obj):
      self.SalesGrossMarginParam:list[Erp_Tablesets_SalesGrossMarginParamRow] = obj["SalesGrossMarginParam"]
      self.ReportStyle:list[Erp_Tablesets_ReportStyleRow] = obj["ReportStyle"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class GetCustomerGroupList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.CustomerGroupList:str = obj["parameters"]
      pass
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SalesGrossMarginTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SalesGrossMarginTableset] = obj["returnObj"]
      pass

class GetOutputType_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.OutputTypeList:str = obj["parameters"]
      pass
...
class GetPriceOptionList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.PriceOptionList:str = obj["parameters"]
      pass
