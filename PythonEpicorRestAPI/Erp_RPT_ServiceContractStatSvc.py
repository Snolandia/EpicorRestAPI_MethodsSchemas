...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ServiceContractStatSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ServiceContractStatSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetContractStatus(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ServiceContractStatSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ServiceContractStatSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ServiceContractStatSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_ServiceContractStatTableset:
   def __init__(self, obj):
      self.ServiceContractStatusParam:list[Erp_Tablesets_ServiceContractStatusParamRow] = obj["ServiceContractStatusParam"]
      self.ReportStyle:list[Erp_Tablesets_ReportStyleRow] = obj["ReportStyle"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_ServiceContractStatusParamRow:
   def __init__(self, obj):
      ...
      self.ContractCodeList:str = obj["ContractCodeList"]
      self.ContractStatus:str = obj["ContractStatus"]
      self.ReportFormat:str = obj["ReportFormat"]
      self.AllStatus:bool = obj["AllStatus"]
      self.ActiveStat:bool = obj["ActiveStat"]
...
class GetContractStatus_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.ContractStatusList:str = obj["parameters"]
      pass
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ServiceContractStatTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ServiceContractStatTableset] = obj["returnObj"]
      pass
