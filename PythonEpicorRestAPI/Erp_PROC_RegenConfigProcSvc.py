...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RegenConfigProcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RegenConfigProcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RegenConfigProcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.RegenConfigProcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_RegenConfigProcParamRow:
   def __init__(self, obj):
      self.RegenAll:bool = obj["RegenAll"]
      ...
      self.ConfigList:str = obj["ConfigList"]
      self.GenAssemblies:bool = obj["GenAssemblies"]
...
class Erp_Tablesets_RegenConfigProcTableset:
   def __init__(self, obj):
      self.RegenConfigProcParam:list[Erp_Tablesets_RegenConfigProcParamRow] = obj["RegenConfigProcParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_RegenConfigProcTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_RegenConfigProcTableset] = obj["returnObj"]
      pass
