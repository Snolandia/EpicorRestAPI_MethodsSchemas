...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TimeBookingExceptionRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TimeBookingExceptionRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_getIndirectLists(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TimeBookingExceptionRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetOperatorsList(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TimeBookingExceptionRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TimeBookingExceptionRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_TimeBookingExceptionRptParamRow:
   def __init__(self, obj):
      self.WeekBeginDate:str = obj["WeekBeginDate"]
      self.WeekBeginDateToken:str = obj["WeekBeginDateToken"]
      self.WeekEndDate:str = obj["WeekEndDate"]
      self.WeekEndDateToken:str = obj["WeekEndDateToken"]
      self.MissingHoursOperator:str = obj["MissingHoursOperator"]
      self.MissingHours:int = obj["MissingHours"]
      self.UtilizationPctOperator:str = obj["UtilizationPctOperator"]
      self.UtilizationPctHours:int = obj["UtilizationPctHours"]
      self.IndirectCodes:str = obj["IndirectCodes"]
      self.ExcludedIndirectCodes:str = obj["ExcludedIndirectCodes"]
      self.EmployeeList:str = obj["EmployeeList"]
      self.EmployeeApproverList:str = obj["EmployeeApproverList"]
      self.ExcludedIndirectCodesDesc:str = obj["ExcludedIndirectCodesDesc"]
      self.IndirectCodesDesc:str = obj["IndirectCodesDesc"]
      self.SysRowID:str = obj["SysRowID"]
...
class Erp_Tablesets_TimeBookingExceptionRptTableset:
   def __init__(self, obj):
      self.TimeBookingExceptionRptParam:list[Erp_Tablesets_TimeBookingExceptionRptParamRow] = obj["TimeBookingExceptionRptParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TimeBookingExceptionRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TimeBookingExceptionRptTableset] = obj["returnObj"]
      pass

class GetOperatorsList_input:
   """ Required : 
   TableName
   FieldName
   """  
...
class getIndirectLists_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.codeAList:str = obj["parameters"]
      self.descList:str = obj["parameters"]
      pass
