...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ShipWhseSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ShipWhseSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_ShipWhseSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ShipWhseSearchSvc/ShipWhseSearches",headers=creds) as resp:
           return await resp.json()

async def post_ShipWhseSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ShipWhseSearchSvc/ShipWhseSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_ShipWhseSearches_Company_PartNum_WarehouseCode(Company, PartNum, WarehouseCode, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ShipWhseSearchSvc/ShipWhseSearches(" + Company + "," + PartNum + "," + WarehouseCode + ")",headers=creds) as resp:
           return await resp.json()

async def patch_ShipWhseSearches_Company_PartNum_WarehouseCode(Company, PartNum, WarehouseCode, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.ShipWhseSearchSvc/ShipWhseSearches(" + Company + "," + PartNum + "," + WarehouseCode + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_ShipWhseSearches_Company_PartNum_WarehouseCode(Company, PartNum, WarehouseCode, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.ShipWhseSearchSvc/ShipWhseSearches(" + Company + "," + PartNum + "," + WarehouseCode + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ShipWhseSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClausePartWhseSearch, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ShipWhseSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewPartWhseSearch(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ShipWhseSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_ShipWhseSearchTableset:
   def __init__(self, obj):
      self.PartWhseSearch:list[Erp_Tablesets_PartWhseSearchRow] = obj["PartWhseSearch"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtShipWhseSearchTableset:
   def __init__(self, obj):
      self.PartWhseSearch:list[Erp_Tablesets_PartWhseSearchRow] = obj["PartWhseSearch"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ShipWhseSearchTableset] = obj["returnObj"]
      pass
...
class GetNewPartWhseSearch_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ShipWhseSearchTableset] = obj["ds"]
      self.partNum:str = obj["partNum"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtShipWhseSearchTableset] = obj["ds"]
