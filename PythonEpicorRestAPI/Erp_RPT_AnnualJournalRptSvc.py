...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_NatAccSegChanged(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangeNatAccSeg(requestBody, epicorHeaders = None):
   """  
...
async def post_GetJournalCodes(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_AnnualJournalParamsRow:
   def __init__(self, obj):
      ...
      """  End Fiscal Period  """  
      self.NatAccFrom:str = obj["NatAccFrom"]
      """  Natutal Account From  """  
      self.NatAccTo:str = obj["NatAccTo"]
      """  Natutal Account To  """  
      self.COACode:str = obj["COACode"]
      """  COA Code of the Main Book.  """  
      self.FiscalCalendarID:str = obj["FiscalCalendarID"]
      self.PrintSelCriteria:bool = obj["PrintSelCriteria"]
      self.IncUnposted:bool = obj["IncUnposted"]
      """  Include Unposted Transactions  """  
      self.ReportOption:str = obj["ReportOption"]
      ...
      self.JournalCodesAvailable:str = obj["JournalCodesAvailable"]
      """  Available Journal Codes list  """  
      self.NatAccFromName:str = obj["NatAccFromName"]
      """  Natural Account From Name  """  
      self.NatAccToName:str = obj["NatAccToName"]
...
class Erp_Tablesets_AnnualJournalRptTableset:
   def __init__(self, obj):
      self.AnnualJournalParams:list[Erp_Tablesets_AnnualJournalParamsRow] = obj["AnnualJournalParams"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_AnnualJournalRptTableset] = obj["ds"]
      pass
...
class GetJournalCodes_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.JournalCodesAvailable:str = obj["parameters"]
      self.JournalCodesSelectable:str = obj["parameters"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_AnnualJournalRptTableset] = obj["returnObj"]
      pass
...
class OnChangeNatAccSeg_input:
   ...
   def __init__(self, obj):
      self.coaCode:str = obj["coaCode"]
      """  COA Code  """  
      self.ipNatAccount:str = obj["ipNatAccount"]
      """  Proposed Natural Account Segment.  """  
      pass

class OnChangeNatAccSeg_output:
   def __init__(self, obj):
      pass
