...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ShopLoadReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ShopLoadReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetSORTBYLIST(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ShopLoadReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ShopLoadReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ShopLoadReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_ShopLoadParamRow:
   def __init__(self, obj):
      self.DeptList:str = obj["DeptList"]
      """  DeptList  """  
      self.CutOffDate:str = obj["CutOffDate"]
      """  CutOff Date  """  
      self.Units:str = obj["Units"]
      self.Summary:bool = obj["Summary"]
      self.Interval:int = obj["Interval"]
      self.FirstBucketInfinite:bool = obj["FirstBucketInfinite"]
...
class Erp_Tablesets_ShopLoadReportTableset:
   def __init__(self, obj):
      self.ShopLoadParam:list[Erp_Tablesets_ShopLoadParamRow] = obj["ShopLoadParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ShopLoadReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ShopLoadReportTableset] = obj["returnObj"]
      pass
