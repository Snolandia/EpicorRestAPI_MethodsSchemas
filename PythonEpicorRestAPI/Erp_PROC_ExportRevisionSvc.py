...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ExportRevisionSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ExportRevisionSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ValidateOutputFolderPath(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ExportRevisionSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetDisplayPath(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ExportRevisionSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ExportRevisionSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ExportRevisionParamRow:
   def __init__(self, obj):
      self.DeleteMode:bool = obj["DeleteMode"]
      """  Indicates if process works in Export (false) or Delete (true) mode.  """  
      self.ExportWithDevTags:bool = obj["ExportWithDevTags"]
      self.isExportAnyway:bool = obj["isExportAnyway"]
      self.OutputFolderPath:str = obj["OutputFolderPath"]
      """  Path to the folder where XML files will be saved.  """  
      self.NewRevsName:str = obj["NewRevsName"]
      """  New name of selected revisions.  """  
      self.ListSelectedToExport:str = obj["ListSelectedToExport"]
      self.ListSelectedToDelete:str = obj["ListSelectedToDelete"]
      self.ListOfRevisionCodes:str = obj["ListOfRevisionCodes"]
      """  List of old Revision Codes.  """  
      self.ListOfNewCodes:str = obj["ListOfNewCodes"]
      """  List of New revision Codes.  """  
      self.ListOfFileNames:str = obj["ListOfFileNames"]
      """  List of File Names for export.  """  
      self.ListOfACTTypeUIDs:str = obj["ListOfACTTypeUIDs"]
      """  List of ACTType UIDs.  """  
      self.ListOfACTTypeNames:str = obj["ListOfACTTypeNames"]
...
class Erp_Tablesets_ExportRevisionTableset:
   def __init__(self, obj):
      self.ExportRevisionParam:list[Erp_Tablesets_ExportRevisionParamRow] = obj["ExportRevisionParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ExportRevisionTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ExportRevisionTableset] = obj["returnObj"]
      pass
...
class ValidateOutputFolderPath_input:
   """ Required : 
   ipFolderPath
   """  
   def __init__(self, obj):
      self.ipFolderPath:str = obj["ipFolderPath"]
      pass

class ValidateOutputFolderPath_output:
   def __init__(self, obj):
      self.returnObj:bool = obj["returnObj"]
      pass
