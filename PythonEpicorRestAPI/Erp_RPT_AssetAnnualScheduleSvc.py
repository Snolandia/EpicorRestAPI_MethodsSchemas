...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetAnnualScheduleSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetAnnualScheduleSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.AssetAnnualScheduleSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_SetFiscalCalendar(requestBody, epicorHeaders = None):
   """  
...
async def post_GetSumFieldsList(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.AssetAnnualScheduleSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetAnnualScheduleSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_AssetAnnualScheduleParamRow:
   def __init__(self, obj):
      self.AssetList:str = obj["AssetList"]
      """  List of Assets for Report  """  
      self.AssetRegID:str = obj["AssetRegID"]
      """  Asset Register ID  """  
      self.CategoriesList:str = obj["CategoriesList"]
      """  Report categories list for report  """  
      self.ExportToFile:bool = obj["ExportToFile"]
      """  Export of the report to file  """  
      self.FiscalYear:int = obj["FiscalYear"]
      """  Fiscal Year  """  
      self.FiscalYearSuffix:str = obj["FiscalYearSuffix"]
      """  Fiscal Year Suffix  """  
      self.GroupByAsset:bool = obj["GroupByAsset"]
      """  Grouping of the data report by Asset  """  
      self.GroupByAssetGroup:bool = obj["GroupByAssetGroup"]
      """  Grouping of the data report by Asset Group  """  
      self.GroupByReportCat:bool = obj["GroupByReportCat"]
      ...
      """  Cut-off Date  """  
      self.SummaryFieldsList:str = obj["SummaryFieldsList"]
      self.PrintSelCriteria:bool = obj["PrintSelCriteria"]
      self.DataSelection:str = obj["DataSelection"]
...
class Erp_Tablesets_AssetAnnualScheduleTableset:
   def __init__(self, obj):
      self.AssetAnnualScheduleParam:list[Erp_Tablesets_AssetAnnualScheduleParamRow] = obj["AssetAnnualScheduleParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_AssetAnnualScheduleTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_AssetAnnualScheduleTableset] = obj["returnObj"]
      pass
...
class GetSumFieldsList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.summFieldsList:str = obj["parameters"]
      self.SummFieldsCodes:str = obj["parameters"]
      pass
...
class SetFiscalCalendar_input:
   """ Required : 
   ipAssetRegisterID
   ds
   """  
   def __init__(self, obj):
      self.ipAssetRegisterID:str = obj["ipAssetRegisterID"]
      """  AssetRegisterID  """  
      self.ds:list[Erp_Tablesets_AssetAnnualScheduleTableset] = obj["ds"]
      pass

class SetFiscalCalendar_output:
   def __init__(self, obj):
      pass
