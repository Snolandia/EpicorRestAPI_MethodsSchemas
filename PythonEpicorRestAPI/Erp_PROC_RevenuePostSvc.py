...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RevenuePostSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RevenuePostSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RevenuePostSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.RevenuePostSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_RevenuePostRow:
   def __init__(self, obj):
      ...
      self.BurdenAmt:int = obj["BurdenAmt"]
      self.LaborAmt:int = obj["LaborAmt"]
      self.MatBurdenAmt:int = obj["MatBurdenAmt"]
      self.MaterialAmt:int = obj["MaterialAmt"]
      self.RevenueAmt:int = obj["RevenueAmt"]
      self.SubConAmt:int = obj["SubConAmt"]
      self.ODCAmt:int = obj["ODCAmt"]
...
class Erp_Tablesets_RevenuePostTableset:
   def __init__(self, obj):
      self.RevenuePost:list[Erp_Tablesets_RevenuePostRow] = obj["RevenuePost"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_RevenuePostTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_RevenuePostTableset] = obj["returnObj"]
      pass
