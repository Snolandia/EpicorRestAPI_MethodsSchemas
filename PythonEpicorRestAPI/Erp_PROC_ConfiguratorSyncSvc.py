...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConfiguratorSyncSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConfiguratorSyncSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_AllExtCompanyList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ConfiguratorSyncSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetTaskExtCompanyIDs(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ConfiguratorSyncSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConfiguratorSyncSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_ConfiguratorSyncParamRow:
   def __init__(self, obj):
...
class Erp_Tablesets_ConfiguratorSyncTableset:
   def __init__(self, obj):
      self.ConfiguratorSyncParam:list[Erp_Tablesets_ConfiguratorSyncParamRow] = obj["ConfiguratorSyncParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ConfiguratorSyncTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ConfiguratorSyncTableset] = obj["returnObj"]
      pass
