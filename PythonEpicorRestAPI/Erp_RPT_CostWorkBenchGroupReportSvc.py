...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CostWorkBenchGroupReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CostWorkBenchGroupReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_PartTypeList(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CostWorkBenchGroupReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_ReportTypeList(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CostWorkBenchGroupReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CostWorkBenchGroupReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CostWorkBenchGroupParamRow:
   def __init__(self, obj):
      self.ReportType:str = obj["ReportType"]
      self.ChangedItemsOnly:bool = obj["ChangedItemsOnly"]
      self.PartType:str = obj["PartType"]
...
class Erp_Tablesets_CostWorkBenchGroupReportTableset:
   def __init__(self, obj):
      self.CostWorkBenchGroupParam:list[Erp_Tablesets_CostWorkBenchGroupParamRow] = obj["CostWorkBenchGroupParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CostWorkBenchGroupReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CostWorkBenchGroupReportTableset] = obj["returnObj"]
      pass
