...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ECCCustomerExtendedSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ECCCustomerExtendedSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetCodeDescList(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ECCCustomerExtendedSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ECCCustomerExtendedSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ECCCustomerExtendedParamRow:
...
class Erp_Tablesets_ECCCustomerExtendedTableset:
   def __init__(self, obj):
      self.ECCCustomerExtendedParam:list[Erp_Tablesets_ECCCustomerExtendedParamRow] = obj["ECCCustomerExtendedParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ECCCustomerExtendedTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ECCCustomerExtendedTableset] = obj["returnObj"]
      pass
