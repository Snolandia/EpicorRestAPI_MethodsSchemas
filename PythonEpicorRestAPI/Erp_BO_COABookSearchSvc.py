...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COABookSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COABookSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_COABookSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COABookSearchSvc/COABookSearches",headers=creds) as resp:
           return await resp.json()

async def post_COABookSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.COABookSearchSvc/COABookSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_COABookSearches_Company_COACode(Company, COACode, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COABookSearchSvc/COABookSearches(" + Company + "," + COACode + ")",headers=creds) as resp:
           return await resp.json()

async def patch_COABookSearches_Company_COACode(Company, COACode, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.COABookSearchSvc/COABookSearches(" + Company + "," + COACode + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_COABookSearches_Company_COACode(Company, COACode, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.COABookSearchSvc/COABookSearches(" + Company + "," + COACode + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COABookSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseCOA, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.COABookSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewCOA(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.COABookSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_COABookSearchTableset:
   def __init__(self, obj):
...
class Erp_Tablesets_UpdExtCOABookSearchTableset:
   def __init__(self, obj):
      self.COA:list[Erp_Tablesets_COARow] = obj["COA"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_COABookSearchTableset] = obj["returnObj"]
      pass
...
class GetNewCOA_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_COABookSearchTableset] = obj["ds"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtCOABookSearchTableset] = obj["ds"]
