...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.BankFileImportExpressSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.BankFileImportExpressSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.BankFileImportExpressSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.BankFileImportExpressSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_BankFileImportExpressParamRow:
   def __init__(self, obj):
      self.ApplyCreditMemo:bool = obj["ApplyCreditMemo"]
      self.Company:str = obj["Company"]
      self.GroupID:str = obj["GroupID"]
      self.EnableLogToFile:bool = obj["EnableLogToFile"]
...
class Erp_Tablesets_BankFileImportExpressTableset:
   def __init__(self, obj):
      self.BankFileImportExpressParam:list[Erp_Tablesets_BankFileImportExpressParamRow] = obj["BankFileImportExpressParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_BankFileImportExpressTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_BankFileImportExpressTableset] = obj["returnObj"]
      pass
