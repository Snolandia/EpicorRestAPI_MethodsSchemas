...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ClosePOMultiCompanySvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ClosePOMultiCompanySvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ClosePOMultiCompanySvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ClosePOMultiCompanySvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ClosePOMultiCompanyParamRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      self.SrcCompany:str = obj["SrcCompany"]
      self.TrgCompany:str = obj["TrgCompany"]
...
class Erp_Tablesets_ClosePOMultiCompanyTableset:
   def __init__(self, obj):
      self.ClosePOMultiCompanyParam:list[Erp_Tablesets_ClosePOMultiCompanyParamRow] = obj["ClosePOMultiCompanyParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ClosePOMultiCompanyTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ClosePOMultiCompanyTableset] = obj["returnObj"]
      pass
