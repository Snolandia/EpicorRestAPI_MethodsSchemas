...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ApplyRecurJrnlsSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ApplyRecurJrnlsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetRecurringBookList(epicorHeaders = None):
   """  
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ApplyRecurJrnlsSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetSelectedRecurringBookList(requestBody, epicorHeaders = None):
   """  
...
JrnlGroupPrefix and SelectedForProcess are set according to
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ApplyRecurJrnlsSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ApplyRecurJrnlsSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ApplyRecurJrnlBooksRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      self.BookID:str = obj["BookID"]
      self.BookDescription:str = obj["BookDescription"]
      self.SelectedForProcess:bool = obj["SelectedForProcess"]
      self.JrnlGroupPrefix:str = obj["JrnlGroupPrefix"]
      self.SysRowID:str = obj["SysRowID"]
      self.RowMod:str = obj["RowMod"]
      """  RowMod  """  
      pass

class Erp_Tablesets_ApplyRecurJrnlParamsRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      self.BookList:str = obj["BookList"]
      ...
      """  Journal Code  """  
      self.JrnlCodeDescription:str = obj["JrnlCodeDescription"]
      """  Journal Code description  """  
      self.SchedDateCutoff:str = obj["SchedDateCutoff"]
      """  The cutoff date.  GLRecSched records with a ScheduleDate <= this date will be processed.  """  
      self.SchedDateCutoffToken:str = obj["SchedDateCutoffToken"]
      self.SysRowID:str = obj["SysRowID"]
...
class Erp_Tablesets_ApplyRecurJrnlsTableset:
   def __init__(self, obj):
      self.ApplyRecurJrnlParams:list[Erp_Tablesets_ApplyRecurJrnlParamsRow] = obj["ApplyRecurJrnlParams"]
      self.ApplyRecurJrnlBooks:list[Erp_Tablesets_ApplyRecurJrnlBooksRow] = obj["ApplyRecurJrnlBooks"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ApplyRecurJrnlsTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ApplyRecurJrnlsTableset] = obj["returnObj"]
      pass
...
class GetRecurringBookList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ApplyRecurJrnlsTableset] = obj["returnObj"]
      pass

class GetSelectedRecurringBookList_input:
   """ Required : 
   bookList
   groupList
   """  
...
class GetSelectedRecurringBookList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ApplyRecurJrnlsTableset] = obj["returnObj"]
      pass
