...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWAPInvListSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWAPInvListSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_OnChangeOfFiscalPeriod(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TWAPInvListSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWAPInvListSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TWAPInvListSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_TWAPInvListParamRow:
   def __init__(self, obj):
...
class Erp_Tablesets_TWAPInvListTableset:
   def __init__(self, obj):
      self.TWAPInvListParam:list[Erp_Tablesets_TWAPInvListParamRow] = obj["TWAPInvListParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TWAPInvListTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TWAPInvListTableset] = obj["returnObj"]
      pass
