...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DefExpRecogProcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DefExpRecogProcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetActualDateFromDateToken(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.DefExpRecogProcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DefExpRecogProcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_DefExpRecogProcParamRow:
   def __init__(self, obj):
      self.ACTType:str = obj["ACTType"]
      self.AmortCodeList:str = obj["AmortCodeList"]
      self.ApplyDate:str = obj["ApplyDate"]
      self.ApplyDateToken:str = obj["ApplyDateToken"]
      self.GLJournalList:str = obj["GLJournalList"]
...
class Erp_Tablesets_DefExpRecogProcTableset:
   def __init__(self, obj):
      self.DefExpRecogProcParam:list[Erp_Tablesets_DefExpRecogProcParamRow] = obj["DefExpRecogProcParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_DefExpRecogProcTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_DefExpRecogProcTableset] = obj["returnObj"]
      pass
