...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_OnChangingQueryID(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class GetDefaults_input:
   ...
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_DynamicQueryExportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_DynamicQueryExportTableset] = obj["returnObj"]
      pass
...
class Ice_Tablesets_DynQueryExpParamRow:
   def __init__(self, obj):
      ...
      self.TextDelim:str = obj["TextDelim"]
      """  The text delimiter to use, if needed, for the format.  """  
      self.OutputLabels:bool = obj["OutputLabels"]
...
class Ice_Tablesets_DynamicQueryExportTableset:
   def __init__(self, obj):
      self.DynQueryExpParam:list[Ice_Tablesets_DynQueryExpParamRow] = obj["DynQueryExpParam"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class OnChangingQueryID_input:
   """ Required : 
   proposedQueryId
   ds
   """  
   def __init__(self, obj):
      self.proposedQueryId:str = obj["proposedQueryId"]
      """  Query id  """  
      self.ds:list[Ice_Tablesets_DynamicQueryExportTableset] = obj["ds"]
      pass

class OnChangingQueryID_output:
   def __init__(self, obj):
      pass
