...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RenewContractProcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RenewContractProcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RenewContractProcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.RenewContractProcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_RenewContractParamRow:
   def __init__(self, obj):
      self.ContractList1:str = obj["ContractList1"]
      ...
      self.ContractList2:str = obj["ContractList2"]
      ...
      self.ContractList3:str = obj["ContractList3"]
      ...
      self.ExpireDateToken:str = obj["ExpireDateToken"]
      self.CustomerList:str = obj["CustomerList"]
      self.TypeList:str = obj["TypeList"]
...
class Erp_Tablesets_RenewContractProcTableset:
   def __init__(self, obj):
      self.RenewContractParam:list[Erp_Tablesets_RenewContractParamRow] = obj["RenewContractParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_RenewContractProcTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_RenewContractProcTableset] = obj["returnObj"]
      pass
