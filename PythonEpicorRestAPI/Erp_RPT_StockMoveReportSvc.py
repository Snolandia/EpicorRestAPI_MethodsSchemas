...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_OnChangeFromDate(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_StockMoveReportParamRow:
   def __init__(self, obj):
      self.ClassIDList:str = obj["ClassIDList"]
      self.CostOption:str = obj["CostOption"]
...
Weighted Average = All transaction costs will be printed as weighted average.  """  
      self.FromDte:str = obj["FromDte"]
      self.FromDteToken:str = obj["FromDteToken"]
      self.IncludeWithoutTranInPeriod:bool = obj["IncludeWithoutTranInPeriod"]
      ...
      self.Parts:str = obj["Parts"]
      self.PrintDescription:bool = obj["PrintDescription"]
      ...
      self.PrintDetails:bool = obj["PrintDetails"]
      self.ProdGrupList:str = obj["ProdGrupList"]
      self.ToDte:str = obj["ToDte"]
      self.ToDteToken:str = obj["ToDteToken"]
      self.WhseCodeList:str = obj["WhseCodeList"]
      self.GroupMethod:str = obj["GroupMethod"]
      """  Grouping Method: By Class, By Site, By Warehouse...  """  
      self.isStockMoveReport:bool = obj["isStockMoveReport"]
      ...
      self.IncludeNonStockItems:bool = obj["IncludeNonStockItems"]
      self.SysRowID:str = obj["SysRowID"]
...
class Erp_Tablesets_StockMoveReportTableset:
   def __init__(self, obj):
      self.StockMoveReportParam:list[Erp_Tablesets_StockMoveReportParamRow] = obj["StockMoveReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_StockMoveReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_StockMoveReportTableset] = obj["returnObj"]
      pass
