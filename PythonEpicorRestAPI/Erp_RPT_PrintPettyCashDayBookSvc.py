...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PrintPettyCashDayBookSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PrintPettyCashDayBookSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PrintPettyCashDayBookSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PrintPettyCashDayBookSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PrintPettyCashDayBookSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PrintPettyCashDayBookParamRow:
   def __init__(self, obj):
      self.CashDeskID:str = obj["CashDeskID"]
      self.FromCashDate:str = obj["FromCashDate"]
      self.FromCashDateToken:str = obj["FromCashDateToken"]
      self.IncludeDrafts:bool = obj["IncludeDrafts"]
      self.ToCashDate:str = obj["ToCashDate"]
      self.ToCashDateToken:str = obj["ToCashDateToken"]
      self.OfficialReport:bool = obj["OfficialReport"]
...
class Erp_Tablesets_PrintPettyCashDayBookTableset:
   def __init__(self, obj):
      self.PrintPettyCashDayBookParam:list[Erp_Tablesets_PrintPettyCashDayBookParamRow] = obj["PrintPettyCashDayBookParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PrintPettyCashDayBookTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PrintPettyCashDayBookTableset] = obj["returnObj"]
      pass
