...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ValidateSummaryOnly(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_DiscountAnalysisRptParamRow:
   def __init__(self, obj):
      self.StartInvDate:str = obj["StartInvDate"]
      """  Start Invoice Date  """  
      self.StartInvDateToken:str = obj["StartInvDateToken"]
      self.EndInvDate:str = obj["EndInvDate"]
      """  End Invoice Date  """  
      self.EndInvDateToken:str = obj["EndInvDateToken"]
      self.PaymentDate:str = obj["PaymentDate"]
      """  Payment Date  """  
      self.PaymentDateToken:str = obj["PaymentDateToken"]
      self.DiscountEarnedType:str = obj["DiscountEarnedType"]
...
class Erp_Tablesets_DiscountAnalysisRptTableset:
   def __init__(self, obj):
      self.DiscountAnalysisRptParam:list[Erp_Tablesets_DiscountAnalysisRptParamRow] = obj["DiscountAnalysisRptParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_DiscountAnalysisRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_DiscountAnalysisRptTableset] = obj["returnObj"]
      pass
...
class ValidateSummaryOnly_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class ValidateSummaryOnly_output:
   def __init__(self, obj):
      pass
