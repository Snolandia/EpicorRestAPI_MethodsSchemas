...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MYLMWRawMaterialSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MYLMWRawMaterialSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SetFiscalDates(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MYLMWRawMaterialSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_CheckBaseCurrency(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MYLMWRawMaterialSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MYLMWRawMaterialSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_MYLMWRawMaterialParamRow:
   def __init__(self, obj):
...
class Erp_Tablesets_MYLMWRawMaterialTableset:
   def __init__(self, obj):
      self.MYLMWRawMaterialParam:list[Erp_Tablesets_MYLMWRawMaterialParamRow] = obj["MYLMWRawMaterialParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MYLMWRawMaterialTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MYLMWRawMaterialTableset] = obj["returnObj"]
      pass
