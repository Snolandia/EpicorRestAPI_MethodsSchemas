...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CostWBPostSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CostWBPostSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_assignPlantList(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CostWBPostSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_ChangePostToPlantCostID(requestBody, epicorHeaders = None):
   """  
...
async def post_GroupIDDefaults(requestBody, epicorHeaders = None):
   """  
...
async def post_validateCostGrp(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CostWBPostSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CostWBPostSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class ChangePostToPlantCostID_input:
   """ Required : 
   cPlantCostID
   """  
   def __init__(self, obj):
      self.cPlantCostID:str = obj["cPlantCostID"]
      """  The Plant Cost ID  """  
      pass

class ChangePostToPlantCostID_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.cPlantList:str = obj["parameters"]
      pass

      """  output parameters  """  

class Erp_Tablesets_CostWBPostRow:
   def __init__(self, obj):
...
class Erp_Tablesets_CostWBPostTableset:
   def __init__(self, obj):
      self.CostWBPost:list[Erp_Tablesets_CostWBPostRow] = obj["CostWBPost"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CostWBPostTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CostWBPostTableset] = obj["returnObj"]
      pass
