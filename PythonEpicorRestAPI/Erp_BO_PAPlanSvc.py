...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_PAPlans(select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlans",headers=creds) as resp:
           return await resp.json()

async def post_PAPlans(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlans", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_PAPlans_Company_PAPlanID(Company, PAPlanID, select = None, expand = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlans(" + Company + "," + PAPlanID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_PAPlans_Company_PAPlanID(Company, PAPlanID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlans(" + Company + "," + PAPlanID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_PAPlans_Company_PAPlanID(Company, PAPlanID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlans(" + Company + "," + PAPlanID + ")",headers=creds) as resp:
           return await resp.json()

async def get_PAPlans_Company_PAPlanID_PAPlanDtls(Company, PAPlanID, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlans(" + Company + "," + PAPlanID + ")/PAPlanDtls",headers=creds) as resp:
           return await resp.json()

async def get_PAPlans_Company_PAPlanID_PAPlanDtls_Company_PAPlanID_PAPlanDtlID(Company, PAPlanID, PAPlanDtlID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlans(" + Company + "," + PAPlanID + ")/PAPlanDtls(" + Company + "," + PAPlanID + "," + PAPlanDtlID + ")",headers=creds) as resp:
           return await resp.json()

async def get_PAPlanDtls(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   Summary: Calls GetRows for the service
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlanDtls",headers=creds) as resp:
           return await resp.json()

async def post_PAPlanDtls(requestBody, epicorHeaders = None):
   """  
   Summary: Calls UpdateExt to create new item for the service
   Description: Calls UpdateExt to create new item for the service. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li></ul></div>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlanDtls", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_PAPlanDtls_Company_PAPlanID_PAPlanDtlID(Company, PAPlanID, PAPlanDtlID, select = None, filter = None, epicorHeaders = None):
   """  
   Summary: Calls GetByID to retrieve the PAPlanDtl item
   Description: Calls GetByID to retrieve the PAPlanDtl item by specified keys. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li><li>String parameters should be specified in single quotes</li></ul></div>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlanDtls(" + Company + "," + PAPlanID + "," + PAPlanDtlID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_PAPlanDtls_Company_PAPlanID_PAPlanDtlID(Company, PAPlanID, PAPlanDtlID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlanDtls(" + Company + "," + PAPlanID + "," + PAPlanDtlID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_PAPlanDtls_Company_PAPlanID_PAPlanDtlID(Company, PAPlanID, PAPlanDtlID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/PAPlanDtls(" + Company + "," + PAPlanID + "," + PAPlanDtlID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClausePAPlan, whereClausePAPlanDtl, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(paPlanID, epicorHeaders = None):
   """  
...
async def post_ChangeWeekID(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PAPlanSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetNewPAPlan(requestBody, epicorHeaders = None):
   """  
...
async def post_GetNewPAPlanDtl(requestBody, epicorHeaders = None):
   """  
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PAPlanDtlRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PAPlanDtlRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PAPlanListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PAPlanListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PAPlanRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PAPlanRow] = obj["value"]
      pass

class Erp_Tablesets_PAPlanDtlRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company identifier  """  
      self.PAPlanID:str = obj["PAPlanID"]
      """  Unique ID  """  
      self.PAPlanDtlID:int = obj["PAPlanDtlID"]
      """  Line Number  """  
      self.PADayID:str = obj["PADayID"]
      """  From PAPlan  """  
      self.PAPeriod:int = obj["PAPeriod"]
      """  From PADay  """  
      self.CrewSize:int = obj["CrewSize"]
      ...
      self.DayIDDescription:str = obj["DayIDDescription"]
      self.RowMod:str = obj["RowMod"]
      """  RowMod  """  
      pass

class Erp_Tablesets_PAPlanListRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.PAPlanID:str = obj["PAPlanID"]
      ...
      self.PAWeekPAWkDescription:str = obj["PAWeekPAWkDescription"]
      """  Description of the week pattern  """  
      self.RowMod:str = obj["RowMod"]
      """  RowMod  """  
      pass

class Erp_Tablesets_PAPlanRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.PAPlanID:str = obj["PAPlanID"]
...
# Custom Schemas:
#########################################################################
class ChangeWeekID_input:
   """ Required : 
   pWeekID
   ds
   """  
   def __init__(self, obj):
      self.pWeekID:str = obj["pWeekID"]
      """  The new week ID.  """  
      self.ds:list[Erp_Tablesets_PAPlanTableset] = obj["ds"]
      pass

class ChangeWeekID_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_PAPlanListTableset:
   def __init__(self, obj):
      self.PAPlanList:list[Erp_Tablesets_PAPlanListRow] = obj["PAPlanList"]
...
class Erp_Tablesets_PAPlanTableset:
   def __init__(self, obj):
      self.PAPlan:list[Erp_Tablesets_PAPlanRow] = obj["PAPlan"]
      self.PAPlanDtl:list[Erp_Tablesets_PAPlanDtlRow] = obj["PAPlanDtl"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtPAPlanTableset:
   def __init__(self, obj):
      self.PAPlan:list[Erp_Tablesets_PAPlanRow] = obj["PAPlan"]
      self.PAPlanDtl:list[Erp_Tablesets_PAPlanDtlRow] = obj["PAPlanDtl"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PAPlanTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PAPlanListTableset] = obj["returnObj"]
      pass
...
class GetRows_input:
   """ Required : 
   whereClausePAPlan
   whereClausePAPlanDtl
   pageSize
   absolutePage
   """  
   def __init__(self, obj):
      self.whereClausePAPlan:str = obj["whereClausePAPlan"]
      self.whereClausePAPlanDtl:str = obj["whereClausePAPlanDtl"]
      self.pageSize:int = obj["pageSize"]
      self.absolutePage:int = obj["absolutePage"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtPAPlanTableset] = obj["ds"]
