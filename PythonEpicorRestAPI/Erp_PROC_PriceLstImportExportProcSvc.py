...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PriceLstImportExportProcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PriceLstImportExportProcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PriceLstImportExportProcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.PriceLstImportExportProcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_PriceLstImportExportProcParamRow:
   def __init__(self, obj):
      ...
      self.PriceLstCode:str = obj["PriceLstCode"]
      """  Current List Code  """  
      self.ImportFileNameDisplay:str = obj["ImportFileNameDisplay"]
...
class Erp_Tablesets_PriceLstImportExportProcTableset:
   def __init__(self, obj):
      self.PriceLstImportExportProcParam:list[Erp_Tablesets_PriceLstImportExportProcParamRow] = obj["PriceLstImportExportProcParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PriceLstImportExportProcTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PriceLstImportExportProcTableset] = obj["returnObj"]
      pass
