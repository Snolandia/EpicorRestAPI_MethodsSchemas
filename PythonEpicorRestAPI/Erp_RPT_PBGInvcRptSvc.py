...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PBGInvcRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PBGInvcRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PBGInvcRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PBGInvcRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PBGInvcRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PBGInvcRptParamRow:
   def __init__(self, obj):
      self.ConInvMeth:str = obj["ConInvMeth"]
      """  Invoicing Method  """  
      self.PrintActDtl:bool = obj["PrintActDtl"]
      """  Print Activity Detail  """  
      self.NewPageSched:bool = obj["NewPageSched"]
      """  New Page Per Progress Schedule  """  
      self.InvoicesLst:str = obj["InvoicesLst"]
      """  List of Invoices  """  
      self.AutoProjectID:str = obj["AutoProjectID"]
      self.AutoInvoiceNum:int = obj["AutoInvoiceNum"]
...
class Erp_Tablesets_PBGInvcRptTableset:
   def __init__(self, obj):
      self.PBGInvcRptParam:list[Erp_Tablesets_PBGInvcRptParamRow] = obj["PBGInvcRptParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PBGInvcRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PBGInvcRptTableset] = obj["returnObj"]
      pass
