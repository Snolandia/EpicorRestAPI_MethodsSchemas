...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CustShpCCProcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CustShpCCProcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CustShpCCProcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CustShpCCProcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CustShpCCProcParamRow:
   def __init__(self, obj):
      self.AuthAmt:str = obj["AuthAmt"]
      self.DocAmt:int = obj["DocAmt"]
      self.GrpID:str = obj["GrpID"]
      self.InvNum:str = obj["InvNum"]
      self.newPNRef:str = obj["newPNRef"]
...
class Erp_Tablesets_CustShpCCProcTableset:
   def __init__(self, obj):
      self.CustShpCCProcParam:list[Erp_Tablesets_CustShpCCProcParamRow] = obj["CustShpCCProcParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CustShpCCProcTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CustShpCCProcTableset] = obj["returnObj"]
      pass
