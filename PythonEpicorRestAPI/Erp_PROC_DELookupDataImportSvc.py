...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DELookupDataImportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DELookupDataImportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ValidateExcelFile(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.DELookupDataImportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DELookupDataImportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_DELookupDataImportParamRow:
   def __init__(self, obj):
      ...
      self.TableList:str = obj["TableList"]
...
class Erp_Tablesets_DELookupDataImportTableset:
   def __init__(self, obj):
      self.DELookupDataImportParam:list[Erp_Tablesets_DELookupDataImportParamRow] = obj["DELookupDataImportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_DELookupDataImportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_DELookupDataImportTableset] = obj["returnObj"]
      pass
...
class ValidateExcelFile_input:
   """ Required : 
   serverImportFileName
   """  
   def __init__(self, obj):
      self.serverImportFileName:str = obj["serverImportFileName"]
      pass

class ValidateExcelFile_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
