...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetSortBy(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetTaxCodes(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetTranstype(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SalesTaxEditParamRow:
   def __init__(self, obj):
      self.CurTaxReportID:str = obj["CurTaxReportID"]
      """  tax report id  """  
      ...
      self.OrigIncludeAP:bool = obj["OrigIncludeAP"]
      self.OrigIncludeAR:bool = obj["OrigIncludeAR"]
      self.OrigReportCategoryList:str = obj["OrigReportCategoryList"]
      self.OrigSupplierList:str = obj["OrigSupplierList"]
      self.OrigTaxCodeList:str = obj["OrigTaxCodeList"]
      self.OrigTaxJurisList:str = obj["OrigTaxJurisList"]
      self.OrigTaxLiabilityList:str = obj["OrigTaxLiabilityList"]
      self.OrigCustomerList:str = obj["OrigCustomerList"]
      self.CurrDesc:str = obj["CurrDesc"]
      self.CurrencyCode:str = obj["CurrencyCode"]
      self.AccountSummary:bool = obj["AccountSummary"]
      ...
      self.OrigRevReportCategoryList:str = obj["OrigRevReportCategoryList"]
      self.BackdatedItem:int = obj["BackdatedItem"]
      self.PrintSelCriteria:bool = obj["PrintSelCriteria"]
      self.OrigBackdatedItem:int = obj["OrigBackdatedItem"]
...
class Erp_Tablesets_SalesTaxEditTableset:
   def __init__(self, obj):
      self.SalesTaxEditParam:list[Erp_Tablesets_SalesTaxEditParamRow] = obj["SalesTaxEditParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SalesTaxEditTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SalesTaxEditTableset] = obj["returnObj"]
      pass
...
class GetSortBy_input:
   """ Required : 
   TransTypeIn
   """  
   def __init__(self, obj):
      self.TransTypeIn:str = obj["TransTypeIn"]
      pass
...
class GetSortBy_output:
   ...
   def parameters(self, obj):
      self.Sortby:str = obj["parameters"]
      pass

      """  output parameters  """  

class GetTaxCodes_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.TaxCodeList:str = obj["parameters"]
      pass
...
class GetTranstype_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.TransType:str = obj["parameters"]
      pass
