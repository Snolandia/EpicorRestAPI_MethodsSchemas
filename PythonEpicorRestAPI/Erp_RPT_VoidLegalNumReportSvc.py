...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.VoidLegalNumReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.VoidLegalNumReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_SetDates(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.VoidLegalNumReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_SetDatesFiscalYear(requestBody, epicorHeaders = None):
   """  
...
async def post_SetDatesFiscalYearSuffix(requestBody, epicorHeaders = None):
   """  
...
async def post_SetDatesFiscalPeriod(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.VoidLegalNumReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.VoidLegalNumReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_VoidLegalNumReportTableset:
   def __init__(self, obj):
      self.VoidLegalNumberReportParam:list[Erp_Tablesets_VoidLegalNumberReportParamRow] = obj["VoidLegalNumberReportParam"]
      self.ReportStyle:list[Erp_Tablesets_ReportStyleRow] = obj["ReportStyle"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_VoidLegalNumberReportParamRow:
   def __init__(self, obj):
      self.LegalNumberList:str = obj["LegalNumberList"]
      ...
      self.ShowUnused:bool = obj["ShowUnused"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_VoidLegalNumReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_VoidLegalNumReportTableset] = obj["returnObj"]
      pass
...
class SetDatesFiscalPeriod_input:
   """ Required : 
   ds
   pFiscalPeriod
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_VoidLegalNumReportTableset] = obj["ds"]
      self.pFiscalPeriod:int = obj["pFiscalPeriod"]
      """  proposed Fiscal Period  """  
      pass

class SetDatesFiscalPeriod_output:
   def __init__(self, obj):
      pass
...
class SetDatesFiscalYearSuffix_input:
   """ Required : 
   ds
   pFiscalYearSuffix
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_VoidLegalNumReportTableset] = obj["ds"]
      self.pFiscalYearSuffix:str = obj["pFiscalYearSuffix"]
      """  proposed Fiscal Year Suffix  """  
      pass

class SetDatesFiscalYearSuffix_output:
   def __init__(self, obj):
      pass
...
class SetDatesFiscalYear_input:
   """ Required : 
   ds
   pFiscalYear
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_VoidLegalNumReportTableset] = obj["ds"]
      self.pFiscalYear:int = obj["pFiscalYear"]
      """  proposed Fiscal Year  """  
      pass

class SetDatesFiscalYear_output:
   def __init__(self, obj):
      pass
...
class SetDates_input:
   ...
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_VoidLegalNumReportTableset] = obj["ds"]
      self.pFiscalCalendarID:str = obj["pFiscalCalendarID"]
      """  proposed Calendar ID  """  
      pass

class SetDates_output:
   def __init__(self, obj):
      pass
