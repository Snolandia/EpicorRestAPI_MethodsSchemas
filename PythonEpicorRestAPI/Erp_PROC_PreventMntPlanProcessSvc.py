...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PreventMntPlanProcessSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PreventMntPlanProcessSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PreventMntPlanProcessSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.PreventMntPlanProcessSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PreventMntPlanProcessRow:
   def __init__(self, obj):
      self.Continuous:bool = obj["Continuous"]
      self.ProcessDelay:int = obj["ProcessDelay"]
      self.EquipLocList:str = obj["EquipLocList"]
      self.EquipStatusList:str = obj["EquipStatusList"]
      self.EquipTypeList:str = obj["EquipTypeList"]
...
class Erp_Tablesets_PreventMntPlanProcessTableset:
   def __init__(self, obj):
      self.PreventMntPlanProcess:list[Erp_Tablesets_PreventMntPlanProcessRow] = obj["PreventMntPlanProcess"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PreventMntPlanProcessTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PreventMntPlanProcessTableset] = obj["returnObj"]
      pass
