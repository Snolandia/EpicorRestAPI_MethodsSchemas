...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.RPT.FailedLogonAuditLogSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.RPT.FailedLogonAuditLogSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.RPT.FailedLogonAuditLogSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.RPT.FailedLogonAuditLogSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.RPT.FailedLogonAuditLogSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class GetDefaults_input:
   ...
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_FailedLogonAuditLogTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_FailedLogonAuditLogTableset] = obj["returnObj"]
      pass
...
class Ice_Tablesets_FailedLogonAuditLogParamRow:
   def __init__(self, obj):
...
class Ice_Tablesets_FailedLogonAuditLogTableset:
   def __init__(self, obj):
      self.FailedLogonAuditLogParam:list[Ice_Tablesets_FailedLogonAuditLogParamRow] = obj["FailedLogonAuditLogParam"]
