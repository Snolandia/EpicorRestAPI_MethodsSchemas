...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_PcLookupColSetHedSearches(select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetHedSearches",headers=creds) as resp:
           return await resp.json()

async def post_PcLookupColSetHedSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetHedSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_PcLookupColSetHedSearches_Company_LookupTblID_ColSetID(Company, LookupTblID, ColSetID, select = None, expand = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetHedSearches(" + Company + "," + LookupTblID + "," + ColSetID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_PcLookupColSetHedSearches_Company_LookupTblID_ColSetID(Company, LookupTblID, ColSetID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetHedSearches(" + Company + "," + LookupTblID + "," + ColSetID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_PcLookupColSetHedSearches_Company_LookupTblID_ColSetID(Company, LookupTblID, ColSetID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetHedSearches(" + Company + "," + LookupTblID + "," + ColSetID + ")",headers=creds) as resp:
           return await resp.json()

async def get_PcLookupColSetHedSearches_Company_LookupTblID_ColSetID_PcLookupColSetDtls(Company, LookupTblID, ColSetID, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetHedSearches(" + Company + "," + LookupTblID + "," + ColSetID + ")/PcLookupColSetDtls",headers=creds) as resp:
           return await resp.json()

async def get_PcLookupColSetHedSearches_Company_LookupTblID_ColSetID_PcLookupColSetDtls_Company_LookupTblID_ColSetID_ColName(Company, LookupTblID, ColSetID, ColName, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetHedSearches(" + Company + "," + LookupTblID + "," + ColSetID + ")/PcLookupColSetDtls(" + Company + "," + LookupTblID + "," + ColSetID + "," + ColName + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_PcLookupColSetDtls(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetDtls",headers=creds) as resp:
           return await resp.json()
...
async def post_PcLookupColSetDtls(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetDtls", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_PcLookupColSetDtls_Company_LookupTblID_ColSetID_ColName(Company, LookupTblID, ColSetID, ColName, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetDtls(" + Company + "," + LookupTblID + "," + ColSetID + "," + ColName + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_PcLookupColSetDtls_Company_LookupTblID_ColSetID_ColName(Company, LookupTblID, ColSetID, ColName, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetDtls(" + Company + "," + LookupTblID + "," + ColSetID + "," + ColName + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_PcLookupColSetDtls_Company_LookupTblID_ColSetID_ColName(Company, LookupTblID, ColSetID, ColName, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/PcLookupColSetDtls(" + Company + "," + LookupTblID + "," + ColSetID + "," + ColName + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClausePcLookupColSetHed, whereClausePcLookupColSetDtl, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(lookupTblID, colSetID, epicorHeaders = None):
   """  
...
async def post_GetNewPcLookupColSetHed(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PcLookupColSetHedSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PcLookupColSetHedListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PcLookupColSetHedListRow] = obj["value"]
      pass
...
class Erp_Tablesets_PcLookupColSetHedListRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company  """  
      self.ColSetID:str = obj["ColSetID"]
...
class Erp_Tablesets_PcLookupColSetHedSearchTableset:
   def __init__(self, obj):
...
class Erp_Tablesets_PcLookupColSetSearchListTableset:
   def __init__(self, obj):
      self.PcLookupColSetHedList:list[Erp_Tablesets_PcLookupColSetHedListRow] = obj["PcLookupColSetHedList"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtPcLookupColSetHedSearchTableset:
   def __init__(self, obj):
      self.PcLookupColSetHed:list[Erp_Tablesets_PcLookupColSetHedRow] = obj["PcLookupColSetHed"]
      self.PcLookupColSetDtl:list[Erp_Tablesets_PcLookupColSetDtlRow] = obj["PcLookupColSetDtl"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PcLookupColSetHedSearchTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PcLookupColSetSearchListTableset] = obj["returnObj"]
      pass
...
class GetNewPcLookupColSetDtl_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PcLookupColSetHedSearchTableset] = obj["ds"]
      self.lookupTblID:str = obj["lookupTblID"]
      self.colSetID:str = obj["colSetID"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtPcLookupColSetHedSearchTableset] = obj["ds"]
