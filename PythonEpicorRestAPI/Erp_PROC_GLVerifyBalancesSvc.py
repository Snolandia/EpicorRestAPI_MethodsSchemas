...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_CheckCOAFmtChange(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetBalanceFmtChange(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangedYear(requestBody, epicorHeaders = None):
   """  
...
async def post_CheckEndDate(requestBody, epicorHeaders = None):
   """  
...
async def post_CheckStartDate(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class ChangedYear_input:
   ...
   def __init__(self, obj):
      self.inFiscalYear:int = obj["inFiscalYear"]
      self.inFiscalYearSuffix:str = obj["inFiscalYearSuffix"]
      self.inIsStartYear:bool = obj["inIsStartYear"]
      self.ds:list[Erp_Tablesets_GLVerifyBalancesTableset] = obj["ds"]
      pass

class ChangedYear_output:
   def __init__(self, obj):
      pass
...
class CheckCOAFmtChange_input:
   ...
   def __init__(self, obj):
      ...
      """  Book ID  """  
      self.clearFilter:bool = obj["clearFilter"]
      """  clear filter  """  
      pass

class CheckCOAFmtChange_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_GLVerifyBalancesParamRow:
   def __init__(self, obj):
      self.GLBook:str = obj["GLBook"]
      """  General Ledger Book ID to verify balances  """  
      self.UpdateBalances:bool = obj["UpdateBalances"]
      ...
      self.VerifyPerBal:bool = obj["VerifyPerBal"]
      ...
      self.StartFiscalYear:int = obj["StartFiscalYear"]
      ...
      self.EndFiscalYear:int = obj["EndFiscalYear"]
      ...
      self.VerifyDaily:bool = obj["VerifyDaily"]
      """  Logical indicating if the daily balances are to be verified.  """  
      self.DailyStart:str = obj["DailyStart"]
      """  First date to verify daily balances.  """  
      self.DailyEnd:str = obj["DailyEnd"]
      """  Last date to verify daily balancees.  """  
      self.NaturalAccounts:str = obj["NaturalAccounts"]
      ...
      """  GL Book Description  """  
      self.StandardTrialBalances:bool = obj["StandardTrialBalances"]
...
class Erp_Tablesets_GLVerifyBalancesTableset:
   def __init__(self, obj):
      self.GLVerifyBalancesParam:list[Erp_Tablesets_GLVerifyBalancesParamRow] = obj["GLVerifyBalancesParam"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class GetBalanceFmtChange_input:
   """ Required : 
   bookID
   """  
   def __init__(self, obj):
...
class GetBalanceFmtChange_output:
   def __init__(self, obj):
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLVerifyBalancesTableset] = obj["returnObj"]
      pass
