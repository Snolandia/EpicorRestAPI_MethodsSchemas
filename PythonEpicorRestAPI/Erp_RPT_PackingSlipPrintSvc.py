...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_HHValidateReportStyle(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_GetDocCopyNumber(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PackingSlipParamRow:
   def __init__(self, obj):
      self.PackNum:int = obj["PackNum"]
      """  Pack slip number  """  
      self.PrintingOptions:str = obj["PrintingOptions"]
      ...
      self.DCHdrList:str = obj["DCHdrList"]
      self.PackNumList:str = obj["PackNumList"]
      self.StyleNumExt:int = obj["StyleNumExt"]
      self.EnableIncludePCID:bool = obj["EnableIncludePCID"]
      """  Indicates if field IncludePCID will be enabled for the input  """  
      self.IncludePCID:bool = obj["IncludePCID"]
      """  Indicated if PCID details will be included on the report  """  
      self.DocCopyNum:str = obj["DocCopyNum"]
      """  Document Copy Number  """  
      self.DraftMode:bool = obj["DraftMode"]
      ...
      self.IncludeInventoryAttributes:bool = obj["IncludeInventoryAttributes"]
...
class Erp_Tablesets_PackingSlipPrintTableset:
   def __init__(self, obj):
      self.PackingSlipParam:list[Erp_Tablesets_PackingSlipParamRow] = obj["PackingSlipParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PackingSlipPrintTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PackingSlipPrintTableset] = obj["returnObj"]
      pass
...
class HHValidateReportStyle_input:
   """ Required : 
   reportStyleID
   """  
   def __init__(self, obj):
      self.reportStyleID:int = obj["reportStyleID"]
      pass

class HHValidateReportStyle_output:
   def __init__(self, obj):
      pass
