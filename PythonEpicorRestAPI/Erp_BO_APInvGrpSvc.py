...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APInvGrpSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APInvGrpSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_APInvGrps(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APInvGrpSvc/APInvGrps",headers=creds) as resp:
           return await resp.json()

async def post_APInvGrps(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.APInvGrpSvc/APInvGrps", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_APInvGrps_Company_GroupID(Company, GroupID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APInvGrpSvc/APInvGrps(" + Company + "," + GroupID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_APInvGrps_Company_GroupID(Company, GroupID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.APInvGrpSvc/APInvGrps(" + Company + "," + GroupID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_APInvGrps_Company_GroupID(Company, GroupID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.APInvGrpSvc/APInvGrps(" + Company + "," + GroupID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APInvGrpSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseAPInvGrp, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APInvGrpSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRowsUseLockSetting(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.APInvGrpSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetNewAPInvGrpNoLock(requestBody, epicorHeaders = None):
   """  
...
async def post_GetNewAPInvGrpForBOE(requestBody, epicorHeaders = None):
   """  
...
async def post_GetAPInvGrpForBOE(requestBody, epicorHeaders = None):
   """  
...
async def post_UnlockAPGroup(requestBody, epicorHeaders = None):
   """  
...
async def post_LockAPGroup(requestBody, epicorHeaders = None):
   """  
...
async def post_GetNewAPInvGrp(requestBody, epicorHeaders = None):
   """  
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_APInvGrpListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_APInvGrpListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_APInvGrpRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_APInvGrpRow] = obj["value"]
      pass

class Erp_Tablesets_APInvGrpListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_APInvGrpRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.GroupID:str = obj["GroupID"]
...
"Invoice with no detail",
 "Invoice Total does not agree with vendor 's total"....  """  
      ...
      self.BaseTotal:int = obj["BaseTotal"]
      self.DispPostErrorLog:str = obj["DispPostErrorLog"]
      self.GenLegalNumsEnabled:bool = obj["GenLegalNumsEnabled"]
...
class Erp_Tablesets_APInvGrpListTableset:
   def __init__(self, obj):
      self.APInvGrpList:list[Erp_Tablesets_APInvGrpListRow] = obj["APInvGrpList"]
...
class Erp_Tablesets_APInvGrpTableset:
   def __init__(self, obj):
      self.APInvGrp:list[Erp_Tablesets_APInvGrpRow] = obj["APInvGrp"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtAPInvGrpTableset:
   def __init__(self, obj):
      self.APInvGrp:list[Erp_Tablesets_APInvGrpRow] = obj["APInvGrp"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class GetAPInvGrpForBOE_input:
   """ Required : 
   groupID
   ds
   """  
   def __init__(self, obj):
      self.groupID:str = obj["groupID"]
      """  Group ID  """  
      self.ds:list[Erp_Tablesets_APInvGrpTableset] = obj["ds"]
      pass

class GetAPInvGrpForBOE_output:
   def __init__(self, obj):
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_APInvGrpTableset] = obj["returnObj"]
      pass
...
class GetListForBOE_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_APInvGrpListTableset] = obj["returnObj"]
      pass
...
class GetNewAPInvGrpForBOE_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class GetNewAPInvGrpForBOE_output:
   def __init__(self, obj):
      pass
...
class GetNewAPInvGrpNoLock_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class GetNewAPInvGrpNoLock_output:
   def __init__(self, obj):
      pass
...
class GetRowsUseLockSetting_input:
   ...
   """  
   def __init__(self, obj):
      self.whereClauseAPInvGrp:str = obj["whereClauseAPInvGrp"]
      self.pageSize:int = obj["pageSize"]
      """  Page Size  """  
      self.absolutePage:int = obj["absolutePage"]
      """  Absolute Page  """  
...
class PrePostGroupInvoices_output:
   ...
   def parameters(self, obj):
      ...
      self.VarianceMessage:str = obj["parameters"]
      self.TaxCalcFlag:bool = obj["TaxCalcFlag"]
      pass

      """  output parameters  """  

class UnlockAPGroup_input:
   """ Required : 
   groupID
   ds
   """  
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtAPInvGrpTableset] = obj["ds"]
