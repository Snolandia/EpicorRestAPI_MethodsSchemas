...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CurrencyReportProcessSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CurrencyReportProcessSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CurrencyReportProcessSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CurrencyReportProcessSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CurrencyReportProcessParamRow:
   def __init__(self, obj):
      self.CurrencyCode:str = obj["CurrencyCode"]
      """  Currency Code of Reporting Currency.  """  
      self.SetAction:bool = obj["SetAction"]
...
class Erp_Tablesets_CurrencyReportProcessTableset:
   def __init__(self, obj):
      self.CurrencyReportProcessParam:list[Erp_Tablesets_CurrencyReportProcessParamRow] = obj["CurrencyReportProcessParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CurrencyReportProcessTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CurrencyReportProcessTableset] = obj["returnObj"]
      pass
