...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLAccountMassDelSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLAccountMassDelSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_GLAccountMassDels(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLAccountMassDelSvc/GLAccountMassDels",headers=creds) as resp:
           return await resp.json()

async def post_GLAccountMassDels(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.GLAccountMassDelSvc/GLAccountMassDels", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_GLAccountMassDels_Company_COACode_SegmentNbr(Company, COACode, SegmentNbr, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLAccountMassDelSvc/GLAccountMassDels(" + Company + "," + COACode + "," + SegmentNbr + ")",headers=creds) as resp:
           return await resp.json()

async def patch_GLAccountMassDels_Company_COACode_SegmentNbr(Company, COACode, SegmentNbr, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.GLAccountMassDelSvc/GLAccountMassDels(" + Company + "," + COACode + "," + SegmentNbr + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_GLAccountMassDels_Company_COACode_SegmentNbr(Company, COACode, SegmentNbr, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.GLAccountMassDelSvc/GLAccountMassDels(" + Company + "," + COACode + "," + SegmentNbr + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLAccountMassDelSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseGLAccountMassDel, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLAccountMassDelSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewGLAccountMassDel(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.GLAccountMassDelSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_GLAccountMassDelListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_GLAccountMassDelListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_GLAccountMassDelRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_GLAccountMassDelRow] = obj["value"]
      pass

class Erp_Tablesets_GLAccountMassDelListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_GLAccountMassDelRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.COACode:str = obj["COACode"]
...
3 (three) - Optional.  The segment is not required to be entered.  """  
      ...
      self.CategorySelectionList:str = obj["CategorySelectionList"]
      """  Category Selection List  """  
      self.DeleteBlanks:bool = obj["DeleteBlanks"]
      self.BitFlag:int = obj["BitFlag"]
      self.RowMod:str = obj["RowMod"]
      """  RowMod  """  
      pass
...
class Erp_Tablesets_GLAccountMassDelListTableset:
   def __init__(self, obj):
      self.GLAccountMassDelList:list[Erp_Tablesets_GLAccountMassDelListRow] = obj["GLAccountMassDelList"]
...
class Erp_Tablesets_GLAccountMassDelTableset:
   def __init__(self, obj):
      self.GLAccountMassDel:list[Erp_Tablesets_GLAccountMassDelRow] = obj["GLAccountMassDel"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtGLAccountMassDelTableset:
   def __init__(self, obj):
      self.GLAccountMassDel:list[Erp_Tablesets_GLAccountMassDelRow] = obj["GLAccountMassDel"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLAccountMassDelTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLAccountMassDelListTableset] = obj["returnObj"]
      pass
...
class GetNewGLAccountMassDel_input:
   """ Required : 
   ds
   coACode
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GLAccountMassDelTableset] = obj["ds"]
      self.coACode:str = obj["coACode"]
      pass

class GetNewGLAccountMassDel_output:
   def __init__(self, obj):
      pass
...
class GetRows_input:
   """ Required : 
   whereClauseGLAccountMassDel
   pageSize
   absolutePage
   """  
   def __init__(self, obj):
      self.whereClauseGLAccountMassDel:str = obj["whereClauseGLAccountMassDel"]
      self.pageSize:int = obj["pageSize"]
      self.absolutePage:int = obj["absolutePage"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtGLAccountMassDelTableset] = obj["ds"]
