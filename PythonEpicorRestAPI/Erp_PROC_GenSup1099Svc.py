...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GenSup1099Svc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GenSup1099Svc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_IsAllSitesAuthorized(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.GenSup1099Svc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GenSup1099Svc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.GenSup1099Svc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_GenSup1099ParamRow:
   def __init__(self, obj):
      self.FormTypeList:str = obj["FormTypeList"]
      """  List of 1099 form types to process  """  
      self.GenMode:str = obj["GenMode"]
      """  Generation Mode  """  
      self.IncludeSubmitted:bool = obj["IncludeSubmitted"]
...
class Erp_Tablesets_GenSup1099Tableset:
   def __init__(self, obj):
      self.GenSup1099Param:list[Erp_Tablesets_GenSup1099ParamRow] = obj["GenSup1099Param"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GenSup1099Tableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GenSup1099Tableset] = obj["returnObj"]
      pass
