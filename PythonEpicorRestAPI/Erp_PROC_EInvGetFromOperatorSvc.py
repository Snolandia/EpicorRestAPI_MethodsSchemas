...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.EInvGetFromOperatorSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.EInvGetFromOperatorSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetInvoiceParams(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.EInvGetFromOperatorSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.EInvGetFromOperatorSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_EInvGetFromOperatorParamRow:
...
class Erp_Tablesets_EInvGetFromOperatorTableset:
   def __init__(self, obj):
      self.EInvGetFromOperatorParam:list[Erp_Tablesets_EInvGetFromOperatorParamRow] = obj["EInvGetFromOperatorParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_EInvGetFromOperatorTableset] = obj["ds"]
      pass
...
class GetInvoiceParams_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_EInvGetFromOperatorTableset] = obj["returnObj"]
      pass
