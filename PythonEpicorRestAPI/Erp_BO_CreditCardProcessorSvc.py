...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_CreditCardProcessors(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/CreditCardProcessors",headers=creds) as resp:
           return await resp.json()
...
async def post_CreditCardProcessors(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/CreditCardProcessors", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_CreditCardProcessors_Company_ProcessorNum(Company, ProcessorNum, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/CreditCardProcessors(" + Company + "," + ProcessorNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_CreditCardProcessors_Company_ProcessorNum(Company, ProcessorNum, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/CreditCardProcessors(" + Company + "," + ProcessorNum + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_CreditCardProcessors_Company_ProcessorNum(Company, ProcessorNum, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/CreditCardProcessors(" + Company + "," + ProcessorNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseCreditCardProcessor, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(processorNum, epicorHeaders = None):
   """  
...
async def post_GetNewCreditCardProcessor(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_CreditCardProcessorListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_CreditCardProcessorListRow] = obj["value"]
      pass
...
class Erp_Tablesets_CreditCardProcessorListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_CreditCardProcessorListTableset:
   def __init__(self, obj):
      self.CreditCardProcessorList:list[Erp_Tablesets_CreditCardProcessorListRow] = obj["CreditCardProcessorList"]
...
class Erp_Tablesets_CreditCardProcessorTableset:
   def __init__(self, obj):
      self.CreditCardProcessor:list[Erp_Tablesets_CreditCardProcessorRow] = obj["CreditCardProcessor"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtCreditCardProcessorTableset:
   def __init__(self, obj):
      self.CreditCardProcessor:list[Erp_Tablesets_CreditCardProcessorRow] = obj["CreditCardProcessor"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CreditCardProcessorTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CreditCardProcessorListTableset] = obj["returnObj"]
      pass
...
class GetNewCreditCardProcessor_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CreditCardProcessorTableset] = obj["ds"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtCreditCardProcessorTableset] = obj["ds"]
