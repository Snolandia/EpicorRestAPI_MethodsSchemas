...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CNBookVoucherFCReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CNBookVoucherFCReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_OnChangeOfBookID(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CNBookVoucherFCReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CNBookVoucherFCReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CNBookVoucherFCReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CNBookVoucherFCReportParamRow:
   def __init__(self, obj):
      ...
      self.JrnCode:str = obj["JrnCode"]
      self.JrnNum:int = obj["JrnNum"]
      self.JrnNumList:str = obj["JrnNumList"]
      ...
      self.NumLinesPerVoucher:int = obj["NumLinesPerVoucher"]
      self.FiveLines:bool = obj["FiveLines"]
      """  Obsolete parameter  """  
      self.TWNumFmtDay:bool = obj["TWNumFmtDay"]
      self.TWNumFmtJrnCode:bool = obj["TWNumFmtJrnCode"]
      self.TWNumFmtJrnNum:bool = obj["TWNumFmtJrnNum"]
      self.TWNumFmtMonth:bool = obj["TWNumFmtMonth"]
      self.TWNumFmtROCYear:bool = obj["TWNumFmtROCYear"]
      self.DynSegmentDescSrc:str = obj["DynSegmentDescSrc"]
...
class Erp_Tablesets_CNBookVoucherFCReportTableset:
   def __init__(self, obj):
      self.CNBookVoucherFCReportParam:list[Erp_Tablesets_CNBookVoucherFCReportParamRow] = obj["CNBookVoucherFCReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CNBookVoucherFCReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CNBookVoucherFCReportTableset] = obj["returnObj"]
      pass
