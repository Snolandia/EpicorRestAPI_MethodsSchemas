...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SetPOTotalAndTaxDefaultsSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SetPOTotalAndTaxDefaultsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SetPOTotalAndTaxDefaultsSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.SetPOTotalAndTaxDefaultsSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_SetPOTotalAndTaxDefaultsParamRow:
   def __init__(self, obj):
      ...
      self.IncludeClosedPOs:bool = obj["IncludeClosedPOs"]
      """  If true, include Closed PO's in the process.  If false, only Open PO's will be considered.  """  
      self.RecalculateExistingTotals:bool = obj["RecalculateExistingTotals"]
      ...
      self.SetTaxDefaults:bool = obj["SetTaxDefaults"]
...
class Erp_Tablesets_SetPOTotalAndTaxDefaultsTableset:
   def __init__(self, obj):
      self.SetPOTotalAndTaxDefaultsParam:list[Erp_Tablesets_SetPOTotalAndTaxDefaultsParamRow] = obj["SetPOTotalAndTaxDefaultsParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SetPOTotalAndTaxDefaultsTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SetPOTotalAndTaxDefaultsTableset] = obj["returnObj"]
      pass
