...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.THLocGLJrnPostSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.THLocGLJrnPostSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_CheckRights(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.THLocGLJrnPostSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_ExcludePR(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.THLocGLJrnPostSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.THLocGLJrnPostSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_THLocGLJrnPostParamRow:
   def __init__(self, obj):
      ...
      self.JournalList:str = obj["JournalList"]
      self.SysRowID:str = obj["SysRowID"]
...
class Erp_Tablesets_THLocGLJrnPostTableset:
   def __init__(self, obj):
      self.THLocGLJrnPostParam:list[Erp_Tablesets_THLocGLJrnPostParamRow] = obj["THLocGLJrnPostParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_THLocGLJrnPostTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_THLocGLJrnPostTableset] = obj["returnObj"]
      pass
