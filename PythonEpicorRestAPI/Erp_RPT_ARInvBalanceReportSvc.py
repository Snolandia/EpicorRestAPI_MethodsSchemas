...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvBalanceReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvBalanceReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetCodeDescList(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvBalanceReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvBalanceReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvBalanceReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class ChangedIncludeGLAcct_input:
   ...
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ARInvBalanceReportTableset] = obj["ds"]
      pass
...
class Erp_Tablesets_ARInvBalanceParamRow:
   def __init__(self, obj):
      self.BalInCredit:bool = obj["BalInCredit"]
...
class Erp_Tablesets_ARInvBalanceReportTableset:
   def __init__(self, obj):
      self.ARInvBalanceParam:list[Erp_Tablesets_ARInvBalanceParamRow] = obj["ARInvBalanceParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ARInvBalanceReportTableset] = obj["returnObj"]
      pass
