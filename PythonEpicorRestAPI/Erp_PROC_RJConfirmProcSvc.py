...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RJConfirmProcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RJConfirmProcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_SubmitMultipleToAgent(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.RJConfirmProcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RJConfirmProcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_RJConfirmProcParamRow:
   def __init__(self, obj):
      self.RvJrnUID:int = obj["RvJrnUID"]
      self.Confirm:bool = obj["Confirm"]
      self.RvJrnUIDList:str = obj["RvJrnUIDList"]
...
class Erp_Tablesets_RJConfirmProcTableset:
   def __init__(self, obj):
      self.RJConfirmProcParam:list[Erp_Tablesets_RJConfirmProcParamRow] = obj["RJConfirmProcParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_RJConfirmProcTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_RJConfirmProcTableset] = obj["returnObj"]
      pass
...
class SubmitMultipleToAgent_input:
   """ Required : 
   ds
   agentID
   agentSchedNum
...
class SubmitMultipleToAgent_output:
   def __init__(self, obj):
      pass
