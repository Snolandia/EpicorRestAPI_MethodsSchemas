...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PartLotWhereUsedReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PartLotWhereUsedReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetReportFormat(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PartLotWhereUsedReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_LotTrackedPart(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PartLotWhereUsedReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_ValidLotsForPart(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PartLotWhereUsedReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PartLotWhereUsedParamRow:
   def __init__(self, obj):
      self.Part:str = obj["Part"]
      self.Lot:str = obj["Lot"]
...
class Erp_Tablesets_PartLotWhereUsedReportTableset:
   def __init__(self, obj):
      self.PartLotWhereUsedParam:list[Erp_Tablesets_PartLotWhereUsedParamRow] = obj["PartLotWhereUsedParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PartLotWhereUsedReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PartLotWhereUsedReportTableset] = obj["returnObj"]
      pass
...
class ValidLotsForPart_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.ValidLots:str = obj["parameters"]
      pass
