...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetBreakOn(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetSortBy(epicorHeaders = None):
   """  
...
async def post_SetPrintInventoryAttributes(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MtlQueueRptParamRow:
   def __init__(self, obj):
      ...
      self.MtlQueueSeq:str = obj["MtlQueueSeq"]
      """  List of Material Queue sequence numbers separated by a tilde ~.  """  
      self.PageBreak:str = obj["PageBreak"]
      ...
      self.OrderLineReleaseList:str = obj["OrderLineReleaseList"]
      ...
      self.PrintAttributes:bool = obj["PrintAttributes"]
...
class Erp_Tablesets_MtlQueueRptTableset:
   def __init__(self, obj):
      self.MtlQueueRptParam:list[Erp_Tablesets_MtlQueueRptParamRow] = obj["MtlQueueRptParam"]
...
class GetBreakOn_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.breakonlist:str = obj["parameters"]
      pass
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MtlQueueRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MtlQueueRptTableset] = obj["returnObj"]
      pass
...
class SetPrintInventoryAttributes_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class SetPrintInventoryAttributes_output:
   def __init__(self, obj):
      pass
