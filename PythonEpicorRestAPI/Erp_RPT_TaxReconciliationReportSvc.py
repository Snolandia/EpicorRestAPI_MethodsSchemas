...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TaxReconciliationReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TaxReconciliationReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetDateOfPeriod(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TaxReconciliationReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_BookChanged(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangeOfFiscalYearSuffix(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangeOfStartPeriod(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangeOfEndPeriod(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangingOfBook(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TaxReconciliationReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TaxReconciliationReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class BookChanged_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.outYear:int = obj["parameters"]
      self.outYearSuffix:str = obj["parameters"]
      self.outPeriod:int = obj["parameters"]
...
class Erp_Tablesets_TaxReconciliationReportParamRow:
   def __init__(self, obj):
      ...
      self.OnlyDifferences:bool = obj["OnlyDifferences"]
...
class Erp_Tablesets_TaxReconciliationReportTableset:
   def __init__(self, obj):
      self.TaxReconciliationReportParam:list[Erp_Tablesets_TaxReconciliationReportParamRow] = obj["TaxReconciliationReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TaxReconciliationReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TaxReconciliationReportTableset] = obj["returnObj"]
      pass
...
class OnChangeOfEndPeriod_input:
   """ Required : 
   period
   ds
   """  
...
class OnChangeOfEndPeriod_output:
   def __init__(self, obj):
      pass
...
class OnChangeOfFiscalYearSuffix_input:
   """ Required : 
   fiscalYearSuffix
   ds
   """  
...
class OnChangeOfFiscalYearSuffix_output:
   def __init__(self, obj):
      pass
...
class OnChangeOfStartPeriod_input:
   """ Required : 
   period
   ds
   """  
...
class OnChangeOfStartPeriod_output:
   def __init__(self, obj):
      pass
...
class OnChangingOfBook_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.coaChanged:bool = obj["coaChanged"]
      self.ds:list[Erp_Tablesets_TaxReconciliationReportTableset] = obj["ds"]
      pass
