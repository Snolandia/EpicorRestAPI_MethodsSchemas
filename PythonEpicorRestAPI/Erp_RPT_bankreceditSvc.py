...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.bankreceditSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.bankreceditSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.bankreceditSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.bankreceditSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.bankreceditSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_bankreceditRow:
   def __init__(self, obj):
      ...
      self.ShowOutstandingItems:bool = obj["ShowOutstandingItems"]
      """  Enables viewing Outstanding items  """  
      self.ShowDocuments:bool = obj["ShowDocuments"]
      """  Enables viewing matched documents  """  
      self.ShowVariance:bool = obj["ShowVariance"]
      """  Enables viewing Variance on statement line  """  
      self.ShowLineLevelGLAccounts:bool = obj["ShowLineLevelGLAccounts"]
...
class Erp_Tablesets_bankreceditTableset:
   def __init__(self, obj):
      self.bankrecedit:list[Erp_Tablesets_bankreceditRow] = obj["bankrecedit"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_bankreceditTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_bankreceditTableset] = obj["returnObj"]
      pass
