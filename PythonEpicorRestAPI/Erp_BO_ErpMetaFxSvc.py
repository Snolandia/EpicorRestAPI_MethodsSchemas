...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ErpMetaFxSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ErpMetaFxSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetApp(request, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.ErpMetaFxSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_Upgrade(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.ErpMetaFxSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetPage(request, epicorHeaders = None):
   """  
...
class Epicor_MetaFX_Core_Models_Configurator_SyncRequest:
   """ Required : 
   CompanyID
   ConfigId
   ExtCompanyID
...
class Epicor_MetaFX_Core_Models_EpMetaFxCacheInvalidateRequest:
   def __init__(self, obj):
      self.viewId:str = obj["viewId"]
      self.Type:str = obj["Type"]
...
class Epicor_MetaFX_Core_Models_EpMetaFxComboRequest:
   def __init__(self, obj):
      self.Folder:str = obj["Folder"]
      self.SubFolder:str = obj["SubFolder"]
      pass

class Epicor_MetaFX_Core_Models_EpMetaFxPeekRequest:
   def __init__(self, obj):
      self.like:str = obj["like"]
      self.properties:list[Epicor_MetaFX_Core_Models_EpMetaFxPeekRequestProperty] = obj["properties"]
      pass

class Epicor_MetaFX_Core_Models_EpMetaFxPeekRequestProperty:
   def __init__(self, obj):
...
class Epicor_MetaFX_Core_Models_EpMetaFxResponse_Epicor_MetaFX_Core_Models_BAQReport_ReportResponse:
   def __init__(self, obj):
      ...
      self.Details:list[Epicor_MetaFX_Core_Models_MessageDetail] = obj["Details"]
      pass
...
class Epicor_MetaFX_Core_Models_EpMetaFxSearchRequest:
   def __init__(self, obj):
      self.like:str = obj["like"]
      self.properties:list[Epicor_MetaFX_Core_Models_EpMetaFxSearchRequestProperty] = obj["properties"]
      pass

class Epicor_MetaFX_Core_Models_EpMetaFxSearchRequestProperty:
   def __init__(self, obj):
...
class Epicor_MetaFX_Core_Models_Layers_EpMetaFxGetLayersRequest:
   def __init__(self, obj):
      self.ViewId:str = obj["ViewId"]
      self.ViewSearchText:str = obj["ViewSearchText"]
      self.TypeCode:str = obj["TypeCode"]
      self.DeviceType:str = obj["DeviceType"]
      self.UserName:str = obj["UserName"]
...
class Epicor_MetaFX_Core_Models_MessageDetail:
   def __init__(self, obj):
      self.Message:str = obj["Message"]
      self.Type:str = obj["Type"]
      pass
...
class Erp_Services_BO_EpMetaFxGenerateViewRequest:
   def __init__(self, obj):
      self.Type:str = obj["Type"]
      self.Id:str = obj["Id"]
      self.Company:str = obj["Company"]
...
class GenerateView_input:
   ...
   """  
   def __init__(self, obj):
      self.request:list[Erp_Services_BO_EpMetaFxGenerateViewRequest] = obj["request"]
      pass

class GenerateView_output:
   def __init__(self, obj):
      self.returnObj:list[Epicor_MetaFX_Core_Models_EpMetaFxResponse_Epicor_MetaFX_Core_Models_BAQReport_ReportResponse] = obj["returnObj"]
      pass
...
class GetCombosData_input:
   ...
   """  
   def __init__(self, obj):
      self.request:list[Epicor_MetaFX_Core_Models_EpMetaFxComboRequest] = obj["request"]
      pass
...
class GetLayers_input:
   ...
   """  
   def __init__(self, obj):
      self.request:list[Epicor_MetaFX_Core_Models_Layers_EpMetaFxGetLayersRequest] = obj["request"]
      pass
...
class GetPeek_input:
   ...
   """  
   def __init__(self, obj):
      self.request:list[Epicor_MetaFX_Core_Models_EpMetaFxPeekRequest] = obj["request"]
      pass
...
class GetSearchForm_input:
   ...
   """  
   def __init__(self, obj):
      self.request:list[Epicor_MetaFX_Core_Models_EpMetaFxSearchRequest] = obj["request"]
      pass
...
class InvalidateCache_input:
   ...
   """  
   def __init__(self, obj):
      self.request:list[Epicor_MetaFX_Core_Models_EpMetaFxCacheInvalidateRequest] = obj["request"]
      pass
...
class Sync_input:
   ...
   """  
   def __init__(self, obj):
      self.request:list[Epicor_MetaFX_Core_Models_Configurator_SyncRequest] = obj["request"]
      pass
