...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.servcontanalSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.servcontanalSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetSortBy(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.servcontanalSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.servcontanalSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.servcontanalSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_servcontanalRow:
   def __init__(self, obj):
      self.fromdt:str = obj["fromdt"]
      self.fromdttoken:str = obj["fromdttoken"]
      self.todt:str = obj["todt"]
      self.todttoken:str = obj["todttoken"]
      self.customers:str = obj["customers"]
      self.parts:str = obj["parts"]
      self.ContCodes:str = obj["ContCodes"]
      self.contstatus:str = obj["contstatus"]
      ...
      self.customersID:str = obj["customersID"]
      self.SysRowID:str = obj["SysRowID"]
...
class Erp_Tablesets_servcontanalTableset:
   def __init__(self, obj):
      self.servcontanal:list[Erp_Tablesets_servcontanalRow] = obj["servcontanal"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_servcontanalTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_servcontanalTableset] = obj["returnObj"]
      pass
...
class GetStatus_output:
   ...
   def parameters(self, obj):
      self.Statuslist:str = obj["parameters"]
      pass
