...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0078Svc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0078Svc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetTransactions(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0078Svc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0078Svc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CVJC0078ParamRow:
...
class Erp_Tablesets_CVJC0078Tableset:
   def __init__(self, obj):
      self.CVJC0078Param:list[Erp_Tablesets_CVJC0078ParamRow] = obj["CVJC0078Param"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_CVJC0078TranTableset:
   def __init__(self, obj):
      self.CVJCLaborHed:list[Erp_Tablesets_CVJCLaborHedRow] = obj["CVJCLaborHed"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_CVJCLaborHedRow:
   def __init__(self, obj):
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CVJC0078Tableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CVJC0078Tableset] = obj["returnObj"]
      pass
...
class GetTransactions_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CVJC0078TranTableset] = obj["returnObj"]
      pass
