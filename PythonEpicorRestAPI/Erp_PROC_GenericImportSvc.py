...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_verifyOutputLocation(requestBody, epicorHeaders = None):
   """  
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_GetInitialPath(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_ProcessXML(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_GenericImportTableset:
   def __init__(self, obj):
      self.GenericImportParam:list[Erp_Tablesets_GenericImportParamRow] = obj["GenericImportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GenericImportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GenericImportTableset] = obj["returnObj"]
      pass
...
class ProcessXML_input:
   ...
   """  
   def __init__(self, obj):
      self.xmlContent:str = obj["xmlContent"]
...
class ProcessXML_output:
   ...
   def parameters(self, obj):
      self.apInvoiceGroupID:str = obj["parameters"]
      self.arInvoiceGroupID:str = obj["parameters"]
      pass
...
class verifyOutputLocation_input:
   """ Required : 
   ipXMLPath
   """  
   def __init__(self, obj):
      self.ipXMLPath:str = obj["ipXMLPath"]
      pass

class verifyOutputLocation_output:
   def __init__(self, obj):
      pass
