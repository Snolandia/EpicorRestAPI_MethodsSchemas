...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetInitialPath(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_IsAllSitesAuthorized(epicorHeaders = None):
   """  
...
async def post_OnChangedPlant(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_Export1099ParamRow:
   def __init__(self, obj):
      self.CombinedFiling:bool = obj["CombinedFiling"]
      self.CompanyCity:str = obj["CompanyCity"]
      self.CompanyName1:str = obj["CompanyName1"]
      ...
      self.ElecInterface:int = obj["ElecInterface"]
      self.ElecInterfaceName:str = obj["ElecInterfaceName"]
      self.ExportFile:str = obj["ExportFile"]
      self.FileType:str = obj["FileType"]
      self.LastFiling:bool = obj["LastFiling"]
      self.MailingAddress:str = obj["MailingAddress"]
      self.MarkAsSubmitted:bool = obj["MarkAsSubmitted"]
      self.NewForms:bool = obj["NewForms"]
      self.PayerAddress:str = obj["PayerAddress"]
      self.PayerCity:str = obj["PayerCity"]
      self.PayerName1:str = obj["PayerName1"]
      self.PayerName2:str = obj["PayerName2"]
      self.PayerNameControl:str = obj["PayerNameControl"]
      self.PayerOfficeCode:str = obj["PayerOfficeCode"]
      self.PayerPhone:str = obj["PayerPhone"]
      self.PayerState:str = obj["PayerState"]
      self.PayerTIN:str = obj["PayerTIN"]
      self.PayerZIP:str = obj["PayerZIP"]
      self.PriorYearData:bool = obj["PriorYearData"]
      self.TaxYear:int = obj["TaxYear"]
      self.TransferAgent:bool = obj["TransferAgent"]
      self.TransmControlCode:str = obj["TransmControlCode"]
      self.TransmName1:str = obj["TransmName1"]
      self.TransmName2:str = obj["TransmName2"]
      self.TransmNameControl:str = obj["TransmNameControl"]
      self.TransmTIN:str = obj["TransmTIN"]
      self.MailingAddress2:str = obj["MailingAddress2"]
      self.MailingAddress3:str = obj["MailingAddress3"]
      self.PayerAddress2:str = obj["PayerAddress2"]
      self.PayerAddress3:str = obj["PayerAddress3"]
      self.FormTypeList:str = obj["FormTypeList"]
...
class Erp_Tablesets_Export1099Tableset:
   def __init__(self, obj):
      self.Export1099Param:list[Erp_Tablesets_Export1099ParamRow] = obj["Export1099Param"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_Export1099Tableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_Export1099Tableset] = obj["returnObj"]
      pass
...
class IsAllSitesAuthorized_output:
   def __init__(self, obj):
      self.returnObj:bool = obj["returnObj"]
      pass

class OnChangedPlant_input:
   """ Required : 
   ipPlant
   ds
   """  
