...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetEditListSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetEditListSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.AssetEditListSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetEditListSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.AssetEditListSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_AssetEditListParamRow:
   def __init__(self, obj):
      ...
      self.IncChildAssets:bool = obj["IncChildAssets"]
      self.IncOutdatedTrans:bool = obj["IncOutdatedTrans"]
      self.PostAdditions:bool = obj["PostAdditions"]
      """  Post Additions  """  
      self.PostDepreciations:bool = obj["PostDepreciations"]
      """  Post Depreciations  """  
      self.PostDisposals:bool = obj["PostDisposals"]
      """  Post Disposals  """  
      self.PostImpairments:bool = obj["PostImpairments"]
      self.StartDate:str = obj["StartDate"]
      """  StartDate  """  
      self.StartDateToken:str = obj["StartDateToken"]
      """  StartDateToken  """  
      self.PostRevaluations:bool = obj["PostRevaluations"]
      """  Post Revaluations  """  
...
class Erp_Tablesets_AssetEditListTableset:
   def __init__(self, obj):
      self.AssetEditListParam:list[Erp_Tablesets_AssetEditListParamRow] = obj["AssetEditListParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_AssetEditListTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_AssetEditListTableset] = obj["returnObj"]
      pass
