...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CostWBInternalReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CostWBInternalReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_UpdateInternalPrices(requestBody, epicorHeaders = None):
   """  
...
either prints and/or updates the Internal Price change
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CostWBInternalReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CostWBInternalReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CostWBInternalReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CostWBInternalParamRow:
   def __init__(self, obj):
      self.GroupID:str = obj["GroupID"]
      self.IPercent:int = obj["IPercent"]
      self.IAction:str = obj["IAction"]
...
class Erp_Tablesets_CostWBInternalReportTableset:
   def __init__(self, obj):
      self.CostWBInternalParam:list[Erp_Tablesets_CostWBInternalParamRow] = obj["CostWBInternalParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CostWBInternalReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CostWBInternalReportTableset] = obj["returnObj"]
      pass
...
class UpdateInternalPrices_input:
   """ Required : 
   cGroupID
   cIPercent
   cIAction
   ...
   def __init__(self, obj):
      ...
      self.cIPercent:int = obj["cIPercent"]
      """  Percentage.  """  
      self.cIAction:str = obj["cIAction"]
      """  Action Calculate, print and update.  """  
      pass

class UpdateInternalPrices_output:
   def __init__(self, obj):
      pass
