...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_CustXPrts(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSvc/CustXPrts",headers=creds) as resp:
           return await resp.json()

async def post_CustXPrts(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSvc/CustXPrts", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_CustXPrts_Company_CustNum_PartNum_XPartNum_SysRowID(Company, CustNum, PartNum, XPartNum, SysRowID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSvc/CustXPrts(" + Company + "," + CustNum + "," + PartNum + "," + XPartNum + "," + SysRowID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_CustXPrts_Company_CustNum_PartNum_XPartNum_SysRowID(Company, CustNum, PartNum, XPartNum, SysRowID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSvc/CustXPrts(" + Company + "," + CustNum + "," + PartNum + "," + XPartNum + "," + SysRowID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_CustXPrts_Company_CustNum_PartNum_XPartNum_SysRowID(Company, CustNum, PartNum, XPartNum, SysRowID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSvc/CustXPrts(" + Company + "," + CustNum + "," + PartNum + "," + XPartNum + "," + SysRowID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseCustXPrt, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetCustomerInfo(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_CustXPrtTableset:
   def __init__(self, obj):
      self.CustXPrt:list[Erp_Tablesets_CustXPrtRow] = obj["CustXPrt"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtCustXPrtTableset:
   def __init__(self, obj):
      self.CustXPrt:list[Erp_Tablesets_CustXPrtRow] = obj["CustXPrt"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CustXPrtTableset] = obj["returnObj"]
      pass
...
class GetCustomerInfo_input:
   ...
   def __init__(self, obj):
      ...
      self.ds:list[Erp_Tablesets_CustXPrtTableset] = obj["ds"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtCustXPrtTableset] = obj["ds"]
