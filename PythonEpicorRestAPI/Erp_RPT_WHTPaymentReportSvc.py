...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WHTPaymentReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WHTPaymentReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetWHTPaymentReportData(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WHTPaymentReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WHTPaymentReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WHTPaymentReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_WHTPaymentReportParamRow:
   def __init__(self, obj):
...
class Erp_Tablesets_WHTPaymentReportTableset:
   def __init__(self, obj):
      self.WHTPaymentReportParam:list[Erp_Tablesets_WHTPaymentReportParamRow] = obj["WHTPaymentReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_WHTPaymentReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_WHTPaymentReportTableset] = obj["returnObj"]
      pass
...
class GetWHTPaymentReportData_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class GetWHTPaymentReportData_output:
   def __init__(self, obj):
      pass
