...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MaterialTranDetailSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MaterialTranDetailSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetSortByOptionList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MaterialTranDetailSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetTranTypeCodeList(epicorHeaders = None):
   """  
...
async def post_GetWareHseList(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MaterialTranDetailSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MaterialTranDetailSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MaterialTranDetailTableset:
   def __init__(self, obj):
      self.MaterialTranDtlParam:list[Erp_Tablesets_MaterialTranDtlParamRow] = obj["MaterialTranDtlParam"]
      self.ReportStyle:list[Erp_Tablesets_ReportStyleRow] = obj["ReportStyle"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_MaterialTranDtlParamRow:
   def __init__(self, obj):
      self.BegDate:str = obj["BegDate"]
      """  Beging Date of Report  """  
      self.EndDate:str = obj["EndDate"]
      """  End Date of Report  """  
      self.Parts:str = obj["Parts"]
      """  Parts Selection List  """  
      self.PartWarehouses:str = obj["PartWarehouses"]
      """  Part Warehouses List  """  
      self.PartTranTypes:str = obj["PartTranTypes"]
      """  Part transaction type  """  
      self.StockType:str = obj["StockType"]
      """  Stock Type  """  
      self.SortByOption:str = obj["SortByOption"]
      """  Sortby Option  """  
      self.BegDateToken:str = obj["BegDateToken"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MaterialTranDetailTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MaterialTranDetailTableset] = obj["returnObj"]
      pass
...
class GetTranTypeCodeList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.TranTypeCodeList:str = obj["parameters"]
      pass
...
class GetTranTypeList_output:
   ...
   def parameters(self, obj):
      self.TranTypeList:str = obj["parameters"]
      pass
...
class GetWareHseList_output:
   ...
   def parameters(self, obj):
      self.WareHseList:str = obj["parameters"]
      pass
