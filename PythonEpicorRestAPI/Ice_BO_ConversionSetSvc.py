...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_ConversionSets(select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionSets",headers=creds) as resp:
           return await resp.json()

async def post_ConversionSets(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionSets", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_ConversionSets_Company_SystemCode_ProcessID(Company, SystemCode, ProcessID, select = None, expand = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionSets(" + Company + "," + SystemCode + "," + ProcessID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_ConversionSets_Company_SystemCode_ProcessID(Company, SystemCode, ProcessID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionSets(" + Company + "," + SystemCode + "," + ProcessID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_ConversionSets_Company_SystemCode_ProcessID(Company, SystemCode, ProcessID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionSets(" + Company + "," + SystemCode + "," + ProcessID + ")",headers=creds) as resp:
           return await resp.json()

async def get_ConversionSets_Company_SystemCode_ProcessID_ConversionTasks(Company, SystemCode, ProcessID, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionSets(" + Company + "," + SystemCode + "," + ProcessID + ")/ConversionTasks",headers=creds) as resp:
           return await resp.json()

async def get_ConversionSets_Company_SystemCode_ProcessID_ConversionTasks_Company_SystemCode_ProcessID_SysTaskNum(Company, SystemCode, ProcessID, SysTaskNum, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionSets(" + Company + "," + SystemCode + "," + ProcessID + ")/ConversionTasks(" + Company + "," + SystemCode + "," + ProcessID + "," + SysTaskNum + ")",headers=creds) as resp:
           return await resp.json()

async def get_ConversionTasks(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   Summary: Calls GetRows for the service
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionTasks",headers=creds) as resp:
           return await resp.json()

async def post_ConversionTasks(requestBody, epicorHeaders = None):
   """  
   Summary: Calls UpdateExt to create new item for the service
   Description: Calls UpdateExt to create new item for the service. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li></ul></div>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionTasks", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_ConversionTasks_Company_SystemCode_ProcessID_SysTaskNum(Company, SystemCode, ProcessID, SysTaskNum, select = None, filter = None, epicorHeaders = None):
   """  
   Summary: Calls GetByID to retrieve the ConversionTask item
   Description: Calls GetByID to retrieve the ConversionTask item by specified keys. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li><li>String parameters should be specified in single quotes</li></ul></div>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionTasks(" + Company + "," + SystemCode + "," + ProcessID + "," + SysTaskNum + ")",headers=creds) as resp:
           return await resp.json()

async def patch_ConversionTasks_Company_SystemCode_ProcessID_SysTaskNum(Company, SystemCode, ProcessID, SysTaskNum, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionTasks(" + Company + "," + SystemCode + "," + ProcessID + "," + SysTaskNum + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_ConversionTasks_Company_SystemCode_ProcessID_SysTaskNum(Company, SystemCode, ProcessID, SysTaskNum, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/ConversionTasks(" + Company + "," + SystemCode + "," + ProcessID + "," + SysTaskNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseConversionSet, whereClauseConversionTask, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
whole updated dataset.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_HasRunningConversionSets(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.BO.ConversionSetSvc/List",headers=creds) as resp:
           return await resp.json()

async def post_GetNewConversionSet(requestBody, epicorHeaders = None):
   """  
...
async def post_GetNewConversionTask(requestBody, epicorHeaders = None):
   """  
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Ice_Tablesets_ConversionSetListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Ice_Tablesets_ConversionSetListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Ice_Tablesets_ConversionSetRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Ice_Tablesets_ConversionSetRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Ice_Tablesets_ConversionTaskRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Ice_Tablesets_ConversionTaskRow] = obj["value"]
      pass

class Ice_Tablesets_ConversionSetListRow:
   def __init__(self, obj):
...
class Ice_Tablesets_ConversionSetRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company  """  
      self.SystemCode:str = obj["SystemCode"]
...
class Ice_Tablesets_ConversionTaskRow:
   def __init__(self, obj):
      self.SystemCode:str = obj["SystemCode"]
      """  SystemCode  """  
      self.ProcessID:str = obj["ProcessID"]
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_ConversionSetTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_ConversionSetListTableset] = obj["returnObj"]
      pass
...
class GetNewConversionSet_input:
   """ Required : 
   ds
   company
   systemCode
   """  
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_ConversionSetTableset] = obj["ds"]
      self.company:str = obj["company"]
      self.systemCode:str = obj["systemCode"]
      pass

class GetNewConversionSet_output:
   def __init__(self, obj):
      pass
...
class GetNewConversionTask_input:
   """ Required : 
   ds
   company
   systemCode
...
class GetNewConversionTask_output:
   def __init__(self, obj):
      pass
...
class GetRows_input:
   """ Required : 
   whereClauseConversionSet
   whereClauseConversionTask
   pageSize
   absolutePage
   """  
   def __init__(self, obj):
      self.whereClauseConversionSet:str = obj["whereClauseConversionSet"]
      self.whereClauseConversionTask:str = obj["whereClauseConversionTask"]
      self.pageSize:int = obj["pageSize"]
      self.absolutePage:int = obj["absolutePage"]
      pass
...
class HasRunningConversionSets_output:
   def __init__(self, obj):
...
class Ice_Tablesets_ConversionSetListTableset:
   def __init__(self, obj):
      self.ConversionSetList:list[Ice_Tablesets_ConversionSetListRow] = obj["ConversionSetList"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class Ice_Tablesets_ConversionSetTableset:
   def __init__(self, obj):
      self.ConversionSet:list[Ice_Tablesets_ConversionSetRow] = obj["ConversionSet"]
      self.ConversionTask:list[Ice_Tablesets_ConversionTaskRow] = obj["ConversionTask"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class Ice_Tablesets_UpdExtConversionSetTableset:
   def __init__(self, obj):
      self.ConversionSet:list[Ice_Tablesets_ConversionSetRow] = obj["ConversionSet"]
      self.ConversionTask:list[Ice_Tablesets_ConversionTaskRow] = obj["ConversionTask"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_UpdExtConversionSetTableset] = obj["ds"]
