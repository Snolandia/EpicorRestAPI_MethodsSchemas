...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CORevelationReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CORevelationReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CORevelationReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetUsers(epicorHeaders = None):
   """  
...
async def post_ExcludePR(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CORevelationReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CORevelationReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_CORevelationReportParamRow:
   def __init__(self, obj):
...
class Erp_Tablesets_CORevelationReportTableset:
   def __init__(self, obj):
      self.CORevelationReportParam:list[Erp_Tablesets_CORevelationReportParamRow] = obj["CORevelationReportParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CORevelationReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CORevelationReportTableset] = obj["returnObj"]
      pass
...
class GetUsers_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.UsersAvailable:str = obj["parameters"]
      self.UsersSelectable:str = obj["parameters"]
      pass
