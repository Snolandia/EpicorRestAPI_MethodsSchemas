...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.RepSup1099Svc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.RepSup1099Svc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetSortBy(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.RepSup1099Svc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.RepSup1099Svc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.RepSup1099Svc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_RepSup1099ParamRow:
   def __init__(self, obj):
      self.Details:bool = obj["Details"]
      ...
      self.InclAllInv:bool = obj["InclAllInv"]
      """  Include All Invoices  """  
      self.ReportMode:str = obj["ReportMode"]
      ...
      """  Current Tax Year  """  
      self.InclUserModified:bool = obj["InclUserModified"]
      ...
      """  Filter Plans list  """  
      self.PlantNameList:str = obj["PlantNameList"]
...
class Erp_Tablesets_RepSup1099Tableset:
   def __init__(self, obj):
      self.RepSup1099Param:list[Erp_Tablesets_RepSup1099ParamRow] = obj["RepSup1099Param"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_RepSup1099Tableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_RepSup1099Tableset] = obj["returnObj"]
      pass
