...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderAckSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderAckSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SetPrintInventoryAttributes(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderAckSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderAckSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderAckSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SalesOrderAckParamRow:
   def __init__(self, obj):
      ...
      self.IncludeReleaseAttributes:bool = obj["IncludeReleaseAttributes"]
      """  Parameter to Include Attributes for SO Releases  """  
      self.IncludeSalesKitAttributes:bool = obj["IncludeSalesKitAttributes"]
...
class Erp_Tablesets_SalesOrderAckTableset:
   def __init__(self, obj):
      self.SalesOrderAckParam:list[Erp_Tablesets_SalesOrderAckParamRow] = obj["SalesOrderAckParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SalesOrderAckTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SalesOrderAckTableset] = obj["returnObj"]
      pass
