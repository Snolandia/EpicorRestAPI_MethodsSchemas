...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TrialBalanceSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TrialBalanceSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TrialBalanceSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TrialBalanceSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TrialBalanceSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_TrialBalanceParamRow:
   def __init__(self, obj):
      ...
      self.DailyBalance:bool = obj["DailyBalance"]
      ...
      self.SegmentCodeList:str = obj["SegmentCodeList"]
...
class Erp_Tablesets_TrialBalanceTableset:
   def __init__(self, obj):
      self.TrialBalanceParam:list[Erp_Tablesets_TrialBalanceParamRow] = obj["TrialBalanceParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TrialBalanceTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TrialBalanceTableset] = obj["returnObj"]
      pass
