...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ZKeySvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ZKeySvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_ZKeys(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ZKeySvc/ZKeys",headers=creds) as resp:
           return await resp.json()
...
async def post_ZKeys(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.BO.ZKeySvc/ZKeys", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_ZKeys_SystemCode_DataTableID_KeyID(SystemCode, DataTableID, KeyID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ZKeySvc/ZKeys(" + SystemCode + "," + DataTableID + "," + KeyID + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_ZKeys_SystemCode_DataTableID_KeyID(SystemCode, DataTableID, KeyID, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Ice.BO.ZKeySvc/ZKeys(" + SystemCode + "," + DataTableID + "," + KeyID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_ZKeys_SystemCode_DataTableID_KeyID(SystemCode, DataTableID, KeyID, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Ice.BO.ZKeySvc/ZKeys(" + SystemCode + "," + DataTableID + "," + KeyID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ZKeySvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseZKey, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.BO.ZKeySvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(systemCode, dataTableID, keyID, epicorHeaders = None):
   """  
...
async def post_GetNewZKey(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.BO.ZKeySvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Ice_Tablesets_ZKeyListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Ice_Tablesets_ZKeyListRow] = obj["value"]
      pass
...
class Ice_Tablesets_ZKeyListRow:
   def __init__(self, obj):
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_ZKeyTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_ZKeyListTableset] = obj["returnObj"]
      pass
...
class GetNewZKey_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_ZKeyTableset] = obj["ds"]
      self.systemCode:str = obj["systemCode"]
      self.dataTableID:str = obj["dataTableID"]
      pass
...
class Ice_Tablesets_UpdExtZKeyTableset:
   def __init__(self, obj):
...
class Ice_Tablesets_ZKeyListTableset:
   def __init__(self, obj):
      self.ZKeyList:list[Ice_Tablesets_ZKeyListRow] = obj["ZKeyList"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class Ice_Tablesets_ZKeyTableset:
   def __init__(self, obj):
      self.ZKey:list[Ice_Tablesets_ZKeyRow] = obj["ZKey"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_UpdExtZKeyTableset] = obj["ds"]
