...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.KBMaxQuoteSyncSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.KBMaxQuoteSyncSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetAttachmentDocTypeList(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.KBMaxQuoteSyncSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.KBMaxQuoteSyncSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_KBMaxQuoteSyncParamRow:
   def __init__(self, obj):
      self.AttachmentDocTypeID:str = obj["AttachmentDocTypeID"]
      """  The attachment doc type id determines where the attachment will be uploaded to.  """  
      self.ServerLogPath:str = obj["ServerLogPath"]
      """  Verbose server log path  """  
      self.SyncFromDays:int = obj["SyncFromDays"]
...
class Erp_Tablesets_KBMaxQuoteSyncTableset:
   def __init__(self, obj):
      self.KBMaxQuoteSyncParam:list[Erp_Tablesets_KBMaxQuoteSyncParamRow] = obj["KBMaxQuoteSyncParam"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class GetAttachmentDocTypeList_input:
   """ Required : 
   tableName
   """  
   def __init__(self, obj):
...
class GetAttachmentDocTypeList_output:
   def __init__(self, obj):
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_KBMaxQuoteSyncTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_KBMaxQuoteSyncTableset] = obj["returnObj"]
      pass
