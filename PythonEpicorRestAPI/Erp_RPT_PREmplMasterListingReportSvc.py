...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PREmplMasterListingReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PREmplMasterListingReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetIncludeInfo(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PREmplMasterListingReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetPayClasses(epicorHeaders = None):
   """  
...
async def post_GetPayTypes(epicorHeaders = None):
   """  
...
async def post_GetSortOptions(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PREmplMasterListingReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PREmplMasterListingReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PREmplListParamRow:
   def __init__(self, obj):
      self.OneEmployeePerPage:bool = obj["OneEmployeePerPage"]
      self.SortBy:str = obj["SortBy"]
      """  SortBy  """  
      self.IncludeInfo:str = obj["IncludeInfo"]
      self.EmplList:str = obj["EmplList"]
      self.ShiftList:str = obj["ShiftList"]
      self.JCDeptList:str = obj["JCDeptList"]
      self.PayTypeList:str = obj["PayTypeList"]
      """  "H" for hourly or "S" for Salaried only  """  
      self.PayClassList:str = obj["PayClassList"]
      self.INCLUDETERM:bool = obj["INCLUDETERM"]
...
class Erp_Tablesets_PREmplMasterListingReportTableset:
   def __init__(self, obj):
      self.PREmplListParam:list[Erp_Tablesets_PREmplListParamRow] = obj["PREmplListParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PREmplMasterListingReportTableset] = obj["ds"]
      pass
...
class GetIncludeInfo_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.IncludeOptions:str = obj["parameters"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PREmplMasterListingReportTableset] = obj["returnObj"]
      pass
...
class GetPayClasses_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.PayClasses:str = obj["parameters"]
      pass

      """  output parameters  """  

class GetPayTypes_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.ValidPayTypes:str = obj["parameters"]
      pass
...
class GetSortOptions_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.SORTOptions:str = obj["parameters"]
      pass
