...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DEZ4Z10ReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DEZ4Z10ReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SetFiscalDates(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.DEZ4Z10ReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_CheckBaseCurrency(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.DEZ4Z10ReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_ChangeReportID(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DEZ4Z10ReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class ChangeReportID_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_DEZ4Z10ReportTableset] = obj["ds"]
      pass

class ChangeReportID_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_DEZ4Z10ReportParamRow:
   def __init__(self, obj):
      self.EndDate:str = obj["EndDate"]
      self.ExportPath:str = obj["ExportPath"]
...
class Erp_Tablesets_DEZ4Z10ReportTableset:
   def __init__(self, obj):
      self.DEZ4Z10ReportParam:list[Erp_Tablesets_DEZ4Z10ReportParamRow] = obj["DEZ4Z10ReportParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_DEZ4Z10ReportTableset] = obj["returnObj"]
      pass
