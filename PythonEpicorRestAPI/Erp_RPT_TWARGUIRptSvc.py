...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWARGUIRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWARGUIRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_OnChangeOfReportPeriod(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TWARGUIRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWARGUIRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TWARGUIRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_TWARGUIRptParamRow:
   def __init__(self, obj):
...
class Erp_Tablesets_TWARGUIRptTableset:
   def __init__(self, obj):
      self.TWARGUIRptParam:list[Erp_Tablesets_TWARGUIRptParamRow] = obj["TWARGUIRptParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TWARGUIRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TWARGUIRptTableset] = obj["returnObj"]
      pass
