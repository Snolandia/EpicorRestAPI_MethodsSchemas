...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MscPackSlipSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MscPackSlipSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewParametersAndDefaults(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MscPackSlipSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MscPackSlipSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MscPackSlipSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MscPackSlipParamRow:
...
class Erp_Tablesets_MscPackSlipTableset:
   def __init__(self, obj):
      self.MscPackSlipParam:list[Erp_Tablesets_MscPackSlipParamRow] = obj["MscPackSlipParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MscPackSlipTableset] = obj["ds"]
      pass
...
class GetNewParametersAndDefaults_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MscPackSlipTableset] = obj["returnObj"]
      pass
