...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_IsTaskScheduled(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_cutOffDate_Default(epicorHeaders = None):
   """  
...
async def post_formatElapsedTime(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_DBPurgeRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      self.CutOffDate:str = obj["CutOffDate"]
      self.ChangeLog:bool = obj["ChangeLog"]
      self.LastPurgDt:str = obj["LastPurgDt"]
      self.CutOffDt:str = obj["CutOffDt"]
      self.RunTime:str = obj["RunTime"]
      self.fStatus:str = obj["fStatus"]
      self.fUserID:str = obj["fUserID"]
      self.LstPurgTime:str = obj["LstPurgTime"]
      self.CompanyName:str = obj["CompanyName"]
      self.DelJrnDtls:bool = obj["DelJrnDtls"]
      """  Delete GL Journal Details  """  
      self.DelLabor:bool = obj["DelLabor"]
      """  Delete Labor detail  """  
      self.DelPartTran:bool = obj["DelPartTran"]
      """  Delete PartTran records.  """  
      self.DelChangeLog:bool = obj["DelChangeLog"]
      """  Delete Change log records  """  
      self.DelJob:bool = obj["DelJob"]
      """  Delete Job  """  
      self.DelOrder:bool = obj["DelOrder"]
      """  Delete Sales Orders  """  
      self.DelPO:bool = obj["DelPO"]
      """  Delete Purchase Order  """  
      self.DelDemand:bool = obj["DelDemand"]
      """  Delete Demand records  """  
      self.DelCnfgInput:bool = obj["DelCnfgInput"]
      ...
      self.DelPartWipTran:bool = obj["DelPartWipTran"]
...
class Erp_Tablesets_DBPurgeTableset:
   def __init__(self, obj):
      self.DBPurge:list[Erp_Tablesets_DBPurgeRow] = obj["DBPurge"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_DBPurgeTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_DBPurgeTableset] = obj["returnObj"]
      pass
...
class cutOffDate_Default_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass

class formatElapsedTime_input:
   """ Required : 
   ii_Time
   """  
   def __init__(self, obj):
      self.ii_Time:int = obj["ii_Time"]
      pass

class formatElapsedTime_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass
