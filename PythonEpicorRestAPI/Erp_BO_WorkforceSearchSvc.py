...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.WorkforceSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.WorkforceSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_WorkforceSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.WorkforceSearchSvc/WorkforceSearches",headers=creds) as resp:
           return await resp.json()

async def post_WorkforceSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.WorkforceSearchSvc/WorkforceSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_WorkforceSearches_Company_SalesRepCode(Company, SalesRepCode, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.WorkforceSearchSvc/WorkforceSearches(" + Company + "," + SalesRepCode + ")",headers=creds) as resp:
           return await resp.json()

async def patch_WorkforceSearches_Company_SalesRepCode(Company, SalesRepCode, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.WorkforceSearchSvc/WorkforceSearches(" + Company + "," + SalesRepCode + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_WorkforceSearches_Company_SalesRepCode(Company, SalesRepCode, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.WorkforceSearchSvc/WorkforceSearches(" + Company + "," + SalesRepCode + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.WorkforceSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseSalesRep, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.WorkforceSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetListCustom(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.WorkforceSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_UpdExtWorkforceSearchTableset:
   def __init__(self, obj):
      self.SalesRep:list[Erp_Tablesets_SalesRepRow] = obj["SalesRep"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_WorkforceSearchTableset:
   def __init__(self, obj):
      self.SalesRep:list[Erp_Tablesets_SalesRepRow] = obj["SalesRep"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_WorkforceSearchTableset] = obj["returnObj"]
      pass
...
class GetNewSalesRep_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_WorkforceSearchTableset] = obj["ds"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtWorkforceSearchTableset] = obj["ds"]
