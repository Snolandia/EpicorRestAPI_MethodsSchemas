...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.JobRoHSSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.JobRoHSSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_getFileName(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.JobRoHSSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.JobRoHSSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_JobRoHSParamRow:
   def __init__(self, obj):
      self.JobList:str = obj["JobList"]
      """  Selected Jobs.  """  
      self.RestrictionTypeList:str = obj["RestrictionTypeList"]
...
class Erp_Tablesets_JobRoHSTableset:
   def __init__(self, obj):
      self.JobRoHSParam:list[Erp_Tablesets_JobRoHSParamRow] = obj["JobRoHSParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_JobRoHSTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_JobRoHSTableset] = obj["returnObj"]
      pass
