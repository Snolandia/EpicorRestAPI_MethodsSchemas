...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.FileDataExportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.FileDataExportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.FileDataExportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.PROC.FileDataExportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class GetDefaults_input:
   ...
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_FileDataExportParamsTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_FileDataExportParamsTableset] = obj["returnObj"]
      pass
...
class Ice_Tablesets_FileDataExportParamsRow:
   def __init__(self, obj):
      self.Columns:str = obj["Columns"]
      """  Columns for export. If it's empty or null, system will export all columns.  """  
      self.FileName:str = obj["FileName"]
      """  Name of file.  """  
      self.Format:str = obj["Format"]
      """  File format.  """  
      self.NotificationTitle:str = obj["NotificationTitle"]
      ...
      self.WhereCondition:str = obj["WhereCondition"]
      """  Sorting and filtering condition for service call.  """  
      self.ColumnTitles:str = obj["ColumnTitles"]
...
class Ice_Tablesets_FileDataExportParamsTableset:
   def __init__(self, obj):
      self.FileDataExportParams:list[Ice_Tablesets_FileDataExportParamsRow] = obj["FileDataExportParams"]
