...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.BudgetExportProcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.BudgetExportProcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetCodeDescList(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.BudgetExportProcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetFullCodeDescList(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.BudgetExportProcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_BudgetExportProcParamRow:
   def __init__(self, obj):
      ...
      self.ExcludedNatAccounts:str = obj["ExcludedNatAccounts"]
      """  List of excluded natural accounts.  """  
      self.ExportAccountCategories:str = obj["ExportAccountCategories"]
      self.ExportAccWithoutBudgets:bool = obj["ExportAccWithoutBudgets"]
      self.ExportFileName:str = obj["ExportFileName"]
      self.ExportFileNameDisplay:str = obj["ExportFileNameDisplay"]
      self.ExportFinBudgets:bool = obj["ExportFinBudgets"]
      self.ExportStatBudgets:bool = obj["ExportStatBudgets"]
      self.FiscalCalendarID:str = obj["FiscalCalendarID"]
      """  FiscalCalendarID assigned to the selected GL book.  """  
      self.FiscalYear:int = obj["FiscalYear"]
      self.FiscalYearSuffix:str = obj["FiscalYearSuffix"]
      self.SelectedNatAccounts:str = obj["SelectedNatAccounts"]
      """  List of selected natural accounts.  """  
      self.SelectedSegments:str = obj["SelectedSegments"]
...
class Erp_Tablesets_BudgetExportProcTableset:
   def __init__(self, obj):
      self.BudgetExportProcParam:list[Erp_Tablesets_BudgetExportProcParamRow] = obj["BudgetExportProcParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_BudgetExportProcTableset] = obj["ds"]
      pass
...
class GetFullCodeDescList_input:
   """ Required : 
   tableName
   fieldName
   """  
...
class GetFullCodeDescList_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_BudgetExportProcTableset] = obj["returnObj"]
      pass
