...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.InventoryMovementSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.InventoryMovementSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetNewParametersReportId(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.InventoryMovementSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.InventoryMovementSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.InventoryMovementSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_InvMovmntParamRow:
   def __init__(self, obj):
      self.PartTranPKs:str = obj["PartTranPKs"]
      self.PartNum:str = obj["PartNum"]
      self.MovementType:str = obj["MovementType"]
      self.InvMovmntReportID:str = obj["InvMovmntReportID"]
      self.PartTranWhereClause:str = obj["PartTranWhereClause"]
...
class Erp_Tablesets_InventoryMovementTableset:
   def __init__(self, obj):
      self.InvMovmntParam:list[Erp_Tablesets_InvMovmntParamRow] = obj["InvMovmntParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_InventoryMovementTableset] = obj["ds"]
      pass
...
class GetNewParametersForReportId_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_InventoryMovementTableset] = obj["returnObj"]
      pass

class GetNewParametersReportId_input:
   """ Required : 
   reportID
   """  
   def __init__(self, obj):
...
class GetNewParametersReportId_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_InventoryMovementTableset] = obj["returnObj"]
      pass
