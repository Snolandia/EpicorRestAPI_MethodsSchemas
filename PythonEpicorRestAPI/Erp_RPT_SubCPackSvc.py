...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SubCPackSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SubCPackSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetNewParametersAndDefaults(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SubCPackSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetLinkedPORels(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SubCPackSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SubCPackSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SubCPackParamRow:
   def __init__(self, obj):
      self.PackNum:int = obj["PackNum"]
      self.LinkedRelease:str = obj["LinkedRelease"]
...
class Erp_Tablesets_SubCPackTableset:
   def __init__(self, obj):
      self.SubCPackParam:list[Erp_Tablesets_SubCPackParamRow] = obj["SubCPackParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SubCPackTableset] = obj["ds"]
      pass
...
class GetLinkedPORels_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.opPORelList:str = obj["parameters"]
      pass

      """  output parameters  """  

class GetNewParametersAndDefaults_input:
   """ Required : 
   packNum
   """  
   def __init__(self, obj):
...
class GetNewParametersAndDefaults_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SubCPackTableset] = obj["returnObj"]
      pass
