...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ExpenseReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ExpenseReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ExpenseReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ExpenseReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ExpenseReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ExpenseParamRow:
   def __init__(self, obj):
      self.FromDate:str = obj["FromDate"]
      self.ToDate:str = obj["ToDate"]
      self.APInvNum:str = obj["APInvNum"]
      self.ClaimRefNum:str = obj["ClaimRefNum"]
      self.ExpStatus:str = obj["ExpStatus"]
      self.FromDateToken:str = obj["FromDateToken"]
      self.ToDateToken:str = obj["ToDateToken"]
      self.PickedExpStatus:str = obj["PickedExpStatus"]
      self.ExpStatusDesc:str = obj["ExpStatusDesc"]
      self.PkdExpStat:str = obj["PkdExpStat"]
      self.PkdExpStatDesc:str = obj["PkdExpStatDesc"]
      self.EmpList:str = obj["EmpList"]
...
class Erp_Tablesets_ExpenseReportTableset:
   def __init__(self, obj):
      self.ExpenseParam:list[Erp_Tablesets_ExpenseParamRow] = obj["ExpenseParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ExpenseReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ExpenseReportTableset] = obj["returnObj"]
      pass
