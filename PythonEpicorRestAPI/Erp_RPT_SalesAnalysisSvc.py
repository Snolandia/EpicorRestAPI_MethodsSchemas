...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesAnalysisSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesAnalysisSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetPriceOptionList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesAnalysisSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesAnalysisSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesAnalysisSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SalesAnalysisParamRow:
   def __init__(self, obj):
      ...
      self.CustGrps:str = obj["CustGrps"]
      """  Selected Customer Groups  """  
      self.PartList:str = obj["PartList"]
      """  Parts Selected  """  
      self.ProdGrps:str = obj["ProdGrps"]
      """  Product Groups  """  
      self.ContCds:str = obj["ContCds"]
      """  Contract Code List  """  
      self.ServCds:str = obj["ServCds"]
      """  Service Call List  """  
      self.SortByOption:str = obj["SortByOption"]
      """  SortBy Option  """  
      self.PriceOption:str = obj["PriceOption"]
      """  Use Price Option  """  
      self.InclDefRevTog:bool = obj["InclDefRevTog"]
      ...
      self.InclAdvDepBillingInvoices:bool = obj["InclAdvDepBillingInvoices"]
...
class Erp_Tablesets_SalesAnalysisTableset:
   def __init__(self, obj):
      self.SalesAnalysisParam:list[Erp_Tablesets_SalesAnalysisParamRow] = obj["SalesAnalysisParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SalesAnalysisTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SalesAnalysisTableset] = obj["returnObj"]
      pass
