...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SlowMovingStockSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SlowMovingStockSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SlowMovingStockSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SlowMovingStockSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SlowMovingStockSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SlowMovingStockParamRow:
   def __init__(self, obj):
      ...
      self.SMStockProvFmtCode:str = obj["SMStockProvFmtCode"]
      """  Slow Moving Stock Provision Format Code to use for the report  """  
      self.IncludeManagedInventory:bool = obj["IncludeManagedInventory"]
      ...
      self.SMStockProvFmtDesc:str = obj["SMStockProvFmtDesc"]
      self.ExcludeOutsideTimePeriods:bool = obj["ExcludeOutsideTimePeriods"]
...
class Erp_Tablesets_SlowMovingStockTableset:
   def __init__(self, obj):
      self.SlowMovingStockParam:list[Erp_Tablesets_SlowMovingStockParamRow] = obj["SlowMovingStockParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SlowMovingStockTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SlowMovingStockTableset] = obj["returnObj"]
      pass
