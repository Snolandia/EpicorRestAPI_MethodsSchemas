...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DefRevAmortProcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DefRevAmortProcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_ExValidateParam(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.DefRevAmortProcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.DefRevAmortProcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.DefRevAmortProcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_DefRevAmortParamRow:
   def __init__(self, obj):
      ...
      self.AmortList1:str = obj["AmortList1"]
      ...
      self.HoldReasonDesc:str = obj["HoldReasonDesc"]
      self.AmortList4:str = obj["AmortList4"]
      """  Fourth Amortization List in case the first AmortList exceeds the 14K limit for Unicode  """  
      self.ShowOption:str = obj["ShowOption"]
      ...
      self.GuidCode:str = obj["GuidCode"]
...
class Erp_Tablesets_DefRevAmortProcTableset:
   def __init__(self, obj):
      self.DefRevAmortParam:list[Erp_Tablesets_DefRevAmortParamRow] = obj["DefRevAmortParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_DefRevAmortProcTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_DefRevAmortProcTableset] = obj["returnObj"]
      pass
