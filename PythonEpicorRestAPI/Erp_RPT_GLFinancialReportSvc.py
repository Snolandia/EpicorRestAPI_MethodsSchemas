...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLFinancialReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLFinancialReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetApplicationDefaults(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GLFinancialReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_ChangeBalanceLevel(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangeFiscalPer(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangeGLReportID(requestBody, epicorHeaders = None):
   """  
...
async def post_getBookDefaults(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GLFinancialReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_getReportFormatList(epicorHeaders = None):
   """  
...
async def post_GetReportFormatListForCOACode(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLFinancialReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class ChangeBalanceLevel_input:
   """ Required : 
   cBalanceLevel
   ds
   """  
   def __init__(self, obj):
      self.cBalanceLevel:str = obj["cBalanceLevel"]
      """  The Balance Level  """  
      self.ds:list[Erp_Tablesets_GLFinancialReportTableset] = obj["ds"]
      pass

class ChangeBalanceLevel_output:
   def __init__(self, obj):
      pass
...
class ChangeGLReportID_input:
   """ Required : 
   cGLReportID
   ds
   """  
   def __init__(self, obj):
      self.cGLReportID:str = obj["cGLReportID"]
      """  The Report ID  """  
      self.ds:list[Erp_Tablesets_GLFinancialReportTableset] = obj["ds"]
      pass

class ChangeGLReportID_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_GLFinancialParamRow:
   def __init__(self, obj):
      self.FiscalYear:int = obj["FiscalYear"]
      self.FiscalPeriod:int = obj["FiscalPeriod"]
      self.GLReportID:str = obj["GLReportID"]
      self.ReportFormat:str = obj["ReportFormat"]
      self.PrintZeros:bool = obj["PrintZeros"]
      """  Print Zero Balances option  """  
      self.ColSetID:str = obj["ColSetID"]
      self.DivisionList:str = obj["DivisionList"]
      self.DepartmentList:str = obj["DepartmentList"]
      self.CompanyList:str = obj["CompanyList"]
      self.ReportFormatCodeDesc:str = obj["ReportFormatCodeDesc"]
      ...
      self.ReportBalFrequency:str = obj["ReportBalFrequency"]
      self.GLBookList:str = obj["GLBookList"]
      self.SegmentNumList:str = obj["SegmentNumList"]
      self.SegmentValList:str = obj["SegmentValList"]
      self.IncCarryFwdBal:bool = obj["IncCarryFwdBal"]
      self.EnableIncCarryFwdBal:bool = obj["EnableIncCarryFwdBal"]
      self.CompBookList:str = obj["CompBookList"]
...
class Erp_Tablesets_GLFinancialReportTableset:
   def __init__(self, obj):
      self.GLFinancialParam:list[Erp_Tablesets_GLFinancialParamRow] = obj["GLFinancialParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLFinancialReportTableset] = obj["returnObj"]
      pass
...
class GetReportFormatListForCOACode_input:
   """ Required : 
   coaCode
   balanceLevel
   """  
...
class GetReportFormatListForCOACode_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.reportFormatList:str = obj["parameters"]
      pass
...
class getBookDefaults_output:
   def __init__(self, obj):
      pass

class getReportFormatList_output:
   def __init__(self, obj):
      pass
