...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_PkgControlVoidPCIDs(select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlVoidPCIDs",headers=creds) as resp:
           return await resp.json()

async def post_PkgControlVoidPCIDs(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlVoidPCIDs", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_PkgControlVoidPCIDs_Company_PCID(Company, PCID, select = None, expand = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlVoidPCIDs(" + Company + "," + PCID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_PkgControlVoidPCIDs_Company_PCID(Company, PCID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlVoidPCIDs(" + Company + "," + PCID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_PkgControlVoidPCIDs_Company_PCID(Company, PCID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlVoidPCIDs(" + Company + "," + PCID + ")",headers=creds) as resp:
           return await resp.json()

async def get_PkgControlVoidPCIDs_Company_PCID_PkgControlItems(Company, PCID, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlVoidPCIDs(" + Company + "," + PCID + ")/PkgControlItems",headers=creds) as resp:
           return await resp.json()

async def get_PkgControlVoidPCIDs_Company_PCID_PkgControlItems_Company_PCID_PCIDItemSeq(Company, PCID, PCIDItemSeq, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlVoidPCIDs(" + Company + "," + PCID + ")/PkgControlItems(" + Company + "," + PCID + "," + PCIDItemSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_PkgControlItems(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlItems",headers=creds) as resp:
           return await resp.json()
...
async def post_PkgControlItems(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlItems", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_PkgControlItems_Company_PCID_PCIDItemSeq(Company, PCID, PCIDItemSeq, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlItems(" + Company + "," + PCID + "," + PCIDItemSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_PkgControlItems_Company_PCID_PCIDItemSeq(Company, PCID, PCIDItemSeq, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlItems(" + Company + "," + PCID + "," + PCIDItemSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_PkgControlItems_Company_PCID_PCIDItemSeq(Company, PCID, PCIDItemSeq, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/PkgControlItems(" + Company + "," + PCID + "," + PCIDItemSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClausePkgControlHeader, whereClausePkgControlItem, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetValidPCIDRow(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlVoidPCIDSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_UpdExtPkgControlVoidPCIDTableset:
   def __init__(self, obj):
      self.PkgControlHeader:list[Erp_Tablesets_PkgControlHeaderRow] = obj["PkgControlHeader"]
      self.PkgControlItem:list[Erp_Tablesets_PkgControlItemRow] = obj["PkgControlItem"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PkgControlVoidPCIDTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PkgControlVoidPCIDListTableset] = obj["returnObj"]
      pass
...
class GetNewPkgControlHeader_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PkgControlVoidPCIDTableset] = obj["ds"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtPkgControlVoidPCIDTableset] = obj["ds"]
