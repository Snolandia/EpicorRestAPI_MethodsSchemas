...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SupplierStatementSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SupplierStatementSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SupplierStatementSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SupplierStatementSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SupplierStatementSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SupplierStatementParamRow:
   def __init__(self, obj):
      self.InvoiceDateCutOff:str = obj["InvoiceDateCutOff"]
      """  Invoice date cut-off  """  
      self.Message:str = obj["Message"]
      self.InvoiceDateCutOffToken:str = obj["InvoiceDateCutOffToken"]
      self.VendorGroupIDList:str = obj["VendorGroupIDList"]
...
class Erp_Tablesets_SupplierStatementTableset:
   def __init__(self, obj):
      self.SupplierStatementParam:list[Erp_Tablesets_SupplierStatementParamRow] = obj["SupplierStatementParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SupplierStatementTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SupplierStatementTableset] = obj["returnObj"]
      pass
