...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_MktgCamps(select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCamps",headers=creds) as resp:
           return await resp.json()

async def post_MktgCamps(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCamps", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_MktgCamps_Company_MktgCampaignID(Company, MktgCampaignID, select = None, expand = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCamps(" + Company + "," + MktgCampaignID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_MktgCamps_Company_MktgCampaignID(Company, MktgCampaignID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCamps(" + Company + "," + MktgCampaignID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_MktgCamps_Company_MktgCampaignID(Company, MktgCampaignID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCamps(" + Company + "," + MktgCampaignID + ")",headers=creds) as resp:
           return await resp.json()

async def get_MktgCamps_Company_MktgCampaignID_MktgEvnts(Company, MktgCampaignID, select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCamps(" + Company + "," + MktgCampaignID + ")/MktgEvnts",headers=creds) as resp:
           return await resp.json()

async def get_MktgCamps_Company_MktgCampaignID_MktgEvnts_Company_MktgCampaignID_MktgEvntSeq(Company, MktgCampaignID, MktgEvntSeq, select = None, expand = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCamps(" + Company + "," + MktgCampaignID + ")/MktgEvnts(" + Company + "," + MktgCampaignID + "," + MktgEvntSeq + ")",headers=creds) as resp:
           return await resp.json()

async def get_MktgCamps_Company_MktgCampaignID_MktgCampAttches(Company, MktgCampaignID, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   Summary: Calls GetByID for the service
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCamps(" + Company + "," + MktgCampaignID + ")/MktgCampAttches",headers=creds) as resp:
           return await resp.json()

async def get_MktgCamps_Company_MktgCampaignID_MktgCampAttches_Company_MktgCampaignID_DrawingSeq(Company, MktgCampaignID, DrawingSeq, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCamps(" + Company + "," + MktgCampaignID + ")/MktgCampAttches(" + Company + "," + MktgCampaignID + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_MktgEvnts(select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvnts",headers=creds) as resp:
           return await resp.json()
...
async def post_MktgEvnts(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvnts", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_MktgEvnts_Company_MktgCampaignID_MktgEvntSeq(Company, MktgCampaignID, MktgEvntSeq, select = None, expand = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvnts(" + Company + "," + MktgCampaignID + "," + MktgEvntSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_MktgEvnts_Company_MktgCampaignID_MktgEvntSeq(Company, MktgCampaignID, MktgEvntSeq, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvnts(" + Company + "," + MktgCampaignID + "," + MktgEvntSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_MktgEvnts_Company_MktgCampaignID_MktgEvntSeq(Company, MktgCampaignID, MktgEvntSeq, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvnts(" + Company + "," + MktgCampaignID + "," + MktgEvntSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_MktgEvnts_Company_MktgCampaignID_MktgEvntSeq_MktgEvntAttches(Company, MktgCampaignID, MktgEvntSeq, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvnts(" + Company + "," + MktgCampaignID + "," + MktgEvntSeq + ")/MktgEvntAttches",headers=creds) as resp:
           return await resp.json()
...
async def get_MktgEvnts_Company_MktgCampaignID_MktgEvntSeq_MktgEvntAttches_Company_MktgCampaignID_MktgEvntSeq_DrawingSeq(Company, MktgCampaignID, MktgEvntSeq, DrawingSeq, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvnts(" + Company + "," + MktgCampaignID + "," + MktgEvntSeq + ")/MktgEvntAttches(" + Company + "," + MktgCampaignID + "," + MktgEvntSeq + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_MktgEvntAttches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvntAttches",headers=creds) as resp:
           return await resp.json()
...
async def post_MktgEvntAttches(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvntAttches", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_MktgEvntAttches_Company_MktgCampaignID_MktgEvntSeq_DrawingSeq(Company, MktgCampaignID, MktgEvntSeq, DrawingSeq, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvntAttches(" + Company + "," + MktgCampaignID + "," + MktgEvntSeq + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_MktgEvntAttches_Company_MktgCampaignID_MktgEvntSeq_DrawingSeq(Company, MktgCampaignID, MktgEvntSeq, DrawingSeq, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvntAttches(" + Company + "," + MktgCampaignID + "," + MktgEvntSeq + "," + DrawingSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_MktgEvntAttches_Company_MktgCampaignID_MktgEvntSeq_DrawingSeq(Company, MktgCampaignID, MktgEvntSeq, DrawingSeq, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgEvntAttches(" + Company + "," + MktgCampaignID + "," + MktgEvntSeq + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()

async def get_MktgCampAttches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   Summary: Calls GetRows for the service
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCampAttches",headers=creds) as resp:
           return await resp.json()

async def post_MktgCampAttches(requestBody, epicorHeaders = None):
   """  
   Summary: Calls UpdateExt to create new item for the service
   Description: Calls UpdateExt to create new item for the service. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li></ul></div>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCampAttches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_MktgCampAttches_Company_MktgCampaignID_DrawingSeq(Company, MktgCampaignID, DrawingSeq, select = None, filter = None, epicorHeaders = None):
   """  
   Summary: Calls GetByID to retrieve the MktgCampAttch item
   Description: Calls GetByID to retrieve the MktgCampAttch item by specified keys. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li><li>String parameters should be specified in single quotes</li></ul></div>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCampAttches(" + Company + "," + MktgCampaignID + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()

async def patch_MktgCampAttches_Company_MktgCampaignID_DrawingSeq(Company, MktgCampaignID, DrawingSeq, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCampAttches(" + Company + "," + MktgCampaignID + "," + DrawingSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_MktgCampAttches_Company_MktgCampaignID_DrawingSeq(Company, MktgCampaignID, DrawingSeq, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/MktgCampAttches(" + Company + "," + MktgCampaignID + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseMktgCamp, whereClauseMktgCampAttch, whereClauseMktgEvnt, whereClauseMktgEvntAttch, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(mktgCampaignID, epicorHeaders = None):
   """  
...
async def post_OnChangeMktgEvntProjectID(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.MktgCampSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetNewMktgCamp(requestBody, epicorHeaders = None):
   """  
...
async def post_GetNewMktgCampAttch(requestBody, epicorHeaders = None):
   """  
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_MktgCampAttchRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_MktgCampAttchRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_MktgCampListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_MktgCampListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_MktgCampRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_MktgCampRow] = obj["value"]
      pass
...
class Erp_Tablesets_MktgCampAttchRow:
   def __init__(self, obj):
...
class Erp_Tablesets_MktgCampListRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.MktgCampaignID:str = obj["MktgCampaignID"]
      """  Unique identifier for this campaign assigned by the user.  """  
      self.CampDescription:str = obj["CampDescription"]
...
class Erp_Tablesets_MktgCampRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.MktgCampaignID:str = obj["MktgCampaignID"]
      ...
      self.CampDescription:str = obj["CampDescription"]
      """  Description of the Marketing campaign  """  
      self.CampComments:str = obj["CampComments"]
      ...
      self.Inactive:bool = obj["Inactive"]
      """  Determines whether or not his campaign can be assigned to new leads, opportunities or quotes.  """  
      self.DefMktgEvntSeq:int = obj["DefMktgEvntSeq"]
...
class Erp_Tablesets_MktgCampListTableset:
   def __init__(self, obj):
      self.MktgCampList:list[Erp_Tablesets_MktgCampListRow] = obj["MktgCampList"]
...
class Erp_Tablesets_MktgCampTableset:
   def __init__(self, obj):
      self.MktgCamp:list[Erp_Tablesets_MktgCampRow] = obj["MktgCamp"]
      self.MktgCampAttch:list[Erp_Tablesets_MktgCampAttchRow] = obj["MktgCampAttch"]
...
class Erp_Tablesets_UpdExtMktgCampTableset:
   def __init__(self, obj):
      self.MktgCamp:list[Erp_Tablesets_MktgCampRow] = obj["MktgCamp"]
      self.MktgCampAttch:list[Erp_Tablesets_MktgCampAttchRow] = obj["MktgCampAttch"]
      self.MktgEvnt:list[Erp_Tablesets_MktgEvntRow] = obj["MktgEvnt"]
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MktgCampTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MktgCampListTableset] = obj["returnObj"]
      pass
...
class GetNewMktgCampAttch_input:
   """ Required : 
   ds
   mktgCampaignID
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MktgCampTableset] = obj["ds"]
      self.mktgCampaignID:str = obj["mktgCampaignID"]
      pass

class GetNewMktgCampAttch_output:
   def __init__(self, obj):
      pass
...
class GetRows_input:
   ...
   """  
   def __init__(self, obj):
      self.whereClauseMktgCamp:str = obj["whereClauseMktgCamp"]
      self.whereClauseMktgCampAttch:str = obj["whereClauseMktgCampAttch"]
...
class OnChangeMktgEvntProjectID_input:
   """ Required : 
   proposedProjectID
   ds
   """  
...
class OnChangeMktgEvntProjectID_output:
   def __init__(self, obj):
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtMktgCampTableset] = obj["ds"]
