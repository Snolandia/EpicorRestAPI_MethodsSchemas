...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ARTaxConfirmSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ARTaxConfirmSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_OnChangeApplyConfirmationDate(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ARTaxConfirmSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_OnChangeLegalNumber(requestBody, epicorHeaders = None):
   """  
...
async def post_GetAvailTranDocTypes(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ARTaxConfirmSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ARTaxConfirmSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ARTaxConfirmParamRow:
...
class Erp_Tablesets_ARTaxConfirmTableset:
   def __init__(self, obj):
      self.ARTaxConfirmParam:list[Erp_Tablesets_ARTaxConfirmParamRow] = obj["ARTaxConfirmParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ARTaxConfirmTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ARTaxConfirmTableset] = obj["returnObj"]
      pass
...
class OnChangeApplyConfirmationDate_input:
   """ Required : 
   pApplyConfirmationDate
   """  
   def __init__(self, obj):
      self.pApplyConfirmationDate:str = obj["pApplyConfirmationDate"]
      """  proposed ApplyConfirmationDate  """  
      pass

class OnChangeApplyConfirmationDate_output:
   def __init__(self, obj):
      pass

class OnChangeLegalNumber_input:
   """ Required : 
   pLegalNumber
   """  
   def __init__(self, obj):
      self.pLegalNumber:str = obj["pLegalNumber"]
      """  proposed LegalNumber  """  
      pass

class OnChangeLegalNumber_output:
   def __init__(self, obj):
      pass
