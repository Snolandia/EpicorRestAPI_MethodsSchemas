...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ProdCfgListingSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ProdCfgListingSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ProdCfgListingSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ProdCfgListingSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ProdCfgListingSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ProdCfgListingTableset:
   def __init__(self, obj):
      self.ProdCfgLstParam:list[Erp_Tablesets_ProdCfgLstParamRow] = obj["ProdCfgLstParam"]
      self.ReportStyle:list[Erp_Tablesets_ReportStyleRow] = obj["ReportStyle"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_ProdCfgLstParamRow:
   def __init__(self, obj):
      self.Parts:str = obj["Parts"]
      """  Parts and Part Revision List  """  
      self.ProdGroup:str = obj["ProdGroup"]
      """  Product Group Lists  """  
      self.PrintInputs:bool = obj["PrintInputs"]
      ...
      self.PrintComments:bool = obj["PrintComments"]
      """  Print Comments section  """  
      self.PrintPageInformation:bool = obj["PrintPageInformation"]
      """  Print page Information  """  
      self.PrintDocumentRules:bool = obj["PrintDocumentRules"]
      """  Print Document Rules  """  
      self.PrintPartCreation:bool = obj["PrintPartCreation"]
      """  Print Part Creation Rules section  """  
      self.PrintMethodRules:bool = obj["PrintMethodRules"]
      """  Used to control all options for Print Rules section.  """  
      self.DynamicLists:bool = obj["DynamicLists"]
      """  Print Dynamic Lists of the comboboxes  """  
      self.Events:bool = obj["Events"]
      """  Print events related to the page, inputos or configurator itself  """  
      self.UserDefinedFunctions:bool = obj["UserDefinedFunctions"]
      """  Print User Defined Functions  """  
      self.Variables:bool = obj["Variables"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ProdCfgListingTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ProdCfgListingTableset] = obj["returnObj"]
      pass
