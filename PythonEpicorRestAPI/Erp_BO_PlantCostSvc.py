...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PlantCostSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PlantCostSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_PlantCosts(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PlantCostSvc/PlantCosts",headers=creds) as resp:
           return await resp.json()

async def post_PlantCosts(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PlantCostSvc/PlantCosts", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_PlantCosts_Company_PlantCostID(Company, PlantCostID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PlantCostSvc/PlantCosts(" + Company + "," + PlantCostID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_PlantCosts_Company_PlantCostID(Company, PlantCostID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PlantCostSvc/PlantCosts(" + Company + "," + PlantCostID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_PlantCosts_Company_PlantCostID(Company, PlantCostID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PlantCostSvc/PlantCosts(" + Company + "," + PlantCostID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PlantCostSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClausePlantCost, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PlantCostSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(plantCostID, epicorHeaders = None):
   """  
...
async def post_PreUpdatePlantCost(requestBody, epicorHeaders = None):
   """  
...
saves the record but before the Update method is called.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PlantCostSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetNewPlantCost(requestBody, epicorHeaders = None):
   """  
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PlantCostListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PlantCostListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PlantCostRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PlantCostRow] = obj["value"]
      pass

class Erp_Tablesets_PlantCostListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_PlantCostRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.PlantCostID:str = obj["PlantCostID"]
      ...
      self.SysRowID:str = obj["SysRowID"]
      """  Unique identifier for this row. The value is a GUID.  """  
      self.SkipRevCostRollup:bool = obj["SkipRevCostRollup"]
      """  This option Skip Revision Costs of a Purchased Part with Method when rolling up costs of the assembly.  """  
      self.FIFOUpdateIssuedCost:bool = obj["FIFOUpdateIssuedCost"]
      """  FIFOUpdateIssuedCost  """  
      self.EnableActualCostAllocation:bool = obj["EnableActualCostAllocation"]
...
class Erp_Tablesets_PlantCostListTableset:
   def __init__(self, obj):
      self.PlantCostList:list[Erp_Tablesets_PlantCostListRow] = obj["PlantCostList"]
...
class Erp_Tablesets_PlantCostTableset:
   def __init__(self, obj):
      self.PlantCost:list[Erp_Tablesets_PlantCostRow] = obj["PlantCost"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtPlantCostTableset:
   def __init__(self, obj):
      self.PlantCost:list[Erp_Tablesets_PlantCostRow] = obj["PlantCost"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PlantCostTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PlantCostListTableset] = obj["returnObj"]
      pass
...
class GetNewPlantCost_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PlantCostTableset] = obj["ds"]
      pass

class GetNewPlantCost_output:
   def __init__(self, obj):
      pass
...
class GetRows_input:
   """ Required : 
   whereClausePlantCost
   pageSize
   absolutePage
   """  
   def __init__(self, obj):
      self.whereClausePlantCost:str = obj["whereClausePlantCost"]
      self.pageSize:int = obj["pageSize"]
      self.absolutePage:int = obj["absolutePage"]
      pass
...
class PreUpdatePlantCost_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class PreUpdatePlantCost_output:
   def __init__(self, obj):
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtPlantCostTableset] = obj["ds"]
