...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdSchemaBookSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdSchemaBookSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_ClearGLAccount(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdSchemaBookSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdSchemaBookSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdSchemaBookSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class ClearGLAccount_input:
   ...
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_WithholdSchemaBookTableset] = obj["ds"]
      pass
...
class Erp_Tablesets_WithholdSchemaBookParamRow:
   def __init__(self, obj):
      ...
      self.IsWithholding:bool = obj["IsWithholding"]
...
class Erp_Tablesets_WithholdSchemaBookTableset:
   def __init__(self, obj):
      self.WithholdSchemaBookParam:list[Erp_Tablesets_WithholdSchemaBookParamRow] = obj["WithholdSchemaBookParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_WithholdSchemaBookTableset] = obj["returnObj"]
      pass
