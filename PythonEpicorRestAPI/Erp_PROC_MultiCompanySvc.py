...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MultiCompanySvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MultiCompanySvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_AllExtCompanyList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.MultiCompanySvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetTaskExtCompanyIDs(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.MultiCompanySvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MultiCompanySvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_MultiCompanyParamRow:
   def __init__(self, obj):
...
class Erp_Tablesets_MultiCompanyTableset:
   def __init__(self, obj):
      self.MultiCompanyParam:list[Erp_Tablesets_MultiCompanyParamRow] = obj["MultiCompanyParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MultiCompanyTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MultiCompanyTableset] = obj["returnObj"]
      pass
