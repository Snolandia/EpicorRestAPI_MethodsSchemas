...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ChangeEndingDate(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_getLastRunDate(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_getStartingDate(requestBody, epicorHeaders = None):
   """  
...
async def post_SetFirstOutdate(epicorHeaders = None):
   """  
...
async def post_canPostToGL(epicorHeaders = None):
   """  
...
async def post_getCostMethod(requestBody, epicorHeaders = None):
   """  
...
async def post_getPerson(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class ChangeEndingDate_input:
   ...
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CaptureCOSWIPTableset] = obj["ds"]
...
class Erp_Tablesets_CaptureCOSWIPParamRow:
   def __init__(self, obj):
      self.CanPostToGL:bool = obj["CanPostToGL"]
      self.EndingDate:str = obj["EndingDate"]
      self.EndingDateToken:str = obj["EndingDateToken"]
      """  EndingDate Token  """  
      self.LastRunDate:str = obj["LastRunDate"]
      self.LastRunInfo:str = obj["LastRunInfo"]
      self.LastRunTime:str = obj["LastRunTime"]
      self.LastRunUserID:str = obj["LastRunUserID"]
      self.PostCostOfSales:bool = obj["PostCostOfSales"]
      self.PostToGeneralLedger:bool = obj["PostToGeneralLedger"]
      self.StartingDate:str = obj["StartingDate"]
      """  Period Starting Date  """  
      self.Acttype:str = obj["Acttype"]
      """  ACT type name.  """  
      self.IsCaptureOT:bool = obj["IsCaptureOT"]
      """  Is Capture Outdated transaction  """  
      self.OTDate:str = obj["OTDate"]
      """  outdated transaction date  """  
      self.OTDateToken:str = obj["OTDateToken"]
      """  outdated transaction date token  """  
      self.AddPBCosts:bool = obj["AddPBCosts"]
      self.StartingDateDesc:str = obj["StartingDateDesc"]
      self.PostFSA:bool = obj["PostFSA"]
...
class Erp_Tablesets_CaptureCOSWIPTableset:
   def __init__(self, obj):
      self.CaptureCOSWIPParam:list[Erp_Tablesets_CaptureCOSWIPParamRow] = obj["CaptureCOSWIPParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CaptureCOSWIPTableset] = obj["returnObj"]
      pass
...
class canPostToGL_output:
   def __init__(self, obj):
      self.returnObj:bool = obj["returnObj"]
      pass

class getCostMethod_input:
   """ Required : 
   CurCostMethod
   """  
   def __init__(self, obj):
      self.CurCostMethod:str = obj["CurCostMethod"]
      pass

class getCostMethod_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass

class getLastRunDate_output:
   def __init__(self, obj):
      pass

class getPerson_input:
   """ Required : 
   CurPerson
   """  
   def __init__(self, obj):
      self.CurPerson:str = obj["CurPerson"]
      pass

class getPerson_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass

class getStartingDate_input:
   """ Required : 
   iDate
   lUpdateTT
   skipEADValidation
   """  
   def __init__(self, obj):
      self.iDate:str = obj["iDate"]
      self.lUpdateTT:bool = obj["lUpdateTT"]
      self.skipEADValidation:bool = obj["skipEADValidation"]
      pass

class getStartingDate_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.lValidFiscal:bool = obj["lValidFiscal"]
      self.cOutMsg:str = obj["parameters"]
      pass
