...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARPromissoryNoteReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARPromissoryNoteReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewParametersAndDefaults(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARPromissoryNoteReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARPromissoryNoteReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARPromissoryNoteReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ARPromissoryNoteParamRow:
...
class Erp_Tablesets_ARPromissoryNoteReportTableset:
   def __init__(self, obj):
      self.ARPromissoryNoteParam:list[Erp_Tablesets_ARPromissoryNoteParamRow] = obj["ARPromissoryNoteParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ARPromissoryNoteReportTableset] = obj["ds"]
      pass
...
class GetNewParametersAndDefaults_input:
   ...
   def __init__(self, obj):
      self.groupID:str = obj["groupID"]
      self.headNum:str = obj["headNum"]
      pass

class GetNewParametersAndDefaults_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ARPromissoryNoteReportTableset] = obj["returnObj"]
      pass
