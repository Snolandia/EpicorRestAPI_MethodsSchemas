...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PkgControlIDGeneratorOptsSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PkgControlIDGeneratorOptsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SetPrintParams(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PkgControlIDGeneratorOptsSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_SetReportDefaults(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangePackageCode(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PkgControlIDGeneratorOptsSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PkgControlIDGeneratorOptsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class ChangePackageCode_input:
   """ Required : 
   ds
   ipPackageCode
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PkgControlIDGeneratorOptsTableset] = obj["ds"]
      self.ipPackageCode:str = obj["ipPackageCode"]
      pass

class ChangePackageCode_output:
   def __init__(self, obj):
      pass
...
class ChangePkgControlIDCode_input:
   """ Required : 
   ds
   ipPackageControlIDCode
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PkgControlIDGeneratorOptsTableset] = obj["ds"]
      self.ipPackageControlIDCode:str = obj["ipPackageControlIDCode"]
      pass
...
class Erp_Tablesets_PkgControlIDGeneratorOptsParamRow:
   def __init__(self, obj):
      ...
      self.PkgControlTypeDesc:str = obj["PkgControlTypeDesc"]
      self.GenerationOptions:str = obj["GenerationOptions"]
...
class Erp_Tablesets_PkgControlIDGeneratorOptsTableset:
   def __init__(self, obj):
      self.PkgControlIDGeneratorOptsParam:list[Erp_Tablesets_PkgControlIDGeneratorOptsParamRow] = obj["PkgControlIDGeneratorOptsParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PkgControlIDGeneratorOptsTableset] = obj["returnObj"]
      pass
...
class SetReportDefaults_output:
   def __init__(self, obj):
      pass
