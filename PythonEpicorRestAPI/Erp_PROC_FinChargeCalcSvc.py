...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.FinChargeCalcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.FinChargeCalcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.FinChargeCalcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.FinChargeCalcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_FinChargeCalcParamRow:
   def __init__(self, obj):
      self.AsOfDate:str = obj["AsOfDate"]
      """  AsOfDate  """  
      self.AsOfDateToken:str = obj["AsOfDateToken"]
      """  AsOfDateToken  """  
      self.ChargeCodeList:str = obj["ChargeCodeList"]
      """  ChargeCodeList  """  
...
class Erp_Tablesets_FinChargeCalcTableset:
   def __init__(self, obj):
      self.FinChargeCalcParam:list[Erp_Tablesets_FinChargeCalcParamRow] = obj["FinChargeCalcParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_FinChargeCalcTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_FinChargeCalcTableset] = obj["returnObj"]
      pass
