...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InspPlanRevSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InspPlanRevSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_InspPlanRevSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InspPlanRevSearchSvc/InspPlanRevSearches",headers=creds) as resp:
           return await resp.json()

async def post_InspPlanRevSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.InspPlanRevSearchSvc/InspPlanRevSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_InspPlanRevSearches_Company_InspPlanNum_InspPlanRevNum(Company, InspPlanNum, InspPlanRevNum, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InspPlanRevSearchSvc/InspPlanRevSearches(" + Company + "," + InspPlanNum + "," + InspPlanRevNum + ")",headers=creds) as resp:
           return await resp.json()

async def patch_InspPlanRevSearches_Company_InspPlanNum_InspPlanRevNum(Company, InspPlanNum, InspPlanRevNum, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.InspPlanRevSearchSvc/InspPlanRevSearches(" + Company + "," + InspPlanNum + "," + InspPlanRevNum + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_InspPlanRevSearches_Company_InspPlanNum_InspPlanRevNum(Company, InspPlanNum, InspPlanRevNum, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.InspPlanRevSearchSvc/InspPlanRevSearches(" + Company + "," + InspPlanNum + "," + InspPlanRevNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InspPlanRevSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseInspPlanRev, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InspPlanRevSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(inspPlanNum, inspPlanRevNum, epicorHeaders = None):
   """  
...
async def post_GetNewInspPlanRev(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.InspPlanRevSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_InspPlanRevListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_InspPlanRevListRow] = obj["value"]
      pass
...
class Erp_Tablesets_InspPlanRevListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_InspPlanRevListTableset:
   def __init__(self, obj):
      self.InspPlanRevList:list[Erp_Tablesets_InspPlanRevListRow] = obj["InspPlanRevList"]
...
class Erp_Tablesets_InspPlanRevTableset:
   def __init__(self, obj):
      self.InspPlanRev:list[Erp_Tablesets_InspPlanRevRow] = obj["InspPlanRev"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtInspPlanRevTableset:
   def __init__(self, obj):
      self.InspPlanRev:list[Erp_Tablesets_InspPlanRevRow] = obj["InspPlanRev"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_InspPlanRevTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_InspPlanRevListTableset] = obj["returnObj"]
      pass
...
class GetNewInspPlanRev_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_InspPlanRevTableset] = obj["ds"]
      self.inspPlanNum:str = obj["inspPlanNum"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtInspPlanRevTableset] = obj["ds"]
