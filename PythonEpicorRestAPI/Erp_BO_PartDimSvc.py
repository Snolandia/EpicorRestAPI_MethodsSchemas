...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_PartDims(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/PartDims",headers=creds) as resp:
           return await resp.json()
...
async def post_PartDims(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/PartDims", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_PartDims_Company_PartNum_DimCode(Company, PartNum, DimCode, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/PartDims(" + Company + "," + PartNum + "," + DimCode + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_PartDims_Company_PartNum_DimCode(Company, PartNum, DimCode, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/PartDims(" + Company + "," + PartNum + "," + DimCode + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_PartDims_Company_PartNum_DimCode(Company, PartNum, DimCode, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/PartDims(" + Company + "," + PartNum + "," + DimCode + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClausePartDim, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(partNum, dimCode, epicorHeaders = None):
   """  
...
async def post_GetNewPartDim(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PartDimListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PartDimListRow] = obj["value"]
      pass
...
class Erp_Tablesets_PartDimListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_PartDimListTableset:
   def __init__(self, obj):
      self.PartDimList:list[Erp_Tablesets_PartDimListRow] = obj["PartDimList"]
...
class Erp_Tablesets_PartDimTableset:
   def __init__(self, obj):
      self.PartDim:list[Erp_Tablesets_PartDimRow] = obj["PartDim"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtPartDimTableset:
   def __init__(self, obj):
      self.PartDim:list[Erp_Tablesets_PartDimRow] = obj["PartDim"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PartDimTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PartDimListTableset] = obj["returnObj"]
      pass
...
class GetNewPartDim_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PartDimTableset] = obj["ds"]
      self.partNum:str = obj["partNum"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtPartDimTableset] = obj["ds"]
