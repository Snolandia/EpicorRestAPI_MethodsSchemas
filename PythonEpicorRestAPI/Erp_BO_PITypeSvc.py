...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PITypeSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PITypeSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_PITypes(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PITypeSvc/PITypes",headers=creds) as resp:
           return await resp.json()

async def post_PITypes(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PITypeSvc/PITypes", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_PITypes_Company_PIType1(Company, PIType1, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PITypeSvc/PITypes(" + Company + "," + PIType1 + ")",headers=creds) as resp:
           return await resp.json()

async def patch_PITypes_Company_PIType1(Company, PIType1, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PITypeSvc/PITypes(" + Company + "," + PIType1 + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_PITypes_Company_PIType1(Company, PIType1, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PITypeSvc/PITypes(" + Company + "," + PIType1 + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PITypeSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClausePIType, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PITypeSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(piType, epicorHeaders = None):
   """  
...
async def post_OnChangeDefault(requestBody, epicorHeaders = None):
   """  
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PITypeSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_OnChangePIScope(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangePIInitiation(requestBody, epicorHeaders = None):
   """  
...
async def post_GetNewPIType(requestBody, epicorHeaders = None):
   """  
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PITypeListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PITypeListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PITypeRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PITypeRow] = obj["value"]
      pass

class Erp_Tablesets_PITypeListRow:
   def __init__(self, obj):
      ...
      self.Initiation:str = obj["Initiation"]
      """  Genarated or Received  """  
      self.CustBankDtl:bool = obj["CustBankDtl"]
      """  Customer Bank Required flag  """  
      self.BankAcctID:str = obj["BankAcctID"]
      """  Unique identifier of the bank account  """  
      self.EDITypeCode:str = obj["EDITypeCode"]
      """  Electronic Type Code  """  
      self.GenType:str = obj["GenType"]
      """  Generation Type  """  
      self.DefaultType:bool = obj["DefaultType"]
      """  Default Type  """  
      self.InitStatus:str = obj["InitStatus"]
      """  Initial Status  """  
      self.ReconStatus:str = obj["ReconStatus"]
      """  Reconciled Status  """  
      self.SupBankDtl:bool = obj["SupBankDtl"]
      """  Supplier Bank Required  """  
      self.GLStage:str = obj["GLStage"]
      """  First Stage to post to GL  """  
      self.GlobalPIType:bool = obj["GlobalPIType"]
      ...
      self.GLStageAP:str = obj["GLStageAP"]
      """  GLStageAP to display in UI.  """  
      self.GLStageAR:str = obj["GLStageAR"]
      """  GLStageAR to display in UI.  """  
      self.ChangeDefaults:bool = obj["ChangeDefaults"]
      ...
      self.PIStatusIStatusDesc:str = obj["PIStatusIStatusDesc"]
      """  Status Description  """  
      self.PIStatusRStatusDesc:str = obj["PIStatusRStatusDesc"]
      """  Status Description  """  
      self.RowMod:str = obj["RowMod"]
      """  RowMod  """  
      pass

class Erp_Tablesets_PITypeRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.PIType1:str = obj["PIType1"]
      self.Description:str = obj["Description"]
      """  Type Description  """  
      self.PIScope:int = obj["PIScope"]
      """  Payment Instrument Scope  """  
      ...
      self.ChangeDefaults:bool = obj["ChangeDefaults"]
      """  Internal switch set by the UI to inform the BL the default PI Type is to be changed.  """  
      self.PIScopeDesc:str = obj["PIScopeDesc"]
      """  PIScope description  """  
...
class Erp_Tablesets_PITypeListTableset:
   def __init__(self, obj):
      self.PITypeList:list[Erp_Tablesets_PITypeListRow] = obj["PITypeList"]
...
class Erp_Tablesets_PITypeTableset:
   def __init__(self, obj):
      self.PIType:list[Erp_Tablesets_PITypeRow] = obj["PIType"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtPITypeTableset:
   def __init__(self, obj):
      self.PIType:list[Erp_Tablesets_PITypeRow] = obj["PIType"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PITypeTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PITypeListTableset] = obj["returnObj"]
      pass
...
class GetNewPIType_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PITypeTableset] = obj["ds"]
      pass

class GetNewPIType_output:
   def __init__(self, obj):
      pass
...
class GetRows_input:
   ...
   """  
   def __init__(self, obj):
      self.whereClausePIType:str = obj["whereClausePIType"]
      self.pageSize:int = obj["pageSize"]
      self.absolutePage:int = obj["absolutePage"]
      pass
...
class OnChangeDefault_input:
   ...
   def __init__(self, obj):
      ...
      self.ipDefaultType:bool = obj["ipDefaultType"]
      pass

class OnChangeDefault_output:
   def __init__(self, obj):
      pass
...
class OnChangePIInitiation_input:
   """ Required : 
   ipPIInitiationNew
   ds
   """  
   def __init__(self, obj):
      self.ipPIInitiationNew:str = obj["ipPIInitiationNew"]
      """  New PI Type Scope.  """  
      self.ds:list[Erp_Tablesets_PITypeTableset] = obj["ds"]
      pass

class OnChangePIInitiation_output:
   def __init__(self, obj):
      pass
...
class OnChangePIScope_input:
   ...
   def __init__(self, obj):
      self.ipPIType:str = obj["ipPIType"]
      """  PI Type.  """  
      self.ipPIScopeNew:int = obj["ipPIScopeNew"]
      """  New PI Type Scope.  """  
      self.ds:list[Erp_Tablesets_PITypeTableset] = obj["ds"]
      pass

class OnChangePIScope_output:
   def __init__(self, obj):
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtPITypeTableset] = obj["ds"]
