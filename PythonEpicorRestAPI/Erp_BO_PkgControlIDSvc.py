...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_PkgControlIDs(select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlIDs",headers=creds) as resp:
           return await resp.json()

async def post_PkgControlIDs(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlIDs", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_PkgControlIDs_Company_PCID(Company, PCID, select = None, expand = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlIDs(" + Company + "," + PCID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_PkgControlIDs_Company_PCID(Company, PCID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlIDs(" + Company + "," + PCID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_PkgControlIDs_Company_PCID(Company, PCID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlIDs(" + Company + "," + PCID + ")",headers=creds) as resp:
           return await resp.json()

async def get_PkgControlIDs_Company_PCID_PkgControlCustPartNums(Company, PCID, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlIDs(" + Company + "," + PCID + ")/PkgControlCustPartNums",headers=creds) as resp:
           return await resp.json()

async def get_PkgControlIDs_Company_PCID_PkgControlCustPartNums_Company_PCID_PCIDCustPartSeq(Company, PCID, PCIDCustPartSeq, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlIDs(" + Company + "," + PCID + ")/PkgControlCustPartNums(" + Company + "," + PCID + "," + PCIDCustPartSeq + ")",headers=creds) as resp:
           return await resp.json()

async def get_PkgControlIDs_Company_PCID_PCLabelValues(Company, PCID, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   Summary: Calls GetByID for the service
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlIDs(" + Company + "," + PCID + ")/PCLabelValues",headers=creds) as resp:
           return await resp.json()

async def get_PkgControlIDs_Company_PCID_PCLabelValues_Company_PCID_LabelSeq(Company, PCID, LabelSeq, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlIDs(" + Company + "," + PCID + ")/PCLabelValues(" + Company + "," + PCID + "," + LabelSeq + ")",headers=creds) as resp:
           return await resp.json()

async def get_PkgControlIDs_Company_PCID_PkgControlItems(Company, PCID, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   Summary: Calls GetByID for the service
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlIDs(" + Company + "," + PCID + ")/PkgControlItems",headers=creds) as resp:
           return await resp.json()

async def get_PkgControlIDs_Company_PCID_PkgControlItems_Company_PCID_PCIDItemSeq(Company, PCID, PCIDItemSeq, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlIDs(" + Company + "," + PCID + ")/PkgControlItems(" + Company + "," + PCID + "," + PCIDItemSeq + ")",headers=creds) as resp:
           return await resp.json()

async def get_PkgControlCustPartNums(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   Summary: Calls GetRows for the service
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlCustPartNums",headers=creds) as resp:
           return await resp.json()

async def post_PkgControlCustPartNums(requestBody, epicorHeaders = None):
   """  
   Summary: Calls UpdateExt to create new item for the service
   Description: Calls UpdateExt to create new item for the service. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li></ul></div>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlCustPartNums", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_PkgControlCustPartNums_Company_PCID_PCIDCustPartSeq(Company, PCID, PCIDCustPartSeq, select = None, filter = None, epicorHeaders = None):
   """  
   Summary: Calls GetByID to retrieve the PkgControlCustPartNum item
   Description: Calls GetByID to retrieve the PkgControlCustPartNum item by specified keys. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li><li>String parameters should be specified in single quotes</li></ul></div>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlCustPartNums(" + Company + "," + PCID + "," + PCIDCustPartSeq + ")",headers=creds) as resp:
           return await resp.json()

async def patch_PkgControlCustPartNums_Company_PCID_PCIDCustPartSeq(Company, PCID, PCIDCustPartSeq, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlCustPartNums(" + Company + "," + PCID + "," + PCIDCustPartSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_PkgControlCustPartNums_Company_PCID_PCIDCustPartSeq(Company, PCID, PCIDCustPartSeq, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlCustPartNums(" + Company + "," + PCID + "," + PCIDCustPartSeq + ")",headers=creds) as resp:
           return await resp.json()

async def get_PCLabelValues(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   Summary: Calls GetRows for the service
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PCLabelValues",headers=creds) as resp:
           return await resp.json()

async def post_PCLabelValues(requestBody, epicorHeaders = None):
   """  
   Summary: Calls UpdateExt to create new item for the service
   Description: Calls UpdateExt to create new item for the service. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li></ul></div>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PCLabelValues", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_PCLabelValues_Company_PCID_LabelSeq(Company, PCID, LabelSeq, select = None, filter = None, epicorHeaders = None):
   """  
   Summary: Calls GetByID to retrieve the PCLabelValue item
   Description: Calls GetByID to retrieve the PCLabelValue item by specified keys. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li><li>String parameters should be specified in single quotes</li></ul></div>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PCLabelValues(" + Company + "," + PCID + "," + LabelSeq + ")",headers=creds) as resp:
           return await resp.json()

async def patch_PCLabelValues_Company_PCID_LabelSeq(Company, PCID, LabelSeq, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PCLabelValues(" + Company + "," + PCID + "," + LabelSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_PCLabelValues_Company_PCID_LabelSeq(Company, PCID, LabelSeq, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PCLabelValues(" + Company + "," + PCID + "," + LabelSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_PkgControlItems(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlItems",headers=creds) as resp:
           return await resp.json()
...
async def post_PkgControlItems(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlItems", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_PkgControlItems_Company_PCID_PCIDItemSeq(Company, PCID, PCIDItemSeq, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlItems(" + Company + "," + PCID + "," + PCIDItemSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_PkgControlItems_Company_PCID_PCIDItemSeq(Company, PCID, PCIDItemSeq, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlItems(" + Company + "," + PCID + "," + PCIDItemSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_PkgControlItems_Company_PCID_PCIDItemSeq(Company, PCID, PCIDItemSeq, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/PkgControlItems(" + Company + "," + PCID + "," + PCIDItemSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClausePkgControlHeader, whereClausePkgControlCustPartNum, whereClausePCLabelValues, whereClausePkgControlItem, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetListCoreStageHX(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetPCIDList(requestBody, epicorHeaders = None):
   """  
...
async def post_PasswordConfigured(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlIDSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewPkgControlCustPartNum(requestBody, epicorHeaders = None):
   """  
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PCLabelValuesRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PCLabelValuesRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PkgControlCustPartNumRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PkgControlCustPartNumRow] = obj["value"]
      pass
...
class CommitPCIDTransfer_input:
   ...
   def __init__(self, obj):
      ...
      self.ds:list[Erp_Tablesets_PkgControlIDTableset] = obj["ds"]
      pass
...
class ConfirmSupervisorPassword_input:
   ...
   def __init__(self, obj):
      ...
      self.ipPassword:str = obj["ipPassword"]
      pass
...
class Erp_Tablesets_UpdExtPkgControlIDTableset:
   def __init__(self, obj):
      self.PkgControlHeader:list[Erp_Tablesets_PkgControlHeaderRow] = obj["PkgControlHeader"]
      self.PkgControlCustPartNum:list[Erp_Tablesets_PkgControlCustPartNumRow] = obj["PkgControlCustPartNum"]
      self.PCLabelValues:list[Erp_Tablesets_PCLabelValuesRow] = obj["PCLabelValues"]
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PkgControlIDTableset] = obj["returnObj"]
      pass
...
class GetListCoreStageHX_input:
   """ Required : 
   WhereClause
   PageSize
   AbsolutePage
...
class GetListCoreStageHX_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PkgControlIDListTableset] = obj["returnObj"]
      pass
...
class GetNewPkgControlCustPartNum_input:
   """ Required : 
   ds
   pcID
   """  
...
class GetNewPkgControlCustPartNum_output:
   def __init__(self, obj):
      pass
...
class GetRows_input:
   ...
   whereClausePkgControlCustPartNum
   whereClausePCLabelValues
   ...
   def __init__(self, obj):
      ...
      self.whereClausePkgControlCustPartNum:str = obj["whereClausePkgControlCustPartNum"]
      self.whereClausePCLabelValues:str = obj["whereClausePCLabelValues"]
...
class PasswordConfigured_output:
   def __init__(self, obj):
      self.returnObj:bool = obj["returnObj"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtPkgControlIDTableset] = obj["ds"]
