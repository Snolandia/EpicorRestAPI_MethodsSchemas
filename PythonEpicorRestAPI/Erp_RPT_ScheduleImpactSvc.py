...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ScheduleImpactSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ScheduleImpactSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_PriceEstimatedRevenue(epicorHeaders = None):
   """  
...
be set for the display of job revunue.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ScheduleImpactSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ScheduleImpactSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ScheduleImpactSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_ScheduleImpactTableset:
   def __init__(self, obj):
      self.ScheduledImpactParam:list[Erp_Tablesets_ScheduledImpactParamRow] = obj["ScheduledImpactParam"]
      self.ReportStyle:list[Erp_Tablesets_ReportStyleRow] = obj["ReportStyle"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_ScheduledImpactParamRow:
   def __init__(self, obj):
      ...
      self.LateJobsAsOneGroup:bool = obj["LateJobsAsOneGroup"]
      self.JobsNowLate:bool = obj["JobsNowLate"]
      self.JobsMoreLate:bool = obj["JobsMoreLate"]
      self.JobsLessLate:bool = obj["JobsLessLate"]
      self.LateJobsUnaffected:bool = obj["LateJobsUnaffected"]
      self.OnTimeJobsAsOneGroup:bool = obj["OnTimeJobsAsOneGroup"]
      self.JobsOnTime:bool = obj["JobsOnTime"]
      self.OnTimeJobsUnaffected:bool = obj["OnTimeJobsUnaffected"]
      self.EarlyJobsAsOneGroup:bool = obj["EarlyJobsAsOneGroup"]
      self.JobsNowEarly:bool = obj["JobsNowEarly"]
      self.JobsMoreEarly:bool = obj["JobsMoreEarly"]
      self.JobsLessEarly:bool = obj["JobsLessEarly"]
      self.EarlyJobsUnaffected:bool = obj["EarlyJobsUnaffected"]
      self.ReqDueDateToken:str = obj["ReqDueDateToken"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ScheduleImpactTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ScheduleImpactTableset] = obj["returnObj"]
      pass
...
class PriceEstimatedRevenue_output:
   def __init__(self, obj):
      pass
