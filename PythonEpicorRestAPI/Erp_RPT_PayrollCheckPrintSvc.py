...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PayrollCheckPrintSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PayrollCheckPrintSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_ChangeBankAcctID(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PayrollCheckPrintSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_checkPrintValidations(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PayrollCheckPrintSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_restartCheckPrintValidations(epicorHeaders = None):
   """  
...
async def post_electronicDeposit(epicorHeaders = None):
   """  
...
async def post_getLastUsedCheckNum(epicorHeaders = None):
   """  
...
async def post_getLoadedCheckNum(requestBody, epicorHeaders = None):
   """  
...
async def post_GetEDIFileName(requestBody, epicorHeaders = None):
   """  
...
async def post_DeleteFileEI(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PayrollCheckPrintSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class ChangeBankAcctID_input:
   ...
   def __init__(self, obj):
      ...
      self.ds:list[Erp_Tablesets_PayrollCheckPrintTableset] = obj["ds"]
      pass
...
class Erp_Tablesets_PayrollCheckPrintParamRow:
   def __init__(self, obj):
      ...
      self.ElectronicDepositFile:str = obj["ElectronicDepositFile"]
      ...
      self.ElectronicDeposit:bool = obj["ElectronicDeposit"]
      self.RestartCheckPrint:bool = obj["RestartCheckPrint"]
      self.GroupID:str = obj["GroupID"]
      self.OverrideCheck:bool = obj["OverrideCheck"]
      self.FiscalYearSuffix:str = obj["FiscalYearSuffix"]
      self.SkipValidateEDFile:bool = obj["SkipValidateEDFile"]
...
class Erp_Tablesets_PayrollCheckPrintTableset:
   def __init__(self, obj):
      self.PayrollCheckPrintParam:list[Erp_Tablesets_PayrollCheckPrintParamRow] = obj["PayrollCheckPrintParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PayrollCheckPrintTableset] = obj["returnObj"]
      pass
...
class checkPrintValidations_output:
   def __init__(self, obj):
      pass

class electronicDeposit_output:
   def __init__(self, obj):
      self.returnObj:bool = obj["returnObj"]
      pass

class getLastUsedCheckNum_output:
   def __init__(self, obj):
      self.returnObj:int = obj["returnObj"]
      """  Last check number generated, returns 1 in case any check exists.  """  
      pass

class getLoadedCheckNum_input:
   """ Required : 
   cBankAcctID
   """  
   def __init__(self, obj):
      self.cBankAcctID:str = obj["cBankAcctID"]
      pass

class getLoadedCheckNum_output:
   def __init__(self, obj):
      self.returnObj:int = obj["returnObj"]
      pass

class restartCheckPrintValidations_output:
   def __init__(self, obj):
      pass
