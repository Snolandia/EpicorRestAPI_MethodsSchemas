...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARRecBalanceSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARRecBalanceSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARRecBalanceSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_GetSortByOptionList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARRecBalanceSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetReferencesList(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARRecBalanceSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ARRecBalanceParamRow:
   def __init__(self, obj):
      ...
      """  Summary Only  """  
      self.IncludeCB:bool = obj["IncludeCB"]
      """  Include Closing Balances  """  
      self.IncludeOB:bool = obj["IncludeOB"]
      """  Include Opening Balances  """  
      self.OnlyTransWithDiff:bool = obj["OnlyTransWithDiff"]
...
class Erp_Tablesets_ARRecBalanceTableset:
   def __init__(self, obj):
      self.ARRecBalanceParam:list[Erp_Tablesets_ARRecBalanceParamRow] = obj["ARRecBalanceParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ARRecBalanceTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ARRecBalanceTableset] = obj["returnObj"]
      pass
...
class GetReferencesList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.ReferencesList:str = obj["parameters"]
      pass
