...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WIPReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WIPReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetSortByList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WIPReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetWIPClearedStatusList(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WIPReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WIPReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_WIPParamRow:
   def __init__(self, obj):
      self.CutOffDate:str = obj["CutOffDate"]
      self.Parts:str = obj["Parts"]
      self.Jobs:str = obj["Jobs"]
      self.ProdGroups:str = obj["ProdGroups"]
      self.CurrPlant:bool = obj["CurrPlant"]
      self.SortBy:str = obj["SortBy"]
      self.CutOffDateToken:str = obj["CutOffDateToken"]
      self.Plants:str = obj["Plants"]
      self.WIPClearedStatus:str = obj["WIPClearedStatus"]
      """  "True", "False", "Both"  """  
      self.JobClosedEndDate:str = obj["JobClosedEndDate"]
      self.JobClosedEndDateToken:str = obj["JobClosedEndDateToken"]
      self.JobClosedStartDate:str = obj["JobClosedStartDate"]
      self.JobClosedStartDateToken:str = obj["JobClosedStartDateToken"]
      self.NotPosted:bool = obj["NotPosted"]
      """  Flag to include posted MFG-VAR  """  
      self.Phantom:bool = obj["Phantom"]
      """  Flag to indicate whether to include phantom MFG-VAR  """  
      self.StartDate:str = obj["StartDate"]
      self.StartDateToken:str = obj["StartDateToken"]
      self.InclJobsNotClosed:bool = obj["InclJobsNotClosed"]
...
class Erp_Tablesets_WIPReportTableset:
   def __init__(self, obj):
      self.WIPParam:list[Erp_Tablesets_WIPParamRow] = obj["WIPParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_WIPReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_WIPReportTableset] = obj["returnObj"]
      pass
...
class GetWIPClearedStatusList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.wipClearedStatusList:str = obj["parameters"]
      pass
