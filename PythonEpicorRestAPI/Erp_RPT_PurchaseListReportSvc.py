...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PurchaseListReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PurchaseListReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetSortBy(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PurchaseListReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_OnChangeSummaryMode(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PurchaseListReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PurchaseListReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PurchaseListReportRow:
   def __init__(self, obj):
      ...
      self.ReportDateToken:str = obj["ReportDateToken"]
      self.SortBy:str = obj["SortBy"]
      self.TaxReportList:str = obj["TaxReportList"]
...
class Erp_Tablesets_PurchaseListReportTableset:
   def __init__(self, obj):
      self.PurchaseListReport:list[Erp_Tablesets_PurchaseListReportRow] = obj["PurchaseListReport"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PurchaseListReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PurchaseListReportTableset] = obj["returnObj"]
      pass
...
class OnChangeSummaryMode_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class OnChangeSummaryMode_output:
   def __init__(self, obj):
      pass
