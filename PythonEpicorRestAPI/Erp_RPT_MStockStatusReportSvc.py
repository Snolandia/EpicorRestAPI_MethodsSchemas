...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MStockStatusReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MStockStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Different lists returned for Vista vs. Vantage
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MStockStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetSortOptions2(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MStockStatusReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MStockStatusReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MStockStatusReportParamRow:
   def __init__(self, obj):
      ...
      self.IncludeManagedInventory:str = obj["IncludeManagedInventory"]
      self.VendorList:str = obj["VendorList"]
      self.CustNumList:str = obj["CustNumList"]
      self.SortOptions2:str = obj["SortOptions2"]
...
class Erp_Tablesets_MStockStatusReportTableset:
   def __init__(self, obj):
      self.MStockStatusReportParam:list[Erp_Tablesets_MStockStatusReportParamRow] = obj["MStockStatusReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MStockStatusReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MStockStatusReportTableset] = obj["returnObj"]
      pass
