...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CNGTIExportProcessSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CNGTIExportProcessSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ValidateLocation(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CNGTIExportProcessSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CNGTIExportProcessSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CNGTIExportProcessParamRow:
   def __init__(self, obj):
      self.CNSkipCustDataValidation:bool = obj["CNSkipCustDataValidation"]
      self.CNNotes:str = obj["CNNotes"]
      self.CNFileLocation:str = obj["CNFileLocation"]
      self.CNIsExport:bool = obj["CNIsExport"]
      self.CNExportDataValidationOnly:bool = obj["CNExportDataValidationOnly"]
      self.CNClientImportFileName:str = obj["CNClientImportFileName"]
      self.CNServerImportFileName:str = obj["CNServerImportFileName"]
      self.CNIncludeProductTaxCategory:bool = obj["CNIncludeProductTaxCategory"]
...
class Erp_Tablesets_CNGTIExportProcessTableset:
   def __init__(self, obj):
      self.CNGTIExportProcessParam:list[Erp_Tablesets_CNGTIExportProcessParamRow] = obj["CNGTIExportProcessParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CNGTIExportProcessTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CNGTIExportProcessTableset] = obj["returnObj"]
      pass
...
class ValidateLocation_input:
   ...
   def __init__(self, obj):
      ...
      self.isExport:bool = obj["isExport"]
      pass

class ValidateLocation_output:
   def __init__(self, obj):
      pass
