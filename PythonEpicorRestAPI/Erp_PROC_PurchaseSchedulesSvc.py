...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PurchaseSchedulesSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PurchaseSchedulesSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.PurchaseSchedulesSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.PurchaseSchedulesSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_PurchaseSchedulesParamRow:
   def __init__(self, obj):
      ...
      self.ExcludeReduction:bool = obj["ExcludeReduction"]
      ...
      self.IncludeAll:bool = obj["IncludeAll"]
...
class Erp_Tablesets_PurchaseSchedulesTableset:
   def __init__(self, obj):
      self.PurchaseSchedulesParam:list[Erp_Tablesets_PurchaseSchedulesParamRow] = obj["PurchaseSchedulesParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PurchaseSchedulesTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PurchaseSchedulesTableset] = obj["returnObj"]
      pass
