...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.VendPartRoHSSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.VendPartRoHSSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_getFileName(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.VendPartRoHSSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.VendPartRoHSSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_VendPartRoHSParamRow:
   def __init__(self, obj):
      self.PartList:str = obj["PartList"]
      """  Selected Parts.  """  
      self.VendorList:str = obj["VendorList"]
      """  Selected Vendors.  """  
...
class Erp_Tablesets_VendPartRoHSTableset:
   def __init__(self, obj):
      self.VendPartRoHSParam:list[Erp_Tablesets_VendPartRoHSParamRow] = obj["VendPartRoHSParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_VendPartRoHSTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_VendPartRoHSTableset] = obj["returnObj"]
      pass
