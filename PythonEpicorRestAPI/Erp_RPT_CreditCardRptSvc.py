...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CreditCardRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CreditCardRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ReportUnmaskedCreditCard(epicorHeaders = None):
   """  
...
the Unmasked Credit Card Report.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CreditCardRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CreditCardRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CreditCardRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CreditCardRptParamRow:
   def __init__(self, obj):
      self.CardTypeList:str = obj["CardTypeList"]
      ...
      self.IncludeFailed:bool = obj["IncludeFailed"]
      """  Flag to be set in the report to include/exclude failed transactions  """  
      self.TranDate:str = obj["TranDate"]
      """  Transaction Date  """  
      self.TranDateToken:str = obj["TranDateToken"]
...
class Erp_Tablesets_CreditCardRptTableset:
   def __init__(self, obj):
      self.CreditCardRptParam:list[Erp_Tablesets_CreditCardRptParamRow] = obj["CreditCardRptParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CreditCardRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CreditCardRptTableset] = obj["returnObj"]
      pass
...
class ReportUnmaskedCreditCard_output:
   def __init__(self, obj):
      pass
