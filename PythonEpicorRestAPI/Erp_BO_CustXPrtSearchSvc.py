...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_CustXPrtSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/CustXPrtSearches",headers=creds) as resp:
           return await resp.json()

async def post_CustXPrtSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/CustXPrtSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_CustXPrtSearches_Company_CustNum_PartNum_XPartNum_SysRowID(Company, CustNum, PartNum, XPartNum, SysRowID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/CustXPrtSearches(" + Company + "," + CustNum + "," + PartNum + "," + XPartNum + "," + SysRowID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_CustXPrtSearches_Company_CustNum_PartNum_XPartNum_SysRowID(Company, CustNum, PartNum, XPartNum, SysRowID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/CustXPrtSearches(" + Company + "," + CustNum + "," + PartNum + "," + XPartNum + "," + SysRowID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_CustXPrtSearches_Company_CustNum_PartNum_XPartNum_SysRowID(Company, CustNum, PartNum, XPartNum, SysRowID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/CustXPrtSearches(" + Company + "," + CustNum + "," + PartNum + "," + XPartNum + "," + SysRowID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseCustXPrt, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewCustXPrt(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_CustXPrtListTableset:
   def __init__(self, obj):
...
class Erp_Tablesets_CustXPrtSearchTableset:
   def __init__(self, obj):
      self.CustXPrt:list[Erp_Tablesets_CustXPrtRow] = obj["CustXPrt"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtCustXPrtSearchTableset:
   def __init__(self, obj):
      self.CustXPrt:list[Erp_Tablesets_CustXPrtRow] = obj["CustXPrt"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CustXPrtSearchTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CustXPrtListTableset] = obj["returnObj"]
      pass
...
class GetNewCustXPrt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CustXPrtSearchTableset] = obj["ds"]
      self.custNum:int = obj["custNum"]
      self.partNum:str = obj["partNum"]
      self.xpartNum:str = obj["xpartNum"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtCustXPrtSearchTableset] = obj["ds"]
