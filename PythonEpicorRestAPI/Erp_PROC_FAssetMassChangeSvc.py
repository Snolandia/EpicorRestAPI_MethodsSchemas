...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.FAssetMassChangeSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.FAssetMassChangeSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetCodeDescList(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.FAssetMassChangeSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetFieldsToReplaceList(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.FAssetMassChangeSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_FAssetMassChangeTableset:
   def __init__(self, obj):
      self.FAssetMassParam:list[Erp_Tablesets_FAssetMassParamRow] = obj["FAssetMassParam"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_FAssetMassParamRow:
   def __init__(self, obj):
      ...
      self.Assets:str = obj["Assets"]
      self.AssetGroups:str = obj["AssetGroups"]
      self.AssetClasses:str = obj["AssetClasses"]
      ...
      self.SelectedAssets:bool = obj["SelectedAssets"]
      self.SelectedAssetGroups:bool = obj["SelectedAssetGroups"]
      self.SelectedAssetClasses:bool = obj["SelectedAssetClasses"]
      self.ReplaceList:str = obj["ReplaceList"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_FAssetMassChangeTableset] = obj["ds"]
      pass
...
class GetFieldsToReplaceList_input:
   """ Required : 
   whereClause
   pageSize
   absolutePage
...
class GetFieldsToReplaceList_output:
   def __init__(self, obj):
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_FAssetMassChangeTableset] = obj["returnObj"]
      pass
