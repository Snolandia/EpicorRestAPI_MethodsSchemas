...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.APDebitMemoFormSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.APDebitMemoFormSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.APDebitMemoFormSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.APDebitMemoFormSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.APDebitMemoFormSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_APDebitMemoFormParamRow:
   def __init__(self, obj):
      self.VendorNum:int = obj["VendorNum"]
      self.InvoiceNum:str = obj["InvoiceNum"]
      self.TWPart1:bool = obj["TWPart1"]
      self.TWPart2:bool = obj["TWPart2"]
      self.TWPart3:bool = obj["TWPart3"]
      self.TWPart4:bool = obj["TWPart4"]
      self.TWReportType:str = obj["TWReportType"]
...
class Erp_Tablesets_APDebitMemoFormTableset:
   def __init__(self, obj):
      self.APDebitMemoFormParam:list[Erp_Tablesets_APDebitMemoFormParamRow] = obj["APDebitMemoFormParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_APDebitMemoFormTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_APDebitMemoFormTableset] = obj["returnObj"]
      pass
