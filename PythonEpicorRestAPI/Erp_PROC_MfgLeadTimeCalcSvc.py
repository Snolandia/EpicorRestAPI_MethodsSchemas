...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MfgLeadTimeCalcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MfgLeadTimeCalcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MfgLeadTimeCalcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.MfgLeadTimeCalcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MfgLeadTimeCalcRow:
   def __init__(self, obj):
      self.AsOfDate:str = obj["AsOfDate"]
      self.AsOfDateToken:str = obj["AsOfDateToken"]
      self.Company:str = obj["Company"]
      self.IncSubAsmblies:bool = obj["IncSubAsmblies"]
...
class Erp_Tablesets_MfgLeadTimeCalcTableset:
   def __init__(self, obj):
      self.MfgLeadTimeCalc:list[Erp_Tablesets_MfgLeadTimeCalcRow] = obj["MfgLeadTimeCalc"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MfgLeadTimeCalcTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MfgLeadTimeCalcTableset] = obj["returnObj"]
      pass
