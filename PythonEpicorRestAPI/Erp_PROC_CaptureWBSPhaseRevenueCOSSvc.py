...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetProjectDesc(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_ProjectIDChanged(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class ChangeEndingDate_input:
   ...
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CaptureWBSPhaseRevenueCOSTableset] = obj["ds"]
...
class Erp_Tablesets_CaptureWBSPhaseRevenueCOSTableset:
   def __init__(self, obj):
      self.CaptureWBSPhaseRevenueCOSParam:list[Erp_Tablesets_CaptureWBSPhaseRevenueCOSParamRow] = obj["CaptureWBSPhaseRevenueCOSParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CaptureWBSPhaseRevenueCOSTableset] = obj["returnObj"]
      pass
