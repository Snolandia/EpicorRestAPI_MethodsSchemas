...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXListOfAccountsSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXListOfAccountsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXListOfAccountsSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.MXListOfAccountsSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MXListOfAccountsParamRow:
   def __init__(self, obj):
      ...
      """  Fiscal Year Suffix  """  
      self.PrintedAccountMaxLevel:int = obj["PrintedAccountMaxLevel"]
      ...
      self.ActiveFlagValidationLevel:int = obj["ActiveFlagValidationLevel"]
...
class Erp_Tablesets_MXListOfAccountsTableset:
   def __init__(self, obj):
      self.MXListOfAccountsParam:list[Erp_Tablesets_MXListOfAccountsParamRow] = obj["MXListOfAccountsParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MXListOfAccountsTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MXListOfAccountsTableset] = obj["returnObj"]
      pass
