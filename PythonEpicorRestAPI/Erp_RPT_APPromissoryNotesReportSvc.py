...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_CheckAPPromNoteIDNumbers(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_CheckAPPromNoteIDNumbersRestart(requestBody, epicorHeaders = None):
   """  
...
async def post_HeadNumDefaults(requestBody, epicorHeaders = None):
   """  
...
async def post_validateAPPNPaymentParam(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class CheckAPPromNoteIDNumbersRestart_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_APPromissoryNotesReportTableset] = obj["ds"]
      pass

class CheckAPPromNoteIDNumbersRestart_output:
   def __init__(self, obj):
      pass
...
class CheckAPPromNoteIDNumbers_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class CheckAPPromNoteIDNumbers_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_APPromissoryNoteParamRow:
   def __init__(self, obj):
...
class Erp_Tablesets_APPromissoryNotesReportTableset:
   def __init__(self, obj):
      self.APPromissoryNoteParam:list[Erp_Tablesets_APPromissoryNoteParamRow] = obj["APPromissoryNoteParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_APPromissoryNotesReportTableset] = obj["returnObj"]
      pass
...
class getStartCheckNum_input:
   ...
   """  
   def __init__(self, obj):
      self.genOption:str = obj["genOption"]
      """  Gen Option  """  
...
class validateAPPNPaymentParam_input:
   """ Required : 
   ttAPPromissoryNoteParam
   """  
   def __init__(self, obj):
      self.ttAPPromissoryNoteParam:list[Erp_Tablesets_APPromissoryNoteParamRow] = obj["ttAPPromissoryNoteParam"]
      pass

class validateAPPNPaymentParam_output:
   def __init__(self, obj):
      pass
