...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ExportMattecSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ExportMattecSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_verifyOutputLocation(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ExportMattecSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ExportMattecSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ExportMattecParamRow:
   def __init__(self, obj):
      self.LogFileName:str = obj["LogFileName"]
      self.Inactive:bool = obj["Inactive"]
      self.OutboundPath:str = obj["OutboundPath"]
      ...
      self.NetChange:bool = obj["NetChange"]
      self.ClearSchedule:str = obj["ClearSchedule"]
      self.ResourceList:str = obj["ResourceList"]
      self.ResourceGrpList:str = obj["ResourceGrpList"]
      self.ExportOption:str = obj["ExportOption"]
      """  Used to determine how to export operations for the Export to Mattec process.  Can be J, O or P.  """  
      self.WriteCSVFile:bool = obj["WriteCSVFile"]
      self.ExecuteODataCalls:bool = obj["ExecuteODataCalls"]
      self.ODataURL:str = obj["ODataURL"]
      self.ODataUsername:str = obj["ODataUsername"]
      self.ODataPassword:str = obj["ODataPassword"]
...
class Erp_Tablesets_ExportMattecTableset:
   def __init__(self, obj):
      self.ExportMattecParam:list[Erp_Tablesets_ExportMattecParamRow] = obj["ExportMattecParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ExportMattecTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ExportMattecTableset] = obj["returnObj"]
      pass
