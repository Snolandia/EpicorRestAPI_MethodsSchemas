...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CntVarSerialNReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CntVarSerialNReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
/// <param name="ds">Report Data set</param>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CntVarSerialNReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CntVarSerialNReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CntVarSerialNReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CntVarSerialNReportParamRow:
   def __init__(self, obj):
      self.PrintTagDtl:bool = obj["PrintTagDtl"]
      self.Warehouse:str = obj["Warehouse"]
      self.Month:int = obj["Month"]
      self.Year:int = obj["Year"]
      self.Cycle:int = obj["Cycle"]
      self.FullPhysical:bool = obj["FullPhysical"]
      self.PartDetailType:int = obj["PartDetailType"]
...
class Erp_Tablesets_CntVarSerialNReportTableset:
   def __init__(self, obj):
      self.CntVarSerialNReportParam:list[Erp_Tablesets_CntVarSerialNReportParamRow] = obj["CntVarSerialNReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CntVarSerialNReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CntVarSerialNReportTableset] = obj["returnObj"]
      pass
