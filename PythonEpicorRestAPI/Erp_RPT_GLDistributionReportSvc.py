...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLDistributionReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLDistributionReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_DisableLI(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GLDistributionReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLDistributionReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GLDistributionReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class DisableLI_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.disableLI:bool = obj["disableLI"]
      pass

      """  output parameters  """  

class Erp_Tablesets_GLDistributionReportRow:
   def __init__(self, obj):
      self.FiscalYear:int = obj["FiscalYear"]
      self.Period:int = obj["Period"]
      self.StartDate:str = obj["StartDate"]
      self.EndDate:str = obj["EndDate"]
      self.Sales:bool = obj["Sales"]
      self.CashRcpts:bool = obj["CashRcpts"]
      self.CashDisburs:bool = obj["CashDisburs"]
      self.Adjustments:bool = obj["Adjustments"]
      self.Payroll:bool = obj["Payroll"]
      self.BankTran:bool = obj["BankTran"]
      self.Purchases:bool = obj["Purchases"]
      self.SelectBy:str = obj["SelectBy"]
      self.StartDateToken:str = obj["StartDateToken"]
      self.EndDateToken:str = obj["EndDateToken"]
      self.LoggedInvoices:bool = obj["LoggedInvoices"]
...
class Erp_Tablesets_GLDistributionReportTableset:
   def __init__(self, obj):
      self.GLDistributionReport:list[Erp_Tablesets_GLDistributionReportRow] = obj["GLDistributionReport"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GLDistributionReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLDistributionReportTableset] = obj["returnObj"]
      pass
