...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARDiscAnalysisSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARDiscAnalysisSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetSortByOptionList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARDiscAnalysisSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARDiscAnalysisSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARDiscAnalysisSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ARDiscAnalysisParamRow:
   def __init__(self, obj):
      self.CashRecDate:str = obj["CashRecDate"]
      """  Cash Receipt Date  """  
      self.CashRecDateToken:str = obj["CashRecDateToken"]
      self.CustNumList:str = obj["CustNumList"]
      """  Customer Selection List  """  
      self.EarnedDisc:bool = obj["EarnedDisc"]
      """  Earned Discounts  """  
      ...
      self.ZeroDisc:bool = obj["ZeroDisc"]
      """  Report Sort By Option  """  
      self.SummaryRpt:bool = obj["SummaryRpt"]
...
class Erp_Tablesets_ARDiscAnalysisTableset:
   def __init__(self, obj):
      self.ARDiscAnalysisParam:list[Erp_Tablesets_ARDiscAnalysisParamRow] = obj["ARDiscAnalysisParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ARDiscAnalysisTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ARDiscAnalysisTableset] = obj["returnObj"]
      pass
