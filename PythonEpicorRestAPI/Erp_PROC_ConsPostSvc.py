...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_ChangeOfEnableLogFile(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetConsolidationValues(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangeOfLogFileName(requestBody, epicorHeaders = None):
   """  
...
async def post_GetConsSrcCtrlValues(requestBody, epicorHeaders = None):
   """  
...
async def post_GetConsolidationStatus(requestBody, epicorHeaders = None):
   """  
...
async def post_ValidateSourceBook(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class ChangeOfEnableLogFile_input:
   """ Required : 
   proposedEnableLogFile
   consPostTableSet
   """  
   def __init__(self, obj):
      self.proposedEnableLogFile:bool = obj["proposedEnableLogFile"]
      """  Proposed value for EnableLogFile.  """  
      self.consPostTableSet:list[Erp_Tablesets_ConsPostTableset] = obj["consPostTableSet"]
      pass

class ChangeOfEnableLogFile_output:
   def __init__(self, obj):
      pass
...
class ChangeOfLogFileName_input:
   """ Required : 
   proposedFileName
   """  
   def __init__(self, obj):
      self.proposedFileName:str = obj["proposedFileName"]
      pass

class ChangeOfLogFileName_output:
   def __init__(self, obj):
...
class Erp_Tablesets_ConsPostParamRow:
   def __init__(self, obj):
      ...
      self.SrcBookDescrip:str = obj["SrcBookDescrip"]
      """  Source GL Book Descrption  """  
      self.TgtBookDescrip:str = obj["TgtBookDescrip"]
...
O - Overriding Period  """  
      ...
      self.EnableLogFile:bool = obj["EnableLogFile"]
...
class Erp_Tablesets_ConsPostTableset:
   def __init__(self, obj):
      self.ConsPostParam:list[Erp_Tablesets_ConsPostParamRow] = obj["ConsPostParam"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class GetConsSrcCtrlValues_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ConsPostTableset] = obj["ds"]
      pass

class GetConsSrcCtrlValues_output:
   def __init__(self, obj):
      pass
...
class GetConsolidationStatus_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class GetConsolidationStatus_output:
   def __init__(self, obj):
      pass
...
class GetConsolidationValues_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class GetConsolidationValues_output:
   def __init__(self, obj):
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ConsPostTableset] = obj["returnObj"]
      pass
...
class ValidateSourceBook_input:
   """ Required : 
   intGenID
   txtSourceBook
   """  
...
class ValidateSourceBook_output:
   def __init__(self, obj):
      pass
