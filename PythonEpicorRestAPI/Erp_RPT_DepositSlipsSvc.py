...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DepositSlipsSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DepositSlipsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetCodeDescList(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.DepositSlipsSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_ValidateParameters(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DepositSlipsSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.DepositSlipsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_DepositSlipsParamRow:
   def __init__(self, obj):
      self.GroupList:str = obj["GroupList"]
      self.PaymentMethodList:str = obj["PaymentMethodList"]
      self.PostedTransactions:int = obj["PostedTransactions"]
      self.TransactionDateFrom:str = obj["TransactionDateFrom"]
      self.TransactionDateFromToken:str = obj["TransactionDateFromToken"]
      self.TransactionDateTo:str = obj["TransactionDateTo"]
      self.TransactionDateToToken:str = obj["TransactionDateToToken"]
      self.BankAccount:str = obj["BankAccount"]
      self.BatchRefList:str = obj["BatchRefList"]
      self.UseCase:int = obj["UseCase"]
      self.BatchRefToAssign:str = obj["BatchRefToAssign"]
      self.AutoBatchNumMode:bool = obj["AutoBatchNumMode"]
...
class Erp_Tablesets_DepositSlipsTableset:
   def __init__(self, obj):
      self.DepositSlipsParam:list[Erp_Tablesets_DepositSlipsParamRow] = obj["DepositSlipsParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_DepositSlipsTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_DepositSlipsTableset] = obj["returnObj"]
      pass
...
class ValidateParameters_input:
   """ Required : 
   bankAcctID
   dateFrom
   dateFromToken
   ...
   def __init__(self, obj):
      ...
      self.dateFromToken:str = obj["dateFromToken"]
      self.dateTo:str = obj["dateTo"]
      self.dateToToken:str = obj["dateToToken"]
      self.pmList:str = obj["pmList"]
      self.cashGrpList:str = obj["cashGrpList"]
      self.batchRefList:str = obj["batchRefList"]
      self.posted:int = obj["posted"]
      self.batchRefToAssign:str = obj["batchRefToAssign"]
      self.autoBatch:bool = obj["autoBatch"]
      pass

class ValidateParameters_output:
   def __init__(self, obj):
