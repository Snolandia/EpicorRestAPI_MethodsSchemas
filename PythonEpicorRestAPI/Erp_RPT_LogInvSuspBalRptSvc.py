...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
<param name="ipFiscalYear">fiscal year</param><param name="ds">Logged Invoice Suspense Report DataSet </param>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_ChangeSelectBy(requestBody, epicorHeaders = None):
   """  
...
async def post_GetSortBy(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_getCurrentPeriod(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class ChangeFiscalYear_input:
   ...
   def __init__(self, obj):
      ...
      self.ds:list[Erp_Tablesets_LogInvSuspBalRptTableset] = obj["ds"]
      pass
...
class ChangeSelectBy_input:
   """ Required : 
   ipSelectBy
   ds
   """  
   def __init__(self, obj):
      self.ipSelectBy:str = obj["ipSelectBy"]
      self.ds:list[Erp_Tablesets_LogInvSuspBalRptTableset] = obj["ds"]
      pass

class ChangeSelectBy_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_LogInvSuspBalRptParamRow:
   def __init__(self, obj):
...
class Erp_Tablesets_LogInvSuspBalRptTableset:
   def __init__(self, obj):
      self.LogInvSuspBalRptParam:list[Erp_Tablesets_LogInvSuspBalRptParamRow] = obj["LogInvSuspBalRptParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_LogInvSuspBalRptTableset] = obj["returnObj"]
      pass
