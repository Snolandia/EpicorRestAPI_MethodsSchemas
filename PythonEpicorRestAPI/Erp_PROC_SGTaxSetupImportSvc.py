...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SGTaxSetupImportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SGTaxSetupImportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SGTaxSetupImportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.SGTaxSetupImportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_SGTaxSetupImportParamRow:
   def __init__(self, obj):
      self.EFTHeadUID:int = obj["EFTHeadUID"]
      """  Electronic Interface  """  
      self.ImportFiles:str = obj["ImportFiles"]
      self.ServerImportFiles:str = obj["ServerImportFiles"]
...
class Erp_Tablesets_SGTaxSetupImportTableset:
   def __init__(self, obj):
      self.SGTaxSetupImportParam:list[Erp_Tablesets_SGTaxSetupImportParamRow] = obj["SGTaxSetupImportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SGTaxSetupImportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SGTaxSetupImportTableset] = obj["returnObj"]
      pass
