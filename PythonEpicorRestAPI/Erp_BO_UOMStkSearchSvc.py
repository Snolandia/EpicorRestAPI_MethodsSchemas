...
# Title: Erp.BO.UOMStkSearchSvc
# Description: This object provides a GetList method returning the Unit of Measures that a specific Part is stocked in.
# Version: v1
...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.UOMStkSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.UOMStkSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.UOMStkSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def post_GetList(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.UOMStkSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_UOMStkSearchTableset:
   def __init__(self, obj):
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_UOMStkSearchTableset] = obj["returnObj"]
      pass
