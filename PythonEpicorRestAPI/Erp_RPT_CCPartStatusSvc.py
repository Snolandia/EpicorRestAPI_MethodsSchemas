...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CCPartStatusSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CCPartStatusSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes: This is to give the UI a visual on the values for the SortByOption.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CCPartStatusSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CCPartStatusSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CCPartStatusSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CCPartStatusParamRow:
   def __init__(self, obj):
      self.WhsList:str = obj["WhsList"]
      """  List of selected Warehouses  """  
      self.ABCList:str = obj["ABCList"]
      ...
      self.OverdueOnly:bool = obj["OverdueOnly"]
...
class Erp_Tablesets_CCPartStatusTableset:
   def __init__(self, obj):
      self.CCPartStatusParam:list[Erp_Tablesets_CCPartStatusParamRow] = obj["CCPartStatusParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CCPartStatusTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CCPartStatusTableset] = obj["returnObj"]
      pass
