...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.SysCubeProcessSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.SysCubeProcessSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetCubeSysRowID(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.PROC.SysCubeProcessSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.SysCubeProcessSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_SysCubeProcessTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_SysCubeProcessTableset] = obj["returnObj"]
      pass
...
class Ice_Tablesets_SysCubeProcessRow:
   def __init__(self, obj):
      self.CubeSysRowID:str = obj["CubeSysRowID"]
      self.SysRowID:str = obj["SysRowID"]
...
class Ice_Tablesets_SysCubeProcessTableset:
   def __init__(self, obj):
      self.SysCubeProcess:list[Ice_Tablesets_SysCubeProcessRow] = obj["SysCubeProcess"]
