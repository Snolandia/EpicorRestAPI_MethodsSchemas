...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CashRecSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CashRecSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_CashRecSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CashRecSearchSvc/CashRecSearches",headers=creds) as resp:
           return await resp.json()

async def post_CashRecSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.CashRecSearchSvc/CashRecSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_CashRecSearches_Company_GroupID_HeadNum(Company, GroupID, HeadNum, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CashRecSearchSvc/CashRecSearches(" + Company + "," + GroupID + "," + HeadNum + ")",headers=creds) as resp:
           return await resp.json()

async def patch_CashRecSearches_Company_GroupID_HeadNum(Company, GroupID, HeadNum, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.CashRecSearchSvc/CashRecSearches(" + Company + "," + GroupID + "," + HeadNum + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_CashRecSearches_Company_GroupID_HeadNum(Company, GroupID, HeadNum, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.CashRecSearchSvc/CashRecSearches(" + Company + "," + GroupID + "," + HeadNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CashRecSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseCashHead, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CashRecSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetDeposits(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.CashRecSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetDepositsAndSort(requestBody, epicorHeaders = None):
   """  
...
async def post_GetAppliedDeposits(requestBody, epicorHeaders = None):
   """  
...
async def post_GetUnappliedDeposits(requestBody, epicorHeaders = None):
   """  
...
class Erp_Tablesets_CashRecSearchTableset:
   def __init__(self, obj):
      self.CashHead:list[Erp_Tablesets_CashHeadRow] = obj["CashHead"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtCashRecSearchTableset:
   def __init__(self, obj):
      self.CashHead:list[Erp_Tablesets_CashHeadRow] = obj["CashHead"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class GetAppliedDeposits_input:
   """ Required : 
   whereClause
   """  
   def __init__(self, obj):
...
class GetAppliedDeposits_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CashRecSearchTableset] = obj["returnObj"]
      pass
...
class GetDepositsAndSort_input:
   """ Required : 
   whereClause
   applied
   pageSize
   ...
   def __init__(self, obj):
      ...
      self.pageSize:str = obj["pageSize"]
      """  page size  """  
      self.absolutePage:str = obj["absolutePage"]
      """  Sort by  """  
      pass

class GetDepositsAndSort_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CashRecSearchTableset] = obj["returnObj"]
      pass
...
class GetNewCashHead_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CashRecSearchTableset] = obj["ds"]
      self.groupID:str = obj["groupID"]
      pass
...
class GetUnappliedDeposits_input:
   """ Required : 
   whereClause
   """  
   def __init__(self, obj):
...
class GetUnappliedDeposits_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CashRecSearchTableset] = obj["returnObj"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtCashRecSearchTableset] = obj["ds"]
