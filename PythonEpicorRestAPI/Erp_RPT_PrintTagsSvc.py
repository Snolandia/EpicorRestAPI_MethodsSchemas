...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetWhseDesc(requestBody, epicorHeaders = None):
   """  
...
/// <param name="ds">Report Data set</param>
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_PrintTagsParamRow:
   def __init__(self, obj):
      ...
      self.PrintBlankPCIDTags:bool = obj["PrintBlankPCIDTags"]
      ...
      self.PrintPCIDNestedTags:bool = obj["PrintPCIDNestedTags"]
...
class Erp_Tablesets_PrintTagsTableset:
   def __init__(self, obj):
      self.PrintTagsParam:list[Erp_Tablesets_PrintTagsParamRow] = obj["PrintTagsParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PrintTagsTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PrintTagsTableset] = obj["returnObj"]
      pass
