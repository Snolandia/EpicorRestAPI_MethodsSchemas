...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWVoidBlankLegalNumRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWVoidBlankLegalNumRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_OnChangeOfReportPeriod(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TWVoidBlankLegalNumRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.TWVoidBlankLegalNumRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.TWVoidBlankLegalNumRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_TWVoidBlankLegalNumRptParamRow:
   def __init__(self, obj):
...
class Erp_Tablesets_TWVoidBlankLegalNumRptTableset:
   def __init__(self, obj):
      self.TWVoidBlankLegalNumRptParam:list[Erp_Tablesets_TWVoidBlankLegalNumRptParamRow] = obj["TWVoidBlankLegalNumRptParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TWVoidBlankLegalNumRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TWVoidBlankLegalNumRptTableset] = obj["returnObj"]
      pass
