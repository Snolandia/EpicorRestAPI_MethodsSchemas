...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_getFileName(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MRPRecalcNeededParamRow:
   def __init__(self, obj):
      self.CheckOnHandQty:bool = obj["CheckOnHandQty"]
      ...
      self.CheckCutoffWindow:bool = obj["CheckCutoffWindow"]
      ...
      self.CheckFiniteHorizon:bool = obj["CheckFiniteHorizon"]
      ...
      self.ProposedScheduleDate:str = obj["ProposedScheduleDate"]
      ...
      self.CheckShortHorizon:bool = obj["CheckShortHorizon"]
      ...
      self.FullLogFile:str = obj["FullLogFile"]
      """  This is the log file name with the file path.  This is not seen by the user but is used internally.  """  
      self.CutOffDateToken:str = obj["CutOffDateToken"]
      """  Cut Off Date Token  """  
      self.ProposedScheduleDateToken:str = obj["ProposedScheduleDateToken"]
...
class Erp_Tablesets_MRPRecalcNeededTableset:
   def __init__(self, obj):
      self.MRPRecalcNeededParam:list[Erp_Tablesets_MRPRecalcNeededParamRow] = obj["MRPRecalcNeededParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MRPRecalcNeededTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MRPRecalcNeededTableset] = obj["returnObj"]
      pass
...
class getFileName_input:
   """ Required : 
   IP_BaseName
   IP_FileType
   """  
   def __init__(self, obj):
      self.IP_BaseName:str = obj["IP_BaseName"]
      self.IP_FileType:str = obj["IP_FileType"]
      pass

class getFileName_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass
