...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetDepreciationReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetDepreciationReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.AssetDepreciationReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_ValidateSummary(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.AssetDepreciationReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.AssetDepreciationReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_AssetDepreciationParamRow:
   def __init__(self, obj):
      self.AssetGroupList:str = obj["AssetGroupList"]
      """  Asset Group List  """  
      self.AssetNumList:str = obj["AssetNumList"]
      """  Asset Number List  """  
      self.AssetRegisterID:str = obj["AssetRegisterID"]
      """  AssetRegisterID  """  
      ...
      self.IncludeChildAssets:bool = obj["IncludeChildAssets"]
      """  Include Child Assets  """  
      self.PeriodFrom:int = obj["PeriodFrom"]
      """  Period From  """  
      self.PeriodTo:int = obj["PeriodTo"]
      """  Period To  """  
...
class Erp_Tablesets_AssetDepreciationReportTableset:
   def __init__(self, obj):
      self.AssetDepreciationParam:list[Erp_Tablesets_AssetDepreciationParamRow] = obj["AssetDepreciationParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_AssetDepreciationReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_AssetDepreciationReportTableset] = obj["returnObj"]
      pass
