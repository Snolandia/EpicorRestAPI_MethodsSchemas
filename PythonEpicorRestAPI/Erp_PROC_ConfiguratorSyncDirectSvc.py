...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConfiguratorSyncDirectSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConfiguratorSyncDirectSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_AllExtCompanyList(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ConfiguratorSyncDirectSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetTaskExtCompanyIDs(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ConfiguratorSyncDirectSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConfiguratorSyncDirectSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class AllExtCompanyList_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass

class Erp_Tablesets_ConfiguratorSyncDirectParamRow:
   def __init__(self, obj):
      ...
      self.ProcessingBranch:str = obj["ProcessingBranch"]
      self.TenantID:str = obj["TenantID"]
      self.TenantMode:bool = obj["TenantMode"]
...
class Erp_Tablesets_ConfiguratorSyncDirectTableset:
   def __init__(self, obj):
      self.ConfiguratorSyncDirectParam:list[Erp_Tablesets_ConfiguratorSyncDirectParamRow] = obj["ConfiguratorSyncDirectParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ConfiguratorSyncDirectTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ConfiguratorSyncDirectTableset] = obj["returnObj"]
      pass
...
class GetTaskExtCompanyIDs_input:
   """ Required : 
   schedNum
   taskNum
   """  
...
class GetTaskExtCompanyIDs_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass
