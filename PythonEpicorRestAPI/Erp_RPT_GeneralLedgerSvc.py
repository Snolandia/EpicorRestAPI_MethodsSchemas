...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_OnChangedBookID(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_GeneralLedgerParamRow:
   def __init__(self, obj):
      self.FiscalYear:int = obj["FiscalYear"]
      """  Fiscal Year  """  
      self.EndFiscalPeriod:int = obj["EndFiscalPeriod"]
      """  End Fiscal Period  """  
      self.StartingAccount:str = obj["StartingAccount"]
      """  Starting Account  """  
      self.EndingAccount:str = obj["EndingAccount"]
      """  Ending Account  """  
      ...
      self.OneTimeIDList:str = obj["OneTimeIDList"]
      """   One-Time Customer/Supllier list
Colombia Loc  """  
      self.PrintSelCriteria:bool = obj["PrintSelCriteria"]
      self.PrintStatData:bool = obj["PrintStatData"]
      self.AdditionalNatAcctList:str = obj["AdditionalNatAcctList"]
      """  Additional Natural Accounts  """  
      self.ExcludedNatAcctList:str = obj["ExcludedNatAcctList"]
      """  Excluded Natural Accounts  """  
      self.AccountSelectionType:str = obj["AccountSelectionType"]
...
class Erp_Tablesets_GeneralLedgerTableset:
   def __init__(self, obj):
      self.GeneralLedgerParam:list[Erp_Tablesets_GeneralLedgerParamRow] = obj["GeneralLedgerParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GeneralLedgerTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GeneralLedgerTableset] = obj["returnObj"]
      pass
