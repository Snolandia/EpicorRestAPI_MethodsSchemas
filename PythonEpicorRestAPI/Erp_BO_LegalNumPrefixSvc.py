...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LegalNumPrefixSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LegalNumPrefixSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_LegalNumPrefixes(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LegalNumPrefixSvc/LegalNumPrefixes",headers=creds) as resp:
           return await resp.json()
...
async def post_LegalNumPrefixes(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.LegalNumPrefixSvc/LegalNumPrefixes", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_LegalNumPrefixes_Company_LegalNumberID_Prefix_Plant(Company, LegalNumberID, Prefix, Plant, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LegalNumPrefixSvc/LegalNumPrefixes(" + Company + "," + LegalNumberID + "," + Prefix + "," + Plant + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_LegalNumPrefixes_Company_LegalNumberID_Prefix_Plant(Company, LegalNumberID, Prefix, Plant, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.LegalNumPrefixSvc/LegalNumPrefixes(" + Company + "," + LegalNumberID + "," + Prefix + "," + Plant + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_LegalNumPrefixes_Company_LegalNumberID_Prefix_Plant(Company, LegalNumberID, Prefix, Plant, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.LegalNumPrefixSvc/LegalNumPrefixes(" + Company + "," + LegalNumberID + "," + Prefix + "," + Plant + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LegalNumPrefixSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseLegalNumPrefix, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LegalNumPrefixSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(legalNumberID, prefix, plant, epicorHeaders = None):
   """  
...
async def post_GetNewLegalNumPrefix(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.LegalNumPrefixSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LegalNumPrefixListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_LegalNumPrefixListRow] = obj["value"]
      pass
...
class Erp_Tablesets_LegalNumPrefixListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_LegalNumPrefixListTableset:
   def __init__(self, obj):
      self.LegalNumPrefixList:list[Erp_Tablesets_LegalNumPrefixListRow] = obj["LegalNumPrefixList"]
...
class Erp_Tablesets_LegalNumPrefixTableset:
   def __init__(self, obj):
      self.LegalNumPrefix:list[Erp_Tablesets_LegalNumPrefixRow] = obj["LegalNumPrefix"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtLegalNumPrefixTableset:
   def __init__(self, obj):
      self.LegalNumPrefix:list[Erp_Tablesets_LegalNumPrefixRow] = obj["LegalNumPrefix"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_LegalNumPrefixTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_LegalNumPrefixListTableset] = obj["returnObj"]
      pass
...
class GetNewLegalNumPrefix_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_LegalNumPrefixTableset] = obj["ds"]
      self.legalNumberID:str = obj["legalNumberID"]
      self.prefix:str = obj["prefix"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtLegalNumPrefixTableset] = obj["ds"]
