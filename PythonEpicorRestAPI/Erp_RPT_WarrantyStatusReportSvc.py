...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WarrantyStatusReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WarrantyStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetReportFormat(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WarrantyStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetWarrantyStatus(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WarrantyStatusReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WarrantyStatusReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_WarrantyStatusReportTableset:
   def __init__(self, obj):
      self.WarrantyStatusParam:list[Erp_Tablesets_WarrantyStatusParamRow] = obj["WarrantyStatusParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_WarrantyStatusReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_WarrantyStatusReportTableset] = obj["returnObj"]
      pass
...
class GetWarrantyStatus_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.WarrantyStatusList:str = obj["parameters"]
      pass
