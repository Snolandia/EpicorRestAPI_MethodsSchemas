...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_LaborDtls(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlSvc/LaborDtls",headers=creds) as resp:
           return await resp.json()
...
async def post_LaborDtls(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlSvc/LaborDtls", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_LaborDtls_Company_LaborHedSeq_LaborDtlSeq(Company, LaborHedSeq, LaborDtlSeq, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlSvc/LaborDtls(" + Company + "," + LaborHedSeq + "," + LaborDtlSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_LaborDtls_Company_LaborHedSeq_LaborDtlSeq(Company, LaborHedSeq, LaborDtlSeq, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlSvc/LaborDtls(" + Company + "," + LaborHedSeq + "," + LaborDtlSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_LaborDtls_Company_LaborHedSeq_LaborDtlSeq(Company, LaborHedSeq, LaborDtlSeq, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlSvc/LaborDtls(" + Company + "," + LaborHedSeq + "," + LaborDtlSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseLaborDtl, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewLaborDtl(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_LaborDtlTableset:
   def __init__(self, obj):
      self.LaborDtl:list[Erp_Tablesets_LaborDtlRow] = obj["LaborDtl"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtLaborDtlTableset:
   def __init__(self, obj):
      self.LaborDtl:list[Erp_Tablesets_LaborDtlRow] = obj["LaborDtl"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_LaborDtlTableset] = obj["returnObj"]
      pass
...
class GetNewLaborDtl_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_LaborDtlTableset] = obj["ds"]
      self.laborHedSeq:int = obj["laborHedSeq"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtLaborDtlTableset] = obj["ds"]
