...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AutoJobReleaseSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AutoJobReleaseSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_CheckSec(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.AutoJobReleaseSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AutoJobReleaseSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.AutoJobReleaseSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class CheckSec_output:
   def __init__(self, obj):
      pass

class Erp_Tablesets_AutoJobReleaseRow:
   def __init__(self, obj):
      ...
      """  Log File  """  
      self.OverrideConstraints:bool = obj["OverrideConstraints"]
      """  Override material constraints  """  
      self.OverridePurReq:bool = obj["OverridePurReq"]
      """  Override open purchase requirements  """  
      self.InspectionOnHand:bool = obj["InspectionOnHand"]
...
class Erp_Tablesets_AutoJobReleaseTableset:
   def __init__(self, obj):
      self.AutoJobRelease:list[Erp_Tablesets_AutoJobReleaseRow] = obj["AutoJobRelease"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_AutoJobReleaseTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_AutoJobReleaseTableset] = obj["returnObj"]
      pass
