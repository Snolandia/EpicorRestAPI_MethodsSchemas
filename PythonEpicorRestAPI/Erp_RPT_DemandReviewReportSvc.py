...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DemandReviewReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DemandReviewReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DemandReviewReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.DemandReviewReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.DemandReviewReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_DemandReviewParamRow:
   def __init__(self, obj):
      self.CustNumList:str = obj["CustNumList"]
      """  Delimited list of Cust Numbers to print the report for  """  
      self.ExcludeClosed:bool = obj["ExcludeClosed"]
      self.ExcludeNoChanges:bool = obj["ExcludeNoChanges"]
      self.ExcludePosted:bool = obj["ExcludePosted"]
      self.ExcludeProcessed:bool = obj["ExcludeProcessed"]
      self.ExcludeRejected:bool = obj["ExcludeRejected"]
      ...
      self.PONumList:str = obj["PONumList"]
      ...
      self.PriceDiscrepancies:bool = obj["PriceDiscrepancies"]
      """  this is a flag in order to show the Price Discrepancies  """  
      self.AllLogEntries:bool = obj["AllLogEntries"]
...
class Erp_Tablesets_DemandReviewReportTableset:
   def __init__(self, obj):
      self.DemandReviewParam:list[Erp_Tablesets_DemandReviewParamRow] = obj["DemandReviewParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_DemandReviewReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_DemandReviewReportTableset] = obj["returnObj"]
      pass
