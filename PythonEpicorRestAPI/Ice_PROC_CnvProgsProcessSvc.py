...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_RunConversion(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_RunConversions(requestBody, epicorHeaders = None):
   """  
...
async def post_SaveToProcessSet(requestBody, epicorHeaders = None):
   """  
...
async def post_GetSysTaskNumByProgram(requestBody, epicorHeaders = None):
   """  
...
async def post_GetLastSysTaskLog(requestBody, epicorHeaders = None):
   """  
...
async def post_GetConversionID(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class GetConversionID_input:
   ...
   def __init__(self, obj):
      ...
      """  ProcessID  """  
      self.processTask:int = obj["processTask"]
      """  SysTaskNum  """  
      pass

class GetConversionID_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.systemCode:str = obj["parameters"]
      self.conversionID:str = obj["parameters"]
      pass
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_CnvProgsProcessTableset] = obj["ds"]
      pass
...
class GetLastSysTaskLog_output:
   def __init__(self, obj):
   ...
   def parameters(self, obj):
      self.msgText:str = obj["parameters"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_CnvProgsProcessTableset] = obj["returnObj"]
      pass
...
class GetSysTaskNumByProgram_input:
   """ Required : 
   convProgram
   """  
   def __init__(self, obj):
      self.convProgram:str = obj["convProgram"]
      """  conversion program name  """  
      pass

class GetSysTaskNumByProgram_output:
   def __init__(self, obj):
      self.returnObj:int = obj["returnObj"]
...
class Ice_Tablesets_CnvProgsProcessRow:
   def __init__(self, obj):
...
class Ice_Tablesets_CnvProgsProcessTableset:
   def __init__(self, obj):
      self.CnvProgsProcess:list[Ice_Tablesets_CnvProgsProcessRow] = obj["CnvProgsProcess"]
...
class RunConversion_input:
   ...
   def __init__(self, obj):
      self.systemCode:str = obj["systemCode"]
      """  systemCode  """  
      self.converionID:str = obj["converionID"]
      """  the ConversionID  """  
      pass

class RunConversion_output:
   def __init__(self, obj):
      pass

class RunConversions_input:
   """ Required : 
   conversions
   """  
   def __init__(self, obj):
      self.conversions:str = obj["conversions"]
      """  The conversions in this format: SystemCode`ConversionID~SystemCode`ConversionID  """  
      pass

class RunConversions_output:
   def __init__(self, obj):
      pass
