...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.APPIStatusChangePostSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.APPIStatusChangePostSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.APPIStatusChangePostSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.APPIStatusChangePostSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_APPIStatusChangePostParamRow:
   def __init__(self, obj):
      self.ACTType:str = obj["ACTType"]
      self.GroupID:str = obj["GroupID"]
      self.NewPIStatus:str = obj["NewPIStatus"]
      self.NewPIType:str = obj["NewPIType"]
      self.HeadNum:int = obj["HeadNum"]
      self.DocID:str = obj["DocID"]
...
class Erp_Tablesets_APPIStatusChangePostTableset:
   def __init__(self, obj):
      self.APPIStatusChangePostParam:list[Erp_Tablesets_APPIStatusChangePostParamRow] = obj["APPIStatusChangePostParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_APPIStatusChangePostTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_APPIStatusChangePostTableset] = obj["returnObj"]
      pass
