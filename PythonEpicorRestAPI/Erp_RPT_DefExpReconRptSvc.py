...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DefExpReconRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DefExpReconRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_OnBookChanged(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.DefExpReconRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.DefExpReconRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.DefExpReconRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_DefExpReconRptParamRow:
   def __init__(self, obj):
      self.BookID:str = obj["BookID"]
      self.COACode:str = obj["COACode"]
      self.DEACodeList:str = obj["DEACodeList"]
      ...
      self.GLAccountDispList:str = obj["GLAccountDispList"]
...
class Erp_Tablesets_DefExpReconRptTableset:
   def __init__(self, obj):
      self.DefExpReconRptParam:list[Erp_Tablesets_DefExpReconRptParamRow] = obj["DefExpReconRptParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_DefExpReconRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_DefExpReconRptTableset] = obj["returnObj"]
      pass
