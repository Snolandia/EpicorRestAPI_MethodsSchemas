...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXGLJournalsSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXGLJournalsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.MXGLJournalsSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.MXGLJournalsSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MXGLJournalsParamRow:
   def __init__(self, obj):
      ...
      self.TypeOfJournal:str = obj["TypeOfJournal"]
      self.SerialNumber:str = obj["SerialNumber"]
      self.PrintFolioNumAux:bool = obj["PrintFolioNumAux"]
      """  If true then additionaly print Folio Number's Auxiliary report  """  
      self.PrintAccountAux:bool = obj["PrintAccountAux"]
...
class Erp_Tablesets_MXGLJournalsTableset:
   def __init__(self, obj):
      self.MXGLJournalsParam:list[Erp_Tablesets_MXGLJournalsParamRow] = obj["MXGLJournalsParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MXGLJournalsTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MXGLJournalsTableset] = obj["returnObj"]
      pass
