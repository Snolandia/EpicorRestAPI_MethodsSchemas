...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CostWBRollUpSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CostWBRollUpSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetSkipRevCostRollup(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CostWBRollUpSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CostWBRollUpSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CostWBRollUpRow:
   def __init__(self, obj):
      ...
      self.ConsiderTransferPartAsMtl:bool = obj["ConsiderTransferPartAsMtl"]
      self.ConsiderOnlyApprovedRevs:bool = obj["ConsiderOnlyApprovedRevs"]
...
class Erp_Tablesets_CostWBRollUpTableset:
   def __init__(self, obj):
      self.CostWBRollUp:list[Erp_Tablesets_CostWBRollUpRow] = obj["CostWBRollUp"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CostWBRollUpTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CostWBRollUpTableset] = obj["returnObj"]
      pass
...
class GetSkipRevCostRollup_input:
   """ Required : 
   ipGroupID
   """  
   def __init__(self, obj):
...
class GetSkipRevCostRollup_output:
   def __init__(self, obj):
      self.returnObj:bool = obj["returnObj"]
      pass

   def parameters(self, obj):
      self.isSkipRevCostRollup:bool = obj["isSkipRevCostRollup"]
      pass
