...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.NLVATDeclarationReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.NLVATDeclarationReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_OnChangeDeclarationUID(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.NLVATDeclarationReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.NLVATDeclarationReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.NLVATDeclarationReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_NLVATDeclarationReportParamRow:
...
class Erp_Tablesets_NLVATDeclarationReportTableset:
   def __init__(self, obj):
      self.NLVATDeclarationReportParam:list[Erp_Tablesets_NLVATDeclarationReportParamRow] = obj["NLVATDeclarationReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_NLVATDeclarationReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_NLVATDeclarationReportTableset] = obj["returnObj"]
      pass
...
class OnChangeDeclarationUID_input:
   """ Required : 
   proposedDeclarationUID
   ds
   """  
   def __init__(self, obj):
      self.proposedDeclarationUID:int = obj["proposedDeclarationUID"]
      """  The proposed DeclarationUID  """  
      self.ds:list[Erp_Tablesets_NLVATDeclarationReportTableset] = obj["ds"]
      pass

class OnChangeDeclarationUID_output:
   def __init__(self, obj):
      pass
