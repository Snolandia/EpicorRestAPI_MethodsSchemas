...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaskSetSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaskSetSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_TaskSetSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaskSetSearchSvc/TaskSetSearches",headers=creds) as resp:
           return await resp.json()

async def post_TaskSetSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.TaskSetSearchSvc/TaskSetSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_TaskSetSearches_Company_TaskSetID(Company, TaskSetID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaskSetSearchSvc/TaskSetSearches(" + Company + "," + TaskSetID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_TaskSetSearches_Company_TaskSetID(Company, TaskSetID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.TaskSetSearchSvc/TaskSetSearches(" + Company + "," + TaskSetID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_TaskSetSearches_Company_TaskSetID(Company, TaskSetID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.TaskSetSearchSvc/TaskSetSearches(" + Company + "," + TaskSetID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaskSetSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseTaskSet, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaskSetSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewTaskSet(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.TaskSetSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_TaskSetSearchTableset:
   def __init__(self, obj):
      self.TaskSet:list[Erp_Tablesets_TaskSetRow] = obj["TaskSet"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtTaskSetSearchTableset:
   def __init__(self, obj):
      self.TaskSet:list[Erp_Tablesets_TaskSetRow] = obj["TaskSet"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TaskSetSearchTableset] = obj["returnObj"]
      pass
...
class GetNewTaskSet_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TaskSetSearchTableset] = obj["ds"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtTaskSetSearchTableset] = obj["ds"]
