...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.IoTDeviceEventProcessorSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.IoTDeviceEventProcessorSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Ice.PROC.IoTDeviceEventProcessorSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Ice.PROC.IoTDeviceEventProcessorSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class GetDefaults_input:
   ...
   def __init__(self, obj):
      self.ds:list[Ice_Tablesets_IoTDeviceEventProcessorTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Ice_Tablesets_IoTDeviceEventProcessorTableset] = obj["returnObj"]
      pass
...
class Ice_Tablesets_IoTDeviceEventProcessorParamRow:
   def __init__(self, obj):
      self.RunTimeMinutes:int = obj["RunTimeMinutes"]
      """  Indicates how long the process will run for  """  
      self.RetentionDays:int = obj["RetentionDays"]
...
class Ice_Tablesets_IoTDeviceEventProcessorTableset:
   def __init__(self, obj):
      self.IoTDeviceEventProcessorParam:list[Ice_Tablesets_IoTDeviceEventProcessorParamRow] = obj["IoTDeviceEventProcessorParam"]
