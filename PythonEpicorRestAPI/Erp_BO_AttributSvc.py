...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.AttributSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.AttributSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_Attributs(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.AttributSvc/Attributs",headers=creds) as resp:
           return await resp.json()

async def post_Attributs(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.AttributSvc/Attributs", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_Attributs_Company_AttrCode(Company, AttrCode, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.AttributSvc/Attributs(" + Company + "," + AttrCode + ")",headers=creds) as resp:
           return await resp.json()

async def patch_Attributs_Company_AttrCode(Company, AttrCode, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.AttributSvc/Attributs(" + Company + "," + AttrCode + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_Attributs_Company_AttrCode(Company, AttrCode, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.AttributSvc/Attributs(" + Company + "," + AttrCode + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.AttributSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseAttribut, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.AttributSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewAttribut(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.AttributSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_AttributListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_AttributListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_AttributRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_AttributRow] = obj["value"]
      pass
...
class Erp_Tablesets_AttributRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
      self.AttrCode:str = obj["AttrCode"]
      ...
      self.Inactive:bool = obj["Inactive"]
      """  Determines whether or not this attribute can be assigned to a customer.  """  
      self.GlobalAttribut:bool = obj["GlobalAttribut"]
...
class Erp_Tablesets_AttributTableset:
   def __init__(self, obj):
      self.Attribut:list[Erp_Tablesets_AttributRow] = obj["Attribut"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtAttributTableset:
   def __init__(self, obj):
      self.Attribut:list[Erp_Tablesets_AttributRow] = obj["Attribut"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_AttributTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_AttributListTableset] = obj["returnObj"]
      pass
...
class GetNewAttribut_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_AttributTableset] = obj["ds"]
      pass

class GetNewAttribut_output:
   def __init__(self, obj):
      pass
...
class GetRows_input:
   ...
   """  
   def __init__(self, obj):
      self.whereClauseAttribut:str = obj["whereClauseAttribut"]
      self.pageSize:int = obj["pageSize"]
      self.absolutePage:int = obj["absolutePage"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtAttributTableset] = obj["ds"]
