...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.FiscalYrSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.FiscalYrSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_FiscalYrSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.FiscalYrSearchSvc/FiscalYrSearches",headers=creds) as resp:
           return await resp.json()

async def post_FiscalYrSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.FiscalYrSearchSvc/FiscalYrSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_FiscalYrSearches_Company_FiscalCalendarID_FiscalYear_FiscalYearSuffix(Company, FiscalCalendarID, FiscalYear, FiscalYearSuffix, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.FiscalYrSearchSvc/FiscalYrSearches(" + Company + "," + FiscalCalendarID + "," + FiscalYear + "," + FiscalYearSuffix + ")",headers=creds) as resp:
           return await resp.json()

async def patch_FiscalYrSearches_Company_FiscalCalendarID_FiscalYear_FiscalYearSuffix(Company, FiscalCalendarID, FiscalYear, FiscalYearSuffix, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.FiscalYrSearchSvc/FiscalYrSearches(" + Company + "," + FiscalCalendarID + "," + FiscalYear + "," + FiscalYearSuffix + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_FiscalYrSearches_Company_FiscalCalendarID_FiscalYear_FiscalYearSuffix(Company, FiscalCalendarID, FiscalYear, FiscalYearSuffix, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.FiscalYrSearchSvc/FiscalYrSearches(" + Company + "," + FiscalCalendarID + "," + FiscalYear + "," + FiscalYearSuffix + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.FiscalYrSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseFiscalYr, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.FiscalYrSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(fiscalCalendarID, fiscalYear, fiscalYearSuffix, epicorHeaders = None):
   """  
...
async def post_GetFiscalCal(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.FiscalYrSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewFiscalYr(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.FiscalYrSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FiscalYrListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_FiscalYrListRow] = obj["value"]
      pass
...
class Erp_Tablesets_FiscalYrListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_FiscalYrListTableset:
   def __init__(self, obj):
      self.FiscalYrList:list[Erp_Tablesets_FiscalYrListRow] = obj["FiscalYrList"]
...
class Erp_Tablesets_FiscalYrSearchTableset:
   def __init__(self, obj):
      self.FiscalYr:list[Erp_Tablesets_FiscalYrRow] = obj["FiscalYr"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_UpdExtFiscalYrSearchTableset:
   def __init__(self, obj):
      self.FiscalYr:list[Erp_Tablesets_FiscalYrRow] = obj["FiscalYr"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_FiscalYrSearchTableset] = obj["returnObj"]
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_FiscalYrListTableset] = obj["returnObj"]
      pass
...
class GetNewFiscalYr_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_FiscalYrSearchTableset] = obj["ds"]
      self.fiscalCalendarID:str = obj["fiscalCalendarID"]
      self.fiscalYear:int = obj["fiscalYear"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtFiscalYrSearchTableset] = obj["ds"]
