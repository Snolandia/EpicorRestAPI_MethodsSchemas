...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StockStatusReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StockStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Different lists returned for Vista vs. Vantage
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.StockStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.StockStatusReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.StockStatusReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_StockStatusReportParamRow:
   def __init__(self, obj):
      self.WHList:str = obj["WHList"]
      self.ClassList:str = obj["ClassList"]
      self.SortOptions:str = obj["SortOptions"]
      self.PurchasedParts:bool = obj["PurchasedParts"]
      self.ManufacturedParts:bool = obj["ManufacturedParts"]
      self.IncludeNonStockItems:bool = obj["IncludeNonStockItems"]
      self.ExcludeZeroQtyParts:bool = obj["ExcludeZeroQtyParts"]
      self.IncludeNonNettable:bool = obj["IncludeNonNettable"]
      self.SummaryOnly:bool = obj["SummaryOnly"]
      self.NegOnHandBalances:bool = obj["NegOnHandBalances"]
      self.ActivityFromCutoffDate:bool = obj["ActivityFromCutoffDate"]
      self.AsOfDate:str = obj["AsOfDate"]
      self.AsOfDateToken:str = obj["AsOfDateToken"]
      self.PlantList:str = obj["PlantList"]
      self.WeightedAverageCost:bool = obj["WeightedAverageCost"]
      self.PartList:str = obj["PartList"]
      self.ContractDescription:str = obj["ContractDescription"]
      self.IncludePlanningContract:bool = obj["IncludePlanningContract"]
      ...
      self.IncludeInventoryByRevision:bool = obj["IncludeInventoryByRevision"]
...
class Erp_Tablesets_StockStatusReportTableset:
   def __init__(self, obj):
      self.StockStatusReportParam:list[Erp_Tablesets_StockStatusReportParamRow] = obj["StockStatusReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_StockStatusReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_StockStatusReportTableset] = obj["returnObj"]
      pass
...
class GetSortOptions_output:
   ...
   def parameters(self, obj):
      self.SortOptionsList:str = obj["parameters"]
      pass
