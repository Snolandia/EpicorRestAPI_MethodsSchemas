...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.IMMiscChrgSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.IMMiscChrgSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_AckMiscChrg(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.IMMiscChrgSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_CountMiscChrg(requestBody, epicorHeaders = None):
   """  
...
async def post_GetAllMiscChrg(requestBody, epicorHeaders = None):
   """  
...
async def post_GetMiscChrg(requestBody, epicorHeaders = None):
   """  
...
class AckMiscChrg_input:
   ...
   def __init__(self, obj):
      self.ts:list[Erp_Tablesets_IMMiscChrgTableset] = obj["ts"]
...
class Erp_Tablesets_IMMiscChrgRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Identifier.  """  
...
class Erp_Tablesets_IMMiscChrgTableset:
   def __init__(self, obj):
      self.IntQueInOut:list[Erp_Tablesets_IntQueInOutRow] = obj["IntQueInOut"]
      self.IMMiscChrg:list[Erp_Tablesets_IMMiscChrgRow] = obj["IMMiscChrg"]
...
class GetAllMiscChrg_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_IMMiscChrgTableset] = obj["returnObj"]
      pass
