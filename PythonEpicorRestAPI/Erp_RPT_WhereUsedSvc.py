...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WhereUsedSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WhereUsedSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetReportFormatList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WhereUsedSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WhereUsedSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WhereUsedSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_WhereUsedParamRow:
   def __init__(self, obj):
      self.Parts:str = obj["Parts"]
      """  Part List  """  
      self.RptFormat:str = obj["RptFormat"]
      """  Report Format(Single or Indented Level)  """  
      self.CurrentRev:bool = obj["CurrentRev"]
      """  Current Revision  """  
      self.EffDate:str = obj["EffDate"]
      """  Effective Date  """  
      self.EffDateToken:str = obj["EffDateToken"]
      self.IncludeReferenceDesignators:bool = obj["IncludeReferenceDesignators"]
...
class Erp_Tablesets_WhereUsedTableset:
   def __init__(self, obj):
      self.WhereUsedParam:list[Erp_Tablesets_WhereUsedParamRow] = obj["WhereUsedParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_WhereUsedTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_WhereUsedTableset] = obj["returnObj"]
      pass
