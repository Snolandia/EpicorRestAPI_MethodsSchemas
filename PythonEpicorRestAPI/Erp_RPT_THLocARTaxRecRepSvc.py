...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.THLocARTaxRecRepSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.THLocARTaxRecRepSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.THLocARTaxRecRepSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.THLocARTaxRecRepSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.THLocARTaxRecRepSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_THLocARTaxRecRepParamRow:
   def __init__(self, obj):
      self.CustID:str = obj["CustID"]
      """  Customer ID  """  
      self.Customers:str = obj["Customers"]
      self.FromRcptDate:str = obj["FromRcptDate"]
      self.FromRcptDateToken:str = obj["FromRcptDateToken"]
      self.ToRcptDate:str = obj["ToRcptDate"]
      self.ToRcptDateToken:str = obj["ToRcptDateToken"]
...
class Erp_Tablesets_THLocARTaxRecRepTableset:
   def __init__(self, obj):
      self.THLocARTaxRecRepParam:list[Erp_Tablesets_THLocARTaxRecRepParamRow] = obj["THLocARTaxRecRepParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_THLocARTaxRecRepTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_THLocARTaxRecRepTableset] = obj["returnObj"]
      pass
