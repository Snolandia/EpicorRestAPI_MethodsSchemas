...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InternalPartCrossRefSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InternalPartCrossRefSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_InternalPartCrossRefs(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InternalPartCrossRefSvc/InternalPartCrossRefs",headers=creds) as resp:
           return await resp.json()

async def post_InternalPartCrossRefs(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.InternalPartCrossRefSvc/InternalPartCrossRefs", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_InternalPartCrossRefs_Company_PartNum_XRefPartNum(Company, PartNum, XRefPartNum, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InternalPartCrossRefSvc/InternalPartCrossRefs(" + Company + "," + PartNum + "," + XRefPartNum + ")",headers=creds) as resp:
           return await resp.json()

async def patch_InternalPartCrossRefs_Company_PartNum_XRefPartNum(Company, PartNum, XRefPartNum, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.InternalPartCrossRefSvc/InternalPartCrossRefs(" + Company + "," + PartNum + "," + XRefPartNum + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_InternalPartCrossRefs_Company_PartNum_XRefPartNum(Company, PartNum, XRefPartNum, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.InternalPartCrossRefSvc/InternalPartCrossRefs(" + Company + "," + PartNum + "," + XRefPartNum + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InternalPartCrossRefSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClausePartRef, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.InternalPartCrossRefSvc/List" + params,headers=creds) as resp:
           return await resp.json()

async def get_GetByID(partNum, xrefPartNum, epicorHeaders = None):
   """  
...
async def post_ChangeMaskPrefixSuffix(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.InternalPartCrossRefSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_ChangePartRefPartNum(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangePartRefSNMask(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangePartRefSNOverride(requestBody, epicorHeaders = None):
   """  
...
async def post_ChangePartRefXRefPartNum(requestBody, epicorHeaders = None):
   """  
...
async def post_GetInternalPartXRef(requestBody, epicorHeaders = None):
   """  
...
async def post_SetPartNum(requestBody, epicorHeaders = None):
   """  
...
async def post_GetNewPartRef(requestBody, epicorHeaders = None):
   """  
...
# OData Schemas:
#########################################################################
class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PartRefListRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PartRefListRow] = obj["value"]
      pass

class Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PartRefRow:
   def __init__(self, obj):
      self.odatametadata:str = obj["odatametadata"]
      self.value:list[Erp_Tablesets_PartRefRow] = obj["value"]
      pass

class Erp_Tablesets_PartRefListRow:
   def __init__(self, obj):
...
class Erp_Tablesets_PartRefRow:
   def __init__(self, obj):
      self.Company:str = obj["Company"]
      """  Company Code  """  
      self.PartNum:str = obj["PartNum"]
...
class ChangeMaskPrefixSuffix_input:
   ...
   def __init__(self, obj):
      ...
      """  Which one to check  """  
      self.ds:list[Erp_Tablesets_InternalPartCrossRefTableset] = obj["ds"]
      pass
...
class ChangePartRefPartNum_input:
   """ Required : 
   iPartNum
   SysRowID
   rowType
...
class ChangePartRefPartNum_output:
   def __init__(self, obj):
      pass
...
class ChangePartRefSNMask_input:
   """ Required : 
   iSNMask
   ds
   """  
...
class ChangePartRefSNMask_output:
   def __init__(self, obj):
      pass
...
class ChangePartRefSNOverride_input:
   """ Required : 
   iSNOverride
   ds
   """  
...
class ChangePartRefSNOverride_output:
   def __init__(self, obj):
      pass
...
class ChangePartRefXRefPartNum_input:
   """ Required : 
   iXRefPartNum
   ds
   """  
   def __init__(self, obj):
      self.iXRefPartNum:str = obj["iXRefPartNum"]
      """  Part Number Reference  """  
      self.ds:list[Erp_Tablesets_InternalPartCrossRefTableset] = obj["ds"]
      pass

class ChangePartRefXRefPartNum_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_InternalPartCrossRefListTableset:
   def __init__(self, obj):
      self.PartRefList:list[Erp_Tablesets_PartRefListRow] = obj["PartRefList"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class Erp_Tablesets_InternalPartCrossRefTableset:
   def __init__(self, obj):
      self.PartRef:list[Erp_Tablesets_PartRefRow] = obj["PartRef"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class Erp_Tablesets_UpdExtInternalPartCrossRefTableset:
   def __init__(self, obj):
      self.PartRef:list[Erp_Tablesets_PartRefRow] = obj["PartRef"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_InternalPartCrossRefTableset] = obj["returnObj"]
      pass
...
class GetInternalPartXRef_input:
   """ Required : 
   iPartNum
   ds
   """  
...
class GetInternalPartXRef_output:
   def __init__(self, obj):
      pass
...
class GetList_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_InternalPartCrossRefListTableset] = obj["returnObj"]
      pass
...
class GetRows_input:
   ...
   """  
   def __init__(self, obj):
      self.whereClausePartRef:str = obj["whereClausePartRef"]
      self.pageSize:int = obj["pageSize"]
      self.absolutePage:int = obj["absolutePage"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtInternalPartCrossRefTableset] = obj["ds"]
