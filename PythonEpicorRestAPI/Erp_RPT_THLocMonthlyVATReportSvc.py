...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.THLocMonthlyVATReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.THLocMonthlyVATReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.THLocMonthlyVATReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.THLocMonthlyVATReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.THLocMonthlyVATReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_THLocMonthlyVATReportParamRow:
   def __init__(self, obj):
      self.HeadOfficeOrBranch:str = obj["HeadOfficeOrBranch"]
      self.Month:int = obj["Month"]
      self.PlaceOfBusiness:str = obj["PlaceOfBusiness"]
      self.TaxCode:str = obj["TaxCode"]
      """  OBSOLETE AND NOT USED ANYMORE  """  
      self.VATOperator:str = obj["VATOperator"]
      self.Year:int = obj["Year"]
      self.BookID:str = obj["BookID"]
      self.BookDescription:str = obj["BookDescription"]
      self.PlantName:str = obj["PlantName"]
      """  Plant Name  """  
      self.SortedBy:str = obj["SortedBy"]
      self.TaxTypeList:str = obj["TaxTypeList"]
      self.ReportMode:str = obj["ReportMode"]
      """  Report Mode  """  
      self.DocNumBasisInput:str = obj["DocNumBasisInput"]
      self.DocNumBasisOutput:str = obj["DocNumBasisOutput"]
      self.DocDateBasisInput:str = obj["DocDateBasisInput"]
      self.DocDateBasisOutput:str = obj["DocDateBasisOutput"]
      self.PrintLegalNumber:bool = obj["PrintLegalNumber"]
      self.PrintRefInvoiceNumber:bool = obj["PrintRefInvoiceNumber"]
      self.PrintTaxRecNumAndDate:bool = obj["PrintTaxRecNumAndDate"]
      self.SysRowID:str = obj["SysRowID"]
...
class Erp_Tablesets_THLocMonthlyVATReportTableset:
   def __init__(self, obj):
      self.THLocMonthlyVATReportParam:list[Erp_Tablesets_THLocMonthlyVATReportParamRow] = obj["THLocMonthlyVATReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_THLocMonthlyVATReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_THLocMonthlyVATReportTableset] = obj["returnObj"]
      pass
