...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_GLJrnDtls(select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtls",headers=creds) as resp:
           return await resp.json()

async def post_GLJrnDtls(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtls", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_GLJrnDtls_Company_BookID_FiscalYear_FiscalYearSuffix_JournalCode_JournalNum_JournalLine(Company, BookID, FiscalYear, FiscalYearSuffix, JournalCode, JournalNum, JournalLine, select = None, expand = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtls(" + Company + "," + BookID + "," + FiscalYear + "," + FiscalYearSuffix + "," + JournalCode + "," + JournalNum + "," + JournalLine + ")",headers=creds) as resp:
           return await resp.json()

async def patch_GLJrnDtls_Company_BookID_FiscalYear_FiscalYearSuffix_JournalCode_JournalNum_JournalLine(Company, BookID, FiscalYear, FiscalYearSuffix, JournalCode, JournalNum, JournalLine, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtls(" + Company + "," + BookID + "," + FiscalYear + "," + FiscalYearSuffix + "," + JournalCode + "," + JournalNum + "," + JournalLine + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_GLJrnDtls_Company_BookID_FiscalYear_FiscalYearSuffix_JournalCode_JournalNum_JournalLine(Company, BookID, FiscalYear, FiscalYearSuffix, JournalCode, JournalNum, JournalLine, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtls(" + Company + "," + BookID + "," + FiscalYear + "," + FiscalYearSuffix + "," + JournalCode + "," + JournalNum + "," + JournalLine + ")",headers=creds) as resp:
           return await resp.json()

async def get_GLJrnDtls_Company_BookID_FiscalYear_FiscalYearSuffix_JournalCode_JournalNum_JournalLine_GLJrnDtlAttches(Company, BookID, FiscalYear, FiscalYearSuffix, JournalCode, JournalNum, JournalLine, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtls(" + Company + "," + BookID + "," + FiscalYear + "," + FiscalYearSuffix + "," + JournalCode + "," + JournalNum + "," + JournalLine + ")/GLJrnDtlAttches",headers=creds) as resp:
           return await resp.json()

async def get_GLJrnDtls_Company_BookID_FiscalYear_FiscalYearSuffix_JournalCode_JournalNum_JournalLine_GLJrnDtlAttches_Company_BookID_FiscalYear_FiscalYearSuffix_JournalCode_JournalNum_JournalLine_DrawingSeq(Company, BookID, FiscalYear, FiscalYearSuffix, JournalCode, JournalNum, JournalLine, DrawingSeq, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtls(" + Company + "," + BookID + "," + FiscalYear + "," + FiscalYearSuffix + "," + JournalCode + "," + JournalNum + "," + JournalLine + ")/GLJrnDtlAttches(" + Company + "," + BookID + "," + FiscalYear + "," + FiscalYearSuffix + "," + JournalCode + "," + JournalNum + "," + JournalLine + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_GLJrnDtlAttches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtlAttches",headers=creds) as resp:
           return await resp.json()
...
async def post_GLJrnDtlAttches(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtlAttches", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GLJrnDtlAttches_Company_BookID_FiscalYear_FiscalYearSuffix_JournalCode_JournalNum_JournalLine_DrawingSeq(Company, BookID, FiscalYear, FiscalYearSuffix, JournalCode, JournalNum, JournalLine, DrawingSeq, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtlAttches(" + Company + "," + BookID + "," + FiscalYear + "," + FiscalYearSuffix + "," + JournalCode + "," + JournalNum + "," + JournalLine + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_GLJrnDtlAttches_Company_BookID_FiscalYear_FiscalYearSuffix_JournalCode_JournalNum_JournalLine_DrawingSeq(Company, BookID, FiscalYear, FiscalYearSuffix, JournalCode, JournalNum, JournalLine, DrawingSeq, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtlAttches(" + Company + "," + BookID + "," + FiscalYear + "," + FiscalYearSuffix + "," + JournalCode + "," + JournalNum + "," + JournalLine + "," + DrawingSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_GLJrnDtlAttches_Company_BookID_FiscalYear_FiscalYearSuffix_JournalCode_JournalNum_JournalLine_DrawingSeq(Company, BookID, FiscalYear, FiscalYearSuffix, JournalCode, JournalNum, JournalLine, DrawingSeq, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/GLJrnDtlAttches(" + Company + "," + BookID + "," + FiscalYear + "," + FiscalYearSuffix + "," + JournalCode + "," + JournalNum + "," + JournalLine + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/List",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def get_GetRows(whereClauseGLJrnDtl, whereClauseGLJrnDtlAttch, pageSize, absolutePage, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetAssociatedABTUIDs(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.GLJrnDtlSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_KineticGetGLJrnDtl(requestBody, epicorHeaders = None):
   """  
...
async def post_GetRowsFilterGLAcct(requestBody, epicorHeaders = None):
   """  
...
async def post_GetRowsGLJrnDtl(requestBody, epicorHeaders = None):
   """  
...
async def post_GetReverseRef(requestBody, epicorHeaders = None):
   """  
...
async def post_GetListByJournalNum(requestBody, epicorHeaders = None):
   """  
...
class Erp_Tablesets_GLJrnDtlTableset:
   def __init__(self, obj):
...
class Erp_Tablesets_UpdExtGLJrnDtlTableset:
   def __init__(self, obj):
      self.GLJrnDtl:list[Erp_Tablesets_GLJrnDtlRow] = obj["GLJrnDtl"]
      self.GLJrnDtlAttch:list[Erp_Tablesets_GLJrnDtlAttchRow] = obj["GLJrnDtlAttch"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
...
class GetAssociatedABTUIDs_input:
   """ Required : 
   GroupID
   HeadNum
   """  
...
class GetAssociatedABTUIDs_output:
   def __init__(self, obj):
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLJrnDtlTableset] = obj["returnObj"]
      pass
...
class GetListByJournalNum_input:
   """ Required : 
   whereClause
   bookID
   fiscalYear
   ...
   def __init__(self, obj):
      ...
      """  End Fiscal Period  """  
      self.journalCodes:str = obj["journalCodes"]
      """  list of GLJrnDtlList.JournalCode, "~" separated (optional)  """  
      self.journalNums:str = obj["journalNums"]
...
class GetListByJournalNum_output:
   def __init__(self, obj):
...
class GetNewGLJrnDtlAttch_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GLJrnDtlTableset] = obj["ds"]
      self.bookID:str = obj["bookID"]
      self.fiscalYear:int = obj["fiscalYear"]
      self.fiscalYearSuffix:str = obj["fiscalYearSuffix"]
      self.journalCode:str = obj["journalCode"]
...
class GetReverseRef_output:
   def __init__(self, obj):
      self.returnObj:int = obj["returnObj"]
      pass

class GetRowsFilterGLAcct_input:
   """ Required : 
   balType
   WhereClause
   ds
...
class GetRowsFilterGLAcct_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLJrnDtlTableset] = obj["returnObj"]
      pass
...
class KineticGetGLJrnDtl_input:
   """ Required : 
   ipGroupID
   ipHeadNum
   ipSourceGroupID
   ...
   def __init__(self, obj):
      ...
      """  HeadNum  """  
      self.ipSourceGroupID:str = obj["ipSourceGroupID"]
      """  SourceGroupID  """  
      self.ipSourceHeadNum:int = obj["ipSourceHeadNum"]
      """  SourceHeadNum  """  
      pass

class KineticGetGLJrnDtl_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLJrnDtlTableset] = obj["returnObj"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtGLJrnDtlTableset] = obj["ds"]
