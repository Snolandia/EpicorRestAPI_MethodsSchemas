...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GUIAPToTaxDeclareSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GUIAPToTaxDeclareSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_OnChangeYearPeriod(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.GUIAPToTaxDeclareSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetTranDocTypeIDList(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.GUIAPToTaxDeclareSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_GetStringFromdate(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GUIAPToTaxDeclareSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_GUIAPToTaxDeclareParamRow:
   def __init__(self, obj):
      self.DeclarePeriod:int = obj["DeclarePeriod"]
      self.DeclareYear:int = obj["DeclareYear"]
      self.InvoiceDateEnd:str = obj["InvoiceDateEnd"]
      self.InvoiceDateStart:str = obj["InvoiceDateStart"]
      self.InvoiceList:str = obj["InvoiceList"]
      self.LegalNumberEnd:str = obj["LegalNumberEnd"]
      self.LegalNumberStart:str = obj["LegalNumberStart"]
...
class Erp_Tablesets_GUIAPToTaxDeclareTableset:
   def __init__(self, obj):
      self.GUIAPToTaxDeclareParam:list[Erp_Tablesets_GUIAPToTaxDeclareParamRow] = obj["GUIAPToTaxDeclareParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GUIAPToTaxDeclareTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GUIAPToTaxDeclareTableset] = obj["returnObj"]
      pass
...
class GetStringFromdate_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.wClause:str = obj["parameters"]
      pass
...
class GetTranDocTypeIDList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.mylist:str = obj["parameters"]
      pass
