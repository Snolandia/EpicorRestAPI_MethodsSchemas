...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BOMResAvSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BOMResAvSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_SetEffectiveDate(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.BOMResAvSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_SetPartIUM(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.BOMResAvSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.BOMResAvSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_BOMResAvRow:
   def __init__(self, obj):
      self.PartNum:str = obj["PartNum"]
      self.Revision:str = obj["Revision"]
      self.ProdQty:int = obj["ProdQty"]
      self.EffDate:str = obj["EffDate"]
      self.PrntSubs:bool = obj["PrntSubs"]
      self.ExcptOnly:bool = obj["ExcptOnly"]
      self.NonNet:bool = obj["NonNet"]
      self.EffDateToken:str = obj["EffDateToken"]
...
class Erp_Tablesets_BOMResAvTableset:
   def __init__(self, obj):
      self.BOMResAv:list[Erp_Tablesets_BOMResAvRow] = obj["BOMResAv"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_BOMResAvTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_BOMResAvTableset] = obj["returnObj"]
      pass
...
class SetEffectiveDate_input:
   ...
   def __init__(self, obj):
      ...
      """  PartNum  """  
      self.cRevision:str = obj["cRevision"]
      """  Revision Num  """  
      self.cAltMethod:str = obj["cAltMethod"]
      """  AltMethod  """  
      pass

class SetEffectiveDate_output:
   def __init__(self, obj):
      pass
