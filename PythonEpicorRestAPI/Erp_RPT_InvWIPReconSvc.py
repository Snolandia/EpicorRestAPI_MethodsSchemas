...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.InvWIPReconSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.InvWIPReconSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.InvWIPReconSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetCOACode(requestBody, epicorHeaders = None):
   """  
...
async def post_GetDetailLevelList(epicorHeaders = None):
   """  
...
Uses the standard LIST-DELIM and SUBLIST-DELIM separators.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.InvWIPReconSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_ValidateDateRange(requestBody, epicorHeaders = None):
   """  
...
async def post_GetSortByOptionList(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.InvWIPReconSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_InvWIPReconParamRow:
   def __init__(self, obj):
      self.StartDt:str = obj["StartDt"]
      """  Start Date for date range  """  
      self.EndDt:str = obj["EndDt"]
      """  End date for date range  """  
      self.FiscalYear:int = obj["FiscalYear"]
      self.JournalNum:int = obj["JournalNum"]
      self.Account:str = obj["Account"]
      self.IncludeOffset:bool = obj["IncludeOffset"]
      self.TransactionType:str = obj["TransactionType"]
      self.JobNum:str = obj["JobNum"]
      self.ActLvlDtl:int = obj["ActLvlDtl"]
      """  1=Full; 2=Summarized by Date/Tran &Type; 3=Summarized by Date/&Job-Part/Tran Type  """  
      self.PostingStatus:str = obj["PostingStatus"]
      """  "Posted", "UnPosted", or "Both"  """  
      self.CurPlantOnly:bool = obj["CurPlantOnly"]
      self.StartDtToken:str = obj["StartDtToken"]
      self.EndDtToken:str = obj["EndDtToken"]
      self.RptUserID:str = obj["RptUserID"]
      self.CurrentPlant:str = obj["CurrentPlant"]
      ...
      self.DispAccount:str = obj["DispAccount"]
...
class Erp_Tablesets_InvWIPReconTableset:
   def __init__(self, obj):
      self.InvWIPReconParam:list[Erp_Tablesets_InvWIPReconParamRow] = obj["InvWIPReconParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_InvWIPReconTableset] = obj["ds"]
      pass
...
class GetCOACode_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.opCOACode:str = obj["parameters"]
      self.opBookDescription:str = obj["parameters"]
      pass
...
class GetDetailLevelList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.pcDetailLevelList:str = obj["parameters"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_InvWIPReconTableset] = obj["returnObj"]
      pass
...
class GetSortByOptionList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.SortByOptionList:str = obj["parameters"]
      pass
...
class GetStatusList_output:
   ...
   def parameters(self, obj):
      self.pcStatusList:str = obj["parameters"]
      pass
...
class GetTranTypeList_output:
   ...
   def parameters(self, obj):
      self.pcTranTypeList:str = obj["parameters"]
      pass
...
class ValidateDateRange_input:
   ...
   """  
   def __init__(self, obj):
      self.ipStartDt:str = obj["ipStartDt"]
      """  Start Date  """  
      self.ipEndDt:str = obj["ipEndDt"]
      """  End Date  """  
      self.ipStartDtToken:str = obj["ipStartDtToken"]
      """  Start Date Token  """  
      self.ipEndDtToken:str = obj["ipEndDtToken"]
      """  End Date Token  """  
      self.ipJobNum:str = obj["ipJobNum"]
      """  JobNum  """  
      pass

class ValidateDateRange_output:
   def __init__(self, obj):
      pass
