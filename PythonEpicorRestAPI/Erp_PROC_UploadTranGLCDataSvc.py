...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_CheckConnection(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_GetDSNList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class CheckConnection_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass

class Erp_Tablesets_UploadTranGLCDataParamRow:
   def __init__(self, obj):
      self.StartDate:str = obj["StartDate"]
      """  Start Date  """  
      self.EndDate:str = obj["EndDate"]
      """  End Date  """  
      self.cnvAPInvoices:bool = obj["cnvAPInvoices"]
      """  Convert AP Invoices  """  
      self.cnvAPTransactions:bool = obj["cnvAPTransactions"]
      """  Convert AP Transactions  """  
      self.cnvARInvoices:bool = obj["cnvARInvoices"]
      """  Convert AR Invoices  """  
      self.cnvBankTransactions:bool = obj["cnvBankTransactions"]
      """  Convert Bank Transactions  """  
      self.cnvCashReceipts:bool = obj["cnvCashReceipts"]
      """  Convert Cash Receipts  """  
      self.cnvGLJournalSource:bool = obj["cnvGLJournalSource"]
      """  Convert GL Journal Source  """  
      self.cnvLaborDetail:bool = obj["cnvLaborDetail"]
      """  Convert Labor Detail  """  
      self.cnvLandedCost:bool = obj["cnvLandedCost"]
      """  Convert Landed Cost  """  
      self.cnvPartTransactions:bool = obj["cnvPartTransactions"]
      """  Convert Part Transactions  """  
      self.cnvPOReleases:bool = obj["cnvPOReleases"]
      """  Convert PO Releases  """  
      self.cnServerName:str = obj["cnServerName"]
      """  Server Name  """  
      self.cnDBName:str = obj["cnDBName"]
      """  DB Name  """  
      self.cnLogin:str = obj["cnLogin"]
      """  Login  """  
      self.cnPassword:str = obj["cnPassword"]
      """  Password  """  
      self.cnDBType:str = obj["cnDBType"]
      """  DB Type  """  
      self.cnDSN:str = obj["cnDSN"]
      """  Data Source Name  """  
...
class Erp_Tablesets_UploadTranGLCDataTableset:
   def __init__(self, obj):
      self.UploadTranGLCDataParam:list[Erp_Tablesets_UploadTranGLCDataParamRow] = obj["UploadTranGLCDataParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UploadTranGLCDataTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_UploadTranGLCDataTableset] = obj["returnObj"]
      pass
