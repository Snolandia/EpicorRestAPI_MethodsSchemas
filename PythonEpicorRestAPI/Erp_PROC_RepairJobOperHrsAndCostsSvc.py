...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RepairJobOperHrsAndCostsSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RepairJobOperHrsAndCostsSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.RepairJobOperHrsAndCostsSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.RepairJobOperHrsAndCostsSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_RepairJobOperHrsAndCostsParamRow:
   def __init__(self, obj):
      self.LogFilename:str = obj["LogFilename"]
      """  Logfile  """  
      self.IncludeClosedJobs:bool = obj["IncludeClosedJobs"]
...
class Erp_Tablesets_RepairJobOperHrsAndCostsTableset:
   def __init__(self, obj):
      self.RepairJobOperHrsAndCostsParam:list[Erp_Tablesets_RepairJobOperHrsAndCostsParamRow] = obj["RepairJobOperHrsAndCostsParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_RepairJobOperHrsAndCostsTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_RepairJobOperHrsAndCostsTableset] = obj["returnObj"]
      pass
