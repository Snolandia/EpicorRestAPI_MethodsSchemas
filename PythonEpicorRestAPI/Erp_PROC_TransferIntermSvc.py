...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.TransferIntermSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.TransferIntermSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_ValidateGenID(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.TransferIntermSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.TransferIntermSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_TransferIntermParamRow:
...
class Erp_Tablesets_TransferIntermTableset:
   def __init__(self, obj):
      self.TransferIntermParam:list[Erp_Tablesets_TransferIntermParamRow] = obj["TransferIntermParam"]
...
class GetConsSrcCtrlValues_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TransferIntermTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TransferIntermTableset] = obj["returnObj"]
      pass
