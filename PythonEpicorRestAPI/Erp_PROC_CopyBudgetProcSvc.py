...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CopyBudgetProcSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CopyBudgetProcSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CopyBudgetProcSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CopyBudgetProcSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CopyBudgetProcParamRow:
   def __init__(self, obj):
      self.Adjustment:int = obj["Adjustment"]
      self.BookDesc:str = obj["BookDesc"]
      self.BookID:str = obj["BookID"]
      self.BudgetActual:str = obj["BudgetActual"]
      """   A - Actuals                   
B - Budget  """  
      self.FiscalCalendarID:str = obj["FiscalCalendarID"]
      self.SourceBudgetCode:str = obj["SourceBudgetCode"]
      self.SourceFiscalYear:int = obj["SourceFiscalYear"]
      self.SourceFiscalYearSuffix:str = obj["SourceFiscalYearSuffix"]
      self.TargetBudgetCode:str = obj["TargetBudgetCode"]
      self.TargetFiscalYear:int = obj["TargetFiscalYear"]
      self.TargetFiscalYearSuffix:str = obj["TargetFiscalYearSuffix"]
...
class Erp_Tablesets_CopyBudgetProcTableset:
   def __init__(self, obj):
      self.CopyBudgetProcParam:list[Erp_Tablesets_CopyBudgetProcParamRow] = obj["CopyBudgetProcParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CopyBudgetProcTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CopyBudgetProcTableset] = obj["returnObj"]
      pass
