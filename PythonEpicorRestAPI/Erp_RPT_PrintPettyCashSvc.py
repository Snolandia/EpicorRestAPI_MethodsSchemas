...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PrintPettyCashSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PrintPettyCashSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_CheckPermissions(requestBody, epicorHeaders = None):
   """  
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PrintPettyCashSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_EnableAssignLegalNumber(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.PrintPettyCashSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.PrintPettyCashSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class CheckPermissions_output:
   def __init__(self, obj):
      pass

class EnableAssignLegalNumber_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_PrintPettyCashTableset] = obj["ds"]
      pass

class EnableAssignLegalNumber_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_PrintPettyCashParamRow:
   def __init__(self, obj):
      self.CashDeskID:str = obj["CashDeskID"]
      self.CashDay:str = obj["CashDay"]
      self.PrintDrafts:bool = obj["PrintDrafts"]
      self.Transactions:str = obj["Transactions"]
      self.AssignLegalNum:bool = obj["AssignLegalNum"]
      self.ReferenceNum:int = obj["ReferenceNum"]
      self.OprTypes:str = obj["OprTypes"]
      self.PrintStatus:str = obj["PrintStatus"]
      self.FltrEmployees:str = obj["FltrEmployees"]
      self.FltrCustomers:str = obj["FltrCustomers"]
      self.FltrSuppliers:str = obj["FltrSuppliers"]
      self.FltrBanks:str = obj["FltrBanks"]
      self.FltrPettyCashDesks:str = obj["FltrPettyCashDesks"]
      self.CashDayToken:str = obj["CashDayToken"]
      self.LegalNum:str = obj["LegalNum"]
      self.ExternalNo:str = obj["ExternalNo"]
      self.DaySeqNum:int = obj["DaySeqNum"]
      self.CashDeskDesc:str = obj["CashDeskDesc"]
      self.OprTypesOption:str = obj["OprTypesOption"]
      self.EnableAssignLegalNumber:bool = obj["EnableAssignLegalNumber"]
      self.Direction:str = obj["Direction"]
      self.FltrCustomersID:str = obj["FltrCustomersID"]
      self.FltrSuppliersID:str = obj["FltrSuppliersID"]
...
class Erp_Tablesets_PrintPettyCashTableset:
   def __init__(self, obj):
      self.PrintPettyCashParam:list[Erp_Tablesets_PrintPettyCashParamRow] = obj["PrintPettyCashParam"]
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_PrintPettyCashTableset] = obj["returnObj"]
      pass
