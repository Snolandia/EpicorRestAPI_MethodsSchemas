...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SchedSetOrderProcessSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SchedSetOrderProcessSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetSchedulingMultiJobFlag(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.SchedSetOrderProcessSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_lastRunDate(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.SchedSetOrderProcessSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_SchedSetOrderProcessRow:
   def __init__(self, obj):
      ...
      self.GSStartDate:str = obj["GSStartDate"]
      self.GSStartDateToken:str = obj["GSStartDateToken"]
      self.GSStartTime:int = obj["GSStartTime"]
...
class Erp_Tablesets_SchedSetOrderProcessTableset:
   def __init__(self, obj):
      self.SchedSetOrderProcess:list[Erp_Tablesets_SchedSetOrderProcessRow] = obj["SchedSetOrderProcess"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SchedSetOrderProcessTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SchedSetOrderProcessTableset] = obj["returnObj"]
      pass
...
class GetSchedulingMultiJobFlag_input:
   """ Required : 
   company
   plant
   """  
...
class GetSchedulingMultiJobFlag_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.outputvalue:bool = obj["outputvalue"]
      pass
...
class lastRunDate_input:
   """ Required : 
   il_SetLastRunDate
   """  
   def __init__(self, obj):
      self.il_SetLastRunDate:bool = obj["il_SetLastRunDate"]
      pass

class lastRunDate_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.outputdate:str = obj["parameters"]
      self.outputtime:int = obj["parameters"]
      pass
