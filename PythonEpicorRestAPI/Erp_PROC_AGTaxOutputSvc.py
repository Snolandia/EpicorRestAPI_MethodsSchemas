...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AGTaxOutputSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AGTaxOutputSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetNewParametersByProcessType(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.AGTaxOutputSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AGTaxOutputSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_AGTaxOutputParamRow:
   def __init__(self, obj):
      self.ProgramID:str = obj["ProgramID"]
      self.SelfAssessmentName:str = obj["SelfAssessmentName"]
      self.WithholdingName:str = obj["WithholdingName"]
      self.FileName:str = obj["FileName"]
      self.SelfAssessmentCustomsName:str = obj["SelfAssessmentCustomsName"]
      self.Period:str = obj["Period"]
      self.HeaderName:str = obj["HeaderName"]
      self.DetailName:str = obj["DetailName"]
      self.SalesName:str = obj["SalesName"]
      self.PurchaseName:str = obj["PurchaseName"]
      self.MinimumAmount:int = obj["MinimumAmount"]
      self.NCSalesRecord:bool = obj["NCSalesRecord"]
      self.PackNum:int = obj["PackNum"]
      self.WithholdingBankName:str = obj["WithholdingBankName"]
...
class Erp_Tablesets_AGTaxOutputTableset:
   def __init__(self, obj):
      self.AGTaxOutputParam:list[Erp_Tablesets_AGTaxOutputParamRow] = obj["AGTaxOutputParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_AGTaxOutputTableset] = obj["ds"]
      pass
...
class GetNewParametersByProcessType_input:
   """ Required : 
   processType
   """  
   def __init__(self, obj):
...
class GetNewParametersByProcessType_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_AGTaxOutputTableset] = obj["returnObj"]
      pass
