...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_TaxResults(select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxResults",headers=creds) as resp:
           return await resp.json()

async def post_TaxResults(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxResults", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_TaxResults_Company_TaxSvcID(Company, TaxSvcID, select = None, expand = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxResults(" + Company + "," + TaxSvcID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_TaxResults_Company_TaxSvcID(Company, TaxSvcID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxResults(" + Company + "," + TaxSvcID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_TaxResults_Company_TaxSvcID(Company, TaxSvcID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxResults(" + Company + "," + TaxSvcID + ")",headers=creds) as resp:
           return await resp.json()

async def get_TaxResults_Company_TaxSvcID_TaxSvcDetails(Company, TaxSvcID, select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxResults(" + Company + "," + TaxSvcID + ")/TaxSvcDetails",headers=creds) as resp:
           return await resp.json()

async def get_TaxResults_Company_TaxSvcID_TaxSvcDetails_Company_TaxSvcID_TCNo(Company, TaxSvcID, TCNo, select = None, expand = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxResults(" + Company + "," + TaxSvcID + ")/TaxSvcDetails(" + Company + "," + TaxSvcID + "," + TCNo + ")",headers=creds) as resp:
           return await resp.json()

async def get_TaxResults_Company_TaxSvcID_TaxSvcMessages(Company, TaxSvcID, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   Summary: Calls GetByID for the service
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxResults(" + Company + "," + TaxSvcID + ")/TaxSvcMessages",headers=creds) as resp:
           return await resp.json()

async def get_TaxResults_Company_TaxSvcID_TaxSvcMessages_Company_TaxSvcID_Sequence(Company, TaxSvcID, Sequence, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxResults(" + Company + "," + TaxSvcID + ")/TaxSvcMessages(" + Company + "," + TaxSvcID + "," + Sequence + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_TaxSvcDetails(select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcDetails",headers=creds) as resp:
           return await resp.json()
...
async def post_TaxSvcDetails(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcDetails", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_TaxSvcDetails_Company_TaxSvcID_TCNo(Company, TaxSvcID, TCNo, select = None, expand = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcDetails(" + Company + "," + TaxSvcID + "," + TCNo + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_TaxSvcDetails_Company_TaxSvcID_TCNo(Company, TaxSvcID, TCNo, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcDetails(" + Company + "," + TaxSvcID + "," + TCNo + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_TaxSvcDetails_Company_TaxSvcID_TCNo(Company, TaxSvcID, TCNo, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcDetails(" + Company + "," + TaxSvcID + "," + TCNo + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_TaxSvcDetails_Company_TaxSvcID_TCNo_TaxSvcJurDtls(Company, TaxSvcID, TCNo, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcDetails(" + Company + "," + TaxSvcID + "," + TCNo + ")/TaxSvcJurDtls",headers=creds) as resp:
           return await resp.json()
...
async def get_TaxSvcDetails_Company_TaxSvcID_TCNo_TaxSvcJurDtls_Company_TaxSvcID_TCNo_Seq(Company, TaxSvcID, TCNo, Seq, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcDetails(" + Company + "," + TaxSvcID + "," + TCNo + ")/TaxSvcJurDtls(" + Company + "," + TaxSvcID + "," + TCNo + "," + Seq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_TaxSvcJurDtls(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcJurDtls",headers=creds) as resp:
           return await resp.json()
...
async def post_TaxSvcJurDtls(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcJurDtls", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_TaxSvcJurDtls_Company_TaxSvcID_TCNo_Seq(Company, TaxSvcID, TCNo, Seq, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcJurDtls(" + Company + "," + TaxSvcID + "," + TCNo + "," + Seq + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_TaxSvcJurDtls_Company_TaxSvcID_TCNo_Seq(Company, TaxSvcID, TCNo, Seq, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcJurDtls(" + Company + "," + TaxSvcID + "," + TCNo + "," + Seq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_TaxSvcJurDtls_Company_TaxSvcID_TCNo_Seq(Company, TaxSvcID, TCNo, Seq, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcJurDtls(" + Company + "," + TaxSvcID + "," + TCNo + "," + Seq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_TaxSvcMessages(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcMessages",headers=creds) as resp:
           return await resp.json()
...
async def post_TaxSvcMessages(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcMessages", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_TaxSvcMessages_Company_TaxSvcID_Sequence(Company, TaxSvcID, Sequence, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcMessages(" + Company + "," + TaxSvcID + "," + Sequence + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_TaxSvcMessages_Company_TaxSvcID_Sequence(Company, TaxSvcID, Sequence, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcMessages(" + Company + "," + TaxSvcID + "," + Sequence + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_TaxSvcMessages_Company_TaxSvcID_Sequence(Company, TaxSvcID, Sequence, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/TaxSvcMessages(" + Company + "," + TaxSvcID + "," + Sequence + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseTaxSvcHead, whereClauseTaxSvcDetail, whereClauseTaxSvcJurDtl, whereClauseTaxSvcMessages, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetTaxSvcID(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.TaxResultsSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetVendorTaxSvcID(requestBody, epicorHeaders = None):
   """  
...
class Erp_Tablesets_TaxResultsTableset:
   def __init__(self, obj):
...
class Erp_Tablesets_UpdExtTaxResultsTableset:
   def __init__(self, obj):
      self.TaxSvcHead:list[Erp_Tablesets_TaxSvcHeadRow] = obj["TaxSvcHead"]
      self.TaxSvcDetail:list[Erp_Tablesets_TaxSvcDetailRow] = obj["TaxSvcDetail"]
      self.TaxSvcJurDtl:list[Erp_Tablesets_TaxSvcJurDtlRow] = obj["TaxSvcJurDtl"]
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_TaxResultsTableset] = obj["returnObj"]
      pass
...
class GetNewTaxSvcDetail_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_TaxResultsTableset] = obj["ds"]
      self.taxSvcID:str = obj["taxSvcID"]
      pass
...
class GetTaxSvcID_input:
   ...
   def __init__(self, obj):
      self.company:str = obj["company"]
      self.apVen:int = obj["apVen"]
      self.hedNum:str = obj["hedNum"]
      pass

class GetTaxSvcID_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass

class GetVendorTaxSvcID_input:
   """ Required : 
   hedNum
   """  
   def __init__(self, obj):
...
class GetVendorTaxSvcID_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtTaxResultsTableset] = obj["ds"]
