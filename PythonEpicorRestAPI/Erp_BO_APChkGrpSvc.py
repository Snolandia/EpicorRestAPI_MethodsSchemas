...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_APChkGrps(select = None, expand = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrps",headers=creds) as resp:
           return await resp.json()

async def post_APChkGrps(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrps", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_APChkGrps_Company_GroupID(Company, GroupID, select = None, expand = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrps(" + Company + "," + GroupID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_APChkGrps_Company_GroupID(Company, GroupID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrps(" + Company + "," + GroupID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_APChkGrps_Company_GroupID(Company, GroupID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrps(" + Company + "," + GroupID + ")",headers=creds) as resp:
           return await resp.json()

async def get_APChkGrps_Company_GroupID_APChkGrpAttches(Company, GroupID, select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrps(" + Company + "," + GroupID + ")/APChkGrpAttches",headers=creds) as resp:
           return await resp.json()

async def get_APChkGrps_Company_GroupID_APChkGrpAttches_Company_GroupID_DrawingSeq(Company, GroupID, DrawingSeq, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrps(" + Company + "," + GroupID + ")/APChkGrpAttches(" + Company + "," + GroupID + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_APChkGrpAttches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrpAttches",headers=creds) as resp:
           return await resp.json()
...
async def post_APChkGrpAttches(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrpAttches", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_APChkGrpAttches_Company_GroupID_DrawingSeq(Company, GroupID, DrawingSeq, select = None, filter = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrpAttches(" + Company + "," + GroupID + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def patch_APChkGrpAttches_Company_GroupID_DrawingSeq(Company, GroupID, DrawingSeq, requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrpAttches(" + Company + "," + GroupID + "," + DrawingSeq + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def delete_APChkGrpAttches_Company_GroupID_DrawingSeq(Company, GroupID, DrawingSeq, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/APChkGrpAttches(" + Company + "," + GroupID + "," + DrawingSeq + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseAPChkGrp, whereClauseAPChkGrpAttch, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_AllowProcessPayments(epicorHeaders = None):
   """  
...
processing payments to be defined
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewAPChkGrpNoLock(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.APChkGrpSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def post_GetDisplayTotals(requestBody, epicorHeaders = None):
   """  
...
async def post_OnChangePayMethod(requestBody, epicorHeaders = None):
   """  
...
async def post_IsBOEGroup(requestBody, epicorHeaders = None):
   """  
...
async def post_GroupExits(requestBody, epicorHeaders = None):
   """  
...
# Custom Schemas:
#########################################################################
class AllowProcessPayments_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_APChkGrpTableset:
   def __init__(self, obj):
...
class Erp_Tablesets_UpdExtAPChkGrpTableset:
   def __init__(self, obj):
      self.APChkGrp:list[Erp_Tablesets_APChkGrpRow] = obj["APChkGrp"]
      self.APChkGrpAttch:list[Erp_Tablesets_APChkGrpAttchRow] = obj["APChkGrpAttch"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
...
class GetByID_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_APChkGrpTableset] = obj["returnObj"]
      pass
...
class GetDisplayTotals_input:
   ...
   def __init__(self, obj):
      ...
      self.ds:list[Erp_Tablesets_APChkGrpTableset] = obj["ds"]
      pass

class GetDisplayTotals_output:
   def __init__(self, obj):
      pass
...
class OnChangePayMethod_input:
   """ Required : 
   vPMUID
   ds
   """  
   def __init__(self, obj):
      self.vPMUID:int = obj["vPMUID"]
      """  The proposed value of PMUID.  """  
      self.ds:list[Erp_Tablesets_APChkGrpTableset] = obj["ds"]
      pass

class OnChangePayMethod_output:
   def __init__(self, obj):
      pass
...
class UpdateExt_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_UpdExtAPChkGrpTableset] = obj["ds"]
