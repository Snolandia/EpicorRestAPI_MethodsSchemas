...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobStatusReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes: This is to give the UI a visual on the values for the SortByOption.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.JobStatusReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.JobStatusReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.JobStatusReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_JobStatusReportParamRow:
   def __init__(self, obj):
      self.DueDate:str = obj["DueDate"]
      """  Job Due Date  """  
      self.TimeOverPct:int = obj["TimeOverPct"]
      """  Time Over Percentage  """  
      self.DelqDays:int = obj["DelqDays"]
      """  Delinquent Days  """  
      self.EfficiencyPct:int = obj["EfficiencyPct"]
      ...
      self.RelJobsOnlyToggle:bool = obj["RelJobsOnlyToggle"]
      """  Show Released Jobs Only  """  
      self.ProdGrpSels:str = obj["ProdGrpSels"]
      """  Product Group Selection  """  
      self.PickedPlants:str = obj["PickedPlants"]
      """  Plants Selection List  """  
      self.DueDateToken:str = obj["DueDateToken"]
...
class Erp_Tablesets_JobStatusReportTableset:
   def __init__(self, obj):
      self.JobStatusReportParam:list[Erp_Tablesets_JobStatusReportParamRow] = obj["JobStatusReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_JobStatusReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_JobStatusReportTableset] = obj["returnObj"]
      pass
