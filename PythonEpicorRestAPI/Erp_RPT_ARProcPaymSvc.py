...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARProcPaymSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARProcPaymSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GenerateBankExportFile(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARProcPaymSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetNewParam(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARProcPaymSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARProcPaymSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ARProcPaymParamRow:
   def __init__(self, obj):
      self.BankAcctID:str = obj["BankAcctID"]
      self.BankName:str = obj["BankName"]
      self.GroupID:str = obj["GroupID"]
      self.PaymDate:str = obj["PaymDate"]
      self.FiscYear:int = obj["FiscYear"]
      self.FiscSuf:str = obj["FiscSuf"]
      self.FiscPeriod:int = obj["FiscPeriod"]
      self.ExportFile:str = obj["ExportFile"]
      self.PrintReport:bool = obj["PrintReport"]
      self.ElecPaym:bool = obj["ElecPaym"]
      self.CurrencyType:str = obj["CurrencyType"]
      """  'Base' - Base currency, 'Doc' - Document currecncy.  """  
      self.ClientDate:str = obj["ClientDate"]
      self.ExportFileDisplay:str = obj["ExportFileDisplay"]
...
class Erp_Tablesets_ARProcPaymTableset:
   def __init__(self, obj):
      self.ARProcPaymParam:list[Erp_Tablesets_ARProcPaymParamRow] = obj["ARProcPaymParam"]
...
class GenerateBankExportFile_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ARProcPaymTableset] = obj["ds"]
      pass
...
class GetNewParam_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ARProcPaymTableset] = obj["returnObj"]
      pass
