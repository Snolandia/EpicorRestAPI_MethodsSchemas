...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MasterProductionScheduleSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MasterProductionScheduleSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes: This is to give the UI a visual on the values for the SortByOption.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MasterProductionScheduleSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MasterProductionScheduleSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MasterProductionScheduleSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MasterProductionScheduleParamRow:
   def __init__(self, obj):
      self.StartDate:str = obj["StartDate"]
      self.PartList:str = obj["PartList"]
      self.PlantList:str = obj["PlantList"]
      self.Sort:str = obj["Sort"]
...
class Erp_Tablesets_MasterProductionScheduleTableset:
   def __init__(self, obj):
      self.MasterProductionScheduleParam:list[Erp_Tablesets_MasterProductionScheduleParamRow] = obj["MasterProductionScheduleParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MasterProductionScheduleTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MasterProductionScheduleTableset] = obj["returnObj"]
      pass
