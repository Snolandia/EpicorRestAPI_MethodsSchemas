...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AssetYearEndSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AssetYearEndSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_DepCalcReqMessage(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.AssetYearEndSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.AssetYearEndSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class DepCalcReqMessage_output:
   def __init__(self, obj):
      self.returnObj:str = obj["returnObj"]
      pass

class Erp_Tablesets_AssetYearEndProcessRow:
   def __init__(self, obj):
      self.FiscalYear:int = obj["FiscalYear"]
      self.FiscalCalendarID:str = obj["FiscalCalendarID"]
      self.FiscalYearSuffix:str = obj["FiscalYearSuffix"]
...
class Erp_Tablesets_AssetYearEndTableset:
   def __init__(self, obj):
      self.AssetYearEndProcess:list[Erp_Tablesets_AssetYearEndProcessRow] = obj["AssetYearEndProcess"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_AssetYearEndTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_AssetYearEndTableset] = obj["returnObj"]
      pass
