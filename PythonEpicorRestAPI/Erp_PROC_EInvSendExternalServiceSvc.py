...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.EInvSendExternalServiceSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.EInvSendExternalServiceSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetInvoiceDefaults(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.EInvSendExternalServiceSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetInvoiceNumDefaults(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.EInvSendExternalServiceSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_EInvSendExternalServiceParamRow:
   def __init__(self, obj):
      ...
      self.RecipientEmail:str = obj["RecipientEmail"]
...
class Erp_Tablesets_EInvSendExternalServiceTableset:
   def __init__(self, obj):
      self.EInvSendExternalServiceParam:list[Erp_Tablesets_EInvSendExternalServiceParamRow] = obj["EInvSendExternalServiceParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_EInvSendExternalServiceTableset] = obj["ds"]
      pass
...
class GetInvoiceDefaults_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class GetInvoiceDefaults_output:
   def __init__(self, obj):
      pass
...
class GetInvoiceNumDefaults_input:
   """ Required : 
   invoiceNum
   """  
   def __init__(self, obj):
...
class GetInvoiceNumDefaults_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_EInvSendExternalServiceTableset] = obj["returnObj"]
      pass
