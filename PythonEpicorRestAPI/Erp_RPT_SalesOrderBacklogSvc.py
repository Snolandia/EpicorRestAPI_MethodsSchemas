...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderBacklogSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderBacklogSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_PrintOptionList(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderBacklogSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_SortByList(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderBacklogSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SalesOrderBacklogSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SalesOrderBacklogParamRow:
   def __init__(self, obj):
      self.PeriodEndDate1:str = obj["PeriodEndDate1"]
      self.PeriodEndDate2:str = obj["PeriodEndDate2"]
      self.PeriodEndDate3:str = obj["PeriodEndDate3"]
      self.PeriodEndDate4:str = obj["PeriodEndDate4"]
      self.CustNumList:str = obj["CustNumList"]
      """  Delimited list of Cust Numbers to print the report for  """  
      self.CustGroupList:str = obj["CustGroupList"]
      ...
      self.SalesRegionList:str = obj["SalesRegionList"]
      """  Delimited list of Sales Regions to print the report for  """  
      self.PrintPartDescriptions:bool = obj["PrintPartDescriptions"]
      self.PrintOrderReleaseDetail:bool = obj["PrintOrderReleaseDetail"]
      self.SortBy:str = obj["SortBy"]
      self.PrintOption:str = obj["PrintOption"]
      """  Print Sales (D)ollars or (Q)uantity  """  
      self.PeriodEndDate1Token:str = obj["PeriodEndDate1Token"]
      self.PeriodEndDate2Token:str = obj["PeriodEndDate2Token"]
      self.PeriodEndDate3Token:str = obj["PeriodEndDate3Token"]
      self.PeriodEndDate4Token:str = obj["PeriodEndDate4Token"]
      self.SalesTerritoryList:str = obj["SalesTerritoryList"]
      """  Delimited list of Sales Regions to print the report for  """  
...
class Erp_Tablesets_SalesOrderBacklogTableset:
   def __init__(self, obj):
      self.SalesOrderBacklogParam:list[Erp_Tablesets_SalesOrderBacklogParamRow] = obj["SalesOrderBacklogParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SalesOrderBacklogTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SalesOrderBacklogTableset] = obj["returnObj"]
      pass
...
class PrintOptionList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.printOptionList:str = obj["parameters"]
      pass
...
class SortByList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.sortOrderList:str = obj["parameters"]
      pass
