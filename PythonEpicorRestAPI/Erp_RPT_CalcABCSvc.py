...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CalcABCSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CalcABCSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.CalcABCSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CalcABCSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.CalcABCSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_CalcABCParamRow:
   def __init__(self, obj):
      self.PrinterSetting:str = obj["PrinterSetting"]
      self.HistUsageFrom:str = obj["HistUsageFrom"]
      self.HistUsageFromToken:str = obj["HistUsageFromToken"]
      self.IncludeProjected:bool = obj["IncludeProjected"]
      self.IncludeQOH:bool = obj["IncludeQOH"]
      self.PageSpecs:str = obj["PageSpecs"]
      self.PlantList:str = obj["PlantList"]
      self.ProjectedThrough:str = obj["ProjectedThrough"]
      self.ProjectedThroughToken:str = obj["ProjectedThroughToken"]
      self.UpdateABCCode:bool = obj["UpdateABCCode"]
      self.WorkStID:str = obj["WorkStID"]
      self.CalcBasedOn:str = obj["CalcBasedOn"]
...
class Erp_Tablesets_CalcABCTableset:
   def __init__(self, obj):
      self.CalcABCParam:list[Erp_Tablesets_CalcABCParamRow] = obj["CalcABCParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CalcABCTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CalcABCTableset] = obj["returnObj"]
      pass
