...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureRevenueCOSSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureRevenueCOSSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_ChangeEndingDate(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureRevenueCOSSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_ExValidateParam(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureRevenueCOSSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureRevenueCOSSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class ChangeEndingDate_input:
   ...
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_CaptureRevenueCOSTableset] = obj["ds"]
...
class Erp_Tablesets_CaptureRevenueCOSRow:
   def __init__(self, obj):
...
class Erp_Tablesets_CaptureRevenueCOSTableset:
   def __init__(self, obj):
      self.CaptureRevenueCOS:list[Erp_Tablesets_CaptureRevenueCOSRow] = obj["CaptureRevenueCOS"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class ExValidateParam_output:
   def __init__(self, obj):
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_CaptureRevenueCOSTableset] = obj["returnObj"]
      pass
