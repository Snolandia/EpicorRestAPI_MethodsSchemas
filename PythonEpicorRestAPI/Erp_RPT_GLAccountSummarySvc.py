...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLAccountSummarySvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLAccountSummarySvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GLAccountSummarySvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.GLAccountSummarySvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.GLAccountSummarySvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_GLAccountSummaryParamRow:
   def __init__(self, obj):
      ...
      """  Starting Account  """  
      self.SummaryLevels:str = obj["SummaryLevels"]
      self.SelectedNatAccList:str = obj["SelectedNatAccList"]
      self.ExcludedNatAccList:str = obj["ExcludedNatAccList"]
      self.PrintMatchCode:bool = obj["PrintMatchCode"]
...
class Erp_Tablesets_GLAccountSummaryTableset:
   def __init__(self, obj):
      self.GLAccountSummaryParam:list[Erp_Tablesets_GLAccountSummaryParamRow] = obj["GLAccountSummaryParam"]
...
class GetApplicationDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GLAccountSummaryTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GLAccountSummaryTableset] = obj["returnObj"]
      pass
