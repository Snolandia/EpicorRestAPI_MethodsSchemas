...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SubcontractStatReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SubcontractStatReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
Notes: This is to give the UI a visual on the values for the ReportFormat Option.
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SubcontractStatReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.SubcontractStatReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.SubcontractStatReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_SubcontractStatReportParamRow:
   def __init__(self, obj):
      self.Vendlist:str = obj["Vendlist"]
      self.ReportFormat:str = obj["ReportFormat"]
      self.Duedate:str = obj["Duedate"]
      self.DueDateToken:str = obj["DueDateToken"]
      self.PrintTransDetail:bool = obj["PrintTransDetail"]
      self.PrintRelatedPOs:bool = obj["PrintRelatedPOs"]
...
class Erp_Tablesets_SubcontractStatReportTableset:
   def __init__(self, obj):
      self.SubcontractStatReportParam:list[Erp_Tablesets_SubcontractStatReportParamRow] = obj["SubcontractStatReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_SubcontractStatReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_SubcontractStatReportTableset] = obj["returnObj"]
      pass
