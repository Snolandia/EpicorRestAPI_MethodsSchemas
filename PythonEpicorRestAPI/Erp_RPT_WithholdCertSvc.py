...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_IsManualGenType(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_PECheckCertificatePrinting(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_WithholdCertParamRow:
   def __init__(self, obj):
      self.FromDate:str = obj["FromDate"]
      self.FromDateToken:str = obj["FromDateToken"]
      self.Reprint:bool = obj["Reprint"]
      ...
      self.ToDateToken:str = obj["ToDateToken"]
      self.PrintPer:str = obj["PrintPer"]
      ...
      self.CertNumberList:str = obj["CertNumberList"]
      ...
      self.PrintOption:bool = obj["PrintOption"]
      """  Indicates if user submits report for printing.  """  
      self.PaymentNumList:str = obj["PaymentNumList"]
      self.PaymentGroupList:str = obj["PaymentGroupList"]
...
class Erp_Tablesets_WithholdCertTableset:
   def __init__(self, obj):
      self.WithholdCertParam:list[Erp_Tablesets_WithholdCertParamRow] = obj["WithholdCertParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_WithholdCertTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_WithholdCertTableset] = obj["returnObj"]
      pass
...
class IsManualGenType_input:
   """ Required : 
   docTranType
   """  
   def __init__(self, obj):
      self.docTranType:str = obj["docTranType"]
      """  Transaction document type  """  
      pass

class IsManualGenType_output:
   def __init__(self, obj):
      pass

class PECheckCertificatePrinting_input:
   """ Required : 
   ds
   """  
   def __init__(self, obj):
...
class PECheckCertificatePrinting_output:
   def __init__(self, obj):
      pass
