...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.EquipListReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.EquipListReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.EquipListReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.EquipListReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.EquipListReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_EquipListReportParamRow:
   def __init__(self, obj):
      self.EquipList:str = obj["EquipList"]
      """  Equipment List  """  
      self.EquipStatus:str = obj["EquipStatus"]
      """  Equipment Status  """  
      self.EquipType:str = obj["EquipType"]
      """  Equipment Type  """  
      self.IncludeChildEquip:bool = obj["IncludeChildEquip"]
      """  Include Child Equipment  """  
      self.JobClosedDate:str = obj["JobClosedDate"]
      """  Job Closed Date After  """  
      self.JobClosedDateToken:str = obj["JobClosedDateToken"]
      """  Job Closed Date After Token  """  
      self.LocationList:str = obj["LocationList"]
      """  Location List  """  
      self.NewPagePerEquip:bool = obj["NewPagePerEquip"]
      """  New Page per Equipment  """  
      self.PrintDetails:bool = obj["PrintDetails"]
      """  Print Details  """  
      self.PrintMaintLog:bool = obj["PrintMaintLog"]
      """  Print Maintenance Log  """  
      self.PrintMaintPlan:bool = obj["PrintMaintPlan"]
      """  Print Maintenance Log  """  
...
class Erp_Tablesets_EquipListReportTableset:
   def __init__(self, obj):
      self.EquipListReportParam:list[Erp_Tablesets_EquipListReportParamRow] = obj["EquipListReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_EquipListReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_EquipListReportTableset] = obj["returnObj"]
      pass
