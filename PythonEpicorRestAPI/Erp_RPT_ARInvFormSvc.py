...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_PackNumDefaults(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_OnChangeOfHeadOrOffice(requestBody, epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ARInvFormParamRow:
   def __init__(self, obj):
      self.InvoiceNum:int = obj["InvoiceNum"]
      self.CurGroup:str = obj["CurGroup"]
      self.PrintNPost:bool = obj["PrintNPost"]
      self.Vouchering:bool = obj["Vouchering"]
      self.AssignLegalNumber:bool = obj["AssignLegalNumber"]
      """  Indicates if a legal number should be generated when printing.  """  
      self.Description:str = obj["Description"]
      """  Description  """  
      self.DocTypeOption:str = obj["DocTypeOption"]
      """  Document Types Options  """  
      self.EnableAssignLegalNumber:bool = obj["EnableAssignLegalNumber"]
      """  Indicates if the EnableAssignLegalNumber field is available for input  """  
      self.PrintStatusOption:str = obj["PrintStatusOption"]
      """  Print Status Options  """  
      self.TranDocTypeID:str = obj["TranDocTypeID"]
      self.TransOptions:str = obj["TransOptions"]
      ...
      self.DCList:str = obj["DCList"]
      self.TH_IsService:bool = obj["TH_IsService"]
      self.ARInvFormReportID:str = obj["ARInvFormReportID"]
      self.BeginDate:str = obj["BeginDate"]
      """  Begin Date range  """  
      self.BeginNum:str = obj["BeginNum"]
      """  Begin invoice number range  """  
      self.EndDate:str = obj["EndDate"]
      """  Ending date for date range  """  
      self.EndNum:str = obj["EndNum"]
      """  Ending invoice number range  """  
      self.InvoiceStatusOption:str = obj["InvoiceStatusOption"]
      """  Invoice status options  """  
      self.THHeadOfficeOrBranch:str = obj["THHeadOfficeOrBranch"]
      self.THPlaceOfBusiness:str = obj["THPlaceOfBusiness"]
      self.TWCompInvPart1:bool = obj["TWCompInvPart1"]
      """  Print TW Computer Invoice, Part I  """  
      self.TWCompInvPart2:bool = obj["TWCompInvPart2"]
      """  Print TW Computer Invoice, Part II  """  
      self.TWCompInvPart3Front:bool = obj["TWCompInvPart3Front"]
      """  Print TW Computer Invoice, Part III Front  """  
      self.TWCompInvPart3Back:bool = obj["TWCompInvPart3Back"]
      """  Print TW Computer Invoice, Part III Back  """  
      self.TWEInvTransDetails:bool = obj["TWEInvTransDetails"]
      """  Print Transaction Details part of TW E-Invoice  """  
      self.TWEInvPrizeCollection:bool = obj["TWEInvPrizeCollection"]
      ...
      self.EnableUseCopyNumInARInv:bool = obj["EnableUseCopyNumInARInv"]
      """  Indicates 'Use copy number' functionality is ON.  """  
      self.DraftCopy:bool = obj["DraftCopy"]
      """  Print Document draft copy  """  
      self.DspDocCopyNum:str = obj["DspDocCopyNum"]
      """  Document Copy Number  """  
      self.CustIDList:str = obj["CustIDList"]
      """  List of selected customer IDs to process  """  
      self.DemandContractList:str = obj["DemandContractList"]
      """  List of selected demand contracts to process  """  
      self.PrintInventoryAttributes:bool = obj["PrintInventoryAttributes"]
...
class Erp_Tablesets_ARInvFormTableset:
   def __init__(self, obj):
      self.ARInvFormParam:list[Erp_Tablesets_ARInvFormParamRow] = obj["ARInvFormParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ARInvFormTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ARInvFormTableset] = obj["returnObj"]
      pass
...
class OnChangeOfHeadOrOffice_input:
   """ Required : 
   headOrOffice
   ds
   """  
   def __init__(self, obj):
      self.headOrOffice:str = obj["headOrOffice"]
      """  The value of HeadOrOffice entered  """  
      self.ds:list[Erp_Tablesets_ARInvFormTableset] = obj["ds"]
      pass

class OnChangeOfHeadOrOffice_output:
   def __init__(self, obj):
      pass
