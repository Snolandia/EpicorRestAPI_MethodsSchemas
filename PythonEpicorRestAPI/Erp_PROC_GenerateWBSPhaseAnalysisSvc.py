...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GenerateWBSPhaseAnalysisSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GenerateWBSPhaseAnalysisSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_GetProjectDesc(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.GenerateWBSPhaseAnalysisSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.GenerateWBSPhaseAnalysisSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_GenerateWBSPhaseAnalysisTableset:
   def __init__(self, obj):
      self.GenerateWBSPhaseAnalysisParam:list[Erp_Tablesets_GenerateWBSPhaseAnalysisParamRow] = obj["GenerateWBSPhaseAnalysisParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_GenerateWBSPhaseAnalysisTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_GenerateWBSPhaseAnalysisTableset] = obj["returnObj"]
      pass
