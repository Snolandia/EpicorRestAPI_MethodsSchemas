...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MaintReqRptSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MaintReqRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MaintReqRptSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MaintReqRptSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MaintReqRptSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MaintReqRptParamRow:
   def __init__(self, obj):
      self.Requests:str = obj["Requests"]
      self.EquipIDs:str = obj["EquipIDs"]
      self.Priority:str = obj["Priority"]
      """  Priority of this request.  Must be a valid value in SchedPri table or blank which means ALL.  """  
      self.RequestStatus:str = obj["RequestStatus"]
      """  Request Status  """  
      self.RequestedBy:str = obj["RequestedBy"]
      """  Requested By - List of User IDs.  """  
      self.EquipmentType:str = obj["EquipmentType"]
      """  Equipment Type  """  
      self.Location:str = obj["Location"]
      """  Location  """  
      self.Plant:str = obj["Plant"]
      """  Plant  """  
      self.ReqOnOrAfter:str = obj["ReqOnOrAfter"]
      self.ReqOnOrBefore:str = obj["ReqOnOrBefore"]
      self.BarCodes:bool = obj["BarCodes"]
      self.Name:str = obj["Name"]
      """  Plant Name.  """  
      self.ReqOnOrAfterToken:str = obj["ReqOnOrAfterToken"]
      self.ReqOnOrBeforeToken:str = obj["ReqOnOrBeforeToken"]
      self.SchedPri:str = obj["SchedPri"]
      self.AllSites:bool = obj["AllSites"]
...
class Erp_Tablesets_MaintReqRptTableset:
   def __init__(self, obj):
      self.MaintReqRptParam:list[Erp_Tablesets_MaintReqRptParamRow] = obj["MaintReqRptParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MaintReqRptTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MaintReqRptTableset] = obj["returnObj"]
      pass
