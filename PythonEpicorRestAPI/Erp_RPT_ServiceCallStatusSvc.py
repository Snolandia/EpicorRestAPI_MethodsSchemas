...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ServiceCallStatusSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ServiceCallStatusSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetCallStatusList(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ServiceCallStatusSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.ServiceCallStatusSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.ServiceCallStatusSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
class Erp_Tablesets_ServiceCallStatusRow:
   def __init__(self, obj):
      ...
      """  Parts  """  
      self.CallTypes:str = obj["CallTypes"]
      """  Call Types List  """  
      self.CallStatus:str = obj["CallStatus"]
      """  Call Status  """  
      self.SortByOption:str = obj["SortByOption"]
      """  Sort By Option  """  
      self.Technicians:bool = obj["Technicians"]
      """  Technicians  """  
      self.Services:bool = obj["Services"]
      """  Services  """  
      self.Materials:bool = obj["Materials"]
      """  Materials  """  
...
class Erp_Tablesets_ServiceCallStatusTableset:
   def __init__(self, obj):
      self.ServiceCallStatus:list[Erp_Tablesets_ServiceCallStatusRow] = obj["ServiceCallStatus"]
      self.ReportStyle:list[Erp_Tablesets_ReportStyleRow] = obj["ReportStyle"]
      self.ExtensionTables:list[Ice_Extensions_ExtensionTableData] = obj["ExtensionTables"]
      pass

class GetCallStatusList_output:
   def __init__(self, obj):
      pass

   def parameters(self, obj):
      self.CallStatusList:str = obj["parameters"]
      pass
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ServiceCallStatusTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ServiceCallStatusTableset] = obj["returnObj"]
      pass
