...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatReportGenericSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatReportGenericSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_GetGroupsFilterSummary(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatReportGenericSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatReportGenericSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatReportGenericSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ISRGParamRow:
   def __init__(self, obj):
      ...
      self.DeclarationType:str = obj["DeclarationType"]
...
class Erp_Tablesets_IntraStatReportGenericTableset:
   def __init__(self, obj):
      self.ISRGParam:list[Erp_Tablesets_ISRGParamRow] = obj["ISRGParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_IntraStatReportGenericTableset] = obj["ds"]
      pass
...
class GetGroupsFilterSummary_input:
   """ Required : 
   ipGroupID
   ds
   """  
...
class GetGroupsFilterSummary_output:
   def __init__(self, obj):
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_IntraStatReportGenericTableset] = obj["returnObj"]
      pass
