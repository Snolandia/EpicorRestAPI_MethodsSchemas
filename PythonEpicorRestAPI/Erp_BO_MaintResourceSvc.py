...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MaintResourceSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MaintResourceSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_MaintResources(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MaintResourceSvc/MaintResources",headers=creds) as resp:
           return await resp.json()

async def post_MaintResources(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.MaintResourceSvc/MaintResources", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_MaintResources_Company_ResourceID(Company, ResourceID, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MaintResourceSvc/MaintResources(" + Company + "," + ResourceID + ")",headers=creds) as resp:
           return await resp.json()

async def patch_MaintResources_Company_ResourceID(Company, ResourceID, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.MaintResourceSvc/MaintResources(" + Company + "," + ResourceID + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_MaintResources_Company_ResourceID(Company, ResourceID, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.MaintResourceSvc/MaintResources(" + Company + "," + ResourceID + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MaintResourceSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseResource, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.MaintResourceSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewResource(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.MaintResourceSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
