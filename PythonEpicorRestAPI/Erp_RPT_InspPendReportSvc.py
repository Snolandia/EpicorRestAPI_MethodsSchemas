...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.InspPendReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.InspPendReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SetPrintInventoryAttributes(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.InspPendReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.InspPendReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.InspPendReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_InspPendReportRow:
   def __init__(self, obj):
      self.Operations:bool = obj["Operations"]
      self.Inventory:bool = obj["Inventory"]
      self.Materials:bool = obj["Materials"]
      self.POReceipts:bool = obj["POReceipts"]
      self.RMA:bool = obj["RMA"]
      self.AsOfDate:str = obj["AsOfDate"]
      self.ShowClosedAct:bool = obj["ShowClosedAct"]
      self.PageBrkSect:bool = obj["PageBrkSect"]
      self.PageBrkPOInsp:bool = obj["PageBrkPOInsp"]
      self.AsOfDateToken:str = obj["AsOfDateToken"]
      self.FirstArticle:bool = obj["FirstArticle"]
...
class Erp_Tablesets_InspPendReportTableset:
   def __init__(self, obj):
      self.InspPendReport:list[Erp_Tablesets_InspPendReportRow] = obj["InspPendReport"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_InspPendReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_InspPendReportTableset] = obj["returnObj"]
      pass
