...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CurrExRateSearchSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CurrExRateSearchSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def get_CurrExRateSearches(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CurrExRateSearchSvc/CurrExRateSearches",headers=creds) as resp:
           return await resp.json()

async def post_CurrExRateSearches(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.CurrExRateSearchSvc/CurrExRateSearches", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def get_CurrExRateSearches_Company_RateGrpCode_SourceCurrCode_TargetCurrCode_EffectiveDate(Company, RateGrpCode, SourceCurrCode, TargetCurrCode, EffectiveDate, select = None, filter = None, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CurrExRateSearchSvc/CurrExRateSearches(" + Company + "," + RateGrpCode + "," + SourceCurrCode + "," + TargetCurrCode + "," + EffectiveDate + ")",headers=creds) as resp:
           return await resp.json()

async def patch_CurrExRateSearches_Company_RateGrpCode_SourceCurrCode_TargetCurrCode_EffectiveDate(Company, RateGrpCode, SourceCurrCode, TargetCurrCode, EffectiveDate, requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.patch(configEpicorSchemas.epicorURL + "Erp.BO.CurrExRateSearchSvc/CurrExRateSearches(" + Company + "," + RateGrpCode + "," + SourceCurrCode + "," + TargetCurrCode + "," + EffectiveDate + ")", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def delete_CurrExRateSearches_Company_RateGrpCode_SourceCurrCode_TargetCurrCode_EffectiveDate(Company, RateGrpCode, SourceCurrCode, TargetCurrCode, EffectiveDate, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.delete(configEpicorSchemas.epicorURL + "Erp.BO.CurrExRateSearchSvc/CurrExRateSearches(" + Company + "," + RateGrpCode + "," + SourceCurrCode + "," + TargetCurrCode + "," + EffectiveDate + ")",headers=creds) as resp:
           return await resp.json()
...
async def get_List(select = None, filter = None, orderby = None, top = None, skip = None, inlinecount = None, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CurrExRateSearchSvc/List",headers=creds) as resp:
           return await resp.json()
...
async def get_GetRows(whereClauseCurrExRate, pageSize, absolutePage, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.BO.CurrExRateSearchSvc/List" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetNewCurrExRate(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.BO.CurrExRateSearchSvc/List", json=requestBody,headers=creds) as resp:
           return await resp.json()
