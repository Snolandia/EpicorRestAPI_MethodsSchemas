...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ImageExportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ImageExportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_OnChangeOutputDir(requestBody, epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ImageExportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ImageExportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_ImageExportParamRow:
   def __init__(self, obj):
      self.CategoryList:str = obj["CategoryList"]
      """  List of selected Image Categories to Export  """  
      self.ExportCategoryInfo:bool = obj["ExportCategoryInfo"]
      """  Export Category and Subcategory Information  """  
      self.ImageList:str = obj["ImageList"]
      """  List of selected Images to Export  """  
      self.OutputDir:str = obj["OutputDir"]
      """  Output directory  """  
      self.SubCategoryList:str = obj["SubCategoryList"]
...
class Erp_Tablesets_ImageExportTableset:
   def __init__(self, obj):
      self.ImageExportParam:list[Erp_Tablesets_ImageExportParamRow] = obj["ImageExportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_ImageExportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ImageExportTableset] = obj["returnObj"]
      pass
...
class OnChangeOutputDir_output:
   def __init__(self, obj):
      pass
