...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
# Custom methods:
#########################################################################
async def post_CheckPrevious(requestBody, epicorHeaders = None):
   """  
...
Notes:
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()

async def post_GetGLSourceBook(epicorHeaders = None):
   """  
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/$metadata",headers=creds) as resp:
           return await resp.json()

async def post_SetDefaultCalendar(requestBody, epicorHeaders = None):
   """  
...
async def post_GetListSourceBook(epicorHeaders = None):
   """  
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
class CheckPrevious_input:
   ...
   def __init__(self, obj):
      ...
      self.ds:list[Erp_Tablesets_ConsYearEndTableset] = obj["ds"]
      pass

class CheckPrevious_output:
   def __init__(self, obj):
      pass
...
class Erp_Tablesets_ConsYearEndParamRow:
   def __init__(self, obj):
      ...
      """  GL Book Description  """  
      self.OkayToContinue:bool = obj["OkayToContinue"]
      ...
      self.OkayPrompt:str = obj["OkayPrompt"]
...
class Erp_Tablesets_ConsYearEndTableset:
   def __init__(self, obj):
      self.ConsYearEndParam:list[Erp_Tablesets_ConsYearEndParamRow] = obj["ConsYearEndParam"]
...
class GetGLSourceBook_output:
   def __init__(self, obj):
      self.returnObj      #schema had no properties on an object.
      pass

class GetListSourceBook_output:
   def __init__(self, obj):
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_ConsYearEndTableset] = obj["returnObj"]
      pass
...
class SetDefaultCalendar_input:
   """ Required : 
   ipBookid
   ds
   """  
...
class SetDefaultCalendar_output:
   def __init__(self, obj):
      pass
