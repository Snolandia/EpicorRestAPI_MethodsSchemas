...
async def getServiceDocument(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MESMenuReportSvc/",headers=creds) as resp:
...
async def get_metadata(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MESMenuReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def get_GetTokenList(tokenDataType, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.get(configEpicorSchemas.epicorURL + "Erp.RPT.MESMenuReportSvc/$metadata" + params,headers=creds) as resp:
           return await resp.json()
...
async def post_GetRptArchiveList(epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MESMenuReportSvc/$metadata",headers=creds) as resp:
           return await resp.json()
...
async def post_SubmitToAgent(requestBody, epicorHeaders = None):
   ...
   async with aiohttp.ClientSession() as session:
       async with session.post(configEpicorSchemas.epicorURL + "Erp.RPT.MESMenuReportSvc/$metadata", json=requestBody,headers=creds) as resp:
           return await resp.json()
...
# Custom Schemas:
#########################################################################
class Erp_Tablesets_MESMenuReportParamRow:
   def __init__(self, obj):
      self.EmployeeList:str = obj["EmployeeList"]
      self.Inbound:bool = obj["Inbound"]
      self.IncludeEmps:bool = obj["IncludeEmps"]
      self.IncludeMenus:bool = obj["IncludeMenus"]
      self.Inventory:bool = obj["Inventory"]
      self.Manufacturing:bool = obj["Manufacturing"]
      self.MaterialHandler:bool = obj["MaterialHandler"]
      self.MenuList:str = obj["MenuList"]
      self.Outbound:bool = obj["Outbound"]
      self.Production:bool = obj["Production"]
      self.Quality:bool = obj["Quality"]
      self.ServiceTech:bool = obj["ServiceTech"]
      self.ShipRecv:bool = obj["ShipRecv"]
      self.Supervisor:bool = obj["Supervisor"]
...
class Erp_Tablesets_MESMenuReportTableset:
   def __init__(self, obj):
      self.MESMenuReportParam:list[Erp_Tablesets_MESMenuReportParamRow] = obj["MESMenuReportParam"]
...
class GetDefaults_input:
   ...
   """  
   def __init__(self, obj):
      self.ds:list[Erp_Tablesets_MESMenuReportTableset] = obj["ds"]
      pass
...
class GetNewParameters_output:
   def __init__(self, obj):
      self.returnObj:list[Erp_Tablesets_MESMenuReportTableset] = obj["returnObj"]
      pass
