...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_DoBatching(requestBody:DoBatching_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DoBatching_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as DoBatching_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_IsFullSerial(epicorHeaders?:Headers){
   ...
   return (new Promise<IsFullSerial_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as IsFullSerial_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_SetFinalOprOnBatchedJob(epicorHeaders?:Headers){
   ...
   return (new Promise<SetFinalOprOnBatchedJob_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as SetFinalOprOnBatchedJob_output)
          })
      .catch((error) => {
          reject(error)
      })
