...
export function post_GetDateOfPeriod(requestBody:GetDateOfPeriod_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_BookChanged(requestBody:BookChanged_input, epicorHeaders?:Headers){
   ...
   return (new Promise<BookChanged_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as BookChanged_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_OnChangeOfFiscalYear(requestBody:OnChangeOfFiscalYear_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeOfFiscalYearSuffix(requestBody:OnChangeOfFiscalYearSuffix_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeOfFiscalYearSuffix_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeOfFiscalYearSuffix_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeOfStartPeriod(requestBody:OnChangeOfStartPeriod_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeOfStartPeriod_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeOfStartPeriod_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeOfEndPeriod(requestBody:OnChangeOfEndPeriod_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeOfEndPeriod_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeOfEndPeriod_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangingOfBook(requestBody:OnChangingOfBook_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangingOfBook_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangingOfBook_output)
          })
      .catch((error) => {
          reject(error)
      })
