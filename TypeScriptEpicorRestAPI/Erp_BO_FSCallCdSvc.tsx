...
export function get_FSCallCds(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_FSCallCds(requestBody:Erp_Tablesets_FSCallCdRow, epicorHeaders?:Headers){
...
export function get_FSCallCds_Company_CallCode(Company:string, CallCode:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FSCallCds_Company_CallCode(Company:string, CallCode:string, requestBody:Erp_Tablesets_FSCallCdRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFSCallCd(requestBody:GetNewFSCallCd_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewFSCallCd_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewFSCallCd_output)
          })
      .catch((error) => {
          reject(error)
      })
