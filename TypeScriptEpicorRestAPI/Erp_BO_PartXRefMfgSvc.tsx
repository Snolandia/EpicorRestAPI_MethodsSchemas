...
export function get_PartXRefMfgs(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PartXRefMfgs(requestBody:Erp_Tablesets_PartXRefMfgRow, epicorHeaders?:Headers){
...
export function get_PartXRefMfgs_Company_PartNum_MfgNum(Company:string, PartNum:string, MfgNum:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PartXRefMfgs_Company_PartNum_MfgNum(Company:string, PartNum:string, MfgNum:string, requestBody:Erp_Tablesets_PartXRefMfgRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetPartDesc(requestBody:GetPartDesc_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetPartDesc_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetPartDesc_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetPartInfo(requestBody:GetPartInfo_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeManufacturerID(requestBody:OnChangeManufacturerID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeManufacturerID_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeManufacturerID_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAprvMfg(requestBody:GetNewAprvMfg_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewAprvMfg_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewAprvMfg_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartXRefMfg(requestBody:GetNewPartXRefMfg_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPartXRefMfg_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPartXRefMfg_output)
          })
      .catch((error) => {
          reject(error)
      })
