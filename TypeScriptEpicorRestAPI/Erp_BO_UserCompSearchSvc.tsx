...
export function get_UserCompSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_UserCompSearches(requestBody:Erp_Tablesets_UserCompRow, epicorHeaders?:Headers){
...
export function get_UserCompSearches_DcdUserID_Company(DcdUserID:string, Company:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UserCompSearches_DcdUserID_Company(DcdUserID:string, Company:string, requestBody:Erp_Tablesets_UserCompRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeTransactionRetrievalDays(requestBody:ChangeTransactionRetrievalDays_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeTransactionRetrievalDays_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ChangeTransactionRetrievalDays_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTransactionRetrievalDays(requestBody:GetTransactionRetrievalDays_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTransactionRetrievalDays_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetTransactionRetrievalDays_output)
          })
      .catch((error) => {
          reject(error)
      })
