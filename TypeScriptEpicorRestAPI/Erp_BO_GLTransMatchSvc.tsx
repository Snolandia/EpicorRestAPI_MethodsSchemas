...
export function get_GLTransMatches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GLTransMatches(requestBody:Erp_Tablesets_GLJrnDtlMatchingRow, epicorHeaders?:Headers){
...
export function get_GLTransMatches_Company_BookID_FiscalYear_JournalCode_JournalNum_JournalLine(Company:string, BookID:string, FiscalYear:string, JournalCode:string, JournalNum:string, JournalLine:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GLTransMatches_Company_BookID_FiscalYear_JournalCode_JournalNum_JournalLine(Company:string, BookID:string, FiscalYear:string, JournalCode:string, JournalNum:string, JournalLine:string, requestBody:Erp_Tablesets_GLJrnDtlMatchingRow, epicorHeaders?:Headers){
...
export function post_GetRowsCustom(requestBody:GetRowsCustom_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetMatchCodes(requestBody:GetMatchCodes_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetMatchCodes_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetMatchCodes_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetMatchingTransactions(requestBody:GetMatchingTransactions_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetMatchingTransactions_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetMatchingTransactions_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetNextMatchCode(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNextMatchCode_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNextMatchCode_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_RemoveMatchCode(requestBody:RemoveMatchCode_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveMatchCode_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as RemoveMatchCode_output)
          })
      .catch((error) => {
          reject(error)
      })
...
This is only being used in the Classic UI, so we don't have a character limit for where clauses as we do in Kinetic/REST.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetWhereClauseForAvailSegments(requestBody:GetWhereClauseForAvailSegments_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetWhereClauseForAvailSegments_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetWhereClauseForAvailSegments_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CalculateBalance(requestBody:CalculateBalance_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CalculateBalance_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CalculateBalance_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGLJrnDtlMatching(requestBody:GetNewGLJrnDtlMatching_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGLJrnDtlMatching_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGLJrnDtlMatching_output)
          })
      .catch((error) => {
          reject(error)
      })
