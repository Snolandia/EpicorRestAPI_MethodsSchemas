...
export function get_NLVATDeclarations(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_NLVATDeclarations(requestBody:any, epicorHeaders?:Headers){
...
export function get_NLVATDeclarations_Company_DeclarationUID(Company:string, DeclarationUID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_NLVATDeclarations_Company_DeclarationUID(Company:string, DeclarationUID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_NLTaxReportDeclarationAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_NLTaxReportDeclarationAttches(requestBody:any, epicorHeaders?:Headers){
...
export function get_NLTaxReportDeclarationAttches_Company_DeclarationUID_DrawingSeq(Company:string, DeclarationUID:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_NLTaxReportDeclarationAttches_Company_DeclarationUID_DrawingSeq(Company:string, DeclarationUID:string, DrawingSeq:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNextNewNLTaxReportDeclaration(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTaxBoxData(requestBody:any, epicorHeaders?:Headers){
...
export function post_GenExportFile(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ResetDeclarationStatus(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SetStatusToSubmitted(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewNLTaxReportDeclaration(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewNLTaxReportDeclarationAttch(requestBody:any, epicorHeaders?:Headers){
