...
export function get_PartTranHists(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PartTranHists(requestBody:Erp_Tablesets_PartTranHistRow, epicorHeaders?:Headers){
...
export function get_PartTranHists_Company_SysDate_SysTime_TranNum(Company:string, SysDate:string, SysTime:string, TranNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PartTranHists_Company_SysDate_SysTime_TranNum(Company:string, SysDate:string, SysTime:string, TranNum:string, requestBody:Erp_Tablesets_PartTranHistRow, epicorHeaders?:Headers){
...
export function get_PartTranAttrValueSets(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PartTranAttrValueSets(requestBody:Erp_Tablesets_PartTranAttrValueSetRow, epicorHeaders?:Headers){
...
export function get_PartTranAttrValueSets_SysRowID(SysRowID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PartTranAttrValueSets_SysRowID(SysRowID:string, requestBody:Erp_Tablesets_PartTranAttrValueSetRow, epicorHeaders?:Headers){
...
export function post_GetSortByList(requestBody:GetSortByList_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_RunPartTranHistory(requestBody:RunPartTranHistory_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunPartTranHistory_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as RunPartTranHistory_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartTranHist(requestBody:GetNewPartTranHist_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPartTranHist_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPartTranHist_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartTranAttrValueSet(requestBody:GetNewPartTranAttrValueSet_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPartTranAttrValueSet_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPartTranAttrValueSet_output)
          })
      .catch((error) => {
          reject(error)
      })
