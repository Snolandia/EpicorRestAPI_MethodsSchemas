...
export function get_BESalesDomestics(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_BESalesDomestics(requestBody:Erp_Tablesets_BESalesDomesticRow, epicorHeaders?:Headers){
...
export function get_BESalesDomestics_Company_ECSalesReportID(Company:string, ECSalesReportID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_BESalesDomestics_Company_ECSalesReportID(Company:string, ECSalesReportID:string, requestBody:Erp_Tablesets_BESalesDomesticRow, epicorHeaders?:Headers){
...
export function post_GenExportFile(requestBody:GenExportFile_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewBESalesDomestic(requestBody:GetNewBESalesDomestic_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewBESalesDomestic_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewBESalesDomestic_output)
          })
      .catch((error) => {
          reject(error)
      })
