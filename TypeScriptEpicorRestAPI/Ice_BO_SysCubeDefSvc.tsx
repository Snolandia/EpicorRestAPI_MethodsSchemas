...
export function get_SysCubeDefs(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_SysCubeDefs(requestBody:Ice_Tablesets_SysCubeDefRow, epicorHeaders?:Headers){
...
export function get_SysCubeDefs_SysRowID(SysRowID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SysCubeDefs_SysRowID(SysRowID:string, requestBody:Ice_Tablesets_SysCubeDefRow, epicorHeaders?:Headers){
...
export function get_SysCubeParams(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SysCubeParams(requestBody:Ice_Tablesets_SysCubeParamRow, epicorHeaders?:Headers){
...
export function get_SysCubeParams_ForeignSysRowID_Sequence(ForeignSysRowID:string, Sequence:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SysCubeParams_ForeignSysRowID_Sequence(ForeignSysRowID:string, Sequence:string, requestBody:Ice_Tablesets_SysCubeParamRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_Validate(requestBody:Validate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Validate_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as Validate_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSysCubeDef(requestBody:GetNewSysCubeDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewSysCubeDef_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewSysCubeDef_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSysCubeParam(requestBody:GetNewSysCubeParam_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewSysCubeParam_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewSysCubeParam_output)
          })
      .catch((error) => {
          reject(error)
      })
