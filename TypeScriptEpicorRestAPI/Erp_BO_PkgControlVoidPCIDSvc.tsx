...
export function get_PkgControlVoidPCIDs(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PkgControlVoidPCIDs(requestBody:any, epicorHeaders?:Headers){
...
export function get_PkgControlVoidPCIDs_Company_PCID(Company:string, PCID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PkgControlVoidPCIDs_Company_PCID(Company:string, PCID:string, requestBody:any, epicorHeaders?:Headers){
