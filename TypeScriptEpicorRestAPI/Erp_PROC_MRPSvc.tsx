...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetCodeDescList(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/GetCodeDescList", {
          method: 'post',
          headers: headers,
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_MRPParamRow{
      /**  Generation Options; Values are NetChange, Regeneration  */  
   GenerateOptions:string,
      /**  Delimited list of Plants  */  
   PlantList:string,
   CutOffDate:string,
      /**  Indicates whether or not to run scheduling  */  
   FiniteLoad:boolean,
      /**  Ignore Material Constraints when scheduling, enabled only when FiniteLoad = yes  */  
   IgnoreConst:boolean,
      /**  Allow backwards scheduling  */  
   AllowHistDate:boolean,
      /**  Run Multi-Level Pegging  */  
   RunPegging:boolean,
   LogFile:string,
      /**  No UI representation , send no for MRP  */  
   FromAutoPur:boolean,
      /**  Use Kit Time when determining due dates  */  
   UseKitTime:boolean,
      /**  Use Production Prep Buffers when determining due dates  */  
   UsePrepTime:boolean,
   LastRunDate:string,
   LastRunTime:string,
   LastRunUser:string,
      /**  StartDate for scheduling  */  
   StartDate:string,
      /**  Start Date Token  */  
   StartDateToken:string,
      /**  Cut Off Date Token  */  
   CutOffDateToken:string,
      /**  Should the Purchase Contract Schedules be generated in this run of MRP?  */  
   IncludePurchaseContract:boolean,
      /**  Number of Processes to split MRP into  */  
   NumProcesses:number,
      /**  Number of schedulers to startup for MRP  */  
   NumSchedulers:number,
      /**  Who's calling, MRP, GenPO, SetOrder, SaveLoad, GFS  */  
   ProcSource:string,
      /**  Logging Level (when LogFile is populated) Basic = 0, 1 = MRP, 2 = MRP and Sched  */  
   LogLevel:number,
   DelaySched:boolean,
   RecycleJobs:boolean,
      /**  Indicates if rough cut scheduling occurs when getting details  */  
   RCSchedGetDetails:boolean,
      /**  Should Active Purchase Contract Parts be included in this MRP run  */  
   IncludePCParts:boolean,
      /**  If true, MRP will get details from the Quote for linked orders.  This is only for non-configured parts.  Configured parts will get details as they always have  */  
   UseQuoteBOM:boolean,
      /**  Delimited list of Part Classes  */  
   ClassList:string,
      /**  Delimited list of Parts  */  
   ItemList:string,
      /**  Delimited list of Product Groups  */  
   ProdGrupList:string,
      /**   Append : Add the content at the end of the log files, 
Overwrite: Overwrite the log files in each run of MRP Process, 
Split: Add date and time in the filename to create separate log files for each run of MRP Process.  */  
   LogType:number,
      /**  Only include Parts in Net Change or Regeneration mode that have activity or min/safety  */  
   InclActivity:boolean,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_MRPTableset{
   MRPParam:Erp_Tablesets_MRPParamRow[],
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_MRPTableset[],
}
