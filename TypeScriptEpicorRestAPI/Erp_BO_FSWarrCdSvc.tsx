...
export function get_FSWarrCds(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_FSWarrCds(requestBody:Erp_Tablesets_FSWarrCdRow, epicorHeaders?:Headers){
...
export function get_FSWarrCds_Company_WarrantyCode(Company:string, WarrantyCode:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FSWarrCds_Company_WarrantyCode(Company:string, WarrantyCode:string, requestBody:Erp_Tablesets_FSWarrCdRow, epicorHeaders?:Headers){
...
export function post_GetCodeDescList(requestBody:GetCodeDescList_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFSWarrCd(requestBody:GetNewFSWarrCd_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewFSWarrCd_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewFSWarrCd_output)
          })
      .catch((error) => {
          reject(error)
      })
