...
/** 
// Title: Ice.RPT.DynamicCriteriaSvc
// Description: DynamicCriteria Service.
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method GetNewDynamicCriteriaReportParam
   Description: Gets new parameters for the given report id.
   OperationID: GetNewDynamicCriteriaReportParam
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetNewDynamicCriteriaReportParam_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetNewDynamicCriteriaReportParam_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewDynamicCriteriaReportParam(requestBody:GetNewDynamicCriteriaReportParam_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewDynamicCriteriaReportParam_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/GetNewDynamicCriteriaReportParam", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as GetNewDynamicCriteriaReportParam_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewParametersForReportId(requestBody:GetNewParametersForReportId_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParametersForReportId_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/GetNewParametersForReportId", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewParametersForReportId_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method TransformDynamicCriteria
   Description: Transform and return DynamicCriteriaParam after processing user criteria XML from JSON(object).
   OperationID: TransformDynamicCriteria
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/TransformDynamicCriteria_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/TransformDynamicCriteria_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_TransformDynamicCriteria(requestBody:TransformDynamicCriteria_input, epicorHeaders?:Headers){
   ...
   return (new Promise<TransformDynamicCriteria_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/TransformDynamicCriteria", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as TransformDynamicCriteria_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method LoadCriteriaFromXml
   Description: Returns DynamicCriteriaParam object after transforming from UserCriteria XML.
   OperationID: LoadCriteriaFromXml
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/LoadCriteriaFromXml_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/LoadCriteriaFromXml_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_LoadCriteriaFromXml(requestBody:LoadCriteriaFromXml_input, epicorHeaders?:Headers){
   ...
   return (new Promise<LoadCriteriaFromXml_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/LoadCriteriaFromXml", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as LoadCriteriaFromXml_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.RPT.DynamicCriteriaSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface GetDefaults_input{
   ds:Ice_Tablesets_DynamicCriteriaTableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param reportID
   */  
export interface GetNewDynamicCriteriaReportParam_input{
      /**  Identifier of the report being shown on the form.  */  
   reportID:string,
}

export interface GetNewDynamicCriteriaReportParam_output{
   returnObj:Ice_Tablesets_DynamicCriteriaTableset[],
}

   /** Required : 
      @param reportId
   */  
export interface GetNewParametersForReportId_input{
      /**  The report identifier.  */  
   reportId:string,
}

export interface GetNewParametersForReportId_output{
   returnObj:Ice_Tablesets_DynamicCriteriaTableset[],
}
...
export interface Ice_Tablesets_DynamicCriteriaParamRow{
      /**  Report ID  */  
   ReportID:string,
      /**  Report Title  */  
   ReportTitle:string,
      /**  Criteria entered by the user as an xml document.  */  
   UserCriteria:string,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Ice_Tablesets_DynamicCriteriaTableset{
   DynamicCriteriaParam:Ice_Tablesets_DynamicCriteriaParamRow[],
...
mfgsysdata\EDI  */  
   ...
   /** Required : 
      @param xml
   */  
export interface LoadCriteriaFromXml_input{
      /**  The XML string (DynamicCriteriaDataSet)  */  
   xml:string,
}

export interface LoadCriteriaFromXml_output{
      /**  The criteria object  */  
...
export interface SubmitToAgent_output{
   ...
   /** Required : 
      @param ds
   */  
export interface TransformDynamicCriteria_input{
   ds:any,      //schema had no properties on an object.
}

export interface TransformDynamicCriteria_output{
   returnObj:any,      //schema had no properties on an object.
}
