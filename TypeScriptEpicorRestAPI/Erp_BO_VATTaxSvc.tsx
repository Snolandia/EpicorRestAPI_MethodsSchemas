...
export function get_VATTaxes(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_VATTaxes(requestBody:Erp_Tablesets_TaxReportRow, epicorHeaders?:Headers){
...
export function get_VATTaxes_Company_ReportID(Company:string, ReportID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_VATTaxes_Company_ReportID(Company:string, ReportID:string, requestBody:Erp_Tablesets_TaxReportRow, epicorHeaders?:Headers){
...
whether to continue or not.  If the user answers yes then call InitializeTaxRptDtl.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PreInitTaxRptDtl(requestBody:PreInitTaxRptDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PreInitTaxRptDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as PreInitTaxRptDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
...
whether to continue or not.  If the user answers yes then call InitializeTaxRptDtl.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PrePostReport(requestBody:PrePostReport_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PrePostReport_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as PrePostReport_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_ValidateFiscalCal(requestBody:ValidateFiscalCal_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTaxReport(requestBody:GetNewTaxReport_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTaxReport_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewTaxReport_output)
          })
      .catch((error) => {
          reject(error)
      })
