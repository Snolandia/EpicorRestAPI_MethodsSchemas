...
export function get_ShopWrns(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ShopWrns(requestBody:any, epicorHeaders?:Headers){
...
export function get_ShopWrns_Company_WarnType_LaborHedSeq_LaborDtlSeq_LabWarnNum(Company:string, WarnType:string, LaborHedSeq:string, LaborDtlSeq:string, LabWarnNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ShopWrns_Company_WarnType_LaborHedSeq_LaborDtlSeq_LabWarnNum(Company:string, WarnType:string, LaborHedSeq:string, LaborDtlSeq:string, LabWarnNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_MoveToHistory(requestBody:any, epicorHeaders?:Headers){
...
This is just for Kinetic UI
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_MoveAllToHistory(requestBody:any, epicorHeaders?:Headers){
...
export function post_MoveAllToHistoryTrackerNoDataSet(epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewShopWrn(requestBody:any, epicorHeaders?:Headers){
