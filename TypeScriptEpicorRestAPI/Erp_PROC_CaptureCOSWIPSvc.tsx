...
/** 
// Title: Erp.PROC.CaptureCOSWIPSvc
// Description: 
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method ChangeEndingDate
   Description: Change ending date
   OperationID: ChangeEndingDate
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ChangeEndingDate_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ChangeEndingDate_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeEndingDate(requestBody:ChangeEndingDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeEndingDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/ChangeEndingDate", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as ChangeEndingDate_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method getLastRunDate
   Description: Purpose: to get last run date.
   OperationID: getLastRunDate
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/getLastRunDate_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getLastRunDate(epicorHeaders?:Headers){
   ...
   return (new Promise<getLastRunDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/getLastRunDate", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as getLastRunDate_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method getStartingDate
   Description: Purpose: Updates the table with the current Fiscal Year and Period and validates
the ending Date.
   OperationID: getStartingDate
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/getStartingDate_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/getStartingDate_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getStartingDate(requestBody:getStartingDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<getStartingDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/getStartingDate", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as getStartingDate_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method SetFirstOutdate
   OperationID: SetFirstOutdate
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/SetFirstOutdate_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SetFirstOutdate(epicorHeaders?:Headers){
   ...
   return (new Promise<SetFirstOutdate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/SetFirstOutdate", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as SetFirstOutdate_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method canPostToGL
   Description: Purpose: True if can post to GL.
   OperationID: canPostToGL
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/canPostToGL_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_canPostToGL(epicorHeaders?:Headers){
   ...
   return (new Promise<canPostToGL_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/canPostToGL", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as canPostToGL_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method getCostMethod
   Description: Purpose: to get cost method.
   OperationID: getCostMethod
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/getCostMethod_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/getCostMethod_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getCostMethod(requestBody:getCostMethod_input, epicorHeaders?:Headers){
   ...
   return (new Promise<getCostMethod_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/getCostMethod", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as getCostMethod_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method getPerson
   Description: Purpose: to get person.
   OperationID: getPerson
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/getPerson_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/getPerson_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getPerson(requestBody:getPerson_input, epicorHeaders?:Headers){
   ...
   return (new Promise<getPerson_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/getPerson", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as getPerson_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetApplicationDefaults(requestBody:GetApplicationDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetApplicationDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/GetApplicationDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureCOSWIPSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
//////////////////////////////////////////////////////////////////////////
   /** Required : 
      ...
      @param endDateToken
   */  
export interface ChangeEndingDate_input{
   ds:Erp_Tablesets_CaptureCOSWIPTableset[],
      /**  The ending date  */  
   endDate:string,
      /**  The ending date Token  */  
   endDateToken:string,
}

export interface ChangeEndingDate_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_CaptureCOSWIPTableset,
}
...
export interface Erp_Tablesets_CaptureCOSWIPParamRow{
   CanPostToGL:boolean,
   EndingDate:string,
      /**  EndingDate Token  */  
   EndingDateToken:string,
   LastRunDate:string,
   LastRunInfo:string,
   LastRunTime:string,
   LastRunUserID:string,
   PostCostOfSales:boolean,
   PostToGeneralLedger:boolean,
      /**  Period Starting Date  */  
   StartingDate:string,
      /**  ACT type name.  */  
   Acttype:string,
      /**  Is Capture Outdated transaction  */  
   IsCaptureOT:boolean,
      /**  outdated transaction date  */  
   OTDate:string,
      /**  outdated transaction date token  */  
   OTDateToken:string,
   AddPBCosts:boolean,
   StartingDateDesc:string,
   PostFSA:boolean,
   EpicorFSA:boolean,
   SysRowID:string,
   AutoAction:string,
...
export interface Erp_Tablesets_CaptureCOSWIPTableset{
   CaptureCOSWIPParam:Erp_Tablesets_CaptureCOSWIPParamRow[],
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_CaptureCOSWIPTableset[],
}
...
export interface SetFirstOutdate_output{
}
...
export interface canPostToGL_output{
   returnObj:boolean,
}
   ...
   /** Required : 
      @param CurCostMethod
   */  
export interface getCostMethod_input{
   CurCostMethod:string,
}

export interface getCostMethod_output{
   returnObj:string,
}

export interface getLastRunDate_output{
}
...
export interface getPerson_output{
   returnObj:string,
}
   ...
   /** Required : 
      @param iDate
      @param lUpdateTT
      @param skipEADValidation
   */  
export interface getStartingDate_input{
   iDate:string,
   lUpdateTT:boolean,
   skipEADValidation:boolean,
}

export interface getStartingDate_output{
parameters : {
      /**  output parameters  */  
   lValidFiscal:boolean,
   cOutMsg:string,
}
}
