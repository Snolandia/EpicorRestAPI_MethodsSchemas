...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_ChangeEndingDate(requestBody:any, epicorHeaders?:Headers){
...
the ending Date.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getStartingDate(requestBody:any, epicorHeaders?:Headers){
...
export function post_canPostToGL(epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getCostMethod(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getPerson(requestBody:any, epicorHeaders?:Headers){
