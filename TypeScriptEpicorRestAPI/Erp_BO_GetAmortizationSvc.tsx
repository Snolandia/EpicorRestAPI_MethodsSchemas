...
export function get_GetAmortizations(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GetAmortizations(requestBody:Erp_Tablesets_InvcDtlRASchRow, epicorHeaders?:Headers){
...
export function get_GetAmortizations_Company_InvoiceNum_InvoiceLine_AmortSeq(Company:string, InvoiceNum:string, InvoiceLine:string, AmortSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GetAmortizations_Company_InvoiceNum_InvoiceLine_AmortSeq(Company:string, InvoiceNum:string, InvoiceLine:string, AmortSeq:string, requestBody:Erp_Tablesets_InvcDtlRASchRow, epicorHeaders?:Headers){
...
this runtime error, the list will be split into four lists if needed.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_BuildAmortizationsLists(requestBody:BuildAmortizationsLists_input, epicorHeaders?:Headers){
   ...
   return (new Promise<BuildAmortizationsLists_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as BuildAmortizationsLists_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetAmortizationsWithTotal(requestBody:GetAmortizationsWithTotal_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetAmortizationRows(requestBody:GetAmortizationRows_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetAmortizationRows_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetAmortizationRows_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetCurrencyBase(epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewInvcDtlRASch(requestBody:GetNewInvcDtlRASch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewInvcDtlRASch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewInvcDtlRASch_output)
          })
      .catch((error) => {
          reject(error)
      })
