...
export function get_DynAttrMasterDtls(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_DynAttrMasterDtls(requestBody:any, epicorHeaders?:Headers){
...
export function get_DynAttrMasterDtls_Company_AttributeID(Company:string, AttributeID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_DynAttrMasterDtls_Company_AttributeID(Company:string, AttributeID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_DynAttrMasterDtlListVals(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_DynAttrMasterDtlListVals(requestBody:any, epicorHeaders?:Headers){
...
export function get_DynAttrMasterDtlListVals_Company_AttributeID_Code(Company:string, AttributeID:string, Code:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_DynAttrMasterDtlListVals_Company_AttributeID_Code(Company:string, AttributeID:string, Code:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_OnChangeFieldDataType(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewDynAttrMasterDtl(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewDynAttrMasterDtlListVal(requestBody:any, epicorHeaders?:Headers){
