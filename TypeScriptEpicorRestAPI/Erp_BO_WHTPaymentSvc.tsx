...
export function get_WHTPayments(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_WHTPayments(requestBody:any, epicorHeaders?:Headers){
...
export function get_WHTPayments_Company_ReportID(Company:string, ReportID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_WHTPayments_Company_ReportID(Company:string, ReportID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_WHTPaymentDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_WHTPaymentDtls(requestBody:any, epicorHeaders?:Headers){
...
export function get_WHTPaymentDtls_Company_ReportID_TranDate_TranNum(Company:string, ReportID:string, TranDate:string, TranNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_WHTPaymentDtls_Company_ReportID_TranDate_TranNum(Company:string, ReportID:string, TranDate:string, TranNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_OnChangeTaxCode(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetWHTaxRecords(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_RemoveUnPaidWHTaxRecords(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_RemoveSelectedWHTaxRecords(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetWHTPaymentAPInvData(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewWHTPaymentHead(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewWHTPaymentDtl(requestBody:any, epicorHeaders?:Headers){
