...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_AckCompany(requestBody:AckCompany_input, epicorHeaders?:Headers){
   ...
   return (new Promise<AckCompany_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as AckCompany_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CountCompany(requestBody:CountCompany_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CountCompany_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CountCompany_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetAllCompany(requestBody:GetAllCompany_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetAllCompany_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetAllCompany_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetCompany(requestBody:GetCompany_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetCompany_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetCompany_output)
          })
      .catch((error) => {
          reject(error)
      })
