...
export function get_ImportSubsids(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ImportSubsids(requestBody:Erp_Tablesets_ConsImportRow, epicorHeaders?:Headers){
...
export function get_ImportSubsids_Company_GenID(Company:string, GenID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ImportSubsids_Company_GenID(Company:string, GenID:string, requestBody:Erp_Tablesets_ConsImportRow, epicorHeaders?:Headers){
...
Notes:
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GroupChangeWarning(requestBody:GroupChangeWarning_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GroupChangeWarning_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GroupChangeWarning_output)
          })
      .catch((error) => {
          reject(error)
      })
...
<param name="ipJournalCode">journal code</param><param name="ds">ImportSubsid dataset row</param>
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ValidateJournal(requestBody:ValidateJournal_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ValidateJournal_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ValidateJournal_output)
          })
      .catch((error) => {
          reject(error)
      })
...
Notes:
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetBookCalendar(requestBody:GetBookCalendar_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBookCalendar_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetBookCalendar_output)
          })
      .catch((error) => {
          reject(error)
      })
...
- the given Fiscal Year/Period is not valid
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckFiscalPeriod(requestBody:CheckFiscalPeriod_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckFiscalPeriod_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CheckFiscalPeriod_output)
          })
      .catch((error) => {
          reject(error)
      })
...
- the filename is blank
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GenerateJournal(requestBody:GenerateJournal_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GenerateJournal_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GenerateJournal_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ParseInputFile(requestBody:ParseInputFile_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ParseInputFile_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ParseInputFile_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewConsImport(requestBody:GetNewConsImport_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewConsImport_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewConsImport_output)
          })
      .catch((error) => {
          reject(error)
      })
