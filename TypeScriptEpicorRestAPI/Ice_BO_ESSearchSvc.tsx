...
export function get_ESSearches(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ESSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_ESSearches_Company_GlbCompany_SearchID(Company:string, GlbCompany:string, SearchID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ESSearches_Company_GlbCompany_SearchID(Company:string, GlbCompany:string, SearchID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_ESSearchFields(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ESSearchFields(requestBody:any, epicorHeaders?:Headers){
...
export function get_ESSearchFields_Company_GlbCompany_SearchID_Seq(Company:string, GlbCompany:string, SearchID:string, Seq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ESSearchFields_Company_GlbCompany_SearchID_Seq(Company:string, GlbCompany:string, SearchID:string, Seq:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_BAQExists(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewESSearch(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewESSearchFields(requestBody:any, epicorHeaders?:Headers){
