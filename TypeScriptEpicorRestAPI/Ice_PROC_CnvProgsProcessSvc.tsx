...
/** 
// Title: Ice.PROC.CnvProgsProcessSvc
// Description: The conversion program process.
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method RunConversion
   Description: Run Conversion
   OperationID: RunConversion
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/RunConversion_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/RunConversion_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_RunConversion(requestBody:RunConversion_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunConversion_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/RunConversion", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as RunConversion_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method RunConversions
   Description: Runs the conversions.
   OperationID: RunConversions
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/RunConversions_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/RunConversions_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_RunConversions(requestBody:RunConversions_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunConversions_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/RunConversions", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as RunConversions_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method SaveToProcessSet
   Description: Save ConversionID to ProcessSet
   OperationID: SaveToProcessSet
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/SaveToProcessSet_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/SaveToProcessSet_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SaveToProcessSet(requestBody:SaveToProcessSet_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveToProcessSet_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/SaveToProcessSet", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as SaveToProcessSet_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetSysTaskNumByProgram
   Description: Get the Last SysTaskNum value by conversion program name
   OperationID: GetSysTaskNumByProgram
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetSysTaskNumByProgram_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetSysTaskNumByProgram_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetSysTaskNumByProgram(requestBody:GetSysTaskNumByProgram_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetSysTaskNumByProgram_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/GetSysTaskNumByProgram", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetSysTaskNumByProgram_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetLastSysTaskLog
   Description: Get the Last SysTaskLog entry number and Message
   OperationID: GetLastSysTaskLog
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetLastSysTaskLog_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetLastSysTaskLog_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetLastSysTaskLog(requestBody:GetLastSysTaskLog_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetLastSysTaskLog_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/GetLastSysTaskLog", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetLastSysTaskLog_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetConversionID
   Description: Get the ConversionID using the processID and task number
   OperationID: GetConversionID
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetConversionID_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetConversionID_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetConversionID(requestBody:GetConversionID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetConversionID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/GetConversionID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetConversionID_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.CnvProgsProcessSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
//////////////////////////////////////////////////////////////////////////
   /** Required : 
      ...
      @param processTask
   */  
export interface GetConversionID_input{
      /**  ProcessID  */  
   processID:string,
      /**  SysTaskNum  */  
   processTask:number,
...
export interface GetConversionID_output{
parameters : {
      /**  output parameters  */  
   systemCode:string,
   conversionID:string,
...
export interface GetDefaults_input{
   ds:Ice_Tablesets_CnvProgsProcessTableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param sysTaskNum
   */  
export interface GetLastSysTaskLog_input{
      /**  the SysTaskNum  */  
   sysTaskNum:number,
}

export interface GetLastSysTaskLog_output{
      /**  the Last SysTaskLog Entry  */  
   returnObj:number,
parameters : {
      /**  output parameters  */  
   msgText:string,
...
export interface GetNewParameters_output{
   returnObj:Ice_Tablesets_CnvProgsProcessTableset[],
}
...
export interface GetParamsFromAgent_output{
   ...
   /** Required : 
      @param convProgram
   */  
export interface GetSysTaskNumByProgram_input{
      /**  conversion program name  */  
   convProgram:string,
}

export interface GetSysTaskNumByProgram_output{
      /**  Last SysTaskNum value  */  
   returnObj:number,
}
...
export interface Ice_Tablesets_CnvProgsProcessRow{
   ConversionID:string,
   SystemCode:string,
   SysRowID:string,
   AutoAction:string,
...
export interface Ice_Tablesets_CnvProgsProcessTableset{
   CnvProgsProcess:Ice_Tablesets_CnvProgsProcessRow[],
...
export interface RemoveDefaults_output{
   ...
   /** Required : 
      ...
      @param converionID
   */  
export interface RunConversion_input{
      /**  systemCode  */  
   systemCode:string,
      /**  the ConversionID  */  
   converionID:string,
...
export interface RunConversion_output{
}

   /** Required : 
      @param conversions
   */  
export interface RunConversions_input{
      /**  The conversions in this format: SystemCode`ConversionID~SystemCode`ConversionID  */  
   conversions:string,
}

export interface RunConversions_output{
}
...
export interface SaveProcessTask_output{
   ...
   /** Required : 
      ...
      @param processID
   */  
export interface SaveToProcessSet_input{
      /**  systemCode  */  
   systemCode:string,
      /**  the ConversionID  */  
   converionID:string,
...
export interface SaveToProcessSet_output{
}
