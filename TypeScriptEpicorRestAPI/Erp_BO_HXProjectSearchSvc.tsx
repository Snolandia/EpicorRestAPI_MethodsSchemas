...
export function get_HXProjectSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_HXProjectSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_HXProjectSearches_Company_ProjectID_Revision(Company:string, ProjectID:string, Revision:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_HXProjectSearches_Company_ProjectID_Revision(Company:string, ProjectID:string, Revision:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewHXProject(requestBody:any, epicorHeaders?:Headers){
