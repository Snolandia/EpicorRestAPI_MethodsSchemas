...
export function get_APInvMscSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_APInvMscSearches(requestBody:Erp_Tablesets_APInvMscRow, epicorHeaders?:Headers){
...
export function get_APInvMscSearches_Company_VendorNum_InvoiceNum_InvoiceLine_MscNum(Company:string, VendorNum:string, InvoiceNum:string, InvoiceLine:string, MscNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_APInvMscSearches_Company_VendorNum_InvoiceNum_InvoiceLine_MscNum(Company:string, VendorNum:string, InvoiceNum:string, InvoiceLine:string, MscNum:string, requestBody:Erp_Tablesets_APInvMscRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAPInvMsc(requestBody:GetNewAPInvMsc_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewAPInvMsc_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewAPInvMsc_output)
          })
      .catch((error) => {
          reject(error)
      })
