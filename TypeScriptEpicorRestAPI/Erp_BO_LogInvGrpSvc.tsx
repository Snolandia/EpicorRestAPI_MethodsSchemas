...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_LogInvGrps(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LogInvGrpRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/LogInvGrps", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LogInvGrpRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   */  
export function post_LogInvGrps(requestBody:Erp_Tablesets_LogInvGrpRow, epicorHeaders?:Headers){
   ...
   */  
export function get_LogInvGrps_Company_GroupID(Company:string, GroupID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_LogInvGrpRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/LogInvGrps(" + Company + "," + GroupID + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as Erp_Tablesets_LogInvGrpRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_LogInvGrps_Company_GroupID(Company:string, GroupID:string, requestBody:Erp_Tablesets_LogInvGrpRow, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function delete_LogInvGrps_Company_GroupID(Company:string, GroupID:string, epicorHeaders?:Headers){
...
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LogInvGrpListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LogInvGrpListRow)
          })
      .catch((error) => {
          reject(error)
      })
...
//////////////////////////////////////////////////////////////////////////
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetRows(whereClauseLogInvGrp:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   if(typeof whereClauseLogInvGrp!== 'undefined'){
      if(firstParam){
         params += "?"
         firstParam = false
      }else{
   ...
   return (new Promise<GetRows_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetByID(groupID:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_DeleteZeroAmtTaxRec(requestBody:DeleteZeroAmtTaxRec_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteZeroAmtTaxRec_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/DeleteZeroAmtTaxRec", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewLogInvGrpNoLock(requestBody:GetNewLogInvGrpNoLock_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewLogInvGrpNoLock_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/GetNewLogInvGrpNoLock", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewLogInvGrpNoLock_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetRowsNoLock(requestBody:GetRowsNoLock_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRowsNoLock_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/GetRowsNoLock", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_OnChangeofApplyDate(requestBody:OnChangeofApplyDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeofApplyDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/OnChangeofApplyDate", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
NOTE: to add a new message please continue with the next index if no error message is assigned to the list, please set string.Empty.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PrePostGroupInvoices(requestBody:PrePostGroupInvoices_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PrePostGroupInvoices_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/PrePostGroupInvoices", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as PrePostGroupInvoices_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_UnlockGroup(requestBody:UnlockGroup_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UnlockGroup_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/UnlockGroup", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewLogInvGrp(requestBody:GetNewLogInvGrp_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewLogInvGrp_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/GetNewLogInvGrp", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewLogInvGrp_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_DeleteByID(requestBody:DeleteByID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/DeleteByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowIDs_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:Update_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Update_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:UpdateExt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UpdateExt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LogInvGrpSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// OData Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LogInvGrpListRow{
   "odatametadata":string,
   "value":Erp_Tablesets_LogInvGrpListRow,
}

export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LogInvGrpRow{
   "odatametadata":string,
   "value":Erp_Tablesets_LogInvGrpRow,
}

export interface Erp_Tablesets_LogInvGrpListRow{
      /**  Company Identifier.  */  
   "Company":string,
...
export interface Erp_Tablesets_LogInvGrpRow{
      /**  Company Identifier.  */  
   "Company":string,
      /**  Before allowing invoices to be entered the user establishes a Group ID. All invoices belong to a group until the group is posted. The GroupID is assigned by the user.  The GroupID is used to Selectively print and post the transactions and establishes the invoice date and fiscal period defaults for invoices assigned to the Group.  */  
   "GroupID":string,
...
export interface Erp_Tablesets_LogInvGrpListTableset{
   LogInvGrpList:Erp_Tablesets_LogInvGrpListRow[],
...
export interface Erp_Tablesets_LogInvGrpTableset{
   LogInvGrp:Erp_Tablesets_LogInvGrpRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface Erp_Tablesets_UpdExtLogInvGrpTableset{
   LogInvGrp:Erp_Tablesets_LogInvGrpRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface GetByID_output{
   returnObj:Erp_Tablesets_LogInvGrpTableset[],
}
...
export interface GetList_output{
   returnObj:Erp_Tablesets_LogInvGrpListTableset[],
parameters : {
      /**  output parameters  */  
   morePages:boolean,
}
   ...
   /** Required : 
      @param ds
   */  
export interface GetNewLogInvGrpNoLock_input{
   ds:Erp_Tablesets_LogInvGrpTableset[],
}

export interface GetNewLogInvGrpNoLock_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_LogInvGrpTableset,
}
   ...
   /** Required : 
      @param ds
   */  
export interface GetNewLogInvGrp_input{
   ds:Erp_Tablesets_LogInvGrpTableset[],
}

export interface GetNewLogInvGrp_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_LogInvGrpTableset,
}
   ...
   /** Required : 
      @param whereClauseLogInvGrp
      @param pageSize
      @param absolutePage
   */  
export interface GetRowsNoLock_input{
   whereClauseLogInvGrp:string,
   pageSize:number,
   absolutePage:number,
}
...
export interface UpdateExt_input{
   ds:Erp_Tablesets_UpdExtLogInvGrpTableset[],
