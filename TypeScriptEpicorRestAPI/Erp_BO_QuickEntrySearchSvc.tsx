...
export function get_QuickEntrySearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_QuickEntrySearches(requestBody:Erp_Tablesets_QuickEntryRow, epicorHeaders?:Headers){
...
export function get_QuickEntrySearches_Company_EmpID_QuickEntryType_QuickEntryCode(Company:string, EmpID:string, QuickEntryType:string, QuickEntryCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_QuickEntrySearches_Company_EmpID_QuickEntryType_QuickEntryCode(Company:string, EmpID:string, QuickEntryType:string, QuickEntryCode:string, requestBody:Erp_Tablesets_QuickEntryRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewQuickEntry(requestBody:GetNewQuickEntry_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewQuickEntry_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewQuickEntry_output)
          })
      .catch((error) => {
          reject(error)
      })
