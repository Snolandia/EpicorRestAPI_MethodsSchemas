...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   OperationID: GetSortBy
      ...
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetSortBy_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetSortBy_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetSortBy(requestBody:GetSortBy_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetSortBy_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/GetSortBy", {
          method: 'post',
          headers: headers,
   ...
   /**  
   Summary: Invoke method GetTaxCodes
   Description: This method provides a list of valid tax codes
   OperationID: GetTaxCodes
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetTaxCodes_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTaxCodes(epicorHeaders?:Headers){
   ...
   return (new Promise<GetTaxCodes_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/GetTaxCodes", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetTaxCodes_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetTranstype
   Description: Get the trans type
   OperationID: GetTranstype
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetTranstype_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTranstype(epicorHeaders?:Headers){
   ...
   return (new Promise<GetTranstype_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/GetTranstype", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetTranstype_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Description: Gets the sort by list
...
export function post_GetSortByList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetSortByList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/GetSortByList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.SalesTaxEditSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface Erp_Tablesets_SalesTaxEditParamRow{
      /**  tax report id  */  
   CurTaxReportID:string,
      /**  tax code list  */  
   TaxCodeList:string,
      /**  sort by  */  
   SortBy:number,
   ...
   IncludeAP:boolean,
   IncludeAR:boolean,
   OrigIncludeAP:boolean,
   OrigIncludeAR:boolean,
   OrigReportCategoryList:string,
   OrigSupplierList:string,
   OrigTaxCodeList:string,
   OrigTaxJurisList:string,
   OrigTaxLiabilityList:string,
   OrigCustomerList:string,
   CurrDesc:string,
   CurrencyCode:string,
      /**  Show Tax Account Summary  */  
   AccountSummary:boolean,
      /**  Book for the Account Summary  */  
   Book:string,
   RevReportCategoryList:string,
   OrigRevReportCategoryList:string,
   BackdatedItem:number,
   PrintSelCriteria:boolean,
   OrigBackdatedItem:number,
      /**  List of selected customer IDs to process  */  
   CustIDList:string,
      /**  List of selected supplierr IDs to process  */  
...
export interface Erp_Tablesets_SalesTaxEditTableset{
   SalesTaxEditParam:Erp_Tablesets_SalesTaxEditParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_SalesTaxEditTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_SalesTaxEditTableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param TransTypeIn
   */  
export interface GetSortBy_input{
   TransTypeIn:string,
}
...
export interface GetTaxCodes_output{
parameters : {
      /**  output parameters  */  
   TaxCodeList:string,
}
...
export interface GetTranstype_output{
parameters : {
      /**  output parameters  */  
   TransType:string,
}
