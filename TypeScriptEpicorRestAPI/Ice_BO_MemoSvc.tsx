...
export function get_Memos(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_Memos(requestBody:any, epicorHeaders?:Headers){
...
export function get_Memos_RelatedToSchemaName_RelatedToFile_RelatedToSysRowID_MemoNum(RelatedToSchemaName:string, RelatedToFile:string, RelatedToSysRowID:string, MemoNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_Memos_RelatedToSchemaName_RelatedToFile_RelatedToSysRowID_MemoNum(RelatedToSchemaName:string, RelatedToFile:string, RelatedToSysRowID:string, MemoNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewMemo(requestBody:any, epicorHeaders?:Headers){
