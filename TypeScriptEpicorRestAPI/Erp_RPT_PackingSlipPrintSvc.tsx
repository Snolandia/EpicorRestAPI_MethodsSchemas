...
/** 
// Title: Erp.RPT.PackingSlipPrintSvc
// Description: PackingSlipPrintSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method HHValidateReportStyle
   OperationID: HHValidateReportStyle
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/HHValidateReportStyle_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/HHValidateReportStyle_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_HHValidateReportStyle(requestBody:HHValidateReportStyle_input, epicorHeaders?:Headers){
   ...
   return (new Promise<HHValidateReportStyle_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/HHValidateReportStyle", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as HHValidateReportStyle_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_PackNumDefaults(requestBody:PackNumDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PackNumDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/PackNumDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   /**  
   Summary: Invoke method GetDocCopyNumber
   Description: This method returns a ShipHead.DocCopyNumber for printing document.
   OperationID: GetDocCopyNumber
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetDocCopyNumber_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetDocCopyNumber_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetDocCopyNumber(requestBody:GetDocCopyNumber_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDocCopyNumber_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/GetDocCopyNumber", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetDocCopyNumber_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PackingSlipPrintSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_PackingSlipParamRow{
      /**  Pack slip number  */  
   PackNum:number,
      /**  S for pack slip, L for labels and B for Both.  */  
   ...
   PackNumList:string,
   StyleNumExt:number,
      /**  Indicates if field IncludePCID will be enabled for the input  */  
   EnableIncludePCID:boolean,
      /**  Indicated if PCID details will be included on the report  */  
   IncludePCID:boolean,
      /**  Document Copy Number  */  
   DocCopyNum:string,
      /**  Indicates if the document will be printed in draft mode or not.  */  
   DraftMode:boolean,
      /**  List of selected demand contacts to process  */  
   DemandContractList:string,
      /**  Indicates if Inventory Attributes will be on the report  */  
   IncludeInventoryAttributes:boolean,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_PackingSlipPrintTableset{
   PackingSlipParam:Erp_Tablesets_PackingSlipParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_PackingSlipPrintTableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param packNum
   */  
export interface GetDocCopyNumber_input{
      /**  The Pack Slip number  */  
   packNum:number,
}

export interface GetDocCopyNumber_output{
   returnObj:number,
}

export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_PackingSlipPrintTableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param reportStyleID
   */  
export interface HHValidateReportStyle_input{
   reportStyleID:number,
}

export interface HHValidateReportStyle_output{
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      @param ds
   */  
export interface PackNumDefaults_input{
   ds:Erp_Tablesets_PackingSlipPrintTableset[],
}
