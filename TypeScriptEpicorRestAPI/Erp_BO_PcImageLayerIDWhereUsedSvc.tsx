...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_GetImageLayerIDWhereUsed(requestBody:GetImageLayerIDWhereUsed_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetImageLayerIDWhereUsed_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetImageLayerIDWhereUsed_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_RebuildLayerDetails(requestBody:RebuildLayerDetails_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RebuildLayerDetails_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as RebuildLayerDetails_output)
          })
      .catch((error) => {
          reject(error)
      })
