...
export function get_AlcBatchSchedSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_AlcBatchSchedSearches(requestBody:Erp_Tablesets_AlcBatchSchedRow, epicorHeaders?:Headers){
...
export function get_AlcBatchSchedSearches_Company_BatchID_SchedNum(Company:string, BatchID:string, SchedNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_AlcBatchSchedSearches_Company_BatchID_SchedNum(Company:string, BatchID:string, SchedNum:string, requestBody:Erp_Tablesets_AlcBatchSchedRow, epicorHeaders?:Headers){
