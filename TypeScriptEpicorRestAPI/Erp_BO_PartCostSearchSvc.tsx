...
export function get_PartCostSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PartCostSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_PartCostSearches_Company_PartNum_CostID(Company:string, PartNum:string, CostID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PartCostSearches_Company_PartNum_CostID(Company:string, PartNum:string, CostID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartCost(requestBody:any, epicorHeaders?:Headers){
