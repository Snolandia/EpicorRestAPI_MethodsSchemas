...
export function get_COARefSegSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_COARefSegSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_COARefSegSearches_Company_COACode(Company:string, COACode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_COARefSegSearches_Company_COACode(Company:string, COACode:string, requestBody:any, epicorHeaders?:Headers){
