...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_TaxReconciliations(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_TaxSvcHeadRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxReconciliations", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function post_TaxReconciliations(requestBody:Erp_Tablesets_TaxSvcHeadRow, epicorHeaders?:Headers){
   ...
   */  
export function get_TaxReconciliations_Company_TaxSvcID(Company:string, TaxSvcID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_TaxSvcHeadRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxReconciliations(" + Company + "," + TaxSvcID + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TaxReconciliations_Company_TaxSvcID(Company:string, TaxSvcID:string, requestBody:Erp_Tablesets_TaxSvcHeadRow, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function delete_TaxReconciliations_Company_TaxSvcID(Company:string, TaxSvcID:string, epicorHeaders?:Headers){
   ...
   */  
export function get_TaxReconciliations_Company_TaxSvcID_TaxSvcDetails(Company:string, TaxSvcID:string, select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_TaxSvcDetailRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxReconciliations(" + Company + "," + TaxSvcID + ")/TaxSvcDetails", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_TaxReconciliations_Company_TaxSvcID_TaxSvcDetails_Company_TaxSvcID_TCNo(Company:string, TaxSvcID:string, TCNo:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_TaxSvcDetailRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxReconciliations(" + Company + "," + TaxSvcID + ")/TaxSvcDetails(" + Company + "," + TaxSvcID + "," + TCNo + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_TaxReconciliations_Company_TaxSvcID_TaxSvcMessages(Company:string, TaxSvcID:string, select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_TaxSvcMessagesRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxReconciliations(" + Company + "," + TaxSvcID + ")/TaxSvcMessages", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_TaxReconciliations_Company_TaxSvcID_TaxSvcMessages_Company_TaxSvcID_Sequence(Company:string, TaxSvcID:string, Sequence:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_TaxSvcMessagesRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxReconciliations(" + Company + "," + TaxSvcID + ")/TaxSvcMessages(" + Company + "," + TaxSvcID + "," + Sequence + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_TaxSvcDetails(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_TaxSvcDetailRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxSvcDetails", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_TaxSvcDetails(requestBody:Erp_Tablesets_TaxSvcDetailRow, epicorHeaders?:Headers){
...
export function get_TaxSvcDetails_Company_TaxSvcID_TCNo(Company:string, TaxSvcID:string, TCNo:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_TaxSvcDetailRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxSvcDetails(" + Company + "," + TaxSvcID + "," + TCNo + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TaxSvcDetails_Company_TaxSvcID_TCNo(Company:string, TaxSvcID:string, TCNo:string, requestBody:Erp_Tablesets_TaxSvcDetailRow, epicorHeaders?:Headers){
...
export function get_TaxSvcDetails_Company_TaxSvcID_TCNo_TaxSvcJurDtls(Company:string, TaxSvcID:string, TCNo:string, select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_TaxSvcJurDtlRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxSvcDetails(" + Company + "," + TaxSvcID + "," + TCNo + ")/TaxSvcJurDtls", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_TaxSvcDetails_Company_TaxSvcID_TCNo_TaxSvcJurDtls_Company_TaxSvcID_TCNo_Seq(Company:string, TaxSvcID:string, TCNo:string, Seq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_TaxSvcJurDtlRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxSvcDetails(" + Company + "," + TaxSvcID + "," + TCNo + ")/TaxSvcJurDtls(" + Company + "," + TaxSvcID + "," + TCNo + "," + Seq + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_TaxSvcJurDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_TaxSvcJurDtlRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxSvcJurDtls", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_TaxSvcJurDtls(requestBody:Erp_Tablesets_TaxSvcJurDtlRow, epicorHeaders?:Headers){
...
export function get_TaxSvcJurDtls_Company_TaxSvcID_TCNo_Seq(Company:string, TaxSvcID:string, TCNo:string, Seq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_TaxSvcJurDtlRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxSvcJurDtls(" + Company + "," + TaxSvcID + "," + TCNo + "," + Seq + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TaxSvcJurDtls_Company_TaxSvcID_TCNo_Seq(Company:string, TaxSvcID:string, TCNo:string, Seq:string, requestBody:Erp_Tablesets_TaxSvcJurDtlRow, epicorHeaders?:Headers){
...
export function get_TaxSvcMessages(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_TaxSvcMessagesRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxSvcMessages", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_TaxSvcMessages(requestBody:Erp_Tablesets_TaxSvcMessagesRow, epicorHeaders?:Headers){
...
export function get_TaxSvcMessages_Company_TaxSvcID_Sequence(Company:string, TaxSvcID:string, Sequence:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_TaxSvcMessagesRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/TaxSvcMessages(" + Company + "," + TaxSvcID + "," + Sequence + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TaxSvcMessages_Company_TaxSvcID_Sequence(Company:string, TaxSvcID:string, Sequence:string, requestBody:Erp_Tablesets_TaxSvcMessagesRow, epicorHeaders?:Headers){
...
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_TaxSvcHeadListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetRows(whereClauseTaxSvcHead:string, whereClauseTaxSvcDetail:string, whereClauseTaxSvcJurDtl:string, whereClauseTaxSvcMessages:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRows_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetByID(taxSvcID:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
Notes:
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetAllActionCodes(epicorHeaders?:Headers){
   ...
   return (new Promise<GetAllActionCodes_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetAllActionCodes", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetAllActionCodes_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetLastDocID(epicorHeaders?:Headers){
   ...
   return (new Promise<GetLastDocID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetLastDocID", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetLastDocID_output)
          })
      .catch((error) => {
          reject(error)
      })
...
This methods will only retrieve today's records.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTaxHistory(requestBody:GetTaxHistory_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTaxHistory_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetTaxHistory", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetTaxHistory_output)
          })
      .catch((error) => {
          reject(error)
      })
...
Updates TaxSvcHead Tax Connect History fields prefixed by TCH
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTaxHistoryByDateRange(requestBody:GetTaxHistoryByDateRange_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTaxHistoryByDateRange_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetTaxHistoryByDateRange", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetTaxHistoryByDateRange_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeofAction(requestBody:OnChangeofAction_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeofAction_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/OnChangeofAction", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as OnChangeofAction_output)
          })
      .catch((error) => {
          reject(error)
      })
...
For Get it uses CalcTaxes and ProcessAndUpdateTaxes methods
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PerformReconciliation(epicorHeaders?:Headers){
   ...
   return (new Promise<PerformReconciliation_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/PerformReconciliation", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as PerformReconciliation_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetHistDates(epicorHeaders?:Headers){
   ...
   return (new Promise<GetHistDates_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetHistDates", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetHistDates_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTaxSvcHead(requestBody:GetNewTaxSvcHead_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTaxSvcHead_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetNewTaxSvcHead", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewTaxSvcHead_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTaxSvcDetail(requestBody:GetNewTaxSvcDetail_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTaxSvcDetail_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetNewTaxSvcDetail", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewTaxSvcDetail_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTaxSvcJurDtl(requestBody:GetNewTaxSvcJurDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTaxSvcJurDtl_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetNewTaxSvcJurDtl", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewTaxSvcJurDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTaxSvcMessages(requestBody:GetNewTaxSvcMessages_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTaxSvcMessages_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetNewTaxSvcMessages", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewTaxSvcMessages_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_DeleteByID(requestBody:DeleteByID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/DeleteByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowIDs_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:Update_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Update_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:UpdateExt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UpdateExt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TaxReconciliationSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface Erp_Tablesets_TaxReconciliationTableset{
...
export interface Erp_Tablesets_UpdExtTaxReconciliationTableset{
   TaxSvcHead:Erp_Tablesets_TaxSvcHeadRow[],
   TaxSvcDetail:Erp_Tablesets_TaxSvcDetailRow[],
   TaxSvcJurDtl:Erp_Tablesets_TaxSvcJurDtlRow[],
   TaxSvcMessages:Erp_Tablesets_TaxSvcMessagesRow[],
...
export interface GetAllActionCodes_output{
   returnObj:string,
parameters : {
      /**  output parameters  */  
   AllResultCodes:string,
}
}
...
export interface GetByID_output{
   returnObj:Erp_Tablesets_TaxReconciliationTableset[],
}
...
export interface GetHistDates_output{
parameters : {
      /**  output parameters  */  
...
export interface GetLastDocID_output{
parameters : {
      /**  output parameters  */  
   lastDocID:number,
}
...
export interface GetNewTaxSvcDetail_input{
   ds:Erp_Tablesets_TaxReconciliationTableset[],
   taxSvcID:string,
}
...
parameters : {
   ...
   /** Required : 
      ...
      @param endDate
   */  
export interface GetTaxHistoryByDateRange_input{
...
export interface GetTaxHistoryByDateRange_output{
parameters : {
      /**  output parameters  */  
   statusFlag:boolean,
   resultCode:string,
   ...
   /** Required : 
      @param lastDocID
   */  
export interface GetTaxHistory_input{
      /**  Used to select TaxSvcHead records.  */  
   lastDocID:number,
}

export interface GetTaxHistory_output{
parameters : {
      /**  output parameters  */  
   statusFlag:boolean,
   resultCode:string,
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface OnChangeofAction_input{
      /**  Action  */  
   action:string,
...
export interface OnChangeofAction_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_TaxReconciliationTableset,
}
...
export interface PerformReconciliation_output{
parameters : {
      /**  output parameters  */  
   statusFlag:boolean,
...
export interface UpdateExt_input{
   ds:Erp_Tablesets_UpdExtTaxReconciliationTableset[],
