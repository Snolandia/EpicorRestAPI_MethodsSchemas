...
export function get_TaxReconciliations(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_TaxReconciliations(requestBody:any, epicorHeaders?:Headers){
...
export function get_TaxReconciliations_Company_TaxSvcID(Company:string, TaxSvcID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TaxReconciliations_Company_TaxSvcID(Company:string, TaxSvcID:string, requestBody:any, epicorHeaders?:Headers){
...
This methods will only retrieve today's records.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTaxHistory(requestBody:any, epicorHeaders?:Headers){
...
Updates TaxSvcHead Tax Connect History fields prefixed by TCH
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTaxHistoryByDateRange(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeofAction(requestBody:any, epicorHeaders?:Headers){
