...
export function get_PcECCs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PcECCs(requestBody:Erp_Tablesets_PcECCOrderDtlRow, epicorHeaders?:Headers){
...
export function get_PcECCs_Company_ECCBSVID(Company:string, ECCBSVID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PcECCs_Company_ECCBSVID(Company:string, ECCBSVID:string, requestBody:Erp_Tablesets_PcECCOrderDtlRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SubmitCIMRequest(requestBody:SubmitCIMRequest_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitCIMRequest_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as SubmitCIMRequest_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_SetKBMaxConfigProdID(requestBody:SetKBMaxConfigProdID_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPcECCOrderDtl(requestBody:GetNewPcECCOrderDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPcECCOrderDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPcECCOrderDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
