...
export function get_COASegBalances(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_COASegBalances(requestBody:Erp_Tablesets_COASegmentRow, epicorHeaders?:Headers){
...
export function get_COASegBalances_Company_COACode_SegmentNbr(Company:string, COACode:string, SegmentNbr:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_COASegBalances_Company_COACode_SegmentNbr(Company:string, COACode:string, SegmentNbr:string, requestBody:Erp_Tablesets_COASegmentRow, epicorHeaders?:Headers){
...
export function post_ComboValue(epicorHeaders?:Headers){
   ...
   return (new Promise<ComboValue_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ComboValue_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeBalancing(requestBody:OnChangeBalancing_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeBalancing_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeBalancing_output)
          })
      .catch((error) => {
          reject(error)
      })
...
Notes:
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeBalancingAcct(requestBody:OnChangeBalancingAcct_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeBalancingAcct_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeBalancingAcct_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeLevel(requestBody:OnChangeLevel_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeLevel_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeLevel_output)
          })
      .catch((error) => {
          reject(error)
      })
...
Notes:
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeOffsetAcct(requestBody:OnChangeOffsetAcct_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeOffsetAcct_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeOffsetAcct_output)
          })
      .catch((error) => {
          reject(error)
      })
