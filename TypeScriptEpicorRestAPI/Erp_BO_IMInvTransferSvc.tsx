...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_SetInvTransfer(requestBody:SetInvTransfer_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SetInvTransfer_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as SetInvTransfer_output)
          })
      .catch((error) => {
          reject(error)
      })
