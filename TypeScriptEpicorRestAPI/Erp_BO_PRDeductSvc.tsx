...
export function get_PRDeducts(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PRDeducts(requestBody:Erp_Tablesets_PRDeductRow, epicorHeaders?:Headers){
...
export function get_PRDeducts_Company_DeductionID(Company:string, DeductionID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PRDeducts_Company_DeductionID(Company:string, DeductionID:string, requestBody:Erp_Tablesets_PRDeductRow, epicorHeaders?:Headers){
...
export function post_GetCodeDescList(requestBody:GetCodeDescList_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPRDeduct(requestBody:GetNewPRDeduct_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPRDeduct_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPRDeduct_output)
          })
      .catch((error) => {
          reject(error)
      })
