...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_CalcSummaryOrdered(requestBody:CalcSummaryOrdered_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CalcSummaryOrdered_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CalcSummaryOrdered_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ProjectCostsHours(requestBody:ProjectCostsHours_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ProjectCostsHours_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ProjectCostsHours_output)
          })
      .catch((error) => {
          reject(error)
      })
