...
export function get_MrpProcQueues(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_MrpProcQueues(requestBody:Erp_Tablesets_MrpProcQueueRow, epicorHeaders?:Headers){
...
export function get_MrpProcQueues_Company_ProcessType_GroupID_ProcessName_Queue(Company:string, ProcessType:string, GroupID:string, ProcessName:string, Queue:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_MrpProcQueues_Company_ProcessType_GroupID_ProcessName_Queue(Company:string, ProcessType:string, GroupID:string, ProcessName:string, Queue:string, requestBody:Erp_Tablesets_MrpProcQueueRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeGroupID(requestBody:ChangeGroupID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeGroupID_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ChangeGroupID_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewMrpProcQueue(requestBody:GetNewMrpProcQueue_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewMrpProcQueue_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewMrpProcQueue_output)
          })
      .catch((error) => {
          reject(error)
      })
