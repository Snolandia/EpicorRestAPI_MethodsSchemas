...
export function get_FAssetRegs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_FAssetRegs(requestBody:Erp_Tablesets_FAssetRegRow, epicorHeaders?:Headers){
...
export function get_FAssetRegs_Company_AssetRegID(Company:string, AssetRegID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FAssetRegs_Company_AssetRegID(Company:string, AssetRegID:string, requestBody:Erp_Tablesets_FAssetRegRow, epicorHeaders?:Headers){
...
export function post_OnChangeCalendarID(requestBody:OnChangeCalendarID_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFAssetReg(requestBody:GetNewFAssetReg_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewFAssetReg_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewFAssetReg_output)
          })
      .catch((error) => {
          reject(error)
      })
