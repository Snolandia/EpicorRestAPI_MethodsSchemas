...
export function get_TranGLCJournals(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_TranGLCJournals(requestBody:Erp_Tablesets_TranGLCDtlRow, epicorHeaders?:Headers){
...
export function get_TranGLCJournals_SysRowID(SysRowID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TranGLCJournals_SysRowID(SysRowID:string, requestBody:Erp_Tablesets_TranGLCDtlRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTranGLCDtl(requestBody:GetTranGLCDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTranGLCDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetTranGLCDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTranGLCDtlSite(requestBody:GetTranGLCDtlSite_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTranGLCDtlSite_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetTranGLCDtlSite_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTranGLCDtl(requestBody:GetNewTranGLCDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTranGLCDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewTranGLCDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
