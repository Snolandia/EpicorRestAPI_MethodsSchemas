...
export function get_PkgCtrlOverlayPCIDValidates(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PkgCtrlOverlayPCIDValidates(requestBody:Erp_Tablesets_PkgControlHeaderRow, epicorHeaders?:Headers){
...
export function get_PkgCtrlOverlayPCIDValidates_Company_PCID(Company:string, PCID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PkgCtrlOverlayPCIDValidates_Company_PCID(Company:string, PCID:string, requestBody:Erp_Tablesets_PkgControlHeaderRow, epicorHeaders?:Headers){
...
export function post_ValidatePCID(requestBody:ValidatePCID_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ValidateOverlayPCID(requestBody:ValidateOverlayPCID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ValidateOverlayPCID_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ValidateOverlayPCID_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OverlayPCIDValidationProcess(requestBody:OverlayPCIDValidationProcess_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OverlayPCIDValidationProcess_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OverlayPCIDValidationProcess_output)
          })
      .catch((error) => {
          reject(error)
      })
