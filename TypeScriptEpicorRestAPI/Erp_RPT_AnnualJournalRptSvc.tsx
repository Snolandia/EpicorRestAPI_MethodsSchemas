...
export function post_GetApplicationDefaults(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_NatAccSegChanged(requestBody:any, epicorHeaders?:Headers){
...
export function post_OnChangeBookID(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeNatAccSeg(requestBody:any, epicorHeaders?:Headers){
