...
/** 
// Title: Erp.RPT.AnnualJournalRptSvc
// Description: 
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetApplicationDefaults(requestBody:GetApplicationDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetApplicationDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/GetApplicationDefaults", {
          method: 'post',
          headers: headers,
   ...
   /**  
   Summary: Invoke method NatAccSegChanged
   Description: Save Natural Account parameters values so they can be shared with other reports.
   OperationID: NatAccSegChanged
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/NatAccSegChanged_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/NatAccSegChanged_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_NatAccSegChanged(requestBody:NatAccSegChanged_input, epicorHeaders?:Headers){
   ...
   return (new Promise<NatAccSegChanged_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/NatAccSegChanged", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as NatAccSegChanged_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Description: Natural Account Segment validation.
...
export function post_OnChangeBookID(requestBody:OnChangeBookID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeBookID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/OnChangeBookID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   /**  
   Summary: Invoke method OnChangeNatAccSeg
   Description: Natural Account Segment validation.
   OperationID: OnChangeNatAccSeg
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/OnChangeNatAccSeg_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/OnChangeNatAccSeg_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeNatAccSeg(requestBody:OnChangeNatAccSeg_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeNatAccSeg_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/OnChangeNatAccSeg", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as OnChangeNatAccSeg_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Description: Notes: Get Journal Codes list
...
export function post_GetJournalCodes(epicorHeaders?:Headers){
   ...
   return (new Promise<GetJournalCodes_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/GetJournalCodes", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.AnnualJournalRptSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_AnnualJournalParamsRow{
      /**  Book ID  */  
   BookID:string,
      /**  Fiscal Year  */  
   FiscalYear:number,
   ...
   EndFiscalPeriod:number,
      /**  Natutal Account From  */  
   NatAccFrom:string,
      /**  Natutal Account To  */  
   NatAccTo:string,
      /**  COA Code of the Main Book.  */  
   COACode:string,
   FiscalCalendarID:string,
   PrintSelCriteria:boolean,
      /**  Include Unposted Transactions  */  
   IncUnposted:boolean,
      /**  Select by 'F' - Fiscal Period, 'D' - Date  */  
   ReportOption:string,
      /**  Starting Date  */  
   StartDate:string,
      /**  Ending Date  */  
   EndDate:string,
      /**  Selected Journal Codes list  */  
   JournalCodeList:string,
   StartDateToken:string,
   EndDateToken:string,
      /**  Available Journal Codes list  */  
   JournalCodesAvailable:string,
      /**  Natural Account From Name  */  
   NatAccFromName:string,
      /**  Natural Account To Name  */  
   NatAccToName:string,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_AnnualJournalRptTableset{
   AnnualJournalParams:Erp_Tablesets_AnnualJournalParamsRow[],
...
export interface GetApplicationDefaults_input{
   ds:Erp_Tablesets_AnnualJournalRptTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_AnnualJournalRptTableset[],
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      @param ds
   */  
export interface NatAccSegChanged_input{
   ds:Erp_Tablesets_AnnualJournalRptTableset[],
}

export interface NatAccSegChanged_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_AnnualJournalRptTableset,
}
...
export interface OnChangeBookID_input{
   ds:Erp_Tablesets_AnnualJournalRptTableset[],
      /**  Proposed Natural Account Segment.  */  
   ipBookID:string,
}
...
parameters : {
   ...
   /** Required : 
      ...
      @param ipNatAccount
   */  
export interface OnChangeNatAccSeg_input{
      /**  COA Code  */  
   coaCode:string,
      /**  Proposed Natural Account Segment.  */  
   ipNatAccount:string,
...
export interface OnChangeNatAccSeg_output{
}
