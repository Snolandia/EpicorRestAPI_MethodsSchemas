...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_ChangeBookID(requestBody:ChangeBookID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeBookID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/ChangeBookID", {
          method: 'post',
          headers: headers,
   ...
   Description: This method will blank fiscal year and suffix when the calendar changes.
...
export function post_ChangeFiscalCalendarID(requestBody:ChangeFiscalCalendarID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeFiscalCalendarID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/ChangeFiscalCalendarID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   /**  
   Summary: Invoke method ChangePurgeOption
   Description: This method will blank Book/CalendarID when Purge mode is changed
   OperationID: ChangePurgeOption
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ChangePurgeOption_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ChangePurgeOption_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangePurgeOption(requestBody:ChangePurgeOption_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangePurgeOption_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/ChangePurgeOption", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ChangePurgeOption_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Description: Call this method to get the text to use for prompting the user for okay to
purge the gl hist for the fiscal year entered.
...
export function post_CheckFiscalyear(requestBody:CheckFiscalyear_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckFiscalyear_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/CheckFiscalyear", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PurgeGLHistSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface ChangeBookID_input{
      /**  The Book ID  */  
   cBookID:string,
   ds:Erp_Tablesets_PurgeGLHistTableset[],
}
...
parameters : {
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface ChangePurgeOption_input{
   cPurgeMode:string,
   ds:Erp_Tablesets_PurgeGLHistTableset[],
}

export interface ChangePurgeOption_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_PurgeGLHistTableset,
}
...
export interface CheckFiscalyear_input{
   ...
   fiscalYearIN:number,
      /**  fiscalYearSuffixIN  */  
   fiscalYearSuffixIN:string,
      /**  purgeOptionIN  */  
   purgeOptionIN:string,
}
...
export interface Erp_Tablesets_PurgeGLHistParamRow{
   Company:string,
   FiscalYear:number,
   PurgeOption:string,
   BookID:string,
...
export interface Erp_Tablesets_PurgeGLHistTableset{
   PurgeGLHistParam:Erp_Tablesets_PurgeGLHistParamRow[],
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_PurgeGLHistTableset[],
}
