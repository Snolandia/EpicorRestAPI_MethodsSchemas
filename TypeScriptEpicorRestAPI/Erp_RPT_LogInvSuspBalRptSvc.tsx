...
/** 
// Title: Erp.RPT.LogInvSuspBalRptSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   Description: Purpose:
Parameters:
<param name="ipFiscalYear">fiscal year</param><param name="ds">Logged Invoice Suspense Report DataSet </param>
...
export function post_ChangeFiscalYear(requestBody:ChangeFiscalYear_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeFiscalYear_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/ChangeFiscalYear", {
          method: 'post',
          headers: headers,
   ...
   /**  
   Summary: Invoke method ChangeSelectBy
   Description: Purpose:
Parameters:
<param name="ipSelectBy">Select by option</param><param name="ds">Logged Invoice Suspense Report DataSet </param>
   OperationID: ChangeSelectBy
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ChangeSelectBy_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ChangeSelectBy_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeSelectBy(requestBody:ChangeSelectBy_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeSelectBy_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/ChangeSelectBy", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ChangeSelectBy_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Description: This method returns a list of 'sortBy' codes and descriptions
...
export function post_GetSortBy(epicorHeaders?:Headers){
   ...
   return (new Promise<GetSortBy_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/GetSortBy", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
   ...
   /**  
   Summary: Invoke method getCurrentPeriod
   OperationID: getCurrentPeriod
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/getCurrentPeriod_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/getCurrentPeriod_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getCurrentPeriod(requestBody:getCurrentPeriod_input, epicorHeaders?:Headers){
   ...
   return (new Promise<getCurrentPeriod_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/getCurrentPeriod", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as getCurrentPeriod_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.LogInvSuspBalRptSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface ChangeFiscalYear_input{
   ipFiscalYear:number,
   ds:Erp_Tablesets_LogInvSuspBalRptTableset[],
}
...
parameters : {
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface ChangeSelectBy_input{
   ipSelectBy:string,
   ds:Erp_Tablesets_LogInvSuspBalRptTableset[],
}

export interface ChangeSelectBy_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_LogInvSuspBalRptTableset,
}
...
export interface Erp_Tablesets_LogInvSuspBalRptParamRow{
   FiscalYear:number,
   FiscalPeriod:number,
      /**  Valid values "Date" and "Period".  */  
   SelectBy:string,
   VendList:string,
   SummaryOnly:boolean,
   SortBy:string,
   CutOffDate:string,
   CutOffDateToken:string,
   CurrencyCode:string,
...
export interface Erp_Tablesets_LogInvSuspBalRptTableset{
   LogInvSuspBalRptParam:Erp_Tablesets_LogInvSuspBalRptParamRow[],
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_LogInvSuspBalRptTableset[],
}
...
export interface SubmitToAgent_output{
   ...
   /** Required : 
      @param iFiscalYear
   */  
export interface getCurrentPeriod_input{
   iFiscalYear:number,
}

export interface getCurrentPeriod_output{
   returnObj:number,
}
