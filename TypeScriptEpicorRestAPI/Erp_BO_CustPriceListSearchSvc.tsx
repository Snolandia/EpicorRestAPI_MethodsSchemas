...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_GetLineShipToWhse(requestBody:GetLineShipToWhse_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetLineShipToWhse_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetLineShipToWhse_output)
          })
      .catch((error) => {
          reject(error)
      })
