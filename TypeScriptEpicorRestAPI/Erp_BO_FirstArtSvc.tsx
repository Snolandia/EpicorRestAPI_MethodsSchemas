...
export function get_FirstArts(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_FirstArts(requestBody:any, epicorHeaders?:Headers){
...
export function get_FirstArts_Company_JobNum_AssemblySeq_OprSeq_ResourceID_SeqNum(Company:string, JobNum:string, AssemblySeq:string, OprSeq:string, ResourceID:string, SeqNum:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FirstArts_Company_JobNum_AssemblySeq_OprSeq_ResourceID_SeqNum(Company:string, JobNum:string, AssemblySeq:string, OprSeq:string, ResourceID:string, SeqNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_FirstArtAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_FirstArtAttches(requestBody:any, epicorHeaders?:Headers){
...
export function get_FirstArtAttches_Company_JobNum_AssemblySeq_OprSeq_ResourceID_SeqNum_DrawingSeq(Company:string, JobNum:string, AssemblySeq:string, OprSeq:string, ResourceID:string, SeqNum:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FirstArtAttches_Company_JobNum_AssemblySeq_OprSeq_ResourceID_SeqNum_DrawingSeq(Company:string, JobNum:string, AssemblySeq:string, OprSeq:string, ResourceID:string, SeqNum:string, DrawingSeq:string, requestBody:any, epicorHeaders?:Headers){
...
dataset of the history of related inspections.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetHistory(requestBody:any, epicorHeaders?:Headers){
...
export function post_GetCodeDescList(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFirstArt(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFirstArtAttch(requestBody:any, epicorHeaders?:Headers){
