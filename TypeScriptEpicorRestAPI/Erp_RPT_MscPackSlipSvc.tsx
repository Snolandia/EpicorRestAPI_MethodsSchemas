...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MscPackSlipSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MscPackSlipSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_MscPackSlipParamRow{
   PackNum:number,
...
export interface Erp_Tablesets_MscPackSlipTableset{
   MscPackSlipParam:Erp_Tablesets_MscPackSlipParamRow[],
...
export interface GetNewParametersAndDefaults_output{
   returnObj:Erp_Tablesets_MscPackSlipTableset[],
}
