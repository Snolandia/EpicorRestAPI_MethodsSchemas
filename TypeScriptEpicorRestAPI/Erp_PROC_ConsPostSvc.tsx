...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method ChangeOfEnableLogFile
   Description: Returns the default log file name when changing the log file option.
   OperationID: ChangeOfEnableLogFile
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ChangeOfEnableLogFile_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ChangeOfEnableLogFile_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeOfEnableLogFile(requestBody:ChangeOfEnableLogFile_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeOfEnableLogFile_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/ChangeOfEnableLogFile", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as ChangeOfEnableLogFile_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetConsolidationValues
   OperationID: GetConsolidationValues
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetConsolidationValues_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetConsolidationValues_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetConsolidationValues(requestBody:GetConsolidationValues_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetConsolidationValues_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/GetConsolidationValues", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetConsolidationValues_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method ChangeOfLogFileName
   Description: This method will validate if the entered filename already exists on the server.
   OperationID: ChangeOfLogFileName
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ChangeOfLogFileName_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ChangeOfLogFileName_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeOfLogFileName(requestBody:ChangeOfLogFileName_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeOfLogFileName_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/ChangeOfLogFileName", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ChangeOfLogFileName_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetConsSrcCtrlValues
   OperationID: GetConsSrcCtrlValues
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetConsSrcCtrlValues_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetConsSrcCtrlValues_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetConsSrcCtrlValues(requestBody:GetConsSrcCtrlValues_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetConsSrcCtrlValues_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/GetConsSrcCtrlValues", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetConsSrcCtrlValues_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetConsolidationStatus
   Description: Gets the consolidation status
   OperationID: GetConsolidationStatus
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetConsolidationStatus_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetConsolidationStatus_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetConsolidationStatus(requestBody:GetConsolidationStatus_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetConsolidationStatus_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/GetConsolidationStatus", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetConsolidationStatus_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method ValidateSourceBook
   OperationID: ValidateSourceBook
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ValidateSourceBook_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ValidateSourceBook_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ValidateSourceBook(requestBody:ValidateSourceBook_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ValidateSourceBook_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/ValidateSourceBook", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ValidateSourceBook_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Description: Checks if the consolidation is ready to be posted
...
export function post_CheckConsReadyToPost(requestBody:CheckConsReadyToPost_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckConsReadyToPost_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/CheckConsReadyToPost", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Description: Validates the Generation ID
...
export function post_ValidateGenID(requestBody:ValidateGenID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ValidateGenID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/ValidateGenID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsPostSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
//////////////////////////////////////////////////////////////////////////
   /** Required : 
      @param proposedEnableLogFile
      @param consPostTableSet
   */  
export interface ChangeOfEnableLogFile_input{
      /**  Proposed value for EnableLogFile.  */  
   proposedEnableLogFile:boolean,
   consPostTableSet:Erp_Tablesets_ConsPostTableset[],
}

export interface ChangeOfEnableLogFile_output{
parameters : {
      /**  output parameters  */  
   consPostTableSet:Erp_Tablesets_ConsPostTableset,
}
   ...
   */  
export interface ChangeOfLogFileName_input{
   proposedFileName:string,
}

export interface ChangeOfLogFileName_output{
   returnObj:boolean,
}
...
export interface Erp_Tablesets_ConsPostParamRow{
      /**  Consolidation Genereate ID  */  
   GenID:number,
   ...
   TgtBook:string,
      /**  Source GL Book Descrption  */  
   SrcBookDescrip:string,
      /**  Target GL Book Description  */  
   TgtBookDescrip:string,
   ...
   Company:string,
   ReadOnly:boolean,
      /**  The path and name of the file to be used to write the log of the process  */  
   LogFilename:string,
...
O - Overriding Period  */  
   ...
   EnableLogFile:boolean,
      /**  This will be the relative path to be displayed to the user in the UI.  */  
...
export interface Erp_Tablesets_ConsPostTableset{
   ConsPostParam:Erp_Tablesets_ConsPostParamRow[],
   ...
   /** Required : 
      @param ds
   */  
export interface GetConsSrcCtrlValues_input{
   ds:Erp_Tablesets_ConsPostTableset[],
}

export interface GetConsSrcCtrlValues_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_ConsPostTableset,
}
   ...
   /** Required : 
      @param ds
   */  
export interface GetConsolidationStatus_input{
   ds:Erp_Tablesets_ConsPostTableset[],
}

export interface GetConsolidationStatus_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_ConsPostTableset,
}
   ...
   /** Required : 
      @param ds
   */  
export interface GetConsolidationValues_input{
   ds:Erp_Tablesets_ConsPostTableset[],
}

export interface GetConsolidationValues_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_ConsPostTableset,
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_ConsPostTableset[],
}
...
export interface ValidateGenID_output{
   ...
   /** Required : 
      ...
      @param txtSourceBook
   */  
export interface ValidateSourceBook_input{
   intGenID:number,
   txtSourceBook:string,
}

export interface ValidateSourceBook_output{
}
