...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_AckShipDtl(requestBody:AckShipDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<AckShipDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as AckShipDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CountShipDtl(requestBody:CountShipDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CountShipDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CountShipDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetShipDtl(requestBody:GetShipDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetShipDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetShipDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetAllShipDtl(requestBody:GetAllShipDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetAllShipDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetAllShipDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
