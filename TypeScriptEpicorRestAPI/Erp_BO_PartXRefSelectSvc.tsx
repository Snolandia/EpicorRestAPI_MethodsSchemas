...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_GetXRefParts(requestBody:GetXRefParts_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetXRefParts_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetXRefParts_output)
          })
      .catch((error) => {
          reject(error)
      })
