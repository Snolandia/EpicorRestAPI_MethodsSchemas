...
export function get_NCChgLogs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_NCChgLogs(requestBody:Ice_Tablesets_NCChgLogRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewNCChgLog(requestBody:GetNewNCChgLog_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewNCChgLog_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewNCChgLog_output)
          })
      .catch((error) => {
          reject(error)
      })
