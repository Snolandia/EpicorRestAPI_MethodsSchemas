...
No maintenance is allowed in this object so there is only this one method.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetSupplyDemand(requestBody:GetSupplyDemand_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetSupplyDemand_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetSupplyDemand_output)
          })
      .catch((error) => {
          reject(error)
      })
