...
export function get_FATranSearches(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_FATranSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_FATranSearches_Company_AssetNum_AssetRegID_DetailNum(Company:string, AssetNum:string, AssetRegID:string, DetailNum:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FATranSearches_Company_AssetNum_AssetRegID_DetailNum(Company:string, AssetNum:string, AssetRegID:string, DetailNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_FATrans(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_FATrans(requestBody:any, epicorHeaders?:Headers){
...
export function get_FATrans_Company_AssetNum_AssetRegID_DetailNum_SeqNum(Company:string, AssetNum:string, AssetRegID:string, DetailNum:string, SeqNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FATrans_Company_AssetNum_AssetRegID_DetailNum_SeqNum(Company:string, AssetNum:string, AssetRegID:string, DetailNum:string, SeqNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetSortedFASchedules(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFASchedule(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFATran(requestBody:any, epicorHeaders?:Headers){
