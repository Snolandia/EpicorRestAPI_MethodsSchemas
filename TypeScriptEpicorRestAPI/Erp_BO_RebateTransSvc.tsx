...
export function get_RebateTrans(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_RebateTrans(requestBody:Erp_Tablesets_RebateTransRow, epicorHeaders?:Headers){
...
export function get_RebateTrans_Company_RebateID_LineNum_CustNum_TranNum(Company:string, RebateID:string, LineNum:string, CustNum:string, TranNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_RebateTrans_Company_RebateID_LineNum_CustNum_TranNum(Company:string, RebateID:string, LineNum:string, CustNum:string, TranNum:string, requestBody:Erp_Tablesets_RebateTransRow, epicorHeaders?:Headers){
...
from an external comma delimited file.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ImportRebateTrans(requestBody:ImportRebateTrans_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ImportRebateTrans_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ImportRebateTrans_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_ImportFile(requestBody:ImportFile_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewRebateTrans(requestBody:GetNewRebateTrans_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewRebateTrans_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewRebateTrans_output)
          })
      .catch((error) => {
          reject(error)
      })
