...
export function get_GLBCOASegmentSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GLBCOASegmentSearches(requestBody:Erp_Tablesets_GLBCOASegmentSearchRow, epicorHeaders?:Headers){
...
export function get_GLBCOASegmentSearches_Company_ExtCompanyID_COACode_SegmentNbr(Company:string, ExtCompanyID:string, COACode:string, SegmentNbr:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GLBCOASegmentSearches_Company_ExtCompanyID_COACode_SegmentNbr(Company:string, ExtCompanyID:string, COACode:string, SegmentNbr:string, requestBody:Erp_Tablesets_GLBCOASegmentSearchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGLBCOASegmentSearch(requestBody:GetNewGLBCOASegmentSearch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGLBCOASegmentSearch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGLBCOASegmentSearch_output)
          })
      .catch((error) => {
          reject(error)
      })
