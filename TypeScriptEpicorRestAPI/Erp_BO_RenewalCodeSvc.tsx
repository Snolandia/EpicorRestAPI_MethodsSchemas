...
export function get_RenewalCodes(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_RenewalCodes(requestBody:Erp_Tablesets_RenewalCodeRow, epicorHeaders?:Headers){
...
export function get_RenewalCodes_Company_RenewalCode1(Company:string, RenewalCode1:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_RenewalCodes_Company_RenewalCode1(Company:string, RenewalCode1:string, requestBody:Erp_Tablesets_RenewalCodeRow, epicorHeaders?:Headers){
...
export function get_RenewalCodeAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_RenewalCodeAttches(requestBody:Erp_Tablesets_RenewalCodeAttchRow, epicorHeaders?:Headers){
...
export function get_RenewalCodeAttches_Company_RenewalCode_DrawingSeq(Company:string, RenewalCode:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_RenewalCodeAttches_Company_RenewalCode_DrawingSeq(Company:string, RenewalCode:string, DrawingSeq:string, requestBody:Erp_Tablesets_RenewalCodeAttchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeOfIncreaseMeth(requestBody:OnChangeOfIncreaseMeth_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeOfIncreaseMeth_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeOfIncreaseMeth_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeOfQuoted(requestBody:OnChangeOfQuoted_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeOfQuoted_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeOfQuoted_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ValidatePriceList(requestBody:ValidatePriceList_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ValidatePriceList_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ValidatePriceList_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_ValidateTaskSet(requestBody:ValidateTaskSet_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewRenewalCode(requestBody:GetNewRenewalCode_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewRenewalCode_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewRenewalCode_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewRenewalCodeAttch(requestBody:GetNewRenewalCodeAttch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewRenewalCodeAttch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewRenewalCodeAttch_output)
          })
      .catch((error) => {
          reject(error)
      })
