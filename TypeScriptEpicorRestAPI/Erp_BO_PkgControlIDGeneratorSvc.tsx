...
export function get_PkgControlIDGenerators(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PkgControlIDGenerators(requestBody:Erp_Tablesets_PkgControlIDGeneratorRow, epicorHeaders?:Headers){
...
export function get_PkgControlIDGenerators_PkgControlIDCode(PkgControlIDCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PkgControlIDGenerators_PkgControlIDCode(PkgControlIDCode:string, requestBody:Erp_Tablesets_PkgControlIDGeneratorRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPkgControlIDGenerator(requestBody:GetNewPkgControlIDGenerator_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPkgControlIDGenerator_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPkgControlIDGenerator_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GenerateButton(requestBody:GenerateButton_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GenerateButton_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GenerateButton_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_ChangePkgControlIDCode(requestBody:ChangePkgControlIDCode_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangePkgControlIDType(requestBody:ChangePkgControlIDType_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangePkgControlIDType_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ChangePkgControlIDType_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangePkgCode(requestBody:ChangePkgCode_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangePkgCode_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ChangePkgCode_output)
          })
      .catch((error) => {
          reject(error)
      })
