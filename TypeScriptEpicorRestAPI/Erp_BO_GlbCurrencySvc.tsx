...
export function get_GlbCurrencies(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GlbCurrencies(requestBody:Erp_Tablesets_GlbCurrencyRow, epicorHeaders?:Headers){
...
export function get_GlbCurrencies_Company_GlbCompany_GlbCurrencyCode(Company:string, GlbCompany:string, GlbCurrencyCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GlbCurrencies_Company_GlbCompany_GlbCurrencyCode(Company:string, GlbCompany:string, GlbCurrencyCode:string, requestBody:Erp_Tablesets_GlbCurrencyRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGlbCurrency(requestBody:GetNewGlbCurrency_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGlbCurrency_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGlbCurrency_output)
          })
      .catch((error) => {
          reject(error)
      })
