...
export function get_GLCOARefTypes(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GLCOARefTypes(requestBody:Erp_Tablesets_GLCOARefTypeRow, epicorHeaders?:Headers){
...
export function get_GLCOARefTypes_Company_COACode_SegmentNbr_RefType(Company:string, COACode:string, SegmentNbr:string, RefType:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GLCOARefTypes_Company_COACode_SegmentNbr_RefType(Company:string, COACode:string, SegmentNbr:string, RefType:string, requestBody:Erp_Tablesets_GLCOARefTypeRow, epicorHeaders?:Headers){
...
export function get_GLCOARefAccts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GLCOARefAccts(requestBody:Erp_Tablesets_GLCOARefAcctRow, epicorHeaders?:Headers){
...
export function get_GLCOARefAccts_Company_COACode_SegmentNbr_RefType_GLAccount(Company:string, COACode:string, SegmentNbr:string, RefType:string, GLAccount:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GLCOARefAccts_Company_COACode_SegmentNbr_RefType_GLAccount(Company:string, COACode:string, SegmentNbr:string, RefType:string, GLAccount:string, requestBody:Erp_Tablesets_GLCOARefAcctRow, epicorHeaders?:Headers){
...
export function post_DefaultCOACodeSegments(epicorHeaders?:Headers){
   ...
   return (new Promise<DefaultCOACodeSegments_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as DefaultCOACodeSegments_output)
          })
      .catch((error) => {
          reject(error)
      })
...
<param name="coaCode">COA</param><param name="segmentNbr">Segment Number to set combo box</param><param name="segmentName">Segment Name to display in the combo box</param>
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_DefaultFirstCOARefSegment(requestBody:DefaultFirstCOARefSegment_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DefaultFirstCOARefSegment_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as DefaultFirstCOARefSegment_output)
          })
      .catch((error) => {
          reject(error)
      })
...
Notes:
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_LookForRefEntities(requestBody:LookForRefEntities_input, epicorHeaders?:Headers){
   ...
   return (new Promise<LookForRefEntities_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as LookForRefEntities_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ValidateSegmentNbr(requestBody:ValidateSegmentNbr_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ValidateSegmentNbr_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ValidateSegmentNbr_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGLCOARefType(requestBody:GetNewGLCOARefType_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGLCOARefType_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGLCOARefType_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGLCOARefAcct(requestBody:GetNewGLCOARefAcct_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGLCOARefAcct_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGLCOARefAcct_output)
          })
      .catch((error) => {
          reject(error)
      })
