...
export function get_CreditCardProcs(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_CreditCardProcs(requestBody:Erp_Tablesets_CreditCardProcRow, epicorHeaders?:Headers){
...
export function get_CreditCardProcs_Company(Company:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_CreditCardProcs_Company(Company:string, requestBody:Erp_Tablesets_CreditCardProcRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeProcessor(requestBody:OnChangeProcessor_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeProcessor_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeProcessor_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_HasPendingAuthorizations(epicorHeaders?:Headers){
   ...
   return (new Promise<HasPendingAuthorizations_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as HasPendingAuthorizations_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_HasProcessorPendingAuthorizations(requestBody:HasProcessorPendingAuthorizations_input, epicorHeaders?:Headers){
   ...
   return (new Promise<HasProcessorPendingAuthorizations_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as HasProcessorPendingAuthorizations_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewCreditCardProc(requestBody:GetNewCreditCardProc_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewCreditCardProc_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewCreditCardProc_output)
          })
      .catch((error) => {
          reject(error)
      })
