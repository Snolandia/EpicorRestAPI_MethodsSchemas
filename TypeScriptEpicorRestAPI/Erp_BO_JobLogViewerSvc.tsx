...
export function get_JobLogViewers(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_JobLogViewers(requestBody:Erp_Tablesets_JobLogViewerHdrRow, epicorHeaders?:Headers){
...
export function get_JobLogViewers_Company_LogNum(Company:string, LogNum:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_JobLogViewers_Company_LogNum(Company:string, LogNum:string, requestBody:Erp_Tablesets_JobLogViewerHdrRow, epicorHeaders?:Headers){
...
export function get_JobLogViewerDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_JobLogViewerDtls(requestBody:Erp_Tablesets_JobLogViewerDtlRow, epicorHeaders?:Headers){
...
export function get_JobLogViewerDtls_Company_LogNum_JobNum(Company:string, LogNum:string, JobNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_JobLogViewerDtls_Company_LogNum_JobNum(Company:string, LogNum:string, JobNum:string, requestBody:Erp_Tablesets_JobLogViewerDtlRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetDetailLogInfo(requestBody:GetDetailLogInfo_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDetailLogInfo_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetDetailLogInfo_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetExportLog(requestBody:GetExportLog_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetExportLog_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetExportLog_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_ImportLog(requestBody:ImportLog_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewJobLogViewerHdr(requestBody:GetNewJobLogViewerHdr_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewJobLogViewerHdr_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewJobLogViewerHdr_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewJobLogViewerDtl(requestBody:GetNewJobLogViewerDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewJobLogViewerDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewJobLogViewerDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
