...
export function get_AlcHedTgtStampSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_AlcHedTgtStampSearches(requestBody:Erp_Tablesets_AlcHedTgtStampSearchRow, epicorHeaders?:Headers){
...
export function get_AlcHedTgtStampSearches_Company_AllocID(Company:string, AllocID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_AlcHedTgtStampSearches_Company_AllocID(Company:string, AllocID:string, requestBody:Erp_Tablesets_AlcHedTgtStampSearchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAlcHedTgtStampSearch(requestBody:GetNewAlcHedTgtStampSearch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewAlcHedTgtStampSearch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewAlcHedTgtStampSearch_output)
          })
      .catch((error) => {
          reject(error)
      })
