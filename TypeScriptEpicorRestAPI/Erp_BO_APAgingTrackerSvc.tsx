...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_GenerateTrackerAgingSite(requestBody:GenerateTrackerAgingSite_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GenerateTrackerAgingSite_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GenerateTrackerAgingSite_output)
          })
      .catch((error) => {
          reject(error)
      })
