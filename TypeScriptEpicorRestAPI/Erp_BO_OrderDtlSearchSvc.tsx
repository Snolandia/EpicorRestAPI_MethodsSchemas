...
export function get_OrderDtlSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_OrderDtlSearches(requestBody:Erp_Tablesets_OrderDtlRow, epicorHeaders?:Headers){
...
export function get_OrderDtlSearches_Company_OrderNum_OrderLine(Company:string, OrderNum:string, OrderLine:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_OrderDtlSearches_Company_OrderNum_OrderLine(Company:string, OrderNum:string, OrderLine:string, requestBody:Erp_Tablesets_OrderDtlRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getBreakListCodeDesc(requestBody:getBreakListCodeDesc_input, epicorHeaders?:Headers){
   ...
   return (new Promise<getBreakListCodeDesc_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as getBreakListCodeDesc_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetRowsContactTracker(requestBody:GetRowsContactTracker_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetRowsCustomerActivity(requestBody:GetRowsCustomerActivity_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRowsCustomerActivity_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetRowsCustomerActivity_output)
          })
      .catch((error) => {
          reject(error)
      })
