...
export function get_LockboxLayouts(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_LockboxLayouts(requestBody:Erp_Tablesets_LockboxLayoutHeadRow, epicorHeaders?:Headers){
...
export function get_LockboxLayouts_Company_LayoutID(Company:string, LayoutID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_LockboxLayouts_Company_LayoutID(Company:string, LayoutID:string, requestBody:Erp_Tablesets_LockboxLayoutHeadRow, epicorHeaders?:Headers){
...
export function get_LockboxLayoutDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_LockboxLayoutDtls(requestBody:Erp_Tablesets_LockboxLayoutDtlRow, epicorHeaders?:Headers){
...
export function get_LockboxLayoutDtls_Company_LayoutID_RecordTypeID_FieldID(Company:string, LayoutID:string, RecordTypeID:string, FieldID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_LockboxLayoutDtls_Company_LayoutID_RecordTypeID_FieldID(Company:string, LayoutID:string, RecordTypeID:string, FieldID:string, requestBody:Erp_Tablesets_LockboxLayoutDtlRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnReadyToUseChange(requestBody:OnReadyToUseChange_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnReadyToUseChange_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnReadyToUseChange_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewLockboxLayoutHead(requestBody:GetNewLockboxLayoutHead_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewLockboxLayoutHead_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewLockboxLayoutHead_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewLockboxLayoutDtl(requestBody:GetNewLockboxLayoutDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewLockboxLayoutDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewLockboxLayoutDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
