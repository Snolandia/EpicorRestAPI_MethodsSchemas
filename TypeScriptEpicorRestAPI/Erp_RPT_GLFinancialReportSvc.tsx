...
export function post_GetApplicationDefaults(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeBalanceLevel(requestBody:any, epicorHeaders?:Headers){
...
export function post_getReportFormatList(epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetReportFormatListForCOACode(requestBody:any, epicorHeaders?:Headers){
