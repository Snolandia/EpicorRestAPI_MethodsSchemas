...
export function get_MrpQueues(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_MrpQueues(requestBody:any, epicorHeaders?:Headers){
...
export function get_MrpQueues_Company_ProcessType_Name(Company:string, ProcessType:string, Name:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_MrpQueues_Company_ProcessType_Name(Company:string, ProcessType:string, Name:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewMrpQueue(requestBody:any, epicorHeaders?:Headers){
