...
export function get_PlantCosts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PlantCosts(requestBody:Erp_Tablesets_PlantCostRow, epicorHeaders?:Headers){
...
export function get_PlantCosts_Company_PlantCostID(Company:string, PlantCostID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PlantCosts_Company_PlantCostID(Company:string, PlantCostID:string, requestBody:Erp_Tablesets_PlantCostRow, epicorHeaders?:Headers){
...
saves the record but before the Update method is called.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PreUpdatePlantCost(requestBody:PreUpdatePlantCost_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PreUpdatePlantCost_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as PreUpdatePlantCost_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPlantCost(requestBody:GetNewPlantCost_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPlantCost_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPlantCost_output)
          })
      .catch((error) => {
          reject(error)
      })
