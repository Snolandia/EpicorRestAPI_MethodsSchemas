...
export function get_ABCCodes(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ABCCodes(requestBody:Erp_Tablesets_ABCCodeRow, epicorHeaders?:Headers){
...
export function get_ABCCodes_Company_ABCCode1(Company:string, ABCCode1:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ABCCodes_Company_ABCCode1(Company:string, ABCCode1:string, requestBody:Erp_Tablesets_ABCCodeRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewABCCode(requestBody:GetNewABCCode_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewABCCode_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewABCCode_output)
          })
      .catch((error) => {
          reject(error)
      })
