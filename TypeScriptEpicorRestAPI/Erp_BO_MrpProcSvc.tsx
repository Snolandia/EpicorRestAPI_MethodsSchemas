...
export function get_MrpProcs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_MrpProcs(requestBody:Erp_Tablesets_MrpProcRow, epicorHeaders?:Headers){
...
export function get_MrpProcs_Company_ProcessType_ProcessName(Company:string, ProcessType:string, ProcessName:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_MrpProcs_Company_ProcessType_ProcessName(Company:string, ProcessType:string, ProcessName:string, requestBody:Erp_Tablesets_MrpProcRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewMrpProc(requestBody:GetNewMrpProc_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewMrpProc_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewMrpProc_output)
          })
      .catch((error) => {
          reject(error)
      })
