...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method IsTaskScheduled
   Description: Parameters:  none
   OperationID: IsTaskScheduled
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/IsTaskScheduled_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_IsTaskScheduled(epicorHeaders?:Headers){
   ...
   return (new Promise<IsTaskScheduled_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/IsTaskScheduled", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as IsTaskScheduled_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method cutOffDate_Default
   Description: Parameters:  none
   OperationID: cutOffDate_Default
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/cutOffDate_Default_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_cutOffDate_Default(epicorHeaders?:Headers){
   ...
   return (new Promise<cutOffDate_Default_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/cutOffDate_Default", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as cutOffDate_Default_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method formatElapsedTime
   Description: Parameters:  none
   OperationID: formatElapsedTime
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/formatElapsedTime_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/formatElapsedTime_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_formatElapsedTime(requestBody:formatElapsedTime_input, epicorHeaders?:Headers){
   ...
   return (new Promise<formatElapsedTime_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/formatElapsedTime", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as formatElapsedTime_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.DBPurgeSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_DBPurgeRow{
   Company:string,
   CutOffDate:string,
   ChangeLog:boolean,
   LastPurgDt:string,
   ...
   LstPurgTime:string,
   CompanyName:string,
      /**  Delete GL Journal Details  */  
   DelJrnDtls:boolean,
      /**  Delete Labor detail  */  
   DelLabor:boolean,
      /**  Delete PartTran records.  */  
   DelPartTran:boolean,
      /**  Delete Change log records  */  
   DelChangeLog:boolean,
      /**  Delete Job  */  
   DelJob:boolean,
      /**  Delete Sales Orders  */  
   DelOrder:boolean,
   ...
   DelDemand:boolean,
      /**  Configuration Input values (PCInValue).  Note: Related source (Order, Quote, PO, Job...) must meet the purge criteria for PCInValue record to be deleted.  */  
   DelCnfgInput:boolean,
      /**  Delete Quote records  */  
   DelQuote:boolean,
      /**  Delete web basket product configurations  */  
   DelECCBasket:boolean,
      /**  Used for Summarization journal selection on UI process.  */  
   JournalCode:string,
      /**  Delete Review Journal records.  */  
   DelRJ:boolean,
      /**  The user is only able to select between “Erp” , “Ice” or  "Erp and Ice". Only change logs for the schema name selected will be processed  */  
   ChangeLogSchemaName:string,
      /**  Delete PartWipTran records.  */  
   DelPartWipTran:boolean,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_DBPurgeTableset{
   DBPurge:Erp_Tablesets_DBPurgeRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_DBPurgeTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_DBPurgeTableset[],
}
...
export interface IsTaskScheduled_output{
}
...
export interface cutOffDate_Default_output{
   returnObj:string,
}
   ...
   /** Required : 
      @param ii_Time
   */  
export interface formatElapsedTime_input{
   ii_Time:number,
}

export interface formatElapsedTime_output{
   returnObj:string,
}
