...
export function get_FSContDtSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_FSContDtSearches(requestBody:Erp_Tablesets_FSContDtSearchRow, epicorHeaders?:Headers){
...
export function get_FSContDtSearches_Company_ContractNum_ContractLine(Company:string, ContractNum:string, ContractLine:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FSContDtSearches_Company_ContractNum_ContractLine(Company:string, ContractNum:string, ContractLine:string, requestBody:Erp_Tablesets_FSContDtSearchRow, epicorHeaders?:Headers){
...
export function post_GetRowsServiceCall(requestBody:GetRowsServiceCall_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetRowsWithShipToNumCheck(requestBody:GetRowsWithShipToNumCheck_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRowsWithShipToNumCheck_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetRowsWithShipToNumCheck_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFSContDtSearch(requestBody:GetNewFSContDtSearch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewFSContDtSearch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewFSContDtSearch_output)
          })
      .catch((error) => {
          reject(error)
      })
