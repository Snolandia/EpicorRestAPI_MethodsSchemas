...
export function get_BESalesIntracoms(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_BESalesIntracoms(requestBody:Erp_Tablesets_BESalesIntracomRow, epicorHeaders?:Headers){
...
export function get_BESalesIntracoms_Company_ECSalesReportID(Company:string, ECSalesReportID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_BESalesIntracoms_Company_ECSalesReportID(Company:string, ECSalesReportID:string, requestBody:Erp_Tablesets_BESalesIntracomRow, epicorHeaders?:Headers){
...
export function post_GenExportFile(requestBody:GenExportFile_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewBESalesIntracom(requestBody:GetNewBESalesIntracom_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewBESalesIntracom_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewBESalesIntracom_output)
          })
      .catch((error) => {
          reject(error)
      })
