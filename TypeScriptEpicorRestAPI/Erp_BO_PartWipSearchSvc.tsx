...
export function get_PartWipSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PartWipSearches(requestBody:Erp_Tablesets_PartWipRow, epicorHeaders?:Headers){
...
export function get_PartWipSearches_Company_Plant_PartNum_JobNum_AssemblySeq_OprSeq_WareHouseCode_BinNum_LotNum_DimCode_TrackType_MtlSeq_PCID_AttributeSetID_SysRowID(Company:string, Plant:string, PartNum:string, JobNum:string, AssemblySeq:string, OprSeq:string, WareHouseCode:string, BinNum:string, LotNum:string, DimCode:string, TrackType:string, MtlSeq:string, PCID:string, AttributeSetID:string, SysRowID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PartWipSearches_Company_Plant_PartNum_JobNum_AssemblySeq_OprSeq_WareHouseCode_BinNum_LotNum_DimCode_TrackType_MtlSeq_PCID_AttributeSetID_SysRowID(Company:string, Plant:string, PartNum:string, JobNum:string, AssemblySeq:string, OprSeq:string, WareHouseCode:string, BinNum:string, LotNum:string, DimCode:string, TrackType:string, MtlSeq:string, PCID:string, AttributeSetID:string, SysRowID:string, requestBody:Erp_Tablesets_PartWipRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetPartWipOprList(requestBody:GetPartWipOprList_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetPartWipOprList_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetPartWipOprList_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetRowsJobTracker(jobNum:string, trackType:string, wipCompleteOnly:string, excludePartLocations:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRowsJobTracker_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetRowsJobTracker_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartWip(requestBody:GetNewPartWip_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPartWip_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPartWip_output)
          })
      .catch((error) => {
          reject(error)
      })
