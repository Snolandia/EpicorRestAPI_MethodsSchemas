...
export function get_PcConDatas(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PcConDatas(requestBody:Erp_Tablesets_PcConDataRow, epicorHeaders?:Headers){
...
export function get_PcConDatas_Company_PartNum_TypeCode_Key1_Key2_Key3_Key4_Key5_Key6_Key7(Company:string, PartNum:string, TypeCode:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, Key6:string, Key7:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PcConDatas_Company_PartNum_TypeCode_Key1_Key2_Key3_Key4_Key5_Key6_Key7(Company:string, PartNum:string, TypeCode:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, Key6:string, Key7:string, requestBody:Erp_Tablesets_PcConDataRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeTypeCode(requestBody:ChangeTypeCode_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeTypeCode_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ChangeTypeCode_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPcConData(requestBody:GetNewPcConData_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPcConData_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPcConData_output)
          })
      .catch((error) => {
          reject(error)
      })
