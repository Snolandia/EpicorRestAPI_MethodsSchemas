...
export function get_GLDailyBalances(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GLDailyBalances(requestBody:any, epicorHeaders?:Headers){
...
export function get_GLDailyBalances_Company_COACode_BookID_MaskType_GLMaskedAccount(Company:string, COACode:string, BookID:string, MaskType:string, GLMaskedAccount:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GLDailyBalances_Company_COACode_BookID_MaskType_GLMaskedAccount(Company:string, COACode:string, BookID:string, MaskType:string, GLMaskedAccount:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CopyMasks(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_DeleteMasksByBook(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetBooksForCOACode(requestBody:any, epicorHeaders?:Headers){
