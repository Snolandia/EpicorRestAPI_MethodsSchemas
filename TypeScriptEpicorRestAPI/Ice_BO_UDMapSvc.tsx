...
export function get_UDMaps(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_UDMaps(requestBody:any, epicorHeaders?:Headers){
...
export function get_UDMaps_MapTableID(MapTableID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UDMaps_MapTableID(MapTableID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_UDMapColumns(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_UDMapColumns(requestBody:any, epicorHeaders?:Headers){
...
export function get_UDMapColumns_MapTableID_Seq(MapTableID:string, Seq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UDMapColumns_MapTableID_Seq(MapTableID:string, Seq:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_GetUDMapTableForEntry(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_DeleteUDMapping(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewUDMapTable(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewUDMapColumn(requestBody:any, epicorHeaders?:Headers){
