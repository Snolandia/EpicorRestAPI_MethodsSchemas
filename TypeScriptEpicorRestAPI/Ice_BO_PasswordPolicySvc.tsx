...
export function get_PasswordPolicies(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PasswordPolicies(requestBody:Ice_Tablesets_PasswordPolicyRow, epicorHeaders?:Headers){
...
export function get_PasswordPolicies_TenantID(TenantID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PasswordPolicies_TenantID(TenantID:string, requestBody:Ice_Tablesets_PasswordPolicyRow, epicorHeaders?:Headers){
...
export function post_CanSavePassword(epicorHeaders?:Headers){
   ...
   return (new Promise<CanSavePassword_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CanSavePassword_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPasswordPolicy(requestBody:GetNewPasswordPolicy_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPasswordPolicy_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPasswordPolicy_output)
          })
      .catch((error) => {
          reject(error)
      })
