...
export function get_PartAllocRuleMasterDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PartAllocRuleMasterDtls(requestBody:Erp_Tablesets_PartAllocRuleMasterDtlRow, epicorHeaders?:Headers){
...
export function get_PartAllocRuleMasterDtls_Company_MasterRuleID(Company:string, MasterRuleID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PartAllocRuleMasterDtls_Company_MasterRuleID(Company:string, MasterRuleID:string, requestBody:Erp_Tablesets_PartAllocRuleMasterDtlRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CopyPartAllocRuleMasterDtl(requestBody:CopyPartAllocRuleMasterDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CopyPartAllocRuleMasterDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CopyPartAllocRuleMasterDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeAction(requestBody:OnChangeAction_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeAction_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeAction_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeAllocTemplate(requestBody:OnChangeAllocTemplate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeAllocTemplate_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeAllocTemplate_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_OnChangeQueryID(requestBody:OnChangeQueryID_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartAllocRuleMasterDtl(requestBody:GetNewPartAllocRuleMasterDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPartAllocRuleMasterDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPartAllocRuleMasterDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
