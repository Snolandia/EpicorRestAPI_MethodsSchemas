...
export function get_ShipDtlSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ShipDtlSearches(requestBody:Erp_Tablesets_ShipDtlRow, epicorHeaders?:Headers){
...
export function get_ShipDtlSearches_Company_PackNum_PackLine(Company:string, PackNum:string, PackLine:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ShipDtlSearches_Company_PackNum_PackLine(Company:string, PackNum:string, PackLine:string, requestBody:Erp_Tablesets_ShipDtlRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListCase(requestBody:GetListCase_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetListCase_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetListCase_output)
          })
      .catch((error) => {
          reject(error)
      })
