...
export function get_GLBGLBooks(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GLBGLBooks(requestBody:Erp_Tablesets_GLBGLBookRow, epicorHeaders?:Headers){
...
export function get_GLBGLBooks_Company_ExtCompanyID_BookID(Company:string, ExtCompanyID:string, BookID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GLBGLBooks_Company_ExtCompanyID_BookID(Company:string, ExtCompanyID:string, BookID:string, requestBody:Erp_Tablesets_GLBGLBookRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGLBGLBook(requestBody:GetNewGLBGLBook_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGLBGLBook_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGLBGLBook_output)
          })
      .catch((error) => {
          reject(error)
      })
