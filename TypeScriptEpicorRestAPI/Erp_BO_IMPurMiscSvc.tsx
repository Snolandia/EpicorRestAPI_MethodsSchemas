...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_AckPurMisc(requestBody:AckPurMisc_input, epicorHeaders?:Headers){
   ...
   return (new Promise<AckPurMisc_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as AckPurMisc_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CountPurMisc(requestBody:CountPurMisc_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CountPurMisc_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CountPurMisc_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetAllPurMisc(requestBody:GetAllPurMisc_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetAllPurMisc_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetAllPurMisc_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetPurMisc(requestBody:GetPurMisc_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetPurMisc_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetPurMisc_output)
          })
      .catch((error) => {
          reject(error)
      })
