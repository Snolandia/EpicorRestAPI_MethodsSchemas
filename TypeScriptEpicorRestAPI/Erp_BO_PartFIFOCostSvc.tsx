...
export function get_PartFIFOCosts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PartFIFOCosts(requestBody:any, epicorHeaders?:Headers){
...
export function get_PartFIFOCosts_Company_PartNum_LotNum_CostID_FIFODate_FIFOSeq_FIFOSubSeq(Company:string, PartNum:string, LotNum:string, CostID:string, FIFODate:string, FIFOSeq:string, FIFOSubSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PartFIFOCosts_Company_PartNum_LotNum_CostID_FIFODate_FIFOSeq_FIFOSubSeq(Company:string, PartNum:string, LotNum:string, CostID:string, FIFODate:string, FIFOSeq:string, FIFOSubSeq:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartFIFOCost(requestBody:any, epicorHeaders?:Headers){
