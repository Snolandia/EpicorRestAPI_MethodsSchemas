...
export function get_ShopLoads(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ShopLoads(requestBody:Erp_Tablesets_ShopLoadRow, epicorHeaders?:Headers){
...
export function get_ShopLoads_Company_ResourceGrpID_ResourceID_LoadDate(Company:string, ResourceGrpID:string, ResourceID:string, LoadDate:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ShopLoads_Company_ResourceGrpID_ResourceID_LoadDate(Company:string, ResourceGrpID:string, ResourceID:string, LoadDate:string, requestBody:Erp_Tablesets_ShopLoadRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewShopLoad(requestBody:GetNewShopLoad_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewShopLoad_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewShopLoad_output)
          })
      .catch((error) => {
          reject(error)
      })
