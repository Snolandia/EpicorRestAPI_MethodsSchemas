...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_GetNewSerialNumberSearch(requestBody:any, epicorHeaders?:Headers){
...
GenericToken1 = null
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SerialNumberSearch(requestBody:any, epicorHeaders?:Headers){
