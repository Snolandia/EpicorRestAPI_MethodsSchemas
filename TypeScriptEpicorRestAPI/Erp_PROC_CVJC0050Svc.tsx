...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method GetTransactions
   Description: This method returns the active labordtl transactions of a given employee.
   OperationID: GetTransactions
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetTransactions_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetTransactions_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTransactions(requestBody:GetTransactions_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTransactions_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/GetTransactions", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as GetTransactions_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GlobalSecurityCheck
   Description: Check if user is Global security manager
   OperationID: GlobalSecurityCheck
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GlobalSecurityCheck_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GlobalSecurityCheck(epicorHeaders?:Headers){
   ...
   return (new Promise<GlobalSecurityCheck_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/GlobalSecurityCheck", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GlobalSecurityCheck_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetLaborSeqLists
   Description: Returns LaborHed.LaborHedSeq, LaborDt.LaborDtlSeq lists of selected transactions
   OperationID: GetLaborSeqLists
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetLaborSeqLists_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetLaborSeqLists_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetLaborSeqLists(requestBody:GetLaborSeqLists_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetLaborSeqLists_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/GetLaborSeqLists", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetLaborSeqLists_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CVJC0050Svc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_CVJC0050ParamRow{
   Company:string,
   CompName:string,
   ConvDesc:string,
   ConvID:string,
   EmpID:string,
   EmpName:string,
   LaborDtlSeqList:string,
   LaborHedSeqList:string,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_CVJC0050Tableset{
   CVJC0050Param:Erp_Tablesets_CVJC0050ParamRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface Erp_Tablesets_CVJC0050TranTableset{
   CVJCLaborDtl:Erp_Tablesets_CVJCLaborDtlRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface Erp_Tablesets_CVJCLaborDtlRow{
   ActiveTrans:boolean,
   AssemblySeq:number,
   ClockInDate:string,
   EmployeeNum:string,
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_CVJC0050Tableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param ds
   */  
export interface GetLaborSeqLists_input{
   ds:Erp_Tablesets_CVJC0050TranTableset[],
}

export interface GetLaborSeqLists_output{
parameters : {
      /**  output parameters  */  
   laborHedSeqList:string,
   laborDtlSeqList:string,
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_CVJC0050Tableset[],
}
...
parameters : {
   ...
   /** Required : 
      ...
      @param employee
   */  
export interface GetTransactions_input{
      /**  The company selected  */  
   company:string,
      /**  The Employee Number to process  */  
   employee:string,
}

export interface GetTransactions_output{
   returnObj:Erp_Tablesets_CVJC0050TranTableset[],
}

export interface GlobalSecurityCheck_output{
   returnObj:boolean,
}
