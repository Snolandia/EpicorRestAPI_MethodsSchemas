...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_SaveLocal(requestBody:SaveLocal_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveLocal_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as SaveLocal_output)
          })
      .catch((error) => {
          reject(error)
      })
