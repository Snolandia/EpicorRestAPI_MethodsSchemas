...
export function get_PartWhseSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PartWhseSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_PartWhseSearches_Company_PartNum_WarehouseCode(Company:string, PartNum:string, WarehouseCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PartWhseSearches_Company_PartNum_WarehouseCode(Company:string, PartNum:string, WarehouseCode:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListbyKBPlant(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_WarehouseInCurPlant(requestBody:any, epicorHeaders?:Headers){
