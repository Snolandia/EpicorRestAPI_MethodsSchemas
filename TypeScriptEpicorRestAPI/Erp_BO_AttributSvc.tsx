...
export function get_Attributs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_Attributs(requestBody:Erp_Tablesets_AttributRow, epicorHeaders?:Headers){
...
export function get_Attributs_Company_AttrCode(Company:string, AttrCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_Attributs_Company_AttrCode(Company:string, AttrCode:string, requestBody:Erp_Tablesets_AttributRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAttribut(requestBody:GetNewAttribut_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewAttribut_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewAttribut_output)
          })
      .catch((error) => {
          reject(error)
      })
