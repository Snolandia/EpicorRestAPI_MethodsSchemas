...
export function get_BpHolds(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_BpHolds(requestBody:Ice_Tablesets_BpHoldTypeRow, epicorHeaders?:Headers){
...
export function get_BpHolds_Company_HoldTypeID(Company:string, HoldTypeID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_BpHolds_Company_HoldTypeID(Company:string, HoldTypeID:string, requestBody:Ice_Tablesets_BpHoldTypeRow, epicorHeaders?:Headers){
...
export function get_BpHoldAttachHists(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_BpHoldAttachHists(requestBody:Ice_Tablesets_BpHoldAttachHistRow, epicorHeaders?:Headers){
...
export function get_BpHoldAttachHists_Company_HoldTypeID_HoldHistoryID(Company:string, HoldTypeID:string, HoldHistoryID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_BpHoldAttachHists_Company_HoldTypeID_HoldHistoryID(Company:string, HoldTypeID:string, HoldHistoryID:string, requestBody:Ice_Tablesets_BpHoldAttachHistRow, epicorHeaders?:Headers){
...
export function get_BpHoldAttachments(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_BpHoldAttachments(requestBody:Ice_Tablesets_BpHoldAttachmentRow, epicorHeaders?:Headers){
...
export function get_BpHoldAttachments_Company_HoldTypeID_HoldAttachID(Company:string, HoldTypeID:string, HoldAttachID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_BpHoldAttachments_Company_HoldTypeID_HoldAttachID(Company:string, HoldTypeID:string, HoldAttachID:string, requestBody:Ice_Tablesets_BpHoldAttachmentRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewBpHoldType(requestBody:GetNewBpHoldType_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewBpHoldType_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewBpHoldType_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewBpHoldAttachHist(requestBody:GetNewBpHoldAttachHist_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewBpHoldAttachHist_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewBpHoldAttachHist_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewBpHoldAttachment(requestBody:GetNewBpHoldAttachment_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewBpHoldAttachment_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewBpHoldAttachment_output)
          })
      .catch((error) => {
          reject(error)
      })
