...
The Running Balance is calculated.
   ...
   */  
export function post_GetPartFIFOTranHistory(requestBody:GetPartFIFOTranHistory_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetPartFIFOTranHistory_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetPartFIFOTranHistory_output)
          })
      .catch((error) => {
          reject(error)
      })
