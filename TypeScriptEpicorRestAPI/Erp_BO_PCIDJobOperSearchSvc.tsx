...
export function get_PCIDJobOperSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PCIDJobOperSearches(requestBody:Erp_Tablesets_JobOperRow, epicorHeaders?:Headers){
...
export function get_PCIDJobOperSearches_Company_JobNum_AssemblySeq_OprSeq(Company:string, JobNum:string, AssemblySeq:string, OprSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PCIDJobOperSearches_Company_JobNum_AssemblySeq_OprSeq(Company:string, JobNum:string, AssemblySeq:string, OprSeq:string, requestBody:Erp_Tablesets_JobOperRow, epicorHeaders?:Headers){
...
Notes:
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PCIDJobOperSearch(requestBody:PCIDJobOperSearch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PCIDJobOperSearch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as PCIDJobOperSearch_output)
          })
      .catch((error) => {
          reject(error)
      })
...
Notes:
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PCIDJobOperListSearch(requestBody:PCIDJobOperListSearch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PCIDJobOperListSearch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as PCIDJobOperListSearch_output)
          })
      .catch((error) => {
          reject(error)
      })
