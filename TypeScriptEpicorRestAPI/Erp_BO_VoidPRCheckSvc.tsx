...
export function get_VoidPRChecks(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_VoidPRChecks(requestBody:Erp_Tablesets_PRCheckRow, epicorHeaders?:Headers){
...
export function get_VoidPRChecks_Company_HeadNum(Company:string, HeadNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_VoidPRChecks_Company_HeadNum(Company:string, HeadNum:string, requestBody:Erp_Tablesets_PRCheckRow, epicorHeaders?:Headers){
...
export function post_ValidateEmpID(requestBody:ValidateEmpID_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeEmployeeID(requestBody:OnChangeEmployeeID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeEmployeeID_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeEmployeeID_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_PreVoidCheck(epicorHeaders?:Headers){
   ...
   return (new Promise<PreVoidCheck_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as PreVoidCheck_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_VoidPayrollCheck(requestBody:VoidPayrollCheck_input, epicorHeaders?:Headers){
   ...
   return (new Promise<VoidPayrollCheck_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as VoidPayrollCheck_output)
          })
      .catch((error) => {
          reject(error)
      })
