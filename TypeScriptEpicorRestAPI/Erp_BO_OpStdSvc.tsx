...
export function get_OpStds(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_OpStds(requestBody:any, epicorHeaders?:Headers){
...
export function get_OpStds_Company_ResourceGrpID_OpCode_OpStdID(Company:string, ResourceGrpID:string, OpCode:string, OpStdID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_OpStds_Company_ResourceGrpID_OpCode_OpStdID(Company:string, ResourceGrpID:string, OpCode:string, OpStdID:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_GetCodeDescList(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewOpStd(requestBody:any, epicorHeaders?:Headers){
