...
export function get_PlasticPackagingTaxReports(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PlasticPackagingTaxReports(requestBody:Erp_Tablesets_PlasticPackagingTaxReportRow, epicorHeaders?:Headers){
...
export function get_PlasticPackagingTaxReports_Company_ReportID(Company:string, ReportID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PlasticPackagingTaxReports_Company_ReportID(Company:string, ReportID:string, requestBody:Erp_Tablesets_PlasticPackagingTaxReportRow, epicorHeaders?:Headers){
...
export function get_PlasticPackagingTaxReportDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PlasticPackagingTaxReportDtls(requestBody:Erp_Tablesets_PlasticPackagingTaxReportDtlRow, epicorHeaders?:Headers){
...
export function get_PlasticPackagingTaxReportDtls_Company_ReportID_Type_ExemptReasonCode(Company:string, ReportID:string, Type:string, ExemptReasonCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PlasticPackagingTaxReportDtls_Company_ReportID_Type_ExemptReasonCode(Company:string, ReportID:string, Type:string, ExemptReasonCode:string, requestBody:Erp_Tablesets_PlasticPackagingTaxReportDtlRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetPlasticTaxRate(requestBody:GetPlasticTaxRate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetPlasticTaxRate_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetPlasticTaxRate_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_Calculate(requestBody:Calculate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Calculate_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as Calculate_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPlasticPackagingTaxReport(requestBody:GetNewPlasticPackagingTaxReport_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPlasticPackagingTaxReport_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPlasticPackagingTaxReport_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPlasticPackagingTaxReportDtl(requestBody:GetNewPlasticPackagingTaxReportDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPlasticPackagingTaxReportDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPlasticPackagingTaxReportDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
