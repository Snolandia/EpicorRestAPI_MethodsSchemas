...
/** 
// Title: Erp.RPT.ReviewJrnReportSvc
// Description: 
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetCOACode(requestBody:GetCOACode_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetCOACode_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/GetCOACode", {
          method: 'post',
          headers: headers,
...
export function post_GetJournalCodes(epicorHeaders?:Headers){
   ...
   return (new Promise<GetJournalCodes_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/GetJournalCodes", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
   ...
   /**  
   Summary: Invoke method GetACTTypesList
   Description: Purpose:     Build a list of ACT types.
Parameters:  none
<remarks> Notes:  special condition - where All Selected needs a list constructed in this case.
</remarks>
   OperationID: GetACTTypesList
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetACTTypesList_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetACTTypesList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetACTTypesList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/GetACTTypesList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetACTTypesList_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetGLBooksList
   Description: Purpose:     Build a list of GL Books.
Parameters:  none
<remarks> Notes:  special condition - where All Selected needs a list constructed in this case.
</remarks>
   OperationID: GetGLBooksList
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetGLBooksList_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetGLBooksList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetGLBooksList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/GetGLBooksList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetGLBooksList_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ReviewJrnReportSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface Erp_Tablesets_ReviewJrnReportParamRow{
   BookID:string,
   StartDate:string,
   DCDUser:string,
   EndDate:string,
   ...
   GLAccount:string,
      /**  Use GL Account for filtering by credit or debit or both of them.  */  
   GLAcctDebCr:string,
   FiscalYear:number,
...
export interface Erp_Tablesets_ReviewJrnReportTableset{
   ReviewJrnReportParam:Erp_Tablesets_ReviewJrnReportParamRow[],
   ReportStyle:Erp_Tablesets_ReportStyleRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface GetACTTypesList_output{
parameters : {
      /**  output parameters  */  
   ACTTypesList:string,
}
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_ReviewJrnReportTableset[],
}
...
export interface GetGLBooksList_output{
parameters : {
      /**  output parameters  */  
   GLBooksList:string,
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_ReviewJrnReportTableset[],
}
