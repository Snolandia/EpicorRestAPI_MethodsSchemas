...
export function get_PartAllocTemplates(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PartAllocTemplates(requestBody:any, epicorHeaders?:Headers){
...
export function get_PartAllocTemplates_Company_AllocTemplateID(Company:string, AllocTemplateID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PartAllocTemplates_Company_AllocTemplateID(Company:string, AllocTemplateID:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_OnChangeEmpID(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeWhseTeam(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PartalloctemplateCheckAllocType(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PartAllocTemplateCheckDemandType(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartAllocTemplate(requestBody:any, epicorHeaders?:Headers){
