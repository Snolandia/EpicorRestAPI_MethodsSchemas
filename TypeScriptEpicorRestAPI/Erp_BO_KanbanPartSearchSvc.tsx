...
export function get_KanbanPartSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_KanbanPartSearches(requestBody:Erp_Tablesets_KanbanPartSearchRow, epicorHeaders?:Headers){
...
export function get_KanbanPartSearches_Company_PartNum(Company:string, PartNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_KanbanPartSearches_Company_PartNum(Company:string, PartNum:string, requestBody:Erp_Tablesets_KanbanPartSearchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewKanbanPartSearch(requestBody:GetNewKanbanPartSearch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewKanbanPartSearch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewKanbanPartSearch_output)
          })
      .catch((error) => {
          reject(error)
      })
