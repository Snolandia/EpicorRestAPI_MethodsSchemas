...
export function get_AnalysisCodes(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_AnalysisCodes(requestBody:Erp_Tablesets_AnalysisCdRow, epicorHeaders?:Headers){
...
export function get_AnalysisCodes_Company_AnalysisCode1(Company:string, AnalysisCode1:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_AnalysisCodes_Company_AnalysisCode1(Company:string, AnalysisCode1:string, requestBody:Erp_Tablesets_AnalysisCdRow, epicorHeaders?:Headers){
...
export function get_AnalysisCdAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_AnalysisCdAttches(requestBody:Erp_Tablesets_AnalysisCdAttchRow, epicorHeaders?:Headers){
...
export function get_AnalysisCdAttches_Company_AnalysisCode_DrawingSeq(Company:string, AnalysisCode:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_AnalysisCdAttches_Company_AnalysisCode_DrawingSeq(Company:string, AnalysisCode:string, DrawingSeq:string, requestBody:Erp_Tablesets_AnalysisCdAttchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAnalysisCd(requestBody:GetNewAnalysisCd_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewAnalysisCd_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewAnalysisCd_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAnalysisCdAttch(requestBody:GetNewAnalysisCdAttch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewAnalysisCdAttch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewAnalysisCdAttch_output)
          })
      .catch((error) => {
          reject(error)
      })
