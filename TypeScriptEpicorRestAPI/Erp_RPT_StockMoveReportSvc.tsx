...
/** 
// Title: Erp.RPT.StockMoveReportSvc
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method OnChangeFromDate
   Description: Updates dataset with values from proposed From Date
   OperationID: OnChangeFromDate
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/OnChangeFromDate_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/OnChangeFromDate_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeFromDate(requestBody:OnChangeFromDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeFromDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/OnChangeFromDate", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as OnChangeFromDate_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.StockMoveReportSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface Erp_Tablesets_StockMoveReportParamRow{
   ClassIDList:string,
      /**   Transaction = The cost on the transactions will be used for the report.
Current = The current cost will be used instead (according to Part/Plant default)
Weighted Average = All transaction costs will be printed as weighted average.  */  
   CostOption:string,
   FromDte:string,
   FromDteToken:string,
      /**  If this is set to ON, parts that do not have any transactions during the selected date range will still be printed on the report.  */  
   IncludeWithoutTranInPeriod:boolean,
   Parts:string,
      /**  If option Print Details is OFF, this option controls if description information shall be printed in the Item column for summary.  */  
   ...
   ToDteToken:string,
   WhseCodeList:string,
      /**  Grouping Method: By Class, By Site, By Warehouse...  */  
   GroupMethod:string,
   isStockMoveReport:boolean,
      /**  Site List  */  
   PlantList:string,
      /**  If it is off, then non-nettable bins should be excluded, else non-nettable bins should be included.  */  
   IncludeNonNettable:boolean,
      /**  This parameter defines a cut-off date used to find balance and cost prior to period which are used as initial values in calculations for Cost Option = “Transaction”  */  
   CutoffDate:string,
...
export interface Erp_Tablesets_StockMoveReportTableset{
   StockMoveReportParam:Erp_Tablesets_StockMoveReportParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_StockMoveReportTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_StockMoveReportTableset[],
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      ...
      @param fromDate
   */  
export interface OnChangeFromDate_input{
   ds:Erp_Tablesets_StockMoveReportTableset[],
      /**  Proposed From Date  */  
   fromDate:string,
}

export interface OnChangeFromDate_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_StockMoveReportTableset,
}
