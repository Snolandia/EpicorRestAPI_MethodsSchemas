...
export function get_JCDepts(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_JCDepts(requestBody:Erp_Tablesets_JCDeptRow, epicorHeaders?:Headers){
...
export function get_JCDepts_Company_JCDept1(Company:string, JCDept1:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_JCDepts_Company_JCDept1(Company:string, JCDept1:string, requestBody:Erp_Tablesets_JCDeptRow, epicorHeaders?:Headers){
...
export function get_JCDeptAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_JCDeptAttches(requestBody:Erp_Tablesets_JCDeptAttchRow, epicorHeaders?:Headers){
...
export function get_JCDeptAttches_Company_JCDept_DrawingSeq(Company:string, JCDept:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_JCDeptAttches_Company_JCDept_DrawingSeq(Company:string, JCDept:string, DrawingSeq:string, requestBody:Erp_Tablesets_JCDeptAttchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewJCDept(requestBody:GetNewJCDept_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewJCDept_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewJCDept_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewJCDeptAttch(requestBody:GetNewJCDeptAttch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewJCDeptAttch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewJCDeptAttch_output)
          })
      .catch((error) => {
          reject(error)
      })
