...
export function get_CreditTrans(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_CreditTrans(requestBody:any, epicorHeaders?:Headers){
...
export function get_CreditTrans_Company_TranDate_TranTime_TranNum(Company:string, TranDate:string, TranTime:string, TranNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_CreditTrans_Company_TranDate_TranTime_TranNum(Company:string, TranDate:string, TranTime:string, TranNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_GetRowsContactTracker(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetRowsForCreditCard(requestBody:any, epicorHeaders?:Headers){
...
It is used for ApplyCM.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListForApplyCreditMemo(requestBody:any, epicorHeaders?:Headers){
...
It is used in Sales Order and Cash Receipt for Credit Card Number search grid.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetCardNumbers(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewCreditTran(requestBody:any, epicorHeaders?:Headers){
