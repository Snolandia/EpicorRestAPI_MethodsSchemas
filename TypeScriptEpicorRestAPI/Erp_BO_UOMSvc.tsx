...
export function get_UOMs(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_UOMs(requestBody:Erp_Tablesets_UOMRow, epicorHeaders?:Headers){
...
export function get_UOMs_Company_UOMCode(Company:string, UOMCode:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UOMs_Company_UOMCode(Company:string, UOMCode:string, requestBody:Erp_Tablesets_UOMRow, epicorHeaders?:Headers){
...
export function get_GetByID(uoMCode:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeAllowDecimals(requestBody:OnChangeAllowDecimals_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeAllowDecimals_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeAllowDecimals_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeNumOfDec(requestBody:OnChangeNumOfDec_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeNumOfDec_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeNumOfDec_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_OnChangeUOMCode(requestBody:OnChangeUOMCode_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckDuplicate(requestBody:CheckDuplicate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckDuplicate_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CheckDuplicate_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_OnChangePECode(requestBody:OnChangePECode_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewUOM(requestBody:GetNewUOM_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewUOM_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewUOM_output)
          })
      .catch((error) => {
          reject(error)
      })
