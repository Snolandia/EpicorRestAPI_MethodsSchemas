...
export function get_CourseRevisionSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_CourseRevisionSearches(requestBody:Erp_Tablesets_CourseRevisionRow, epicorHeaders?:Headers){
...
export function get_CourseRevisionSearches_Company_CourseID_RevisionCode(Company:string, CourseID:string, RevisionCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_CourseRevisionSearches_Company_CourseID_RevisionCode(Company:string, CourseID:string, RevisionCode:string, requestBody:Erp_Tablesets_CourseRevisionRow, epicorHeaders?:Headers){
