...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_FinCharges(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinCharges", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      .then((res) => res.json())
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   */  
export function post_FinCharges(requestBody:any, epicorHeaders?:Headers){
   ...
   */  
export function get_FinCharges_Company_ChargeCode(Company:string, ChargeCode:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_FinChargeRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinCharges(" + Company + "," + ChargeCode + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      .then((res) => res.json())
      .then((data) => {
         resolve(data as Erp_Tablesets_FinChargeRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FinCharges_Company_ChargeCode(Company:string, ChargeCode:string, requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function delete_FinCharges_Company_ChargeCode(Company:string, ChargeCode:string, epicorHeaders?:Headers){
   ...
   */  
export function get_FinCharges_Company_ChargeCode_FinChargeRates(Company:string, ChargeCode:string, select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeRateRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinCharges(" + Company + "," + ChargeCode + ")/FinChargeRates", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      .then((res) => res.json())
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeRateRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   */  
export function get_FinCharges_Company_ChargeCode_FinChargeRates_Company_ChargeCode_EffDate(Company:string, ChargeCode:string, EffDate:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_FinChargeRateRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinCharges(" + Company + "," + ChargeCode + ")/FinChargeRates(" + Company + "," + ChargeCode + "," + EffDate + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      .then((res) => res.json())
      .then((data) => {
         resolve(data as Erp_Tablesets_FinChargeRateRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   */  
export function get_FinCharges_Company_ChargeCode_LangDescs(Company:string, ChargeCode:string, select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LangDescRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinCharges(" + Company + "," + ChargeCode + ")/LangDescs", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_FinCharges_Company_ChargeCode_LangDescs_Company_TableName_Key1_Key2_Key3_LangNameID(Company:string, ChargeCode:string, TableName:string, Key1:string, Key2:string, Key3:string, LangNameID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_LangDescRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinCharges(" + Company + "," + ChargeCode + ")/LangDescs(" + Company + "," + TableName + "," + Key1 + "," + Key2 + "," + Key3 + "," + LangNameID + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_FinCharges_Company_ChargeCode_EntityGLCs(Company:string, ChargeCode:string, select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_EntityGLCRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinCharges(" + Company + "," + ChargeCode + ")/EntityGLCs", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_FinCharges_Company_ChargeCode_EntityGLCs_Company_RelatedToFile_Key1_Key2_Key3_Key4_Key5_Key6_GLControlType(Company:string, ChargeCode:string, RelatedToFile:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, Key6:string, GLControlType:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_EntityGLCRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinCharges(" + Company + "," + ChargeCode + ")/EntityGLCs(" + Company + "," + RelatedToFile + "," + Key1 + "," + Key2 + "," + Key3 + "," + Key4 + "," + Key5 + "," + Key6 + "," + GLControlType + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_FinCharges_Company_ChargeCode_FinChargeAttches(Company:string, ChargeCode:string, select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeAttchRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinCharges(" + Company + "," + ChargeCode + ")/FinChargeAttches", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      .then((res) => res.json())
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeAttchRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   */  
export function get_FinCharges_Company_ChargeCode_FinChargeAttches_Company_ChargeCode_DrawingSeq(Company:string, ChargeCode:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_FinChargeAttchRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinCharges(" + Company + "," + ChargeCode + ")/FinChargeAttches(" + Company + "," + ChargeCode + "," + DrawingSeq + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      .then((res) => res.json())
      .then((data) => {
         resolve(data as Erp_Tablesets_FinChargeAttchRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      200 Desc: OK => reference#/components/schemas/Epicor.RESTApi.Help.ODataSetResponse_System.Collections.Generic.List_Erp.Tablesets.FinChargeRateRow
   */  
export function get_FinChargeRates(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeRateRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinChargeRates", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_FinChargeRates(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      200 Desc: OK => reference#/components/schemas/Erp.Tablesets.FinChargeRateRow
   */  
export function get_FinChargeRates_Company_ChargeCode_EffDate(Company:string, ChargeCode:string, EffDate:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_FinChargeRateRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinChargeRates(" + Company + "," + ChargeCode + "," + EffDate + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FinChargeRates_Company_ChargeCode_EffDate(Company:string, ChargeCode:string, EffDate:string, requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function delete_FinChargeRates_Company_ChargeCode_EffDate(Company:string, ChargeCode:string, EffDate:string, epicorHeaders?:Headers){
...
export function get_LangDescs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LangDescRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/LangDescs", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_LangDescs_Company_TableName_Key1_Key2_Key3_LangNameID(Company:string, TableName:string, Key1:string, Key2:string, Key3:string, LangNameID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_LangDescRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/LangDescs(" + Company + "," + TableName + "," + Key1 + "," + Key2 + "," + Key3 + "," + LangNameID + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_EntityGLCs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_EntityGLCRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/EntityGLCs", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_EntityGLCs_Company_RelatedToFile_Key1_Key2_Key3_Key4_Key5_Key6_GLControlType(Company:string, RelatedToFile:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, Key6:string, GLControlType:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_EntityGLCRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/EntityGLCs(" + Company + "," + RelatedToFile + "," + Key1 + "," + Key2 + "," + Key3 + "," + Key4 + "," + Key5 + "," + Key6 + "," + GLControlType + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function delete_EntityGLCs_Company_RelatedToFile_Key1_Key2_Key3_Key4_Key5_Key6_GLControlType(Company:string, RelatedToFile:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, Key6:string, GLControlType:string, epicorHeaders?:Headers){
   ...
   Returns: 
      200 Desc: OK => reference#/components/schemas/Epicor.RESTApi.Help.ODataSetResponse_System.Collections.Generic.List_Erp.Tablesets.FinChargeAttchRow
   */  
export function get_FinChargeAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeAttchRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinChargeAttches", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_FinChargeAttches(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      200 Desc: OK => reference#/components/schemas/Erp.Tablesets.FinChargeAttchRow
   */  
export function get_FinChargeAttches_Company_ChargeCode_DrawingSeq(Company:string, ChargeCode:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_FinChargeAttchRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/FinChargeAttches(" + Company + "," + ChargeCode + "," + DrawingSeq + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FinChargeAttches_Company_ChargeCode_DrawingSeq(Company:string, ChargeCode:string, DrawingSeq:string, requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function delete_FinChargeAttches_Company_ChargeCode_DrawingSeq(Company:string, ChargeCode:string, DrawingSeq:string, epicorHeaders?:Headers){
...
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      .then((res) => res.json())
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeListRow)
          })
      .catch((error) => {
          reject(error)
      })
...
//////////////////////////////////////////////////////////////////////////
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetRows(whereClauseFinCharge:string, whereClauseFinChargeAttch:string, whereClauseFinChargeRate:string, whereClauseLangDesc:string, whereClauseEntityGLC:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   if(typeof whereClauseFinCharge!== 'undefined'){
      if(firstParam){
         params += "?"
         firstParam = false
      }else{
   ...
   if(typeof whereClauseFinChargeAttch!== 'undefined'){
      if(firstParam){
         params += "?"
         firstParam = false
      }else{
   ...
   if(typeof whereClauseFinChargeRate!== 'undefined'){
      if(firstParam){
         params += "?"
         firstParam = false
      }else{
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetByID(chargeCode:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeFinChargeFinInvTerms(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/OnChangeFinChargeFinInvTerms", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeFinChargeMiscCode(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/OnChangeFinChargeMiscCode", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeFinChargeTaxCatID(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/OnChangeFinChargeTaxCatID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFinCharge(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/GetNewFinCharge", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFinChargeAttch(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/GetNewFinChargeAttch", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFinChargeRate(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/GetNewFinChargeRate", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetNewLangDesc(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/GetNewLangDesc", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetNewEntityGLC(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/GetNewEntityGLC", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_DeleteByID(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/DeleteByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.FinChargeSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeAttchRow{
   "odatametadata":string,
   "value":Erp_Tablesets_FinChargeAttchRow[],
}

export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeListRow{
   "odatametadata":string,
   "value":Erp_Tablesets_FinChargeListRow[],
}

export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeRateRow{
   "odatametadata":string,
   "value":Erp_Tablesets_FinChargeRateRow[],
}

export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_FinChargeRow{
   "odatametadata":string,
   "value":Erp_Tablesets_FinChargeRow[],
}
...
export interface Erp_Tablesets_FinChargeAttchRow{
   "Company":string,
   "ChargeCode":string,
   "DrawingSeq":number,
   "XFileRefNum":number,
...
export interface Erp_Tablesets_FinChargeListRow{
      /**  Company Identifier.  */  
   "Company":string,
...
export interface Erp_Tablesets_FinChargeRateRow{
      /**  Company Identifier.  */  
   "Company":string,
...
export interface Erp_Tablesets_FinChargeRow{
      /**  Company Identifier.  */  
   "Company":string,
      /**  Unique Identifier for the Finance Charges  */  
   "ChargeCode":string,
...
export interface Erp_Tablesets_FinChargeListTableset{
   FinChargeList:Erp_Tablesets_FinChargeListRow[],
...
export interface Erp_Tablesets_FinChargeTableset{
   FinCharge:Erp_Tablesets_FinChargeRow[],
   FinChargeAttch:Erp_Tablesets_FinChargeAttchRow[],
   FinChargeRate:Erp_Tablesets_FinChargeRateRow[],
...
export interface Erp_Tablesets_UpdExtFinChargeTableset{
   FinCharge:Erp_Tablesets_FinChargeRow[],
   FinChargeAttch:Erp_Tablesets_FinChargeAttchRow[],
   FinChargeRate:Erp_Tablesets_FinChargeRateRow[],
   LangDesc:Erp_Tablesets_LangDescRow[],
...
export interface GetByID_output{
   returnObj:Erp_Tablesets_FinChargeTableset[],
}
...
export interface GetList_output{
   returnObj:Erp_Tablesets_FinChargeListTableset[],
parameters : {
      /**  output parameters  */  
   morePages:boolean,
}
...
export interface GetNewEntityGLC_input{
   ds:Erp_Tablesets_FinChargeTableset[],
   relatedToFile:string,
   key1:string,
   key2:string,
   key3:string,
...
parameters : {
   ...
   /** Required : 
      ...
      @param chargeCode
   */  
export interface GetNewFinChargeAttch_input{
   ds:Erp_Tablesets_FinChargeTableset[],
   chargeCode:string,
}

export interface GetNewFinChargeAttch_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_FinChargeTableset[],
}
   ...
   /** Required : 
      ...
      @param chargeCode
   */  
export interface GetNewFinChargeRate_input{
   ds:Erp_Tablesets_FinChargeTableset[],
   chargeCode:string,
}

export interface GetNewFinChargeRate_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_FinChargeTableset[],
}
   ...
   /** Required : 
      @param ds
   */  
export interface GetNewFinCharge_input{
   ds:Erp_Tablesets_FinChargeTableset[],
}

export interface GetNewFinCharge_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_FinChargeTableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param whereClauseFinCharge
      @param whereClauseFinChargeAttch
      @param whereClauseFinChargeRate
...
export interface GetRows_input{
   whereClauseFinCharge:string,
   whereClauseFinChargeAttch:string,
   whereClauseFinChargeRate:string,
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface OnChangeFinChargeFinInvTerms_input{
      /**  The proposed FinInvTerms value  */  
   ipFinInvTerms:string,
   ds:Erp_Tablesets_FinChargeTableset[],
}

export interface OnChangeFinChargeFinInvTerms_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_FinChargeTableset[],
}
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface OnChangeFinChargeMiscCode_input{
      /**  The proposed Misc Charge Code value  */  
   ipMiscCode:string,
   ds:Erp_Tablesets_FinChargeTableset[],
}

export interface OnChangeFinChargeMiscCode_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_FinChargeTableset[],
}
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface OnChangeFinChargeTaxCatID_input{
      /**  The proposed TaxCatID value  */  
   ipTaxCatID:string,
   ds:Erp_Tablesets_FinChargeTableset[],
}

export interface OnChangeFinChargeTaxCatID_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_FinChargeTableset[],
}
...
export interface UpdateExt_input{
   ds:Erp_Tablesets_UpdExtFinChargeTableset[],
