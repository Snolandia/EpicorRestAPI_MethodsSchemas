...
export function get_Annotations(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_Annotations(requestBody:Ice_Tablesets_AnnotationRow, epicorHeaders?:Headers){
...
export function get_Annotations_Company_HelpPageRef_LangNameID_AnnotationType_CreatedBy(Company:string, HelpPageRef:string, LangNameID:string, AnnotationType:string, CreatedBy:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_Annotations_Company_HelpPageRef_LangNameID_AnnotationType_CreatedBy(Company:string, HelpPageRef:string, LangNameID:string, AnnotationType:string, CreatedBy:string, requestBody:Ice_Tablesets_AnnotationRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeofAnnotationType(requestBody:OnChangeofAnnotationType_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeofAnnotationType_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeofAnnotationType_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeofCreatedBy(requestBody:OnChangeofCreatedBy_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeofCreatedBy_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeofCreatedBy_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAnnotation(requestBody:GetNewAnnotation_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewAnnotation_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewAnnotation_output)
          })
      .catch((error) => {
          reject(error)
      })
