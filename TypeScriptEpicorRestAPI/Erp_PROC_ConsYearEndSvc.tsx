...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method CheckPrevious
   Description: Purpose:  set default values when book changes
Parameters:
<param name="ipBookid">Book ID</param><param name="ds">Chart of Accounts Data Set</param>
Notes:
   OperationID: CheckPrevious
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/CheckPrevious_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/CheckPrevious_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckPrevious(requestBody:CheckPrevious_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckPrevious_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/CheckPrevious", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as CheckPrevious_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetGLSourceBook
   OperationID: GetGLSourceBook
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetGLSourceBook_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetGLSourceBook(epicorHeaders?:Headers){
   ...
   return (new Promise<GetGLSourceBook_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/GetGLSourceBook", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetGLSourceBook_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method SetDefaultCalendar
   Description: Purpose:  set default values when book changes
Parameters:
<param name="ipBookid">Book ID</param><param name="ds">Chart of Accounts Data Set</param>
Notes:
   OperationID: SetDefaultCalendar
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/SetDefaultCalendar_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/SetDefaultCalendar_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SetDefaultCalendar(requestBody:SetDefaultCalendar_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SetDefaultCalendar_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/SetDefaultCalendar", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as SetDefaultCalendar_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetListSourceBook
   OperationID: GetListSourceBook
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetListSourceBook_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListSourceBook(epicorHeaders?:Headers){
   ...
   return (new Promise<GetListSourceBook_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/GetListSourceBook", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetListSourceBook_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.ConsYearEndSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
//////////////////////////////////////////////////////////////////////////
   /** Required : 
      ...
      @param ds
   */  
export interface CheckPrevious_input{
   ipBookid:string,
   ds:Erp_Tablesets_ConsYearEndTableset[],
}

export interface CheckPrevious_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_ConsYearEndTableset,
}
...
export interface Erp_Tablesets_ConsYearEndParamRow{
      /**  Fiscal Year for Consolidation Year End processing.  */  
   FiscalYear:number,
   ...
   BookDescription:string,
      /**  Logical indicating the user wants to continue with year end logic even though a previous period has not been consolidated.  */  
   OkayToContinue:boolean,
      /**  Message used to ask the user if it is okay to continue  */  
   OkayPrompt:string,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_ConsYearEndTableset{
   ConsYearEndParam:Erp_Tablesets_ConsYearEndParamRow[],
...
export interface GetGLSourceBook_output{
   returnObj:any,      //schema had no properties on an object.
}

export interface GetListSourceBook_output{
parameters : {
      /**  output parameters  */  
   strList:string,
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_ConsYearEndTableset[],
}
...
export interface SaveProcessTask_output{
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface SetDefaultCalendar_input{
   ipBookid:string,
   ds:Erp_Tablesets_ConsYearEndTableset[],
}

export interface SetDefaultCalendar_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_ConsYearEndTableset,
}
