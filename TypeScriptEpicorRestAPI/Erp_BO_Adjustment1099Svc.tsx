...
export function get_Adjustment1099s(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_Adjustment1099s(requestBody:any, epicorHeaders?:Headers){
...
export function get_Adjustment1099s_Company_FormTypeID_AdjustmentNum(Company:string, FormTypeID:string, AdjustmentNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_Adjustment1099s_Company_FormTypeID_AdjustmentNum(Company:string, FormTypeID:string, AdjustmentNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_Change1099Code(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CleanDate(requestBody:any, epicorHeaders?:Headers){
...
export function post_GetByIDSite(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAdjustment1099(requestBody:any, epicorHeaders?:Headers){
