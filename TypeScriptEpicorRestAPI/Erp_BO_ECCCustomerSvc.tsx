...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_ECCCustomerPortal(requestBody:ECCCustomerPortal_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ECCCustomerPortal_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ECCCustomerPortal_output)
          })
      .catch((error) => {
          reject(error)
      })
