...
export function get_ExtPRPayClasses(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ExtPRPayClasses(requestBody:Erp_Tablesets_ExtPRPayClassRow, epicorHeaders?:Headers){
...
export function get_ExtPRPayClasses_Company_PayClassID(Company:string, PayClassID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ExtPRPayClasses_Company_PayClassID(Company:string, PayClassID:string, requestBody:Erp_Tablesets_ExtPRPayClassRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewExtPRPayClass(requestBody:GetNewExtPRPayClass_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewExtPRPayClass_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewExtPRPayClass_output)
          })
      .catch((error) => {
          reject(error)
      })
