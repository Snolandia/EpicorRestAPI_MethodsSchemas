...
export function post_CheckEmployee(requestBody:CheckEmployee_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAssyMtlInfo(requestBody:GetNewAssyMtlInfo_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewAssyMtlInfo_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewAssyMtlInfo_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewMiscInfo(requestBody:GetNewMiscInfo_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewMiscInfo_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewMiscInfo_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSalvageInfo(requestBody:GetNewSalvageInfo_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewSalvageInfo_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewSalvageInfo_output)
          })
      .catch((error) => {
          reject(error)
      })
