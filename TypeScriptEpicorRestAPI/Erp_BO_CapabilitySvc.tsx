...
export function get_Capabilities(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_Capabilities(requestBody:any, epicorHeaders?:Headers){
...
export function get_Capabilities_Company_CapabilityID(Company:string, CapabilityID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_Capabilities_Company_CapabilityID(Company:string, CapabilityID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_CapAddls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CapAddls(requestBody:any, epicorHeaders?:Headers){
...
export function get_CapAddls_Company_CapabilityID_CapAddID(Company:string, CapabilityID:string, CapAddID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_CapAddls_Company_CapabilityID_CapAddID(Company:string, CapabilityID:string, CapAddID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_externalMESEnabled(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getCapabilityIDDescription(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewCapability(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewCapAddl(requestBody:any, epicorHeaders?:Headers){
