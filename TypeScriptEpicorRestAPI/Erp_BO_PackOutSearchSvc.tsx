...
a temp table we need our own public method.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_POGetRows(requestBody:POGetRows_input, epicorHeaders?:Headers){
   ...
   return (new Promise<POGetRows_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as POGetRows_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_TFOrderGetRows(matchField:string, packNum:string, orderNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<TFOrderGetRows_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as TFOrderGetRows_output)
          })
      .catch((error) => {
          reject(error)
      })
