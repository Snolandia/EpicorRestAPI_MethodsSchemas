...
export function get_AgingRptFmts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_AgingRptFmts(requestBody:any, epicorHeaders?:Headers){
...
export function get_AgingRptFmts_Company_FmtCode(Company:string, FmtCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_AgingRptFmts_Company_FmtCode(Company:string, FmtCode:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAgingRptFmt(requestBody:any, epicorHeaders?:Headers){
