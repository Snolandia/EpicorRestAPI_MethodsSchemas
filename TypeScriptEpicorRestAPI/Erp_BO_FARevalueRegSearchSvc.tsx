...
export function get_FARevalueRegSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_FARevalueRegSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_FARevalueRegSearches_Company_AssetNum_RevalueNum_AssetRegID(Company:string, AssetNum:string, RevalueNum:string, AssetRegID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FARevalueRegSearches_Company_AssetNum_RevalueNum_AssetRegID(Company:string, AssetNum:string, RevalueNum:string, AssetRegID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewFARevalueRegSearch(requestBody:any, epicorHeaders?:Headers){
