...
export function get_INGSTR1Reports(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_INGSTR1Reports(requestBody:Erp_Tablesets_INGSTR1ReportRow, epicorHeaders?:Headers){
...
export function get_INGSTR1Reports_Company_ReportID(Company:string, ReportID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_INGSTR1Reports_Company_ReportID(Company:string, ReportID:string, requestBody:Erp_Tablesets_INGSTR1ReportRow, epicorHeaders?:Headers){
...
export function get_INGSTR1ReportDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_INGSTR1ReportDtls(requestBody:Erp_Tablesets_INGSTR1ReportDtlRow, epicorHeaders?:Headers){
...
export function get_INGSTR1ReportDtls_Company_ReportID_InvoiceNum(Company:string, ReportID:string, InvoiceNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_INGSTR1ReportDtls_Company_ReportID_InvoiceNum(Company:string, ReportID:string, InvoiceNum:string, requestBody:Erp_Tablesets_INGSTR1ReportDtlRow, epicorHeaders?:Headers){
...
export function post_ChangeSubmit(requestBody:ChangeSubmit_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewINGSTR1Report(requestBody:GetNewINGSTR1Report_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewINGSTR1Report_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewINGSTR1Report_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewINGSTR1ReportDtl(requestBody:GetNewINGSTR1ReportDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewINGSTR1ReportDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewINGSTR1ReportDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
