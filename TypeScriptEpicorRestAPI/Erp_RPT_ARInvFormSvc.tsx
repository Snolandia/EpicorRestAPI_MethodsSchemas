...
/** 
// Title: Erp.RPT.ARInvFormSvc
// Description: class ARInvFormSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_PackNumDefaults(requestBody:PackNumDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PackNumDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/PackNumDefaults", {
          method: 'post',
          headers: headers,
   ...
   /**  
   Summary: Invoke method OnChangeOfHeadOrOffice
   Description: On change of HeadOrOffice
   OperationID: OnChangeOfHeadOrOffice
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/OnChangeOfHeadOrOffice_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/OnChangeOfHeadOrOffice_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeOfHeadOrOffice(requestBody:OnChangeOfHeadOrOffice_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeOfHeadOrOffice_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/OnChangeOfHeadOrOffice", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as OnChangeOfHeadOrOffice_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.ARInvFormSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_ARInvFormParamRow{
   InvoiceNum:number,
   CurGroup:string,
   PrintNPost:boolean,
   Vouchering:boolean,
   ...
   DocTypeOption:string,
      /**  Indicates if the EnableAssignLegalNumber field is available for input  */  
   EnableAssignLegalNumber:boolean,
      /**  Print Status Options  */  
   PrintStatusOption:string,
   TranDocTypeID:string,
      /**  Select Transaction options (AR Invoices, AR Invoices and Credit Memos, All Project Billing, Cost Plus, Credit Memo, Fixed Fee, Progress Payments, Time and Materials)  */  
   TransOptions:string,
   CustList:string,
   DCList:string,
   TH_IsService:boolean,
   ARInvFormReportID:string,
      /**  Begin Date range  */  
   BeginDate:string,
      /**  Begin invoice number range  */  
   BeginNum:string,
      /**  Ending date for date range  */  
   EndDate:string,
      /**  Ending invoice number range  */  
   EndNum:string,
      /**  Invoice status options  */  
   InvoiceStatusOption:string,
   THHeadOfficeOrBranch:string,
   THPlaceOfBusiness:string,
      /**  Print TW Computer Invoice, Part I  */  
   TWCompInvPart1:boolean,
      /**  Print TW Computer Invoice, Part II  */  
   TWCompInvPart2:boolean,
      /**  Print TW Computer Invoice, Part III Front  */  
   TWCompInvPart3Front:boolean,
      /**  Print TW Computer Invoice, Part III Back  */  
   TWCompInvPart3Back:boolean,
      /**  Print Transaction Details part of TW E-Invoice  */  
   TWEInvTransDetails:boolean,
      /**  Print Prize Collection part of TW E-Invoice  */  
   TWEInvPrizeCollection:boolean,
      /**  Indicates the program where invoice printing is run from  */  
   CalledFrom:string,
      /**  Indicates 'Use copy number' functionality is ON.  */  
   EnableUseCopyNumInARInv:boolean,
      /**  Print Document draft copy  */  
   DraftCopy:boolean,
      /**  Document Copy Number  */  
   DspDocCopyNum:string,
      /**  List of selected customer IDs to process  */  
   CustIDList:string,
      /**  List of selected demand contracts to process  */  
   DemandContractList:string,
      /**  Will enable the Attribute Set Short Description to be shown on the report.  */  
   PrintInventoryAttributes:boolean,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_ARInvFormTableset{
   ARInvFormParam:Erp_Tablesets_ARInvFormParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_ARInvFormTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_ARInvFormTableset[],
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface OnChangeOfHeadOrOffice_input{
      /**  The value of HeadOrOffice entered  */  
   headOrOffice:string,
   ds:Erp_Tablesets_ARInvFormTableset[],
}

export interface OnChangeOfHeadOrOffice_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_ARInvFormTableset,
}
