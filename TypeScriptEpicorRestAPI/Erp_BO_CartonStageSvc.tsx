...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_CartonStages(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_CartonStageRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/CartonStages", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function post_CartonStages(requestBody:any, epicorHeaders?:Headers){
   ...
   */  
export function get_CartonStages_Company_PackNum_ShipmentType(Company:string, PackNum:string, ShipmentType:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_CartonStageRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/CartonStages(" + Company + "," + PackNum + "," + ShipmentType + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_CartonStages_Company_PackNum_ShipmentType(Company:string, PackNum:string, ShipmentType:string, requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function delete_CartonStages_Company_PackNum_ShipmentType(Company:string, PackNum:string, ShipmentType:string, epicorHeaders?:Headers){
...
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_CartonStageListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetRows(whereClauseCartonStage:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetByID(packNum:string, shipmentType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListCustom(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/GetListCustom", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_GetNewCartonStage(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/GetNewCartonStage", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_DeleteByID(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/DeleteByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CartonStageSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface Erp_Tablesets_CartonStageTableset{
   CartonStage:Erp_Tablesets_CartonStageRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface Erp_Tablesets_UpdExtCartonStageTableset{
   CartonStage:Erp_Tablesets_CartonStageRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface GetByID_output{
   returnObj:Erp_Tablesets_CartonStageTableset[],
}
...
export interface GetNewCartonStage_input{
   ds:Erp_Tablesets_CartonStageTableset[],
   packNum:number,
}
...
export interface UpdateExt_input{
   ds:Erp_Tablesets_UpdExtCartonStageTableset[],
