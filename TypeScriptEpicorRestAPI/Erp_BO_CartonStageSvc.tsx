...
export function get_CartonStages(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_CartonStages(requestBody:Erp_Tablesets_CartonStageRow, epicorHeaders?:Headers){
...
export function get_CartonStages_Company_PackNum_ShipmentType(Company:string, PackNum:string, ShipmentType:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_CartonStages_Company_PackNum_ShipmentType(Company:string, PackNum:string, ShipmentType:string, requestBody:Erp_Tablesets_CartonStageRow, epicorHeaders?:Headers){
