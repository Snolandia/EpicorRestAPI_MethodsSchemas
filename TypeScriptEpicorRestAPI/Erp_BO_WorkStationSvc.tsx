...
export function get_WorkStations(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_WorkStations(requestBody:Erp_Tablesets_WorkStationRow, epicorHeaders?:Headers){
...
export function get_WorkStations_Company_WorkStationID(Company:string, WorkStationID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_WorkStations_Company_WorkStationID(Company:string, WorkStationID:string, requestBody:Erp_Tablesets_WorkStationRow, epicorHeaders?:Headers){
...
export function get_Devices(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_Devices(requestBody:Erp_Tablesets_DeviceRow, epicorHeaders?:Headers){
...
export function get_Devices_Company_WorkStationID_Type_DefaultDevice(Company:string, WorkStationID:string, Type:string, DefaultDevice:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_Devices_Company_WorkStationID_Type_DefaultDevice(Company:string, WorkStationID:string, Type:string, DefaultDevice:string, requestBody:Erp_Tablesets_DeviceRow, epicorHeaders?:Headers){
...
export function post_GetCodeDescList(requestBody:GetCodeDescList_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckDeviceTypeCount(requestBody:CheckDeviceTypeCount_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckDeviceTypeCount_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CheckDeviceTypeCount_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckForDefaultDeviceType(requestBody:CheckForDefaultDeviceType_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckForDefaultDeviceType_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CheckForDefaultDeviceType_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_DuplicateStation(requestBody:DuplicateStation_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DuplicateStation_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as DuplicateStation_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewWorkStation(requestBody:GetNewWorkStation_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewWorkStation_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewWorkStation_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewDevice(requestBody:GetNewDevice_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewDevice_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewDevice_output)
          })
      .catch((error) => {
          reject(error)
      })
