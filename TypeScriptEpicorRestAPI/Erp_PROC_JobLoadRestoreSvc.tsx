...
/** 
// Title: Erp.PROC.JobLoadRestoreSvc
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method fillJobLoadHead
   Description: Parameters:  none
   OperationID: fillJobLoadHead
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/fillJobLoadHead_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_fillJobLoadHead(epicorHeaders?:Headers){
   ...
   return (new Promise<fillJobLoadHead_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/fillJobLoadHead", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as fillJobLoadHead_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetJobRecords
   Description: This method copies job
   OperationID: GetJobRecords
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetJobRecords_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetJobRecords_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetJobRecords(requestBody:GetJobRecords_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetJobRecords_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/GetJobRecords", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as GetJobRecords_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetNewJobLoadHead
   Description: Check valid job number for new record in JobLoadHead
   OperationID: GetNewJobLoadHead
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetNewJobLoadHead_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetNewJobLoadHead_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewJobLoadHead(requestBody:GetNewJobLoadHead_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewJobLoadHead_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/GetNewJobLoadHead", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewJobLoadHead_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method lastRunDate
   OperationID: lastRunDate
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/lastRunDate_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/lastRunDate_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_lastRunDate(requestBody:lastRunDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<lastRunDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/lastRunDate", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as lastRunDate_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method ValidJobNum
   Description: Check valid job number for new record in JobLoadHead
   OperationID: ValidJobNum
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ValidJobNum_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ValidJobNum_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ValidJobNum(requestBody:ValidJobNum_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ValidJobNum_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/ValidJobNum", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ValidJobNum_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.JobLoadRestoreSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_JobLoadHeadRow{
...
export interface Erp_Tablesets_JobLoadRestoreParamRow{
   JobList1:string,
   JobList2:string,
   JobList3:string,
   LastRunDate:string,
   ...
   LastRunUserID:string,
      /**  Number of schedulers to startup for Global Finite Scheduling  */  
   NumSchedulers:number,
      /**  If true user is allowed to view and edit the list of jobs (add/delete)  */  
   OverRideJobList:boolean,
   Plant:string,
   ProcSource:string,
   StartDate:string,
...
export interface Erp_Tablesets_JobLoadRestoreTableset{
   JobLoadRestoreParam:Erp_Tablesets_JobLoadRestoreParamRow[],
   JobLoadHead:Erp_Tablesets_JobLoadHeadRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_JobLoadRestoreTableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param ds
   */  
export interface GetJobRecords_input{
   ds:Erp_Tablesets_JobLoadRestoreTableset[],
}

export interface GetJobRecords_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_JobLoadRestoreTableset,
}
   ...
   /** Required : 
      @param ds
   */  
export interface GetNewJobLoadHead_input{
   ds:Erp_Tablesets_JobLoadRestoreTableset[],
}

export interface GetNewJobLoadHead_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_JobLoadRestoreTableset,
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_JobLoadRestoreTableset[],
}
...
export interface SubmitToAgent_output{
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface ValidJobNum_input{
      /**  The job number  */  
   nJobNum:string,
   ds:Erp_Tablesets_JobLoadRestoreTableset[],
}

export interface ValidJobNum_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_JobLoadRestoreTableset,
}
...
export interface fillJobLoadHead_output{
}

   /** Required : 
      @param il_SetLastRunDate
   */  
export interface lastRunDate_input{
   il_SetLastRunDate:boolean,
}

export interface lastRunDate_output{
parameters : {
      /**  output parameters  */  
   outputdate:string,
   outputtime:number,
