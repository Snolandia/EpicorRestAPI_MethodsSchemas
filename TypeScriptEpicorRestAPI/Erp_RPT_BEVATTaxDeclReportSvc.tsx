...
/** 
// Title: Erp.RPT.BEVATTaxDeclReportSvc
// Description: BE VAT Declaration report
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method OnChangeTaxReportID
   Description: Method to call when changing the TaxReportID on the Report.
   OperationID: OnChangeTaxReportID
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/OnChangeTaxReportID_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/OnChangeTaxReportID_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeTaxReportID(requestBody:OnChangeTaxReportID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeTaxReportID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/OnChangeTaxReportID", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as OnChangeTaxReportID_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Description: Method to call when changing the Electronic Interface for the Report.
...
export function post_OnChangeEFTHeadUID(requestBody:OnChangeEFTHeadUID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeEFTHeadUID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/OnChangeEFTHeadUID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   /**  
   Summary: Invoke method ExportTaxDeclReport
   Description: Export VAT Declaration Report to *.xml file.
   OperationID: ExportTaxDeclReport
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ExportTaxDeclReport_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ExportTaxDeclReport_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ExportTaxDeclReport(requestBody:ExportTaxDeclReport_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ExportTaxDeclReport_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/ExportTaxDeclReport", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ExportTaxDeclReport_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.BEVATTaxDeclReportSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_BEVATTaxDeclReportParamRow{
      /**  VAT Tax Report ID  */  
   TaxReportID:string,
      /**  Report period: yyyy-mm  */  
   Period:string,
      /**  VAT Tax Report Description  */  
   Description:string,
      /**  Indicate whether VAT Tax Report is Posted.  */  
   Posted:boolean,
      /**  Demand Payment  */  
   AskPayment:boolean,
      /**  Demand Restitution  */  
   ...
   ClientListing:boolean,
      /**  Declaration Comment  */  
   Comment:string,
      /**  Declaration Language: Dutch, French and German  */  
   DeclLanguage:string,
      /**  Export Electronic Interface ID  */  
   EFTHeadUID:number,
      /**  Output File  */  
   OutputFile:string,
   SysRowID:string,
...
export interface Erp_Tablesets_BEVATTaxDeclReportTableset{
   BEVATTaxDeclReportParam:Erp_Tablesets_BEVATTaxDeclReportParamRow[],
...
mfgsysdata\EDI  */  
   ...
   /** Required : 
      ...
      @param ipFileFile
   */  
export interface ExportTaxDeclReport_input{
   ds:Erp_Tablesets_BEVATTaxDeclReportTableset[],
      /**  File Name  */  
   ipFileFile:string,
}

export interface ExportTaxDeclReport_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_BEVATTaxDeclReportTableset,
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_BEVATTaxDeclReportTableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param proposedTaxReportID
      @param ds
   */  
export interface OnChangeTaxReportID_input{
      /**  The proposed TaxReportID  */  
   proposedTaxReportID:string,
   ds:Erp_Tablesets_BEVATTaxDeclReportTableset[],
}

export interface OnChangeTaxReportID_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_BEVATTaxDeclReportTableset,
}
