...
export function get_SalesReps(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_SalesReps(requestBody:Erp_Tablesets_SalesRepRow, epicorHeaders?:Headers){
...
export function get_SalesReps_Company_SalesRepCode(Company:string, SalesRepCode:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SalesReps_Company_SalesRepCode(Company:string, SalesRepCode:string, requestBody:Erp_Tablesets_SalesRepRow, epicorHeaders?:Headers){
...
export function get_SaleAuths(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SaleAuths(requestBody:Erp_Tablesets_SaleAuthRow, epicorHeaders?:Headers){
...
export function get_SaleAuths_Company_SalesRepCode_DcdUserID(Company:string, SalesRepCode:string, DcdUserID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SaleAuths_Company_SalesRepCode_DcdUserID(Company:string, SalesRepCode:string, DcdUserID:string, requestBody:Erp_Tablesets_SaleAuthRow, epicorHeaders?:Headers){
...
export function get_SalesRepAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SalesRepAttches(requestBody:Erp_Tablesets_SalesRepAttchRow, epicorHeaders?:Headers){
...
export function get_SalesRepAttches_Company_SalesRepCode_DrawingSeq(Company:string, SalesRepCode:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SalesRepAttches_Company_SalesRepCode_DrawingSeq(Company:string, SalesRepCode:string, DrawingSeq:string, requestBody:Erp_Tablesets_SalesRepAttchRow, epicorHeaders?:Headers){
...
2. The user does not have a primary salesrep.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_DefaultDefaultUser(requestBody:DefaultDefaultUser_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DefaultDefaultUser_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as DefaultDefaultUser_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetPerConData(requestBody:GetPerConData_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeUserID(requestBody:OnChangeUserID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeUserID_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeUserID_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetNewSalesRep(requestBody:GetNewSalesRep_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSalesRepAttch(requestBody:GetNewSalesRepAttch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewSalesRepAttch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewSalesRepAttch_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSaleAuth(requestBody:GetNewSaleAuth_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewSaleAuth_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewSaleAuth_output)
          })
      .catch((error) => {
          reject(error)
      })
