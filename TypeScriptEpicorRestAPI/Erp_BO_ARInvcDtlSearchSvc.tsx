...
export function get_ARInvcDtlSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ARInvcDtlSearches(requestBody:Erp_Tablesets_InvcDtlRow, epicorHeaders?:Headers){
...
export function get_ARInvcDtlSearches_Company_InvoiceNum_InvoiceLine(Company:string, InvoiceNum:string, InvoiceLine:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ARInvcDtlSearches_Company_InvoiceNum_InvoiceLine(Company:string, InvoiceNum:string, InvoiceLine:string, requestBody:Erp_Tablesets_InvcDtlRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListAlternalSearch(requestBody:GetListAlternalSearch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetListAlternalSearch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetListAlternalSearch_output)
          })
      .catch((error) => {
          reject(error)
      })
