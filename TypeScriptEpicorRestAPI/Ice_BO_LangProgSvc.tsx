...
export function get_LangProgs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_LangProgs(requestBody:any, epicorHeaders?:Headers){
...
export function get_LangProgs_Company_ProgramID(Company:string, ProgramID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_LangProgs_Company_ProgramID(Company:string, ProgramID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewLangProg(requestBody:any, epicorHeaders?:Headers){
