...
export function get_KanBanTypes(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_KanBanTypes(requestBody:Erp_Tablesets_KanBanTypeRow, epicorHeaders?:Headers){
...
export function get_KanBanTypes_Company_KBCode(Company:string, KBCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_KanBanTypes_Company_KBCode(Company:string, KBCode:string, requestBody:Erp_Tablesets_KanBanTypeRow, epicorHeaders?:Headers){
...
export function post_GetCodeDescList(requestBody:GetCodeDescList_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewKanBanType(requestBody:GetNewKanBanType_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewKanBanType_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewKanBanType_output)
          })
      .catch((error) => {
          reject(error)
      })
