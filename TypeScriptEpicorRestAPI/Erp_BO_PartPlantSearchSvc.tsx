...
export function get_PartPlantSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PartPlantSearches(requestBody:Erp_Tablesets_PartPlantRow, epicorHeaders?:Headers){
...
export function get_PartPlantSearches_Company_PartNum_Plant(Company:string, PartNum:string, Plant:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PartPlantSearches_Company_PartNum_Plant(Company:string, PartNum:string, Plant:string, requestBody:Erp_Tablesets_PartPlantRow, epicorHeaders?:Headers){
...
export function post_GetActiveParts(requestBody:GetActiveParts_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetPartPlantPlanningParameters(requestBody:GetPartPlantPlanningParameters_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetPartPlantPlanningParameters_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetPartPlantPlanningParameters_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartPlant(requestBody:GetNewPartPlant_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPartPlant_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPartPlant_output)
          })
      .catch((error) => {
          reject(error)
      })
