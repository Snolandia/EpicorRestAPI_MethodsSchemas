...
export function get_AlternateParts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_AlternateParts(requestBody:Erp_Tablesets_PartSubsRow, epicorHeaders?:Headers){
...
export function get_AlternateParts_Company_PartNum_SubPart(Company:string, PartNum:string, SubPart:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_AlternateParts_Company_PartNum_SubPart(Company:string, PartNum:string, SubPart:string, requestBody:Erp_Tablesets_PartSubsRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListAlternateParts(requestBody:GetListAlternateParts_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetListAlternateParts_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetListAlternateParts_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListAlternatePartsForSO(requestBody:GetListAlternatePartsForSO_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetListAlternatePartsForSO_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetListAlternatePartsForSO_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartSubs(requestBody:GetNewPartSubs_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPartSubs_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPartSubs_output)
          })
      .catch((error) => {
          reject(error)
      })
