...
/** 
// Title: Erp.PROC.PBInvcGenProcSvc
// Description: PBInvcGenProcSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetCodeDescList(requestBody:GetCodeDescList_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetCodeDescList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/GetCodeDescList", {
          method: 'post',
          headers: headers,
   ...
   /**  
   Summary: Invoke method PreSubmitToAgent
   Description: This will update InvcType and WBSPhaseList before invoking SubmitToAgent
   OperationID: PreSubmitToAgent
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/PreSubmitToAgent_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/PreSubmitToAgent_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PreSubmitToAgent(requestBody:PreSubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PreSubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/PreSubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as PreSubmitToAgent_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PBInvcGenProcSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_PBInvcGenParamRow{
      /**  Ending date for the range which is used to prepare the invoices.  */  
   PeriodEndDate:string,
      /**  Date that will be used when the invoices are posted  */  
   InvoiceDate:string,
      /**  List of selected Invoicing Methods: FF=Fixed Fee, TM = Time & Materials, CP = Cost Plus, PP = Progress Payments. e.g. "TM,FF,CP", it is calculated on UI from checkboxes  */  
   InvcType:string,
      /**  Project ID List from the Filter tab  */  
   PrjList:string,
   AutoPrint:boolean,
   AutoApprove:boolean,
      /**  Include actuals against WBS Phases where the Invoicing Method is ?Cost Plus?  */  
   InvCP:boolean,
      /**  Include actuals against WBS Phases where the Invoicing Method is ?Fixed Fee?  */  
   InvFF:boolean,
      /**  Include actuals against WBS Phases where the Invoicing Method is ?Time and Material?  */  
   InvTM:boolean,
      /**  Include actuals against WBS Phases where the Invoicing Method is ?Progress Payment?  */  
   InvPP:boolean,
      /**  Project ID/Phase ID List from the Filter panel  */  
   WBSPhaseList:string,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_PBInvcGenProcTableset{
   PBInvcGenParam:Erp_Tablesets_PBInvcGenParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_PBInvcGenProcTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_PBInvcGenProcTableset[],
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      ...
      @param maintProgram
   */  
export interface PreSubmitToAgent_input{
   ds:Erp_Tablesets_PBInvcGenProcTableset[],
   agentID:string,
   agentSchedNum:number,
   agentTaskNum:number,
...
export interface PreSubmitToAgent_output{
}
