...
export function get_GUIBatchAssignLNs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GUIBatchAssignLNs(requestBody:Erp_Tablesets_GUINumHedRow, epicorHeaders?:Headers){
...
export function get_GUIBatchAssignLNs_Company_FiscalYear_FiscalYearSuffix_FiscalPeriod_TranDocTypeID(Company:string, FiscalYear:string, FiscalYearSuffix:string, FiscalPeriod:string, TranDocTypeID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GUIBatchAssignLNs_Company_FiscalYear_FiscalYearSuffix_FiscalPeriod_TranDocTypeID(Company:string, FiscalYear:string, FiscalYearSuffix:string, FiscalPeriod:string, TranDocTypeID:string, requestBody:Erp_Tablesets_GUINumHedRow, epicorHeaders?:Headers){
...
export function get_GUIARAutomatics(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GUIARAutomatics(requestBody:Erp_Tablesets_GUIARAutomaticRow, epicorHeaders?:Headers){
...
export function get_GUIARAutomatics_SysRowID(SysRowID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GUIARAutomatics_SysRowID(SysRowID:string, requestBody:Erp_Tablesets_GUIARAutomaticRow, epicorHeaders?:Headers){
...
export function get_GUIARManuals(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GUIARManuals(requestBody:Erp_Tablesets_GUIARManualRow, epicorHeaders?:Headers){
...
export function get_GUIARManuals_SysRowID(SysRowID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GUIARManuals_SysRowID(SysRowID:string, requestBody:Erp_Tablesets_GUIARManualRow, epicorHeaders?:Headers){
...
export function get_GUINumDtlLists(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GUINumDtlLists(requestBody:Erp_Tablesets_GUINumDtlListRow, epicorHeaders?:Headers){
...
export function get_GUINumDtlLists_Company_FiscalYear_FiscalYearSuffix_FiscalPeriod_TranDocTypeID_GroupID(Company:string, FiscalYear:string, FiscalYearSuffix:string, FiscalPeriod:string, TranDocTypeID:string, GroupID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GUINumDtlLists_Company_FiscalYear_FiscalYearSuffix_FiscalPeriod_TranDocTypeID_GroupID(Company:string, FiscalYear:string, FiscalYearSuffix:string, FiscalPeriod:string, TranDocTypeID:string, GroupID:string, requestBody:Erp_Tablesets_GUINumDtlListRow, epicorHeaders?:Headers){
...
export function post_OnChangeTranDocTypeID(requestBody:OnChangeTranDocTypeID_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetInvoice(requestBody:GetInvoice_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetInvoice_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetInvoice_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_Simulation(requestBody:Simulation_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Simulation_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as Simulation_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetNewGUINumHed(requestBody:GetNewGUINumHed_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGUINumDtlList(requestBody:GetNewGUINumDtlList_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGUINumDtlList_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGUINumDtlList_output)
          })
      .catch((error) => {
          reject(error)
      })
