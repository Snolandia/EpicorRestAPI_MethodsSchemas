...
export function get_JPAPPerBills(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_JPAPPerBills(requestBody:any, epicorHeaders?:Headers){
...
export function get_JPAPPerBills_Company_VendorNum(Company:string, VendorNum:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_JPAPPerBills_Company_VendorNum(Company:string, VendorNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_JPAPPerBillDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_JPAPPerBillDtls(requestBody:any, epicorHeaders?:Headers){
...
export function get_JPAPPerBillDtls_Company_VendorNum_SummarizationDay(Company:string, VendorNum:string, SummarizationDay:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_JPAPPerBillDtls_Company_VendorNum_SummarizationDay(Company:string, VendorNum:string, SummarizationDay:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetVendorNumByVendorID(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetByVendorID(requestBody:any, epicorHeaders?:Headers){
...
export function post_ValidateSummDay(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewJPAPPerBillHead(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewJPAPPerBillDtl(requestBody:any, epicorHeaders?:Headers){
