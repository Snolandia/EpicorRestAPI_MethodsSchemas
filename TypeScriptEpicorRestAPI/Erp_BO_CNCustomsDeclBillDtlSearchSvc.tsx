...
export function get_CNCustomsDeclBillDtlSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_CNCustomsDeclBillDtlSearches(requestBody:Erp_Tablesets_CNCustomsDeclBillDtlSearchRow, epicorHeaders?:Headers){
...
export function get_CNCustomsDeclBillDtlSearches_Company_DeclarationBill_DeclarationBillLine(Company:string, DeclarationBill:string, DeclarationBillLine:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_CNCustomsDeclBillDtlSearches_Company_DeclarationBill_DeclarationBillLine(Company:string, DeclarationBill:string, DeclarationBillLine:string, requestBody:Erp_Tablesets_CNCustomsDeclBillDtlSearchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetRowsOfSrcDocumentType(requestBody:GetRowsOfSrcDocumentType_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRowsOfSrcDocumentType_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetRowsOfSrcDocumentType_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewCNCustomsDeclBillDtlSearch(requestBody:GetNewCNCustomsDeclBillDtlSearch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewCNCustomsDeclBillDtlSearch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewCNCustomsDeclBillDtlSearch_output)
          })
      .catch((error) => {
          reject(error)
      })
