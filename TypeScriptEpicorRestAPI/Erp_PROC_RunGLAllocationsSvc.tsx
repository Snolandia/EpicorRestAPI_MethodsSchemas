...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_GetSchedAllocations(requestBody:GetSchedAllocations_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetSchedAllocations_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/GetSchedAllocations", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as GetSchedAllocations_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetSearchFilter(requestBody:GetSearchFilter_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetSearchFilter_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/GetSearchFilter", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetSearchFilter_output)
          })
      .catch((error) => {
          reject(error)
      })
...
<param name="ds"> Run GL Allocations DataSet</param><param name="ipYTDAlloc">logical for ytd allocations</param>
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SetYTDStartDate(requestBody:SetYTDStartDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SetYTDStartDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/SetYTDStartDate", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as SetYTDStartDate_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_UpdGLAllocBatches(requestBody:UpdGLAllocBatches_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UpdGLAllocBatches_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/UpdGLAllocBatches", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as UpdGLAllocBatches_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ValidateApplyDate(requestBody:ValidateApplyDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ValidateApplyDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/ValidateApplyDate", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ValidateApplyDate_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetApplicationDefaults(requestBody:GetApplicationDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetApplicationDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/GetApplicationDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetDefaultApplyDates(requestBody:GetDefaultApplyDates_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaultApplyDates_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/GetDefaultApplyDates", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetDefaultApplyDates_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnFiscalPeriodChanged(requestBody:OnFiscalPeriodChanged_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnFiscalPeriodChanged_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/OnFiscalPeriodChanged", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as OnFiscalPeriodChanged_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnGLBookChanged(requestBody:OnGLBookChanged_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnGLBookChanged_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/OnGLBookChanged", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as OnGLBookChanged_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetDefaultFiscalPeriod(requestBody:GetDefaultFiscalPeriod_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaultFiscalPeriod_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/GetDefaultFiscalPeriod", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetDefaultFiscalPeriod_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.RunGLAllocationsSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_GLAllocBatchesRow{
   BatchID:string,
   BookID:string,
   SchedDate:string,
   Reverse:boolean,
...
export interface Erp_Tablesets_RunGLAllocationsParamRow{
   ApplyDate:string,
   FiscalPeriod:number,
   FiscalYear:number,
   ...
   YTDAlloc:boolean,
   FiscalPerStart:string,
   FiscalPerEnd:string,
      /**  List scheduled dates for batches to process  */  
   SchedDateList:string,
   ReversalDate:string,
   ApplyDatesOption:string,
      /**  Period, DatesRange  */  
   SelectBy:string,
   SysRowID:string,
   AutoAction:string,
...
export interface Erp_Tablesets_RunGLAllocationsTableset{
   RunGLAllocationsParam:Erp_Tablesets_RunGLAllocationsParamRow[],
   GLAllocBatches:Erp_Tablesets_GLAllocBatchesRow[],
...
export interface GetApplicationDefaults_input{
   ds:Erp_Tablesets_RunGLAllocationsTableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param ds
   */  
export interface GetDefaultApplyDates_input{
   ds:Erp_Tablesets_RunGLAllocationsTableset[],
}

export interface GetDefaultApplyDates_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_RunGLAllocationsTableset,
}
   ...
   /** Required : 
      @param ds
   */  
export interface GetDefaultFiscalPeriod_input{
   ds:Erp_Tablesets_RunGLAllocationsTableset[],
}

export interface GetDefaultFiscalPeriod_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_RunGLAllocationsTableset,
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_RunGLAllocationsTableset[],
}
...
export interface GetParamsFromAgent_output{
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface GetSchedAllocations_input{
...
export interface GetSchedAllocations_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_RunGLAllocationsTableset,
}
   ...
   /** Required : 
      ...
      @param ipEndDate
   */  
export interface GetSearchFilter_input{
      /**  Book ID  for the Allocation Batch search  */  
   ipBookID:string,
...
export interface GetSearchFilter_output{
parameters : {
      /**  output parameters  */  
   myFilter:string,
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      @param ds
   */  
export interface OnFiscalPeriodChanged_input{
   ds:Erp_Tablesets_RunGLAllocationsTableset[],
}

export interface OnFiscalPeriodChanged_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_RunGLAllocationsTableset,
}
   ...
   /** Required : 
      @param ds
   */  
export interface OnGLBookChanged_input{
   ds:Erp_Tablesets_RunGLAllocationsTableset[],
}

export interface OnGLBookChanged_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_RunGLAllocationsTableset,
}
...
export interface SaveProcessTask_output{
   ...
   /** Required : 
      ...
      @param ipYTDAlloc
   */  
export interface SetYTDStartDate_input{
   ds:Erp_Tablesets_RunGLAllocationsTableset[],
   ipYTDAlloc:boolean,
}

export interface SetYTDStartDate_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_RunGLAllocationsTableset,
}
...
export interface SubmitToAgent_output{
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface UpdGLAllocBatches_input{
      /**  Book ID  for the Allocation Batch search  */  
   ipBookID:string,
      /**  List of Batch IDs  */  
   ipBatchIDList:string,
   ds:Erp_Tablesets_RunGLAllocationsTableset[],
}

export interface UpdGLAllocBatches_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_RunGLAllocationsTableset,
}
   ...
   /** Required : 
      ...
      @param ipApplyDate
   */  
export interface ValidateApplyDate_input{
      /**  Book ID  for the Allocation Batch search  */  
   ipBookID:string,
...
export interface ValidateApplyDate_output{
}
