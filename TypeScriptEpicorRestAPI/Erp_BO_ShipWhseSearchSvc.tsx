...
export function get_ShipWhseSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ShipWhseSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_ShipWhseSearches_Company_PartNum_WarehouseCode(Company:string, PartNum:string, WarehouseCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ShipWhseSearches_Company_PartNum_WarehouseCode(Company:string, PartNum:string, WarehouseCode:string, requestBody:any, epicorHeaders?:Headers){
