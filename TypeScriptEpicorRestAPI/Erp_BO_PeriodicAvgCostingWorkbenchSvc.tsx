...
export function get_PeriodicAvgCostingWorkbenches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PeriodicAvgCostingWorkbenches(requestBody:Erp_Tablesets_PeriodicAverageCostHeadRow, epicorHeaders?:Headers){
...
export function get_PeriodicAvgCostingWorkbenches_Company_Plant_PeriodicAverageCostID_CalculationNum(Company:string, Plant:string, PeriodicAverageCostID:string, CalculationNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PeriodicAvgCostingWorkbenches_Company_Plant_PeriodicAverageCostID_CalculationNum(Company:string, Plant:string, PeriodicAverageCostID:string, CalculationNum:string, requestBody:Erp_Tablesets_PeriodicAverageCostHeadRow, epicorHeaders?:Headers){
...
export function post_OnChangedFiscalYrPeriod(requestBody:OnChangedFiscalYrPeriod_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetPeriodicAverageCostLineRows(requestBody:GetPeriodicAverageCostLineRows_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetPeriodicAverageCostLineRows_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetPeriodicAverageCostLineRows_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPeriodicAverageCostHead(requestBody:GetNewPeriodicAverageCostHead_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPeriodicAverageCostHead_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPeriodicAverageCostHead_output)
          })
      .catch((error) => {
          reject(error)
      })
