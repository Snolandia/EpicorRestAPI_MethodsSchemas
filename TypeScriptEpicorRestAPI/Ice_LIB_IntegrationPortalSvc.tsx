...
export function get_GetContext(epicorHeaders?:Headers){
   ...
   return (new Promise<GetContext_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetContext_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_ListAutomationStudioAPICollections(pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<ListAutomationStudioAPICollections_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ListAutomationStudioAPICollections_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_ListAutomationStudioAPIEndpoints(collectionPath:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<ListAutomationStudioAPIEndpoints_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ListAutomationStudioAPIEndpoints_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_IsAutomationStudioAPIEndpointValid(collectionPath:string, endpointPath:string, method:string, epicorHeaders?:Headers){
   ...
   return (new Promise<IsAutomationStudioAPIEndpointValid_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as IsAutomationStudioAPIEndpointValid_output)
          })
      .catch((error) => {
          reject(error)
      })
