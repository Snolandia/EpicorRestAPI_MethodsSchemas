...
export function get_ESignatures(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ESignatures(requestBody:Ice_Tablesets_ESignatureAuditRow, epicorHeaders?:Headers){
...
export function get_ESignatures_SysRowID(SysRowID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ESignatures_SysRowID(SysRowID:string, requestBody:Ice_Tablesets_ESignatureAuditRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetByRelatedToSysRowID(requestBody:GetByRelatedToSysRowID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetByRelatedToSysRowID_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetByRelatedToSysRowID_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_DoesESignatureAuditExist(requestBody:DoesESignatureAuditExist_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DoesESignatureAuditExist_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as DoesESignatureAuditExist_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewESignatureAudit(requestBody:GetNewESignatureAudit_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewESignatureAudit_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewESignatureAudit_output)
          })
      .catch((error) => {
          reject(error)
      })
