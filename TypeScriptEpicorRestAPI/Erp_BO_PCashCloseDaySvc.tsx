...
export function get_PCashCloseDays(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PCashCloseDays(requestBody:Erp_Tablesets_PCashBalRow, epicorHeaders?:Headers){
...
export function get_PCashCloseDays_Company_CashDeskID_Date(Company:string, CashDeskID:string, Date:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PCashCloseDays_Company_CashDeskID_Date(Company:string, CashDeskID:string, Date:string, requestBody:Erp_Tablesets_PCashBalRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ClosePettyCashDay(requestBody:ClosePettyCashDay_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ClosePettyCashDay_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ClosePettyCashDay_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPCashBal(requestBody:GetNewPCashBal_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPCashBal_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPCashBal_output)
          })
      .catch((error) => {
          reject(error)
      })
