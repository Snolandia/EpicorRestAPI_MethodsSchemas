...
export function get_JobClosingCds(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_JobClosingCds(requestBody:Erp_Tablesets_JobClosingCdRow, epicorHeaders?:Headers){
...
export function get_JobClosingCds_Company_JobClosingCode(Company:string, JobClosingCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_JobClosingCds_Company_JobClosingCode(Company:string, JobClosingCode:string, requestBody:Erp_Tablesets_JobClosingCdRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewJobClosingCd(requestBody:GetNewJobClosingCd_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewJobClosingCd_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewJobClosingCd_output)
          })
      .catch((error) => {
          reject(error)
      })
