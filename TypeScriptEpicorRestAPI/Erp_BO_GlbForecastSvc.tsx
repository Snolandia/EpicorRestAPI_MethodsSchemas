...
export function get_GlbForecasts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GlbForecasts(requestBody:any, epicorHeaders?:Headers){
...
export function get_GlbForecasts_Company_PartNum_Plant_ForeDate_CustNum(Company:string, PartNum:string, Plant:string, ForeDate:string, CustNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GlbForecasts_Company_PartNum_Plant_ForeDate_CustNum(Company:string, PartNum:string, Plant:string, ForeDate:string, CustNum:string, requestBody:any, epicorHeaders?:Headers){
...
Similar to the ImportForecasts routine, which takes in a dataset derived from a spreadsheet file.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_AcceptGlbForecasts(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ClearGlbForecasts(requestBody:any, epicorHeaders?:Headers){
...
export function post_IsConfigurable(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGlbForecast(requestBody:any, epicorHeaders?:Headers){
