...
export function get_GetListExcludeInactive(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetListExcludeInactive_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetListExcludeInactive_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetRowsExcludeInactive(whereClausePerConSearch:string, whereClausePerConLnkSearch:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRowsExcludeInactive_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetRowsExcludeInactive_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetRowsPaging(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRowsPaging_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetRowsPaging_output)
          })
      .catch((error) => {
          reject(error)
      })
