...
export function get_InternalPartCrossRefs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_InternalPartCrossRefs(requestBody:Erp_Tablesets_PartRefRow, epicorHeaders?:Headers){
...
export function get_InternalPartCrossRefs_Company_PartNum_XRefPartNum(Company:string, PartNum:string, XRefPartNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_InternalPartCrossRefs_Company_PartNum_XRefPartNum(Company:string, PartNum:string, XRefPartNum:string, requestBody:Erp_Tablesets_PartRefRow, epicorHeaders?:Headers){
...
export function post_ChangeMaskPrefixSuffix(requestBody:ChangeMaskPrefixSuffix_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangePartRefPartNum(requestBody:ChangePartRefPartNum_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangePartRefPartNum_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ChangePartRefPartNum_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangePartRefSNMask(requestBody:ChangePartRefSNMask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangePartRefSNMask_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ChangePartRefSNMask_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangePartRefSNOverride(requestBody:ChangePartRefSNOverride_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangePartRefSNOverride_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ChangePartRefSNOverride_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangePartRefXRefPartNum(requestBody:ChangePartRefXRefPartNum_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangePartRefXRefPartNum_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ChangePartRefXRefPartNum_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetInternalPartXRef(requestBody:GetInternalPartXRef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetInternalPartXRef_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetInternalPartXRef_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_ValidatePartNum(requestBody:ValidatePartNum_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SetPartNum(requestBody:SetPartNum_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SetPartNum_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as SetPartNum_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartRef(requestBody:GetNewPartRef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPartRef_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPartRef_output)
          })
      .catch((error) => {
          reject(error)
      })
