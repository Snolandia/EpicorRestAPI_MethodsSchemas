...
export function get_PAPlans(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PAPlans(requestBody:Erp_Tablesets_PAPlanRow, epicorHeaders?:Headers){
...
export function get_PAPlans_Company_PAPlanID(Company:string, PAPlanID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PAPlans_Company_PAPlanID(Company:string, PAPlanID:string, requestBody:Erp_Tablesets_PAPlanRow, epicorHeaders?:Headers){
...
export function get_PAPlanDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PAPlanDtls(requestBody:Erp_Tablesets_PAPlanDtlRow, epicorHeaders?:Headers){
...
export function get_PAPlanDtls_Company_PAPlanID_PAPlanDtlID(Company:string, PAPlanID:string, PAPlanDtlID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PAPlanDtls_Company_PAPlanID_PAPlanDtlID(Company:string, PAPlanID:string, PAPlanDtlID:string, requestBody:Erp_Tablesets_PAPlanDtlRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeWeekID(requestBody:ChangeWeekID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeWeekID_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ChangeWeekID_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPAPlan(requestBody:GetNewPAPlan_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPAPlan_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPAPlan_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPAPlanDtl(requestBody:GetNewPAPlanDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPAPlanDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPAPlanDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
