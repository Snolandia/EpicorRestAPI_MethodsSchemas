...
export function get_GlbTables(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GlbTables(requestBody:Erp_Tablesets_GlbTableRow, epicorHeaders?:Headers){
...
export function get_GlbTables_Company_TableName_ExtSystemID_ExtCompanyID(Company:string, TableName:string, ExtSystemID:string, ExtCompanyID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GlbTables_Company_TableName_ExtSystemID_ExtCompanyID(Company:string, TableName:string, ExtSystemID:string, ExtCompanyID:string, requestBody:Erp_Tablesets_GlbTableRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetAvailFields(requestBody:GetAvailFields_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetAvailFields_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetAvailFields_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetCodeDescList(requestBody:GetCodeDescList_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeCompany(requestBody:OnChangeCompany_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeCompany_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeCompany_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGlbTable(requestBody:GetNewGlbTable_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGlbTable_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGlbTable_output)
          })
      .catch((error) => {
          reject(error)
      })
