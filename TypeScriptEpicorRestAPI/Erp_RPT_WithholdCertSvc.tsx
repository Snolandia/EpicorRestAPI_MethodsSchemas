...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method IsManualGenType
   Description: Check if tran doc type is associated to a manual generation legal number
   OperationID: IsManualGenType
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/IsManualGenType_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/IsManualGenType_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_IsManualGenType(requestBody:IsManualGenType_input, epicorHeaders?:Headers){
   ...
   return (new Promise<IsManualGenType_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/IsManualGenType", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as IsManualGenType_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method PECheckCertificatePrinting
   Description: Check Generation options
   OperationID: PECheckCertificatePrinting
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/PECheckCertificatePrinting_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/PECheckCertificatePrinting_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PECheckCertificatePrinting(requestBody:PECheckCertificatePrinting_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PECheckCertificatePrinting_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/PECheckCertificatePrinting", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as PECheckCertificatePrinting_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.WithholdCertSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface Erp_Tablesets_WithholdCertParamRow{
   FromDate:string,
   FromDateToken:string,
      /**  Yes indicates that only already printed cetificates will be printed. No indicates that only not printed before certificates will be printed.  */  
   Reprint:boolean,
   ToDate:string,
   ToDateToken:string,
      /**  D = DateRange.  I = Invoice . P  = Payment  */  
   PrintPer:string,
      /**  The list of suppliers to print WithHolding Tax Certificates for.  */  
   SupplierList:string,
   TaxTypeList:string,
   TaxLiabilityList:string,
   ReportCategoryList:string,
      /**  Only when reprint is selected  */  
   CertNumberList:string,
      /**  Transaction Document type ID (for legail numbers)  */  
   TranDocTypeID:string,
   TranDocTypeDesc:string,
      /**  Indicates if user submits report for printing.  */  
   PrintOption:boolean,
   PaymentNumList:string,
...
export interface Erp_Tablesets_WithholdCertTableset{
   WithholdCertParam:Erp_Tablesets_WithholdCertParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_WithholdCertTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_WithholdCertTableset[],
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      @param docTranType
   */  
export interface IsManualGenType_input{
      /**  Transaction document type  */  
   docTranType:string,
}

export interface IsManualGenType_output{
}

   /** Required : 
      @param ds
   */  
export interface PECheckCertificatePrinting_input{
   ds:Erp_Tablesets_WithholdCertTableset[],
}

export interface PECheckCertificatePrinting_output{
parameters : {
      /**  output parameters  */  
   warning:string,
}
