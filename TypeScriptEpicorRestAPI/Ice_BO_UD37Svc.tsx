...
export function get_UD37s(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_UD37s(requestBody:Ice_Tablesets_UD37Row, epicorHeaders?:Headers){
...
export function get_UD37s_Company_Key1_Key2_Key3_Key4_Key5(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UD37s_Company_Key1_Key2_Key3_Key4_Key5(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, requestBody:Ice_Tablesets_UD37Row, epicorHeaders?:Headers){
...
export function get_UD37Attchs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_UD37Attchs(requestBody:Ice_Tablesets_UD37AttchRow, epicorHeaders?:Headers){
...
export function get_UD37Attchs_Company_Key1_Key2_Key3_Key4_Key5_DrawingSeq(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UD37Attchs_Company_Key1_Key2_Key3_Key4_Key5_DrawingSeq(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, DrawingSeq:string, requestBody:Ice_Tablesets_UD37AttchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetaNewUD37(requestBody:GetaNewUD37_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetaNewUD37_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetaNewUD37_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewUD37(requestBody:GetNewUD37_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewUD37_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewUD37_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewUD37Attch(requestBody:GetNewUD37Attch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewUD37Attch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewUD37Attch_output)
          })
      .catch((error) => {
          reject(error)
      })
