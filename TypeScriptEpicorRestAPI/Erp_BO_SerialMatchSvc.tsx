...
export function get_SerialMatches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_SerialMatches(requestBody:any, epicorHeaders?:Headers){
...
export function get_SerialMatches_Company_ChildPartNum_ChildSerialNo(Company:string, ChildPartNum:string, ChildSerialNo:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SerialMatches_Company_ChildPartNum_ChildSerialNo(Company:string, ChildPartNum:string, ChildSerialNo:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetRowsLLSerialNumberTracker(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetRowsWUSerialNumberTracker(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSerialMatch(requestBody:any, epicorHeaders?:Headers){
