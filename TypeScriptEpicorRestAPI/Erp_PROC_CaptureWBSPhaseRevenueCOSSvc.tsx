...
/** 
// Title: Erp.PROC.CaptureWBSPhaseRevenueCOSSvc
// Description: 
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method GetProjectDesc
   Description: Purpose: Method to get project Description.
   OperationID: GetProjectDesc
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetProjectDesc_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetProjectDesc_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetProjectDesc(requestBody:GetProjectDesc_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetProjectDesc_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/GetProjectDesc", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as GetProjectDesc_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method ProjectIDChanged
   Description: Get project Description.
   OperationID: ProjectIDChanged
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ProjectIDChanged_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ProjectIDChanged_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ProjectIDChanged(requestBody:ProjectIDChanged_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ProjectIDChanged_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/ProjectIDChanged", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ProjectIDChanged_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_getStartingDate(requestBody:getStartingDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<getStartingDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/getStartingDate", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_ChangeEndingDate(requestBody:ChangeEndingDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeEndingDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/ChangeEndingDate", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.CaptureWBSPhaseRevenueCOSSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface ChangeEndingDate_input{
   ds:Erp_Tablesets_CaptureWBSPhaseRevenueCOSTableset[],
      /**  The ending date  */  
   endDate:string,
}
...
export interface Erp_Tablesets_CaptureWBSPhaseRevenueCOSParamRow{
   ACTType:string,
   AsOfDate:string,
      /**  Called From program  */  
   CalledFrom:string,
   COSandWIPCall:boolean,
   Description:string,
...
export interface Erp_Tablesets_CaptureWBSPhaseRevenueCOSTableset{
   CaptureWBSPhaseRevenueCOSParam:Erp_Tablesets_CaptureWBSPhaseRevenueCOSParamRow[],
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_CaptureWBSPhaseRevenueCOSTableset[],
}
...
export interface GetParamsFromAgent_output{
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface GetProjectDesc_input{
      /**  Project ID  */  
   projectID:string,
   ds:Erp_Tablesets_CaptureWBSPhaseRevenueCOSTableset[],
}

export interface GetProjectDesc_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_CaptureWBSPhaseRevenueCOSTableset,
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      @param projectID
   */  
export interface ProjectIDChanged_input{
      /**  Project ID  */  
   projectID:string,
}

export interface ProjectIDChanged_output{
   returnObj:boolean,
}
