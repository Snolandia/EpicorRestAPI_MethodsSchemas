...
export function get_VendorPPSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_VendorPPSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_VendorPPSearches_Company_VendorNum_PurPoint(Company:string, VendorNum:string, PurPoint:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_VendorPPSearches_Company_VendorNum_PurPoint(Company:string, VendorNum:string, PurPoint:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListForActiveSuppliers(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_VendorPPListGetList(requestBody:any, epicorHeaders?:Headers){
