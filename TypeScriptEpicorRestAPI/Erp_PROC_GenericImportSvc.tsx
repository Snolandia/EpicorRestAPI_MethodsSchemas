...
/** 
// Title: Erp.PROC.GenericImportSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method verifyOutputLocation
   Description: Purpose: Checks if the given directory is a valid one.
Parameters:  none
Notes:
   OperationID: verifyOutputLocation
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/verifyOutputLocation_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/verifyOutputLocation_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_verifyOutputLocation(requestBody:verifyOutputLocation_input, epicorHeaders?:Headers){
   ...
   return (new Promise<verifyOutputLocation_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/verifyOutputLocation", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as verifyOutputLocation_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetInitialPath(epicorHeaders?:Headers){
   ...
   return (new Promise<GetInitialPath_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/GetInitialPath", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
   ...
   /**  
   Summary: Invoke method ProcessXML
   Description: Processes XML contents containing AR / AP invoice details and returns the last invoice groupID that was created
and the number of invoices that were processed within the group.
If you pass the GroupID / GroupConter invoices will be appended to the groupID up to the relevant InvPerGroup setting.
   OperationID: ProcessXML
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ProcessXML_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ProcessXML_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ProcessXML(requestBody:ProcessXML_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ProcessXML_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/ProcessXML", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ProcessXML_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GenericImportSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_GenericImportParamRow{
   Continuous:boolean,
   ProcessingDelay:number,
   LogFilename:string,
   Inactive:boolean,
      /**  Path where the files will be stored to be read by the generic import process.  */  
   XMLPath:string,
      /**  Number of AP Invoices per Group  */  
   APInvPerGroup:number,
      /**  Number of AR Invoices per Group  */  
   ARInvPerGroup:number,
      /**  If true, indicates the group will be relased to be processed when the current file reach the end of it. And by the contrary, if no, the group will try to read another file to continue adding data to this group if the number per group allow it.  */  
   GroupByFile:boolean,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_GenericImportTableset{
   GenericImportParam:Erp_Tablesets_GenericImportParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_GenericImportTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_GenericImportTableset[],
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      ...
      @param apInvPerGroup
      @param arInvPerGroup
      @param apInvoiceGroupID
      @param arInvoiceGroupID
   */  
export interface ProcessXML_input{
      /**  XML to parse containing the invoices  */  
   xmlContent:string,
      /**  When this option is true the process will close/release the current group when the end of xml content is reached. This occurs only if the number of invoices has not reached the number per group defined by the user.  */  
   groupByFile:boolean,
      /**  Number of AR Invoices to post per group  */  
   apInvPerGroup:number,
      /**  Number of AP Invoices to post per group  */  
   arInvPerGroup:number,
      /**  Returns the last AP Invoice GroupID created, if this value is passed invoices will be appended to the existing group  */  
   apInvoiceGroupID:string,
      /**  Returns the last AR Invoice GroupID created, if this value is passed invoices will be appended to the existing group  */  
   arInvoiceGroupID:string,
}

export interface ProcessXML_output{
...
export interface SubmitToAgent_output{
   ...
   /** Required : 
      @param ipXMLPath
   */  
export interface verifyOutputLocation_input{
   ipXMLPath:string,
}

export interface verifyOutputLocation_output{
}
