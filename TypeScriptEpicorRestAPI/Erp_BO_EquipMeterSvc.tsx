...
export function get_EquipMeters(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_EquipMeters(requestBody:Erp_Tablesets_EquipMeterRow, epicorHeaders?:Headers){
...
export function get_EquipMeters_Company_EquipID_TransNum(Company:string, EquipID:string, TransNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_EquipMeters_Company_EquipID_TransNum(Company:string, EquipID:string, TransNum:string, requestBody:Erp_Tablesets_EquipMeterRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewEquipMeter(requestBody:GetNewEquipMeter_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewEquipMeter_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewEquipMeter_output)
          })
      .catch((error) => {
          reject(error)
      })
