...
/** 
// Title: Erp.BO.TFOrdDtlSearchSvc
// Description: Search object for TFOrdDtl table
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Description: Get TFOrdDtlSearches items from the server using GetRows standard method. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li></ul></div>
   OperationID: GetRows_TFOrdDtlSearches
   ...
   */  
export function get_TFOrdDtlSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_TFOrdDtlRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/TFOrdDtlSearches", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   OperationID: NewUpdateExt_TFOrdDtlSearches
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas headers
   ...
   */  
export function post_TFOrdDtlSearches(requestBody:Erp_Tablesets_TFOrdDtlRow, epicorHeaders?:Headers){
   ...
   /**  
   Summary: Calls GetByID to retrieve the TFOrdDtlSearch item
   Description: Calls GetByID to retrieve the TFOrdDtlSearch item by specified keys. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li><li>String parameters should be specified in single quotes</li></ul></div>
   OperationID: GetById_TFOrdDtlSearch
   ...
   */  
export function get_TFOrdDtlSearches_Company_TFLineNum(Company:string, TFLineNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_TFOrdDtlRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/TFOrdDtlSearches(" + Company + "," + TFLineNum + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   /**  
   Summary: Calls UpdateExt to update TFOrdDtlSearch for the service
   Description: Calls UpdateExt to update TFOrdDtlSearch. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li><li>String parameters should be specified in single quotes</li></ul></div>
   OperationID: UpdateExt_TFOrdDtlSearch
      @param Company Desc: Company   Required: True   Allow empty value : True
      @param TFLineNum Desc: TFLineNum   Required: True   Allow empty value : True
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas headers
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TFOrdDtlSearches_Company_TFLineNum(Company:string, TFLineNum:string, requestBody:Erp_Tablesets_TFOrdDtlRow, epicorHeaders?:Headers){
   ...
   /**  
   Summary: Call UpdateExt to delete TFOrdDtlSearch item
   Description: Call UpdateExt to delete TFOrdDtlSearch item. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li><li>String parameters should be specified in single quotes</li></ul></div>
   OperationID: DeleteUpdateExt_TFOrdDtlSearch
      @param Company Desc: Company   Required: True   Allow empty value : True
      @param TFLineNum Desc: TFLineNum   Required: True   Allow empty value : True
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas headers
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function delete_TFOrdDtlSearches_Company_TFLineNum(Company:string, TFLineNum:string, epicorHeaders?:Headers){
...
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_TFOrdDtlListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetRows(whereClauseTFOrdDtl:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRows_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetByID(tfLineNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Description: This method GetDetail by ID
...
export function post_CustomGetByID(requestBody:CustomGetByID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CustomGetByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/CustomGetByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   /**  
   Summary: Invoke method GetOrdHedList
   Description: This method is used to provide a list of OrderHed
   OperationID: GetOrdHedList
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetOrdHedList_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetOrdHedList_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetOrdHedList(requestBody:GetOrdHedList_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetOrdHedList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/GetOrdHedList", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetOrdHedList_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetNewTFOrdDtl(requestBody:GetNewTFOrdDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTFOrdDtl_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/GetNewTFOrdDtl", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_DeleteByID(requestBody:DeleteByID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/DeleteByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowIDs_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:Update_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Update_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:UpdateExt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UpdateExt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.TFOrdDtlSearchSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface CustomGetByID_output{
   returnObj:Erp_Tablesets_TFOrdDtlSearchTableset[],
}
...
export interface Erp_Tablesets_TFOrdDtlSearchTableset{
   TFOrdDtl:Erp_Tablesets_TFOrdDtlRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface Erp_Tablesets_UpdExtTFOrdDtlSearchTableset{
   TFOrdDtl:Erp_Tablesets_TFOrdDtlRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface GetNewTFOrdDtl_input{
   ds:Erp_Tablesets_TFOrdDtlSearchTableset[],
}
...
parameters : {
   ...
   /** Required : 
      ...
      @param absolutePage
   */  
export interface GetOrdHedList_input{
      /**  Where clause.  */  
   whereClause:string,
      /**  Page size.  */  
   pageSize:number,
...
export interface GetOrdHedList_output{
   returnObj:Erp_Tablesets_TFOrdDtlListTableset[],
parameters : {
      /**  output parameters  */  
   morePages:boolean,
...
export interface UpdateExt_input{
   ds:Erp_Tablesets_UpdExtTFOrdDtlSearchTableset[],
