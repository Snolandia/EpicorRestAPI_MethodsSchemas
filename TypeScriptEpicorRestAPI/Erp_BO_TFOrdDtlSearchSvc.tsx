...
export function get_TFOrdDtlSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_TFOrdDtlSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_TFOrdDtlSearches_Company_TFLineNum(Company:string, TFLineNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TFOrdDtlSearches_Company_TFLineNum(Company:string, TFLineNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_CustomGetByID(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetOrdHedList(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTFOrdDtl(requestBody:any, epicorHeaders?:Headers){
