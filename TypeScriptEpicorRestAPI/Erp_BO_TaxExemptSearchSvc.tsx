...
export function get_TaxExemptSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_TaxExemptSearches(requestBody:Erp_Tablesets_TaxExemptRow, epicorHeaders?:Headers){
...
export function get_TaxExemptSearches_Company_RelatedToFile_Key1_Key2_TaxCode_RateCode_EffectiveFrom(Company:string, RelatedToFile:string, Key1:string, Key2:string, TaxCode:string, RateCode:string, EffectiveFrom:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TaxExemptSearches_Company_RelatedToFile_Key1_Key2_TaxCode_RateCode_EffectiveFrom(Company:string, RelatedToFile:string, Key1:string, Key2:string, TaxCode:string, RateCode:string, EffectiveFrom:string, requestBody:Erp_Tablesets_TaxExemptRow, epicorHeaders?:Headers){
...
export function post_ChangeTypeOnEntity(requestBody:ChangeTypeOnEntity_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetPercentDefault(requestBody:GetPercentDefault_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetPercentDefault_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetPercentDefault_output)
          })
      .catch((error) => {
          reject(error)
      })
