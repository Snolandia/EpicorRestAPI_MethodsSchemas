...
export function get_DemandCntDtlSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_DemandCntDtlSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_DemandCntDtlSearches_Company_DemandContractNum_DemandContractLine(Company:string, DemandContractNum:string, DemandContractLine:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_DemandCntDtlSearches_Company_DemandContractNum_DemandContractLine(Company:string, DemandContractNum:string, DemandContractLine:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewDemandContractDtl(requestBody:any, epicorHeaders?:Headers){
