...
export function get_LaborDtlGroupAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_LaborDtlGroupAttches(requestBody:any, epicorHeaders?:Headers){
...
export function get_LaborDtlGroupAttches_Company_EmployeeNum_ClaimRef_DrawingSeq(Company:string, EmployeeNum:string, ClaimRef:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_LaborDtlGroupAttches_Company_EmployeeNum_ClaimRef_DrawingSeq(Company:string, EmployeeNum:string, ClaimRef:string, DrawingSeq:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_GetNewLaborDtlGroup(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewLaborDtlGroupAttch(requestBody:any, epicorHeaders?:Headers){
