...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_LaborDtlGroups(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LaborDtlGroupRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/LaborDtlGroups", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_LaborDtlGroups(requestBody:Erp_Tablesets_LaborDtlGroupRow, epicorHeaders?:Headers){
   ...
   */  
export function get_LaborDtlGroups_Company_EmployeeNum_ClaimRef(Company:string, EmployeeNum:string, ClaimRef:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_LaborDtlGroupRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/LaborDtlGroups(" + Company + "," + EmployeeNum + "," + ClaimRef + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function delete_LaborDtlGroups_Company_EmployeeNum_ClaimRef(Company:string, EmployeeNum:string, ClaimRef:string, epicorHeaders?:Headers){
   ...
   */  
export function get_LaborDtlGroups_Company_EmployeeNum_ClaimRef_LaborDtlGroupAttches(Company:string, EmployeeNum:string, ClaimRef:string, select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LaborDtlGroupAttchRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/LaborDtlGroups(" + Company + "," + EmployeeNum + "," + ClaimRef + ")/LaborDtlGroupAttches", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LaborDtlGroupAttchRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   */  
export function get_LaborDtlGroups_Company_EmployeeNum_ClaimRef_LaborDtlGroupAttches_Company_EmployeeNum_ClaimRef_DrawingSeq(Company:string, EmployeeNum:string, ClaimRef:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_LaborDtlGroupAttchRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/LaborDtlGroups(" + Company + "," + EmployeeNum + "," + ClaimRef + ")/LaborDtlGroupAttches(" + Company + "," + EmployeeNum + "," + ClaimRef + "," + DrawingSeq + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as Erp_Tablesets_LaborDtlGroupAttchRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      200 Desc: OK => reference #/components/schemas/Epicor.RESTApi.Help.ODataSetResponse_System.Collections.Generic.List_Erp.Tablesets.LaborDtlGroupAttchRow
   */  
export function get_LaborDtlGroupAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LaborDtlGroupAttchRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/LaborDtlGroupAttches", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_LaborDtlGroupAttches(requestBody:Erp_Tablesets_LaborDtlGroupAttchRow, epicorHeaders?:Headers){
   ...
   Returns: 
      200 Desc: OK => reference #/components/schemas/Erp.Tablesets.LaborDtlGroupAttchRow
   */  
export function get_LaborDtlGroupAttches_Company_EmployeeNum_ClaimRef_DrawingSeq(Company:string, EmployeeNum:string, ClaimRef:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_LaborDtlGroupAttchRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/LaborDtlGroupAttches(" + Company + "," + EmployeeNum + "," + ClaimRef + "," + DrawingSeq + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_LaborDtlGroupAttches_Company_EmployeeNum_ClaimRef_DrawingSeq(Company:string, EmployeeNum:string, ClaimRef:string, DrawingSeq:string, requestBody:Erp_Tablesets_LaborDtlGroupAttchRow, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function delete_LaborDtlGroupAttches_Company_EmployeeNum_ClaimRef_DrawingSeq(Company:string, EmployeeNum:string, ClaimRef:string, DrawingSeq:string, epicorHeaders?:Headers){
...
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LaborDtlGroupListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LaborDtlGroupListRow)
          })
      .catch((error) => {
          reject(error)
      })
...
//////////////////////////////////////////////////////////////////////////
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetRows(whereClauseLaborDtlGroup:string, whereClauseLaborDtlGroupAttch:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   ...
   if(typeof whereClauseLaborDtlGroupAttch!== 'undefined'){
      if(firstParam){
         params += "?"
         firstParam = false
      }else{
   ...
   return (new Promise<GetRows_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetByID(employeeNum:string, claimRef:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   ...
   return (new Promise<GetByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
Return True if it exists else returns False.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_EmployeeExists(requestBody:EmployeeExists_input, epicorHeaders?:Headers){
   ...
   return (new Promise<EmployeeExists_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/EmployeeExists", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as EmployeeExists_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetNewLaborDtlGroup(requestBody:GetNewLaborDtlGroup_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewLaborDtlGroup_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/GetNewLaborDtlGroup", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewLaborDtlGroupAttch(requestBody:GetNewLaborDtlGroupAttch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewLaborDtlGroupAttch_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/GetNewLaborDtlGroupAttch", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewLaborDtlGroupAttch_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_DeleteByID(requestBody:DeleteByID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/DeleteByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowIDs_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:Update_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Update_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:UpdateExt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UpdateExt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.LaborDtlGroupSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// OData Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LaborDtlGroupAttchRow{
   "odatametadata":string,
   "value":Erp_Tablesets_LaborDtlGroupAttchRow,
}

export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_LaborDtlGroupListRow{
   "odatametadata":string,
   "value":Erp_Tablesets_LaborDtlGroupListRow,
}
...
export interface Erp_Tablesets_LaborDtlGroupAttchRow{
   "Company":string,
   "EmployeeNum":string,
   "ClaimRef":string,
   "DrawingSeq":number,
...
export interface Erp_Tablesets_LaborDtlGroupListRow{
      /**  Company Identifier.  */  
   "Company":string,
...
export interface Erp_Tablesets_LaborDtlGroupListTableset{
   LaborDtlGroupList:Erp_Tablesets_LaborDtlGroupListRow[],
...
export interface Erp_Tablesets_LaborDtlGroupTableset{
   LaborDtlGroup:Erp_Tablesets_LaborDtlGroupRow[],
   LaborDtlGroupAttch:Erp_Tablesets_LaborDtlGroupAttchRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface Erp_Tablesets_UpdExtLaborDtlGroupTableset{
   LaborDtlGroup:Erp_Tablesets_LaborDtlGroupRow[],
   LaborDtlGroupAttch:Erp_Tablesets_LaborDtlGroupAttchRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface GetByID_output{
   returnObj:Erp_Tablesets_LaborDtlGroupTableset[],
}
...
export interface GetList_output{
   returnObj:Erp_Tablesets_LaborDtlGroupListTableset[],
parameters : {
      /**  output parameters  */  
   morePages:boolean,
}
   ...
   /** Required : 
      ...
      @param claimRef
   */  
export interface GetNewLaborDtlGroupAttch_input{
   ds:Erp_Tablesets_LaborDtlGroupTableset[],
   employeeNum:string,
   claimRef:string,
}

export interface GetNewLaborDtlGroupAttch_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_LaborDtlGroupTableset,
}
...
parameters : {
   ...
   /** Required : 
      ...
      @param whereClauseLaborDtlGroupAttch
      @param pageSize
      @param absolutePage
   */  
export interface GetRows_input{
   whereClauseLaborDtlGroup:string,
   whereClauseLaborDtlGroupAttch:string,
   pageSize:number,
   absolutePage:number,
}
...
export interface UpdateExt_input{
   ds:Erp_Tablesets_UpdExtLaborDtlGroupTableset[],
