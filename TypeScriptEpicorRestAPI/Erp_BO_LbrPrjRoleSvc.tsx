...
export function get_LbrPrjRoles(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_LbrPrjRoles(requestBody:Erp_Tablesets_LaborDtlRow, epicorHeaders?:Headers){
...
export function get_LbrPrjRoles_Company_LaborHedSeq_LaborDtlSeq(Company:string, LaborHedSeq:string, LaborDtlSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_LbrPrjRoles_Company_LaborHedSeq_LaborDtlSeq(Company:string, LaborHedSeq:string, LaborDtlSeq:string, requestBody:Erp_Tablesets_LaborDtlRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeNewPrjRoleCd(requestBody:OnChangeNewPrjRoleCd_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeNewPrjRoleCd_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeNewPrjRoleCd_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_UpdatePrjRoleCd(requestBody:UpdatePrjRoleCd_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UpdatePrjRoleCd_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as UpdatePrjRoleCd_output)
          })
      .catch((error) => {
          reject(error)
      })
