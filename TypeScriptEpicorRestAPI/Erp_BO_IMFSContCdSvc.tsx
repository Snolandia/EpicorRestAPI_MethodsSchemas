...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.IMFSContCdSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.IMFSContCdSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_AckFSContCd(requestBody:AckFSContCd_input, epicorHeaders?:Headers){
   ...
   return (new Promise<AckFSContCd_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.IMFSContCdSvc/AckFSContCd", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as AckFSContCd_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CountFSContCd(requestBody:CountFSContCd_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CountFSContCd_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.IMFSContCdSvc/CountFSContCd", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as CountFSContCd_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetAllFSContCd(requestBody:GetAllFSContCd_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetAllFSContCd_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.IMFSContCdSvc/GetAllFSContCd", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetAllFSContCd_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetFSContCd(requestBody:GetFSContCd_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetFSContCd_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.IMFSContCdSvc/GetFSContCd", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetFSContCd_output)
          })
      .catch((error) => {
          reject(error)
      })
...
//////////////////////////////////////////////////////////////////////////
   /** Required : 
      ...
      @param extCompanyID
   */  
export interface AckFSContCd_input{
   ts:Erp_Tablesets_IMFSContCdTableset[],
   company:string,
   extSystemID:string,
...
export interface AckFSContCd_output{
...
parameters : {
   ...
   /** Required : 
      ...
      @param extCompanyID
   */  
export interface CountFSContCd_input{
   company:string,
   extSystemID:string,
   transferMethod:string,
   extCompanyID:string,
...
export interface CountFSContCd_output{
parameters : {
      /**  output parameters  */  
   totalCount:number,
}
...
export interface Erp_Tablesets_IMFSContCdRow{
      /**  Company Identifier.  */  
   Company:string,
...
export interface Erp_Tablesets_IMFSContCdTableset{
   IntQueInOut:Erp_Tablesets_IntQueInOutRow[],
   IMFSContCd:Erp_Tablesets_IMFSContCdRow[],
...
export interface Erp_Tablesets_IntQueInOutRow{
   ...
   /** Required : 
      ...
      @param absolutePage
   */  
export interface GetAllFSContCd_input{
   company:string,
   extSystemID:string,
   transferMethod:string,
   extCompanyID:string,
...
export interface GetAllFSContCd_output{
   returnObj:Erp_Tablesets_IMFSContCdTableset[],
parameters : {
      /**  output parameters  */  
   morePages:boolean,
}
   ...
   /** Required : 
      ...
      @param absolutePage
   */  
export interface GetFSContCd_input{
   company:string,
   extSystemID:string,
   transferMethod:string,
   extCompanyID:string,
...
export interface GetFSContCd_output{
   returnObj:Erp_Tablesets_IMFSContCdTableset[],
parameters : {
      /**  output parameters  */  
   morePages:boolean,
