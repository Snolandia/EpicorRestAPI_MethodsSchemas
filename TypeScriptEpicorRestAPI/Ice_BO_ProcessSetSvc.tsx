...
export function get_ProcessSets(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ProcessSets(requestBody:Ice_Tablesets_ProcessSetRow, epicorHeaders?:Headers){
...
export function get_ProcessSets_Company_SystemCode_ProcessID(Company:string, SystemCode:string, ProcessID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ProcessSets_Company_SystemCode_ProcessID(Company:string, SystemCode:string, ProcessID:string, requestBody:Ice_Tablesets_ProcessSetRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_DuplicateProcessSet(requestBody:DuplicateProcessSet_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DuplicateProcessSet_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as DuplicateProcessSet_output)
          })
      .catch((error) => {
          reject(error)
      })
...
process set. The source process set cannot be a system process set.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_MoveTaskToSet(requestBody:MoveTaskToSet_input, epicorHeaders?:Headers){
   ...
   return (new Promise<MoveTaskToSet_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as MoveTaskToSet_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewProcessSet(requestBody:GetNewProcessSet_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewProcessSet_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewProcessSet_output)
          })
      .catch((error) => {
          reject(error)
      })
