...
export function get_PkgControlIDs(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PkgControlIDs(requestBody:Erp_Tablesets_PkgControlHeaderRow, epicorHeaders?:Headers){
...
export function get_PkgControlIDs_Company_PCID(Company:string, PCID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PkgControlIDs_Company_PCID(Company:string, PCID:string, requestBody:Erp_Tablesets_PkgControlHeaderRow, epicorHeaders?:Headers){
...
export function get_PkgControlCustPartNums(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PkgControlCustPartNums(requestBody:Erp_Tablesets_PkgControlCustPartNumRow, epicorHeaders?:Headers){
...
export function get_PkgControlCustPartNums_Company_PCID_PCIDCustPartSeq(Company:string, PCID:string, PCIDCustPartSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PkgControlCustPartNums_Company_PCID_PCIDCustPartSeq(Company:string, PCID:string, PCIDCustPartSeq:string, requestBody:Erp_Tablesets_PkgControlCustPartNumRow, epicorHeaders?:Headers){
...
export function get_PCLabelValues(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PCLabelValues(requestBody:Erp_Tablesets_PCLabelValuesRow, epicorHeaders?:Headers){
...
export function get_PCLabelValues_Company_PCID_LabelSeq(Company:string, PCID:string, LabelSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PCLabelValues_Company_PCID_LabelSeq(Company:string, PCID:string, LabelSeq:string, requestBody:Erp_Tablesets_PCLabelValuesRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListCoreStageHX(requestBody:GetListCoreStageHX_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetListCoreStageHX_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetListCoreStageHX_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetPCIDList(requestBody:GetPCIDList_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetPCIDList_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetPCIDList_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_PasswordConfigured(epicorHeaders?:Headers){
   ...
   return (new Promise<PasswordConfigured_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as PasswordConfigured_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetNewPkgControlHeader(requestBody:GetNewPkgControlHeader_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPkgControlCustPartNum(requestBody:GetNewPkgControlCustPartNum_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPkgControlCustPartNum_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPkgControlCustPartNum_output)
          })
      .catch((error) => {
          reject(error)
      })
