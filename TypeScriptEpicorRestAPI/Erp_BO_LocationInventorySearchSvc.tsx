...
export function get_GetRows(whereClauseLocInvSearch:string, whereClauseLocInvAddrSearch:string, whereClauseLocMtl:string, whereClauseDynAttr:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetRowsWithAttributeList(requestBody:GetRowsWithAttributeList_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRowsWithAttributeList_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetRowsWithAttributeList_output)
          })
      .catch((error) => {
          reject(error)
      })
