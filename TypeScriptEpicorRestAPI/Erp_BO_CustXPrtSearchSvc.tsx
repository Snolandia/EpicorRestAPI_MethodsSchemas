...
/** 
// Title: Erp.BO.CustXPrtSearchSvc
// Description: Special Customer Part Search prevents Users to modify
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Description: Get CustXPrtSearches items from the server using GetRows standard method. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li></ul></div>
   OperationID: GetRows_CustXPrtSearches
   ...
   */  
export function get_CustXPrtSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_CustXPrtRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/CustXPrtSearches", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   OperationID: NewUpdateExt_CustXPrtSearches
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas headers
   ...
   */  
export function post_CustXPrtSearches(requestBody:Erp_Tablesets_CustXPrtRow, epicorHeaders?:Headers){
   ...
   /**  
   Summary: Calls GetByID to retrieve the CustXPrtSearch item
   Description: Calls GetByID to retrieve the CustXPrtSearch item by specified keys. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li><li>String parameters should be specified in single quotes</li></ul></div>
   OperationID: GetById_CustXPrtSearch
   ...
   */  
export function get_CustXPrtSearches_Company_CustNum_PartNum_XPartNum_SysRowID(Company:string, CustNum:string, PartNum:string, XPartNum:string, SysRowID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_CustXPrtRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/CustXPrtSearches(" + Company + "," + CustNum + "," + PartNum + "," + XPartNum + "," + SysRowID + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   /**  
   Summary: Calls UpdateExt to update CustXPrtSearch for the service
   Description: Calls UpdateExt to update CustXPrtSearch. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li><li>String parameters should be specified in single quotes</li></ul></div>
   OperationID: UpdateExt_CustXPrtSearch
      @param Company Desc: Company   Required: True   Allow empty value : True
      @param CustNum Desc: CustNum   Required: True
      @param PartNum Desc: PartNum   Required: True   Allow empty value : True
      @param XPartNum Desc: XPartNum   Required: True   Allow empty value : True
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_CustXPrtSearches_Company_CustNum_PartNum_XPartNum_SysRowID(Company:string, CustNum:string, PartNum:string, XPartNum:string, SysRowID:string, requestBody:Erp_Tablesets_CustXPrtRow, epicorHeaders?:Headers){
   ...
   /**  
   Summary: Call UpdateExt to delete CustXPrtSearch item
   Description: Call UpdateExt to delete CustXPrtSearch item. <div>OData-specific rules:<ul><li>OData $-parameters data are case-sensitive</li><li>String parameters should be specified in single quotes</li></ul></div>
   OperationID: DeleteUpdateExt_CustXPrtSearch
      @param Company Desc: Company   Required: True   Allow empty value : True
      @param CustNum Desc: CustNum   Required: True
      @param PartNum Desc: PartNum   Required: True   Allow empty value : True
      @param XPartNum Desc: XPartNum   Required: True   Allow empty value : True
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function delete_CustXPrtSearches_Company_CustNum_PartNum_XPartNum_SysRowID(Company:string, CustNum:string, PartNum:string, XPartNum:string, SysRowID:string, epicorHeaders?:Headers){
...
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_CustXPrtListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetRows(whereClauseCustXPrt:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRows_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetByID(custNum:string, partNum:string, xpartNum:string, sysRowID:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetNewCustXPrt(requestBody:GetNewCustXPrt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewCustXPrt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/GetNewCustXPrt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_DeleteByID(requestBody:DeleteByID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/DeleteByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowIDs_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:Update_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Update_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:UpdateExt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UpdateExt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CustXPrtSearchSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface Erp_Tablesets_CustXPrtSearchTableset{
   CustXPrt:Erp_Tablesets_CustXPrtRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface Erp_Tablesets_UpdExtCustXPrtSearchTableset{
   CustXPrt:Erp_Tablesets_CustXPrtRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface GetByID_output{
   returnObj:Erp_Tablesets_CustXPrtSearchTableset[],
}
...
export interface GetNewCustXPrt_input{
   ds:Erp_Tablesets_CustXPrtSearchTableset[],
   custNum:number,
   partNum:string,
   xpartNum:string,
}
...
export interface UpdateExt_input{
   ds:Erp_Tablesets_UpdExtCustXPrtSearchTableset[],
