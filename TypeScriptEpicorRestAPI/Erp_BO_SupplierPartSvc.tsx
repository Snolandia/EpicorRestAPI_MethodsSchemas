...
export function get_SupplierParts(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_SupplierParts(requestBody:any, epicorHeaders?:Headers){
...
export function get_SupplierParts_Company_PartNum_VendorNum_VendPartNum_MfgNum_MfgPartNum(Company:string, PartNum:string, VendorNum:string, VendPartNum:string, MfgNum:string, MfgPartNum:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SupplierParts_Company_PartNum_VendorNum_VendPartNum_MfgNum_MfgPartNum(Company:string, PartNum:string, VendorNum:string, VendPartNum:string, MfgNum:string, MfgPartNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_SupplierPartAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SupplierPartAttches(requestBody:any, epicorHeaders?:Headers){
...
export function get_SupplierPartAttches_Company_PartNum_VendorNum_VendPartNum_MfgNum_MfgPartNum_DrawingSeq(Company:string, PartNum:string, VendorNum:string, VendPartNum:string, MfgNum:string, MfgPartNum:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SupplierPartAttches_Company_PartNum_VendorNum_VendPartNum_MfgNum_MfgPartNum_DrawingSeq(Company:string, PartNum:string, VendorNum:string, VendPartNum:string, MfgNum:string, MfgPartNum:string, DrawingSeq:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetByID(partNum:string, vendorNum:string, vendPartNum:string, mfgNum:string, mfgPartNum:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeSupplierPartMfgNum(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeSupplierPartMfgPartNum(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSupplierPart(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSupplierPartAttch(requestBody:any, epicorHeaders?:Headers){
