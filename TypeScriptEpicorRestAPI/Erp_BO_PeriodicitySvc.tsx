...
export function get_Periodicities(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_Periodicities(requestBody:any, epicorHeaders?:Headers){
...
export function get_Periodicities_Company_Plant_VendorNum_PurPoint_CustNum_ShipToNum(Company:string, Plant:string, VendorNum:string, PurPoint:string, CustNum:string, ShipToNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_Periodicities_Company_Plant_VendorNum_PurPoint_CustNum_ShipToNum(Company:string, Plant:string, VendorNum:string, PurPoint:string, CustNum:string, ShipToNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_Existplant(requestBody:any, epicorHeaders?:Headers){
...
export function post_GetCodeDescList(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_FindCustNum(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_FindVendorNum(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPeriodicity(requestBody:any, epicorHeaders?:Headers){
