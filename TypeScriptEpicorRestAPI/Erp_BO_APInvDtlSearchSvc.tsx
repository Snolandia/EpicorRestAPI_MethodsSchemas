...
export function get_APInvDtlSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_APInvDtlSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_APInvDtlSearches_Company_VendorNum_InvoiceNum_InvoiceLine(Company:string, VendorNum:string, InvoiceNum:string, InvoiceLine:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_APInvDtlSearches_Company_VendorNum_InvoiceNum_InvoiceLine(Company:string, VendorNum:string, InvoiceNum:string, InvoiceLine:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAPInvDtl(requestBody:any, epicorHeaders?:Headers){
