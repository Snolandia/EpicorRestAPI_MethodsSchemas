...
export function get_DmdMassGrps(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_DmdMassGrps(requestBody:Erp_Tablesets_DmdMassGrpRow, epicorHeaders?:Headers){
...
export function get_DmdMassGrps_Company_GroupID(Company:string, GroupID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_DmdMassGrps_Company_GroupID(Company:string, GroupID:string, requestBody:Erp_Tablesets_DmdMassGrpRow, epicorHeaders?:Headers){
...
export function get_DmdMassGrpDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_DmdMassGrpDtls(requestBody:Erp_Tablesets_DmdMassGrpDtlRow, epicorHeaders?:Headers){
...
export function get_DmdMassGrpDtls_Company_PrimaryField_PrimaryFieldDtl(Company:string, PrimaryField:string, PrimaryFieldDtl:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_DmdMassGrpDtls_Company_PrimaryField_PrimaryFieldDtl(Company:string, PrimaryField:string, PrimaryFieldDtl:string, requestBody:Erp_Tablesets_DmdMassGrpDtlRow, epicorHeaders?:Headers){
...
export function post_DeleteDemand(requestBody:DeleteDemand_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeLockStatus(requestBody:OnChangeLockStatus_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeLockStatus_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeLockStatus_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewDmdMassGrp(requestBody:GetNewDmdMassGrp_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewDmdMassGrp_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewDmdMassGrp_output)
          })
      .catch((error) => {
          reject(error)
      })
