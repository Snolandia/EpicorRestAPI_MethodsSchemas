...
export function get_SalesRepQuotas(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_SalesRepQuotas(requestBody:Erp_Tablesets_SRepQHedRow, epicorHeaders?:Headers){
...
export function get_SalesRepQuotas_Company_SalesRepCode_FiscalCalendarID_FiscalYear_FiscalYearSuffix(Company:string, SalesRepCode:string, FiscalCalendarID:string, FiscalYear:string, FiscalYearSuffix:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SalesRepQuotas_Company_SalesRepCode_FiscalCalendarID_FiscalYear_FiscalYearSuffix(Company:string, SalesRepCode:string, FiscalCalendarID:string, FiscalYear:string, FiscalYearSuffix:string, requestBody:Erp_Tablesets_SRepQHedRow, epicorHeaders?:Headers){
...
export function get_SRepQDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SRepQDtls(requestBody:Erp_Tablesets_SRepQDtlRow, epicorHeaders?:Headers){
...
export function get_SRepQDtls_Company_SalesRepCode_FiscalYear_FiscalYearSuffix_FiscalPeriod_FiscalCalendarID(Company:string, SalesRepCode:string, FiscalYear:string, FiscalYearSuffix:string, FiscalPeriod:string, FiscalCalendarID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SRepQDtls_Company_SalesRepCode_FiscalYear_FiscalYearSuffix_FiscalPeriod_FiscalCalendarID(Company:string, SalesRepCode:string, FiscalYear:string, FiscalYearSuffix:string, FiscalPeriod:string, FiscalCalendarID:string, requestBody:Erp_Tablesets_SRepQDtlRow, epicorHeaders?:Headers){
...
when the SRepQDtl.QuotaAmt changes.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeDtlQuotaAmt(requestBody:ChangeDtlQuotaAmt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeDtlQuotaAmt_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ChangeDtlQuotaAmt_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_ChangeSalesRepCode(requestBody:ChangeSalesRepCode_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ValidateSalesRepCode(requestBody:ValidateSalesRepCode_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ValidateSalesRepCode_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ValidateSalesRepCode_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CopySalesQuota(requestBody:CopySalesQuota_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CopySalesQuota_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CopySalesQuota_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_DeleteSalesQuota(requestBody:DeleteSalesQuota_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteSalesQuota_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as DeleteSalesQuota_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_ValidateFiscalYear(requestBody:ValidateFiscalYear_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSRepQHed(requestBody:GetNewSRepQHed_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewSRepQHed_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewSRepQHed_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSRepQDtl(requestBody:GetNewSRepQDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewSRepQDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewSRepQDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
