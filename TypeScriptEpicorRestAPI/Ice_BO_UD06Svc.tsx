...
export function get_UD06s(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_UD06s(requestBody:Ice_Tablesets_UD06Row, epicorHeaders?:Headers){
...
export function get_UD06s_Company_Key1_Key2_Key3_Key4_Key5(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UD06s_Company_Key1_Key2_Key3_Key4_Key5(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, requestBody:Ice_Tablesets_UD06Row, epicorHeaders?:Headers){
...
export function get_UD06Attchs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_UD06Attchs(requestBody:Ice_Tablesets_UD06AttchRow, epicorHeaders?:Headers){
...
export function get_UD06Attchs_Company_Key1_Key2_Key3_Key4_Key5_DrawingSeq(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UD06Attchs_Company_Key1_Key2_Key3_Key4_Key5_DrawingSeq(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, DrawingSeq:string, requestBody:Ice_Tablesets_UD06AttchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetaNewUD06(requestBody:GetaNewUD06_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetaNewUD06_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetaNewUD06_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewUD06(requestBody:GetNewUD06_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewUD06_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewUD06_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewUD06Attch(requestBody:GetNewUD06Attch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewUD06Attch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewUD06Attch_output)
          })
      .catch((error) => {
          reject(error)
      })
