...
/** 
// Title: Erp.RPT.APInvBalanceReportSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_GetDateOfPeriod(requestBody:GetDateOfPeriod_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDateOfPeriod_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/GetDateOfPeriod", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as GetDateOfPeriod_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetCOA(requestBody:GetCOA_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetCOA_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/GetCOA", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   /**  
   Summary: Invoke method ClearGLAccount
   Description: Deletes the GL Account option from the Sort By selection.
   OperationID: ClearGLAccount
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ClearGLAccount_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ClearGLAccount_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ClearGLAccount(requestBody:ClearGLAccount_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ClearGLAccount_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/ClearGLAccount", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ClearGLAccount_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetCodeDescList(requestBody:GetCodeDescList_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetCodeDescList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/GetCodeDescList", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   /**  
   Summary: Invoke method IsCOADifferent
   Description: Returns true when the COA is different between 2 books.
   OperationID: IsCOADifferent
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/IsCOADifferent_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/IsCOADifferent_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_IsCOADifferent(requestBody:IsCOADifferent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<IsCOADifferent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/IsCOADifferent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as IsCOADifferent_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method ChangedIncludeGLAcct
   Description: Toggles whether to show the 'Include GL Account' within the Sort By Available Options
Plus removes the item from the 'Selected'.
   OperationID: ChangedIncludeGLAcct
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ChangedIncludeGLAcct_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ChangedIncludeGLAcct_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangedIncludeGLAcct(requestBody:ChangedIncludeGLAcct_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangedIncludeGLAcct_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/ChangedIncludeGLAcct", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ChangedIncludeGLAcct_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APInvBalanceReportSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
//////////////////////////////////////////////////////////////////////////
   /** Required : 
      @param ds
   */  
export interface ChangedIncludeGLAcct_input{
   ds:Erp_Tablesets_APInvBalanceReportTableset[],
}

export interface ChangedIncludeGLAcct_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_APInvBalanceReportTableset,
}
   ...
   /** Required : 
      @param ds
   */  
export interface ClearGLAccount_input{
   ds:Erp_Tablesets_APInvBalanceReportTableset[],
}

export interface ClearGLAccount_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_APInvBalanceReportTableset,
}
...
export interface Erp_Tablesets_APInvBalanceParamRow{
   BeginDate:string,
   EndDate:string,
   AcctBalInDebit:boolean,
   VendList:string,
   VendGroupList:string,
   ...
   Book:string,
   IncludeGLAcct:boolean,
   Range:string,
   PayInstOption:string,
      /**  Fiscal Year  */  
   FiscalYear:number,
      /**  Fiscal Year Suffix  */  
   ...
   IncludePrePayments:boolean,
      /**  Include Logged Invoices. Only Logged Invoices with Posted = true, void = false and matched = true. Will be displayed.  */  
   IncludeLI:boolean,
      /**  Colombia Loc Field  */  
   OneTimeList:string,
      /**  Sort By option for Columbia  */  
   COSortBy:string,
      /**  Print Selection Criteria  */  
   PrintSelCriteria:boolean,
   IsPECorrection:boolean,
   VendIDList:string,
   SortByAvailID:string,
   SortByDesc:string,
   SortByAvailDesc:string,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_APInvBalanceReportTableset{
   APInvBalanceParam:Erp_Tablesets_APInvBalanceParamRow[],
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_APInvBalanceReportTableset[],
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      ...
      @param currBookID
   */  
export interface IsCOADifferent_input{
      /**  Previous BookID  */  
   prevBookID:string,
      /**  Selected BookID  */  
   currBookID:string,
...
export interface IsCOADifferent_output{
   returnObj:boolean,
}
