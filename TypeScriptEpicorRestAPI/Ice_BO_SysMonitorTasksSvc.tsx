...
export function get_SysMonitorTasks(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_SysMonitorTasks(requestBody:Ice_Tablesets_SysTaskRow, epicorHeaders?:Headers){
...
export function get_SysMonitorTasks_SysTaskNum(SysTaskNum:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SysMonitorTasks_SysTaskNum(SysTaskNum:string, requestBody:Ice_Tablesets_SysTaskRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetBallonRowsKeepIdleTime(requestBody:GetBallonRowsKeepIdleTime_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBallonRowsKeepIdleTime_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetBallonRowsKeepIdleTime_output)
          })
      .catch((error) => {
          reject(error)
      })
