...
export function get_TaskMasts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_TaskMasts(requestBody:Erp_Tablesets_TaskMastRow, epicorHeaders?:Headers){
...
export function get_TaskMasts_Company_TaskID(Company:string, TaskID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TaskMasts_Company_TaskID(Company:string, TaskID:string, requestBody:Erp_Tablesets_TaskMastRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeTypeCode(requestBody:OnChangeTypeCode_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeTypeCode_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeTypeCode_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTaskMast(requestBody:GetNewTaskMast_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTaskMast_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewTaskMast_output)
          })
      .catch((error) => {
          reject(error)
      })
