...
/** 
// Title: Erp.PROC.MassVoidCCAuthSvc
// Description: Voids all pending authorized transactions.
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method CopyTargetConfig
   Description: Copy configuration from Credit Card to Source and Target configurations.
   OperationID: CopyTargetConfig
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/CopyTargetConfig_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/CopyTargetConfig_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CopyTargetConfig(requestBody:CopyTargetConfig_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CopyTargetConfig_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/CopyTargetConfig", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as CopyTargetConfig_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MassVoidCCAuthSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
//////////////////////////////////////////////////////////////////////////
   /** Required : 
      @param ds
   */  
export interface CopyTargetConfig_input{
   ds:Erp_Tablesets_MassVoidCCAuthTableset[],
}

export interface CopyTargetConfig_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_MassVoidCCAuthTableset,
}
...
export interface Erp_Tablesets_MassVoidCCAuthParamRow{
      /**  Processor Interface code for source configuration.  */  
   Src_ProcInterfaceCode:string,
      /**  Host Address for source configuration.  */  
   Src_HostAddress:string,
      /**  Host Port number for source configuration.  */  
   Src_HostPort:number,
      /**  Time Out for source configuration.  */  
   Src_TimeOut:number,
      /**  The description for the Processor Type for source configuration.  */  
   Src_Processor:string,
      /**  Partner for source configuration.  */  
   Src_Partner:string,
      /**  Partner User for source configuration.  */  
   Src_PartnerUser:string,
      /**  Partner Vendor for source configuration.  */  
   Src_PartnerVendor:string,
      /**  Partner Password for source configuration.  */  
   Src_PartnerPwd:string,
      /**  Group ID used for FDMS processor for source configuration.  */  
   Src_FDMSGroupID:string,
      /**  Customer ID used for FDMS processor for source configuration.  */  
   Src_FDMSCustomerID:string,
      /**  TTP_ID used for FDMS processor for source configuration.  */  
   Src_TPPID:string,
      /**  Phone Number used for FDMS processor for source configuration.  */  
   Src_FDMSPhoneNum:string,
      /**  Test flag for source configuration.  */  
   Src_IsTest:boolean,
      /**  Proxy Address for source configuration.  */  
   Src_ProxyAddress:string,
      /**  Proxy Port number for source configuration.  */  
   Src_ProxyPort:number,
      /**  Proxy Logon for source configuration.  */  
   Src_ProxyLogon:string,
      /**  Proxy Password for source configuration.  */  
   Src_ProxyPwd:string,
      /**  Indicates if the process will void the authorizations.  */  
   IsVoid:boolean,
      /**  Indicates if the process will do a reathorization task.  */  
   IsReauthorize:boolean,
      /**  Indicates if the current tokens will be replaced for the new processor tokens on transactions, orders and receipts.  */  
   IsConvertTokens:boolean,
      /**  Host Address for the Paygate Hosted Token Service.  */  
   PayGateAddress:string,
      /**  Processor Interface code for target configuration.  */  
   Tgt_ProcInterfaceCode:string,
      /**  Host Address for target configuration.  */  
   Tgt_HostAddress:string,
      /**  Host Port number for target configuration.  */  
   Tgt_HostPort:number,
      /**  Time Out for target configuration.  */  
   Tgt_TimeOut:number,
      /**  Test flag for target configuration.  */  
   Tgt_IsTest:boolean,
      /**  Proxy Address for target configuration.  */  
   Tgt_ProxyAddress:string,
      /**  Proxy Port number for target configuration.  */  
   Tgt_ProxyPort:number,
      /**  Proxy Logon for target configuration.  */  
   Tgt_ProxyLogon:string,
      /**  Proxy Password for target configuration.  */  
   Tgt_ProxyPwd:string,
      /**  Secure Data Service port number.  */  
   Src_SDSPort:number,
   Tgt_IsTraining:boolean,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_MassVoidCCAuthTableset{
   MassVoidCCAuthParam:Erp_Tablesets_MassVoidCCAuthParamRow[],
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_MassVoidCCAuthTableset[],
}
