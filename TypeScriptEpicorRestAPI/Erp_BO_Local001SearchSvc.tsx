...
export function get_Local001Searchs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_Local001Searchs(requestBody:Erp_Tablesets_Local001Row, epicorHeaders?:Headers){
...
export function get_Local001Searchs_Company_LocalName_Key1_Key2_Key3_Key4_Key5(Company:string, LocalName:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_Local001Searchs_Company_LocalName_Key1_Key2_Key3_Key4_Key5(Company:string, LocalName:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, requestBody:Erp_Tablesets_Local001Row, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewLocal001(requestBody:GetNewLocal001_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewLocal001_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewLocal001_output)
          })
      .catch((error) => {
          reject(error)
      })
