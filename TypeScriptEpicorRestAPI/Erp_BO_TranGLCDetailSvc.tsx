...
like1-like6, likeValue1-likeValue6 - data from CompoundKeys (or else) input arrays when from was opened from context menu.
   ...
   */  
export function post_ParseValueInParametersToTranGLCKeys(requestBody:any, epicorHeaders?:Headers){
...
Notes:
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTransactionDetail(requestBody:any, epicorHeaders?:Headers){
