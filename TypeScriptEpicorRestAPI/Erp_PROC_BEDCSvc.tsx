...
3) Both
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_DefaultQueryFields(requestBody:DefaultQueryFields_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DefaultQueryFields_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as DefaultQueryFields_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetBAQFields(requestBody:GetBAQFields_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBAQFields_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetBAQFields_output)
          })
      .catch((error) => {
          reject(error)
      })
...
if the new parmaters are not already populated
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PopNewParam(requestBody:PopNewParam_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PopNewParam_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as PopNewParam_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_testEntryLists(epicorHeaders?:Headers){
   ...
   return (new Promise<testEntryLists_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as testEntryLists_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_testField(requestBody:testField_input, epicorHeaders?:Headers){
   ...
   return (new Promise<testField_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as testField_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_validFieldName(requestBody:validFieldName_input, epicorHeaders?:Headers){
   ...
   return (new Promise<validFieldName_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as validFieldName_output)
          })
      .catch((error) => {
          reject(error)
      })
