...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_GetSugList(requestBody:GetSugList_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetSugList_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetSugList_output)
          })
      .catch((error) => {
          reject(error)
      })
