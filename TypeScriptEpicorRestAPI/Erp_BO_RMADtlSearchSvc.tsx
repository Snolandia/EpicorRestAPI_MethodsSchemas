...
export function get_RMADtlSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_RMADtlSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_RMADtlSearches_Company_RMANum_RMALine(Company:string, RMANum:string, RMALine:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_RMADtlSearches_Company_RMANum_RMALine(Company:string, RMANum:string, RMALine:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_GetRowsCustomerTracker(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetRowsProjectTracker(requestBody:any, epicorHeaders?:Headers){
