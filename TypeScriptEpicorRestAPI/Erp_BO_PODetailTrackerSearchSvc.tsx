...
export function get_PODetailTrackerSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PODetailTrackerSearches(requestBody:Erp_Tablesets_PODetailRow, epicorHeaders?:Headers){
...
export function get_PODetailTrackerSearches_Company_PONUM_POLine(Company:string, PONUM:string, POLine:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PODetailTrackerSearches_Company_PONUM_POLine(Company:string, PONUM:string, POLine:string, requestBody:Erp_Tablesets_PODetailRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetRowsByVendorNum(requestBody:GetRowsByVendorNum_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetRowsByVendorNum_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetRowsByVendorNum_output)
          })
      .catch((error) => {
          reject(error)
      })
