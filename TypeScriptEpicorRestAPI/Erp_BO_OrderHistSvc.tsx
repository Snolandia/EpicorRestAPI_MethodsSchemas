...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_GetListOrderHistory(requestBody:GetListOrderHistory_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetListOrderHistory_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetListOrderHistory_output)
          })
      .catch((error) => {
          reject(error)
      })
