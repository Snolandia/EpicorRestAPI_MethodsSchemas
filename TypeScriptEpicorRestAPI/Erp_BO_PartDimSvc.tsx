...
/** 
// Title: Erp.BO.PartDimSvc
// Description: Part Dimension file
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_PartDims(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PartDimRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/PartDims", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function post_PartDims(requestBody:Erp_Tablesets_PartDimRow, epicorHeaders?:Headers){
...
export function get_PartDims_Company_PartNum_DimCode(Company:string, PartNum:string, DimCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_PartDimRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/PartDims(" + Company + "," + PartNum + "," + DimCode + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PartDims_Company_PartNum_DimCode(Company:string, PartNum:string, DimCode:string, requestBody:Erp_Tablesets_PartDimRow, epicorHeaders?:Headers){
...
export function delete_PartDims_Company_PartNum_DimCode(Company:string, PartNum:string, DimCode:string, epicorHeaders?:Headers){
   ...
   OperationID: GetList
      ...
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas headers
   Returns: 
      200 Desc: OK => reference #/components/schemas/Epicor.RESTApi.Help.ODataSetResponse_System.Collections.Generic.List_Erp.Tablesets.PartDimListRow
   */  
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PartDimListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PartDimListRow)
          })
      .catch((error) => {
          reject(error)
      })
...
//////////////////////////////////////////////////////////////////////////
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetRows(whereClausePartDim:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   ...
   return (new Promise<GetRows_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetByID(partNum:string, dimCode:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   ...
   return (new Promise<GetByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPartDim(requestBody:GetNewPartDim_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPartDim_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/GetNewPartDim", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewPartDim_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_DeleteByID(requestBody:DeleteByID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/DeleteByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowIDs_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:Update_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Update_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:UpdateExt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UpdateExt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PartDimSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// OData Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PartDimListRow{
   "odatametadata":string,
   "value":Erp_Tablesets_PartDimListRow,
}
...
export interface Erp_Tablesets_PartDimListRow{
      /**  Company Identifier.  */  
   "Company":string,
...
export interface Erp_Tablesets_PartDimListTableset{
   PartDimList:Erp_Tablesets_PartDimListRow[],
...
export interface Erp_Tablesets_PartDimTableset{
   PartDim:Erp_Tablesets_PartDimRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface Erp_Tablesets_UpdExtPartDimTableset{
   PartDim:Erp_Tablesets_PartDimRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface GetByID_output{
   returnObj:Erp_Tablesets_PartDimTableset[],
}
...
export interface GetList_output{
   returnObj:Erp_Tablesets_PartDimListTableset[],
parameters : {
      /**  output parameters  */  
   morePages:boolean,
}
...
export interface GetNewPartDim_input{
   ds:Erp_Tablesets_PartDimTableset[],
   partNum:string,
}
...
export interface UpdateExt_input{
   ds:Erp_Tablesets_UpdExtPartDimTableset[],
