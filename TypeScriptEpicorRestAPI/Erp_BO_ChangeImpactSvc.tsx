...
export function post_GetData(epicorHeaders?:Headers){
   ...
   return (new Promise<GetData_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetData_output)
          })
      .catch((error) => {
          reject(error)
      })
...
EarlyGracePeriod and LateGracePeriod change.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeParameters(requestBody:OnChangeParameters_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeParameters_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnChangeParameters_output)
          })
      .catch((error) => {
          reject(error)
      })
