...
export function get_NLICPReports(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_NLICPReports(requestBody:Erp_Tablesets_NLICPReportRow, epicorHeaders?:Headers){
...
export function get_NLICPReports_Company_ReportID(Company:string, ReportID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_NLICPReports_Company_ReportID(Company:string, ReportID:string, requestBody:Erp_Tablesets_NLICPReportRow, epicorHeaders?:Headers){
...
export function get_NLICPReportAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_NLICPReportAttches(requestBody:Erp_Tablesets_NLICPReportAttchRow, epicorHeaders?:Headers){
...
export function get_NLICPReportAttches_Company_ReportID_DrawingSeq(Company:string, ReportID:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_NLICPReportAttches_Company_ReportID_DrawingSeq(Company:string, ReportID:string, DrawingSeq:string, requestBody:Erp_Tablesets_NLICPReportAttchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_RefreshDatesAndPeriods(requestBody:RefreshDatesAndPeriods_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RefreshDatesAndPeriods_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as RefreshDatesAndPeriods_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GenExportFile(requestBody:GenExportFile_input, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ResetPost(requestBody:ResetPost_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ResetPost_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ResetPost_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SetManuallySubmitted(requestBody:SetManuallySubmitted_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SetManuallySubmitted_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as SetManuallySubmitted_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewNLICPReport(requestBody:GetNewNLICPReport_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewNLICPReport_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewNLICPReport_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewNLICPReportAttch(requestBody:GetNewNLICPReportAttch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewNLICPReportAttch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewNLICPReportAttch_output)
          })
      .catch((error) => {
          reject(error)
      })
