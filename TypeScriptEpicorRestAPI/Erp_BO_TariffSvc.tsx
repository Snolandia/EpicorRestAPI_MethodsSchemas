...
export function get_Tariffs(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_Tariffs(requestBody:Erp_Tablesets_TariffRow, epicorHeaders?:Headers){
...
export function get_Tariffs_Company_TariffCode(Company:string, TariffCode:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_Tariffs_Company_TariffCode(Company:string, TariffCode:string, requestBody:Erp_Tablesets_TariffRow, epicorHeaders?:Headers){
...
export function get_TariffComms(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_TariffComms(requestBody:Erp_Tablesets_TariffCommRow, epicorHeaders?:Headers){
...
export function get_TariffComms_Company_TariffCode_CommodityCode(Company:string, TariffCode:string, CommodityCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TariffComms_Company_TariffCode_CommodityCode(Company:string, TariffCode:string, CommodityCode:string, requestBody:Erp_Tablesets_TariffCommRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnCommCodeChange(requestBody:OnCommCodeChange_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnCommCodeChange_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as OnCommCodeChange_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTariff(requestBody:GetNewTariff_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTariff_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewTariff_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTariffComm(requestBody:GetNewTariffComm_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTariffComm_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewTariffComm_output)
          })
      .catch((error) => {
          reject(error)
      })
