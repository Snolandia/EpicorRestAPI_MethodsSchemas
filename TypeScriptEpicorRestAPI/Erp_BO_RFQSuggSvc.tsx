...
export function get_RFQSuggs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_RFQSuggs(requestBody:Erp_Tablesets_RFQSuggRow, epicorHeaders?:Headers){
...
export function get_RFQSuggs_Company_SugNum(Company:string, SugNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_RFQSuggs_Company_SugNum(Company:string, SugNum:string, requestBody:Erp_Tablesets_RFQSuggRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewRFQSugg(requestBody:GetNewRFQSugg_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewRFQSugg_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewRFQSugg_output)
          })
      .catch((error) => {
          reject(error)
      })
