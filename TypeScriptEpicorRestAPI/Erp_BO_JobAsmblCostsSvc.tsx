...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_GetJobAsmblCosts(requestBody:GetJobAsmblCosts_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetJobAsmblCosts_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetJobAsmblCosts_output)
          })
      .catch((error) => {
          reject(error)
      })
