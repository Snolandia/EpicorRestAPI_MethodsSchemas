...
export function get_ProdGrupPlts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ProdGrupPlts(requestBody:any, epicorHeaders?:Headers){
...
export function get_ProdGrupPlts_Company_ProdCode_OwnerPlant(Company:string, ProdCode:string, OwnerPlant:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ProdGrupPlts_Company_ProdCode_OwnerPlant(Company:string, ProdCode:string, OwnerPlant:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_SelectProdGrpTaxEffRateGLCLookupLink(prodCode:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_LoadTaxEffRateGLC(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ApplyProdGrpTaxEffRateGLCLookup(requestBody:any, epicorHeaders?:Headers){
...
export function post_GetNewProdGrup(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewProdGrupPlt(requestBody:any, epicorHeaders?:Headers){
