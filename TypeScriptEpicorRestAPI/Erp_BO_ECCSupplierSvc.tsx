...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_ECCSupplierPortal(requestBody:ECCSupplierPortal_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ECCSupplierPortal_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as ECCSupplierPortal_output)
          })
      .catch((error) => {
          reject(error)
      })
