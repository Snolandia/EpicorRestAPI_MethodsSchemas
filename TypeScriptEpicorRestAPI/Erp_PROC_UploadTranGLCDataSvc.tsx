...
/** 
// Title: Erp.PROC.UploadTranGLCDataSvc
// Description: UploadTranGLCData Process
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method CheckConnection
   Description: Validates 9.04 DB connection parameters
   OperationID: CheckConnection
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/CheckConnection_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/CheckConnection_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckConnection(requestBody:CheckConnection_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckConnection_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/CheckConnection", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as CheckConnection_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Description: Retrieves the list of available ODBC Data Sources
...
export function post_GetDSNList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetDSNList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/GetDSNList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.UploadTranGLCDataSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
//////////////////////////////////////////////////////////////////////////
   /** Required : 
      ...
      @param password
   */  
export interface CheckConnection_input{
      /**  Database Type: Progress or SQL  */  
   dbType:string,
      /**  Data Source name  */  
   dsn:string,
      /**  Server name  */  
...
export interface CheckConnection_output{
   returnObj:string,
}

export interface Erp_Tablesets_UploadTranGLCDataParamRow{
      /**  Start Date  */  
   StartDate:string,
      /**  End Date  */  
   EndDate:string,
      /**  Convert AP Invoices  */  
   cnvAPInvoices:boolean,
      /**  Convert AP Transactions  */  
   cnvAPTransactions:boolean,
      /**  Convert AR Invoices  */  
   cnvARInvoices:boolean,
      /**  Convert Bank Transactions  */  
   cnvBankTransactions:boolean,
      /**  Convert Cash Receipts  */  
   cnvCashReceipts:boolean,
      /**  Convert GL Journal Source  */  
   cnvGLJournalSource:boolean,
      /**  Convert Labor Detail  */  
   cnvLaborDetail:boolean,
      /**  Convert Landed Cost  */  
   cnvLandedCost:boolean,
      /**  Convert Part Transactions  */  
   cnvPartTransactions:boolean,
      /**  Convert PO Releases  */  
   cnvPOReleases:boolean,
      /**  Server Name  */  
   cnServerName:string,
      /**  DB Name  */  
   cnDBName:string,
...
export interface Erp_Tablesets_UploadTranGLCDataTableset{
   UploadTranGLCDataParam:Erp_Tablesets_UploadTranGLCDataParamRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface GetDSNList_output{
      /**  Delimeted list of ODBC Data Sources  */  
   returnObj:string,
}
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_UploadTranGLCDataTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_UploadTranGLCDataTableset[],
}
