...
export function get_FSTechSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_FSTechSearches(requestBody:Erp_Tablesets_FsTechRow, epicorHeaders?:Headers){
...
export function get_FSTechSearches_Company_CallNum_SeqNum(Company:string, CallNum:string, SeqNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_FSTechSearches_Company_CallNum_SeqNum(Company:string, CallNum:string, SeqNum:string, requestBody:Erp_Tablesets_FsTechRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_FsTechGetList(requestBody:FsTechGetList_input, epicorHeaders?:Headers){
   ...
   return (new Promise<FsTechGetList_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as FsTechGetList_output)
          })
      .catch((error) => {
          reject(error)
      })
