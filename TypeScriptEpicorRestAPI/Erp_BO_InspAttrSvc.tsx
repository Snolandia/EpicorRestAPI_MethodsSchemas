...
export function get_InspAttrs(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_InspAttrs(requestBody:any, epicorHeaders?:Headers){
...
export function get_InspAttrs_Company_AttributeUse_AttributeID(Company:string, AttributeUse:string, AttributeID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_InspAttrs_Company_AttributeUse_AttributeID(Company:string, AttributeUse:string, AttributeID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_InspAttrAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_InspAttrAttches(requestBody:any, epicorHeaders?:Headers){
...
export function get_InspAttrAttches_Company_AttributeUse_AttributeID_DrawingSeq(Company:string, AttributeUse:string, AttributeID:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_InspAttrAttches_Company_AttributeUse_AttributeID_DrawingSeq(Company:string, AttributeUse:string, AttributeID:string, DrawingSeq:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewInspAttr(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewInspAttrAttch(requestBody:any, epicorHeaders?:Headers){
