...
/** 
// Title: Ice.PROC.DynamicQueryExportSvc
// Description: 
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method OnChangingQueryID
   Description: Retrieved query from database and took FileName, FileType, TextDelim, OutputLabels from QueryHdr(Exports)
   OperationID: OnChangingQueryID
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/OnChangingQueryID_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/OnChangingQueryID_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangingQueryID(requestBody:OnChangingQueryID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangingQueryID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/OnChangingQueryID", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as OnChangingQueryID_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Description: Checks query existence by id
...
export function post_ValidateQueryID(requestBody:ValidateQueryID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ValidateQueryID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/ValidateQueryID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.PROC.DynamicQueryExportSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface GetDefaults_input{
   ds:Ice_Tablesets_DynamicQueryExportTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Ice_Tablesets_DynamicQueryExportTableset[],
}
...
export interface Ice_Tablesets_DynQueryExpParamRow{
      /**  The Query to export  */  
   QueryID:string,
      /**  The filename for the export  */  
   ExportFilename:string,
      /**  The format of the BAQ export  */  
   ExportFormat:string,
      /**  The query description  */  
   QueryDescription:string,
      /**  The text delimiter to use, if needed, for the format.  */  
   TextDelim:string,
      /**  If true field labels will be output  */  
...
export interface Ice_Tablesets_DynamicQueryExportTableset{
   DynQueryExpParam:Ice_Tablesets_DynQueryExpParamRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

   /** Required : 
      @param proposedQueryId
      @param ds
   */  
export interface OnChangingQueryID_input{
      /**  Query id  */  
   proposedQueryId:string,
   ds:Ice_Tablesets_DynamicQueryExportTableset[],
}

export interface OnChangingQueryID_output{
parameters : {
      /**  output parameters  */  
   ds:Ice_Tablesets_DynamicQueryExportTableset,
}
