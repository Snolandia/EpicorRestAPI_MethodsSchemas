...
export function get_TaxBoxReportConfigs(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_TaxBoxReportConfigs(requestBody:any, epicorHeaders?:Headers){
...
export function get_TaxBoxReportConfigs_Company_ConfigID(Company:string, ConfigID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TaxBoxReportConfigs_Company_ConfigID(Company:string, ConfigID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_TaxBoxReportConfigDtls(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_TaxBoxReportConfigDtls(requestBody:any, epicorHeaders?:Headers){
...
export function get_TaxBoxReportConfigDtls_Company_ConfigID_LineNum(Company:string, ConfigID:string, LineNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TaxBoxReportConfigDtls_Company_ConfigID_LineNum(Company:string, ConfigID:string, LineNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTaxBoxCodeDescList(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTaxBoxCodeDescListApart(requestBody:any, epicorHeaders?:Headers){
...
Function also updates all formulas referencing to lines with changed numbers.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_InsertLine(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_PasteLinesData(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTaxBoxReportConfigHead(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTaxBoxReportConfigDtl(requestBody:any, epicorHeaders?:Headers){
