...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method GetWhseDesc
   Description: Purpose:
Parameters:  none
Notes:
/// <param name="ipWhseCode">Warehouse Code</param>
/// <param name="ds">Report Data set</param>
   OperationID: GetWhseDesc
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetWhseDesc_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetWhseDesc_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetWhseDesc(requestBody:GetWhseDesc_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetWhseDesc_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/GetWhseDesc", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as GetWhseDesc_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.PrintTagsSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_PrintTagsParamRow{
      /**  Print bar code flag  */  
   PrintBarCodes:boolean,
      /**  Type. Cycle or physical.  */  
   Type:string,
      /**  Types are N for new,  and R for re-print (All option is being removed for 9.0)  */  
   PrintType:string,
      /**  Plant  */  
   Plant:string,
      /**  Warehouse  */  
   WarehouseCode:string,
      /**  Indicates how many tags to print per sheet if sheets are being printed  */  
   TagsPerSheet:number,
      /**  True = physical inventory  */  
   FullPhysical:boolean,
      /**  Indicates whether sheets or tags should be printed for this cycle.  */  
   SheetOrTag:number,
      /**  Indicates whether blank tags assigned to the CCHdr should be printed  */  
   PrintBlankTags:boolean,
      /**  A delimited list of CCSheet ids for reprint  */  
   SheetList:string,
      /**  A delimited list of CCTag ids for reprint.  */  
   TagList:string,
   CycleSeq:number,
      /**  CCPeriodDefn.PeriodDesc - the description for the period record this cycle relates to  */  
   PeriodDesc:string,
      /**  Cycle Period  */  
   CCMonth:number,
   CCYear:number,
   WhseDesc:string,
      /**  Flag to indicate if the user wants to print blank tags generated for  PCID. If true CCTag for the selected cycle where PCIDTag = true and BlankTag = true and Printed = false will be printed. If false no CCTag blank tags will be printed.  */  
   PrintBlankPCIDTags:boolean,
      /**  Flag to indicate if the user wants to print PCID tags for nested PCID and Item Part Qty. If false only unprinted PCID tags for top level PCIDs will be printed (CCTag.TopLevelPCID = CCTag.PCID and CCTag.PCIDTag = true and BlankTag = false and Printed = false). If true all PCID tags where PCIDTag = true and BlankTag = false, Printed = false and TopLevelPCID ! = blank will be printed.  */  
   PrintPCIDNestedTags:boolean,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_PrintTagsTableset{
   PrintTagsParam:Erp_Tablesets_PrintTagsParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_PrintTagsTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_PrintTagsTableset[],
}
...
parameters : {
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface GetWhseDesc_input{
   ipWhseCode:string,
   ds:Erp_Tablesets_PrintTagsTableset[],
}

export interface GetWhseDesc_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_PrintTagsTableset,
}
