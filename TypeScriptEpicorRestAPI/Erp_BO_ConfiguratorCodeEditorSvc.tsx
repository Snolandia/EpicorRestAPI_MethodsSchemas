...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_BuildCodeEditorOptions(requestBody:BuildCodeEditorOptions_input, epicorHeaders?:Headers){
   ...
   return (new Promise<BuildCodeEditorOptions_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as BuildCodeEditorOptions_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewConfiguratorCodeEditor(requestBody:GetNewConfiguratorCodeEditor_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewConfiguratorCodeEditor_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewConfiguratorCodeEditor_output)
          })
      .catch((error) => {
          reject(error)
      })
