...
/** 
// Title: Erp.RPT.MtlQueueRptSvc
// Description: MtlQueueRptSvc class
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method GetBreakOn
   Description: This method returns a list of 'break on' codes and descriptions
   OperationID: GetBreakOn
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetBreakOn_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetBreakOn(epicorHeaders?:Headers){
   ...
   return (new Promise<GetBreakOn_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/GetBreakOn", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetBreakOn_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetSortBy
   Description: This method returns a list of 'sort by' codes and descriptions
   OperationID: GetSortBy
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetSortBy_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetSortBy(epicorHeaders?:Headers){
   ...
   return (new Promise<GetSortBy_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/GetSortBy", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetSortBy_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method SetPrintInventoryAttributes
   Description: Set Print Attributes used as Parameters
   OperationID: SetPrintInventoryAttributes
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/SetPrintInventoryAttributes_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/SetPrintInventoryAttributes_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SetPrintInventoryAttributes(requestBody:SetPrintInventoryAttributes_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SetPrintInventoryAttributes_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/SetPrintInventoryAttributes", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as SetPrintInventoryAttributes_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.MtlQueueRptSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_MtlQueueRptParamRow{
      /**  Company  */  
   Company:string,
      /**  Plant  */  
   Plant:string,
      /**  Employee ID who selected the record.  */  
   EmpID:string,
      /**  List of Material Queue sequence numbers separated by a tilde ~.  */  
   MtlQueueSeq:string,
      /**  Page break options are: None, Order Number (allows order pick list), and JobNumber (Allows job pick list).  */  
   PageBreak:string,
      /**  Sort By options are: Selected Order, Warehouse/bin, transtype/warehouse/bin, Order number/line, Order number/warehouse/bin, job number/warehouse/bin, and job number/asm/seq.  */  
   SortBy:string,
   ReleaseForPickingSeq:number,
      /**  List of Orders,Lines and Releases numbers separated by a tilde ~.  */  
   OrderLineReleaseList:string,
      /**  Flag to indicate if Bar Codes are printed on labels.  Defaulted to the Company level flag.  */  
   BarCodes:boolean,
      /**  Flag to indicate if Attributes sets will be printed in the report.  */  
...
export interface Erp_Tablesets_MtlQueueRptTableset{
   MtlQueueRptParam:Erp_Tablesets_MtlQueueRptParamRow[],
...
export interface GetBreakOn_output{
parameters : {
      /**  output parameters  */  
   breakonlist:string,
}
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_MtlQueueRptTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_MtlQueueRptTableset[],
}
...
export interface GetSortBy_output{
parameters : {
      /**  output parameters  */  
   sortbylist:string,
}
...
export interface SaveProcessTask_output{
   ...
   /** Required : 
      @param ds
   */  
export interface SetPrintInventoryAttributes_input{
   ds:Erp_Tablesets_MtlQueueRptTableset[],
}

export interface SetPrintInventoryAttributes_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_MtlQueueRptTableset,
}
