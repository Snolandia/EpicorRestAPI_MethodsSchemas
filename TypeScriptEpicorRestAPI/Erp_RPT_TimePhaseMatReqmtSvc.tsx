...
/** 
// Title: Erp.RPT.TimePhaseMatReqmtSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method GetPartClassList
   Description: This method provides a list of Stock Types with the values and description.
   OperationID: GetPartClassList
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetPartClassList_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetPartClassList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetPartClassList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/GetPartClassList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetPartClassList_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetPartTypeList
   Description: This method provides a list of PartType options with the values and description.
   OperationID: GetPartTypeList
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetPartTypeList_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetPartTypeList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetPartTypeList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/GetPartTypeList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetPartTypeList_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetStockTypeList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetStockTypeList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/GetStockTypeList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_GetContractByID(requestBody:GetContractByID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetContractByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/GetContractByID", {
          method: 'post',
          headers: headers,
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TimePhaseMatReqmtSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface Erp_Tablesets_TimePhaseMatReqmtParamRow{
      /**  Part Number  */  
   OnlyPartNum:string,
      /**  Part Types  */  
   PartTypes:string,
   ...
   StockTypes:string,
      /**  Part Class List  */  
   PartClasses:string,
      /**  Project Balance Cut Off Date  */  
   ProjBalCutOff:string,
      /**  Exceptions Only  */  
   DoSecondPass:boolean,
      /**  Order By Date  */  
   OrderByDate:string,
      /**  Below Re-Order toggle  */  
   ...
   OverMaximum:boolean,
      /**  Include Suggestions  */  
   Suggestions:boolean,
   ProjBalCutOffToken:string,
   OrderByDateToken:string,
      /**  Include / Exclude Transfer Order Suggestions  */  
   TFSuggestions:boolean,
      /**  Plant ID  */  
   PlantID:string,
      /**  Contract Description  */  
   ContractDescription:string,
   ContractID:string,
   PlanningContract:boolean,
      /**  If the part doesn’t meet any of the current exceptions and this parameter is true, it will show anyway the Part with zero on hand quantity.  */  
   PrintZeroOnHandQtyIfNoExpection:boolean,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_TimePhaseMatReqmtTableset{
   TimePhaseMatReqmtParam:Erp_Tablesets_TimePhaseMatReqmtParamRow[],
...
export interface GetContractByID_input{
   ds:Erp_Tablesets_TimePhaseMatReqmtTableset[],
      /**  ContractID changed  */  
   contractID:string,
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_TimePhaseMatReqmtTableset[],
}
...
export interface GetPartClassList_output{
parameters : {
      /**  output parameters  */  
...
export interface GetPartTypeList_output{
parameters : {
      /**  output parameters  */  
   PartTypeList:string,
}
