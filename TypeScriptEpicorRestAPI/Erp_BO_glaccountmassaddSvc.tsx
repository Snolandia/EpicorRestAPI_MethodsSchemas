...
export function get_glaccountmassadds(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_glaccountmassadds(requestBody:Erp_Tablesets_glaccountmassaddRow, epicorHeaders?:Headers){
...
export function get_glaccountmassadds_Company_COACode_SegmentNbr(Company:string, COACode:string, SegmentNbr:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_glaccountmassadds_Company_COACode_SegmentNbr(Company:string, COACode:string, SegmentNbr:string, requestBody:Erp_Tablesets_glaccountmassaddRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewglaccountmassadd(requestBody:GetNewglaccountmassadd_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewglaccountmassadd_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewglaccountmassadd_output)
          })
      .catch((error) => {
          reject(error)
      })
