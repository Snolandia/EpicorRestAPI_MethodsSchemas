...
export function get_JobParts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_JobParts(requestBody:any, epicorHeaders?:Headers){
...
export function get_JobParts_Company_JobNum_PartNum(Company:string, JobNum:string, PartNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_JobParts_Company_JobNum_PartNum(Company:string, JobNum:string, PartNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewJobPart(requestBody:any, epicorHeaders?:Headers){
