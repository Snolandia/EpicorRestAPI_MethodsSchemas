...
export function get_DocTypes(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_DocTypes(requestBody:Ice_Tablesets_DocTypeRow, epicorHeaders?:Headers){
...
export function get_DocTypes_Company_DocTypeID(Company:string, DocTypeID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_DocTypes_Company_DocTypeID(Company:string, DocTypeID:string, requestBody:Ice_Tablesets_DocTypeRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetEffectiveSettings(requestBody:GetEffectiveSettings_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetEffectiveSettings_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetEffectiveSettings_output)
          })
      .catch((error) => {
          reject(error)
      })
...
filtered by its transfer type
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetDocTypesWithMetadata(requestBody:GetDocTypesWithMetadata_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDocTypesWithMetadata_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetDocTypesWithMetadata_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewDocType(requestBody:GetNewDocType_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewDocType_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewDocType_output)
          })
      .catch((error) => {
          reject(error)
      })
