...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_AddIndirectEmpExpense(requestBody:AddIndirectEmpExpense_input, epicorHeaders?:Headers){
   ...
   return (new Promise<AddIndirectEmpExpense_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as AddIndirectEmpExpense_output)
          })
      .catch((error) => {
          reject(error)
      })
