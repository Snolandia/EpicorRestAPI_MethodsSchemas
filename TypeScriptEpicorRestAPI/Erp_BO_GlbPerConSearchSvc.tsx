...
export function get_GlbPerConSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GlbPerConSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_GlbPerConSearches_Company_GlbCompany_GlbPerConID(Company:string, GlbCompany:string, GlbPerConID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GlbPerConSearches_Company_GlbCompany_GlbPerConID(Company:string, GlbCompany:string, GlbPerConID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGlbPerCon(requestBody:any, epicorHeaders?:Headers){
