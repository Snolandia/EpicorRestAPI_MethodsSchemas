...
/** 
// Title: Erp.PROC.Export1099Svc
// Description: Export 1099 class
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   Description: Get the default export file folder
...
export function post_GetInitialPath(epicorHeaders?:Headers){
   ...
   return (new Promise<GetInitialPath_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/GetInitialPath", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
   ...
   /**  
   Summary: Invoke method IsAllSitesAuthorized
   Description: This method checks if All sites authorized
   OperationID: IsAllSitesAuthorized
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/IsAllSitesAuthorized_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_IsAllSitesAuthorized(epicorHeaders?:Headers){
   ...
   return (new Promise<IsAllSitesAuthorized_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/IsAllSitesAuthorized", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as IsAllSitesAuthorized_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method OnChangedPlant
   Description: This method called after Plant changed
   OperationID: OnChangedPlant
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/OnChangedPlant_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/OnChangedPlant_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangedPlant(requestBody:OnChangedPlant_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangedPlant_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/OnChangedPlant", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as OnChangedPlant_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.Export1099Svc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_Export1099ParamRow{
   CombinedFiling:boolean,
   CompanyCity:string,
   CompanyName1:string,
   CompanyName2:string,
   CompanyState:string,
   ...
   ContactName:string,
   ContactPhone:string,
   ElecInterface:number,
   ElecInterfaceName:string,
   ExportFile:string,
   FileType:string,
   LastFiling:boolean,
   ...
   PayerTIN:string,
   PayerZIP:string,
   PriorYearData:boolean,
   TaxYear:number,
   TransferAgent:boolean,
   TransmControlCode:string,
   TransmName1:string,
   TransmName2:string,
   TransmNameControl:string,
   TransmTIN:string,
   MailingAddress2:string,
   MailingAddress3:string,
   PayerAddress2:string,
   PayerAddress3:string,
      /**  Form Type filter list.  */  
   FormTypeList:string,
   Plant:string,
   SysRowID:string,
   AutoAction:string,
...
export interface Erp_Tablesets_Export1099Tableset{
   Export1099Param:Erp_Tablesets_Export1099ParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_Export1099Tableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_Export1099Tableset[],
}
...
export interface IsAllSitesAuthorized_output{
   returnObj:boolean,
}
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface OnChangedPlant_input{
   ipPlant:string,
   ds:Erp_Tablesets_Export1099Tableset[],
}

export interface OnChangedPlant_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_Export1099Tableset,
}
