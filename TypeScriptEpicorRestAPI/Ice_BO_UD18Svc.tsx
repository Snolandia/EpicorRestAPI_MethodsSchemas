...
export function get_UD18s(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_UD18s(requestBody:Ice_Tablesets_UD18Row, epicorHeaders?:Headers){
...
export function get_UD18s_Company_Key1_Key2_Key3_Key4_Key5(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UD18s_Company_Key1_Key2_Key3_Key4_Key5(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, requestBody:Ice_Tablesets_UD18Row, epicorHeaders?:Headers){
...
export function get_UD18Attchs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_UD18Attchs(requestBody:Ice_Tablesets_UD18AttchRow, epicorHeaders?:Headers){
...
export function get_UD18Attchs_Company_Key1_Key2_Key3_Key4_Key5_DrawingSeq(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UD18Attchs_Company_Key1_Key2_Key3_Key4_Key5_DrawingSeq(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, DrawingSeq:string, requestBody:Ice_Tablesets_UD18AttchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetaNewUD18(requestBody:GetaNewUD18_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetaNewUD18_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetaNewUD18_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewUD18(requestBody:GetNewUD18_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewUD18_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewUD18_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewUD18Attch(requestBody:GetNewUD18Attch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewUD18Attch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewUD18Attch_output)
          })
      .catch((error) => {
          reject(error)
      })
