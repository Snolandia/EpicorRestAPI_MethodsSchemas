...
export function get_ProcessTaskParams(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ProcessTaskParams(requestBody:any, epicorHeaders?:Headers){
...
export function get_ProcessTaskParams_Company_SystemCode_ProcessID_SysTaskNum_ParamName(Company:string, SystemCode:string, ProcessID:string, SysTaskNum:string, ParamName:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ProcessTaskParams_Company_SystemCode_ProcessID_SysTaskNum_ParamName(Company:string, SystemCode:string, ProcessID:string, SysTaskNum:string, ParamName:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_GetNewProcessTask(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewProcessTaskParam(requestBody:any, epicorHeaders?:Headers){
