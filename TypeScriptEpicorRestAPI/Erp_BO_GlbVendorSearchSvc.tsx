...
export function get_GlbVendorSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GlbVendorSearches(requestBody:Erp_Tablesets_GlbVendorRow, epicorHeaders?:Headers){
...
export function get_GlbVendorSearches_Company_GlbCompany_GlbVendorNum(Company:string, GlbCompany:string, GlbVendorNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GlbVendorSearches_Company_GlbCompany_GlbVendorNum(Company:string, GlbCompany:string, GlbVendorNum:string, requestBody:Erp_Tablesets_GlbVendorRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_RefreshGlbVendorRow(requestBody:RefreshGlbVendorRow_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RefreshGlbVendorRow_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as RefreshGlbVendorRow_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGlbVendor(requestBody:GetNewGlbVendor_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGlbVendor_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGlbVendor_output)
          })
      .catch((error) => {
          reject(error)
      })
