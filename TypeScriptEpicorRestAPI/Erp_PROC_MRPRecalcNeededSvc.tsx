...
/** 
// Title: Erp.PROC.MRPRecalcNeededSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method getFileName
   OperationID: getFileName
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/getFileName_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/getFileName_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getFileName(requestBody:getFileName_input, epicorHeaders?:Headers){
   ...
   return (new Promise<getFileName_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/getFileName", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as getFileName_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.MRPRecalcNeededSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_MRPRecalcNeededParamRow{
      /**  When this option is selected the process loops through all PartPlant records for authorized plants where the GenerateSugg = yes or the ProcessMR = yes and the MinimumQty > 0 or SafetyQty > 0.  The on hand is calculated.  If the on hand < Minimum + SafetyQty the MRPRecalcneeded flag is set to true.  */  
   CheckOnHandQty:boolean,
      /**  The Cut Off window is determined for each authorized plant by loooking at the MRPLastCutoffDate and the current porposed cutoff date.  Any Part with a PartDtl record that falls between the MRPLastCutoffDate and Proposed Cutoff date have their MRPRecalcNeeded flat set to true.  */  
   CheckCutoffWindow:boolean,
      /**  When this option is selected the Resource Groups and Resources with a finite horizon are processed looking for unfirmed jobs whose JobOper due date is greather than or equal to the Last Schedule Date + finite horizon and less than or equal to the proposed scheduled date + finite horizon.  */  
   CheckFiniteHorizon:boolean,
      /**  This is the date used when the Check Finite Horizon option is selected.  */  
   ProposedScheduleDate:string,
      /**  Delimited list of plants  */  
   PlantList:string,
      /**  Loops through all PartPlant records where the ProcessMRPflag = yes and ShortHorizonDays > 0.  If a PartDl record falls between the MrpLastScheduleDate + ShortHorizonDas and the ProposedScheduleDAte + ShortHorizonDays the part is placed on the MRP activity chain.  */  
   CheckShortHorizon:boolean,
      /**  Date used when the Check Cutoff Window option is selected.  */  
   CutoffDate:string,
      /**  Log file name used to output statistics.  */  
   LogFile:string,
      /**  This is the log file name with the file path.  This is not seen by the user but is used internally.  */  
   FullLogFile:string,
      /**  Cut Off Date Token  */  
   CutOffDateToken:string,
      /**  Proposed Schedule Date Token  */  
   ProposedScheduleDateToken:string,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_MRPRecalcNeededTableset{
   MRPRecalcNeededParam:Erp_Tablesets_MRPRecalcNeededParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_MRPRecalcNeededTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_MRPRecalcNeededTableset[],
}
...
export interface SubmitToAgent_output{
   ...
   /** Required : 
      ...
      @param IP_FileType
   */  
export interface getFileName_input{
   IP_BaseName:string,
   IP_FileType:string,
}

export interface getFileName_output{
   returnObj:string,
}
