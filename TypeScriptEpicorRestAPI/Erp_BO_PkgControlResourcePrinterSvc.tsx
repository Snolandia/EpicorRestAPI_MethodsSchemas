...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_PkgControlResourcePrinters(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PkgControlResourcePrinterRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/PkgControlResourcePrinters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PkgControlResourcePrinterRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   */  
export function post_PkgControlResourcePrinters(requestBody:Erp_Tablesets_PkgControlResourcePrinterRow, epicorHeaders?:Headers){
   ...
   */  
export function get_PkgControlResourcePrinters_Company_ResourceID(Company:string, ResourceID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_PkgControlResourcePrinterRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/PkgControlResourcePrinters(" + Company + "," + ResourceID + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as Erp_Tablesets_PkgControlResourcePrinterRow)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PkgControlResourcePrinters_Company_ResourceID(Company:string, ResourceID:string, requestBody:Erp_Tablesets_PkgControlResourcePrinterRow, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function delete_PkgControlResourcePrinters_Company_ResourceID(Company:string, ResourceID:string, epicorHeaders?:Headers){
   ...
   Returns: 
      200 Desc: OK => reference #/components/schemas/Epicor.RESTApi.Help.ODataSetResponse_System.Collections.Generic.List_Erp.Tablesets.PkgControlResourcePrinterRow
   */  
export function get_PkgControlResourcePrinters_Company_ResourceID_PkgControlResourcePrinters(Company:string, ResourceID:string, select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PkgControlResourcePrinterRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/PkgControlResourcePrinters(" + Company + "," + ResourceID + ")/PkgControlResourcePrinters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      200 Desc: OK => reference #/components/schemas/Erp.Tablesets.PkgControlResourcePrinterRow
   */  
export function get_PkgControlResourcePrinters_Company_ResourceID_PkgControlResourcePrinters_Company_ResourceID(Company:string, ResourceID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_PkgControlResourcePrinterRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/PkgControlResourcePrinters(" + Company + "," + ResourceID + ")/PkgControlResourcePrinters(" + Company + "," + ResourceID + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_ResourceListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetRows(whereClauseResource:string, whereClausePkgControlResourcePrinter:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   ...
   if(typeof whereClausePkgControlResourcePrinter!== 'undefined'){
      if(firstParam){
         params += "?"
         firstParam = false
      }else{
   ...
   return (new Promise<GetRows_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetByID(resourceID:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_OnChangePrinterID(requestBody:OnChangePrinterID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangePrinterID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/OnChangePrinterID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetNewResource(requestBody:GetNewResource_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewResource_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/GetNewResource", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPkgControlResourcePrinter(requestBody:GetNewPkgControlResourcePrinter_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPkgControlResourcePrinter_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/GetNewPkgControlResourcePrinter", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewPkgControlResourcePrinter_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_DeleteByID(requestBody:DeleteByID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/DeleteByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowIDs_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:Update_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Update_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:UpdateExt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UpdateExt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.PkgControlResourcePrinterSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// OData Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_PkgControlResourcePrinterRow{
   "odatametadata":string,
   "value":Erp_Tablesets_PkgControlResourcePrinterRow,
}
...
export interface Erp_Tablesets_PkgControlResourcePrinterRow{
      /**  Company Identifier.  */  
   "Company":string,
      /**  Site Identifier.  */  
   "Plant":string,
...
export interface Erp_Tablesets_PkgControlResourcePrinterListTableset{
...
export interface Erp_Tablesets_PkgControlResourcePrinterTableset{
   Resource:Erp_Tablesets_ResourceRow[],
   PkgControlResourcePrinter:Erp_Tablesets_PkgControlResourcePrinterRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface Erp_Tablesets_UpdExtPkgControlResourcePrinterTableset{
   Resource:Erp_Tablesets_ResourceRow[],
   PkgControlResourcePrinter:Erp_Tablesets_PkgControlResourcePrinterRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface GetByID_output{
   returnObj:Erp_Tablesets_PkgControlResourcePrinterTableset[],
}
...
export interface GetList_output{
   returnObj:Erp_Tablesets_PkgControlResourcePrinterListTableset[],
parameters : {
      /**  output parameters  */  
   morePages:boolean,
}
   ...
   /** Required : 
      ...
      @param resourceID
   */  
export interface GetNewPkgControlResourcePrinter_input{
   ds:Erp_Tablesets_PkgControlResourcePrinterTableset[],
   plant:string,
   resourceID:string,
}

export interface GetNewPkgControlResourcePrinter_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_PkgControlResourcePrinterTableset,
}
...
parameters : {
   ...
   /** Required : 
      ...
      @param whereClausePkgControlResourcePrinter
      @param pageSize
      @param absolutePage
   */  
export interface GetRows_input{
   whereClauseResource:string,
   whereClausePkgControlResourcePrinter:string,
   pageSize:number,
   absolutePage:number,
}
...
export interface UpdateExt_input{
   ds:Erp_Tablesets_UpdExtPkgControlResourcePrinterTableset[],
