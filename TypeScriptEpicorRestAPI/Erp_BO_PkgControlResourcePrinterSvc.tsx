...
export function get_PkgControlResourcePrinters(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PkgControlResourcePrinters(requestBody:any, epicorHeaders?:Headers){
...
export function get_PkgControlResourcePrinters_Company_ResourceID(Company:string, ResourceID:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PkgControlResourcePrinters_Company_ResourceID(Company:string, ResourceID:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_GetNewResource(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPkgControlResourcePrinter(requestBody:any, epicorHeaders?:Headers){
