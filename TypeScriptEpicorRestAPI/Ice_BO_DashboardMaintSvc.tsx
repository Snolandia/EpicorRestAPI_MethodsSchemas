...
export function get_DashboardMaints(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_DashboardMaints(requestBody:Ice_Tablesets_DashboardMaintRow, epicorHeaders?:Headers){
...
export function get_DashboardMaints_Company_ProductID_GlbCompany_CGCCode_DefinitionID(Company:string, ProductID:string, GlbCompany:string, CGCCode:string, DefinitionID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_DashboardMaints_Company_ProductID_GlbCompany_CGCCode_DefinitionID(Company:string, ProductID:string, GlbCompany:string, CGCCode:string, DefinitionID:string, requestBody:Ice_Tablesets_DashboardMaintRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewDashboardMaint(requestBody:GetNewDashboardMaint_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewDashboardMaint_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewDashboardMaint_output)
          })
      .catch((error) => {
          reject(error)
      })
