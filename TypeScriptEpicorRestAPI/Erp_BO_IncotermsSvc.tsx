...
export function get_Incoterms(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_Incoterms(requestBody:Erp_Tablesets_IncotermsRow, epicorHeaders?:Headers){
...
export function get_Incoterms_Company_IncotermCode(Company:string, IncotermCode:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_Incoterms_Company_IncotermCode(Company:string, IncotermCode:string, requestBody:Erp_Tablesets_IncotermsRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewIncoterms(requestBody:GetNewIncoterms_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewIncoterms_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewIncoterms_output)
          })
      .catch((error) => {
          reject(error)
      })
