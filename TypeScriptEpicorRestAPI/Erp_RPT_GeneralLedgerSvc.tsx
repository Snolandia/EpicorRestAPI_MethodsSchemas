...
/** 
// Title: Erp.RPT.GeneralLedgerSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetApplicationDefaults(requestBody:GetApplicationDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetApplicationDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/GetApplicationDefaults", {
          method: 'post',
          headers: headers,
   ...
   /**  
   Summary: Invoke method OnChangedBookID
   Description: Check to see if Currency can be changed
   OperationID: OnChangedBookID
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/OnChangedBookID_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/OnChangedBookID_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangedBookID(requestBody:OnChangedBookID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangedBookID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/OnChangedBookID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as OnChangedBookID_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Description: Check to see if Fiscal Year can be changed
...
export function post_OnChangeOfFiscalYear(requestBody:OnChangeOfFiscalYear_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeOfFiscalYear_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/OnChangeOfFiscalYear", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.GeneralLedgerSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_GeneralLedgerParamRow{
      /**  Fiscal Year  */  
   FiscalYear:number,
      /**  End Fiscal Period  */  
   ...
   FiscalYearSuffix:string,
      /**  Detail Or Summary.  (D)etail, (S)ummary, (B)oth  */  
   DtlOrSum:string,
      /**  Main Book ID  */  
   BookID:string,
      /**  Segment Values List  */  
   ...
   FiscalCalendarID:string,
      /**  Sub-Total Level List  */  
   LevelList:string,
      /**  To Natural Account  */  
   ToNatAccount:string,
      /**  From Natural Account  */  
   FromNatAccount:string,
      /**   One-Time Customer/Supllier list
Colombia Loc  */  
   OneTimeIDList:string,
   PrintSelCriteria:boolean,
   PrintStatData:boolean,
      /**  Additional Natural Accounts  */  
   AdditionalNatAcctList:string,
      /**  Excluded Natural Accounts  */  
   ExcludedNatAcctList:string,
      /**  Selection using particular account (Account) or natural account range (NARange)  */  
...
export interface Erp_Tablesets_GeneralLedgerTableset{
   GeneralLedgerParam:Erp_Tablesets_GeneralLedgerParamRow[],
...
export interface GetApplicationDefaults_input{
   ds:Erp_Tablesets_GeneralLedgerTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_GeneralLedgerTableset[],
}
...
parameters : {
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface OnChangedBookID_input{
      /**  The Currency Code entered  */  
   bookID:string,
   ds:Erp_Tablesets_GeneralLedgerTableset[],
}

export interface OnChangedBookID_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_GeneralLedgerTableset,
}
