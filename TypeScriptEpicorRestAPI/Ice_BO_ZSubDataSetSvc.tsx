...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_ZSubDataSets(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Ice_Tablesets_ZSubDataSetRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/ZSubDataSets", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_ZSubDataSets_SystemCode_ParentDataSetID_DataTableSystemCode_DataTableID(SystemCode:string, ParentDataSetID:string, DataTableSystemCode:string, DataTableID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Ice_Tablesets_ZSubDataSetRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/ZSubDataSets(" + SystemCode + "," + ParentDataSetID + "," + DataTableSystemCode + "," + DataTableID + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Ice_Tablesets_ZSubDataSetListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      .then((res) => res.json())
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Ice_Tablesets_ZSubDataSetListRow)
          })
      .catch((error) => {
          reject(error)
      })
...
//////////////////////////////////////////////////////////////////////////
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetRows(whereClauseZSubDataSet:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetByID(systemCode:string, parentDataSetID:string, dataTableSystemCode:string, dataTableID:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   ...
   if(typeof parentDataSetID!== 'undefined'){
      if(firstParam){
         params += "?"
         firstParam = false
      }else{
   ...
   if(typeof dataTableSystemCode!== 'undefined'){
      if(firstParam){
         params += "?"
         firstParam = false
      }else{
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_AttachmenTableExist(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/AttachmenTableExist", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:any, epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ZSubDataSetSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// OData Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Ice_Tablesets_ZSubDataSetListRow{
   "odatametadata":string,
   "value":Ice_Tablesets_ZSubDataSetListRow[],
}
...
export interface Ice_Tablesets_ZSubDataSetListRow{
      /**  SystemCode  */  
   "SystemCode":string,
      /**  Parent DataSet  */  
...
//////////////////////////////////////////////////////////////////////////
   /** Required : 
      @param tableName
   */  
export interface AttachmenTableExist_input{
   tableName:string,
}

export interface AttachmenTableExist_output{
}
...
export interface GetByID_output{
   returnObj:Ice_Tablesets_ZSubDataSetTableset[],
}
...
export interface GetList_output{
   returnObj:Ice_Tablesets_ZSubDataSetListTableset[],
parameters : {
      /**  output parameters  */  
   morePages:boolean,
}
...
export interface Ice_Tablesets_UpdExtZSubDataSetTableset{
...
export interface Ice_Tablesets_ZSubDataSetListTableset{
   ZSubDataSetList:Ice_Tablesets_ZSubDataSetListRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface Ice_Tablesets_ZSubDataSetTableset{
   ZSubDataSet:Ice_Tablesets_ZSubDataSetRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface UpdateExt_input{
   ds:Ice_Tablesets_UpdExtZSubDataSetTableset[],
...
export interface Update_input{
   ds:Ice_Tablesets_ZSubDataSetTableset[],
}
