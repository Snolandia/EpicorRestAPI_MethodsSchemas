...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_AttachmenTableExist(requestBody:AttachmenTableExist_input, epicorHeaders?:Headers){
   ...
   return (new Promise<AttachmenTableExist_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as AttachmenTableExist_output)
          })
      .catch((error) => {
          reject(error)
      })
