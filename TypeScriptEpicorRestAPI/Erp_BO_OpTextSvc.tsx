...
export function get_OpTexts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_OpTexts(requestBody:Erp_Tablesets_OpTextRow, epicorHeaders?:Headers){
...
export function get_OpTexts_Company_OpTextID(Company:string, OpTextID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_OpTexts_Company_OpTextID(Company:string, OpTextID:string, requestBody:Erp_Tablesets_OpTextRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewOpText(requestBody:GetNewOpText_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewOpText_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewOpText_output)
          })
      .catch((error) => {
          reject(error)
      })
