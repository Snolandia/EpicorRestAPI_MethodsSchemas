...
Notes:
   ...
   */  
export function post_CheckPermissions(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_EnableAssignLegalNumber(requestBody:any, epicorHeaders?:Headers){
