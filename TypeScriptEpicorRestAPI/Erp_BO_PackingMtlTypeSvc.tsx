...
export function get_PackingMtlTypes(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PackingMtlTypes(requestBody:any, epicorHeaders?:Headers){
...
export function get_PackingMtlTypes_Company_PkgMtlTypeCode(Company:string, PkgMtlTypeCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PackingMtlTypes_Company_PkgMtlTypeCode(Company:string, PkgMtlTypeCode:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPackingMtlType(requestBody:any, epicorHeaders?:Headers){
