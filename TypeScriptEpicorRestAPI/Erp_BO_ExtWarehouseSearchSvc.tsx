...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function get_ExtWarehouseSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_ExtWarehouseRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/ExtWarehouseSearches", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function post_ExtWarehouseSearches(requestBody:Erp_Tablesets_ExtWarehouseRow, epicorHeaders?:Headers){
   ...
   */  
export function get_ExtWarehouseSearches_Company_ExtSystemID_TransferMethod_ExtCompanyID_ExtPlantID_ExtWarehouseID(Company:string, ExtSystemID:string, TransferMethod:string, ExtCompanyID:string, ExtPlantID:string, ExtWarehouseID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_ExtWarehouseRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/ExtWarehouseSearches(" + Company + "," + ExtSystemID + "," + TransferMethod + "," + ExtCompanyID + "," + ExtPlantID + "," + ExtWarehouseID + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ExtWarehouseSearches_Company_ExtSystemID_TransferMethod_ExtCompanyID_ExtPlantID_ExtWarehouseID(Company:string, ExtSystemID:string, TransferMethod:string, ExtCompanyID:string, ExtPlantID:string, ExtWarehouseID:string, requestBody:Erp_Tablesets_ExtWarehouseRow, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function delete_ExtWarehouseSearches_Company_ExtSystemID_TransferMethod_ExtCompanyID_ExtPlantID_ExtWarehouseID(Company:string, ExtSystemID:string, TransferMethod:string, ExtCompanyID:string, ExtPlantID:string, ExtWarehouseID:string, epicorHeaders?:Headers){
...
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_ExtWarehouseListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_ExtWarehouseListRow)
          })
      .catch((error) => {
          reject(error)
      })
...
//////////////////////////////////////////////////////////////////////////
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetRows(whereClauseExtWarehouse:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   ...
   return (new Promise<GetRows_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetByID(extSystemID:string, transferMethod:string, extCompanyID:string, extPlantID:string, extWarehouseID:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   ...
   if(typeof extWarehouseID!== 'undefined'){
      if(firstParam){
         params += "?"
         firstParam = false
      }else{
   ...
   return (new Promise<GetByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetNewExtWarehouse(requestBody:GetNewExtWarehouse_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewExtWarehouse_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/GetNewExtWarehouse", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_DeleteByID(requestBody:DeleteByID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/DeleteByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowIDs_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:Update_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Update_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:UpdateExt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UpdateExt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.ExtWarehouseSearchSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// OData Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_ExtWarehouseListRow{
   "odatametadata":string,
   "value":Erp_Tablesets_ExtWarehouseListRow,
}
...
export interface Erp_Tablesets_ExtWarehouseListRow{
      /**  Company identifier  */  
   "Company":string,
...
export interface Erp_Tablesets_ExtWarehouseListTableset{
   ExtWarehouseList:Erp_Tablesets_ExtWarehouseListRow[],
...
export interface Erp_Tablesets_ExtWarehouseSearchTableset{
   ExtWarehouse:Erp_Tablesets_ExtWarehouseRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface Erp_Tablesets_UpdExtExtWarehouseSearchTableset{
   ExtWarehouse:Erp_Tablesets_ExtWarehouseRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface GetByID_output{
   returnObj:Erp_Tablesets_ExtWarehouseSearchTableset[],
}
...
export interface GetList_output{
   returnObj:Erp_Tablesets_ExtWarehouseListTableset[],
parameters : {
      /**  output parameters  */  
   morePages:boolean,
}
...
export interface GetNewExtWarehouse_input{
   ds:Erp_Tablesets_ExtWarehouseSearchTableset[],
   extSystemID:string,
   transferMethod:string,
   extCompanyID:string,
   extPlantID:string,
...
export interface UpdateExt_input{
   ds:Erp_Tablesets_UpdExtExtWarehouseSearchTableset[],
