...
export function get_SysTasks(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_SysTasks(requestBody:Ice_Tablesets_SysTaskRow, epicorHeaders?:Headers){
...
export function get_SysTasks_SysTaskNum(SysTaskNum:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SysTasks_SysTaskNum(SysTaskNum:string, requestBody:Ice_Tablesets_SysTaskRow, epicorHeaders?:Headers){
...
export function get_SysTaskParams(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SysTaskParams(requestBody:Ice_Tablesets_SysTaskParamRow, epicorHeaders?:Headers){
...
export function get_SysTaskParams_SysTaskNum_ParamName(SysTaskNum:string, ParamName:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_SysTaskParams_SysTaskNum_ParamName(SysTaskNum:string, ParamName:string, requestBody:Ice_Tablesets_SysTaskParamRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SysTaskExists(requestBody:SysTaskExists_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SysTaskExists_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as SysTaskExists_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_DeleteSysTaskKillRecords(epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteSysTaskKillRecords_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as DeleteSysTaskKillRecords_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_CleanUpActiveTasks(epicorHeaders?:Headers){
   ...
   return (new Promise<CleanUpActiveTasks_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CleanUpActiveTasks_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_KillActiveTasks(epicorHeaders?:Headers){
   ...
   return (new Promise<KillActiveTasks_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as KillActiveTasks_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckForDups(requestBody:CheckForDups_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckForDups_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CheckForDups_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_SetSysTaskStatusForPendingTask(requestBody:SetSysTaskStatusForPendingTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SetSysTaskStatusForPendingTask_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as SetSysTaskStatusForPendingTask_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_WriteToTaskLog(requestBody:WriteToTaskLog_input, epicorHeaders?:Headers){
   ...
   return (new Promise<WriteToTaskLog_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as WriteToTaskLog_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSysTask(requestBody:GetNewSysTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewSysTask_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewSysTask_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewSysTaskParam(requestBody:GetNewSysTaskParam_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewSysTaskParam_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewSysTaskParam_output)
          })
      .catch((error) => {
          reject(error)
      })
