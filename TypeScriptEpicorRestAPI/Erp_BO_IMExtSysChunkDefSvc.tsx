...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_AckExtSysChunkDef(requestBody:AckExtSysChunkDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<AckExtSysChunkDef_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as AckExtSysChunkDef_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CountExtSysChunkDef(requestBody:CountExtSysChunkDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CountExtSysChunkDef_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as CountExtSysChunkDef_output)
          })
      .catch((error) => {
          reject(error)
      })
...
No difference between GetAllExtSysChunkDef and GetExtSysChunkDef for this object
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetAllExtSysChunkDef(requestBody:GetAllExtSysChunkDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetAllExtSysChunkDef_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetAllExtSysChunkDef_output)
          })
      .catch((error) => {
          reject(error)
      })
...
No difference between GetAllExtSysChunkDef and GetExtSysChunkDef for this object
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetExtSysChunkDef(requestBody:GetExtSysChunkDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetExtSysChunkDef_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetExtSysChunkDef_output)
          })
      .catch((error) => {
          reject(error)
      })
