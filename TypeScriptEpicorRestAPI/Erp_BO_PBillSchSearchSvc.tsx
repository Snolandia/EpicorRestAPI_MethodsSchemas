...
export function get_PBillSchSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PBillSchSearches(requestBody:Erp_Tablesets_PBillSchRow, epicorHeaders?:Headers){
...
export function get_PBillSchSearches_Company_ProjectID_BillSchedID(Company:string, ProjectID:string, BillSchedID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PBillSchSearches_Company_ProjectID_BillSchedID(Company:string, ProjectID:string, BillSchedID:string, requestBody:Erp_Tablesets_PBillSchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPBillSch(requestBody:GetNewPBillSch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewPBillSch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewPBillSch_output)
          })
      .catch((error) => {
          reject(error)
      })
