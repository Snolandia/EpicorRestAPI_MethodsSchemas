...
export function get_GlbCustomerSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GlbCustomerSearches(requestBody:Erp_Tablesets_GlbCustomerRow, epicorHeaders?:Headers){
...
export function get_GlbCustomerSearches_Company_GlbCompany_GlbCustNum(Company:string, GlbCompany:string, GlbCustNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GlbCustomerSearches_Company_GlbCompany_GlbCustNum(Company:string, GlbCompany:string, GlbCustNum:string, requestBody:Erp_Tablesets_GlbCustomerRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGlbCustomer(requestBody:GetNewGlbCustomer_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGlbCustomer_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGlbCustomer_output)
          })
      .catch((error) => {
          reject(error)
      })
