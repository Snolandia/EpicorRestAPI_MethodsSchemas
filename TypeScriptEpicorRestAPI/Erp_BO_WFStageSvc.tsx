...
export function get_WFStages(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_WFStages(requestBody:any, epicorHeaders?:Headers){
...
export function get_WFStages_Company_WorkflowType_WFStageID(Company:string, WorkflowType:string, WFStageID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_WFStages_Company_WorkflowType_WFStageID(Company:string, WorkflowType:string, WFStageID:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_GetCodeDescList(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewWFStage(requestBody:any, epicorHeaders?:Headers){
