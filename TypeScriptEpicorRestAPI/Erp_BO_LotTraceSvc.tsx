...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_PerformTrace(requestBody:PerformTrace_input, epicorHeaders?:Headers){
   ...
   return (new Promise<PerformTrace_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as PerformTrace_output)
          })
      .catch((error) => {
          reject(error)
      })
