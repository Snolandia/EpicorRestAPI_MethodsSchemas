...
export function get_MeterReads(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_MeterReads(requestBody:Erp_Tablesets_MeterReadRow, epicorHeaders?:Headers){
...
export function get_MeterReads_Company_EquipID(Company:string, EquipID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_MeterReads_Company_EquipID(Company:string, EquipID:string, requestBody:Erp_Tablesets_MeterReadRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewMeterRead(requestBody:GetNewMeterRead_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewMeterRead_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewMeterRead_output)
          })
      .catch((error) => {
          reject(error)
      })
