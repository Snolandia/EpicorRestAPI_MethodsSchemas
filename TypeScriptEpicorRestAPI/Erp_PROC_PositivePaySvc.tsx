...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   Description: This method retrieves the BankAcct fields
   ...
   */  
export function post_ChangeBankAcctID(requestBody:ChangeBankAcctID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeBankAcctID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/ChangeBankAcctID", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as ChangeBankAcctID_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method ChangeEFTHeadUID
   Description: This method retrieves the BankAcct fields
   OperationID: ChangeEFTHeadUID
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ChangeEFTHeadUID_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ChangeEFTHeadUID_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeEFTHeadUID(requestBody:ChangeEFTHeadUID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangeEFTHeadUID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/ChangeEFTHeadUID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ChangeEFTHeadUID_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetActualDateFromDateToken
   Description: Calculates Date from specified Date Token
   OperationID: GetActualDateFromDateToken
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetActualDateFromDateToken_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetActualDateFromDateToken_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetActualDateFromDateToken(requestBody:GetActualDateFromDateToken_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetActualDateFromDateToken_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/GetActualDateFromDateToken", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetActualDateFromDateToken_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.PositivePaySvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface ChangeBankAcctID_input{
      /**  Proposed BankAcctID field  */  
   BankAcctID:string,
   ds:Erp_Tablesets_PositivePayTableset[],
}
...
parameters : {
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface ChangeEFTHeadUID_input{
      /**  Proposed EFTHeadUID field  */  
   EFTHeadUID:number,
   ds:Erp_Tablesets_PositivePayTableset[],
}

export interface ChangeEFTHeadUID_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_PositivePayTableset,
}
...
export interface Erp_Tablesets_PositivePayParamRow{
   ...
   OutputFileNameDisplay:string,
      /**  Batch ID value for Bank Account.  */  
   PositivePayBatchID:string,
      /**  Remote ID value for Bank Account.  */  
   PositivePayRemoteID:string,
      /**  Bank Account Description  */  
   BankAcctDesc:string,
      /**  Check number is assigned during the check printing process for checks that are printed by the system or entered by the user for hand written checks.  */  
   FromCheckNum:number,
      /**  Check number is assigned during the check printing process for checks that are printed by the system or entered by the user for hand written checks.  */  
   ToCheckNum:number,
   EFTHeadName:string,
...
export interface Erp_Tablesets_PositivePayTableset{
   PositivePayParam:Erp_Tablesets_PositivePayParamRow[],
   ...
   /** Required : 
      ...
      @param dateToken
   */  
export interface GetActualDateFromDateToken_input{
      /**  Output date value for the date token.  */  
   date:string,
      /**  Date Token Value  */  
   dateToken:string,
}

export interface GetActualDateFromDateToken_output{
   returnObj:string,
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_PositivePayTableset[],
}
