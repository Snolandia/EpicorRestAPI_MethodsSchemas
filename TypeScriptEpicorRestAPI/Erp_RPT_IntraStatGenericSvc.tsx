...
/** 
// Title: Erp.RPT.IntraStatGenericSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method GetPeriodOrDate
   Description: This method provides a list of options for the 'ByPeriodOrDate' parameter
   OperationID: GetPeriodOrDate
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetPeriodOrDate_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetPeriodOrDate(epicorHeaders?:Headers){
   ...
   return (new Promise<GetPeriodOrDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/GetPeriodOrDate", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetPeriodOrDate_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetTranType
   Description: This method provides a list of options for the 'TranType' parameter
   OperationID: GetTranType
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetTranType_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetTranType(epicorHeaders?:Headers){
   ...
   return (new Promise<GetTranType_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/GetTranType", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as GetTranType_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetWarning_ByDateRange
   Description: Purpose:
Parameters:  none
Notes:
            
<remarks>    Notes: This is a public procedure 'getwarning_byDateRange' that can be
used to check for and display a warning message, processing continues after user responds to warning message
output values are 'warningOut' (logical) = yes if warning should be displayed, 'warningmess' = text of warning message.
warns if unposted entries exist in period.
input parameters = 'DateFrom'  and "DateTo' entered on prompt screen
REFERENCED WHEN 'ByPeriodOrDate = "DT"
</remarks>
   OperationID: GetWarning_ByDateRange
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetWarning_ByDateRange_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetWarning_ByDateRange_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetWarning_ByDateRange(requestBody:GetWarning_ByDateRange_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetWarning_ByDateRange_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/GetWarning_ByDateRange", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as GetWarning_ByDateRange_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetWarning_ByFiscalPeriod
   Description: Purpose:
Parameters:  none
Notes:
            
<remarks>    Notes: This is a public procedure 'getwarning_byFiscalPeriod' that can be
used to check for and display a warning message, processing continues after user responds to warning message
output values are 'warningOut' (logical) = yes if warning should be displayed, 'warningmess' = text of warning message.
warns if unposted entries exist in period.
input parameters = periodin = period entered on prompt screen, fiscalyearin = fiscal year entered on prompt screen
REFERENCED WHEN 'ByPeriodOrDate = "FP"
</remarks>
   OperationID: GetWarning_ByFiscalPeriod
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetWarning_ByFiscalPeriod_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetWarning_ByFiscalPeriod_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetWarning_ByFiscalPeriod(requestBody:GetWarning_ByFiscalPeriod_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetWarning_ByFiscalPeriod_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/GetWarning_ByFiscalPeriod", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetWarning_ByFiscalPeriod_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.IntraStatGenericSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_IntraStatGenericParamRow{
   FiscalYear:number,
   Period:number,
   TranType:string,
   RoundWeights:boolean,
   RoundAmounts:boolean,
   ByPeriodOrDate:string,
   StartDate:string,
   EndDate:string,
   StartDateToken:string,
   EndDateToken:string,
   FiscalYearToken:string,
   PeriodToken:string,
   GroupBy:string,
   SysRowID:string,
   AutoAction:string,
...
export interface Erp_Tablesets_IntraStatGenericTableset{
   IntraStatGenericParam:Erp_Tablesets_IntraStatGenericParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_IntraStatGenericTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_IntraStatGenericTableset[],
}
...
export interface GetPeriodOrDate_output{
parameters : {
      /**  output parameters  */  
   PeriodOrDateCode:string,
}
}
...
export interface GetTranType_output{
parameters : {
      /**  output parameters  */  
   TranTypes:string,
}
   ...
   /** Required : 
      ...
      @param DateTo
   */  
export interface GetWarning_ByDateRange_input{
   DateFrom:string,
   DateTo:string,
}

export interface GetWarning_ByDateRange_output{
parameters : {
      /**  output parameters  */  
   WarningOut:boolean,
   WarningMess:string,
   ...
   /** Required : 
      ...
      @param FiscalYearIn
   */  
export interface GetWarning_ByFiscalPeriod_input{
   PeriodIn:number,
   FiscalYearIn:number,
}

export interface GetWarning_ByFiscalPeriod_output{
parameters : {
      /**  output parameters  */  
   WarningOut:boolean,
   WarningMess:string,
