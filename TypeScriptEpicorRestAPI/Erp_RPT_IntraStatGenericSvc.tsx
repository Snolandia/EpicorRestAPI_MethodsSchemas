...
REFERENCED WHEN 'ByPeriodOrDate = "DT"
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetWarning_ByDateRange(requestBody:any, epicorHeaders?:Headers){
...
REFERENCED WHEN 'ByPeriodOrDate = "FP"
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetWarning_ByFiscalPeriod(requestBody:any, epicorHeaders?:Headers){
