...
export function get_GLBGLCOARefTypes(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GLBGLCOARefTypes(requestBody:Erp_Tablesets_GLBGLCOARefTypeRow, epicorHeaders?:Headers){
...
export function get_GLBGLCOARefTypes_Company_ExtCompanyID_COACode_SegmentNbr_RefType(Company:string, ExtCompanyID:string, COACode:string, SegmentNbr:string, RefType:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GLBGLCOARefTypes_Company_ExtCompanyID_COACode_SegmentNbr_RefType(Company:string, ExtCompanyID:string, COACode:string, SegmentNbr:string, RefType:string, requestBody:Erp_Tablesets_GLBGLCOARefTypeRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGLBGLCOARefType(requestBody:GetNewGLBGLCOARefType_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGLBGLCOARefType_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGLBGLCOARefType_output)
          })
      .catch((error) => {
          reject(error)
      })
