...
export function get_PredictiveSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_PredictiveSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_PredictiveSearches_Company_GlbCompany_QuickSearchID(Company:string, GlbCompany:string, QuickSearchID:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_PredictiveSearches_Company_GlbCompany_QuickSearchID(Company:string, GlbCompany:string, QuickSearchID:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewPredictiveSearch(requestBody:any, epicorHeaders?:Headers){
