...
export function get_DemandLogs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_DemandLogs(requestBody:Erp_Tablesets_DemandLogRow, epicorHeaders?:Headers){
...
export function get_DemandLogs_Company_TranNum_SysDate_SysTime(Company:string, TranNum:string, SysDate:string, SysTime:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_DemandLogs_Company_TranNum_SysDate_SysTime(Company:string, TranNum:string, SysDate:string, SysTime:string, requestBody:Erp_Tablesets_DemandLogRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewDemandLog(requestBody:GetNewDemandLog_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewDemandLog_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewDemandLog_output)
          })
      .catch((error) => {
          reject(error)
      })
