...
/** 
// Title: Erp.PROC.GLVerifyBalancesSvc
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method CheckCOAFmtChange
   Description: Purpose: Validate BookID and get Book information
   OperationID: CheckCOAFmtChange
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/CheckCOAFmtChange_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/CheckCOAFmtChange_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckCOAFmtChange(requestBody:CheckCOAFmtChange_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckCOAFmtChange_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/CheckCOAFmtChange", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as CheckCOAFmtChange_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetBalanceFmtChange
   Description: Purpose: Return true if COA was changed and Verify Balances is needed
   OperationID: GetBalanceFmtChange
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetBalanceFmtChange_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetBalanceFmtChange_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetBalanceFmtChange(requestBody:GetBalanceFmtChange_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBalanceFmtChange_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/GetBalanceFmtChange", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetBalanceFmtChange_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method ChangedYear
   Description: Purpose: to set default fiscal period when fiscal year is changed
   OperationID: ChangedYear
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ChangedYear_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ChangedYear_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangedYear(requestBody:ChangedYear_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ChangedYear_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/ChangedYear", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ChangedYear_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method CheckEndDate
   Description: Purpose: Validate EndDate and update End Fiscal Info if it is correct
   OperationID: CheckEndDate
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/CheckEndDate_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/CheckEndDate_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckEndDate(requestBody:CheckEndDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckEndDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/CheckEndDate", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as CheckEndDate_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method CheckStartDate
   Description: Purpose: Validate StartDate and update Start Fiscal Info if it is correct
   OperationID: CheckStartDate
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/CheckStartDate_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/CheckStartDate_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckStartDate(requestBody:CheckStartDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckStartDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/CheckStartDate", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as CheckStartDate_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.GLVerifyBalancesSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
//////////////////////////////////////////////////////////////////////////
   /** Required : 
      @param inFiscalYear
      @param inFiscalYearSuffix
      @param inIsStartYear
      @param ds
   */  
export interface ChangedYear_input{
   inFiscalYear:number,
   inFiscalYearSuffix:string,
   inIsStartYear:boolean,
   ds:Erp_Tablesets_GLVerifyBalancesTableset[],
}

export interface ChangedYear_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_GLVerifyBalancesTableset,
}
   ...
   /** Required : 
      ...
      @param clearFilter
   */  
export interface CheckCOAFmtChange_input{
   ds:Erp_Tablesets_GLVerifyBalancesTableset[],
      /**  Book ID  */  
   bookID:string,
      /**  clear filter  */  
...
export interface CheckCOAFmtChange_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_GLVerifyBalancesTableset,
   clearFilter:boolean,
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface CheckEndDate_input{
      /**  proposed daily end date  */  
   ipEndDate:string,
   ds:Erp_Tablesets_GLVerifyBalancesTableset[],
}

export interface CheckEndDate_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_GLVerifyBalancesTableset,
}
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface CheckStartDate_input{
      /**  Proposed Daily Start Date  */  
   ipStartDate:string,
   ds:Erp_Tablesets_GLVerifyBalancesTableset[],
}

export interface CheckStartDate_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_GLVerifyBalancesTableset,
}
...
export interface Erp_Tablesets_GLVerifyBalancesParamRow{
      /**  General Ledger Book ID to verify balances  */  
   GLBook:string,
      /**  Logical inidcating if the balance records are to be audited and/or updated.  If yes, the data is audited and updated.  If no, the data is only audited.  Audited means a report showing current value and calculated value is created.  No database updates occur.  */  
   UpdateBalances:boolean,
      /**  Logical indicating if the period and currency balances are to be verified.  If yes then: if update blances equals yes the balances are reported and updated.  If update blances equals no the balances are reported by NOT updated.  */  
   VerifyPerBal:boolean,
      /**  Starting Fiscal Year to verify balances.  Must be a valid year in the FiscalCalendar associated with the GL Book.  */  
   StartFiscalYear:number,
      /**  This is the first period in the start fiscal year to verify.  */  
   StartFiscalPeriod:number,
      /**  Ending fiscal year to verify balances.  Must be valid in the FiscalCalendar assoicated with the GL Book.  */  
   EndFiscalYear:number,
      /**  This is the last period in the end fiscal year to verify.  */  
   EndFiscalPeriod:number,
      /**  Logical indicating if the daily balances are to be verified.  */  
   VerifyDaily:boolean,
      /**  First date to verify daily balances.  */  
   DailyStart:string,
      /**  Last date to verify daily balancees.  */  
   DailyEnd:string,
      /**  List of natural accounts to use to verify the balance records.  If nothing is entered, ALL balance records are verified.  */  
   NaturalAccounts:string,
      /**  GL Book Description  */  
   GLBookDesc:string,
      /**  Indicates if the standard trial balances shall be verified or rebuilt.  */  
   StandardTrialBalances:boolean,
      /**  Log file for the csv output.  */  
   LogFileName:string,
      /**  Logical indicating to the UI that a balance format change has occurred and a rebuild is required.  */  
   BalanceFmtChange:boolean,
      /**  The fiscal year suffix allows for additional breakdown/definition of fiscal years, for example, by quarters.  */  
   EndFiscalYearSuffix:string,
      /**  The fiscal year suffix allows for additional breakdown/definition of fiscal years, for example, by quarters.  */  
   StartFiscalYearSuffix:string,
      /**  The id of the fiscal calendar.  */  
   FiscalCalendarID:string,
      /**  Logical indicating if the GLBook is to be enabled  */  
   EnableBook:boolean,
...
export interface Erp_Tablesets_GLVerifyBalancesTableset{
   GLVerifyBalancesParam:Erp_Tablesets_GLVerifyBalancesParamRow[],
   ...
   /** Required : 
      @param bookID
   */  
export interface GetBalanceFmtChange_input{
      /**  Book ID  */  
   bookID:string,
}

export interface GetBalanceFmtChange_output{
parameters : {
      /**  output parameters  */  
   balanceFmtChange:boolean,
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_GLVerifyBalancesTableset[],
}
