...
export function get_CurrExRates(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_CurrExRates(requestBody:any, epicorHeaders?:Headers){
...
export function get_CurrExRates_Company_RateGrpCode_SourceCurrCode_TargetCurrCode_EffectiveDate(Company:string, RateGrpCode:string, SourceCurrCode:string, TargetCurrCode:string, EffectiveDate:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_CurrExRates_Company_RateGrpCode_SourceCurrCode_TargetCurrCode_EffectiveDate(Company:string, RateGrpCode:string, SourceCurrCode:string, TargetCurrCode:string, EffectiveDate:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_AllowHistUpdates(epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_AlternalGetNewCurrExRate(requestBody:any, epicorHeaders?:Headers){
...
with RuleCode = 1 using the Current company and the given Rate Group Code as filters.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetCurrenciesDefaults(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListFilterDates(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetRowsFilterDates(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetByIDAlternate(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetListFilterDatesK(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetRateGrpData(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ImportExchangeRates(requestBody:any, epicorHeaders?:Headers){
...
updates  db exchange rate for display.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeExRate(requestBody:any, epicorHeaders?:Headers){
...
it must exist in the CurrExRate for the same RateGrp.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_UpdateCurrExRate(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_UpdateEffectiveDate(requestBody:any, epicorHeaders?:Headers){
