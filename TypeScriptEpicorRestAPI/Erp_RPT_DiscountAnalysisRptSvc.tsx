...
/** 
// Title: Erp.RPT.DiscountAnalysisRptSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method ValidateSummaryOnly
   Description: Used to Reset the SummaryOnly field when SortBy is changed.
   OperationID: ValidateSummaryOnly
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ValidateSummaryOnly_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ValidateSummaryOnly_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ValidateSummaryOnly(requestBody:ValidateSummaryOnly_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ValidateSummaryOnly_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/ValidateSummaryOnly", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as ValidateSummaryOnly_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.DiscountAnalysisRptSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_DiscountAnalysisRptParamRow{
      /**  Start Invoice Date  */  
   StartInvDate:string,
   StartInvDateToken:string,
      /**  End Invoice Date  */  
   EndInvDate:string,
   EndInvDateToken:string,
      /**  Payment Date  */  
   PaymentDate:string,
   PaymentDateToken:string,
      /**  Discount Earned Type (Earned or Not Earned)  */  
   DiscountEarnedType:string,
      /**  Flag to be set in the report to include/exclude Zero Discounts  */  
   ExcludeZeroDiscounts:boolean,
      /**  Delimited string of Invoice Numbers to be included in the Report  */  
   InvoiceNumList:string,
      /**  Delimited string of VendorNumbers to be included in the Report  */  
   VendNumList:string,
      /**  Sort By  */  
   SortBy:string,
   SummaryOnly:boolean,
...
export interface Erp_Tablesets_DiscountAnalysisRptTableset{
   DiscountAnalysisRptParam:Erp_Tablesets_DiscountAnalysisRptParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_DiscountAnalysisRptTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_DiscountAnalysisRptTableset[],
}
...
export interface SubmitToAgent_output{
   ...
   /** Required : 
      @param ds
   */  
export interface ValidateSummaryOnly_input{
   ds:Erp_Tablesets_DiscountAnalysisRptTableset[],
}

export interface ValidateSummaryOnly_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_DiscountAnalysisRptTableset,
}
