...
export function get_ContractRenewalSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_ContractRenewalSearches(requestBody:any, epicorHeaders?:Headers){
...
export function get_ContractRenewalSearches_Company_ContractNum_RenewalNbr(Company:string, ContractNum:string, RenewalNbr:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_ContractRenewalSearches_Company_ContractNum_RenewalNbr(Company:string, ContractNum:string, RenewalNbr:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_GetRenewals(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewContractRenewalSearch(requestBody:any, epicorHeaders?:Headers){
