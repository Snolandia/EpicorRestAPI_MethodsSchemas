...
export function get_GLBCOASegOpts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GLBCOASegOpts(requestBody:any, epicorHeaders?:Headers){
...
export function get_GLBCOASegOpts_Company_ExtCompanyID_COACode_SegmentNbr_SegmentCode_SubSegmentNbr(Company:string, ExtCompanyID:string, COACode:string, SegmentNbr:string, SegmentCode:string, SubSegmentNbr:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GLBCOASegOpts_Company_ExtCompanyID_COACode_SegmentNbr_SegmentCode_SubSegmentNbr(Company:string, ExtCompanyID:string, COACode:string, SegmentNbr:string, SegmentCode:string, SubSegmentNbr:string, requestBody:any, epicorHeaders?:Headers){
...
export function post_GetNewGLBCOASegValues(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGLBCOASegOpt(requestBody:any, epicorHeaders?:Headers){
