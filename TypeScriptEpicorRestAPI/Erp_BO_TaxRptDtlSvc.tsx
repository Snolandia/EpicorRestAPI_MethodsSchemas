...
export function get_TaxRptDtls(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_TaxRptDtls(requestBody:Erp_Tablesets_TaxRptDtlRow, epicorHeaders?:Headers){
...
export function get_TaxRptDtls_Company_ReportID_BoxCode(Company:string, ReportID:string, BoxCode:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TaxRptDtls_Company_ReportID_BoxCode(Company:string, ReportID:string, BoxCode:string, requestBody:Erp_Tablesets_TaxRptDtlRow, epicorHeaders?:Headers){
...
export function get_TaxRptDtlAttches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_TaxRptDtlAttches(requestBody:Erp_Tablesets_TaxRptDtlAttchRow, epicorHeaders?:Headers){
...
export function get_TaxRptDtlAttches_Company_ReportID_BoxCode_DrawingSeq(Company:string, ReportID:string, BoxCode:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TaxRptDtlAttches_Company_ReportID_BoxCode_DrawingSeq(Company:string, ReportID:string, BoxCode:string, DrawingSeq:string, requestBody:Erp_Tablesets_TaxRptDtlAttchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTaxRptDtl(requestBody:GetNewTaxRptDtl_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTaxRptDtl_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewTaxRptDtl_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTaxRptDtlAttch(requestBody:GetNewTaxRptDtlAttch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewTaxRptDtlAttch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewTaxRptDtlAttch_output)
          })
      .catch((error) => {
          reject(error)
      })
