...
export function get_CrossDocks(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_CrossDocks(requestBody:any, epicorHeaders?:Headers){
...
export function post_GetCodeDescList(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewCrossDock(requestBody:any, epicorHeaders?:Headers){
