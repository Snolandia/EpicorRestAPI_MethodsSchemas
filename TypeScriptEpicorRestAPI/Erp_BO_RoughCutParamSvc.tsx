...
export function get_RoughCutParams(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_RoughCutParams(requestBody:Erp_Tablesets_RoughCutParamRow, epicorHeaders?:Headers){
...
export function get_RoughCutParams_Company_RoughCutCode(Company:string, RoughCutCode:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_RoughCutParams_Company_RoughCutCode(Company:string, RoughCutCode:string, requestBody:Erp_Tablesets_RoughCutParamRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewRoughCutParam(requestBody:GetNewRoughCutParam_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewRoughCutParam_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewRoughCutParam_output)
          })
      .catch((error) => {
          reject(error)
      })
