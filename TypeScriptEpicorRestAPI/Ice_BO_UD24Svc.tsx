...
export function get_UD24s(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_UD24s(requestBody:Ice_Tablesets_UD24Row, epicorHeaders?:Headers){
...
export function get_UD24s_Company_Key1_Key2_Key3_Key4_Key5(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UD24s_Company_Key1_Key2_Key3_Key4_Key5(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, requestBody:Ice_Tablesets_UD24Row, epicorHeaders?:Headers){
...
export function get_UD24Attchs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_UD24Attchs(requestBody:Ice_Tablesets_UD24AttchRow, epicorHeaders?:Headers){
...
export function get_UD24Attchs_Company_Key1_Key2_Key3_Key4_Key5_DrawingSeq(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, DrawingSeq:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_UD24Attchs_Company_Key1_Key2_Key3_Key4_Key5_DrawingSeq(Company:string, Key1:string, Key2:string, Key3:string, Key4:string, Key5:string, DrawingSeq:string, requestBody:Ice_Tablesets_UD24AttchRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetaNewUD24(requestBody:GetaNewUD24_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetaNewUD24_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetaNewUD24_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewUD24(requestBody:GetNewUD24_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewUD24_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewUD24_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewUD24Attch(requestBody:GetNewUD24Attch_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewUD24Attch_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewUD24Attch_output)
          })
      .catch((error) => {
          reject(error)
      })
