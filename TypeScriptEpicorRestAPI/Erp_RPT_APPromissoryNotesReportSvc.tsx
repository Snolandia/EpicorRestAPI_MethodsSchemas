...
/** 
// Title: Erp.RPT.APPromissoryNotesReportSvc
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method CheckAPPromNoteIDNumbers
   Description: Check scope for APPromNoteID numbers.
   OperationID: CheckAPPromNoteIDNumbers
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/CheckAPPromNoteIDNumbers_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/CheckAPPromNoteIDNumbers_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckAPPromNoteIDNumbers(requestBody:CheckAPPromNoteIDNumbers_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckAPPromNoteIDNumbers_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/CheckAPPromNoteIDNumbers", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as CheckAPPromNoteIDNumbers_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method CheckAPPromNoteIDNumbersRestart
   Description: Check scope for APPromNoteID numbers.
   OperationID: CheckAPPromNoteIDNumbersRestart
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/CheckAPPromNoteIDNumbersRestart_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/CheckAPPromNoteIDNumbersRestart_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CheckAPPromNoteIDNumbersRestart(requestBody:CheckAPPromNoteIDNumbersRestart_input, epicorHeaders?:Headers){
   ...
   return (new Promise<CheckAPPromNoteIDNumbersRestart_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/CheckAPPromNoteIDNumbersRestart", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as CheckAPPromNoteIDNumbersRestart_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method HeadNumDefaults
   Description: This method will default the AssignLegalNumber values.
   OperationID: HeadNumDefaults
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/HeadNumDefaults_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/HeadNumDefaults_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_HeadNumDefaults(requestBody:HeadNumDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<HeadNumDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/HeadNumDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as HeadNumDefaults_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_OnChangeCheckDate(requestBody:OnChangeCheckDate_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeCheckDate_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/OnChangeCheckDate", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
   ...
   Description: Call method when the over rides the Head Number .
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeLoadedCheckNum(requestBody:OnChangeLoadedCheckNum_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeLoadedCheckNum_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/OnChangeLoadedCheckNum", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as OnChangeLoadedCheckNum_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method validateAPPNPaymentParam
   Description: Common validations used by ReStartProcessPayment and ProcessPayment.
   OperationID: validateAPPNPaymentParam
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/validateAPPNPaymentParam_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/validateAPPNPaymentParam_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_validateAPPNPaymentParam(requestBody:validateAPPNPaymentParam_input, epicorHeaders?:Headers){
   ...
   return (new Promise<validateAPPNPaymentParam_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/validateAPPNPaymentParam", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as validateAPPNPaymentParam_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Description: Get the last payment number for the specified bank account and pi type generation option,
increment by 1 to display the starting payment number.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_getStartCheckNum(requestBody:getStartCheckNum_input, epicorHeaders?:Headers){
   ...
   return (new Promise<getStartCheckNum_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/getStartCheckNum", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as getStartCheckNum_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.APPromissoryNotesReportSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
//////////////////////////////////////////////////////////////////////////
   /** Required : 
      @param ds
   */  
export interface CheckAPPromNoteIDNumbersRestart_input{
   ds:Erp_Tablesets_APPromissoryNotesReportTableset[],
}

export interface CheckAPPromNoteIDNumbersRestart_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_APPromissoryNotesReportTableset,
}
   ...
   /** Required : 
      @param ds
   */  
export interface CheckAPPromNoteIDNumbers_input{
   ds:Erp_Tablesets_APPromissoryNotesReportTableset[],
}

export interface CheckAPPromNoteIDNumbers_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_APPromissoryNotesReportTableset,
}
...
export interface Erp_Tablesets_APPromissoryNoteParamRow{
   GroupID:string,
   HeadNum:number,
      /**  Indicates if a legal number should be generated when printing.  */  
   AssignLegalNumber:boolean,
      /**  Indicates if the AssignLegalNumber field is available for input  */  
   EnableAssignLegalNumber:boolean,
      /**  Can be C for checks or O for Others  */  
...
export interface Erp_Tablesets_APPromissoryNotesReportTableset{
   APPromissoryNoteParam:Erp_Tablesets_APPromissoryNoteParamRow[],
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_APPromissoryNotesReportTableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param ds
   */  
export interface HeadNumDefaults_input{
   ds:Erp_Tablesets_APPromissoryNotesReportTableset[],
}

export interface HeadNumDefaults_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_APPromissoryNotesReportTableset,
}
...
export interface getStartCheckNum_output{
   ...
   /** Required : 
      @param ttAPPromissoryNoteParam
   */  
export interface validateAPPNPaymentParam_input{
   ttAPPromissoryNoteParam:Erp_Tablesets_APPromissoryNoteParamRow[],
}

export interface validateAPPNPaymentParam_output{
}
