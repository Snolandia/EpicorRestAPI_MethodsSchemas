...
/** 
// Title: Erp.BO.CreditCardProcessorSvc
// Description: CreditCardProcessor Business Object
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_CreditCardProcessors(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_CreditCardProcessorRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/CreditCardProcessors", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   */  
export function post_CreditCardProcessors(requestBody:Erp_Tablesets_CreditCardProcessorRow, epicorHeaders?:Headers){
...
export function get_CreditCardProcessors_Company_ProcessorNum(Company:string, ProcessorNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Erp_Tablesets_CreditCardProcessorRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/CreditCardProcessors(" + Company + "," + ProcessorNum + ")", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_CreditCardProcessors_Company_ProcessorNum(Company:string, ProcessorNum:string, requestBody:Erp_Tablesets_CreditCardProcessorRow, epicorHeaders?:Headers){
...
export function delete_CreditCardProcessors_Company_ProcessorNum(Company:string, ProcessorNum:string, epicorHeaders?:Headers){
   ...
   OperationID: GetList
      ...
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas headers
   Returns: 
      200 Desc: OK => reference #/components/schemas/Epicor.RESTApi.Help.ODataSetResponse_System.Collections.Generic.List_Erp.Tablesets.CreditCardProcessorListRow
   */  
export function get_List(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   return (new Promise<Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_CreditCardProcessorListRow>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/List", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_CreditCardProcessorListRow)
          })
      .catch((error) => {
          reject(error)
      })
...
//////////////////////////////////////////////////////////////////////////
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetRows(whereClauseCreditCardProcessor:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   ...
   return (new Promise<GetRows_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/GetRows" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function get_GetByID(processorNum:string, epicorHeaders?:Headers){
   var firstParam = true
   var params = ""
   if(typeof processorNum!== 'undefined'){
      if(firstParam){
         params += "?"
         firstParam = false
      }else{
      ...
      params += "processorNum=" + processorNum
   }
   ...
   return (new Promise<GetByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/GetByID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/GetList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewCreditCardProcessor(requestBody:GetNewCreditCardProcessor_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewCreditCardProcessor_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/GetNewCreditCardProcessor", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewCreditCardProcessor_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_DeleteByID(requestBody:DeleteByID_input, epicorHeaders?:Headers){
   ...
   return (new Promise<DeleteByID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/DeleteByID", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetBySysRowID(id:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowID_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/GetBySysRowID" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetBySysRowIDs(ids:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetBySysRowIDs_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/GetBySysRowIDs" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_Update(requestBody:Update_input, epicorHeaders?:Headers){
   ...
   return (new Promise<Update_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/Update", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_UpdateExt(requestBody:UpdateExt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<UpdateExt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.BO.CreditCardProcessorSvc/UpdateExt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// OData Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Epicor_RESTApi_Help_ODataSetResponse_System_Collections_Generic_List_Erp_Tablesets_CreditCardProcessorListRow{
   "odatametadata":string,
   "value":Erp_Tablesets_CreditCardProcessorListRow,
}
...
export interface Erp_Tablesets_CreditCardProcessorListRow{
      /**  ProcessorNum  */  
   "ProcessorNum":number,
      /**  Processor  */  
   "Processor":string,
...
export interface Erp_Tablesets_CreditCardProcessorListTableset{
   CreditCardProcessorList:Erp_Tablesets_CreditCardProcessorListRow[],
...
export interface Erp_Tablesets_CreditCardProcessorTableset{
   CreditCardProcessor:Erp_Tablesets_CreditCardProcessorRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}

export interface Erp_Tablesets_UpdExtCreditCardProcessorTableset{
   CreditCardProcessor:Erp_Tablesets_CreditCardProcessorRow[],
   ExtensionTables:Ice_Extensions_ExtensionTableData[],
}
...
export interface GetByID_output{
   returnObj:Erp_Tablesets_CreditCardProcessorTableset[],
}
...
export interface GetList_output{
   returnObj:Erp_Tablesets_CreditCardProcessorListTableset[],
parameters : {
      /**  output parameters  */  
   morePages:boolean,
}
...
export interface GetNewCreditCardProcessor_input{
   ds:Erp_Tablesets_CreditCardProcessorTableset[],
}
...
export interface UpdateExt_input{
   ds:Erp_Tablesets_UpdExtCreditCardProcessorTableset[],
