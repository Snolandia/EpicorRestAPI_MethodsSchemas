...
export function get_GlbPartSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GlbPartSearches(requestBody:Erp_Tablesets_GlbPartRow, epicorHeaders?:Headers){
...
export function get_GlbPartSearches_Company_GlbCompany_GlbPartNum(Company:string, GlbCompany:string, GlbPartNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GlbPartSearches_Company_GlbCompany_GlbPartNum(Company:string, GlbCompany:string, GlbPartNum:string, requestBody:Erp_Tablesets_GlbPartRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGlbPart(requestBody:GetNewGlbPart_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGlbPart_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGlbPart_output)
          })
      .catch((error) => {
          reject(error)
      })
