...
export function get_GLBGLAccounts(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_GLBGLAccounts(requestBody:Erp_Tablesets_GLBGLAccountRow, epicorHeaders?:Headers){
...
export function get_GLBGLAccounts_Company_ExtCompanyID_COACode_GLAccount(Company:string, ExtCompanyID:string, COACode:string, GLAccount:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_GLBGLAccounts_Company_ExtCompanyID_COACode_GLAccount(Company:string, ExtCompanyID:string, COACode:string, GLAccount:string, requestBody:Erp_Tablesets_GLBGLAccountRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewGLBGLAccount(requestBody:GetNewGLBGLAccount_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewGLBGLAccount_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewGLBGLAccount_output)
          })
      .catch((error) => {
          reject(error)
      })
