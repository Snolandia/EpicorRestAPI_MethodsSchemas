...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ConfigCheckSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ConfigCheckSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   */  
export function post_runConfigCheck(epicorHeaders?:Headers){
   ...
   return (new Promise<runConfigCheck_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ConfigCheckSvc/runConfigCheck", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as runConfigCheck_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_CompactLOH(epicorHeaders?:Headers){
   ...
   return (new Promise<CompactLOH_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ConfigCheckSvc/CompactLOH", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
      ...
      .then((data) => {
         resolve(data as CompactLOH_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function post_GetInstanceDefinition(epicorHeaders?:Headers){
   ...
   return (new Promise<GetInstanceDefinition_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ConfigCheckSvc/GetInstanceDefinition", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
for convenience of travel over the wire using GZipStream
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_zippedLogFiles(requestBody:zippedLogFiles_input, epicorHeaders?:Headers){
   ...
   return (new Promise<zippedLogFiles_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Ice.BO.ConfigCheckSvc/zippedLogFiles", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as zippedLogFiles_output)
          })
      .catch((error) => {
          reject(error)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface CompactLOH_output{
...
export interface runConfigCheck_output{
      /**  A string that can then be transformed to a dataset using DataSet.ReadXML  */  
   returnObj:string,
}

   /** Required : 
      @param getOnlyLastItem
   */  
export interface zippedLogFiles_input{
      /**  Get only the last server log file by name  */  
   getOnlyLastItem:boolean,
}

export interface zippedLogFiles_output{
