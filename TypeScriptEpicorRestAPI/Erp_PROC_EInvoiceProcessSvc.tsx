...
Note: A parameter dataset should never contain more than one record.
   ...
   */  
export function post_GetNewParametersExt(requestBody:any, epicorHeaders?:Headers){
...
Note: A parameter dataset should never contain more than one record.
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewParametersForReceipt(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ProcessInvoice(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ProcessReceipt(requestBody:any, epicorHeaders?:Headers){
