...
/** 
// Title: Erp.PROC.EInvoiceProcessSvc
// Description: 
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method GetNewParametersExt
   Description: Creates a new (parameter record) in the dataset.
Fill it depends on received invoice num
Note: A parameter dataset should never contain more than one record.
   OperationID: GetNewParametersExt
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetNewParametersExt_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetNewParametersExt_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewParametersExt(requestBody:GetNewParametersExt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParametersExt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/GetNewParametersExt", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as GetNewParametersExt_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method GetNewParametersForReceipt
   Description: Creates a new (parameter record) in the dataset.
Fill it depends on received group and headNum
Note: A parameter dataset should never contain more than one record.
   OperationID: GetNewParametersForReceipt
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/GetNewParametersForReceipt_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/GetNewParametersForReceipt_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewParametersForReceipt(requestBody:GetNewParametersForReceipt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParametersForReceipt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/GetNewParametersForReceipt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as GetNewParametersForReceipt_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method ProcessInvoice
   Description: Create task to generate E-Invoice for AR Invoice.
   OperationID: ProcessInvoice
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ProcessInvoice_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ProcessInvoice_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ProcessInvoice(requestBody:ProcessInvoice_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ProcessInvoice_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/ProcessInvoice", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ProcessInvoice_output)
          })
      .catch((error) => {
          reject(error)
      })
   ...
   /**  
   Summary: Invoke method ProcessReceipt
   Description: Create task to generate E-Invoice for Cash Receipt.
   OperationID: ProcessReceipt
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/ProcessReceipt_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/ProcessReceipt_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ProcessReceipt(requestBody:ProcessReceipt_input, epicorHeaders?:Headers){
   ...
   return (new Promise<ProcessReceipt_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/ProcessReceipt", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
      ...
      .then((data) => {
         resolve(data as ProcessReceipt_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.PROC.EInvoiceProcessSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
// Custom Schemas:
//////////////////////////////////////////////////////////////////////////
export interface Erp_Tablesets_EInvoiceProcessParamRow{
      /**  Begin Date  */  
   BeginDate:string,
   BeginDateToken:string,
      /**  List of selected customers to process  */  
   CustomerList:string,
      /**  End Date  */  
   EndDate:string,
   EndDateToken:string,
...
L - Legal Number  */  
   SearchByOption:string,
      /**  Skip sending email if true  */  
   SkipSendEmail:boolean,
      /**  Error Status - 1  */  
   StatusError:boolean,
      /**  Generated Status - 2  */  
   StatusGenerated:boolean,
   StatusOpen:boolean,
      /**  Sent Status - 3  */  
   StatusSent:boolean,
   TranDocType:string,
   TranDocTypeDescription:string,
      /**   A - All invoices and credit memos
S - Just selected  */  
   TranDocTypeOption:string,
   TrackerMode:boolean,
      /**  User terminal IP  */  
   TerminalIP:string,
      /**  User terminal Name  */  
   ...
   ReceiptTranDocTypeID:string,
      /**  A - All Receipts, S - Just selected  */  
   ReceiptTranDocTypeOption:string,
   SysRowID:string,
   AutoAction:string,
   PrinterName:string,
...
export interface Erp_Tablesets_EInvoiceProcessTableset{
   EInvoiceProcessParam:Erp_Tablesets_EInvoiceProcessParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_EInvoiceProcessTableset[],
}
...
parameters : {
   ...
   /** Required : 
      @param invoiceNum
   */  
export interface GetNewParametersExt_input{
   invoiceNum:any,      //schema had no properties on an object.
}

export interface GetNewParametersExt_output{
   returnObj:Erp_Tablesets_EInvoiceProcessTableset[],
}
   ...
   /** Required : 
      ...
      @param headNum
   */  
export interface GetNewParametersForReceipt_input{
   groupID:string,
   headNum:number,
}

export interface GetNewParametersForReceipt_output{
   returnObj:Erp_Tablesets_EInvoiceProcessTableset[],
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      ...
      @param useSSRSRenderFormat
   */  
export interface ProcessInvoice_input{
   invoiceNum:number,
   reportID:string,
   reportStyleNum:number,
   useSSRSRenderFormat:string,
}

export interface ProcessInvoice_output{
   returnObj:number,
}
   ...
   /** Required : 
      ...
      @param useSSRSRenderFormat
   */  
export interface ProcessReceipt_input{
   groupID:string,
   headNum:number,
   checkRef:string,
   reportID:string,
...
export interface ProcessReceipt_output{
   returnObj:number,
}
