...
export function get_APInvSearches(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_APInvSearches(requestBody:Erp_Tablesets_APInvHedRow, epicorHeaders?:Headers){
...
export function get_APInvSearches_Company_VendorNum_InvoiceNum(Company:string, VendorNum:string, InvoiceNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_APInvSearches_Company_VendorNum_InvoiceNum(Company:string, VendorNum:string, InvoiceNum:string, requestBody:Erp_Tablesets_APInvHedRow, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewAPInvHed(requestBody:GetNewAPInvHed_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewAPInvHed_output>((resolve, reject) => {
      ...
      .then((data) => {
         resolve(data as GetNewAPInvHed_output)
          })
      .catch((error) => {
          reject(error)
      })
