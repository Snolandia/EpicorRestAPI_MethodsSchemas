...
/** 
// Title: Erp.RPT.TWARZeroRatedSalesListRptSvc
// Description: TW AR Zero-rated Sales List report
// Version: v1
*/ 
...
export function getServiceDocument(epicorHeaders?:Headers){
   ...
   return (new Promise<JSON>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_metadata(epicorHeaders?:Headers){
   ...
   return (new Promise<any>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/$metadata", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
//////////////////////////////////////////////////////////////////////////
   ...
   /**  
   Summary: Invoke method OnChangeOfReportPeriod
   Description: Update Start/End Dates when FiscalYear/FiscalYearSuffix/ReportPeriod is changed
   OperationID: OnChangeOfReportPeriod
      @param epicorHeaders A string representing the epicor log in information to be used, 
         already converted to base64 in the format username:password, defaults to the configEpicorSchemas creds
      @param requestBody Desc: Input parameters  => reference#/components/schemas/OnChangeOfReportPeriod_input
   Returns: 
      200 Desc: OK => reference#/components/schemas/OnChangeOfReportPeriod_output
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_OnChangeOfReportPeriod(requestBody:OnChangeOfReportPeriod_input, epicorHeaders?:Headers){
   ...
   return (new Promise<OnChangeOfReportPeriod_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/OnChangeOfReportPeriod", {
          method: 'post',
          headers: headers,
      ...
      .then((data) => {
         resolve(data as OnChangeOfReportPeriod_output)
          })
      .catch((error) => {
          reject(error)
      })
...
export function get_GetTokenList(tokenDataType:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/GetTokenList" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetTokenValue(pcValue:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetTokenValue_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/GetTokenValue" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetRptArchiveList(epicorHeaders?:Headers){
   ...
   return (new Promise<GetRptArchiveList_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/GetRptArchiveList", {
          method: 'post',
          headers: headers,
      })
      fetch(request)
...
export function post_SubmitToAgent(requestBody:SubmitToAgent_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SubmitToAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/SubmitToAgent", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_GetDefaults(requestBody:GetDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/GetDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function get_GetNewParameters(epicorHeaders?:Headers){
   ...
   return (new Promise<GetNewParameters_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/GetNewParameters", {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function get_GetParamsFromAgent(agentID:string, agentSchedNum:string, agentTaskNum:string, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamsFromAgent_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/GetParamsFromAgent" + params, {
          method: 'get',
          headers: headers,
      })
      fetch(request)
...
export function post_GetParamTaskDef(requestBody:GetParamTaskDef_input, epicorHeaders?:Headers){
   ...
   return (new Promise<GetParamTaskDef_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/GetParamTaskDef", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RemoveDefaults(requestBody:RemoveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RemoveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/RemoveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_RunDirect(requestBody:RunDirect_input, epicorHeaders?:Headers){
   ...
   return (new Promise<RunDirect_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/RunDirect", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveDefaults(requestBody:SaveDefaults_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveDefaults_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/SaveDefaults", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export function post_SaveProcessTask(requestBody:SaveProcessTask_input, epicorHeaders?:Headers){
   ...
   return (new Promise<SaveProcessTask_output>((resolve, reject) => {
      const request: RequestInfo = new Request(configEpicorSchemas.epicorURL + "Erp.RPT.TWARZeroRatedSalesListRptSvc/SaveProcessTask", {
          method: 'post',
          headers: headers,
          body: JSON.stringify(requestBody)
      })
...
export interface Erp_Tablesets_TWARZeroRatedSalesListRptParamRow{
   FiscalCalendarID:string,
   FiscalYear:number,
   FiscalYearSuffix:string,
   ReportPeriod:number,
   DeclarationDate:string,
   DeclarationDateToken:string,
   StartDate:string,
   EndDate:string,
...
export interface Erp_Tablesets_TWARZeroRatedSalesListRptTableset{
   TWARZeroRatedSalesListRptParam:Erp_Tablesets_TWARZeroRatedSalesListRptParamRow[],
...
export interface GetDefaults_input{
   ds:Erp_Tablesets_TWARZeroRatedSalesListRptTableset[],
}
...
export interface GetNewParameters_output{
   returnObj:Erp_Tablesets_TWARZeroRatedSalesListRptTableset[],
}
...
export interface Ice_Extensions_ExtensionTableData{
   ...
   /** Required : 
      ...
      @param ds
   */  
export interface OnChangeOfReportPeriod_input{
      /**  New Fiscal Year value  */  
   fiscalYear:number,
      /**  New Fiscal Year Suffix value  */  
   fiscalYearSuffix:string,
      /**  New ReportPeriod value  */  
   reportPeriod:number,
   ds:Erp_Tablesets_TWARZeroRatedSalesListRptTableset[],
}

export interface OnChangeOfReportPeriod_output{
parameters : {
      /**  output parameters  */  
   ds:Erp_Tablesets_TWARZeroRatedSalesListRptTableset,
}
