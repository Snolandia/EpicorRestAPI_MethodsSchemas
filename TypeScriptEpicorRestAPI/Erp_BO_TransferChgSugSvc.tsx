...
export function get_TransferChgSugs(select?:string, expand?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   */  
export function post_TransferChgSugs(requestBody:any, epicorHeaders?:Headers){
...
export function get_TransferChgSugs_Company_TFLineNum(Company:string, TFLineNum:string, select?:string, expand?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TransferChgSugs_Company_TFLineNum(Company:string, TFLineNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_TFOrdSugs(select?:string, filter?:string, orderby?:string, top?:string, skip?:string, inlinecount?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_TFOrdSugs(requestBody:any, epicorHeaders?:Headers){
...
export function get_TFOrdSugs_Company_TFLineNum(Company:string, TFLineNum:string, select?:string, filter?:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function patch_TFOrdSugs_Company_TFLineNum(Company:string, TFLineNum:string, requestBody:any, epicorHeaders?:Headers){
...
export function get_GetList(whereClause:string, pageSize:string, absolutePage:string, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ChangeReqValue(requestBody:any, epicorHeaders?:Headers){
...
and TFOrdDTl.NeedByDate less or = horizonDate
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_ProcessChgSuggestions(requestBody:any, epicorHeaders?:Headers){
...
export function post_GetNewTFOrdDtl(requestBody:any, epicorHeaders?:Headers){
   ...
   Returns: 
      ...
      500 Desc: Internal server error. Server is unable to process the request.
   */  
export function post_GetNewTFOrdSug(requestBody:any, epicorHeaders?:Headers){
